...
C# __Копировать
     public sealed class ActionTypeRegistry : Registry<int, ActionType>, 
    	IActionTypeRegistry, IRegistry<int, ActionType>
VB __Копировать
     Public NotInheritable Class ActionTypeRegistry
    	Inherits Registry(Of Integer, ActionType)
    	Implements IActionTypeRegistry, IRegistry(Of Integer, ActionType)
C++ __Копировать
     public ref class ActionTypeRegistry sealed : public Registry<int, ActionType^>, 
    	IActionTypeRegistry, IRegistry<int, ActionType^>
F# __Копировать
     [<SealedAttribute>]
    type ActionTypeRegistry = 
        class
            inherit Registry<int, ActionType>
            interface IActionTypeRegistry
            interface IRegistry<int, ActionType>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Registry](T_Tessa_Platform_Registry_2.htm)<[Int32](https://learn.microsoft.com/dotnet/api/system.int32), [ActionType](T_Tessa_Platform_Runtime_ActionType.htm)> __ ActionTypeRegistry
Implements
    [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Int32](https://learn.microsoft.com/dotnet/api/system.int32), [ActionType](T_Tessa_Platform_Runtime_ActionType.htm)>, [IActionTypeRegistry](T_Tessa_Platform_Runtime_IActionTypeRegistry.htm)
##  __Свойства
[Instance](P_Tessa_Platform_Runtime_ActionTypeRegistry_Instance.htm)|
Экземпляр класса.  
---|---  
##  __Методы
