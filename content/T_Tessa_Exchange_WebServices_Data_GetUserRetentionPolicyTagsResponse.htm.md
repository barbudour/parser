# GetUserRetentionPolicyTagsResponse - класс
...
C++ __Копировать
     public ref class GetUserRetentionPolicyTagsResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ GetUserRetentionPolicyTagsResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[RetentionPolicyTags](P_Tessa_Exchange_WebServices_Data_GetUserRetentionPolicyTagsResponse_RetentionPolicyTags.htm)|
