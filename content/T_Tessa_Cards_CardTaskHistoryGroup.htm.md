...
## __Свойства
[Caption](P_Tessa_Cards_CardTaskHistoryGroup_Caption.htm)|  Название группы
заданий.  
---|---  
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[Iteration](P_Tessa_Cards_CardTaskHistoryGroup_Iteration.htm)|  Цикл
согласования.  
[ParentRowID](P_Tessa_Cards_CardTaskHistoryGroup_ParentRowID.htm)|
Идентификатор родительской группы заданий.  
[RowID](P_Tessa_Cards_CardTaskHistoryGroup_RowID.htm)|  Идентификатор группы
заданий.  
[State](P_Tessa_Cards_CardTaskHistoryGroup_State.htm)|  Состояние строки с
группой заданий.  
[TypeID](P_Tessa_Cards_CardTaskHistoryGroup_TypeID.htm)|  Идентификатор типа
группы заданий.  
## __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[HasChanges](M_Tessa_Cards_CardTaskHistoryGroup_HasChanges.htm)|  Возвращает
признак того, что группа истории заданий изменена.  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[IsEmpty](M_Tessa_Cards_CardTaskHistoryGroup_IsEmpty.htm)|  Возвращает признак
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[RemoveChanges](M_Tessa_Cards_CardTaskHistoryGroup_RemoveChanges.htm)|
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[RepairStorage](M_Tessa_Cards_CardTaskHistoryGroup_RepairStorage.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardTaskHistoryGroup_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
