# KrClientCommandCustomExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrClientCommandCustomExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class KrClientCommandCustomExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type KrClientCommandCustomExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ KrClientCommandCustomExtension
##  __Конструкторы
[KrClientCommandCustomExtension](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_Requests_KrClientCommandCustomExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrClientCommandCustomExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_Requests_KrClientCommandCustomExtension_AfterRequest.htm)|
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Client.Workflow.KrProcess.Requests - пространство
имён](N_Tessa_Extensions_Default_Client_Workflow_KrProcess_Requests.htm)
