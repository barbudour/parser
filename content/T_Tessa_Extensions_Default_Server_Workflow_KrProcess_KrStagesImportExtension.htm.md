...
C# __Копировать
     public sealed class KrStagesImportExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class KrStagesImportExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class KrStagesImportExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type KrStagesImportExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ KrStagesImportExtension
##  __Конструкторы
[KrStagesImportExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrStagesImportExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrStagesImportExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrStagesImportExtension_BeforeRequest.htm)|  
(Переопределяет
