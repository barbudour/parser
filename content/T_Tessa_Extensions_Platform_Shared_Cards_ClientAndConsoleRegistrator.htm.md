# ClientAndConsoleRegistrator - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Shared.Cards](N_Tessa_Extensions_Platform_Shared_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [RegistratorAttribute(ExtensionStage.Platform, Type = SessionType.Client, IsPlatform = true, 
    	Tag = RegistratorTag.DefaultForClientAndConsole)]
    public sealed class ClientAndConsoleRegistrator : RegistratorBase
VB __Копировать
    <RegistratorAttribute(ExtensionStage.Platform, Type := SessionType.Client, IsPlatform := true, 
    	Tag := RegistratorTag.DefaultForClientAndConsole)>
    Public NotInheritable Class ClientAndConsoleRegistrator
    	Inherits RegistratorBase
C++ __Копировать
    [RegistratorAttribute(ExtensionStage::Platform, Type = SessionType::Client, 
    	IsPlatform = true, Tag = RegistratorTag::DefaultForClientAndConsole)]
    public ref class ClientAndConsoleRegistrator sealed : public RegistratorBase
F# __Копировать
     [<SealedAttribute>]
    [<RegistratorAttribute(ExtensionStage.Platform, Type = SessionType.Client, IsPlatform = true, 
    	Tag = RegistratorTag.DefaultForClientAndConsole)>]
    type ClientAndConsoleRegistrator = 
        class
            inherit RegistratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm) __ ClientAndConsoleRegistrator
##  __Конструкторы
[ClientAndConsoleRegistrator](M_Tessa_Extensions_Platform_Shared_Cards_ClientAndConsoleRegistrator__ctor.htm)|
Инициализирует новый экземпляр класса ClientAndConsoleRegistrator  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterExtensions](M_Tessa_Extensions_Platform_Shared_Cards_ClientAndConsoleRegistrator_RegisterExtensions.htm)|  
(Переопределяет
[RegistratorBase.RegisterExtensions(IExtensionContainer)](M_Tessa_Extensions_RegistratorBase_RegisterExtensions.htm))  
[RegisterUnity](M_Tessa_Extensions_Platform_Shared_Cards_ClientAndConsoleRegistrator_RegisterUnity.htm)|  
(Переопределяет
