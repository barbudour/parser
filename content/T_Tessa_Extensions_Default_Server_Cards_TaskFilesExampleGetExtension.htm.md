# TaskFilesExampleGetExtension - класс
...
VB __Копировать
     Public Class TaskFilesExampleGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class TaskFilesExampleGetExtension : public CardGetExtension
F# __Копировать
     type TaskFilesExampleGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ TaskFilesExampleGetExtension
##  __Конструкторы
[TaskFilesExampleGetExtension](M_Tessa_Extensions_Default_Server_Cards_TaskFilesExampleGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса TaskFilesExampleGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Cards_TaskFilesExampleGetExtension_AfterRequest.htm)|
