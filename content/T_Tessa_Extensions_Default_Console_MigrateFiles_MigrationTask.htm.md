...
VB __Копировать
     Public NotInheritable Class MigrationTask
C++ __Копировать
     public ref class MigrationTask sealed
F# __Копировать
     [<SealedAttribute>]
    type MigrationTask = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ MigrationTask
##  __Конструкторы
[MigrationTask](M_Tessa_Extensions_Default_Console_MigrateFiles_MigrationTask__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RunAsync](M_Tessa_Extensions_Default_Console_MigrateFiles_MigrationTask_RunAsync.htm)|  
