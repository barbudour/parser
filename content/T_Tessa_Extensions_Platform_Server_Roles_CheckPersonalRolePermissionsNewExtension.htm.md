# CheckPersonalRolePermissionsNewExtension - класс
...
C# __Копировать
     public sealed class CheckPersonalRolePermissionsNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class CheckPersonalRolePermissionsNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class CheckPersonalRolePermissionsNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type CheckPersonalRolePermissionsNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ CheckPersonalRolePermissionsNewExtension
##  __Конструкторы
[CheckPersonalRolePermissionsNewExtension](M_Tessa_Extensions_Platform_Server_Roles_CheckPersonalRolePermissionsNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса CheckPersonalRolePermissionsNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_CheckPersonalRolePermissionsNewExtension_AfterRequest.htm)|  
(Переопределяет
