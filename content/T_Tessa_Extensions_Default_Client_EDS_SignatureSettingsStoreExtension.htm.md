# SignatureSettingsStoreExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class SignatureSettingsStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class SignatureSettingsStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type SignatureSettingsStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ SignatureSettingsStoreExtension
##  __Конструкторы
[SignatureSettingsStoreExtension](M_Tessa_Extensions_Default_Client_EDS_SignatureSettingsStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса SignatureSettingsStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Client_EDS_SignatureSettingsStoreExtension_BeforeRequest.htm)|  
(Переопределяет
