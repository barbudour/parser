# SelectItemOnPreviewMouseDown - класс
...
C# __Копировать
     public sealed class SelectItemOnPreviewMouseDown : Behavior<ItemsControl>
VB __Копировать
     Public NotInheritable Class SelectItemOnPreviewMouseDown
    	Inherits Behavior(Of ItemsControl)
C++ __Копировать
     public ref class SelectItemOnPreviewMouseDown sealed : public Behavior<ItemsControl^>
F# __Копировать
     [<SealedAttribute>]
    type SelectItemOnPreviewMouseDown = 
        class
            inherit Behavior<ItemsControl>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[ItemsControl](https://learn.microsoft.com/dotnet/api/system.windows.controls.itemscontrol)> __ SelectItemOnPreviewMouseDown
##  __Конструкторы
[SelectItemOnPreviewMouseDown](M_Tessa_UI_Behaviors_SelectItemOnPreviewMouseDown__ctor.htm)|
Инициализирует новый экземпляр класса SelectItemOnPreviewMouseDown  
---|---  
##  __Свойства
...
[ChangedButton](P_Tessa_UI_Behaviors_SelectItemOnPreviewMouseDown_ChangedButton.htm)|
Признак того, что должна быть обработка событий нажатия мыши, которые уже
отмечены как обработанные.  
...
(Унаследован от
[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject))  
[HandledEventsToo](P_Tessa_UI_Behaviors_SelectItemOnPreviewMouseDown_HandledEventsToo.htm)|
Признак того, что должна быть обработка событий нажатия мыши, которые уже
отмечены как обработанные.  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_SelectItemOnPreviewMouseDown_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_SelectItemOnPreviewMouseDown_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_SelectItemOnPreviewMouseDown_OnDetaching.htm)|  
(Переопределяет
