# WindowInputBindingsBehavior - класс
...
C# __Копировать
     public sealed class WindowInputBindingsBehavior : Behavior<Window>
VB __Копировать
     Public NotInheritable Class WindowInputBindingsBehavior
    	Inherits Behavior(Of Window)
C++ __Копировать
     public ref class WindowInputBindingsBehavior sealed : public Behavior<Window^>
F# __Копировать
     [<SealedAttribute>]
    type WindowInputBindingsBehavior = 
        class
            inherit Behavior<Window>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[Window](https://learn.microsoft.com/dotnet/api/system.windows.window)> __ WindowInputBindingsBehavior
##  __Конструкторы
[WindowInputBindingsBehavior](M_Tessa_UI_Windows_WindowInputBindingsBehavior__ctor.htm)|
Инициализирует новый экземпляр класса WindowInputBindingsBehavior  
---|---  
##  __Свойства
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Windows_WindowInputBindingsBehavior_CreateInstanceCore.htm)|
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Windows_WindowInputBindingsBehavior_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Windows_WindowInputBindingsBehavior_OnDetaching.htm)|  
(Переопределяет
