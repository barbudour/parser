# NumberBuilder.TryGetSequenceNameAsync - метод
...
C# __Копировать
     public Task<string> TryGetSequenceNameAsync(
...
#### Реализации
[INumberBuilder.TryGetSequenceNameAsync(INumberContext, NumberTypeDescriptor,
CancellationToken)](M_Tessa_Cards_Numbers_INumberBuilder_TryGetSequenceNameAsync.htm)  
##  __См. также
#### Ссылки
