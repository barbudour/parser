...
C# __Копировать
    ...
    public sealed class MailFile : InfoStorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class MailFile
    	Inherits InfoStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class MailFile sealed : public InfoStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm) __ MailFile
Implements
    [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable)
##  __Конструкторы
[MailFile()](M_Tessa_Notices_MailFile__ctor.htm)|  Создаёт экземпляр класса и
пустое хранилище Dictionary<string, object>, декоратором для которого является
создаваемый объект.  
---|---  
[MailFile(Dictionary<String, Object>)](M_Tessa_Notices_MailFile__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[MailFile(IStorageObjectProvider)](M_Tessa_Notices_MailFile__ctor_2.htm)|
...
(Унаследован от
[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm))  
[FileID](P_Tessa_Notices_MailFile_FileID.htm)|  Идентификатор файла. Свойство
обязательно для заполнения.  
[FileName](P_Tessa_Notices_MailFile_FileName.htm)|  Имя файла, отображаемое в
письме. Свойство обязательно для заполнения.  
[FileTypeName](P_Tessa_Notices_MailFile_FileTypeName.htm)|  Имя типа файла,
используемое в расширениях на получение контента. Заполнять свойство
необязательно.  
[Info](P_Tessa_Platform_Storage_InfoStorageObject_Info.htm)|  Дополнительная
пользовательская информация.  
(Унаследован от
[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm))  
[IsVirtual](P_Tessa_Notices_MailFile_IsVirtual.htm)|  Признак того, что файл
является виртуальным, поэтому загружается посредством расширений
[ICardGetFileContentExtension](T_Tessa_Cards_Extensions_ICardGetFileContentExtension.htm).
Заполнять свойство необязательно, по умолчанию значение равно false.  
[Modified](P_Tessa_Notices_MailFile_Modified.htm)|  Дата изменения файла или
null, если дата неизвестна. Заполнять свойство необязательно, по умолчанию
значение равно null.  
[ModifiedByName](P_Tessa_Notices_MailFile_ModifiedByName.htm)|  Имя
пользователя, изменившего файл, или null, если имя неизвестно. Заполнять
свойство необязательно, по умолчанию значение равно null.  
[Source](P_Tessa_Notices_MailFile_Source.htm)|  Хранилище файлов. Заполнять
свойство необязательно, причём, если файл не виртуальный, то по умолчанию
будет использоваться хранилище с ID = 0. Это свойство заполняет те же данные,
что и свойство [SourceID](P_Tessa_Notices_MailFile_SourceID.htm), но в
типизированном виде.  
[SourceID](P_Tessa_Notices_MailFile_SourceID.htm)|  Идентификатор хранилища
файлов. Заполнять свойство необязательно, причём, если файл не виртуальный, то
по умолчанию будет использоваться хранилище с ID = 0. Это свойство заполняет
те же данные, что и свойство [Source](P_Tessa_Notices_MailFile_Source.htm), но
в нетипизированном виде.  
[VersionID](P_Tessa_Notices_MailFile_VersionID.htm)|  Идентификатор версии
файла. Свойство обязательно для заполнения.  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Notices_MailFile_Clone.htm)|  Выполняет глубокое клонирование
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
##  __Поля
[FileIDKey](F_Tessa_Notices_MailFile_FileIDKey.htm)|  
---|---  
[FileNameKey](F_Tessa_Notices_MailFile_FileNameKey.htm)|  
[FileTypeNameKey](F_Tessa_Notices_MailFile_FileTypeNameKey.htm)|  
[IsVirtualKey](F_Tessa_Notices_MailFile_IsVirtualKey.htm)|  
[ModifiedByNameKey](F_Tessa_Notices_MailFile_ModifiedByNameKey.htm)|  
[ModifiedKey](F_Tessa_Notices_MailFile_ModifiedKey.htm)|  
[SourceIDKey](F_Tessa_Notices_MailFile_SourceIDKey.htm)|  
[VersionIDKey](F_Tessa_Notices_MailFile_VersionIDKey.htm)|  
## __Методы расширения
