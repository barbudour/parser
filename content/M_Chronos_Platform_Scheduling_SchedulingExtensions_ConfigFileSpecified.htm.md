# SchedulingExtensions.ConfigFileSpecified - метод
...
C# __Копировать
     public static bool ConfigFileSpecified(
    	this IPluginMetadataTrigger trigger
    )
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function ConfigFileSpecified ( 
...
F# __Копировать
     [<ExtensionAttribute>]
    static member ConfigFileSpecified : 
...
true, если метаданные содержат информацию о конфигурационном файле; false в
противном случае.
