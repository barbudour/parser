# KrSecondarySatelliteHandler - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrSecondarySatelliteHandler
    	Inherits SatelliteHandlerBase
C++ __Копировать
     public ref class KrSecondarySatelliteHandler sealed : public SatelliteHandlerBase
F# __Копировать
     [<SealedAttribute>]
    type KrSecondarySatelliteHandler = 
        class
            inherit SatelliteHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[SatelliteHandlerBase](T_Tessa_Extensions_Platform_Server_Cards_Satellites_Handlers_SatelliteHandlerBase.htm) __ KrSecondarySatelliteHandler
##  __Конструкторы
[KrSecondarySatelliteHandler](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Satellite_KrSecondarySatelliteHandler__ctor.htm)|
Инициализирует новый экземпляр класса KrSecondarySatelliteHandler  
---|---  
##  __Методы
...
(Унаследован от
[SatelliteHandlerBase](T_Tessa_Extensions_Platform_Server_Cards_Satellites_Handlers_SatelliteHandlerBase.htm))  
[IsMainCardTypeAsync](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Satellite_KrSecondarySatelliteHandler_IsMainCardTypeAsync.htm)|  
...
(Унаследован от
[SatelliteHandlerBase](T_Tessa_Extensions_Platform_Server_Cards_Satellites_Handlers_SatelliteHandlerBase.htm))  
[PrepareSatelliteForCreateAsync](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Satellite_KrSecondarySatelliteHandler_PrepareSatelliteForCreateAsync.htm)|  
(Переопределяет
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Server.Workflow.KrProcess.Satellite - пространство
имён](N_Tessa_Extensions_Default_Server_Workflow_KrProcess_Satellite.htm)
