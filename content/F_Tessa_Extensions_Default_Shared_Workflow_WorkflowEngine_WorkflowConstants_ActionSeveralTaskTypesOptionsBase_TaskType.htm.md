# WorkflowConstants.ActionSeveralTaskTypesOptionsBase.TaskType - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Const TaskType As String = "TaskType"
C++ __Копировать
     public:
    literal String^ TaskType = "TaskType"
F# __Копировать
     static val mutable TaskType: string
#### Значение поля
