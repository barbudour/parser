...
C++ __Копировать
     public ref class SyncFolderItemsResponse sealed : public SyncResponse<Item^, ItemChange^>
F# __Копировать
     [<SealedAttribute>]
    type SyncFolderItemsResponse = 
        class
            inherit SyncResponse<Item, ItemChange>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __[SyncResponse](T_Tessa_Exchange_WebServices_Data_SyncResponse_2.htm)<[Item](T_Tessa_Exchange_WebServices_Data_Item.htm), [ItemChange](T_Tessa_Exchange_WebServices_Data_ItemChange.htm)> __ SyncFolderItemsResponse
##  __Свойства
