...
Асинхронная задача.
#### Реализации
[ICardModelSettings.SetupFromAsync(Dictionary<String, Object>, Func<Action,
CancellationToken, Task>,
CancellationToken)](M_Tessa_Cards_ICardModelSettings_SetupFromAsync.htm)  
##  __См. также
#### Ссылки
