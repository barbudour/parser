# SchemeTableCollection - класс
##  __Definition
 **Пространство имён:** [Tessa.Scheme](N_Tessa_Scheme.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class SchemeTableCollection : SchemeNamedObjectCollection<SchemeTable>
VB __Копировать
     Public NotInheritable Class SchemeTableCollection
    	Inherits SchemeNamedObjectCollection(Of SchemeTable)
C++ __Копировать
     public ref class SchemeTableCollection sealed : public SchemeNamedObjectCollection<SchemeTable^>
F# __Копировать
     [<SealedAttribute>]
    type SchemeTableCollection = 
        class
            inherit SchemeNamedObjectCollection<SchemeTable>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[SchemeObjectCollection](T_Tessa_Scheme_SchemeObjectCollection_1.htm)<[SchemeTable](T_Tessa_Scheme_SchemeTable.htm)> __[SchemeNamedObjectCollection](T_Tessa_Scheme_SchemeNamedObjectCollection_1.htm)<[SchemeTable](T_Tessa_Scheme_SchemeTable.htm)> __ SchemeTableCollection
##  __Свойства
...
(Унаследован от
[SchemeObjectCollection<T>](T_Tessa_Scheme_SchemeObjectCollection_1.htm))  
[Construct](M_Tessa_Scheme_SchemeTableCollection_Construct.htm)|  
(Переопределяет
