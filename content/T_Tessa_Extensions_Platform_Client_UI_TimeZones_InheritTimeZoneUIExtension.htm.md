# InheritTimeZoneUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI.TimeZones](N_Tessa_Extensions_Platform_Client_UI_TimeZones.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public class InheritTimeZoneUIExtension : CardUIExtension
VB __Копировать
     Public Class InheritTimeZoneUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class InheritTimeZoneUIExtension : public CardUIExtension
F# __Копировать
     type InheritTimeZoneUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ InheritTimeZoneUIExtension
##  __Конструкторы
[InheritTimeZoneUIExtension](M_Tessa_Extensions_Platform_Client_UI_TimeZones_InheritTimeZoneUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса InheritTimeZoneUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_TimeZones_InheritTimeZoneUIExtension_Initialized.htm)|  
(Переопределяет
