...
C# __Копировать
     public class WebProxyFactory : WebProxyFactoryBase
VB __Копировать
     Public Class WebProxyFactory
    	Inherits WebProxyFactoryBase
C++ __Копировать
     public ref class WebProxyFactory : public WebProxyFactoryBase
F# __Копировать
     type WebProxyFactory = 
        class
            inherit WebProxyFactoryBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxyFactoryBase](T_Tessa_Platform_Runtime_WebProxyFactoryBase.htm) __ WebProxyFactory
##  __Конструкторы
[WebProxyFactory](M_Tessa_Platform_Runtime_WebProxyFactory__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Свойства
[ConnectionSettings](P_Tessa_Platform_Runtime_WebProxyFactory_ConnectionSettings.htm)|
Настройки соединения с веб-приложением системы.  
---|---  
...
(Унаследован от
[WebProxyFactoryBase](T_Tessa_Platform_Runtime_WebProxyFactoryBase.htm))  
[SessionTokenHolder](P_Tessa_Platform_Runtime_WebProxyFactory_SessionTokenHolder.htm)|
Объект, содержащий токен, связанный с текущей сессией, или null, если связь с
сессией не поддерживается.  
[SessionVersionHolder](P_Tessa_Platform_Runtime_WebProxyFactory_SessionVersionHolder.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializeProxyParametersAsync](M_Tessa_Platform_Runtime_WebProxyFactory_InitializeProxyParametersAsync.htm)|
...
(Переопределяет [WebProxyFactoryBase.InitializeProxyParametersAsync(IWebProxy,
CancellationToken)](M_Tessa_Platform_Runtime_WebProxyFactoryBase_InitializeProxyParametersAsync.htm))  
