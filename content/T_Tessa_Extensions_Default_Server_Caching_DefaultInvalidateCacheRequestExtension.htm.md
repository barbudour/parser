# DefaultInvalidateCacheRequestExtension - класс
...
C# __Копировать
     public sealed class DefaultInvalidateCacheRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class DefaultInvalidateCacheRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class DefaultInvalidateCacheRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type DefaultInvalidateCacheRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ DefaultInvalidateCacheRequestExtension
##  __Конструкторы
[DefaultInvalidateCacheRequestExtension](M_Tessa_Extensions_Default_Server_Caching_DefaultInvalidateCacheRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса DefaultInvalidateCacheRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Caching_DefaultInvalidateCacheRequestExtension_AfterRequest.htm)|  
(Переопределяет
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Server.Caching - пространство
имён](N_Tessa_Extensions_Default_Server_Caching.htm)
