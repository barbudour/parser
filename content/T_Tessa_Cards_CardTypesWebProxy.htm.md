...
C# __Копировать
     public sealed class CardTypesWebProxy : WebProxy
VB __Копировать
     Public NotInheritable Class CardTypesWebProxy
    	Inherits WebProxy
C++ __Копировать
     public ref class CardTypesWebProxy sealed : public WebProxy
F# __Копировать
     [<SealedAttribute>]
    type CardTypesWebProxy = 
        class
            inherit WebProxy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm) __ CardTypesWebProxy
##  __Конструкторы
[CardTypesWebProxy](M_Tessa_Cards_CardTypesWebProxy__ctor.htm)| Создаёт
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetAllCardTypesAsync](M_Tessa_Cards_CardTypesWebProxy_GetAllCardTypesAsync.htm)|
Возвращает объекты, описывающие типы всех карточек, со всей необходимой
информацией.  
[GetCachedMetadataAsync](M_Tessa_Cards_CardTypesWebProxy_GetCachedMetadataAsync.htm)|
...
[GetCardTypeAsync](M_Tessa_Cards_CardTypesWebProxy_GetCardTypeAsync.htm)|
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[StoreAsync](M_Tessa_Cards_CardTypesWebProxy_StoreAsync.htm)| Добавляет,
