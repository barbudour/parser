# KrPermissionMandatoryRuleStorage - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrPermissionMandatoryRuleStorage
    	Inherits StorageObject
C++ __Копировать
     public ref class KrPermissionMandatoryRuleStorage sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    type KrPermissionMandatoryRuleStorage = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ KrPermissionMandatoryRuleStorage
##  __Конструкторы
...
Инициализирует новый экземпляр класса KrPermissionMandatoryRuleStorage  
---|---  
