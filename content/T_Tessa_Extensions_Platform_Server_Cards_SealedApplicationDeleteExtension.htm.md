# SealedApplicationDeleteExtension - класс
...
C# __Копировать
     public sealed class SealedApplicationDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class SealedApplicationDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class SealedApplicationDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type SealedApplicationDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ SealedApplicationDeleteExtension
##  __Конструкторы
[SealedApplicationDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_SealedApplicationDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса SealedApplicationDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_SealedApplicationDeleteExtension_BeforeRequest.htm)|  
(Переопределяет
