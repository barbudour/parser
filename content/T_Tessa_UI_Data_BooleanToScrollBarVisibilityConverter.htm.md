# BooleanToScrollBarVisibilityConverter - класс
...
C# __Копировать
     public sealed class BooleanToScrollBarVisibilityConverter : ValueConverter<bool, ScrollBarVisibility>
VB __Копировать
     Public NotInheritable Class BooleanToScrollBarVisibilityConverter
    	Inherits ValueConverter(Of Boolean, ScrollBarVisibility)
C++ __Копировать
     public ref class BooleanToScrollBarVisibilityConverter sealed : public ValueConverter<bool, ScrollBarVisibility^>
F# __Копировать
     [<SealedAttribute>]
    type BooleanToScrollBarVisibilityConverter = 
        class
            inherit ValueConverter<bool, ScrollBarVisibility>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueConverter](T_Tessa_UI_Data_ValueConverter_2.htm)<[Boolean](https://learn.microsoft.com/dotnet/api/system.boolean), [ScrollBarVisibility](https://learn.microsoft.com/dotnet/api/system.windows.controls.scrollbarvisibility)> __ BooleanToScrollBarVisibilityConverter
##  __Конструкторы
[BooleanToScrollBarVisibilityConverter](M_Tessa_UI_Data_BooleanToScrollBarVisibilityConverter__ctor.htm)|
Инициализирует новый экземпляр класса BooleanToScrollBarVisibilityConverter  
---|---  
##  __Методы
...
CultureInfo)](M_Tessa_UI_Data_BooleanToScrollBarVisibilityConverter_Convert.htm)|  
