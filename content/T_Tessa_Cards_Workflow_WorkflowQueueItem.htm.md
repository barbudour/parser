# WorkflowQueueItem - класс
Действие с номером в очереди
...
C# __Копировать
    ...
    public sealed class WorkflowQueueItem : CardInfoStorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowQueueItem
    	Inherits CardInfoStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowQueueItem sealed : public CardInfoStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[Handled](P_Tessa_Cards_Workflow_WorkflowQueueItem_Handled.htm)|  Признак
того, что действие обработано. Обработанные действия не будут обработаны
повторно и могут быть удалены из очереди после завершения цепочки действий.  
[ID](P_Tessa_Cards_Workflow_WorkflowQueueItem_ID.htm)|  Идентификатор записи.  
[Info](P_Tessa_Cards_CardInfoStorageObject_Info.htm)|  Дополнительная
пользовательская информация.  
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[QueueEventType](P_Tessa_Cards_Workflow_WorkflowQueueItem_QueueEventType.htm)|
Тип события по вызову действия с сигналом, в результате которого была
добавлена запись в очередь
[WorkflowQueue](T_Tessa_Cards_Workflow_WorkflowQueue.htm).  
[Signal](P_Tessa_Cards_Workflow_WorkflowQueueItem_Signal.htm)|  Объект,
определяющий сигнал, для которого требуется выполнить действие в очереди.  
## __Методы
[Clean](M_Tessa_Cards_Workflow_WorkflowQueueItem_Clean.htm)| Выполняет очистку
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_Workflow_WorkflowQueueItem_Clone.htm)|  Выполняет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Cards_Workflow_WorkflowQueueItem_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[IsEmpty](M_Tessa_Cards_Workflow_WorkflowQueueItem_IsEmpty.htm)|  Возвращает
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetSignal](M_Tessa_Cards_Workflow_WorkflowQueueItem_TryGetSignal.htm)|
Возвращает сигнал, для которого требуется выполнить действие в очереди, или
null, если сигнал ещё не был задан.  
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_Workflow_WorkflowQueueItem_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
