# ScannerBusyException - класс
Исключительная ситуация возникающая при не завершенной сессии сканирования.
## __Definition
 **Пространство имён:** [Tessa.Host](N_Tessa_Host.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public class ScannerBusyException : ScanException
VB __Копировать
    <SerializableAttribute>
    Public Class ScannerBusyException
    	Inherits ScanException
C++ __Копировать
    [SerializableAttribute]
    public ref class ScannerBusyException : public ScanException
F# __Копировать
     [<SerializableAttribute>]
    type ScannerBusyException = 
        class
            inherit ScanException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ScanException](T_Tessa_Host_ScanException.htm) __ ScannerBusyException
##  __Конструкторы
[ScannerBusyException()](M_Tessa_Host_ScannerBusyException__ctor.htm)|
Initializes a new instance of the
[Exception](https://learn.microsoft.com/dotnet/api/system.exception) class.  
---|---  
[ScannerBusyException(String)](M_Tessa_Host_ScannerBusyException__ctor_2.htm)|
Initializes a new instance of the
[Exception](https://learn.microsoft.com/dotnet/api/system.exception) class
with a specified error message.  
[ScannerBusyException(SerializationInfo,
StreamingContext)](M_Tessa_Host_ScannerBusyException__ctor_1.htm)| Initializes
a new instance of the
[Exception](https://learn.microsoft.com/dotnet/api/system.exception) class
with serialized data.  
[ScannerBusyException(String,
Exception)](M_Tessa_Host_ScannerBusyException__ctor_3.htm)| Initializes a new
instance of the
[Exception](https://learn.microsoft.com/dotnet/api/system.exception) class
with a specified error message and a reference to the inner exception that is
the cause of this exception.  
##  __Свойства
[ConditionCode](P_Tessa_Host_ScanException_ConditionCode.htm)|  Gets or sets
Код состояния  
(Унаследован от [ScanException](T_Tessa_Host_ScanException.htm))  
---|---  
...
(Унаследован от
[Exception](https://learn.microsoft.com/dotnet/api/system.exception))  
[StatusCode](P_Tessa_Host_ScanException_StatusCode.htm)|  Gets or sets Код
ошибки  
(Унаследован от [ScanException](T_Tessa_Host_ScanException.htm))  
