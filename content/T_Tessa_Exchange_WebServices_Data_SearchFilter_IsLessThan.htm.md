...
VB __Копировать
     Public NotInheritable Class IsLessThan
    	Inherits SearchFilter.RelationalFilter
C++ __Копировать
     public ref class IsLessThan sealed : public SearchFilter.RelationalFilter
F# __Копировать
     [<SealedAttribute>]
    type IsLessThan = 
        class
