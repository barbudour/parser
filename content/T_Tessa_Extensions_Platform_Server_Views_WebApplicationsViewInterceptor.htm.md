# WebApplicationsViewInterceptor - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Views](N_Tessa_Extensions_Platform_Server_Views.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class WebApplicationsViewInterceptor : ViewInterceptorBase
VB __Копировать
     Public NotInheritable Class WebApplicationsViewInterceptor
    	Inherits ViewInterceptorBase
C++ __Копировать
     public ref class WebApplicationsViewInterceptor sealed : public ViewInterceptorBase
F# __Копировать
     [<SealedAttribute>]
    type WebApplicationsViewInterceptor = 
        class
            inherit ViewInterceptorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ViewInterceptorBase](T_Tessa_Views_ViewInterceptorBase.htm) __ WebApplicationsViewInterceptor
##  __Конструкторы
[WebApplicationsViewInterceptor](M_Tessa_Extensions_Platform_Server_Views_WebApplicationsViewInterceptor__ctor.htm)|
Инициализирует новый экземпляр класса WebApplicationsViewInterceptor  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetDataAsync](M_Tessa_Extensions_Platform_Server_Views_WebApplicationsViewInterceptor_GetDataAsync.htm)|
