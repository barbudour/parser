...
VB __Копировать
     Public NotInheritable Class DialogStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class DialogStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type DialogStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ DialogStoreExtension
##  __Конструкторы
[DialogStoreExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_StageTypeRequests_DialogStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса DialogStoreExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_StageTypeRequests_DialogStoreExtension_AfterRequest.htm)|
