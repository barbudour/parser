# InvalidateContextRoleDeleteExtension - класс
...
C# __Копировать
     public sealed class InvalidateContextRoleDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class InvalidateContextRoleDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class InvalidateContextRoleDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type InvalidateContextRoleDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ InvalidateContextRoleDeleteExtension
##  __Конструкторы
[InvalidateContextRoleDeleteExtension](M_Tessa_Extensions_Platform_Shared_Roles_InvalidateContextRoleDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса InvalidateContextRoleDeleteExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Platform_Shared_Roles_InvalidateContextRoleDeleteExtension_AfterRequest.htm)|  
(Переопределяет
