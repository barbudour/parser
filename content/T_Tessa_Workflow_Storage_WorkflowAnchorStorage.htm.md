# WorkflowAnchorStorage - класс
##  __Definition
 **Пространство имён:** [Tessa.Workflow.Storage](N_Tessa_Workflow_Storage.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class WorkflowAnchorStorage : StorageObject, 
    	INotifyPropertyChanged
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowAnchorStorage
    	Inherits StorageObject
    	Implements INotifyPropertyChanged
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowAnchorStorage sealed : public StorageObject, 
    	INotifyPropertyChanged
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowAnchorStorage = 
        class
            inherit StorageObject
            interface INotifyPropertyChanged
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ WorkflowAnchorStorage
Implements
    [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged)
##  __Конструкторы
[WorkflowAnchorStorage()](M_Tessa_Workflow_Storage_WorkflowAnchorStorage__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowAnchorStorage  
---|---  
[WorkflowAnchorStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowAnchorStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowAnchorStorage  
[WorkflowAnchorStorage(Dictionary<String, Object>,
WorkflowLinkStorage)](M_Tessa_Workflow_Storage_WorkflowAnchorStorage__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowAnchorStorage  
##  __Свойства
[Link](P_Tessa_Workflow_Storage_WorkflowAnchorStorage_Link.htm)|  
---|---  
[X](P_Tessa_Workflow_Storage_WorkflowAnchorStorage_X.htm)|  
[Y](P_Tessa_Workflow_Storage_WorkflowAnchorStorage_Y.htm)|  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
##  __События
[PropertyChanged](E_Tessa_Workflow_Storage_WorkflowAnchorStorage_PropertyChanged.htm)|
