...
VB __Копировать
     Public Class StageGroupViewModel
    	Inherits ViewModel(Of EmptyModel)
C++ __Копировать
     public ref class StageGroupViewModel : public ViewModel<EmptyModel^>
F# __Копировать
     type StageGroupViewModel = 
        class
            inherit ViewModel<EmptyModel>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NotificationObject](T_Tessa_Platform_NotificationObject.htm) __[NotificationUIObject](T_Tessa_UI_NotificationUIObject.htm) __[ViewModel](T_Tessa_UI_ViewModel_1.htm)<[EmptyModel](T_Tessa_UI_EmptyModel.htm)> __ StageGroupViewModel
##  __Конструкторы
[StageGroupViewModel](M_Tessa_Extensions_Default_Client_Views_StageSelector_StageGroupViewModel__ctor.htm)|
Инициализирует новый экземпрял класса StageGroupViewModel.  
---|---  
## __Свойства
[ID](P_Tessa_Extensions_Default_Client_Views_StageSelector_StageGroupViewModel_ID.htm)|
...
[Name](P_Tessa_Extensions_Default_Client_Views_StageSelector_StageGroupViewModel_Name.htm)|
Возвращает название группы этапов.  
[Order](P_Tessa_Extensions_Default_Client_Views_StageSelector_StageGroupViewModel_Order.htm)|
