...
C# __Копировать
     public sealed class TemplateRepairExtension : CardRepairExtension
VB __Копировать
     Public NotInheritable Class TemplateRepairExtension
    	Inherits CardRepairExtension
C++ __Копировать
     public ref class TemplateRepairExtension sealed : public CardRepairExtension
F# __Копировать
     [<SealedAttribute>]
    type TemplateRepairExtension = 
        class
            inherit CardRepairExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm) __ TemplateRepairExtension
##  __Конструкторы
[TemplateRepairExtension](M_Tessa_Extensions_Platform_Shared_Cards_TemplateRepairExtension__ctor.htm)|
Инициализирует новый экземпляр класса TemplateRepairExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Shared_Cards_TemplateRepairExtension_AfterRequest.htm)|  
(Переопределяет
