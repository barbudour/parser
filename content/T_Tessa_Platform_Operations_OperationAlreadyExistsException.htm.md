...
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class OperationAlreadyExistsException
    	Inherits ApplicationException
C++ __Копировать
    [SerializableAttribute]
    public ref class OperationAlreadyExistsException sealed : public ApplicationException
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type OperationAlreadyExistsException = 
        class
            inherit ApplicationException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception) __ OperationAlreadyExistsException
##  __Конструкторы
[OperationAlreadyExistsException](M_Tessa_Platform_Operations_OperationAlreadyExistsException__ctor.htm)|
Создаёт экземпляр класса с указанием идентификатора операции, которая уже
существует.  
---|---  
## __Свойства
...
(Унаследован от
[Exception](https://learn.microsoft.com/dotnet/api/system.exception))  
[OperationID](P_Tessa_Platform_Operations_OperationAlreadyExistsException_OperationID.htm)|
Идентификатор операции, которую не удалось создать, потому что она уже
существует. Это не идентификатор уже существующей операции, т.к. операция
может не быть создана из-за коллизии по
[TypeID](P_Tessa_Platform_Operations_OperationAlreadyExistsException_TypeID.htm)
и
[RequestHash](P_Tessa_Platform_Operations_OperationAlreadyExistsException_RequestHash.htm).  
[RequestHash](P_Tessa_Platform_Operations_OperationAlreadyExistsException_RequestHash.htm)|
Хеш от запроса операции, которую не удалось создать. Может быть равен null.  
[RequestHashWasChecked](P_Tessa_Platform_Operations_OperationAlreadyExistsException_RequestHashWasChecked.htm)|
Признак того, что при создании операции проверялось её возможная коллизия по
полям
[TypeID](P_Tessa_Platform_Operations_OperationAlreadyExistsException_TypeID.htm)
и
[RequestHash](P_Tessa_Platform_Operations_OperationAlreadyExistsException_RequestHash.htm).  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Platform_Operations_OperationAlreadyExistsException_GetObjectData.htm)|
