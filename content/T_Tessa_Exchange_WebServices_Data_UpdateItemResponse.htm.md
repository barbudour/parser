...
C++ __Копировать
     public ref class UpdateItemResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ UpdateItemResponse
##  __Свойства
[ConflictCount](P_Tessa_Exchange_WebServices_Data_UpdateItemResponse_ConflictCount.htm)|
Gets the number of property conflicts that were resolved during the update
operation.  
---|---  
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[ReturnedItem](P_Tessa_Exchange_WebServices_Data_UpdateItemResponse_ReturnedItem.htm)|
Gets the item that was returned by the update operation. ReturnedItem is set
only when a recurring Task is marked as complete or when its recurrence
pattern changes.  
## __Методы
