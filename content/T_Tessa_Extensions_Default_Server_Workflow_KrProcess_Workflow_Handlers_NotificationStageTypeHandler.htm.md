# NotificationStageTypeHandler - класс
Обработчик этапа
...
VB __Копировать
     Public Class NotificationStageTypeHandler
    	Inherits StageTypeHandlerBase
C++ __Копировать
     public ref class NotificationStageTypeHandler : public StageTypeHandlerBase
F# __Копировать
     type NotificationStageTypeHandler = 
        class
            inherit StageTypeHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StageTypeHandlerBase](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTypeHandlerBase.htm) __ NotificationStageTypeHandler
##  __Конструкторы
[NotificationStageTypeHandler](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_NotificationStageTypeHandler__ctor.htm)|
Инициалиализирует новый экземпляр класса NotificationStageTypeHandler.  
---|---  
## __Свойства
[CompilationCache](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_NotificationStageTypeHandler_CompilationCache.htm)|
Возвращает кэш содержащий результаты компиляции.  
---|---  
[NotificationManager](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_NotificationStageTypeHandler_NotificationManager.htm)|
Возвращает объект для отправки уведомлений, построенных по карточке
уведомления.  
[Session](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_NotificationStageTypeHandler_Session.htm)|
Возвращает сессию пользователя.  
[UnityContainer](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_NotificationStageTypeHandler_UnityContainer.htm)|
...
(Унаследован от
[StageTypeHandlerBase](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTypeHandlerBase.htm))  
[HandleStageStartAsync](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_NotificationStageTypeHandler_HandleStageStartAsync.htm)|
...
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
##  __Поля
[ModifyEmailMethodDescriptor](F_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_NotificationStageTypeHandler_ModifyEmailMethodDescriptor.htm)|
