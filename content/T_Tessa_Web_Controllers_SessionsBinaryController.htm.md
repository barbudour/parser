# SessionsBinaryController - класс
...
C# __Копировать
    [RouteAttribute("api/b/Sessions")]
    [AllowAnonymousAttribute]
    [ApiExplorerSettingsAttribute(IgnoreApi = true)]
    public sealed class SessionsBinaryController : Controller
VB __Копировать
    <RouteAttribute("api/b/Sessions")>
    <AllowAnonymousAttribute>
    <ApiExplorerSettingsAttribute(IgnoreApi := true)>
    Public NotInheritable Class SessionsBinaryController
    	Inherits Controller
C++ __Копировать
    [RouteAttribute(L"api/b/Sessions")]
    [AllowAnonymousAttribute]
    [ApiExplorerSettingsAttribute(IgnoreApi = true)]
    public ref class SessionsBinaryController sealed : public Controller
F# __Копировать
     [<SealedAttribute>]
    [<RouteAttribute("api/b/Sessions")>]
    [<AllowAnonymousAttribute>]
    [<ApiExplorerSettingsAttribute(IgnoreApi = true)>]
    type SessionsBinaryController = 
        class
            inherit Controller
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase) __[Controller](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controller) __ SessionsBinaryController
##  __Конструкторы
[SessionsBinaryController](M_Tessa_Web_Controllers_SessionsBinaryController__ctor.htm)|
Инициализирует новый экземпляр класса SessionsBinaryController  
---|---  
##  __Свойства
...
(Унаследован от
[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase))  
[PostCloseSession](M_Tessa_Web_Controllers_SessionsBinaryController_PostCloseSession.htm)|
Закрывает текущую сессию, которая определяется по HTTP-заголовку. Возвращает
признак того, что сессия существовала и была закрыта.  
[PostCloseSessionAsAdmin](M_Tessa_Web_Controllers_SessionsBinaryController_PostCloseSessionAsAdmin.htm)|
...
[PostCloseSessionWithToken](M_Tessa_Web_Controllers_SessionsBinaryController_PostCloseSessionWithToken.htm)|
Закрывает сессию с указанием строки с токеном сессии. Токен возвращается
методами открытия сессии в контроллере
[LoginBinaryController](T_Tessa_Web_Controllers_LoginBinaryController.htm).
Методу не требуется наличие информации по сессии в HTTP-заголовке. Возвращает
признак того, что сессия существовала и была закрыта.  
[PostIncrementConfigurationVersion](M_Tessa_Web_Controllers_SessionsBinaryController_PostIncrementConfigurationVersion.htm)|
