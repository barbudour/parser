# UniversalSatelliteImportExtension - класс
...
C# __Копировать
     public sealed class UniversalSatelliteImportExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class UniversalSatelliteImportExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class UniversalSatelliteImportExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type UniversalSatelliteImportExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ UniversalSatelliteImportExtension
##  __Конструкторы
[UniversalSatelliteImportExtension](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteImportExtension__ctor.htm)|
Инициализирует новый экземпляр класса UniversalSatelliteImportExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteImportExtension_BeforeCommitTransaction.htm)|
