# FolderPermissionCollection - класс
...
C++ __Копировать
     public ref class FolderPermissionCollection sealed : public ComplexPropertyCollection<FolderPermission^>
F# __Копировать
     [<SealedAttribute>]
    type FolderPermissionCollection = 
        class
            inherit ComplexPropertyCollection<FolderPermission>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[FolderPermission](T_Tessa_Exchange_WebServices_Data_FolderPermission.htm)> __ FolderPermissionCollection
##  __Свойства
...
(Унаследован от
[ComplexPropertyCollection<TComplexProperty>](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm))  
[UnknownEntries](P_Tessa_Exchange_WebServices_Data_FolderPermissionCollection_UnknownEntries.htm)|
Gets a list of unknown user Ids in the collection.  
## __Методы
[Add](M_Tessa_Exchange_WebServices_Data_FolderPermissionCollection_Add.htm)|
Adds a permission to the collection.  
---|---  
[AddRange](M_Tessa_Exchange_WebServices_Data_FolderPermissionCollection_AddRange.htm)|
Adds the specified permissions to the collection.  
[Clear](M_Tessa_Exchange_WebServices_Data_FolderPermissionCollection_Clear.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Remove](M_Tessa_Exchange_WebServices_Data_FolderPermissionCollection_Remove.htm)|
Removes a permission from the collection.  
[RemoveAt](M_Tessa_Exchange_WebServices_Data_FolderPermissionCollection_RemoveAt.htm)|
Removes a permission from the collection.  
