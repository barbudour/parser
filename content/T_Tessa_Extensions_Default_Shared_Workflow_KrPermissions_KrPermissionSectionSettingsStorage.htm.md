# KrPermissionSectionSettingsStorage - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class KrPermissionSectionSettingsStorage : StorageObject, 
    	IKrPermissionSectionSettings
VB __Копировать
     Public NotInheritable Class KrPermissionSectionSettingsStorage
    	Inherits StorageObject
    	Implements IKrPermissionSectionSettings
C++ __Копировать
     public ref class KrPermissionSectionSettingsStorage sealed : public StorageObject, 
    	IKrPermissionSectionSettings
F# __Копировать
     [<SealedAttribute>]
    type KrPermissionSectionSettingsStorage = 
        class
            inherit StorageObject
            interface IKrPermissionSectionSettings
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ KrPermissionSectionSettingsStorage
Implements
...
Инициализирует новый экземпляр класса KrPermissionSectionSettingsStorage  
---|---  
