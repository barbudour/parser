# DeletedOriginalTileExtension - класс
...
C# __Копировать
     public sealed class DeletedOriginalTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class DeletedOriginalTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class DeletedOriginalTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type DeletedOriginalTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ DeletedOriginalTileExtension
##  __Конструкторы
[DeletedOriginalTileExtension](M_Tessa_Extensions_Platform_Client_Tiles_DeletedOriginalTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса DeletedOriginalTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm))  
[InitializingLocal](M_Tessa_Extensions_Platform_Client_Tiles_DeletedOriginalTileExtension_InitializingLocal.htm)|  
(Переопределяет
