# KrAddCycleFileInfoGetExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Class KrAddCycleFileInfoGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class KrAddCycleFileInfoGetExtension : public CardGetExtension
F# __Копировать
     type KrAddCycleFileInfoGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ KrAddCycleFileInfoGetExtension
##  __Конструкторы
[KrAddCycleFileInfoGetExtension](M_Tessa_Extensions_Default_Server_Cards_KrAddCycleFileInfoGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrAddCycleFileInfoGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Cards_KrAddCycleFileInfoGetExtension_AfterRequest.htm)|  
(Переопределяет
