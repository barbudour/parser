# RuleOperationErrorCollection - класс
...
C++ __Копировать
     public ref class RuleOperationErrorCollection sealed : public ComplexPropertyCollection<RuleOperationError^>
F# __Копировать
     [<SealedAttribute>]
    type RuleOperationErrorCollection = 
        class
            inherit ComplexPropertyCollection<RuleOperationError>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[RuleOperationError](T_Tessa_Exchange_WebServices_Data_RuleOperationError.htm)> __ RuleOperationErrorCollection
##  __Свойства
