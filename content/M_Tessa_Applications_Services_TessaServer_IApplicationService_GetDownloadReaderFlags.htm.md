# IApplicationService.GetDownloadReaderFlags - метод
...
C# __Копировать
     ApplicationDownloadFlags GetDownloadReaderFlags()
VB __Копировать
     Function GetDownloadReaderFlags As ApplicationDownloadFlags
C++ __Копировать
     ApplicationDownloadFlags GetDownloadReaderFlags()
F# __Копировать
