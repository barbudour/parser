...
VB __Копировать
     Public Class PluginFacade
C++ __Копировать
     public ref class PluginFacade
F# __Копировать
     type PluginFacade = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ PluginFacade
##  __Конструкторы
[PluginFacade](M_Chronos_Platform_Scheduling_PluginFacade__ctor.htm)|  Создаёт
экземпляр класса с указанием необязательных параметров.  
---|---  
## __Методы
