# ProcessManagementUIHandler - класс
...
VB __Копировать
     Public NotInheritable Class ProcessManagementUIHandler
    	Inherits StageTypeUIHandlerBase
C++ __Копировать
     public ref class ProcessManagementUIHandler sealed : public StageTypeUIHandlerBase
F# __Копировать
     [<SealedAttribute>]
    type ProcessManagementUIHandler = 
        class
            inherit StageTypeUIHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StageTypeUIHandlerBase](T_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_StageTypeUIHandlerBase.htm) __ ProcessManagementUIHandler
##  __Конструкторы
[ProcessManagementUIHandler](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_ProcessManagementUIHandler__ctor.htm)|
Инициализирует новый экземпляр класса ProcessManagementUIHandler  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Finalize(IKrStageTypeUIHandlerContext)](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_ProcessManagementUIHandler_Finalize.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialize](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_ProcessManagementUIHandler_Initialize.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Validate](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_ProcessManagementUIHandler_Validate.htm)|
Выполняется при валидации строки с параметрами этапа перед сохранением или
закрытием её окна редактирования.  
(Переопределяет
[StageTypeUIHandlerBase.Validate(IKrStageTypeUIHandlerContext)](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_StageTypeUIHandlerBase_Validate.htm))  
##  __Методы расширения
