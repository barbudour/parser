# TestProcessTileExtension - класс
...
C# __Копировать
     public sealed class TestProcessTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class TestProcessTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class TestProcessTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type TestProcessTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ TestProcessTileExtension
##  __Конструкторы
[TestProcessTileExtension](M_Tessa_Extensions_Default_Client_Tiles_TestProcessTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса TestProcessTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_TestProcessTileExtension_InitializingGlobal.htm)|  
(Переопределяет
