# InjectForumCardMetadataExtension - класс
...
VB __Копировать
     Public NotInheritable Class InjectForumCardMetadataExtension
    	Inherits CardTypeMetadataExtension
C++ __Копировать
     public ref class InjectForumCardMetadataExtension sealed : public CardTypeMetadataExtension
F# __Копировать
     [<SealedAttribute>]
    type InjectForumCardMetadataExtension = 
        class
            inherit CardTypeMetadataExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardMetadataExtension](T_Tessa_Cards_Extensions_CardMetadataExtension.htm) __[CardTypeMetadataExtension](T_Tessa_Cards_Extensions_CardTypeMetadataExtension.htm) __ InjectForumCardMetadataExtension
##  __Конструкторы
[InjectForumCardMetadataExtension](M_Tessa_Extensions_Default_Shared_Settings_InjectForumCardMetadataExtension__ctor.htm)|
Инициализирует новый экземпляр класса InjectForumCardMetadataExtension  
---|---  
##  __Свойства
...
[ModifyTypes](M_Tessa_Extensions_Default_Shared_Settings_InjectForumCardMetadataExtension_ModifyTypes.htm)|
