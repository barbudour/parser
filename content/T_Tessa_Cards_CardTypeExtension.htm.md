...
C# __Копировать
    ...
    public sealed class CardTypeExtension : CardSerializableObject, 
    	IEquatable<CardTypeExtension>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardTypeExtension
    	Inherits CardSerializableObject
    	Implements IEquatable(Of CardTypeExtension)
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTypeExtension sealed : public CardSerializableObject, 
    	IEquatable<CardTypeExtension^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardTypeExtension = 
        class
            inherit CardSerializableObject
            interface IEquatable<CardTypeExtension>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __ CardTypeExtension
Implements
    [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)<CardTypeExtension>
##  __Конструкторы
[CardTypeExtension](M_Tessa_Cards_CardTypeExtension__ctor.htm)| Создаёт
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[Type](P_Tessa_Cards_CardTypeExtension_Type.htm)|  Тип расширения или null,
если значение типа не было установлено.  
[XmlElementNameInternal](P_Tessa_Cards_CardTypeExtension_XmlElementNameInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeAttributeFromXml](M_Tessa_Cards_CardTypeExtension_DeserializeAttributeFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeElementFromXml](M_Tessa_Cards_CardTypeExtension_DeserializeElementFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_CardTypeExtension_DeserializeFromBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_CardTypeExtension_DeserializeFromStorageInternal.htm)|
...
[EqualsByExtensionSettings](M_Tessa_Cards_CardTypeExtension_EqualsByExtensionSettings.htm)|
...
[GetHashCode](M_Tessa_Cards_CardTypeExtension_GetHashCode.htm)| Возвращает
хеш-код объекта.  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetValidationName](M_Tessa_Cards_CardTypeExtension_GetValidationName.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_CardTypeExtension_OnDeserializing.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SealInternal](M_Tessa_Cards_CardTypeExtension_SealInternal.htm)|
Защищает объект от изменений.
Метод может быть переопределён в классах-наследниках.
(Переопределяет
[CardSerializableObject.SealInternal()](M_Tessa_Cards_CardSerializableObject_SealInternal.htm))  
[SerializeAttributesToXml](M_Tessa_Cards_CardTypeExtension_SerializeAttributesToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeElementsToXml](M_Tessa_Cards_CardTypeExtension_SerializeElementsToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_CardTypeExtension_SerializeToBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_CardTypeExtension_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
...
(Унаследован от
[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardTypeExtension_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
...
##  __Поля
[XmlElementName](F_Tessa_Cards_CardTypeExtension_XmlElementName.htm)|  Имя
XML-элемента.  
---|---  
## __Методы расширения
...
---|---  
[GetID](M_Tessa_Cards_CardExtensions_GetID_1.htm)|  Получить уникальный
...
(Определяется
[ComHelper](T_Tessa_Extensions_Default_Client_EDS_ComHelper.htm))  
[MakeGlobal](M_Tessa_Cards_CardExtensions_MakeGlobal_9.htm)|  Сделать
