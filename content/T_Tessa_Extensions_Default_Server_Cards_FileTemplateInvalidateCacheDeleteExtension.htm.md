# FileTemplateInvalidateCacheDeleteExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class FileTemplateInvalidateCacheDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class FileTemplateInvalidateCacheDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type FileTemplateInvalidateCacheDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ FileTemplateInvalidateCacheDeleteExtension
##  __Конструкторы
[FileTemplateInvalidateCacheDeleteExtension](M_Tessa_Extensions_Default_Server_Cards_FileTemplateInvalidateCacheDeleteExtension__ctor.htm)|
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Server_Cards_FileTemplateInvalidateCacheDeleteExtension_AfterRequest.htm)|  
(Переопределяет
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Default_Server_Cards_FileTemplateInvalidateCacheDeleteExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
