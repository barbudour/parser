# WorkflowEngineTileManagerExtensionRegistry - класс
...
C# __Копировать
     public sealed class WorkflowEngineTileManagerExtensionRegistry : Registry<Guid, IWorkflowEngineTileManagerExtension>, 
    	IWorkflowEngineTileManagerExtensionRegistry, IRegistry<Guid, IWorkflowEngineTileManagerExtension>
VB __Копировать
     Public NotInheritable Class WorkflowEngineTileManagerExtensionRegistry
    	Inherits Registry(Of Guid, IWorkflowEngineTileManagerExtension)
    	Implements IWorkflowEngineTileManagerExtensionRegistry, IRegistry(Of Guid, IWorkflowEngineTileManagerExtension)
C++ __Копировать
     public ref class WorkflowEngineTileManagerExtensionRegistry sealed : public Registry<Guid, IWorkflowEngineTileManagerExtension^>, 
    	IWorkflowEngineTileManagerExtensionRegistry, IRegistry<Guid, IWorkflowEngineTileManagerExtension^>
F# __Копировать
     [<SealedAttribute>]
    type WorkflowEngineTileManagerExtensionRegistry = 
        class
            inherit Registry<Guid, IWorkflowEngineTileManagerExtension>
            interface IWorkflowEngineTileManagerExtensionRegistry
            interface IRegistry<Guid, IWorkflowEngineTileManagerExtension>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Registry](T_Tessa_Platform_Registry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [IWorkflowEngineTileManagerExtension](T_Tessa_Workflow_IWorkflowEngineTileManagerExtension.htm)> __ WorkflowEngineTileManagerExtensionRegistry
Implements
    [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [IWorkflowEngineTileManagerExtension](T_Tessa_Workflow_IWorkflowEngineTileManagerExtension.htm)>, [IWorkflowEngineTileManagerExtensionRegistry](T_Tessa_Workflow_IWorkflowEngineTileManagerExtensionRegistry.htm)
##  __Конструкторы
[WorkflowEngineTileManagerExtensionRegistry](M_Tessa_Workflow_WorkflowEngineTileManagerExtensionRegistry__ctor.htm)|
