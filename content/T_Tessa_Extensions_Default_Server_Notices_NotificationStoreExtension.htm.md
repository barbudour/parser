# NotificationStoreExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class NotificationStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class NotificationStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type NotificationStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ NotificationStoreExtension
##  __Конструкторы
[NotificationStoreExtension](M_Tessa_Extensions_Default_Server_Notices_NotificationStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса NotificationStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Default_Server_Notices_NotificationStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Default_Server_Notices_NotificationStoreExtension_BeforeRequest.htm)|  
(Переопределяет
