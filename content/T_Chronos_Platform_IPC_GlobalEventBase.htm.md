...
Derived
[Chronos.Platform.IPC.DefaultGlobalEvent](T_Chronos_Platform_IPC_DefaultGlobalEvent.htm)
[Chronos.Platform.IPC.LinuxGlobalEvent](T_Chronos_Platform_IPC_LinuxGlobalEvent.htm)
Implements
    [IGlobalEvent](T_Chronos_Platform_IPC_IGlobalEvent.htm), [IAsyncDisposable](https://learn.microsoft.com/dotnet/api/system.iasyncdisposable)
##  __Конструкторы
[GlobalEventBase](M_Chronos_Platform_IPC_GlobalEventBase__ctor.htm)|
