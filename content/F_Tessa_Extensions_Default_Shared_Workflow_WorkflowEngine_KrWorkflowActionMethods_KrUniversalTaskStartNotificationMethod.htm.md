# KrWorkflowActionMethods.KrUniversalTaskStartNotificationMethod - поле
...
VB __Копировать
     Public Shared ReadOnly KrUniversalTaskStartNotificationMethod As WorkflowActionMethodDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionMethodDescriptor^ KrUniversalTaskStartNotificationMethod
F# __Копировать
     static val KrUniversalTaskStartNotificationMethod: WorkflowActionMethodDescriptor
#### Значение поля
