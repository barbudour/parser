# FixRolesTemplateNewExtension - класс
...
C# __Копировать
     public sealed class FixRolesTemplateNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class FixRolesTemplateNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class FixRolesTemplateNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type FixRolesTemplateNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ FixRolesTemplateNewExtension
##  __Конструкторы
[FixRolesTemplateNewExtension](M_Tessa_Extensions_Platform_Server_Roles_FixRolesTemplateNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса FixRolesTemplateNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_FixRolesTemplateNewExtension_AfterRequest.htm)|  
(Переопределяет
