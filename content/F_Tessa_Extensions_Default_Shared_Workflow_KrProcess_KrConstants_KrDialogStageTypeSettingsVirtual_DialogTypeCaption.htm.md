# KrConstants.KrDialogStageTypeSettingsVirtual.DialogTypeCaption - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly DialogTypeCaption As String
C++ __Копировать
     public:
    static initonly String^ DialogTypeCaption
F# __Копировать
     static val DialogTypeCaption: string
#### Значение поля
