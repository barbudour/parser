# CardGetFileVersionsExtensionContext - класс
Контекст загрузки версий для файла карточки.
## __Definition
 **Пространство имён:** [Tessa.Cards.Extensions](N_Tessa_Cards_Extensions.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class CardGetFileVersionsExtensionContext : CardFileExtensionContext, 
    	ICardGetFileVersionsExtensionContext, ICardFileRequestExtensionContext<CardGetFileVersionsRequest, CardGetFileVersionsResponse>, ICardFileExtensionContext, 
    	ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext, ICardRequestExtensionContext<CardGetFileVersionsRequest, CardGetFileVersionsResponse>
VB __Копировать
     Public NotInheritable Class CardGetFileVersionsExtensionContext
    	Inherits CardFileExtensionContext
    	Implements ICardGetFileVersionsExtensionContext, ICardFileRequestExtensionContext(Of CardGetFileVersionsRequest, CardGetFileVersionsResponse), 
    	ICardFileExtensionContext, ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext, 
    	ICardRequestExtensionContext(Of CardGetFileVersionsRequest, CardGetFileVersionsResponse)
C++ __Копировать
     public ref class CardGetFileVersionsExtensionContext sealed : public CardFileExtensionContext, 
    	ICardGetFileVersionsExtensionContext, ICardFileRequestExtensionContext<CardGetFileVersionsRequest^, CardGetFileVersionsResponse^>, ICardFileExtensionContext, 
    	ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext, ICardRequestExtensionContext<CardGetFileVersionsRequest^, CardGetFileVersionsResponse^>
F# __Копировать
     [<SealedAttribute>]
    type CardGetFileVersionsExtensionContext = 
        class
            inherit CardFileExtensionContext
            interface ICardGetFileVersionsExtensionContext
            interface ICardFileRequestExtensionContext<CardGetFileVersionsRequest, CardGetFileVersionsResponse>
            ...
            interface ICardRequestExtensionContext<CardGetFileVersionsRequest, CardGetFileVersionsResponse>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardExtensionContext](T_Tessa_Cards_Extensions_CardExtensionContext.htm) __[CardFileExtensionContext](T_Tessa_Cards_Extensions_CardFileExtensionContext.htm) __ CardGetFileVersionsExtensionContext
Implements
    [ICardExtensionContext](T_Tessa_Cards_Extensions_ICardExtensionContext.htm), [ICardFileExtensionContext](T_Tessa_Cards_Extensions_ICardFileExtensionContext.htm), [ICardFileRequestExtensionContext](T_Tessa_Cards_Extensions_ICardFileRequestExtensionContext_2.htm)<[CardGetFileVersionsRequest](T_Tessa_Cards_CardGetFileVersionsRequest.htm), [CardGetFileVersionsResponse](T_Tessa_Cards_CardGetFileVersionsResponse.htm)>, [ICardGetFileVersionsExtensionContext](T_Tessa_Cards_Extensions_ICardGetFileVersionsExtensionContext.htm), [ICardRequestExtensionContext](T_Tessa_Cards_Extensions_ICardRequestExtensionContext_2.htm)<[CardGetFileVersionsRequest](T_Tessa_Cards_CardGetFileVersionsRequest.htm), [CardGetFileVersionsResponse](T_Tessa_Cards_CardGetFileVersionsResponse.htm)>, [ICardTypeExtensionContext](T_Tessa_Cards_Extensions_ICardTypeExtensionContext.htm), [IExtensionContext](T_Tessa_Extensions_IExtensionContext.htm), [ITraceableExtensionContext](T_Tessa_Extensions_ITraceableExtensionContext.htm)
##  __Конструкторы
[CardGetFileVersionsExtensionContext](M_Tessa_Cards_Extensions_CardGetFileVersionsExtensionContext__ctor.htm)|
...
(Унаследован от
[CardExtensionContext](T_Tessa_Cards_Extensions_CardExtensionContext.htm))  
[Method](P_Tessa_Cards_Extensions_CardGetFileVersionsExtensionContext_Method.htm)|
Способ загрузки списка версий файла.  
[Request](P_Tessa_Cards_Extensions_CardGetFileVersionsExtensionContext_Request.htm)|
...
(Унаследован от
[CardExtensionContext](T_Tessa_Cards_Extensions_CardExtensionContext.htm))  
[Response](P_Tessa_Cards_Extensions_CardGetFileVersionsExtensionContext_Response.htm)|
