# CardSatelliteDeleteExtension - класс
...
C# __Копировать
     public abstract class CardSatelliteDeleteExtension : CardDeleteExtension
VB __Копировать
     Public MustInherit Class CardSatelliteDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class CardSatelliteDeleteExtension abstract : public CardDeleteExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type CardSatelliteDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ CardSatelliteDeleteExtension
##  __Конструкторы
[CardSatelliteDeleteExtension](M_Tessa_Cards_Extensions_Templates_CardSatelliteDeleteExtension__ctor.htm)|
...
##  __Методы
[AfterBeginTransaction](M_Tessa_Cards_Extensions_Templates_CardSatelliteDeleteExtension_AfterBeginTransaction.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsMainCardTypeAsync](M_Tessa_Cards_Extensions_Templates_CardSatelliteDeleteExtension_IsMainCardTypeAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[SatelliteCardWasNotFoundAsync](M_Tessa_Cards_Extensions_Templates_CardSatelliteDeleteExtension_SatelliteCardWasNotFoundAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetSatelliteCardAsync](M_Tessa_Cards_Extensions_Templates_CardSatelliteDeleteExtension_TryGetSatelliteCardAsync.htm)|
...
[TryGetSatelliteIDAsync](M_Tessa_Cards_Extensions_Templates_CardSatelliteDeleteExtension_TryGetSatelliteIDAsync.htm)|
