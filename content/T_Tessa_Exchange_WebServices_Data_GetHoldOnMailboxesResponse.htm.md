# GetHoldOnMailboxesResponse - класс
...
VB __Копировать
     Public NotInheritable Class GetHoldOnMailboxesResponse
    	Inherits ServiceResponse
C++ __Копировать
     public ref class GetHoldOnMailboxesResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ GetHoldOnMailboxesResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[HoldResult](P_Tessa_Exchange_WebServices_Data_GetHoldOnMailboxesResponse_HoldResult.htm)|
Mailbox hold result  
