# KrProcessSharedExtensions.GetActiveTasksSection - метод
...
C# __Копировать
     public static CardSection GetActiveTasksSection(
    	this Card card
    )
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function GetActiveTasksSection ( 
    	card As Card
    ) As CardSection
C++ __Копировать
     public:
    [ExtensionAttribute]
    static CardSection^ GetActiveTasksSection(
    	Card^ card
    )
F# __Копировать
     [<ExtensionAttribute>]
    static member GetActiveTasksSection : 
