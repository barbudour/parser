...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WorkflowActionBase](T_Tessa_Workflow_Actions_WorkflowActionBase.htm) __[KrWorkflowActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowActionBase.htm) __[KrWorkflowTaskActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowTaskActionBase.htm) __ KrUniversalTaskAction
##  __Конструкторы
[KrUniversalTaskAction](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrUniversalTaskAction__ctor.htm)|
Инициализирует новый экземпляр класса KrUniversalTaskAction.  
---|---  
## __Свойства
...
[CheckActive](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrUniversalTaskAction_CheckActive.htm)|
...
[Compile](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrUniversalTaskAction_Compile.htm)|
...
(Унаследован от
[KrWorkflowTaskActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowTaskActionBase.htm))  
[CompleteTaskCoreAsync](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrUniversalTaskAction_CompleteTaskCoreAsync.htm)|  
(Переопределяет
...
[ExecuteAsync](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrUniversalTaskAction_ExecuteAsync.htm)|
...
4.3. Если по окончанию обработки задания оно все еще есть, ставим KeepAlive =
true.  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetResultAsync](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrUniversalTaskAction_GetResultAsync.htm)|  
(Переопределяет
...
(Унаследован от
[KrWorkflowTaskActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowTaskActionBase.htm))  
[PrepareForExecute](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrUniversalTaskAction_PrepareForExecute.htm)|
...
(Унаследован от
[KrWorkflowTaskActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowTaskActionBase.htm))  
[Validate](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrUniversalTaskAction_Validate.htm)|
