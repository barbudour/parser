# CardPermissionsNewExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class CardPermissionsNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class CardPermissionsNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class CardPermissionsNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type CardPermissionsNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ CardPermissionsNewExtension
##  __Конструкторы
[CardPermissionsNewExtension](M_Tessa_Extensions_Default_Server_Cards_CardPermissionsNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса CardPermissionsNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Cards_CardPermissionsNewExtension_AfterRequest.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Default_Server_Cards_CardPermissionsNewExtension_BeforeRequest.htm)|  
(Переопределяет
