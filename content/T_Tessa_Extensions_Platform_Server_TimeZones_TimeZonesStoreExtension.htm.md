# TimeZonesStoreExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.TimeZones](N_Tessa_Extensions_Platform_Server_TimeZones.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class TimeZonesStoreExtension : CardStoreExtension
VB __Копировать
     Public Class TimeZonesStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class TimeZonesStoreExtension : public CardStoreExtension
F# __Копировать
     type TimeZonesStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ TimeZonesStoreExtension
##  __Конструкторы
[TimeZonesStoreExtension](M_Tessa_Extensions_Platform_Server_TimeZones_TimeZonesStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса TimeZonesStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_TimeZones_TimeZonesStoreExtension_AfterBeginTransaction.htm)|  
(Переопределяет
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_TimeZones_TimeZonesStoreExtension_BeforeRequest.htm)|  
(Переопределяет
