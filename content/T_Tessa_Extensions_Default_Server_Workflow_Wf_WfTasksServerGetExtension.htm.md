# WfTasksServerGetExtension - класс
...
C# __Копировать
     public sealed class WfTasksServerGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class WfTasksServerGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class WfTasksServerGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type WfTasksServerGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ WfTasksServerGetExtension
##  __Конструкторы
[WfTasksServerGetExtension](M_Tessa_Extensions_Default_Server_Workflow_Wf_WfTasksServerGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса WfTasksServerGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_Wf_WfTasksServerGetExtension_AfterRequest.htm)|  
(Переопределяет
