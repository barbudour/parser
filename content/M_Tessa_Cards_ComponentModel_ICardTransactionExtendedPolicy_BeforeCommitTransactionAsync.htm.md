# ICardTransactionExtendedPolicy.BeforeCommitTransactionAsync - метод
...
C# __Копировать
     Task<bool> BeforeCommitTransactionAsync(
    	IValidationResultBuilder validationResult,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Function BeforeCommitTransactionAsync ( 
...
F# __Копировать
     abstract BeforeCommitTransactionAsync : 
