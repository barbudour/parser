# CardServiceClient.GetFileVersionsAsync - метод
...
#### Реализации
[ICardService.GetFileVersionsAsync(CardGetFileVersionsRequest,
CancellationToken)](M_Tessa_Cards_ICardService_GetFileVersionsAsync.htm)  
##  __См. также
#### Ссылки
