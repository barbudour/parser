# MenuActionCollection - класс
Коллекция действий [IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm).
## __Definition
 **Пространство имён:** [Tessa.UI.Menu](N_Tessa_UI_Menu.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class MenuActionCollection : UINamedObservableCollection<IMenuAction, IMenuActionCollection>, 
    	IMenuActionCollection, INamedObservableCollection<IMenuAction, IMenuActionCollection>, IObservableCollection<IMenuAction, IMenuActionCollection>, 
    	IList<IMenuAction>, ICollection<IMenuAction>, IEnumerable<IMenuAction>, 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
VB __Копировать
     Public NotInheritable Class MenuActionCollection
    	Inherits UINamedObservableCollection(Of IMenuAction, IMenuActionCollection)
    	Implements IMenuActionCollection, INamedObservableCollection(Of IMenuAction, IMenuActionCollection), 
    	IObservableCollection(Of IMenuAction, IMenuActionCollection), IList(Of IMenuAction), 
    	ICollection(Of IMenuAction), IEnumerable(Of IMenuAction), IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
C++ __Копировать
     public ref class MenuActionCollection sealed : public UINamedObservableCollection<IMenuAction^, IMenuActionCollection^>, 
    	IMenuActionCollection, INamedObservableCollection<IMenuAction^, IMenuActionCollection^>, IObservableCollection<IMenuAction^, IMenuActionCollection^>, 
    	IList<IMenuAction^>, ICollection<IMenuAction^>, IEnumerable<IMenuAction^>, 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
F# __Копировать
     [<SealedAttribute>]
    type MenuActionCollection = 
        class
            inherit UINamedObservableCollection<IMenuAction, IMenuActionCollection>
            interface IMenuActionCollection
            interface INamedObservableCollection<IMenuAction, IMenuActionCollection>
            interface IObservableCollection<IMenuAction, IMenuActionCollection>
            interface IList<IMenuAction>
            interface ICollection<IMenuAction>
            interface IEnumerable<IMenuAction>
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)> __[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)> __[SuspendableObservableCollection](T_Tessa_Platform_Collections_SuspendableObservableCollection_1.htm)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)> __[ObservableCollection](T_Tessa_Platform_Collections_ObservableCollection_2.htm)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm), [IMenuActionCollection](T_Tessa_UI_Menu_IMenuActionCollection.htm)> __[NamedObservableCollection](T_Tessa_Platform_Collections_NamedObservableCollection_2.htm)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm), [IMenuActionCollection](T_Tessa_UI_Menu_IMenuActionCollection.htm)> __[UINamedObservableCollection](T_Tessa_UI_UINamedObservableCollection_2.htm)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm), [IMenuActionCollection](T_Tessa_UI_Menu_IMenuActionCollection.htm)> __ MenuActionCollection
Implements
    [ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)>, [IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.ienumerable), [INotifyCollectionChanged](https://learn.microsoft.com/dotnet/api/system.collections.specialized.inotifycollectionchanged), [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged), [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable), [INamedObservableCollection](T_Tessa_Platform_Collections_INamedObservableCollection_2.htm)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm), [IMenuActionCollection](T_Tessa_UI_Menu_IMenuActionCollection.htm)>, [IObservableCollection](T_Tessa_Platform_Collections_IObservableCollection_2.htm)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm), [IMenuActionCollection](T_Tessa_UI_Menu_IMenuActionCollection.htm)>, [IMenuActionCollection](T_Tessa_UI_Menu_IMenuActionCollection.htm)
##  __Конструкторы
[MenuActionCollection()](M_Tessa_UI_Menu_MenuActionCollection__ctor.htm)|
Создаёт экземпляр коллекции с параметрами по умолчанию.  
---|---  
[MenuActionCollection(IEnumerable<IMenuAction>)](M_Tessa_UI_Menu_MenuActionCollection__ctor_1.htm)|
...
[MenuActionCollection(List<IMenuAction>)](M_Tessa_UI_Menu_MenuActionCollection__ctor_2.htm)|
...
(Унаследован от
[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)>)  
...
(Унаследован от [NamedObservableCollection<TItem,
...
(Унаследован от
[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)>)  
...
(Унаследован от
[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)>)  
[Clone](M_Tessa_UI_Menu_MenuActionCollection_Clone.htm)|  Выполняет глубокое
...
(Унаследован от
[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)>)  
[Contains(String)](M_Tessa_Platform_Collections_NamedObservableCollection_2_Contains.htm)|
...
(Унаследован от [ObservableCollection<TItem,
TCollection>](T_Tessa_Platform_Collections_ObservableCollection_2.htm))  
[OnPropertyChangedAsync(PropertyChangedEventArgs)](M_Tessa_UI_UINamedObservableCollection_2_OnPropertyChangedAsync.htm)|
...
(Унаследован от [UINamedObservableCollection<TItem,
...
[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)>)  
##  __Методы расширения
[AddRange<IMenuAction>](M_Tessa_Platform_Collections_Extensions_AddRange__1.htm)|
Добавляет значения items в коллекцию collection.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
---|---  
[AddRange<IMenuAction>](M_Tessa_Platform_Collections_Extensions_AddRange__1_1.htm)|
Добавляет значения items в коллекцию collection.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[AsArray<IMenuAction>](M_Tessa_Platform_Collections_EnumerableExtensions_AsArray__1.htm)|
...
[ConvertToListDictionaries<IMenuAction>](M_Tessa_Views_Mapping_DictionaryConverter_ConvertToListDictionaries__1.htm)|
...
[ConvertToListDictionaries<IMenuAction>](M_Tessa_Views_Mapping_DictionaryConverter_ConvertToListDictionaries__1_1.htm)|
Осуществляет сопоставлению коллекции source на коллекцию коллекций ключ-
значение в соответствии с контекстом сопоставления context  
(Определяется
[DictionaryConverter](T_Tessa_Views_Mapping_DictionaryConverter.htm))  
[ForEach<IMenuAction>](M_Tessa_Platform_Collections_EnumerableExtensions_ForEach__1.htm)|
Выполняет указанное действие с каждым элементом коллекции
[IEnumerable<T>](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1).  
(Определяется
[EnumerableExtensions](T_Tessa_Platform_Collections_EnumerableExtensions.htm))  
[FullOuterJoin<IMenuAction, TInner, TKey,
TResult>](M_Tessa_Platform_Collections_Extensions_FullOuterJoin__4.htm)|  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[IndexOf<IMenuAction>](M_Tessa_Platform_Collections_Extensions_IndexOf__1.htm)|
Возвращает индекс первого вхождения элемента в последовательность,
определяемый посредством заданного выражения.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[IndexOf<IMenuAction>](M_Tessa_Platform_Collections_Extensions_IndexOf__1_1.htm)|
Возвращает индекс первого вхождения элемента в последовательность,
...
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[IndexOf<IMenuAction>](M_Tessa_Platform_Collections_Extensions_IndexOf__1_2.htm)|
...
элементом.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[IndexOf<IMenuAction>](M_Tessa_Platform_Collections_Extensions_IndexOf__1_3.htm)|
Выполняет поиск элемента, удовлетворяющего условиям указанного предиката, и
возвращает отсчитываемый от нуля индекс первого вхождения в диапазоне
элементов списка, начинающемся с заданного индекса и содержащем указанное
число элементов.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[InsertRange<IMenuAction>](M_Tessa_Platform_Collections_Extensions_InsertRange__1.htm)|
Вставляет диапазон элементов в заданный список items, начиная с указанного
индекса index.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[OrderByDependencies<IMenuAction>](M_Tessa_Platform_Collections_Extensions_OrderByDependencies__1.htm)|  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[OrderByDependencies<IMenuAction>](M_Tessa_Platform_Collections_Extensions_OrderByDependencies__1_1.htm)|  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[OrderByDependencies<IMenuAction,
...
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[OrderByLocalized<IMenuAction>](M_Tessa_Platform_PlatformExtensions_OrderByLocalized__1.htm)|
Сортирует значения последовательности по возрастанию по локализованному ключу,
который определяется для каждого элемента.  
(Определяется [PlatformExtensions](T_Tessa_Platform_PlatformExtensions.htm))  
[OrderByLocalizedDescending<IMenuAction>](M_Tessa_Platform_PlatformExtensions_OrderByLocalizedDescending__1.htm)|
Сортирует значения последовательности по убыванию по локализованному ключу,
который определяется для каждого элемента.  
(Определяется [PlatformExtensions](T_Tessa_Platform_PlatformExtensions.htm))  
[RemoveAll<IMenuAction>](M_Tessa_Platform_Collections_Extensions_RemoveAll__1.htm)|
Удаляет все элементы, совпадающие по заданному предикату. Возвращает
количество удалённых элементов.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[RemoveRange<IMenuAction>](M_Tessa_Platform_Collections_Extensions_RemoveRange__1.htm)|
Удаляет значения items из коллекции collection.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[RemoveRange<IMenuAction>](M_Tessa_Platform_Collections_Extensions_RemoveRange__1_1.htm)|
Удаляет значения items из коллекции collection.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[RunWithMaxDegreeOfParallelismAsync<IMenuAction>](M_Tessa_Platform_PlatformExtensions_RunWithMaxDegreeOfParallelismAsync__1.htm)|
Выполняет асинхронную обработку элементов с ограничением на максимальное
количество параллельных задач.  
(Определяется [PlatformExtensions](T_Tessa_Platform_PlatformExtensions.htm))  
[ToDictionaryAsync<IMenuAction, TKey,
...
(Определяется [PlatformExtensions](T_Tessa_Platform_PlatformExtensions.htm))  
[ToObservableCollection<IMenuAction>](M_Tessa_Platform_Collections_Extensions_ToObservableCollection__1.htm)|
Преобразует коллекцию IEnumerable в ObservableCollection  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[ToSealableList<IMenuAction>](M_Tessa_Platform_Collections_Extensions_ToSealableList__1.htm)|
...
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[TryFirst<IMenuAction>](M_Tessa_Platform_Collections_EnumerableExtensions_TryFirst__1.htm)|
Возвращает первый элемент последовательности, удовлетворяющий условию.  
(Определяется
[EnumerableExtensions](T_Tessa_Platform_Collections_EnumerableExtensions.htm))  
[TrySingleOrDefault<IMenuAction>](M_Tessa_Platform_Collections_EnumerableExtensions_TrySingleOrDefault__1.htm)|
