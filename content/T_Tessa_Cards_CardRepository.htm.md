...
VB __Копировать
     Public NotInheritable Class CardRepository
    	Implements ICardRepository
C++ __Копировать
     public ref class CardRepository sealed : ICardRepository
F# __Копировать
     [<SealedAttribute>]
    type CardRepository = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardRepository
Implements
    [ICardRepository](T_Tessa_Cards_ICardRepository.htm)
##  __Конструкторы
[CardRepository](M_Tessa_Cards_CardRepository__ctor.htm)|  Создаёт экземпляр
репозитория с указанием метаинформации по типам карточек, объекта сессии
текущего пользователя и используемых компонентов.  
---|---  
## __Методы
