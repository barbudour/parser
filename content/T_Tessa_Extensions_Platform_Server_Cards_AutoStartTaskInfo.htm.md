...
C# __Копировать
     public sealed class AutoStartTaskInfo
VB __Копировать
     Public NotInheritable Class AutoStartTaskInfo
C++ __Копировать
     public ref class AutoStartTaskInfo sealed
F# __Копировать
     [<SealedAttribute>]
    type AutoStartTaskInfo = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ AutoStartTaskInfo
##  __Конструкторы
[AutoStartTaskInfo](M_Tessa_Extensions_Platform_Server_Cards_AutoStartTaskInfo__ctor.htm)|
Инициализирует новый экземпляр класса AutoStartTaskInfo  
---|---  
##  __Свойства
