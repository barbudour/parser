# CardTransactionExtendedStrategy - класс
...
VB __Копировать
     Public NotInheritable Class CardTransactionExtendedStrategy
    	Implements ICardTransactionStrategy, ITransactionStrategy
C++ __Копировать
     public ref class CardTransactionExtendedStrategy sealed : ICardTransactionStrategy, 
    	ITransactionStrategy
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardTransactionExtendedStrategy
Implements
...
##  __Конструкторы
[CardTransactionExtendedStrategy](M_Tessa_Cards_ComponentModel_CardTransactionExtendedStrategy__ctor.htm)|
...
---|---  
[ExecuteInReaderLockAsync](M_Tessa_Cards_ComponentModel_CardTransactionExtendedStrategy_ExecuteInReaderLockAsync.htm)|
Выполняет запрос на чтение карточки внутри блокировки reader/writer.  
[ExecuteInTransactionAsync](M_Tessa_Cards_ComponentModel_CardTransactionExtendedStrategy_ExecuteInTransactionAsync.htm)|
...
транзакция.  
[ExecuteInWriterLockAsync](M_Tessa_Cards_ComponentModel_CardTransactionExtendedStrategy_ExecuteInWriterLockAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ReleaseWriterLockAsync](M_Tessa_Cards_ComponentModel_CardTransactionExtendedStrategy_ReleaseWriterLockAsync.htm)|
