# CompletionOptionStoreExtension - класс
...
C# __Копировать
     public sealed class CompletionOptionStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class CompletionOptionStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class CompletionOptionStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type CompletionOptionStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ CompletionOptionStoreExtension
##  __Конструкторы
[CompletionOptionStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_CompletionOptionStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса CompletionOptionStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_CompletionOptionStoreExtension_BeforeRequest.htm)|  
(Переопределяет
