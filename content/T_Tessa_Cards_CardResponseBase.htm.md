# CardResponseBase - класс
Базовый класс для ответа на запрос к сервису карточек. Содержит объект,
осуществляющий валидацию результата запроса.
## __Definition
 **Пространство имён:** [Tessa.Cards](N_Tessa_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public abstract class CardResponseBase : CardInfoStorageObject
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class CardResponseBase
    	Inherits CardInfoStorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class CardResponseBase abstract : public CardInfoStorageObject
F# __Копировать
     [<AbstractClassAttribute>]
    [<SerializableAttribute>]
    type CardResponseBase = 
        class
            inherit CardInfoStorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm) __ CardResponseBase
Derived
[Tessa.Cards.CardDeleteResponse](T_Tessa_Cards_CardDeleteResponse.htm)
[Tessa.Cards.CardGetFileContentResponse](T_Tessa_Cards_CardGetFileContentResponse.htm)
[Tessa.Cards.CardGetFileVersionsResponse](T_Tessa_Cards_CardGetFileVersionsResponse.htm)
[Tessa.Cards.CardResponse](T_Tessa_Cards_CardResponse.htm)
[Tessa.Cards.CardStoreResponse](T_Tessa_Cards_CardStoreResponse.htm)
[Tessa.Cards.CardValueResponseBase](T_Tessa_Cards_CardValueResponseBase.htm)
[Tessa.Web.Client.Models.CardRepairResponse](T_Tessa_Web_Client_Models_CardRepairResponse.htm)
Подробнее __Less __
##  __Конструкторы
...
##  __Поля
[ValidationResultKey](F_Tessa_Cards_CardResponseBase_ValidationResultKey.htm)|  
---|---  
## __Методы расширения
...
CardResponseBase флаг показывающий требуется ли оставить открытым окно диалога
или нет.  
(Определяется
[CardRequestExtensions](T_Tessa_Cards_CardRequestExtensions.htm))  
