# ApplicationServiceClient - класс
...
C# __Копировать
     public sealed class ApplicationServiceClient : IApplicationService
VB __Копировать
     Public NotInheritable Class ApplicationServiceClient
    	Implements IApplicationService
C++ __Копировать
     public ref class ApplicationServiceClient sealed : IApplicationService
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ApplicationServiceClient
Implements
    [IApplicationService](T_Tessa_Applications_Services_TessaServer_IApplicationService.htm)
##  __Конструкторы
[ApplicationServiceClient](M_Tessa_Applications_Services_TessaServer_ApplicationServiceClient__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Методы
[DownloadAsync](M_Tessa_Applications_Services_TessaServer_ApplicationServiceClient_DownloadAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetApplicationsAsync](M_Tessa_Applications_Services_TessaServer_ApplicationServiceClient_GetApplicationsAsync.htm)|
Возвращает список всех приложений, доступных пользователю.  
[GetDownloadReaderFlags](M_Tessa_Applications_Services_TessaServer_ApplicationServiceClient_GetDownloadReaderFlags.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetApplicationIdAsync](M_Tessa_Applications_Services_TessaServer_ApplicationServiceClient_TryGetApplicationIdAsync.htm)|
Осуществляет попытку получения идентификатора приложения по его алиасу.  
[TryGetFaultedResultAsync](M_Tessa_Applications_Services_TessaServer_ApplicationServiceClient_TryGetFaultedResultAsync.htm)|
...
[TryGetModifiedAsync](M_Tessa_Applications_Services_TessaServer_ApplicationServiceClient_TryGetModifiedAsync.htm)|
