# TemplateEditCardRequestExtension - класс
...
C# __Копировать
     public sealed class TemplateEditCardRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class TemplateEditCardRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class TemplateEditCardRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type TemplateEditCardRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ TemplateEditCardRequestExtension
##  __Конструкторы
[TemplateEditCardRequestExtension](M_Tessa_Extensions_Platform_Server_Cards_TemplateEditCardRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса TemplateEditCardRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_TemplateEditCardRequestExtension_AfterRequest.htm)|  
(Переопределяет
