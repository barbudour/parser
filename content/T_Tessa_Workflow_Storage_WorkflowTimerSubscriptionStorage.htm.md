# WorkflowTimerSubscriptionStorage - класс
##  __Definition
 **Пространство имён:** [Tessa.Workflow.Storage](N_Tessa_Workflow_Storage.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class WorkflowTimerSubscriptionStorage : WorkflowSubscriptionStorageBase
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowTimerSubscriptionStorage
    	Inherits WorkflowSubscriptionStorageBase
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowTimerSubscriptionStorage sealed : public WorkflowSubscriptionStorageBase
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowTimerSubscriptionStorage = 
        class
            inherit WorkflowSubscriptionStorageBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __[WorkflowSubscriptionStorageBase](T_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase.htm) __ WorkflowTimerSubscriptionStorage
##  __Конструкторы
[WorkflowTimerSubscriptionStorage()](M_Tessa_Workflow_Storage_WorkflowTimerSubscriptionStorage__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowTimerSubscriptionStorage  
---|---  
[WorkflowTimerSubscriptionStorage(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowTimerSubscriptionStorage__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowTimerSubscriptionStorage  
[WorkflowTimerSubscriptionStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowTimerSubscriptionStorage__ctor_3.htm)|
Инициализирует новый экземпляр класса WorkflowTimerSubscriptionStorage  
[WorkflowTimerSubscriptionStorage(Guid, Guid, Nullable<Int32>, String,
Nullable<DateTime>, Boolean,
Boolean)](M_Tessa_Workflow_Storage_WorkflowTimerSubscriptionStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowTimerSubscriptionStorage  
##  __Свойства
[Cron](P_Tessa_Workflow_Storage_WorkflowTimerSubscriptionStorage_Cron.htm)|  
---|---  
[Date](P_Tessa_Workflow_Storage_WorkflowTimerSubscriptionStorage_Date.htm)|  
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[LockProcess](P_Tessa_Workflow_Storage_WorkflowTimerSubscriptionStorage_LockProcess.htm)|  
[NodeID](P_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase_NodeID.htm)|
ID узла  
(Унаследован от
[WorkflowSubscriptionStorageBase](T_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase.htm))  
[Period](P_Tessa_Workflow_Storage_WorkflowTimerSubscriptionStorage_Period.htm)|  
[ProcessID](P_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase_ProcessID.htm)|
ID процесса  
(Унаследован от
[WorkflowSubscriptionStorageBase](T_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase.htm))  
[RunOnce](P_Tessa_Workflow_Storage_WorkflowTimerSubscriptionStorage_RunOnce.htm)|  
## __Методы
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[Clone](M_Tessa_Workflow_Storage_WorkflowTimerSubscriptionStorage_Clone.htm)|  
(Переопределяет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[UpdateData](M_Tessa_Workflow_Storage_WorkflowStorageBase_UpdateData.htm)|  
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
##  __События
