# CardTemplateGetExtension - класс
...
C# __Копировать
     public sealed class CardTemplateGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class CardTemplateGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class CardTemplateGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type CardTemplateGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ CardTemplateGetExtension
##  __Конструкторы
[CardTemplateGetExtension](M_Tessa_Extensions_Platform_Client_Cards_CardTemplateGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса CardTemplateGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Client_Cards_CardTemplateGetExtension_AfterRequest.htm)|  
(Переопределяет
