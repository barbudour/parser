...
VB __Копировать
     Public NotInheritable Class CardsWebProxy
    	Inherits WebProxy
C++ __Копировать
     public ref class CardsWebProxy sealed : public WebProxy
F# __Копировать
     [<SealedAttribute>]
    type CardsWebProxy = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm) __ CardsWebProxy
##  __Конструкторы
[CardsWebProxy](M_Tessa_Cards_CardsWebProxy__ctor.htm)| Создаёт экземпляр
...
изменений.  
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[DeleteAsync](M_Tessa_Cards_CardsWebProxy_DeleteAsync.htm)| Удаляет карточку
по информации, переданной в запросе.  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetAsync](M_Tessa_Cards_CardsWebProxy_GetAsync.htm)| Возвращает данные
карточки по заданному запросу.  
[GetFileContentAsync](M_Tessa_Cards_CardsWebProxy_GetFileContentAsync.htm)|
Получает контент версии файла.  
[GetFileVersionsAsync](M_Tessa_Cards_CardsWebProxy_GetFileVersionsAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[NewAsync](M_Tessa_Cards_CardsWebProxy_NewAsync.htm)| Возвращает заполненную
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[RequestAsync](M_Tessa_Cards_CardsWebProxy_RequestAsync.htm)| Выполняет
