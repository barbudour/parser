...
(Переопределяет
[TypeConverter.GetStandardValuesSupported(ITypeDescriptorContext)](https://learn.microsoft.com/dotnet/api/system.componentmodel.typeconverter.getstandardvaluessupported#system-
