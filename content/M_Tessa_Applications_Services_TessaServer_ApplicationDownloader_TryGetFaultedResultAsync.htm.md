# ApplicationDownloader.TryGetFaultedResultAsync - метод
...
#### Реализации
[IApplicationDownloader.TryGetFaultedResultAsync(Guid,
CancellationToken)](M_Tessa_Applications_Services_TessaServer_IApplicationDownloader_TryGetFaultedResultAsync.htm)  
##  __См. также
#### Ссылки
