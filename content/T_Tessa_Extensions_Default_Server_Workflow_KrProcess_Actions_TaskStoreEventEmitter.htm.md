...
VB __Копировать
     Public NotInheritable Class TaskStoreEventEmitter
    	Inherits CardStoreTaskExtension
C++ __Копировать
     public ref class TaskStoreEventEmitter sealed : public CardStoreTaskExtension
F# __Копировать
     [<SealedAttribute>]
    type TaskStoreEventEmitter = 
        class
            inherit CardStoreTaskExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreTaskExtension](T_Tessa_Cards_Extensions_CardStoreTaskExtension.htm) __ TaskStoreEventEmitter
##  __Конструкторы
[TaskStoreEventEmitter](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Actions_TaskStoreEventEmitter__ctor.htm)|
Инициализирует новый экземпляр класса TaskStoreEventEmitter.  
---|---  
## __Методы
...
(Унаследован от
[CardStoreTaskExtension](T_Tessa_Cards_Extensions_CardStoreTaskExtension.htm))  
[StoreTaskBeforeCommitTransaction](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Actions_TaskStoreEventEmitter_StoreTaskBeforeCommitTransaction.htm)|
...
[StoreTaskBeforeRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Actions_TaskStoreEventEmitter_StoreTaskBeforeRequest.htm)|
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Server.Workflow.KrProcess.Actions - пространство
имён](N_Tessa_Extensions_Default_Server_Workflow_KrProcess_Actions.htm)
