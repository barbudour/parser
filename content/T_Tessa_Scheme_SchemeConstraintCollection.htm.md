...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[SchemeObjectCollection](T_Tessa_Scheme_SchemeObjectCollection_1.htm)<[SchemeConstraint](T_Tessa_Scheme_SchemeConstraint.htm)> __[SchemeNamedObjectCollection](T_Tessa_Scheme_SchemeNamedObjectCollection_1.htm)<[SchemeConstraint](T_Tessa_Scheme_SchemeConstraint.htm)> __ SchemeConstraintCollection
##  __Свойства
...
(Унаследован от
[SchemeObjectCollection<T>](T_Tessa_Scheme_SchemeObjectCollection_1.htm))  
[PrimaryKey](P_Tessa_Scheme_SchemeConstraintCollection_PrimaryKey.htm)|  
## __Методы
...
(Унаследован от
[SchemeObjectCollection<T>](T_Tessa_Scheme_SchemeObjectCollection_1.htm))  
[ClearItems](M_Tessa_Scheme_SchemeConstraintCollection_ClearItems.htm)|  
(Переопределяет
[SchemeObjectCollection<T>.ClearItems()](M_Tessa_Scheme_SchemeObjectCollection_1_ClearItems.htm))  
[Construct](M_Tessa_Scheme_SchemeConstraintCollection_Construct.htm)|  
(Переопределяет
...
(Унаследован от
[SchemeObjectCollection<T>](T_Tessa_Scheme_SchemeObjectCollection_1.htm))  
[InsertItem](M_Tessa_Scheme_SchemeConstraintCollection_InsertItem.htm)|  
...
(Унаследован от
[SchemeObjectCollection<T>](T_Tessa_Scheme_SchemeObjectCollection_1.htm))  
[RemoveItem](M_Tessa_Scheme_SchemeConstraintCollection_RemoveItem.htm)|  
(Переопределяет [SchemeObjectCollection<T>.RemoveItem(T,
Boolean)](M_Tessa_Scheme_SchemeObjectCollection_1_RemoveItem.htm))  
[ReplaceItem](M_Tessa_Scheme_SchemeConstraintCollection_ReplaceItem.htm)|  
...
(Унаследован от
[SchemeNamedObjectCollection<T>](T_Tessa_Scheme_SchemeNamedObjectCollection_1.htm))  
[ValidateInsertingItem](M_Tessa_Scheme_SchemeConstraintCollection_ValidateInsertingItem.htm)|  
