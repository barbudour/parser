...
VB __Копировать
     Public NotInheritable Class KrSourceGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class KrSourceGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrSourceGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ KrSourceGetExtension
##  __Конструкторы
[KrSourceGetExtension](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrSourceGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrSourceGetExtension.  
---|---  
## __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrSourceGetExtension_AfterRequest.htm)|
