# NumberStorageTypeDescriptor - класс
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[Type](P_Tessa_Cards_Numbers_NumberStorageTypeDescriptor_Type.htm)|  Тип
номера.  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_Numbers_NumberStorageTypeDescriptor_Clone.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[IsEmpty](M_Tessa_Cards_Numbers_NumberStorageTypeDescriptor_IsEmpty.htm)|
...
восстановить в методе FromTypedJson.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[ToNumberTypeDescriptor](M_Tessa_Cards_Numbers_NumberStorageTypeDescriptor_ToNumberTypeDescriptor.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_Numbers_NumberStorageTypeDescriptor_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
[CardInfoStorageObject.ValidateInternal(IValidationResultBuilder)](M_Tessa_Cards_CardInfoStorageObject_ValidateInternal.htm))  
##  __Поля
[TypeIDKey](F_Tessa_Cards_Numbers_NumberStorageTypeDescriptor_TypeIDKey.htm)|  
---|---  
[TypeNameKey](F_Tessa_Cards_Numbers_NumberStorageTypeDescriptor_TypeNameKey.htm)|  
## __Методы расширения
