...
C# __Копировать
    ...
    public class ItemModel : StorageObject
VB __Копировать
    <SerializableAttribute>
...
C++ __Копировать
    [SerializableAttribute]
    public ref class ItemModel : public StorageObject
F# __Копировать
     [<SerializableAttribute>]
    type ItemModel = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ItemModel
##  __Конструкторы
[ItemModel(Dictionary<String,
Object>)](M_Tessa_Forums_Models_ItemModel__ctor.htm)| Инициализирует новый
экземпляр класса ItemModel  
---|---  
[ItemModel(SerializationInfo,
StreamingContext)](M_Tessa_Forums_Models_ItemModel__ctor_2.htm)|
Инициализирует новый экземпляр класса ItemModel  
[ItemModel(Guid, String, String, AttachmentType,
Int64)](M_Tessa_Forums_Models_ItemModel__ctor_1.htm)| Инициализирует новый
экземпляр класса ItemModel  
[ItemModel(String, String, String, AttachmentType,
Int64)](M_Tessa_Forums_Models_ItemModel__ctor_3.htm)| Инициализирует новый
экземпляр класса ItemModel  
##  __Свойства
[Caption](P_Tessa_Forums_Models_ItemModel_Caption.htm)|  
---|---  
[DataBase64](P_Tessa_Forums_Models_ItemModel_DataBase64.htm)|  
[FileName](P_Tessa_Forums_Models_ItemModel_FileName.htm)|  
[FileSize](P_Tessa_Forums_Models_ItemModel_FileSize.htm)|  Размер файла. Для
AttachmentType.Link, а так же для файлов, отправленных в версиях ниже 3.6.0.7
равен -1.  
[ID](P_Tessa_Forums_Models_ItemModel_ID.htm)|  
[MessageID](P_Tessa_Forums_Models_ItemModel_MessageID.htm)|  
[OriginalFileID](P_Tessa_Forums_Models_ItemModel_OriginalFileID.htm)|  
[ShowInToolbar](P_Tessa_Forums_Models_ItemModel_ShowInToolbar.htm)|  Флаг
отображать вложение под сообщением в режиме чтения. В режиме редактирования
флаг игнорируется, а вложение всегда отображается.  
[StoreMode](P_Tessa_Forums_Models_ItemModel_StoreMode.htm)|  
[Type](P_Tessa_Forums_Models_ItemModel_Type.htm)|  
[Uri](P_Tessa_Forums_Models_ItemModel_Uri.htm)|  
## __Методы
