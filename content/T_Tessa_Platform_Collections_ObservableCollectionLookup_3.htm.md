# ObservableCollectionLookup<TKey, TItem, TCollection> \- класс
...
C# __Копировать
     public abstract class ObservableCollectionLookup<TKey, TItem, TCollection> : ObservableCollection<TItem, TCollection>, 
    	IObservableCollectionLookup<TKey, TItem, TCollection>, IObservableCollection<TItem, TCollection>, 
    	IList<TItem>, ICollection<TItem>, IEnumerable<TItem>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer<TKey, TItem>
    where TItem : class
    where TCollection : class, Object, IObservableCollectionLookup<TKey, TItem, TCollection>
VB __Копировать
     Public MustInherit Class ObservableCollectionLookup(Of TKey, TItem As Class, TCollection As {Class, Object, IObservableCollectionLookup(Of TKey, TItem, TCollection)})
    	Inherits ObservableCollection(Of TItem, TCollection)
    	Implements IObservableCollectionLookup(Of TKey, TItem, TCollection), 
    	IObservableCollection(Of TItem, TCollection), IList(Of TItem), 
    	ICollection(Of TItem), IEnumerable(Of TItem), IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer(Of TKey, TItem)
C++ __Копировать
    generic<typename TKey, typename TItem, typename TCollection>
    where TItem : ref class
    where TCollection : ref class, Object, IObservableCollectionLookup<TKey, TItem, TCollection>
    public ref class ObservableCollectionLookup abstract : public ObservableCollection<TItem, TCollection>, 
    	IObservableCollectionLookup<TKey, TItem, TCollection>, IObservableCollection<TItem, TCollection>, 
    	IList<TItem>, ICollection<TItem>, IEnumerable<TItem>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer<TKey, TItem>
F# __Копировать
     [<AbstractClassAttribute>]
    type ObservableCollectionLookup<'TKey, 'TItem, 'TCollection when 'TItem : not struct when 'TCollection : not struct and Object and IObservableCollectionLookup<'TKey, 'TItem, 'TCollection>> = 
        class
            inherit ObservableCollection<'TItem, 'TCollection>
            interface IObservableCollectionLookup<'TKey, 'TItem, 'TCollection>
            ...
            interface ILookupContainer<'TKey, 'TItem>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<TItem> __[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<TItem> __[SuspendableObservableCollection](T_Tessa_Platform_Collections_SuspendableObservableCollection_1.htm)<TItem> __[ObservableCollection](T_Tessa_Platform_Collections_ObservableCollection_2.htm)<TItem, TCollection> __ ObservableCollectionLookup<TKey, TItem, TCollection>
Derived
[Tessa.Files.FileEntityCollection<TItem,
TCollection>](T_Tessa_Files_FileEntityCollection_2.htm)
[Tessa.Files.FileTagCollection](T_Tessa_Files_FileTagCollection.htm)
Implements
    [ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<TItem>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<TItem>, [IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<TItem>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.ienumerable), [INotifyCollectionChanged](https://learn.microsoft.com/dotnet/api/system.collections.specialized.inotifycollectionchanged), [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged), [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable), [ILookupContainer](T_Tessa_Platform_Collections_ILookupContainer_2.htm)<TKey, TItem>, [IObservableCollection](T_Tessa_Platform_Collections_IObservableCollection_2.htm)<TItem, TCollection>, [IObservableCollectionLookup](T_Tessa_Platform_Collections_IObservableCollectionLookup_3.htm)<TKey, TItem, TCollection>
#### Параметры типа
TKey
    Неуникальный ключ, по которому идентифицируются объекты.
TItem
    Ссылочный тип объектов в коллекции.
TCollection
     Ссылочный тип коллекции. Обычно это тот же класс, который унаследован от этого класса. 
## __Конструкторы
[ObservableCollectionLookup<TKey, TItem,
TCollection>()](M_Tessa_Platform_Collections_ObservableCollectionLookup_3__ctor.htm)|
Создаёт экземпляр коллекции с параметрами по умолчанию.  
---|---  
[ObservableCollectionLookup<TKey, TItem,
TCollection>(IEnumerable<TItem>)](M_Tessa_Platform_Collections_ObservableCollectionLookup_3__ctor_1.htm)|
...
[ObservableCollectionLookup<TKey, TItem,
TCollection>(List<TItem>)](M_Tessa_Platform_Collections_ObservableCollectionLookup_3__ctor_2.htm)|
...
(Переопределяет
[ObservableCollection<T>.ClearItems()](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1.clearitems#system-
collections-objectmodel-observablecollection-1-clearitems))  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetKey](M_Tessa_Platform_Collections_ObservableCollectionLookup_3_GetKey.htm)|
Возвращает неуникальный ключ, по которому идентифицируется заданный элемент
коллекции.  
...
(Переопределяет [ObservableCollection<T>.InsertItem(Int32,
T)](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1.insertitem#system-
...
(Переопределяет
[ObservableCollection<T>.RemoveItem(Int32)](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1.removeitem#system-
...
(Переопределяет [ObservableCollection<T>.SetItem(Int32,
T)](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1.setitem#system-
