# CardGetFileContentExtension.AfterRequestFinally - метод
...
Асинхронная задача.
#### Реализации
[ICardGetFileContentExtension.AfterRequestFinally(ICardGetFileContentExtensionContext)](M_Tessa_Cards_Extensions_ICardGetFileContentExtension_AfterRequestFinally.htm)  
##  __См. также
#### Ссылки
