# KrLaunchProcessCustomExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrLaunchProcessCustomExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class KrLaunchProcessCustomExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type KrLaunchProcessCustomExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ KrLaunchProcessCustomExtension
##  __Конструкторы
[KrLaunchProcessCustomExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrLaunchProcessCustomExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrLaunchProcessCustomExtension.  
---|---  
## __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrLaunchProcessCustomExtension_AfterRequest.htm)|
