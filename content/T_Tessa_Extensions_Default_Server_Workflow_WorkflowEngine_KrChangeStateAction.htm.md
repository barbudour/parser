...
VB __Копировать
     Public NotInheritable Class KrChangeStateAction
    	Inherits KrWorkflowActionBase
C++ __Копировать
     public ref class KrChangeStateAction sealed : public KrWorkflowActionBase
F# __Копировать
     [<SealedAttribute>]
    type KrChangeStateAction = 
        class
            inherit KrWorkflowActionBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WorkflowActionBase](T_Tessa_Workflow_Actions_WorkflowActionBase.htm) __[KrWorkflowActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowActionBase.htm) __ KrChangeStateAction
##  __Конструкторы
[KrChangeStateAction](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrChangeStateAction__ctor.htm)|
Инициализирует новый экземпляр класса KrChangeStateAction  
---|---  
##  __Свойства
...
[ExecuteAsync](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrChangeStateAction_ExecuteAsync.htm)|  
...
(Унаследован от
[KrWorkflowActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowActionBase.htm))  
[MainActionSection](F_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrChangeStateAction_MainActionSection.htm)|  
