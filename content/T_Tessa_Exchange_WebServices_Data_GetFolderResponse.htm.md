...
VB __Копировать
     Public NotInheritable Class GetFolderResponse
    	Inherits ServiceResponse
C++ __Копировать
     public ref class GetFolderResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ GetFolderResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[Folder](P_Tessa_Exchange_WebServices_Data_GetFolderResponse_Folder.htm)|
