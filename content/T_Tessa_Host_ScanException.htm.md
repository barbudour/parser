...
C++ __Копировать
    [SerializableAttribute]
    public ref class ScanException : public Exception
F# __Копировать
     [<SerializableAttribute>]
    type ScanException = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __ ScanException
Derived
[Tessa.Host.ScannerBusyException](T_Tessa_Host_ScannerBusyException.htm)
##  __Конструкторы
[ScanException()](M_Tessa_Host_ScanException__ctor.htm)| Initializes a new
instance of the
[Exception](https://learn.microsoft.com/dotnet/api/system.exception) class.  
---|---  
[ScanException(String)](M_Tessa_Host_ScanException__ctor_2.htm)| Initializes a
new instance of the
[Exception](https://learn.microsoft.com/dotnet/api/system.exception) class
with a specified error message.  
[ScanException(SerializationInfo,
StreamingContext)](M_Tessa_Host_ScanException__ctor_1.htm)| Initializes a new
instance of the
[Exception](https://learn.microsoft.com/dotnet/api/system.exception) class
with serialized data.  
[ScanException(String, Exception)](M_Tessa_Host_ScanException__ctor_3.htm)|
