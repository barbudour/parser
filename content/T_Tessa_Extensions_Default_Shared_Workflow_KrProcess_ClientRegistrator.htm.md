...
VB __Копировать
    <RegistratorAttribute(ExtensionStage.AfterPlatform, Type := SessionType.Client, 
    	Tag := RegistratorTag.DefaultForClientAndConsole)>
    Public NotInheritable Class ClientRegistrator
    	Inherits RegistratorBase
C++ __Копировать
    [RegistratorAttribute(ExtensionStage::AfterPlatform, Type = SessionType::Client, 
    	Tag = RegistratorTag::DefaultForClientAndConsole)]
    public ref class ClientRegistrator sealed : public RegistratorBase
F# __Копировать
     [<SealedAttribute>]
    [<RegistratorAttribute(ExtensionStage.AfterPlatform, Type = SessionType.Client, 
    	Tag = RegistratorTag.DefaultForClientAndConsole)>]
    type ClientRegistrator = 
        class
            inherit RegistratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm) __ ClientRegistrator
##  __Конструкторы
[ClientRegistrator](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_ClientRegistrator__ctor.htm)|
Инициализирует новый экземпляр класса ClientRegistrator  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterExtensions](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_ClientRegistrator_RegisterExtensions.htm)|
...
[RegisterUnity](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_ClientRegistrator_RegisterUnity.htm)|
