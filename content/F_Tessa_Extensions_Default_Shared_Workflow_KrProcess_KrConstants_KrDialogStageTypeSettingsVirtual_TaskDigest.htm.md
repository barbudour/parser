# KrConstants.KrDialogStageTypeSettingsVirtual.TaskDigest - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly TaskDigest As String
C++ __Копировать
     public:
    static initonly String^ TaskDigest
F# __Копировать
     static val TaskDigest: string
#### Значение поля
