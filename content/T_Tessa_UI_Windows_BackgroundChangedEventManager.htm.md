# BackgroundChangedEventManager - класс
...
C# __Копировать
     public sealed class BackgroundChangedEventManager : WeakEventManager<BackgroundChangedEventManager, BackgroundManager>
VB __Копировать
     Public NotInheritable Class BackgroundChangedEventManager
    	Inherits WeakEventManager(Of BackgroundChangedEventManager, BackgroundManager)
C++ __Копировать
     public ref class BackgroundChangedEventManager sealed : public WeakEventManager<BackgroundChangedEventManager^, BackgroundManager^>
F# __Копировать
     [<SealedAttribute>]
    type BackgroundChangedEventManager = 
        class
            inherit WeakEventManager<BackgroundChangedEventManager, BackgroundManager>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[WeakEventManager](https://learn.microsoft.com/dotnet/api/system.windows.weakeventmanager) __[WeakEventManager](T_Tessa_UI_WeakEventManager_2.htm)<BackgroundChangedEventManager, [BackgroundManager](T_Tessa_UI_Windows_BackgroundManager.htm)> __ BackgroundChangedEventManager
##  __Свойства
...
(Унаследован от
[WeakEventManager](https://learn.microsoft.com/dotnet/api/system.windows.weakeventmanager))  
[StartListening(BackgroundManager)](M_Tessa_UI_Windows_BackgroundChangedEventManager_StartListening.htm)|  
...
[StopListening(BackgroundManager)](M_Tessa_UI_Windows_BackgroundChangedEventManager_StopListening.htm)|  
(Переопределяет [WeakEventManager<TManager,
