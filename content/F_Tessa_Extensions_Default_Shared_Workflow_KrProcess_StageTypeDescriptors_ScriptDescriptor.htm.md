# StageTypeDescriptors.ScriptDescriptor - поле
...
VB __Копировать
     Public Shared ReadOnly ScriptDescriptor As StageTypeDescriptor
C++ __Копировать
     public:
    static initonly StageTypeDescriptor^ ScriptDescriptor
F# __Копировать
     static val ScriptDescriptor: StageTypeDescriptor
#### Значение поля
