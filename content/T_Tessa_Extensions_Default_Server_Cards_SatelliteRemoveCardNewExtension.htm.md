# SatelliteRemoveCardNewExtension - класс
...
VB __Копировать
     Public NotInheritable Class SatelliteRemoveCardNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class SatelliteRemoveCardNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type SatelliteRemoveCardNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ SatelliteRemoveCardNewExtension
##  __Конструкторы
[SatelliteRemoveCardNewExtension](M_Tessa_Extensions_Default_Server_Cards_SatelliteRemoveCardNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса SatelliteRemoveCardNewExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Cards_SatelliteRemoveCardNewExtension_BeforeRequest.htm)|  
(Переопределяет
