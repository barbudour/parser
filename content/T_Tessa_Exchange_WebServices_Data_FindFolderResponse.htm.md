...
VB __Копировать
     Public NotInheritable Class FindFolderResponse
    	Inherits ServiceResponse
C++ __Копировать
     public ref class FindFolderResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ FindFolderResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[Results](P_Tessa_Exchange_WebServices_Data_FindFolderResponse_Results.htm)|
