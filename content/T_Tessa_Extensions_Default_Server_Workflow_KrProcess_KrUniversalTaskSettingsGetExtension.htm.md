# KrUniversalTaskSettingsGetExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrUniversalTaskSettingsGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class KrUniversalTaskSettingsGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrUniversalTaskSettingsGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ KrUniversalTaskSettingsGetExtension
##  __Конструкторы
[KrUniversalTaskSettingsGetExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrUniversalTaskSettingsGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrUniversalTaskSettingsGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrUniversalTaskSettingsGetExtension_AfterRequest.htm)|  
(Переопределяет
