# NumberDirectorBase.NotifyBeforeEventCoreAsync - метод
...
C# __Копировать
     protected override Task NotifyBeforeEventCoreAsync(
    	INumberContext context,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Protected Overrides Function NotifyBeforeEventCoreAsync ( 
