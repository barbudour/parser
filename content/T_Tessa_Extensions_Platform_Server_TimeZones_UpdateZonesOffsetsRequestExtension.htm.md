# UpdateZonesOffsetsRequestExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.TimeZones](N_Tessa_Extensions_Platform_Server_TimeZones.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class UpdateZonesOffsetsRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class UpdateZonesOffsetsRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class UpdateZonesOffsetsRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type UpdateZonesOffsetsRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ UpdateZonesOffsetsRequestExtension
##  __Конструкторы
[UpdateZonesOffsetsRequestExtension](M_Tessa_Extensions_Platform_Server_TimeZones_UpdateZonesOffsetsRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса UpdateZonesOffsetsRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_TimeZones_UpdateZonesOffsetsRequestExtension_AfterRequest.htm)|  
(Переопределяет
