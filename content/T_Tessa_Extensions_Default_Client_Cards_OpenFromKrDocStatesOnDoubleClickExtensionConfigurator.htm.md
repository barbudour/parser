# OpenFromKrDocStatesOnDoubleClickExtensionConfigurator - класс
...
C# __Копировать
     public sealed class OpenFromKrDocStatesOnDoubleClickExtensionConfigurator : ExtensionSettingsConfiguratorBase
VB __Копировать
     Public NotInheritable Class OpenFromKrDocStatesOnDoubleClickExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class OpenFromKrDocStatesOnDoubleClickExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type OpenFromKrDocStatesOnDoubleClickExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ OpenFromKrDocStatesOnDoubleClickExtensionConfigurator
##  __Конструкторы
[OpenFromKrDocStatesOnDoubleClickExtensionConfigurator](M_Tessa_Extensions_Default_Client_Cards_OpenFromKrDocStatesOnDoubleClickExtensionConfigurator__ctor.htm)|
Инициализирует новый экземпляр класса
OpenFromKrDocStatesOnDoubleClickExtensionConfigurator  
---|---  
##  __Свойства
