# CollectionToListAdapter<T> \- класс
##  __Definition
 **Пространство имён:** [Tessa.UI](N_Tessa_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class CollectionToListAdapter<T> : Collection<T>
VB __Копировать
     Public NotInheritable Class CollectionToListAdapter(Of T)
    	Inherits Collection(Of T)
C++ __Копировать
    generic<typename T>
    public ref class CollectionToListAdapter sealed : public Collection<T>
F# __Копировать
     [<SealedAttribute>]
    type CollectionToListAdapter<'T> = 
        class
            inherit Collection<'T>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<T> __ CollectionToListAdapter<T>
#### Параметры типа
T
##  __Конструкторы
[CollectionToListAdapter<T>](M_Tessa_UI_CollectionToListAdapter_1__ctor.htm)|
Инициализирует новый экземпляр класса CollectionToListAdapter<T>  
---|---  
##  __Свойства
...
(Унаследован от
[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<T>)  
[ClearItems](M_Tessa_UI_CollectionToListAdapter_1_ClearItems.htm)|  
(Переопределяет
...
(Унаследован от
[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<T>)  
[InsertItem](M_Tessa_UI_CollectionToListAdapter_1_InsertItem.htm)|  
...
(Унаследован от
[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<T>)  
[RemoveItem](M_Tessa_UI_CollectionToListAdapter_1_RemoveItem.htm)|  
(Переопределяет
...
[SetItem](M_Tessa_UI_CollectionToListAdapter_1_SetItem.htm)|  
