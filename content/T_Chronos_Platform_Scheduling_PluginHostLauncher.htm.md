...
C# __Копировать
     public sealed class PluginHostLauncher : IPluginLauncher
VB __Копировать
     Public NotInheritable Class PluginHostLauncher
    	Implements IPluginLauncher
C++ __Копировать
     public ref class PluginHostLauncher sealed : IPluginLauncher
F# __Копировать
     [<SealedAttribute>]
    type PluginHostLauncher = 
        class
            interface IPluginLauncher
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ PluginHostLauncher
Implements
    [IPluginLauncher](T_Chronos_Platform_Scheduling_IPluginLauncher.htm)
##  __Конструкторы
[PluginHostLauncher](M_Chronos_Platform_Scheduling_PluginHostLauncher__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[LaunchAsync](M_Chronos_Platform_Scheduling_PluginHostLauncher_LaunchAsync.htm)|
