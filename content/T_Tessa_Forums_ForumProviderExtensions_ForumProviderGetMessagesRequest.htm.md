# ForumProviderExtensions.ForumProviderGetMessagesRequest - класс
##  __Definition
 **Пространство имён:** [Tessa.Forums](N_Tessa_Forums.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class ForumProviderGetMessagesRequest : StorageObject
VB __Копировать
     Public Class ForumProviderGetMessagesRequest
    	Inherits StorageObject
C++ __Копировать
     public ref class ForumProviderGetMessagesRequest : public StorageObject
F# __Копировать
     type ForumProviderGetMessagesRequest = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForumProviderExtensions.ForumProviderGetMessagesRequest
##  __Конструкторы
[ForumProviderExtensions.ForumProviderGetMessagesRequest()](M_Tessa_Forums_ForumProviderExtensions_ForumProviderGetMessagesRequest__ctor.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderGetMessagesRequest  
---|---  
[ForumProviderExtensions.ForumProviderGetMessagesRequest(Dictionary<String,
Object>)](M_Tessa_Forums_ForumProviderExtensions_ForumProviderGetMessagesRequest__ctor_1.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderGetMessagesRequest  
##  __Свойства
[IsNeedUpdateLastReadMessageTime](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetMessagesRequest_IsNeedUpdateLastReadMessageTime.htm)|  
---|---  
[IsSuperModerator](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetMessagesRequest_IsSuperModerator.htm)|  
[LastReadMessageTime](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetMessagesRequest_LastReadMessageTime.htm)|  
[LimitMessages](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetMessagesRequest_LimitMessages.htm)|  
[MessageID](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetMessagesRequest_MessageID.htm)|  
[PageNumber](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetMessagesRequest_PageNumber.htm)|  
[Query](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetMessagesRequest_Query.htm)|  
[ReverseOrder](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetMessagesRequest_ReverseOrder.htm)|  
[TopicID](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetMessagesRequest_TopicID.htm)|  
## __Методы
