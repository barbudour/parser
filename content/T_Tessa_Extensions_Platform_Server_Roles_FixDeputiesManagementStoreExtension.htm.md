# FixDeputiesManagementStoreExtension - класс
...
C# __Копировать
     public sealed class FixDeputiesManagementStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class FixDeputiesManagementStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class FixDeputiesManagementStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type FixDeputiesManagementStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ FixDeputiesManagementStoreExtension
##  __Конструкторы
[FixDeputiesManagementStoreExtension](M_Tessa_Extensions_Platform_Server_Roles_FixDeputiesManagementStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса FixDeputiesManagementStoreExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_FixDeputiesManagementStoreExtension_AfterRequest.htm)|  
(Переопределяет
