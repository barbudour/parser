# ConvertablePreviewUIExtension - класс
...
C# __Копировать
     public sealed class ConvertablePreviewUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class ConvertablePreviewUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class ConvertablePreviewUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type ConvertablePreviewUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ ConvertablePreviewUIExtension
##  __Конструкторы
[ConvertablePreviewUIExtension](M_Tessa_Extensions_Platform_Client_UI_ConvertablePreviewUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса ConvertablePreviewUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_ConvertablePreviewUIExtension_Initialized.htm)|  
(Переопределяет
