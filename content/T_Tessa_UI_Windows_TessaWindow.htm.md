# TessaWindow - класс
Окно со стилизованной рамкой.
## __Definition
 **Пространство имён:** [Tessa.UI.Windows](N_Tessa_UI_Windows.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
    [TemplatePartAttribute(Name = "PART_MinimizeButton", Type = typeof(TessaWindowChromeButton))]
    [TemplatePartAttribute(Name = "PART_MaximizeButton", Type = typeof(TessaWindowChromeButton))]
    [TemplatePartAttribute(Name = "PART_CloseButton", Type = typeof(Button))]
    [TemplatePartAttribute(Name = "PART_Icon", Type = typeof(Image))]
    [TemplatePartAttribute(Name = "PART_DragWidget", Type = typeof(Thumb))]
    public class TessaWindow : Window
VB __Копировать
    <TemplatePartAttribute(Name := "PART_MinimizeButton", Type := GetType(TessaWindowChromeButton))>
    <TemplatePartAttribute(Name := "PART_MaximizeButton", Type := GetType(TessaWindowChromeButton))>
    <TemplatePartAttribute(Name := "PART_CloseButton", Type := GetType(Button))>
    <TemplatePartAttribute(Name := "PART_Icon", Type := GetType(Image))>
    <TemplatePartAttribute(Name := "PART_DragWidget", Type := GetType(Thumb))>
    Public Class TessaWindow
    	Inherits Window
C++ __Копировать
    [TemplatePartAttribute(Name = L"PART_MinimizeButton", Type = typeof(TessaWindowChromeButton))]
    [TemplatePartAttribute(Name = L"PART_MaximizeButton", Type = typeof(TessaWindowChromeButton))]
    [TemplatePartAttribute(Name = L"PART_CloseButton", Type = typeof(Button))]
    [TemplatePartAttribute(Name = L"PART_Icon", Type = typeof(Image))]
    [TemplatePartAttribute(Name = L"PART_DragWidget", Type = typeof(Thumb))]
    public ref class TessaWindow : public Window
F# __Копировать
     [<TemplatePartAttribute(Name = "PART_MinimizeButton", Type = typeof(TessaWindowChromeButton))>]
    [<TemplatePartAttribute(Name = "PART_MaximizeButton", Type = typeof(TessaWindowChromeButton))>]
    [<TemplatePartAttribute(Name = "PART_CloseButton", Type = typeof(Button))>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Visual](https://learn.microsoft.com/dotnet/api/system.windows.media.visual) __[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement) __[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement) __[Control](https://learn.microsoft.com/dotnet/api/system.windows.controls.control) __[ContentControl](https://learn.microsoft.com/dotnet/api/system.windows.controls.contentcontrol) __[Window](https://learn.microsoft.com/dotnet/api/system.windows.window) __ TessaWindow
Derived
[Tessa.Extensions.Default.Client.Workplaces.WebChart.WebChartSettingsDialog](T_Tessa_Extensions_Default_Client_Workplaces_WebChart_WebChartSettingsDialog.htm)
[Tessa.UI.AppManager.CatalogService.ApplicationCatalogEditDialog](T_Tessa_UI_AppManager_CatalogService_ApplicationCatalogEditDialog.htm)
[Tessa.UI.AppManager.CatalogService.ApplicationCatalogManagerDialog](T_Tessa_UI_AppManager_CatalogService_ApplicationCatalogManagerDialog.htm)
[Tessa.UI.AppManager.Shell](T_Tessa_UI_AppManager_Shell.htm)
[Tessa.UI.Cards.Views.Controls.EditNumeratorDialog](T_Tessa_UI_Cards_Views_Controls_EditNumeratorDialog.htm)
[Tessa.UI.Controls.ColorPicker.ColorPickerDialog](T_Tessa_UI_Controls_ColorPicker_ColorPickerDialog.htm)
[Tessa.UI.Controls.TextStyleChooser.TextStyleChooser](T_Tessa_UI_Controls_TextStyleChooser_TextStyleChooser.htm)
[Tessa.UI.Controls.ViewMapper.ViewMappingDialog](T_Tessa_UI_Controls_ViewMapper_ViewMappingDialog.htm)
[Tessa.UI.HashEditor.InputValueWindow](T_Tessa_UI_HashEditor_InputValueWindow.htm)
[Tessa.UI.Localization.LocalizationEntryEditorDialog](T_Tessa_UI_Localization_LocalizationEntryEditorDialog.htm)
[Tessa.UI.Runtime.LoginDialog](T_Tessa_UI_Runtime_LoginDialog.htm)
[Tessa.UI.Scheme.Differences.SubmittingQueueDialog](T_Tessa_UI_Scheme_Differences_SubmittingQueueDialog.htm)
[Tessa.UI.Scheme.IndexedColumnOptionsDialog](T_Tessa_UI_Scheme_IndexedColumnOptionsDialog.htm)
[Tessa.UI.Scheme.Providers.Database.ConnectionDialog](T_Tessa_UI_Scheme_Providers_Database_ConnectionDialog.htm)
[Tessa.UI.Views.Charting.Charts.ChartDesignerWindow](T_Tessa_UI_Views_Charting_Charts_ChartDesignerWindow.htm)
[Tessa.UI.Views.Charting.Charts.ChartPrintDialog](T_Tessa_UI_Views_Charting_Charts_ChartPrintDialog.htm)
[Tessa.UI.Views.Charting.Controls.AppearanceEditorDialog](T_Tessa_UI_Views_Charting_Controls_AppearanceEditorDialog.htm)
[Tessa.UI.Views.Charting.Controls.DisplayValueFormattingDialog](T_Tessa_UI_Views_Charting_Controls_DisplayValueFormattingDialog.htm)
[Tessa.UI.Views.Charting.ViewModelDialog](T_Tessa_UI_Views_Charting_ViewModelDialog.htm)
[Tessa.UI.Views.FilterDialog](T_Tessa_UI_Views_FilterDialog.htm)
[Tessa.UI.Views.Filtering.DisplayValueFormattingDialog](T_Tessa_UI_Views_Filtering_DisplayValueFormattingDialog.htm)
[Tessa.UI.Views.FolderPropertyDialog](T_Tessa_UI_Views_FolderPropertyDialog.htm)
[Tessa.UI.Views.SearchQueryDialog](T_Tessa_UI_Views_SearchQueryDialog.htm)
[Tessa.UI.Views.SearchQueryManageDialog](T_Tessa_UI_Views_SearchQueryManageDialog.htm)
[Tessa.UI.Views.SelectValueDialog](T_Tessa_UI_Views_SelectValueDialog.htm)
[Tessa.UI.Views.WorkplacesDialog](T_Tessa_UI_Views_WorkplacesDialog.htm)
Подробнее __Less __
##  __Заметки
Каждое окно автоматически имеет поведение
[ContextMenu](T_Tessa_UI_Behaviors_ContextMenu.htm).
## __Конструкторы
[TessaWindow](M_Tessa_UI_Windows_TessaWindow__ctor.htm)| Создаёт экземпляр
...
[AllowsTransparency](https://learn.microsoft.com/dotnet/api/system.windows.window.allowstransparency#system-
windows-window-allowstransparency)| Gets or sets a value that indicates
whether a window's client area supports transparency.  
(Унаследован от
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[CanMinimize](P_Tessa_UI_Windows_TessaWindow_CanMinimize.htm)|  Признак того,
что окно можно свернуть. По умолчанию возвращает true.  
[CanResize](P_Tessa_UI_Windows_TessaWindow_CanResize.htm)|  Признак того, что
пользователь может изменить размер окна. По умолчанию возвращает true.  
[ChromeBackground](P_Tessa_UI_Windows_TessaWindow_ChromeBackground.htm)|
Задний фон для заголовка окна.  
[ChromeBorderBrush](P_Tessa_UI_Windows_TessaWindow_ChromeBorderBrush.htm)|
Цвет рамки вокруг окна.  
[ChromeInactiveBackground](P_Tessa_UI_Windows_TessaWindow_ChromeInactiveBackground.htm)|
Задний фон для заголовка окна, когда оно неактивно.  
[ChromeInactiveBorderBrush](P_Tessa_UI_Windows_TessaWindow_ChromeInactiveBorderBrush.htm)|
Цвет рамки вокруг окна, когда оно неактивно.  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[CloseKey](P_Tessa_UI_Windows_TessaWindow_CloseKey.htm)|  Горячая клавиша, при
нажатии которой окно закрывается, или null, если для закрытия окна не
требуется сочетание клавиш.  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[DialogResult](https://learn.microsoft.com/dotnet/api/system.windows.window.dialogresult#system-
windows-window-dialogresult)| Gets or sets the dialog result value, which is
the value that is returned from the
[ShowDialog()](https://learn.microsoft.com/dotnet/api/system.windows.window.showdialog#system-
windows-window-showdialog) method.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
(Унаследован от
[Control](https://learn.microsoft.com/dotnet/api/system.windows.controls.control))  
[Icon](https://learn.microsoft.com/dotnet/api/system.windows.window.icon#system-
windows-window-icon)| Gets or sets a window's icon.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[IsActive](https://learn.microsoft.com/dotnet/api/system.windows.window.isactive#system-
windows-window-isactive)| Gets a value that indicates whether the window is
active.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[Left](https://learn.microsoft.com/dotnet/api/system.windows.window.left#system-
windows-window-left)| Gets or sets the position of the window's left edge, in
relation to the desktop.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[LogicalChildren](https://learn.microsoft.com/dotnet/api/system.windows.window.logicalchildren#system-
windows-window-logicalchildren)| Gets an enumerator for a window's logical
child elements.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[MinContentHeight](P_Tessa_UI_Windows_TessaWindow_MinContentHeight.htm)|
Минимальная высота области с контентом окна.  
[MinContentWidth](P_Tessa_UI_Windows_TessaWindow_MinContentWidth.htm)|
Минимальная ширина области с контентом окна.  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[OwnedWindows](https://learn.microsoft.com/dotnet/api/system.windows.window.ownedwindows#system-
windows-window-ownedwindows)| Gets a collection of windows for which this
window is the owner.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[Owner](https://learn.microsoft.com/dotnet/api/system.windows.window.owner#system-
windows-window-owner)| Gets or sets the
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window) that
owns this
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window).  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[ResizeMode](https://learn.microsoft.com/dotnet/api/system.windows.window.resizemode#system-
windows-window-resizemode)| Gets or sets the resize mode.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[ResolveOwner](P_Tessa_UI_Windows_TessaWindow_ResolveOwner.htm)|  Признак
того, что следует получить последнее активное окно при инициализации
(выполнении конструктора) данного окна, чтобы назначить его в качестве
владельца текущего окна
[Owner](https://learn.microsoft.com/dotnet/api/system.windows.window.owner#system-
windows-window-owner). Если активное окно отсутствует, то в качестве владельца
назначается основное окно приложения. Рекомендуется устанавливать свойство в
XAML. Если же требуется получить владельца окна в коде после вызова
конструктора, то используйте метод
[ResolveOwnerAsActiveWindow()](M_Tessa_UI_Windows_TessaWindow_ResolveOwnerAsActiveWindow.htm).  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[RestoreBounds](https://learn.microsoft.com/dotnet/api/system.windows.window.restorebounds#system-
windows-window-restorebounds)| Gets the size and location of a window before
being either minimized or maximized.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[ShowActivated](https://learn.microsoft.com/dotnet/api/system.windows.window.showactivated#system-
windows-window-showactivated)| Gets or sets a value that indicates whether a
window is activated when first shown.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[ShowInTaskbar](https://learn.microsoft.com/dotnet/api/system.windows.window.showintaskbar#system-
windows-window-showintaskbar)| Gets or sets a value that indicates whether the
window has a task bar button.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[SizeToContent](https://learn.microsoft.com/dotnet/api/system.windows.window.sizetocontent#system-
windows-window-sizetocontent)| Gets or sets a value that indicates whether a
window will automatically size itself to fit the size of its content.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[TaskbarItemInfo](https://learn.microsoft.com/dotnet/api/system.windows.window.taskbariteminfo#system-
windows-window-taskbariteminfo)| Gets or sets the Windows 7 taskbar thumbnail
for the
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window).  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[Title](https://learn.microsoft.com/dotnet/api/system.windows.window.title#system-
windows-window-title)| Gets or sets a window's title.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[Top](https://learn.microsoft.com/dotnet/api/system.windows.window.top#system-
windows-window-top)| Gets or sets the position of the window's top edge, in
relation to the desktop.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[Topmost](https://learn.microsoft.com/dotnet/api/system.windows.window.topmost#system-
windows-window-topmost)| Gets or sets a value that indicates whether a window
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[WindowStartupLocation](https://learn.microsoft.com/dotnet/api/system.windows.window.windowstartuplocation#system-
windows-window-windowstartuplocation)| Gets or sets the position of the window
when first shown.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[WindowState](https://learn.microsoft.com/dotnet/api/system.windows.window.windowstate#system-
windows-window-windowstate)| Gets or sets a value that indicates whether a
window is restored, minimized, or maximized.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[WindowStyle](https://learn.microsoft.com/dotnet/api/system.windows.window.windowstyle#system-
windows-window-windowstyle)| Gets or sets a window's border style.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
##  __Методы
[Activate](https://learn.microsoft.com/dotnet/api/system.windows.window.activate#system-
windows-window-activate)| Attempts to bring the window to the foreground and
activates it.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
---|---  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[ArrangeOverride](https://learn.microsoft.com/dotnet/api/system.windows.window.arrangeoverride#system-
windows-window-arrangeoverride\(system-windows-size\))| Override this method
to arrange and size a window and its child elements.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[Close](https://learn.microsoft.com/dotnet/api/system.windows.window.close#system-
windows-window-close)| Manually closes a
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window).  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[DragMove](https://learn.microsoft.com/dotnet/api/system.windows.window.dragmove#system-
windows-window-dragmove)| Allows a window to be dragged by a mouse with its
left button down over an exposed area of the window's client area.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[EndInit](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement.endinit#system-
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[GetWindowStyle](M_Tessa_UI_Windows_TessaWindow_GetWindowStyle.htm)|  Стиль
окна по умолчанию.  
[Hide](https://learn.microsoft.com/dotnet/api/system.windows.window.hide#system-
windows-window-hide)| Makes a window invisible.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
(Унаследован от
[Visual](https://learn.microsoft.com/dotnet/api/system.windows.media.visual))  
[MaximizeOrRestore](M_Tessa_UI_Windows_TessaWindow_MaximizeOrRestore.htm)|
Разворачивает окно на весь экран или восстанавливает его нормальное
отображение, если для окна разрешено изменение размера.  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[MeasureOverride](https://learn.microsoft.com/dotnet/api/system.windows.window.measureoverride#system-
windows-window-measureoverride\(system-windows-size\))| Override this method
to measure the size of a window.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[Minimize](M_Tessa_UI_Windows_TessaWindow_Minimize.htm)|  Сворачивает окно в
трей, если сворачивание разрешено.  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnActivated](https://learn.microsoft.com/dotnet/api/system.windows.window.onactivated#system-
windows-window-onactivated\(system-eventargs\))| Raises the
[Activated](https://learn.microsoft.com/dotnet/api/system.windows.window.activated)
event.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[OnApplyTemplate](M_Tessa_UI_Windows_TessaWindow_OnApplyTemplate.htm)|  
(Переопределяет
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnClosed](https://learn.microsoft.com/dotnet/api/system.windows.window.onclosed#system-
windows-window-onclosed\(system-eventargs\))| Raises the
[Closed](https://learn.microsoft.com/dotnet/api/system.windows.window.closed)
event.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[OnClosing](https://learn.microsoft.com/dotnet/api/system.windows.window.onclosing#system-
windows-window-onclosing\(system-componentmodel-canceleventargs\))| Raises the
[Closing](https://learn.microsoft.com/dotnet/api/system.windows.window.closing)
event.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[OnContentChanged](https://learn.microsoft.com/dotnet/api/system.windows.window.oncontentchanged#system-
windows-window-oncontentchanged\(system-object-system-object\))| Called when
the
[Content](https://learn.microsoft.com/dotnet/api/system.windows.controls.contentcontrol.content#system-
windows-controls-contentcontrol-content) property changes.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[OnContentRendered](https://learn.microsoft.com/dotnet/api/system.windows.window.oncontentrendered#system-
windows-window-oncontentrendered\(system-eventargs\))| Raises the
[ContentRendered](https://learn.microsoft.com/dotnet/api/system.windows.window.contentrendered)
event.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[OnCreateAutomationPeer](https://learn.microsoft.com/dotnet/api/system.windows.window.oncreateautomationpeer#system-
windows-window-oncreateautomationpeer)| Creates and returns a
[WindowAutomationPeer](https://learn.microsoft.com/dotnet/api/system.windows.automation.peers.windowautomationpeer)
object for this
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window).  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[OnDeactivated](https://learn.microsoft.com/dotnet/api/system.windows.window.ondeactivated#system-
windows-window-ondeactivated\(system-eventargs\))| Raises the
[Deactivated](https://learn.microsoft.com/dotnet/api/system.windows.window.deactivated)
event.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[OnDpiChanged](https://learn.microsoft.com/dotnet/api/system.windows.window.ondpichanged#system-
windows-window-ondpichanged\(system-windows-dpiscale-system-windows-
dpiscale\))| Called when the DPI at which this window is rendered changes.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnInitialized(EventArgs)](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement.oninitialized#system-
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[OnInitialized(EventArgs)](M_Tessa_UI_Windows_TessaWindow_OnInitialized.htm)|  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnKeyDown](M_Tessa_UI_Windows_TessaWindow_OnKeyDown.htm)|  
(Переопределяет
[UIElement.OnKeyDown(KeyEventArgs)](https://learn.microsoft.com/dotnet/api/system.windows.uielement.onkeydown#system-
windows-uielement-onkeydown\(system-windows-input-keyeventargs\)))  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnLocationChanged](https://learn.microsoft.com/dotnet/api/system.windows.window.onlocationchanged#system-
windows-window-onlocationchanged\(system-eventargs\))| Raises the
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnManipulationBoundaryFeedback](https://learn.microsoft.com/dotnet/api/system.windows.window.onmanipulationboundaryfeedback#system-
windows-window-onmanipulationboundaryfeedback\(system-windows-input-
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[OnSourceInitialized(EventArgs)](https://learn.microsoft.com/dotnet/api/system.windows.window.onsourceinitialized#system-
windows-window-onsourceinitialized\(system-eventargs\))| Raises the
[SourceInitialized](https://learn.microsoft.com/dotnet/api/system.windows.window.sourceinitialized)
event.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[OnSourceInitialized(EventArgs)](M_Tessa_UI_Windows_TessaWindow_OnSourceInitialized.htm)|  
[OnStateChanged(EventArgs)](https://learn.microsoft.com/dotnet/api/system.windows.window.onstatechanged#system-
windows-window-onstatechanged\(system-eventargs\))| Raises the
[StateChanged](https://learn.microsoft.com/dotnet/api/system.windows.window.statechanged)
event.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[OnStateChanged(EventArgs)](M_Tessa_UI_Windows_TessaWindow_OnStateChanged.htm)|  
[OnStateChanging](M_Tessa_UI_Windows_TessaWindow_OnStateChanging.htm)|
Событие, происходящее перед изменением состояния. Рекомендуется использовать
его для изменения размеров окна в зависимости от состояния.  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnVisualChildrenChanged](https://learn.microsoft.com/dotnet/api/system.windows.window.onvisualchildrenchanged#system-
windows-window-onvisualchildrenchanged\(system-windows-dependencyobject-
...
of this [Window](https://learn.microsoft.com/dotnet/api/system.windows.window)
object is modified.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[OnVisualParentChanged](https://learn.microsoft.com/dotnet/api/system.windows.window.onvisualparentchanged#system-
windows-window-onvisualparentchanged\(system-windows-dependencyobject\))|
...
[Visual](https://learn.microsoft.com/dotnet/api/system.windows.media.visual))  
[ResolveOwnerAsActiveWindow](M_Tessa_UI_Windows_TessaWindow_ResolveOwnerAsActiveWindow.htm)|
Устанавливает последнее активное окно как владельца текущего окна
[Owner](https://learn.microsoft.com/dotnet/api/system.windows.window.owner#system-
windows-window-owner). Если активное окно отсутствует, то в качестве владельца
назначается основное окно приложения. Рекомендуется вызвать метод после того,
как выполнена инициализация окна (т.е. после вызова конструктора), но перед
первым отображением. Метод не выполняет действий, если вызван из потока,
отличного от основного потока приложения или если текущий объект является
активным окном или главным окном приложения.  
[RestrictSizeToWorkingArea](M_Tessa_UI_Windows_TessaWindow_RestrictSizeToWorkingArea.htm)|
Ограничивает максимальную ширину и высоту окна размером рабочей области
дисплея, на которой выведено окно
[Owner](https://learn.microsoft.com/dotnet/api/system.windows.window.owner#system-
windows-window-owner). Если такое окно не установлено, то используются размеры
основного дисплея.  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[Show](https://learn.microsoft.com/dotnet/api/system.windows.window.show#system-
windows-window-show)| Opens a window and returns without waiting for the newly
opened window to close.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[ShowDialog](https://learn.microsoft.com/dotnet/api/system.windows.window.showdialog#system-
windows-window-showdialog)| Opens a window and returns only when the newly
...
[Close()](https://learn.microsoft.com/dotnet/api/system.windows.window.close#system-
windows-window-close) is called, and can be handled to cancel window closure.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[ContentRendered](https://learn.microsoft.com/dotnet/api/system.windows.window.contentrendered)|
...
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[DpiChanged](https://learn.microsoft.com/dotnet/api/system.windows.window.dpichanged)|
...
[IsMouseCaptureWithinChanged](https://learn.microsoft.com/dotnet/api/system.windows.uielement.ismousecapturewithinchanged)|
Occurs when the value of the
[IsMouseCaptureWithinProperty](https://learn.microsoft.com/dotnet/api/system.windows.uielement.ismousecapturewithinproperty)
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[PreviewStylusOutOfRange](https://learn.microsoft.com/dotnet/api/system.windows.uielement.previewstylusoutofrange)|
...
[ActualWidth](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement.actualwidth#system-
windows-frameworkelement-actualwidth) properties change value on this element.  
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[SourceInitialized](https://learn.microsoft.com/dotnet/api/system.windows.window.sourceinitialized)|
This event is raised to support interoperation with Win32. See
[HwndSource](https://learn.microsoft.com/dotnet/api/system.windows.interop.hwndsource).  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
...
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[StateChanged](https://learn.microsoft.com/dotnet/api/system.windows.window.statechanged)|
Occurs when the window's
[WindowState](https://learn.microsoft.com/dotnet/api/system.windows.window.windowstate#system-
windows-window-windowstate) property changes.  
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[StateChanging](E_Tessa_UI_Windows_TessaWindow_StateChanging.htm)|  Событие,
происходящее перед изменением состояния. Рекомендуется использовать его для
изменения размеров окна в зависимости от состояния.  
...
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
##  __Поля
[CanMinimizeProperty](F_Tessa_UI_Windows_TessaWindow_CanMinimizeProperty.htm)|
Признак того, что окно можно свернуть. По умолчанию возвращает true.  
---|---  
[CanResizeProperty](F_Tessa_UI_Windows_TessaWindow_CanResizeProperty.htm)|
Признак того, что пользователь может изменить размер окна. По умолчанию
возвращает true.  
[ChromeBackgroundProperty](F_Tessa_UI_Windows_TessaWindow_ChromeBackgroundProperty.htm)|
Задний фон для заголовка окна.  
[ChromeBorderBrushProperty](F_Tessa_UI_Windows_TessaWindow_ChromeBorderBrushProperty.htm)|
Цвет рамки вокруг окна.  
[ChromeInactiveBackgroundProperty](F_Tessa_UI_Windows_TessaWindow_ChromeInactiveBackgroundProperty.htm)|
Задний фон для заголовка окна, когда оно неактивно.  
[ChromeInactiveBorderBrushProperty](F_Tessa_UI_Windows_TessaWindow_ChromeInactiveBorderBrushProperty.htm)|
Цвет рамки вокруг окна, когда оно неактивно.  
[CloseKeyProperty](F_Tessa_UI_Windows_TessaWindow_CloseKeyProperty.htm)|
Горячая клавиша, при нажатии которой окно закрывается, или null, если для
закрытия окна не требуется сочетание клавиш.  
[MinContentHeightProperty](F_Tessa_UI_Windows_TessaWindow_MinContentHeightProperty.htm)|
Минимальная высота области с контентом окна.  
[MinContentWidthProperty](F_Tessa_UI_Windows_TessaWindow_MinContentWidthProperty.htm)|
Минимальная ширина области с контентом окна.  
[ResolveOwnerProperty](F_Tessa_UI_Windows_TessaWindow_ResolveOwnerProperty.htm)|
Признак того, что следует получить последнее активное окно при инициализации
(выполнении конструктора) данного окна, чтобы назначить его в качестве
владельца текущего окна
[Owner](https://learn.microsoft.com/dotnet/api/system.windows.window.owner#system-
windows-window-owner). Если активное окно отсутствует, то в качестве владельца
