...
C# __Копировать
     public sealed class ViewsWebProxy : WebProxy
VB __Копировать
     Public NotInheritable Class ViewsWebProxy
    	Inherits WebProxy
C++ __Копировать
     public ref class ViewsWebProxy sealed : public WebProxy
F# __Копировать
     [<SealedAttribute>]
    type ViewsWebProxy = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm) __ ViewsWebProxy
##  __Конструкторы
[ViewsWebProxy](M_Tessa_Views_ViewsWebProxy__ctor.htm)| Создаёт экземпляр
...
изменений.  
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[DeleteAsync](M_Tessa_Views_ViewsWebProxy_DeleteAsync.htm)|  Удаляет одно или
несколько представлений. Метод доступен только администраторам.  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetAllAsync](M_Tessa_Views_ViewsWebProxy_GetAllAsync.htm)|  Возвращает общую
метаинформацию по всем представлениям, доступным текущего сотруднику. Такая
метаинформация требуется для выполнения запросов к представлению, но не
содержит информации о внутреннем устройстве SQL запроса.  
[GetDataAsync](M_Tessa_Views_ViewsWebProxy_GetDataAsync.htm)|  Выполняет
представление и возвращает сериализованный результат выполнения. Представление
должно быть доступно для текущего пользователя.  
[GetHashCode](https://learn.microsoft.com/dotnet/api/system.object.gethashcode#system-
object-gethashcode)| Serves as the default hash function.  
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetModelsAsync](M_Tessa_Views_ViewsWebProxy_GetModelsAsync.htm)|  Возвращает
метаинформацию по запрошенным представлениям. Метод доступен только
администраторам.  
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[ImportAsync](M_Tessa_Views_ViewsWebProxy_ImportAsync.htm)|  Импортирует
заданные представления.  
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[StoreAsync](M_Tessa_Views_ViewsWebProxy_StoreAsync.htm)|  Сохраняет одно или
несколько представлений. Метод доступен только администраторам.  
