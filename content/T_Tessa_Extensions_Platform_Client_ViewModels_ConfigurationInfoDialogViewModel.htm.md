# ConfigurationInfoDialogViewModel - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.ViewModels](N_Tessa_Extensions_Platform_Client_ViewModels.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class ConfigurationInfoDialogViewModel : ViewModel<IConfigurationInfo>
VB __Копировать
     Public NotInheritable Class ConfigurationInfoDialogViewModel
    	Inherits ViewModel(Of IConfigurationInfo)
C++ __Копировать
     public ref class ConfigurationInfoDialogViewModel sealed : public ViewModel<IConfigurationInfo^>
F# __Копировать
     [<SealedAttribute>]
    type ConfigurationInfoDialogViewModel = 
        class
            inherit ViewModel<IConfigurationInfo>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NotificationObject](T_Tessa_Platform_NotificationObject.htm) __[NotificationUIObject](T_Tessa_UI_NotificationUIObject.htm) __[ViewModel](T_Tessa_UI_ViewModel_1.htm)<[IConfigurationInfo](T_Tessa_Platform_Runtime_IConfigurationInfo.htm)> __ ConfigurationInfoDialogViewModel
##  __Конструкторы
[ConfigurationInfoDialogViewModel](M_Tessa_Extensions_Platform_Client_ViewModels_ConfigurationInfoDialogViewModel__ctor.htm)|
Инициализирует новый экземпляр класса ConfigurationInfoDialogViewModel  
---|---  
##  __Свойства
...
(Унаследован от [ViewModel<TModel>](T_Tessa_UI_ViewModel_1.htm))  
[ShowExtensionsDialog](M_Tessa_Extensions_Platform_Client_ViewModels_ConfigurationInfoDialogViewModel_ShowExtensionsDialog.htm)|  
