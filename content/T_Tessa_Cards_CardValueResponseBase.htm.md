# CardValueResponseBase - класс
Базовый объект для ответа на запрос на получение информации по карточке от
сервиса карточек. Содержит информацию о карточке и объект, осуществляющий
валидацию.
## __Definition
...
C# __Копировать
    ...
    public abstract class CardValueResponseBase : CardResponseBase
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class CardValueResponseBase
    	Inherits CardResponseBase
C++ __Копировать
    [SerializableAttribute]
    public ref class CardValueResponseBase abstract : public CardResponseBase
F# __Копировать
     [<AbstractClassAttribute>]
    [<SerializableAttribute>]
    type CardValueResponseBase = 
        class
...
Derived
[Tessa.Cards.CardGetResponse](T_Tessa_Cards_CardGetResponse.htm)
[Tessa.Cards.CardNewResponse](T_Tessa_Cards_CardNewResponse.htm)
##  __Конструкторы
[CardValueResponseBase(Dictionary<String,
Object>)](M_Tessa_Cards_CardValueResponseBase__ctor.htm)| Создаёт экземпляр
класса с указанием хранилища, декоратором для которого является создаваемый
объект.  
---|---  
[CardValueResponseBase(SerializationInfo,
StreamingContext)](M_Tessa_Cards_CardValueResponseBase__ctor_1.htm)|  Создаёт
...
(Переопределяет
[CardResponseBase.Clean()](M_Tessa_Cards_CardResponseBase_Clean.htm))  
---|---  
...
(Переопределяет
[CardResponseBase.EnsureCacheResolved()](M_Tessa_Cards_CardResponseBase_EnsureCacheResolved.htm))  
...
(Переопределяет
[CardResponseBase.EraseOnError()](M_Tessa_Cards_CardResponseBase_EraseOnError.htm))  
...
##  __Поля
[CardKey](F_Tessa_Cards_CardValueResponseBase_CardKey.htm)|  
---|---  
[SectionRowsKey](F_Tessa_Cards_CardValueResponseBase_SectionRowsKey.htm)|  
## __Методы расширения
