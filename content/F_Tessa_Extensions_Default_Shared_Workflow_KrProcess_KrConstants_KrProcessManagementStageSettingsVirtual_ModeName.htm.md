# KrConstants.KrProcessManagementStageSettingsVirtual.ModeName - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly ModeName As String
C++ __Копировать
     public:
    static initonly String^ ModeName
F# __Копировать
     static val ModeName: string
#### Значение поля
