# NotificationRecipientsSourceResolver - класс
...
C# __Копировать
     public sealed class NotificationRecipientsSourceResolver : Resolver<Type, INotificationRecipientsSource>, 
    	INotificationRecipientsSourceResolver, IResolver<Type, INotificationRecipientsSource>
VB __Копировать
     Public NotInheritable Class NotificationRecipientsSourceResolver
    	Inherits Resolver(Of Type, INotificationRecipientsSource)
    	Implements INotificationRecipientsSourceResolver, IResolver(Of Type, INotificationRecipientsSource)
C++ __Копировать
     public ref class NotificationRecipientsSourceResolver sealed : public Resolver<Type^, INotificationRecipientsSource^>, 
    	INotificationRecipientsSourceResolver, IResolver<Type^, INotificationRecipientsSource^>
F# __Копировать
     [<SealedAttribute>]
    type NotificationRecipientsSourceResolver = 
        class
            inherit Resolver<Type, INotificationRecipientsSource>
            interface INotificationRecipientsSourceResolver
            interface IResolver<Type, INotificationRecipientsSource>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Resolver](T_Tessa_Platform_Resolver_2.htm)<[Type](https://learn.microsoft.com/dotnet/api/system.type), [INotificationRecipientsSource](T_Tessa_Notices_Sources_INotificationRecipientsSource.htm)> __ NotificationRecipientsSourceResolver
Implements
    [INotificationRecipientsSourceResolver](T_Tessa_Notices_Sources_INotificationRecipientsSourceResolver.htm), [IResolver](T_Tessa_Platform_IResolver_2.htm)<[Type](https://learn.microsoft.com/dotnet/api/system.type), [INotificationRecipientsSource](T_Tessa_Notices_Sources_INotificationRecipientsSource.htm)>
##  __Конструкторы
[NotificationRecipientsSourceResolver](M_Tessa_Notices_Sources_NotificationRecipientsSourceResolver__ctor.htm)|
Инициализирует новый экземпляр класса NotificationRecipientsSourceResolver  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetSource](M_Tessa_Notices_Sources_NotificationRecipientsSourceResolver_GetSource.htm)|
...
TSource>](M_Tessa_Notices_Sources_NotificationRecipientsSourceResolver_RegisterParameter__2.htm)|
