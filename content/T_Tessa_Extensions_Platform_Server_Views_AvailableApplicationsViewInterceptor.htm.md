# AvailableApplicationsViewInterceptor - класс
...
C# __Копировать
     public sealed class AvailableApplicationsViewInterceptor : ViewInterceptorBase
VB __Копировать
     Public NotInheritable Class AvailableApplicationsViewInterceptor
    	Inherits ViewInterceptorBase
C++ __Копировать
     public ref class AvailableApplicationsViewInterceptor sealed : public ViewInterceptorBase
F# __Копировать
     [<SealedAttribute>]
    type AvailableApplicationsViewInterceptor = 
        class
            inherit ViewInterceptorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ViewInterceptorBase](T_Tessa_Views_ViewInterceptorBase.htm) __ AvailableApplicationsViewInterceptor
##  __Конструкторы
[AvailableApplicationsViewInterceptor](M_Tessa_Extensions_Platform_Server_Views_AvailableApplicationsViewInterceptor__ctor.htm)|
Инициализирует новый экземпляр класса AvailableApplicationsViewInterceptor  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetDataAsync](M_Tessa_Extensions_Platform_Server_Views_AvailableApplicationsViewInterceptor_GetDataAsync.htm)|
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Platform.Server.Views - пространство
имён](N_Tessa_Extensions_Platform_Server_Views.htm)
