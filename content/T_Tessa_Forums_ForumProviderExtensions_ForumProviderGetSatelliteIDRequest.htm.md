# ForumProviderExtensions.ForumProviderGetSatelliteIDRequest - класс
##  __Definition
 **Пространство имён:** [Tessa.Forums](N_Tessa_Forums.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class ForumProviderGetSatelliteIDRequest : StorageObject
VB __Копировать
     Public Class ForumProviderGetSatelliteIDRequest
    	Inherits StorageObject
C++ __Копировать
     public ref class ForumProviderGetSatelliteIDRequest : public StorageObject
F# __Копировать
     type ForumProviderGetSatelliteIDRequest = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForumProviderExtensions.ForumProviderGetSatelliteIDRequest
##  __Конструкторы
[ForumProviderExtensions.ForumProviderGetSatelliteIDRequest()](M_Tessa_Forums_ForumProviderExtensions_ForumProviderGetSatelliteIDRequest__ctor.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderGetSatelliteIDRequest  
---|---  
[ForumProviderExtensions.ForumProviderGetSatelliteIDRequest(Dictionary<String,
Object>)](M_Tessa_Forums_ForumProviderExtensions_ForumProviderGetSatelliteIDRequest__ctor_1.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderGetSatelliteIDRequest  
##  __Свойства
[CardID](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetSatelliteIDRequest_CardID.htm)|  
---|---  
## __Методы
