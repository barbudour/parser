...
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class MailInfo
    	Inherits InfoStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class MailInfo sealed : public InfoStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm) __ MailInfo
Implements
    [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable)
##  __Конструкторы
[MailInfo()](M_Tessa_Notices_MailInfo__ctor.htm)|  Создаёт экземпляр класса и
пустое хранилище Dictionary<string, object>, декоратором для которого является
создаваемый объект.  
---|---  
[MailInfo(Dictionary<String, Object>)](M_Tessa_Notices_MailInfo__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[MailInfo(IStorageObjectProvider)](M_Tessa_Notices_MailInfo__ctor_2.htm)|
...
## __Свойства
[CardID](P_Tessa_Notices_MailInfo_CardID.htm)|  Идентификатор карточки.
Заполнять свойство необязательно, кроме случаев, когда к письму прикладываются
невиртуальные файлы.  
---|---  
[CardTypeID](P_Tessa_Notices_MailInfo_CardTypeID.htm)|  Идентификатор типа
карточки. Заполнять свойство необязательно, даже если к письму прикладываются
файлы.  
[CardTypeName](P_Tessa_Notices_MailInfo_CardTypeName.htm)|  Имя типа карточки.
Заполнять свойство необязательно, даже если к письму прикладываются файлы.  
...
(Унаследован от
[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm))  
[Files](P_Tessa_Notices_MailInfo_Files.htm)|  Файлы, приложенные к письму.
Значение не равно null.  
[Format](P_Tessa_Notices_MailInfo_Format.htm)|  Формат отправляемого
сообщения. По умолчанию [Html](T_Tessa_Notices_MailFormat.htm).  
[Info](P_Tessa_Platform_Storage_InfoStorageObject_Info.htm)|  Дополнительная
пользовательская информация.  
(Унаследован от
[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm))  
[LanguageCode](P_Tessa_Notices_MailInfo_LanguageCode.htm)|  Имя языка, для
которого локализуется сообщение (в т.ч. сообщения об ошибках с файлами и
контент виртуальных файлов). Заполнять свойство необязательно, по умолчанию
будет использоваться английский язык
[EnglishLanguageCode](F_Tessa_Localization_LocalizationManager_EnglishLanguageCode.htm).  
[MainRecipientDisplayName](P_Tessa_Notices_MailInfo_MainRecipientDisplayName.htm)|
Отображаемое имя основного получателя. Может быть равно null или пустой
строке. Заполнять свойство необязательно.  
[Recipients](P_Tessa_Notices_MailInfo_Recipients.htm)|  Список получателей
письма. Значение не равно null.  
[TimeZoneUtcOffsetMinutes](P_Tessa_Notices_MailInfo_TimeZoneUtcOffsetMinutes.htm)|
Временная зона получателя уведомления.  
[UserID](P_Tessa_Notices_MailInfo_UserID.htm)|  Идентификатор пользователя.  
[UserName](P_Tessa_Notices_MailInfo_UserName.htm)|  Идентификатор
пользователя.  
## __Методы
[AddRecipient](M_Tessa_Notices_MailInfo_AddRecipient.htm)|  Добавляет к письму
получателя указанного типа и возвращает текущий объект. Список получателей
доступен в свойстве [Recipients](P_Tessa_Notices_MailInfo_Recipients.htm).  
---|---  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Notices_MailInfo_Clone.htm)|  Выполняет глубокое клонирование
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Notices_MailInfo_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[SerializeJson](M_Tessa_Notices_MailInfo_SerializeJson.htm)|  Сериализует
объект для хранения в письме в текстовой форме.  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryDeserialize](M_Tessa_Notices_MailInfo_TryDeserialize.htm)|  Возвращает
объект MailInfo, полученный из данных в письме, которые сериализованы в виде
типизированного json, обычно методом
[SerializeJson()](M_Tessa_Notices_MailInfo_SerializeJson.htm), или null, если
данные не заданы.  
...
не найден.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetFiles](M_Tessa_Notices_MailInfo_TryGetFiles.htm)|  Возвращает файлы,
приложенные к письму, или null, если коллекция ещё не была создана.  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetRecipients](M_Tessa_Notices_MailInfo_TryGetRecipients.htm)|  Возвращает
список получателей письма, или null, если коллекция ещё не была создана.  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
##  __Поля
[CardIDKey](F_Tessa_Notices_MailInfo_CardIDKey.htm)|  
---|---  
[CardTypeIDKey](F_Tessa_Notices_MailInfo_CardTypeIDKey.htm)|  
[CardTypeNameKey](F_Tessa_Notices_MailInfo_CardTypeNameKey.htm)|  
[FilesKey](F_Tessa_Notices_MailInfo_FilesKey.htm)|  
[FormatKey](F_Tessa_Notices_MailInfo_FormatKey.htm)|  
[LanguageCodeKey](F_Tessa_Notices_MailInfo_LanguageCodeKey.htm)|  
[MainRecipientDisplayNameKey](F_Tessa_Notices_MailInfo_MainRecipientDisplayNameKey.htm)|  
[RecipientsKey](F_Tessa_Notices_MailInfo_RecipientsKey.htm)|  
[TimeZoneUtcOffsetMinutesKey](F_Tessa_Notices_MailInfo_TimeZoneUtcOffsetMinutesKey.htm)|  
[UserIDKey](F_Tessa_Notices_MailInfo_UserIDKey.htm)|  
[UserNameKey](F_Tessa_Notices_MailInfo_UserNameKey.htm)|  
## __Методы расширения
