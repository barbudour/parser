# ICardRequestExtensionContext<TRequest, TResponse> \- интерфейс
Контекст процесса взаимодействия с запросом на карточку.
## __Definition
 **Пространство имён:** [Tessa.Cards.Extensions](N_Tessa_Cards_Extensions.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public interface ICardRequestExtensionContext<out TRequest, TResponse> : ICardExtensionContext, 
...
VB __Копировать
     Public Interface ICardRequestExtensionContext(Of Out TRequest As CardInfoStorageObject, TResponse As CardInfoStorageObject)
...
C++ __Копировать
    ...
    where TRequest : CardInfoStorageObject
    where TResponse : CardInfoStorageObject
    public interface class ICardRequestExtensionContext : ICardExtensionContext, 
    	ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
F# __Копировать
     type ICardRequestExtensionContext<'TRequest, 'TResponse when 'TRequest : CardInfoStorageObject when 'TResponse : CardInfoStorageObject> = 
        interface
