# GetDataWithDelayExtensionConfigurator - класс
...
C# __Копировать
     public sealed class GetDataWithDelayExtensionConfigurator : ExtensionSettingsConfiguratorBase
VB __Копировать
     Public NotInheritable Class GetDataWithDelayExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class GetDataWithDelayExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type GetDataWithDelayExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ GetDataWithDelayExtensionConfigurator
##  __Конструкторы
[GetDataWithDelayExtensionConfigurator](M_Tessa_Extensions_Default_Client_Views_GetDataWithDelayExtensionConfigurator__ctor.htm)|
Инициализирует новый экземпляр класса GetDataWithDelayExtensionConfigurator  
---|---  
##  __Свойства
