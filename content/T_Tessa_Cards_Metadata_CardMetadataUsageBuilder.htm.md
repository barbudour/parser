# CardMetadataUsageBuilder - класс
...
C# __Копировать
     public sealed class CardMetadataUsageBuilder : CardMetadataBuilderBase
VB __Копировать
     Public NotInheritable Class CardMetadataUsageBuilder
    	Inherits CardMetadataBuilderBase
C++ __Копировать
     public ref class CardMetadataUsageBuilder sealed : public CardMetadataBuilderBase
F# __Копировать
     [<SealedAttribute>]
    type CardMetadataUsageBuilder = 
        class
            inherit CardMetadataBuilderBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardMetadataBuilderBase](T_Tessa_Cards_Metadata_CardMetadataBuilderBase.htm) __ CardMetadataUsageBuilder
##  __Конструкторы
...
##  __Методы
[AddCardTypeAsync](M_Tessa_Cards_Metadata_CardMetadataUsageBuilder_AddCardTypeAsync.htm)|
