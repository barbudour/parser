# TopicModel - класс
Модель с информацией по сообщению в обсуждении.
## __Definition
 **Пространство имён:** [Tessa.Forums.Models](N_Tessa_Forums_Models.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class TopicModel : StorageObject, 
    	IStorageCleanable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class TopicModel
    	Inherits StorageObject
    	Implements IStorageCleanable
C++ __Копировать
    [SerializableAttribute]
    public ref class TopicModel sealed : public StorageObject, 
    	IStorageCleanable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ TopicModel
Implements
    [IStorageCleanable](T_Tessa_Platform_Storage_IStorageCleanable.htm)
##  __Конструкторы
[TopicModel()](M_Tessa_Forums_Models_TopicModel__ctor.htm)|  Создаёт экземпляр
класса и пустое хранилище Dictionary<string, object>, декоратором для которого
является создаваемый объект.  
---|---  
[TopicModel(Dictionary<String,
Object>)](M_Tessa_Forums_Models_TopicModel__ctor_1.htm)| Создаёт экземпляр
класса с указанием хранилища, декоратором для которого является создаваемый
объект.  
[TopicModel(IStorageObjectProvider)](M_Tessa_Forums_Models_TopicModel__ctor_2.htm)|
...
## __Свойства
[AuthorID](P_Tessa_Forums_Models_TopicModel_AuthorID.htm)|  
---|---  
[AuthorName](P_Tessa_Forums_Models_TopicModel_AuthorName.htm)|  
[Created](P_Tessa_Forums_Models_TopicModel_Created.htm)|  
[CurrentMessageNumber](P_Tessa_Forums_Models_TopicModel_CurrentMessageNumber.htm)|  
[CurrentParticipantInfo](P_Tessa_Forums_Models_TopicModel_CurrentParticipantInfo.htm)|  
[Description](P_Tessa_Forums_Models_TopicModel_Description.htm)|  
[EnableFullTextMessageSearch](P_Tessa_Forums_Models_TopicModel_EnableFullTextMessageSearch.htm)|
Признак, что включен полнотекстовый поиск по сообщениям.  
[ID](P_Tessa_Forums_Models_TopicModel_ID.htm)|  
[IsArchived](P_Tessa_Forums_Models_TopicModel_IsArchived.htm)|  
[LastMessageAuthorID](P_Tessa_Forums_Models_TopicModel_LastMessageAuthorID.htm)|  
[LastMessageAuthorName](P_Tessa_Forums_Models_TopicModel_LastMessageAuthorName.htm)|  
[LastReadMessageTime](P_Tessa_Forums_Models_TopicModel_LastReadMessageTime.htm)|  
[LastUpdateDateTime](P_Tessa_Forums_Models_TopicModel_LastUpdateDateTime.htm)|  
[Messages](P_Tessa_Forums_Models_TopicModel_Messages.htm)|  
[MessagesCount](P_Tessa_Forums_Models_TopicModel_MessagesCount.htm)|  
[ReadByDefault](P_Tessa_Forums_Models_TopicModel_ReadByDefault.htm)|  
[Title](P_Tessa_Forums_Models_TopicModel_Title.htm)|  
[TypeID](P_Tessa_Forums_Models_TopicModel_TypeID.htm)|  
## __Методы
[Clean](M_Tessa_Forums_Models_TopicModel_Clean.htm)| Выполняет очистку
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[IsEmpty](M_Tessa_Forums_Models_TopicModel_IsEmpty.htm)|  Возвращает признак
