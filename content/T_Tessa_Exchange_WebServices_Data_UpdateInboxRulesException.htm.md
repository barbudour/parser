# UpdateInboxRulesException - класс
...
C++ __Копировать
     public ref class UpdateInboxRulesException sealed : public ServiceRemoteException
F# __Копировать
     [<SealedAttribute>]
    type UpdateInboxRulesException = 
        class
            inherit ServiceRemoteException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceRemoteException](T_Tessa_Exchange_WebServices_Data_ServiceRemoteException.htm) __ UpdateInboxRulesException
##  __Свойства
...
---|---  
[ErrorCode](P_Tessa_Exchange_WebServices_Data_UpdateInboxRulesException_ErrorCode.htm)|
Gets the rule operation error code.  
[ErrorMessage](P_Tessa_Exchange_WebServices_Data_UpdateInboxRulesException_ErrorMessage.htm)|
Gets the rule operation error message.  
[Errors](P_Tessa_Exchange_WebServices_Data_UpdateInboxRulesException_Errors.htm)|
...
(Унаследован от
[Exception](https://learn.microsoft.com/dotnet/api/system.exception))  
[ServiceResponse](P_Tessa_Exchange_WebServices_Data_UpdateInboxRulesException_ServiceResponse.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Exchange_WebServices_Data_UpdateInboxRulesException_GetObjectData.htm)|
Sets the
