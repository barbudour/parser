# NegatedBooleanConverter - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Data](N_Tessa_UI_Data.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
    [ValueConversionAttribute(typeof(bool), typeof(bool))]
    public sealed class NegatedBooleanConverter : ValueConverter<bool, bool>
VB __Копировать
    <ValueConversionAttribute(GetType(Boolean), GetType(Boolean))>
    Public NotInheritable Class NegatedBooleanConverter
    	Inherits ValueConverter(Of Boolean, Boolean)
C++ __Копировать
    [ValueConversionAttribute(typeof(bool), typeof(bool))]
    public ref class NegatedBooleanConverter sealed : public ValueConverter<bool, bool>
F# __Копировать
     [<SealedAttribute>]
    [<ValueConversionAttribute(typeof(bool), typeof(bool))>]
    type NegatedBooleanConverter = 
        class
            inherit ValueConverter<bool, bool>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueConverter](T_Tessa_UI_Data_ValueConverter_2.htm)<[Boolean](https://learn.microsoft.com/dotnet/api/system.boolean), [Boolean](https://learn.microsoft.com/dotnet/api/system.boolean)> __ NegatedBooleanConverter
##  __Конструкторы
[NegatedBooleanConverter](M_Tessa_UI_Data_NegatedBooleanConverter__ctor.htm)|
Инициализирует новый экземпляр класса NegatedBooleanConverter  
---|---  
##  __Методы
[BoxSourceValue](M_Tessa_UI_Data_NegatedBooleanConverter_BoxSourceValue.htm)|  
(Переопределяет [ValueConverter<TSource,
TTarget>.BoxSourceValue(TSource)](M_Tessa_UI_Data_ValueConverter_2_BoxSourceValue.htm))  
---|---  
[BoxTargetValue](M_Tessa_UI_Data_NegatedBooleanConverter_BoxTargetValue.htm)|  
(Переопределяет [ValueConverter<TSource,
TTarget>.BoxTargetValue(TTarget)](M_Tessa_UI_Data_ValueConverter_2_BoxTargetValue.htm))  
[Convert(Boolean, Object,
CultureInfo)](M_Tessa_UI_Data_NegatedBooleanConverter_Convert.htm)|  
...
[ConvertBack(Boolean, Object,
CultureInfo)](M_Tessa_UI_Data_NegatedBooleanConverter_ConvertBack.htm)|  
