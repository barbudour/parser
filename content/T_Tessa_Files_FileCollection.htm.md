# FileCollection - класс
Коллекция файлов. Обеспечивает доступ по идентификаторам
[ID](P_Tessa_Files_IFileEntity_ID.htm).
## __Definition
 **Пространство имён:** [Tessa.Files](N_Tessa_Files.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class FileCollection : FileEntityCollection<IFile, IFileCollection>, 
    	IFileCollection, IFileEntityCollection<IFile, IFileCollection>, IObservableCollectionLookup<Guid, IFile, IFileCollection>, 
    	IObservableCollection<IFile, IFileCollection>, IList<IFile>, 
    	ICollection<IFile>, IEnumerable<IFile>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer<Guid, IFile>, 
    	IControllableCollection<IFile>
VB __Копировать
     Public NotInheritable Class FileCollection
    	Inherits FileEntityCollection(Of IFile, IFileCollection)
    	Implements IFileCollection, IFileEntityCollection(Of IFile, IFileCollection), 
    	IObservableCollectionLookup(Of Guid, IFile, IFileCollection), IObservableCollection(Of IFile, IFileCollection), 
    	IList(Of IFile), ICollection(Of IFile), IEnumerable(Of IFile), 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer(Of Guid, IFile), 
    	IControllableCollection(Of IFile)
C++ __Копировать
     public ref class FileCollection sealed : public FileEntityCollection<IFile^, IFileCollection^>, 
    	IFileCollection, IFileEntityCollection<IFile^, IFileCollection^>, IObservableCollectionLookup<Guid, IFile^, IFileCollection^>, 
    	IObservableCollection<IFile^, IFileCollection^>, IList<IFile^>, 
    	ICollection<IFile^>, IEnumerable<IFile^>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer<Guid, IFile^>, 
...
F# __Копировать
    ...
    type FileCollection = 
        class
            inherit FileEntityCollection<IFile, IFileCollection>
            interface IFileCollection
            interface IFileEntityCollection<IFile, IFileCollection>
            interface IObservableCollectionLookup<Guid, IFile, IFileCollection>
            interface IObservableCollection<IFile, IFileCollection>
            interface IList<IFile>
            interface ICollection<IFile>
            interface IEnumerable<IFile>
            interface IEnumerable
            interface INotifyCollectionChanged
            interface INotifyPropertyChanged
            interface ICloneable
            interface ILookupContainer<Guid, IFile>
            interface IControllableCollection<IFile>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<[IFile](T_Tessa_Files_IFile.htm)> __[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[IFile](T_Tessa_Files_IFile.htm)> __[SuspendableObservableCollection](T_Tessa_Platform_Collections_SuspendableObservableCollection_1.htm)<[IFile](T_Tessa_Files_IFile.htm)> __[ObservableCollection](T_Tessa_Platform_Collections_ObservableCollection_2.htm)<[IFile](T_Tessa_Files_IFile.htm), [IFileCollection](T_Tessa_Files_IFileCollection.htm)> __[ObservableCollectionLookup](T_Tessa_Platform_Collections_ObservableCollectionLookup_3.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [IFile](T_Tessa_Files_IFile.htm), [IFileCollection](T_Tessa_Files_IFileCollection.htm)> __[FileEntityCollection](T_Tessa_Files_FileEntityCollection_2.htm)<[IFile](T_Tessa_Files_IFile.htm), [IFileCollection](T_Tessa_Files_IFileCollection.htm)> __ FileCollection
Implements
    [ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<[IFile](T_Tessa_Files_IFile.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<[IFile](T_Tessa_Files_IFile.htm)>, [IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<[IFile](T_Tessa_Files_IFile.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.ienumerable), [INotifyCollectionChanged](https://learn.microsoft.com/dotnet/api/system.collections.specialized.inotifycollectionchanged), [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged), [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable), [IFileCollection](T_Tessa_Files_IFileCollection.htm), [IFileEntityCollection](T_Tessa_Files_IFileEntityCollection_2.htm)<[IFile](T_Tessa_Files_IFile.htm), [IFileCollection](T_Tessa_Files_IFileCollection.htm)>, [IControllableCollection](T_Tessa_Platform_Collections_IControllableCollection_1.htm)<[IFile](T_Tessa_Files_IFile.htm)>, [ILookupContainer](T_Tessa_Platform_Collections_ILookupContainer_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [IFile](T_Tessa_Files_IFile.htm)>, [IObservableCollection](T_Tessa_Platform_Collections_IObservableCollection_2.htm)<[IFile](T_Tessa_Files_IFile.htm), [IFileCollection](T_Tessa_Files_IFileCollection.htm)>, [IObservableCollectionLookup](T_Tessa_Platform_Collections_IObservableCollectionLookup_3.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [IFile](T_Tessa_Files_IFile.htm), [IFileCollection](T_Tessa_Files_IFileCollection.htm)>
##  __Конструкторы
[FileCollection()](M_Tessa_Files_FileCollection__ctor.htm)| Создаёт экземпляр
коллекции с параметрами по умолчанию.  
---|---  
[FileCollection(IEnumerable<IFile>)](M_Tessa_Files_FileCollection__ctor_1.htm)|
...
[FileCollection(List<IFile>)](M_Tessa_Files_FileCollection__ctor_2.htm)|
...
(Унаследован от
[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<[IFile](T_Tessa_Files_IFile.htm)>)  
...
(Унаследован от [ObservableCollectionLookup<TKey, TItem,
TCollection>](T_Tessa_Platform_Collections_ObservableCollectionLookup_3.htm))  
[Clone](M_Tessa_Files_FileCollection_Clone.htm)|  Выполняет глубокое
