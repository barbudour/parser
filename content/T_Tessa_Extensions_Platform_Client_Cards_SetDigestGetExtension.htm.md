...
C# __Копировать
     public sealed class SetDigestGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class SetDigestGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class SetDigestGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type SetDigestGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ SetDigestGetExtension
##  __Конструкторы
[SetDigestGetExtension](M_Tessa_Extensions_Platform_Client_Cards_SetDigestGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса SetDigestGetExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Client_Cards_SetDigestGetExtension_BeforeRequest.htm)|  
(Переопределяет
