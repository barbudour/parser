# KrConstants.NewIterationStageTemplate - поле
...
VB __Копировать
     Public Shared ReadOnly NewIterationStageTemplate As Guid
C++ __Копировать
     public:
    static initonly Guid NewIterationStageTemplate
F# __Копировать
     static val NewIterationStageTemplate: Guid
#### Значение поля
