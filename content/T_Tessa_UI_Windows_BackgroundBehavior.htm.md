# BackgroundBehavior - класс
The background behavior.
## __Definition
 **Пространство имён:** [Tessa.UI.Windows](N_Tessa_UI_Windows.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class BackgroundBehavior : Behavior<Control>, 
    	IWeakEventListener
VB __Копировать
     Public NotInheritable Class BackgroundBehavior
    	Inherits Behavior(Of Control)
    	Implements IWeakEventListener
C++ __Копировать
     public ref class BackgroundBehavior sealed : public Behavior<Control^>, 
    	IWeakEventListener
F# __Копировать
     [<SealedAttribute>]
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Windows_BackgroundBehavior_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Windows_BackgroundBehavior_OnAttached.htm)|  Called
after the behavior is attached to an AssociatedObject.  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Windows_BackgroundBehavior_OnDetaching.htm)|  Called
when the behavior is being detached from its AssociatedObject, but before it
