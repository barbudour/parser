# MultitypeSatelliteDeleteExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Cards.Extensions.Templates](N_Tessa_Cards_Extensions_Templates.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class MultitypeSatelliteDeleteExtension : CardDeleteExtension
VB __Копировать
     Public MustInherit Class MultitypeSatelliteDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class MultitypeSatelliteDeleteExtension abstract : public CardDeleteExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type MultitypeSatelliteDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ MultitypeSatelliteDeleteExtension
Derived
[Tessa.Cards.Extensions.Templates.TaskSatelliteDeleteExtension](T_Tessa_Cards_Extensions_Templates_TaskSatelliteDeleteExtension.htm)
##  __Конструкторы
[MultitypeSatelliteDeleteExtension](M_Tessa_Cards_Extensions_Templates_MultitypeSatelliteDeleteExtension__ctor.htm)|
