# PersonalRoleDeleteExtension - класс
...
C# __Копировать
     public sealed class PersonalRoleDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class PersonalRoleDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class PersonalRoleDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type PersonalRoleDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ PersonalRoleDeleteExtension
##  __Конструкторы
[PersonalRoleDeleteExtension](M_Tessa_Extensions_Platform_Server_Roles_PersonalRoleDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса PersonalRoleDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Roles_PersonalRoleDeleteExtension_BeforeRequest.htm)|  
(Переопределяет
