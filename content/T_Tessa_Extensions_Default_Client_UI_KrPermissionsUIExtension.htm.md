# KrPermissionsUIExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrPermissionsUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrPermissionsUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrPermissionsUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrPermissionsUIExtension
##  __Конструкторы
[KrPermissionsUIExtension](M_Tessa_Extensions_Default_Client_UI_KrPermissionsUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrPermissionsUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrPermissionsUIExtension_Initialized.htm)|  
(Переопределяет
