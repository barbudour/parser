...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ QueryDispatcher
Implements
    [IQueryDispatcher](T_Tessa_Views_MessageServices_IQueryDispatcher.htm)
##  __Конструкторы
[QueryDispatcher](M_Tessa_Views_MessageServices_QueryDispatcher__ctor.htm)|
Инициализирует новый экземпляр класса QueryDispatcher  
---|---  
##  __Методы
...
---|---  
[Execute<TResult>](M_Tessa_Views_MessageServices_QueryDispatcher_Execute__1.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsRegistered<TQuery>](M_Tessa_Views_MessageServices_QueryDispatcher_IsRegistered__1.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Register](M_Tessa_Views_MessageServices_QueryDispatcher_Register.htm)|
...
TResult>](M_Tessa_Views_MessageServices_QueryDispatcher_TryGetHandler__2.htm)|
Осуществляет попытку получения обработчика для запроса TQuery с результатом
выполнения TResult  
[UnRegister<TQuery>](M_Tessa_Views_MessageServices_QueryDispatcher_UnRegister__1.htm)|
