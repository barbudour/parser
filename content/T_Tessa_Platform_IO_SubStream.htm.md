# SubStream - класс
Поток, позволяющий последовательно прочитать заданное число байт из заданного
потока.
## __Definition
...
VB __Копировать
     Public NotInheritable Class SubStream
    	Inherits Stream
C++ __Копировать
     public ref class SubStream sealed : public Stream
F# __Копировать
     [<SealedAttribute>]
    type SubStream = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[MarshalByRefObject](https://learn.microsoft.com/dotnet/api/system.marshalbyrefobject) __[Stream](https://learn.microsoft.com/dotnet/api/system.io.stream) __ SubStream
##  __Конструкторы
[SubStream](M_Tessa_Platform_IO_SubStream__ctor.htm)|  Создаёт экземпляр
класса с указанием потока, из которого осуществляется фактическое чтение, и
ограничения на количество прочитанных байт.  
---|---  
## __Свойства
[BytesRemains](P_Tessa_Platform_IO_SubStream_BytesRemains.htm)|  Количество
байт, которое можно прочитать из потока с текущей позиции.  
---|---  
[CanRead](P_Tessa_Platform_IO_SubStream_CanRead.htm)| Признак того, что поток
поддерживает чтение данных.  
(Переопределяет
[Stream.CanRead](https://learn.microsoft.com/dotnet/api/system.io.stream.canread#system-
io-stream-canread))  
[CanSeek](P_Tessa_Platform_IO_SubStream_CanSeek.htm)|  Признак того, что
...
[CanWrite](P_Tessa_Platform_IO_SubStream_CanWrite.htm)|  Признак того, что в
...
io-stream-canwrite))  
[Length](P_Tessa_Platform_IO_SubStream_Length.htm)| Общее количество доступных
в потоке байт.  
(Переопределяет
[Stream.Length](https://learn.microsoft.com/dotnet/api/system.io.stream.length#system-
io-stream-length))  
[Position](P_Tessa_Platform_IO_SubStream_Position.htm)| Текущая позиция в
...
(Унаследован от
[Stream](https://learn.microsoft.com/dotnet/api/system.io.stream))  
[Dispose(Boolean)](M_Tessa_Platform_IO_SubStream_Dispose.htm)| Освобождает
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Flush](M_Tessa_Platform_IO_SubStream_Flush.htm)|  Записывает все данные из
...
(Унаследован от
[Stream](https://learn.microsoft.com/dotnet/api/system.io.stream))  
[FlushAsync(CancellationToken)](M_Tessa_Platform_IO_SubStream_FlushAsync.htm)|
...
[Stream](https://learn.microsoft.com/dotnet/api/system.io.stream))  
Устарело.  
[Read(Span<Byte>)](M_Tessa_Platform_IO_SubStream_Read_1.htm)| When overridden
in a derived class, reads a sequence of bytes from the current stream and
...
[Read(Byte[], Int32, Int32)](M_Tessa_Platform_IO_SubStream_Read.htm)|
...
CancellationToken)](M_Tessa_Platform_IO_SubStream_ReadAsync_1.htm)|
...
CancellationToken)](M_Tessa_Platform_IO_SubStream_ReadAsync.htm)| Асинхронно
считывает данные из потока и записывает их в заданный массив байт.  
...
(Унаследован от
[Stream](https://learn.microsoft.com/dotnet/api/system.io.stream))  
[Seek](M_Tessa_Platform_IO_SubStream_Seek.htm)| Изменяет текущую позицию в
...
[SeekEndAsync](M_Tessa_Platform_IO_SubStream_SeekEndAsync.htm)|  Переходит к
окончанию потока. Может использовать асинхронное чтение, если поток не
поддерживает мгновенный переход.  
[SetLength](M_Tessa_Platform_IO_SubStream_SetLength.htm)| Устанавливает размер
данных в потоке. Метод не поддерживается.  
(Переопределяет
...
(Унаследован от
[Stream](https://learn.microsoft.com/dotnet/api/system.io.stream))  
[Write(Byte[], Int32, Int32)](M_Tessa_Platform_IO_SubStream_Write.htm)|
