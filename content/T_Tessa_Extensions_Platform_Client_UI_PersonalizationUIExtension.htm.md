# PersonalizationUIExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class PersonalizationUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class PersonalizationUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type PersonalizationUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ PersonalizationUIExtension
##  __Конструкторы
[PersonalizationUIExtension](M_Tessa_Extensions_Platform_Client_UI_PersonalizationUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса PersonalizationUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_PersonalizationUIExtension_Initialized.htm)|  
(Переопределяет
