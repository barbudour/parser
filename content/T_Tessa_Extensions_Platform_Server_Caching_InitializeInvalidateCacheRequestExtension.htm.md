# InitializeInvalidateCacheRequestExtension - класс
...
C# __Копировать
     public sealed class InitializeInvalidateCacheRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class InitializeInvalidateCacheRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class InitializeInvalidateCacheRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type InitializeInvalidateCacheRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ InitializeInvalidateCacheRequestExtension
##  __Конструкторы
[InitializeInvalidateCacheRequestExtension](M_Tessa_Extensions_Platform_Server_Caching_InitializeInvalidateCacheRequestExtension__ctor.htm)|
...
(Унаследован от
[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Caching_InitializeInvalidateCacheRequestExtension_BeforeRequest.htm)|  
(Переопределяет
