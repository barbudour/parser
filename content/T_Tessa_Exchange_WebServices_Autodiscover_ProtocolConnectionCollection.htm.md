# ProtocolConnectionCollection - класс
...
VB __Копировать
     Public NotInheritable Class ProtocolConnectionCollection
C++ __Копировать
     public ref class ProtocolConnectionCollection sealed
F# __Копировать
     [<SealedAttribute>]
    type ProtocolConnectionCollection = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ProtocolConnectionCollection
##  __Свойства
