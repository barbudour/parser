# WebChartWorkplaceExtensionConfigurator - класс
...
VB __Копировать
     Public NotInheritable Class WebChartWorkplaceExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class WebChartWorkplaceExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type WebChartWorkplaceExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ WebChartWorkplaceExtensionConfigurator
##  __Конструкторы
[WebChartWorkplaceExtensionConfigurator](M_Tessa_Extensions_Default_Client_Workplaces_WebChart_WebChartWorkplaceExtensionConfigurator__ctor.htm)|
Initializes a new instance of the WebChartWorkplaceExtensionConfigurator
class.  
---|---  
## __Свойства
...
[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm))  
##  __Методы
[ConfigureAsync](M_Tessa_Extensions_Default_Client_Workplaces_WebChart_WebChartWorkplaceExtensionConfigurator_ConfigureAsync.htm)|
...
(Переопределяет
[ExtensionSettingsConfiguratorBase.ConfigureAsync(IExtensionConfigurationContext,
CancellationToken)](M_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase_ConfigureAsync.htm))  
---|---  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialize](M_Tessa_Extensions_Default_Client_Workplaces_WebChart_WebChartWorkplaceExtensionConfigurator_Initialize.htm)|
