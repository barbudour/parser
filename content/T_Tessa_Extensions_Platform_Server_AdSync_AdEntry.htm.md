...
C# __Копировать
     public class AdEntry : LdapEntry
VB __Копировать
     Public Class AdEntry
    	Inherits LdapEntry
C++ __Копировать
     public ref class AdEntry : public LdapEntry
F# __Копировать
     type AdEntry = 
        class
            inherit LdapEntry
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ LdapEntry __ AdEntry
##  __Конструкторы
[AdEntry](M_Tessa_Extensions_Platform_Server_AdSync_AdEntry__ctor.htm)|
Инициализирует новый экземпляр класса AdEntry  
---|---  
##  __Свойства
