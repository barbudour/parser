# TemplateUniqueValidatorRequestExtension - класс
...
C# __Копировать
     public sealed class TemplateUniqueValidatorRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class TemplateUniqueValidatorRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class TemplateUniqueValidatorRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type TemplateUniqueValidatorRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ TemplateUniqueValidatorRequestExtension
##  __Заметки
Метод должен выполняться после
[TemplateSaveCardRequestExtension](T_Tessa_Extensions_Platform_Server_Cards_TemplateSaveCardRequestExtension.htm).
## __Конструкторы
[TemplateUniqueValidatorRequestExtension](M_Tessa_Extensions_Platform_Server_Cards_TemplateUniqueValidatorRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса TemplateUniqueValidatorRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_TemplateUniqueValidatorRequestExtension_AfterRequest.htm)|  
(Переопределяет
