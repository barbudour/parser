...
##  __Конструкторы
[RegistratorShared](M_Tessa_Extensions_Platform_Server_Workflow_RegistratorShared__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterExtensions](M_Tessa_Extensions_Platform_Server_Workflow_RegistratorShared_RegisterExtensions.htm)|  
(Переопределяет
