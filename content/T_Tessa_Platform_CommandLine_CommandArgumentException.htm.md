...
VB __Копировать
    <SerializableAttribute>
    Public Class CommandArgumentException
    	Inherits CommandException
C++ __Копировать
    [SerializableAttribute]
    public ref class CommandArgumentException : public CommandException
F# __Копировать
     [<SerializableAttribute>]
    type CommandArgumentException = 
        class
            inherit CommandException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[CommandException](T_Tessa_Platform_CommandLine_CommandException.htm) __ CommandArgumentException
##  __Конструкторы
...
## __Свойства
[ArgumentName](P_Tessa_Platform_CommandLine_CommandArgumentException_ArgumentName.htm)|
Gets the name of the argument that causes this exception.  
---|---  
[CommandName](P_Tessa_Platform_CommandLine_CommandException_CommandName.htm)|
