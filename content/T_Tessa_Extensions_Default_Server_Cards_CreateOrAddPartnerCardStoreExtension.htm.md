# CreateOrAddPartnerCardStoreExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class CreateOrAddPartnerCardStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class CreateOrAddPartnerCardStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type CreateOrAddPartnerCardStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ CreateOrAddPartnerCardStoreExtension
##  __Конструкторы
[CreateOrAddPartnerCardStoreExtension](M_Tessa_Extensions_Default_Server_Cards_CreateOrAddPartnerCardStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса CreateOrAddPartnerCardStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Default_Server_Cards_CreateOrAddPartnerCardStoreExtension_AfterBeginTransaction.htm)|  
(Переопределяет
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Cards_CreateOrAddPartnerCardStoreExtension_BeforeRequest.htm)|  
(Переопределяет
