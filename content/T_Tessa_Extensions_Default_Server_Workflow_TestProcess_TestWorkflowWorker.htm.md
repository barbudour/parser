...
C# __Копировать
     public sealed class TestWorkflowWorker : WorkflowTaskWorker<IWorkflowManager>
VB __Копировать
     Public NotInheritable Class TestWorkflowWorker
    	Inherits WorkflowTaskWorker(Of IWorkflowManager)
C++ __Копировать
     public ref class TestWorkflowWorker sealed : public WorkflowTaskWorker<IWorkflowManager^>
F# __Копировать
     [<SealedAttribute>]
    type TestWorkflowWorker = 
        class
            inherit WorkflowTaskWorker<IWorkflowManager>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WorkflowWorker](T_Tessa_Cards_Workflow_WorkflowWorker_1.htm)<[IWorkflowManager](T_Tessa_Cards_Workflow_IWorkflowManager.htm)> __[WorkflowTaskWorker](T_Tessa_Cards_Workflow_WorkflowTaskWorker_1.htm)<[IWorkflowManager](T_Tessa_Cards_Workflow_IWorkflowManager.htm)> __ TestWorkflowWorker
##  __Конструкторы
[TestWorkflowWorker](M_Tessa_Extensions_Default_Server_Workflow_TestProcess_TestWorkflowWorker__ctor.htm)|
Инициализирует новый экземпляр класса TestWorkflowWorker  
---|---  
##  __Свойства
...
(Унаследован от
[WorkflowWorker<TManager>](T_Tessa_Cards_Workflow_WorkflowWorker_1.htm))  
[CompleteTaskCoreAsync](M_Tessa_Extensions_Default_Server_Workflow_TestProcess_TestWorkflowWorker_CompleteTaskCoreAsync.htm)|
...
(Унаследован от
[WorkflowWorker<TManager>](T_Tessa_Cards_Workflow_WorkflowWorker_1.htm))  
[ProcessSignalCoreAsync](M_Tessa_Extensions_Default_Server_Workflow_TestProcess_TestWorkflowWorker_ProcessSignalCoreAsync.htm)|
Обрабатывает внешний сигнал. Возвращает признак того, что сигнал известен и
был обработан.  
(Переопределяет
...
(Унаследован от
[WorkflowWorker<TManager>](T_Tessa_Cards_Workflow_WorkflowWorker_1.htm))  
[RenderStepCoreAsync](M_Tessa_Extensions_Default_Server_Workflow_TestProcess_TestWorkflowWorker_RenderStepCoreAsync.htm)|
Выполняет переход.  
...
(Унаследован от
[WorkflowWorker<TManager>](T_Tessa_Cards_Workflow_WorkflowWorker_1.htm))  
[StartProcessCoreAsync](M_Tessa_Extensions_Default_Server_Workflow_TestProcess_TestWorkflowWorker_StartProcessCoreAsync.htm)|
...
(Унаследован от
[WorkflowWorker<TManager>](T_Tessa_Cards_Workflow_WorkflowWorker_1.htm))  
[StopProcessCoreAsync](M_Tessa_Extensions_Default_Server_Workflow_TestProcess_TestWorkflowWorker_StopProcessCoreAsync.htm)|
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Server.Workflow.TestProcess - пространство
имён](N_Tessa_Extensions_Default_Server_Workflow_TestProcess.htm)
