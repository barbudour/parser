...
C# __Копировать
     public static readonly string ParentTaskHistoryGroupTypeID
VB __Копировать
     Public Shared ReadOnly ParentTaskHistoryGroupTypeID As String
C++ __Копировать
     public:
    static initonly String^ ParentTaskHistoryGroupTypeID
F# __Копировать
     static val ParentTaskHistoryGroupTypeID: string
#### Значение поля
