...
C# __Копировать
     public class AdConnection : LdapConnection
VB __Копировать
     Public Class AdConnection
    	Inherits LdapConnection
C++ __Копировать
     public ref class AdConnection : public LdapConnection
F# __Копировать
     type AdConnection = 
        class
            inherit LdapConnection
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ LdapConnection __ AdConnection
##  __Конструкторы
[AdConnection](M_Tessa_Extensions_Platform_Server_AdSync_AdConnection__ctor.htm)|
Инициализирует новый экземпляр класса AdConnection  
---|---  
##  __Свойства
