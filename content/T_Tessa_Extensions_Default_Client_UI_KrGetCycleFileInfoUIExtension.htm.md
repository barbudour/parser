# KrGetCycleFileInfoUIExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrGetCycleFileInfoUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrGetCycleFileInfoUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrGetCycleFileInfoUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrGetCycleFileInfoUIExtension
##  __Конструкторы
[KrGetCycleFileInfoUIExtension](M_Tessa_Extensions_Default_Client_UI_KrGetCycleFileInfoUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrGetCycleFileInfoUIExtension  
---|---  
##  __Методы
...
(Унаследован от [CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm))  
[Initializing](M_Tessa_Extensions_Default_Client_UI_KrGetCycleFileInfoUIExtension_Initializing.htm)|  
(Переопределяет
