# KrPermissionsViewInterceptor - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class KrPermissionsViewInterceptor : ViewInterceptorBase
VB __Копировать
     Public NotInheritable Class KrPermissionsViewInterceptor
    	Inherits ViewInterceptorBase
C++ __Копировать
     public ref class KrPermissionsViewInterceptor sealed : public ViewInterceptorBase
F# __Копировать
     [<SealedAttribute>]
    type KrPermissionsViewInterceptor = 
        class
            inherit ViewInterceptorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ViewInterceptorBase](T_Tessa_Views_ViewInterceptorBase.htm) __ KrPermissionsViewInterceptor
##  __Конструкторы
[KrPermissionsViewInterceptor](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrPermissionsViewInterceptor__ctor.htm)|
Инициализирует новый экземпляр класса KrPermissionsViewInterceptor  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetDataAsync](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrPermissionsViewInterceptor_GetDataAsync.htm)|
