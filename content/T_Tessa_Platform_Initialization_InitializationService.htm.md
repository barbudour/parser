...
VB __Копировать
     Public NotInheritable Class InitializationService
    	Implements IInitializationService
C++ __Копировать
     public ref class InitializationService sealed : IInitializationService
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ InitializationService
Implements
    [IInitializationService](T_Tessa_Platform_Initialization_IInitializationService.htm)
##  __Конструкторы
[InitializationService](M_Tessa_Platform_Initialization_InitializationService__ctor.htm)|
Создаёт экземпляр класса с указанием зависимостей сервиса.  
---|---  
## __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializeAsync](M_Tessa_Platform_Initialization_InitializationService_InitializeAsync.htm)|
