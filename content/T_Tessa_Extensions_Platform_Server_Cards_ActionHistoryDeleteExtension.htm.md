# ActionHistoryDeleteExtension - класс
...
C# __Копировать
     public sealed class ActionHistoryDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class ActionHistoryDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class ActionHistoryDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type ActionHistoryDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ ActionHistoryDeleteExtension
##  __Конструкторы
[ActionHistoryDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_ActionHistoryDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса ActionHistoryDeleteExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Cards_ActionHistoryDeleteExtension_AfterBeginTransaction.htm)|  
(Переопределяет
