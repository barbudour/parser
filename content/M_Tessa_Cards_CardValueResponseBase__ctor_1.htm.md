# CardValueResponseBase(SerializationInfo, StreamingContext) - конструктор
...
C# __Копировать
     protected CardValueResponseBase(
...
F# __Копировать
     new : 
            ...
            context : StreamingContext -> CardValueResponseBase
#### Параметры
info
...
[CardValueResponseBase -
перегрузка](Overload_Tessa_Cards_CardValueResponseBase__ctor.htm)
