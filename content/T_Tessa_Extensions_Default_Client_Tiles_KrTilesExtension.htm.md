...
C# __Копировать
     public sealed class KrTilesExtension : TileExtension
VB __Копировать
     Public NotInheritable Class KrTilesExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class KrTilesExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type KrTilesExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ KrTilesExtension
##  __Конструкторы
[KrTilesExtension](M_Tessa_Extensions_Default_Client_Tiles_KrTilesExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrTilesExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_KrTilesExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[InitializingLocal](M_Tessa_Extensions_Default_Client_Tiles_KrTilesExtension_InitializingLocal.htm)|  
(Переопределяет
