# KrSatelliteTransferRepairExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class KrSatelliteTransferRepairExtension : CardSatelliteTransferRepairExtension
VB __Копировать
     Public NotInheritable Class KrSatelliteTransferRepairExtension
    	Inherits CardSatelliteTransferRepairExtension
C++ __Копировать
     public ref class KrSatelliteTransferRepairExtension sealed : public CardSatelliteTransferRepairExtension
F# __Копировать
     [<SealedAttribute>]
    type KrSatelliteTransferRepairExtension = 
        class
            inherit CardSatelliteTransferRepairExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm) __[CardSatelliteTransferRepairExtension](T_Tessa_Cards_Extensions_Templates_CardSatelliteTransferRepairExtension.htm) __ KrSatelliteTransferRepairExtension
##  __Конструкторы
[KrSatelliteTransferRepairExtension](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrSatelliteTransferRepairExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrSatelliteTransferRepairExtension  
---|---  
##  __Свойства
...
(Унаследован от
[CardSatelliteTransferRepairExtension](T_Tessa_Cards_Extensions_Templates_CardSatelliteTransferRepairExtension.htm))  
[SatelliteSectionName](P_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrSatelliteTransferRepairExtension_SatelliteSectionName.htm)|  
(Переопределяет
...
[StoreKey](P_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrSatelliteTransferRepairExtension_StoreKey.htm)|  
(Переопределяет
