# KrConstants.KrDialogStageTypeSettingsVirtual.CardStoreModeID - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly CardStoreModeID As String
C++ __Копировать
     public:
    static initonly String^ CardStoreModeID
F# __Копировать
     static val CardStoreModeID: string
#### Значение поля
