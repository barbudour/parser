# FixPersonalRoleTemplateNewExtension - класс
...
C# __Копировать
     public sealed class FixPersonalRoleTemplateNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class FixPersonalRoleTemplateNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class FixPersonalRoleTemplateNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type FixPersonalRoleTemplateNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ FixPersonalRoleTemplateNewExtension
##  __Конструкторы
[FixPersonalRoleTemplateNewExtension](M_Tessa_Extensions_Platform_Server_Roles_FixPersonalRoleTemplateNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса FixPersonalRoleTemplateNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_FixPersonalRoleTemplateNewExtension_AfterRequest.htm)|  
(Переопределяет
