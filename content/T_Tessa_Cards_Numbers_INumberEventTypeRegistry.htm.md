# INumberEventTypeRegistry - интерфейс
...
C# __Копировать
     public interface INumberEventTypeRegistry : IRegistry<Guid, NumberEventType>
VB __Копировать
     Public Interface INumberEventTypeRegistry
    	Inherits IRegistry(Of Guid, NumberEventType)
C++ __Копировать
     public interface class INumberEventTypeRegistry : IRegistry<Guid, NumberEventType^>
F# __Копировать
     type INumberEventTypeRegistry = 
        interface
            interface IRegistry<Guid, NumberEventType>
        end
Implements
    [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [NumberEventType](T_Tessa_Cards_Numbers_NumberEventType.htm)>
##  __Методы
