# ManagerWorkplaceSettings.InactiveImageColumnName - свойство
...
VB __Копировать
     Public Property InactiveImageColumnName As String
    	Get
    	Set
C++ __Копировать
     public:
    property String^ InactiveImageColumnName {
    	String^ get ();
    	void set (String^ value);
    }
F# __Копировать
     member InactiveImageColumnName : string with get, set
#### Значение свойства
