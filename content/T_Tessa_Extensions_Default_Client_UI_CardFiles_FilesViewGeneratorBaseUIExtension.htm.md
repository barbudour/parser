...
VB __Копировать
     Public MustInherit Class FilesViewGeneratorBaseUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class FilesViewGeneratorBaseUIExtension abstract : public CardUIExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type FilesViewGeneratorBaseUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ FilesViewGeneratorBaseUIExtension
Derived
[Tessa.Extensions.Default.Client.UI.CardFiles.InitializeFilesViewUIExtension](T_Tessa_Extensions_Default_Client_UI_CardFiles_InitializeFilesViewUIExtension.htm)
##  __Конструкторы
[FilesViewGeneratorBaseUIExtension](M_Tessa_Extensions_Default_Client_UI_CardFiles_FilesViewGeneratorBaseUIExtension__ctor.htm)|
...
---|---  
[AttachViewToFileControlAsync](M_Tessa_Extensions_Default_Client_UI_CardFiles_FilesViewGeneratorBaseUIExtension_AttachViewToFileControlAsync.htm)|
Связывает представление с файловым API через FileControl, созданный в
InitializeFileControlAsync.  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetFileControl](M_Tessa_Extensions_Default_Client_UI_CardFiles_FilesViewGeneratorBaseUIExtension_TryGetFileControl.htm)|
Метод для получения контрола файлов для контрола представление из info по
имени контрола.  
## __Методы расширения
