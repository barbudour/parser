...
C# __Копировать
     public sealed class FileTemplateUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class FileTemplateUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class FileTemplateUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type FileTemplateUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ FileTemplateUIExtension
##  __Конструкторы
[FileTemplateUIExtension](M_Tessa_Extensions_Platform_Client_UI_FileTemplateUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса FileTemplateUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_FileTemplateUIExtension_Initialized.htm)|
Блокируем возможность добавлять больше одного файла в карточку типа
FileTemplate  
(Переопределяет
