# DefaultCardTypeExtensionSettings.DefaultGroup - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly DefaultGroup As String
C++ __Копировать
     public:
    static initonly String^ DefaultGroup
F# __Копировать
     static val DefaultGroup: string
#### Значение поля
