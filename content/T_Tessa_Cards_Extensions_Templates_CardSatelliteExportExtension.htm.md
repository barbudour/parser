# CardSatelliteExportExtension - класс
...
C# __Копировать
     public abstract class CardSatelliteExportExtension : CardGetExtension
VB __Копировать
     Public MustInherit Class CardSatelliteExportExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class CardSatelliteExportExtension abstract : public CardGetExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type CardSatelliteExportExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ CardSatelliteExportExtension
##  __Конструкторы
[CardSatelliteExportExtension](M_Tessa_Cards_Extensions_Templates_CardSatelliteExportExtension__ctor.htm)|
...
## __Методы
[AfterRequest](M_Tessa_Cards_Extensions_Templates_CardSatelliteExportExtension_AfterRequest.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsMainCardTypeAsync](M_Tessa_Cards_Extensions_Templates_CardSatelliteExportExtension_IsMainCardTypeAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[SetSatelliteAsync](M_Tessa_Cards_Extensions_Templates_CardSatelliteExportExtension_SetSatelliteAsync.htm)|
Сохраняет карточку-сателлит в пакете основной карточки.  
[ToString](https://learn.microsoft.com/dotnet/api/system.object.tostring#system-
object-tostring)| Returns a string that represents the current object.  
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetSatelliteIDAsync](M_Tessa_Cards_Extensions_Templates_CardSatelliteExportExtension_TryGetSatelliteIDAsync.htm)|
