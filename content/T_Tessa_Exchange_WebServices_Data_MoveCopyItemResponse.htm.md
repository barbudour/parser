...
VB __Копировать
     Public NotInheritable Class MoveCopyItemResponse
    	Inherits ServiceResponse
C++ __Копировать
     public ref class MoveCopyItemResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
    type MoveCopyItemResponse = 
        class
            inherit ServiceResponse
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ MoveCopyItemResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[Item](P_Tessa_Exchange_WebServices_Data_MoveCopyItemResponse_Item.htm)|  Gets
the copied or moved item. Item is null if the copy or move operation was
between two mailboxes or between a mailbox and a public folder.  
