# ICardFileSource.UseSimpleNamingScheme - свойство
...
C# __Копировать
     bool UseSimpleNamingScheme { get; }
VB __Копировать
     ReadOnly Property UseSimpleNamingScheme As Boolean
    	Get
C++ __Копировать
    property bool UseSimpleNamingScheme {
    	bool get ();
    }
F# __Копировать
