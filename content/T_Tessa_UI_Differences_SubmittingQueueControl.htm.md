...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnSubmittingQueueChanged](M_Tessa_UI_Differences_SubmittingQueueControl_OnSubmittingQueueChanged.htm)|  
...
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
##  __Поля
[ScrollToSubmittingItemProperty](F_Tessa_UI_Differences_SubmittingQueueControl_ScrollToSubmittingItemProperty.htm)|  
---|---  
[SubmittingQueueProperty](F_Tessa_UI_Differences_SubmittingQueueControl_SubmittingQueueProperty.htm)|  
## __Методы расширения
