# AdSyncCardStoreExtension - класс
...
C# __Копировать
     public sealed class AdSyncCardStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class AdSyncCardStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class AdSyncCardStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type AdSyncCardStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ AdSyncCardStoreExtension
##  __Конструкторы
[AdSyncCardStoreExtension](M_Tessa_Extensions_Platform_Server_AdSync_AdSyncCardStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса AdSyncCardStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_AdSync_AdSyncCardStoreExtension_AfterBeginTransaction.htm)|  
(Переопределяет
