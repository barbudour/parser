...
C# __Копировать
     public sealed class CardTaskTypePolicy : CardTypePolicyBase, 
    	ICardTaskTypePolicy, IExtensionPolicy
VB __Копировать
     Public NotInheritable Class CardTaskTypePolicy
    	Inherits CardTypePolicyBase
    	Implements ICardTaskTypePolicy, IExtensionPolicy
C++ __Копировать
     public ref class CardTaskTypePolicy sealed : public CardTypePolicyBase, 
    	ICardTaskTypePolicy, IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type CardTaskTypePolicy = 
        class
            inherit CardTypePolicyBase
            interface ICardTaskTypePolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardTypePolicyBase](T_Tessa_Cards_Extensions_CardTypePolicyBase.htm) __ CardTaskTypePolicy
Implements
    [ICardTaskTypePolicy](T_Tessa_Cards_Extensions_ICardTaskTypePolicy.htm), [IExtensionPolicy](T_Tessa_Extensions_IExtensionPolicy.htm)
##  __Заметки
