...
##  __Конструкторы
[CommandRegistrator](M_Tessa_Extensions_Default_Console_CreateDatabase_CommandRegistrator__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterCommands](M_Tessa_Extensions_Default_Console_CreateDatabase_CommandRegistrator_RegisterCommands.htm)|  
(Переопределяет
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Console.CreateDatabase - пространство
имён](N_Tessa_Extensions_Default_Console_CreateDatabase.htm)
