# KrConstants.KrSettingsRouteDialogCardTypes.CardTypeName - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Const CardTypeName As String = "CardTypeName"
C++ __Копировать
     public:
    literal String^ CardTypeName = "CardTypeName"
F# __Копировать
     static val mutable CardTypeName: string
#### Значение поля
