# NumberComposer.ReserveAcquiredNumberCoreAsync - метод
...
C# __Копировать
     protected virtual Task<bool> ReserveAcquiredNumberCoreAsync(
    	INumberContext context,
    	INumberObject number,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Protected Overridable Function ReserveAcquiredNumberCoreAsync ( 
...
C++ __Копировать
     protected:
    virtual Task<bool>^ ReserveAcquiredNumberCoreAsync(
    	INumberContext^ context, 
    	INumberObject^ number, 
    	CancellationToken cancellationToken = CancellationToken()
    )
F# __Копировать
     abstract ReserveAcquiredNumberCoreAsync : 
    ...
    *)
    -> Task<bool> 
    override ReserveAcquiredNumberCoreAsync : 
            context : INumberContext * 
            number : INumberObject * 
            ?cancellationToken : CancellationToken 
    (* Defaults:
