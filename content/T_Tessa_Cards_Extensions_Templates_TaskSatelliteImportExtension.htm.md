# TaskSatelliteImportExtension - класс
...
C# __Копировать
     public abstract class TaskSatelliteImportExtension : CardStoreExtension
VB __Копировать
     Public MustInherit Class TaskSatelliteImportExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class TaskSatelliteImportExtension abstract : public CardStoreExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type TaskSatelliteImportExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ TaskSatelliteImportExtension
##  __Конструкторы
[TaskSatelliteImportExtension](M_Tessa_Cards_Extensions_Templates_TaskSatelliteImportExtension__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Свойства
[ExtendedRepositoryWithoutTransaction](P_Tessa_Cards_Extensions_Templates_TaskSatelliteImportExtension_ExtendedRepositoryWithoutTransaction.htm)|
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Cards_Extensions_Templates_TaskSatelliteImportExtension_BeforeCommitTransaction.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsMainCardTypeAsync](M_Tessa_Cards_Extensions_Templates_TaskSatelliteImportExtension_IsMainCardTypeAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetSatelliteCardListAsync](M_Tessa_Cards_Extensions_Templates_TaskSatelliteImportExtension_TryGetSatelliteCardListAsync.htm)|
