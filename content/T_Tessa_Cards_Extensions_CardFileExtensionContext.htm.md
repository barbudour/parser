# CardFileExtensionContext - класс
Контекст процесса взаимодействия с файлом карточки.
## __Definition
 **Пространство имён:** [Tessa.Cards.Extensions](N_Tessa_Cards_Extensions.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class CardFileExtensionContext : CardExtensionContext, 
    	ICardFileExtensionContext, ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
VB __Копировать
     Public MustInherit Class CardFileExtensionContext
    	Inherits CardExtensionContext
    	Implements ICardFileExtensionContext, ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, 
    	ITraceableExtensionContext
C++ __Копировать
     public ref class CardFileExtensionContext abstract : public CardExtensionContext, 
    	ICardFileExtensionContext, ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
F# __Копировать
     [<AbstractClassAttribute>]
    type CardFileExtensionContext = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardExtensionContext](T_Tessa_Cards_Extensions_CardExtensionContext.htm) __ CardFileExtensionContext
Derived
[Tessa.Cards.Extensions.CardGetFileContentExtensionContext](T_Tessa_Cards_Extensions_CardGetFileContentExtensionContext.htm)
[Tessa.Cards.Extensions.CardGetFileVersionsExtensionContext](T_Tessa_Cards_Extensions_CardGetFileVersionsExtensionContext.htm)
Implements
...
##  __Конструкторы
[CardFileExtensionContext](M_Tessa_Cards_Extensions_CardFileExtensionContext__ctor.htm)|
