# TaskHistoryViewDetailsViewModel - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Class TaskHistoryViewDetailsViewModel
    	Inherits ViewModel(Of EmptyModel)
C++ __Копировать
     public ref class TaskHistoryViewDetailsViewModel : public ViewModel<EmptyModel^>
F# __Копировать
     type TaskHistoryViewDetailsViewModel = 
        class
            inherit ViewModel<EmptyModel>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NotificationObject](T_Tessa_Platform_NotificationObject.htm) __[NotificationUIObject](T_Tessa_UI_NotificationUIObject.htm) __[ViewModel](T_Tessa_UI_ViewModel_1.htm)<[EmptyModel](T_Tessa_UI_EmptyModel.htm)> __ TaskHistoryViewDetailsViewModel
##  __Конструкторы
[TaskHistoryViewDetailsViewModel](M_Tessa_Extensions_Platform_Client_UI_TaskHistory_TaskHistoryViewDetailsViewModel__ctor.htm)|
Инициализирует новый экземпляр класса TaskHistoryViewDetailsViewModel  
---|---  
##  __Свойства
[BottomElements](P_Tessa_Extensions_Platform_Client_UI_TaskHistory_TaskHistoryViewDetailsViewModel_BottomElements.htm)|  
---|---  
[LeftRow](P_Tessa_Extensions_Platform_Client_UI_TaskHistory_TaskHistoryViewDetailsViewModel_LeftRow.htm)|  
...
[RightRow](P_Tessa_Extensions_Platform_Client_UI_TaskHistory_TaskHistoryViewDetailsViewModel_RightRow.htm)|  
