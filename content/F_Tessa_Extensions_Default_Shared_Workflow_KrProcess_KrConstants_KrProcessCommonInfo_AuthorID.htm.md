# KrConstants.KrProcessCommonInfo.AuthorID - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Const AuthorID As String = "AuthorID"
C++ __Копировать
     public:
    literal String^ AuthorID = "AuthorID"
F# __Копировать
     static val mutable AuthorID: string
#### Значение поля
