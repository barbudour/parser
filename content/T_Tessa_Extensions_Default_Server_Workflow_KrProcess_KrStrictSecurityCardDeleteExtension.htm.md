# KrStrictSecurityCardDeleteExtension - класс
...
C# __Копировать
     public sealed class KrStrictSecurityCardDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class KrStrictSecurityCardDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class KrStrictSecurityCardDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type KrStrictSecurityCardDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ KrStrictSecurityCardDeleteExtension
##  __Конструкторы
[KrStrictSecurityCardDeleteExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrStrictSecurityCardDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrStrictSecurityCardDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrStrictSecurityCardDeleteExtension_BeforeRequest.htm)|  
(Переопределяет
