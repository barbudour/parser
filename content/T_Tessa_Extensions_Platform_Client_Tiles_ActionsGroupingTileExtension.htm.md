# ActionsGroupingTileExtension - класс
...
C# __Копировать
     public sealed class ActionsGroupingTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class ActionsGroupingTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class ActionsGroupingTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type ActionsGroupingTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ ActionsGroupingTileExtension
##  __Конструкторы
[ActionsGroupingTileExtension](M_Tessa_Extensions_Platform_Client_Tiles_ActionsGroupingTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса ActionsGroupingTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm))  
[InitializingLocal](M_Tessa_Extensions_Platform_Client_Tiles_ActionsGroupingTileExtension_InitializingLocal.htm)|  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[OpeningLocal](M_Tessa_Extensions_Platform_Client_Tiles_ActionsGroupingTileExtension_OpeningLocal.htm)|  
(Переопределяет
