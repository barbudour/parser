...
##  __Конструкторы
[Registrator](M_Tessa_Extensions_Default_Server_Files_VirtualFiles_Registrator__ctor.htm)|
...
в этом объекте.  
(Унаследован от [RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm))  
[RegisterUnity](M_Tessa_Extensions_Default_Server_Files_VirtualFiles_Registrator_RegisterUnity.htm)|  
(Переопределяет
