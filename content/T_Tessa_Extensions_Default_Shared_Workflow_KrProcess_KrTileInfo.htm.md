...
VB __Копировать
     Public NotInheritable Class KrTileInfo
    	Inherits StorageObject
C++ __Копировать
     public ref class KrTileInfo sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    type KrTileInfo = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ KrTileInfo
##  __Конструкторы
...
Инициализирует новый экземпляр класса KrTileInfo  
##  __Свойства
