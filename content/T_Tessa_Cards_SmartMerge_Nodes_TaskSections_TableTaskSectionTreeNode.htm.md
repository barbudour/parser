# TableTaskSectionTreeNode - класс
##  __Definition
 **Пространство имён:**
[Tessa.Cards.SmartMerge.Nodes.TaskSections](N_Tessa_Cards_SmartMerge_Nodes_TaskSections.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class TableTaskSectionTreeNode : TaskTreeNodeBase
VB __Копировать
     Public Class TableTaskSectionTreeNode
    	Inherits TaskTreeNodeBase
C++ __Копировать
     public ref class TableTaskSectionTreeNode : public TaskTreeNodeBase
F# __Копировать
     type TableTaskSectionTreeNode = 
        class
            inherit TaskTreeNodeBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TreeNodeBase](T_Tessa_SmartMerge_TreeNodeBase_1.htm)<[Card](T_Tessa_Cards_Card.htm)> __[CardTreeNodeBase](T_Tessa_Cards_SmartMerge_Nodes_CardTreeNodeBase.htm) __[CardSectionTreeNodeBase](T_Tessa_Cards_SmartMerge_Nodes_CardSectionTreeNodeBase.htm) __[TaskTreeNodeBase](T_Tessa_Cards_SmartMerge_Nodes_TaskSections_TaskTreeNodeBase.htm) __ TableTaskSectionTreeNode
##  __Конструкторы
[TableTaskSectionTreeNode](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_TableTaskSectionTreeNode__ctor.htm)|
Инициализирует новый экземпляр класса TableTaskSectionTreeNode  
---|---  
##  __Свойства
...
(Унаследован от
[CardSectionTreeNodeBase](T_Tessa_Cards_SmartMerge_Nodes_CardSectionTreeNodeBase.htm))  
[IgnoreDuplicates](P_Tessa_Cards_SmartMerge_Nodes_TaskSections_TableTaskSectionTreeNode_IgnoreDuplicates.htm)|
Игнорировать дубликаты строк (в случае более одного совпадения по ключевым
полям на одном "тир-уровне").  
(Переопределяет
[TreeNodeBase<T>.IgnoreDuplicates](P_Tessa_SmartMerge_TreeNodeBase_1_IgnoreDuplicates.htm))  
...
[CardSectionTreeNodeBase](T_Tessa_Cards_SmartMerge_Nodes_CardSectionTreeNodeBase.htm))  
##  __Методы
[AttachTo](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_TableTaskSectionTreeNode_AttachTo.htm)|
Устанавливает родительский узел.  
(Переопределяет
[TreeNodeBase<T>.AttachTo(ITreeNode<T>)](M_Tessa_SmartMerge_TreeNodeBase_1_AttachTo.htm))  
---|---  
...
его.  
(Унаследован от [TreeNodeBase<T>](T_Tessa_SmartMerge_TreeNodeBase_1.htm))  
[Clone](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_TableTaskSectionTreeNode_Clone.htm)|
Клонирует узел.  
(Переопределяет
...
[EqualsByKey](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_TableTaskSectionTreeNode_EqualsByKey.htm)|
...
[GetMergeResult](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_TableTaskSectionTreeNode_GetMergeResult.htm)|
...
состояние узла.  
(Унаследован от [TreeNodeBase<T>](T_Tessa_SmartMerge_TreeNodeBase_1.htm))  
[ToString](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_TableTaskSectionTreeNode_ToString.htm)|
Returns a string that represents the current object.  
(Переопределяет
[TaskTreeNodeBase.ToString()](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_TaskTreeNodeBase_ToString.htm))  
##  __Методы расширения
