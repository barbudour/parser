# PersonalRoleGetExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Roles](N_Tessa_Extensions_Platform_Server_Roles.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class PersonalRoleGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class PersonalRoleGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class PersonalRoleGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type PersonalRoleGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ PersonalRoleGetExtension
##  __Конструкторы
[PersonalRoleGetExtension](M_Tessa_Extensions_Platform_Server_Roles_PersonalRoleGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса PersonalRoleGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_PersonalRoleGetExtension_AfterRequest.htm)|  
(Переопределяет
