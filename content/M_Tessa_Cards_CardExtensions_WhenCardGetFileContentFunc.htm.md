# CardExtensions.WhenCardGetFileContentFunc - метод
...
C# __Копировать
     public static IExtensionPolicyContainer WhenCardGetFileContentFunc(
    	this IExtensionPolicyContainer policyContainer,
    	Func<ICardGetFileContentExtensionContext, bool> isAllowedFunc
    )
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function WhenCardGetFileContentFunc ( 
    	policyContainer As IExtensionPolicyContainer,
    	isAllowedFunc As Func(Of ICardGetFileContentExtensionContext, Boolean)
    ) As IExtensionPolicyContainer
C++ __Копировать
     public:
    [ExtensionAttribute]
    static IExtensionPolicyContainer^ WhenCardGetFileContentFunc(
    	IExtensionPolicyContainer^ policyContainer, 
    	Func<ICardGetFileContentExtensionContext^, bool>^ isAllowedFunc
    )
F# __Копировать
     [<ExtensionAttribute>]
    static member WhenCardGetFileContentFunc : 
            policyContainer : IExtensionPolicyContainer * 
            isAllowedFunc : Func<ICardGetFileContentExtensionContext, bool> -> IExtensionPolicyContainer 
#### Параметры
policyContainer
...
isAllowedFunc
[Func](https://learn.microsoft.com/dotnet/api/system.func-2)<[ICardGetFileContentExtensionContext](T_Tessa_Cards_Extensions_ICardGetFileContentExtensionContext.htm),
