# FileSignatureCollectionBase<TCollection> \- класс
Базовый класс для коллекции подписей для версии файла.
## __Definition
 **Пространство имён:** [Tessa.Files](N_Tessa_Files.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class FileSignatureCollectionBase<TCollection> : FileEntityCollection<IFileSignature, TCollection>, 
    	IFileSignatureCollectionBase<TCollection>, IFileEntityCollection<IFileSignature, TCollection>, 
    	IObservableCollectionLookup<Guid, IFileSignature, TCollection>, IObservableCollection<IFileSignature, TCollection>, 
    ...
    where TCollection : class, Object, IFileSignatureCollectionBase<TCollection>
VB __Копировать
     Public MustInherit Class FileSignatureCollectionBase(Of TCollection As {Class, Object, IFileSignatureCollectionBase(Of TCollection)})
    	Inherits FileEntityCollection(Of IFileSignature, TCollection)
    	Implements IFileSignatureCollectionBase(Of TCollection), IFileEntityCollection(Of IFileSignature, TCollection), 
    	IObservableCollectionLookup(Of Guid, IFileSignature, TCollection), IObservableCollection(Of IFileSignature, TCollection), 
...
C++ __Копировать
    ...
    where TCollection : ref class, Object, IFileSignatureCollectionBase<TCollection>
    public ref class FileSignatureCollectionBase abstract : public FileEntityCollection<IFileSignature^, TCollection>, 
    	IFileSignatureCollectionBase<TCollection>, IFileEntityCollection<IFileSignature^, TCollection>, 
    	IObservableCollectionLookup<Guid, IFileSignature^, TCollection>, IObservableCollection<IFileSignature^, TCollection>, 
    	IList<IFileSignature^>, ICollection<IFileSignature^>, IEnumerable<IFileSignature^>, 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer<Guid, IFileSignature^>, 
...
F# __Копировать
    ...
    type FileSignatureCollectionBase<'TCollection when 'TCollection : not struct and Object and IFileSignatureCollectionBase<'TCollection>> = 
        class
            inherit FileEntityCollection<IFileSignature, 'TCollection>
            interface IFileSignatureCollectionBase<'TCollection>
            interface IFileEntityCollection<IFileSignature, 'TCollection>
            interface IObservableCollectionLookup<Guid, IFileSignature, 'TCollection>
            interface IObservableCollection<IFileSignature, 'TCollection>
