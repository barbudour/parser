# UINamedObservableCollection<TItem, TCollection> \- класс
Коллекция именованных объектов, для которой доступны уведомление об изменениях
и клонирование. Учитывает асинхронное изменение свойств для основного потока
UI в WPF.
## __Definition
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<TItem> __[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<TItem> __[SuspendableObservableCollection](T_Tessa_Platform_Collections_SuspendableObservableCollection_1.htm)<TItem> __[ObservableCollection](T_Tessa_Platform_Collections_ObservableCollection_2.htm)<TItem, TCollection> __[NamedObservableCollection](T_Tessa_Platform_Collections_NamedObservableCollection_2.htm)<TItem, TCollection> __ UINamedObservableCollection<TItem, TCollection>
Derived
[Tessa.UI.Cards.CardToolbarItemCollection](T_Tessa_UI_Cards_CardToolbarItemCollection.htm)
[Tessa.UI.Files.FileGroupingCollection](T_Tessa_UI_Files_FileGroupingCollection.htm)
[Tessa.UI.Files.FileSortingCollection](T_Tessa_UI_Files_FileSortingCollection.htm)
[Tessa.UI.Menu.MenuActionCollection](T_Tessa_UI_Menu_MenuActionCollection.htm)
#### Параметры типа
TItem
...
TCollection>()](M_Tessa_UI_UINamedObservableCollection_2__ctor.htm)| Создаёт
экземпляр коллекции с параметрами по умолчанию.  
---|---  
[UINamedObservableCollection<TItem,
TCollection>(IEnumerable<TItem>)](M_Tessa_UI_UINamedObservableCollection_2__ctor_1.htm)|
...
[UINamedObservableCollection<TItem,
TCollection>(List<TItem>)](M_Tessa_UI_UINamedObservableCollection_2__ctor_2.htm)|
