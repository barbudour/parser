# SchemePartitionCollection - класс
##  __Definition
 **Пространство имён:** [Tessa.Scheme](N_Tessa_Scheme.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class SchemePartitionCollection : SchemeNamedObjectCollection<SchemePartition>
VB __Копировать
     Public NotInheritable Class SchemePartitionCollection
    	Inherits SchemeNamedObjectCollection(Of SchemePartition)
C++ __Копировать
     public ref class SchemePartitionCollection sealed : public SchemeNamedObjectCollection<SchemePartition^>
F# __Копировать
     [<SealedAttribute>]
    type SchemePartitionCollection = 
        class
            inherit SchemeNamedObjectCollection<SchemePartition>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[SchemeObjectCollection](T_Tessa_Scheme_SchemeObjectCollection_1.htm)<[SchemePartition](T_Tessa_Scheme_SchemePartition.htm)> __[SchemeNamedObjectCollection](T_Tessa_Scheme_SchemeNamedObjectCollection_1.htm)<[SchemePartition](T_Tessa_Scheme_SchemePartition.htm)> __ SchemePartitionCollection
##  __Свойства
...
---|---  
[DefaultPartition](P_Tessa_Scheme_SchemePartitionCollection_DefaultPartition.htm)|  
...
(Унаследован от
[SchemeObjectCollection<T>](T_Tessa_Scheme_SchemeObjectCollection_1.htm))  
[Construct](M_Tessa_Scheme_SchemePartitionCollection_Construct.htm)|  
(Переопределяет
