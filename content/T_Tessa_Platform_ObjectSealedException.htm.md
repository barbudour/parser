...
C# __Копировать
    ...
    public sealed class ObjectSealedException : ApplicationException
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class ObjectSealedException
    	Inherits ApplicationException
C++ __Копировать
    [SerializableAttribute]
    public ref class ObjectSealedException sealed : public ApplicationException
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type ObjectSealedException = 
        class
            inherit ApplicationException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception) __ ObjectSealedException
##  __Конструкторы
[ObjectSealedException(Type)](M_Tessa_Platform_ObjectSealedException__ctor.htm)|
Создаёт экземпляр класса с указанием типа объекта, который был защищён от
изменений.  
---|---  
[ObjectSealedException(Type,
String)](M_Tessa_Platform_ObjectSealedException__ctor_1.htm)|  Создаёт
экземпляр класса с указанием типа объекта, который был защищён от изменений, и
текста сообщения об ошибке.  
[ObjectSealedException(Type, String,
Exception)](M_Tessa_Platform_ObjectSealedException__ctor_2.htm)|  Создаёт
экземпляр класса с указанием типа объекта, который был защищён от изменений,
текста сообщения об ошибке и внутреннего исключения.  
## __Свойства
...
(Унаследован от
[Exception](https://learn.microsoft.com/dotnet/api/system.exception))  
[ObjectType](P_Tessa_Platform_ObjectSealedException_ObjectType.htm)|  Тип
объекта, который был защищён от изменений.  
