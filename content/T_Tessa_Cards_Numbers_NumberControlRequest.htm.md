...
C# __Копировать
    ...
    public sealed class NumberControlRequest : CardStorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class NumberControlRequest
    	Inherits CardStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class NumberControlRequest sealed : public CardStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type NumberControlRequest = 
        class
            inherit CardStorageObject
            interface ICloneable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __ NumberControlRequest
Implements
...
## __Методы
[Clean](M_Tessa_Cards_Numbers_NumberControlRequest_Clean.htm)| Выполняет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_Numbers_NumberControlRequest_Clone.htm)|  Выполняет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetControlLocation](M_Tessa_Cards_Numbers_NumberControlRequest_TryGetControlLocation.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetNumberObject](M_Tessa_Cards_Numbers_NumberControlRequest_TryGetNumberObject.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_Numbers_NumberControlRequest_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
