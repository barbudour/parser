...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception) __ ValidationException
##  __Конструкторы
[ValidationException(ValidationResult)](M_Tessa_Platform_Validation_ValidationException__ctor_1.htm)|
Создаёт экземпляр класса с указанием результата валидации.  
---|---  
[ValidationException(SerializationInfo,
StreamingContext)](M_Tessa_Platform_Validation_ValidationException__ctor.htm)|
...
Exception)](M_Tessa_Platform_Validation_ValidationException__ctor_2.htm)|
Создаёт экземпляр класса с указанием результата валидации и внутреннего
исключения, послужившее причиной этому.  
## __Свойства
...
(Унаследован от
[Exception](https://learn.microsoft.com/dotnet/api/system.exception))  
[Result](P_Tessa_Platform_Validation_ValidationException_Result.htm)|
Результат валидации, содержащий различные сообщения, в т.ч. сообщения об
ошибках.  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Platform_Validation_ValidationException_GetObjectData.htm)|
