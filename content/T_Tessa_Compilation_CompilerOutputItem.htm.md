...
C# __Копировать
    ...
    public sealed class CompilerOutputItem : ICompilerOutputItem
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CompilerOutputItem
    	Implements ICompilerOutputItem
C++ __Копировать
    [SerializableAttribute]
    public ref class CompilerOutputItem sealed : ICompilerOutputItem
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CompilerOutputItem = 
        class
            interface ICompilerOutputItem
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CompilerOutputItem
Implements
...
новый экземпляр класса CompilerOutputItem  
---|---  
