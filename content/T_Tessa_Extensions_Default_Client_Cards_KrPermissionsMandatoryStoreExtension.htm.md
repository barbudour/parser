# KrPermissionsMandatoryStoreExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrPermissionsMandatoryStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class KrPermissionsMandatoryStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type KrPermissionsMandatoryStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ KrPermissionsMandatoryStoreExtension
##  __Конструкторы
[KrPermissionsMandatoryStoreExtension](M_Tessa_Extensions_Default_Client_Cards_KrPermissionsMandatoryStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrPermissionsMandatoryStoreExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Client_Cards_KrPermissionsMandatoryStoreExtension_AfterRequest.htm)|  
(Переопределяет
