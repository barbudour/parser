...
VB __Копировать
     Public NotInheritable Class KrHistoryFileItem
C++ __Копировать
     public ref class KrHistoryFileItem sealed
F# __Копировать
     [<SealedAttribute>]
    type KrHistoryFileItem = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ KrHistoryFileItem
##  __Конструкторы
[KrHistoryFileItem](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrHistoryFileItem__ctor.htm)|
Инициализирует новый экземпляр класса KrHistoryFileItem  
---|---  
##  __Свойства
