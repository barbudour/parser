# DelegatedCommandDispatcher - класс
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ DelegatedCommandDispatcher
Implements
    [ICommandDispatcher](T_Tessa_Views_MessageServices_ICommandDispatcher.htm)
##  __Конструкторы
[DelegatedCommandDispatcher](M_Tessa_Views_MessageServices_DelegatedCommandDispatcher__ctor.htm)|
Инициализирует новый экземпляр класса DelegatedCommandDispatcher  
---|---  
##  __Методы
[Deregister<TCommand>](M_Tessa_Views_MessageServices_DelegatedCommandDispatcher_Deregister__1.htm)|
...
[ExecuteAsync](M_Tessa_Views_MessageServices_DelegatedCommandDispatcher_ExecuteAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsRegistered<TCommand>](M_Tessa_Views_MessageServices_DelegatedCommandDispatcher_IsRegistered__1.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Register](M_Tessa_Views_MessageServices_DelegatedCommandDispatcher_Register.htm)|
Осуществляет регистрацию обработчика команды  
[ToString](https://learn.microsoft.com/dotnet/api/system.object.tostring#system-
object-tostring)| Returns a string that represents the current object.  
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetHandler<TCommand>](M_Tessa_Views_MessageServices_DelegatedCommandDispatcher_TryGetHandler__1.htm)|
