# AutomaticNodeRefreshSettings - класс
...
C# __Копировать
     public class AutomaticNodeRefreshSettings : IStorageSerializable, 
    	IAutomaticNodeRefreshSettings
VB __Копировать
     Public Class AutomaticNodeRefreshSettings
    	Implements IStorageSerializable, IAutomaticNodeRefreshSettings
C++ __Копировать
     public ref class AutomaticNodeRefreshSettings : IStorageSerializable, 
    	IAutomaticNodeRefreshSettings
F# __Копировать
     type AutomaticNodeRefreshSettings = 
        class
            interface IStorageSerializable
            interface IAutomaticNodeRefreshSettings
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ AutomaticNodeRefreshSettings
Implements
    [IAutomaticNodeRefreshSettings](T_Tessa_Extensions_Default_Shared_Workplaces_IAutomaticNodeRefreshSettings.htm), [IStorageSerializable](T_Tessa_Platform_Storage_IStorageSerializable.htm)
##  __Конструкторы
[AutomaticNodeRefreshSettings](M_Tessa_Extensions_Default_Shared_Workplaces_AutomaticNodeRefreshSettings__ctor.htm)|
...
табличных данных  
## __Методы
[Deserialize](M_Tessa_Extensions_Default_Shared_Workplaces_AutomaticNodeRefreshSettings_Deserialize.htm)|  
---|---  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Serialize](M_Tessa_Extensions_Default_Shared_Workplaces_AutomaticNodeRefreshSettings_Serialize.htm)|  
