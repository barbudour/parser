...
C++ __Копировать
    [SerializableAttribute]
    public ref class CommandCanceledException : public CommandException
F# __Копировать
     [<SerializableAttribute>]
    type CommandCanceledException = 
        class
            inherit CommandException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[CommandException](T_Tessa_Platform_CommandLine_CommandException.htm) __ CommandCanceledException
##  __Конструкторы
