...
C# __Копировать
     public sealed class DefaultExecuteStrategy : IExtensionStrategy
VB __Копировать
     Public NotInheritable Class DefaultExecuteStrategy
    	Implements IExtensionStrategy
C++ __Копировать
     public ref class DefaultExecuteStrategy sealed : IExtensionStrategy
F# __Копировать
     [<SealedAttribute>]
    type DefaultExecuteStrategy = 
        class
            interface IExtensionStrategy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ DefaultExecuteStrategy
Implements
    [IExtensionStrategy](T_Tessa_Extensions_IExtensionStrategy.htm)
##  __Конструкторы
[DefaultExecuteStrategy](M_Tessa_Extensions_DefaultExecuteStrategy__ctor.htm)|
Инициализирует новый экземпляр класса DefaultExecuteStrategy  
---|---  
##  __Свойства
...
---|---  
##  __Методы
[ApplyAsync](M_Tessa_Extensions_DefaultExecuteStrategy_ApplyAsync.htm)|
