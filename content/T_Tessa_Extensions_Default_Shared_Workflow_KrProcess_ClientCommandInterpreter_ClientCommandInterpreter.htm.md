# ClientCommandInterpreter - класс
...
VB __Копировать
     Public NotInheritable Class ClientCommandInterpreter
    	Implements IClientCommandInterpreter
C++ __Копировать
     public ref class ClientCommandInterpreter sealed : IClientCommandInterpreter
F# __Копировать
     [<SealedAttribute>]
    type ClientCommandInterpreter = 
        class
            interface IClientCommandInterpreter
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ClientCommandInterpreter
Implements
...
##  __Конструкторы
[ClientCommandInterpreter](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_ClientCommandInterpreter_ClientCommandInterpreter__ctor.htm)|
Инициализирует новый экземпляр класса ClientCommandInterpreter.  
---|---  
## __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InterpretAsync](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_ClientCommandInterpreter_ClientCommandInterpreter_InterpretAsync.htm)|
