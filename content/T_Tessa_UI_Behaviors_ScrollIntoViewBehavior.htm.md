# ScrollIntoViewBehavior - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Behaviors](N_Tessa_UI_Behaviors.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class ScrollIntoViewBehavior : Behavior<ItemsControl>, 
    	IWeakEventListener
VB __Копировать
     Public NotInheritable Class ScrollIntoViewBehavior
    	Inherits Behavior(Of ItemsControl)
    	Implements IWeakEventListener
C++ __Копировать
     public ref class ScrollIntoViewBehavior sealed : public Behavior<ItemsControl^>, 
    	IWeakEventListener
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[ItemsControl](https://learn.microsoft.com/dotnet/api/system.windows.controls.itemscontrol)> __ ScrollIntoViewBehavior
Implements
    [IWeakEventListener](https://learn.microsoft.com/dotnet/api/system.windows.iweakeventlistener)
##  __Конструкторы
[ScrollIntoViewBehavior](M_Tessa_UI_Behaviors_ScrollIntoViewBehavior__ctor.htm)|
Инициализирует новый экземпляр класса ScrollIntoViewBehavior  
---|---  
##  __Свойства
...
(Унаследован от
[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject))  
[ElementIndex](P_Tessa_UI_Behaviors_ScrollIntoViewBehavior_ElementIndex.htm)|  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_ScrollIntoViewBehavior_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_ScrollIntoViewBehavior_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_ScrollIntoViewBehavior_OnDetaching.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[ReceiveWeakEvent](M_Tessa_UI_Behaviors_ScrollIntoViewBehavior_ReceiveWeakEvent.htm)|  
...
---|---  
##  __Поля
[ElementIndexProperty](F_Tessa_UI_Behaviors_ScrollIntoViewBehavior_ElementIndexProperty.htm)|  
---|---  
## __См. также
#### Ссылки
