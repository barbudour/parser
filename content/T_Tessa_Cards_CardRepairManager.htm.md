...
C# __Копировать
     public sealed class CardRepairManager : ICardRepairManager
VB __Копировать
     Public NotInheritable Class CardRepairManager
    	Implements ICardRepairManager
C++ __Копировать
     public ref class CardRepairManager sealed : ICardRepairManager
F# __Копировать
     [<SealedAttribute>]
    type CardRepairManager = 
        class
            interface ICardRepairManager
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardRepairManager
Implements
    [ICardRepairManager](T_Tessa_Cards_ICardRepairManager.htm)
##  __Конструкторы
[CardRepairManager](M_Tessa_Cards_CardRepairManager__ctor.htm)|  Создаёт
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RepairAsync](M_Tessa_Cards_CardRepairManager_RepairAsync.htm)|  Исправляет
