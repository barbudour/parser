# CardFileRequestBase(SerializationInfo, StreamingContext) - конструктор
...
F# __Копировать
     new : 
            ...
            context : StreamingContext -> CardFileRequestBase
#### Параметры
info
...
[CardFileRequestBase -
перегрузка](Overload_Tessa_Cards_CardFileRequestBase__ctor.htm)
