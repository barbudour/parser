# IWorkflowQueueEventTypeRegistry - интерфейс
...
C# __Копировать
     public interface IWorkflowQueueEventTypeRegistry : IRegistry<Guid, WorkflowQueueEventType>
VB __Копировать
     Public Interface IWorkflowQueueEventTypeRegistry
    	Inherits IRegistry(Of Guid, WorkflowQueueEventType)
C++ __Копировать
     public interface class IWorkflowQueueEventTypeRegistry : IRegistry<Guid, WorkflowQueueEventType^>
F# __Копировать
     type IWorkflowQueueEventTypeRegistry = 
        interface
            interface IRegistry<Guid, WorkflowQueueEventType>
        end
Implements
    [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [WorkflowQueueEventType](T_Tessa_Cards_Workflow_WorkflowQueueEventType.htm)>
##  __Методы
