# PerformanceTestViewModel - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Diagnostics](N_Tessa_UI_Diagnostics.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public class PerformanceTestViewModel : PerformanceTestBaseViewModel
VB __Копировать
     Public Class PerformanceTestViewModel
    	Inherits PerformanceTestBaseViewModel
C++ __Копировать
     public ref class PerformanceTestViewModel : public PerformanceTestBaseViewModel
F# __Копировать
     type PerformanceTestViewModel = 
        class
            inherit PerformanceTestBaseViewModel
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NotificationObject](T_Tessa_Platform_NotificationObject.htm) __[NotificationUIObject](T_Tessa_UI_NotificationUIObject.htm) __[ViewModel](T_Tessa_UI_ViewModel_1.htm)<[IPerformanceCounter](T_Tessa_Diagnostics_IPerformanceCounter.htm)> __[PerformanceCounterViewModel](T_Tessa_UI_Diagnostics_PerformanceCounterViewModel.htm) __[PerformanceTestBaseViewModel](T_Tessa_UI_Diagnostics_PerformanceTestBaseViewModel.htm) __ PerformanceTestViewModel
##  __Конструкторы
[PerformanceTestViewModel(PerformanceTest)](M_Tessa_UI_Diagnostics_PerformanceTestViewModel__ctor.htm)|
Инициализирует новый экземпляр класса PerformanceTestViewModel  
---|---  
[PerformanceTestViewModel(PerformanceTest,
Dispatcher)](M_Tessa_UI_Diagnostics_PerformanceTestViewModel__ctor_1.htm)|
Инициализирует новый экземпляр класса PerformanceTestViewModel  
[PerformanceTestViewModel(PerformanceTest,
PerformanceCounterViewModel[])](M_Tessa_UI_Diagnostics_PerformanceTestViewModel__ctor_3.htm)|
Инициализирует новый экземпляр класса PerformanceTestViewModel  
[PerformanceTestViewModel(PerformanceTest, Dispatcher,
PerformanceCounterViewModel[])](M_Tessa_UI_Diagnostics_PerformanceTestViewModel__ctor_2.htm)|
Инициализирует новый экземпляр класса PerformanceTestViewModel  
##  __Свойства
[AverageFrequency](P_Tessa_UI_Diagnostics_PerformanceTestViewModel_AverageFrequency.htm)|  
---|---  
[Counters](P_Tessa_UI_Diagnostics_PerformanceTestViewModel_Counters.htm)|  
[Executed](P_Tessa_UI_Diagnostics_PerformanceTestViewModel_Executed.htm)|  
[Frequency](P_Tessa_UI_Diagnostics_PerformanceTestViewModel_Frequency.htm)|  
...
(Унаследован от
[PerformanceCounterViewModel](T_Tessa_UI_Diagnostics_PerformanceCounterViewModel.htm))  
[Model](P_Tessa_UI_Diagnostics_PerformanceTestViewModel_Model.htm)|  
...
(Унаследован от
[PerformanceTestBaseViewModel](T_Tessa_UI_Diagnostics_PerformanceTestBaseViewModel.htm))  
[RefreshOverride](M_Tessa_UI_Diagnostics_PerformanceTestViewModel_RefreshOverride.htm)|  
(Переопределяет
[PerformanceTestBaseViewModel.RefreshOverride()](M_Tessa_UI_Diagnostics_PerformanceTestBaseViewModel_RefreshOverride.htm))  
[Start](M_Tessa_UI_Diagnostics_PerformanceCounterViewModel_Start.htm)|  
(Унаследован от
[PerformanceCounterViewModel](T_Tessa_UI_Diagnostics_PerformanceCounterViewModel.htm))  
[StartOverride](M_Tessa_UI_Diagnostics_PerformanceTestViewModel_StartOverride.htm)|  
(Переопределяет
[PerformanceTestBaseViewModel.StartOverride()](M_Tessa_UI_Diagnostics_PerformanceTestBaseViewModel_StartOverride.htm))  
[Stop](M_Tessa_UI_Diagnostics_PerformanceCounterViewModel_Stop.htm)|  
(Унаследован от
[PerformanceCounterViewModel](T_Tessa_UI_Diagnostics_PerformanceCounterViewModel.htm))  
[StopOverride](M_Tessa_UI_Diagnostics_PerformanceTestViewModel_StopOverride.htm)|  
(Переопределяет
[PerformanceTestBaseViewModel.StopOverride()](M_Tessa_UI_Diagnostics_PerformanceTestBaseViewModel_StopOverride.htm))  
