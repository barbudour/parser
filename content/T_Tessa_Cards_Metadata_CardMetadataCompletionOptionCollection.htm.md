# CardMetadataCompletionOptionCollection - класс
...
C# __Копировать
    ...
    public sealed class CardMetadataCompletionOptionCollection : CardSerializableEntryCollection<CardMetadataCompletionOption>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardMetadataCompletionOptionCollection
    	Inherits CardSerializableEntryCollection(Of CardMetadataCompletionOption)
C++ __Копировать
    [SerializableAttribute]
    public ref class CardMetadataCompletionOptionCollection sealed : public CardSerializableEntryCollection<CardMetadataCompletionOption^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardMetadataCompletionOptionCollection = 
        class
            inherit CardSerializableEntryCollection<CardMetadataCompletionOption>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __[CardSerializableEntryCollection](T_Tessa_Cards_CardSerializableEntryCollection_1.htm)<[CardMetadataCompletionOption](T_Tessa_Cards_Metadata_CardMetadataCompletionOption.htm)> __ CardMetadataCompletionOptionCollection
##  __Конструкторы
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[XmlElementNameInternal](P_Tessa_Cards_Metadata_CardMetadataCompletionOptionCollection_XmlElementNameInternal.htm)|
...
[XmlItemNameInternal](P_Tessa_Cards_Metadata_CardMetadataCompletionOptionCollection_XmlItemNameInternal.htm)|
