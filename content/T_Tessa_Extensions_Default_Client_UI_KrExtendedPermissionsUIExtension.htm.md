# KrExtendedPermissionsUIExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrExtendedPermissionsUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrExtendedPermissionsUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrExtendedPermissionsUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrExtendedPermissionsUIExtension
##  __Конструкторы
[KrExtendedPermissionsUIExtension](M_Tessa_Extensions_Default_Client_UI_KrExtendedPermissionsUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrExtendedPermissionsUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrExtendedPermissionsUIExtension_Initialized.htm)|  
(Переопределяет
