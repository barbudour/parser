# CardTypeExtensionType - класс
Тип расширения для типа карточки, используемый в объектах метаинформации по
типу карточки [CardType](T_Tessa_Cards_CardType.htm) для связи с
пользовательским интерфейсом редактирования карточки и с выполнением
...
C# __Копировать
    ...
    public sealed class CardTypeExtensionType : RegistryItem<Guid, CardTypeExtensionType>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardTypeExtensionType
    	Inherits RegistryItem(Of Guid, CardTypeExtensionType)
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTypeExtensionType sealed : public RegistryItem<Guid, CardTypeExtensionType^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardTypeExtensionType = 
        class
            inherit RegistryItem<Guid, CardTypeExtensionType>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[RegistryItem](T_Tessa_Platform_RegistryItem_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), CardTypeExtensionType> __ CardTypeExtensionType
##  __Конструкторы
...
---|---  
[IsUnknown](P_Tessa_Cards_CardTypeExtensionType_IsUnknown.htm)|  Признак того,
что тип элемента управления неизвестен системе.  
[Name](P_Tessa_Platform_RegistryItem_2_Name.htm)| Имя объекта, по которому
объект можно идентифицировать в коллекциях.  
(Унаследован от [RegistryItem<TIdentifier,
TItem>](T_Tessa_Platform_RegistryItem_2.htm))  
[Registry](P_Tessa_Cards_CardTypeExtensionType_Registry.htm)| Реестр,
...
##  __Методы
[CreateUnknown](M_Tessa_Cards_CardTypeExtensionType_CreateUnknown.htm)|
...
[FromGuid](M_Tessa_Cards_CardTypeExtensionType_FromGuid.htm)|  Возвращает тип
по уникальному идентификатору, полученному посредством метода
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsAllowed](M_Tessa_Cards_CardTypeExtensionType_IsAllowed.htm)|  Возвращает
признак того, что расширение разрешено для заданного типа экземпляра карточки.  
...
TItem>](T_Tessa_Platform_RegistryItem_2.htm))  
##  __Поля
[UnknownName](F_Tessa_Cards_CardTypeExtensionType_UnknownName.htm)|  Тип
расширения, который не был найден в реестре типов.  
---|---  
## __Методы расширения
