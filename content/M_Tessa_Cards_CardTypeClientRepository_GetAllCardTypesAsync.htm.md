# CardTypeClientRepository.GetAllCardTypesAsync - метод
...
#### Реализации
[ICardTypeClientRepository.GetAllCardTypesAsync(CancellationToken)](M_Tessa_Cards_ICardTypeClientRepository_GetAllCardTypesAsync.htm)  
##  __См. также
#### Ссылки
