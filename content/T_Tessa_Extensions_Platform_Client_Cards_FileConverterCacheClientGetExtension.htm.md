# FileConverterCacheClientGetExtension - класс
...
C# __Копировать
     public sealed class FileConverterCacheClientGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class FileConverterCacheClientGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class FileConverterCacheClientGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type FileConverterCacheClientGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ FileConverterCacheClientGetExtension
##  __Конструкторы
[FileConverterCacheClientGetExtension](M_Tessa_Extensions_Platform_Client_Cards_FileConverterCacheClientGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса FileConverterCacheClientGetExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Client_Cards_FileConverterCacheClientGetExtension_BeforeRequest.htm)|  
(Переопределяет
