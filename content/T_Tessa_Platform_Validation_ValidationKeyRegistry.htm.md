...
C# __Копировать
     public sealed class ValidationKeyRegistry : NamedRegistry<ValidationKey>, 
    	IValidationKeyRegistry, INamedRegistry<ValidationKey>, IRegistry<Guid, ValidationKey>
VB __Копировать
     Public NotInheritable Class ValidationKeyRegistry
    	Inherits NamedRegistry(Of ValidationKey)
    	Implements IValidationKeyRegistry, INamedRegistry(Of ValidationKey), 
    	IRegistry(Of Guid, ValidationKey)
C++ __Копировать
     public ref class ValidationKeyRegistry sealed : public NamedRegistry<ValidationKey^>, 
    	IValidationKeyRegistry, INamedRegistry<ValidationKey^>, IRegistry<Guid, ValidationKey^>
F# __Копировать
     [<SealedAttribute>]
    type ValidationKeyRegistry = 
        class
            inherit NamedRegistry<ValidationKey>
            interface IValidationKeyRegistry
            interface INamedRegistry<ValidationKey>
            interface IRegistry<Guid, ValidationKey>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Registry](T_Tessa_Platform_Registry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [ValidationKey](T_Tessa_Platform_Validation_ValidationKey.htm)> __[NamedRegistry](T_Tessa_Platform_NamedRegistry_1.htm)<[ValidationKey](T_Tessa_Platform_Validation_ValidationKey.htm)> __ ValidationKeyRegistry
Implements
    [INamedRegistry](T_Tessa_Platform_INamedRegistry_1.htm)<[ValidationKey](T_Tessa_Platform_Validation_ValidationKey.htm)>, [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [ValidationKey](T_Tessa_Platform_Validation_ValidationKey.htm)>, [IValidationKeyRegistry](T_Tessa_Platform_Validation_IValidationKeyRegistry.htm)
##  __Свойства
[Instance](P_Tessa_Platform_Validation_ValidationKeyRegistry_Instance.htm)|
Экземпляр класса.  
---|---  
##  __Методы
