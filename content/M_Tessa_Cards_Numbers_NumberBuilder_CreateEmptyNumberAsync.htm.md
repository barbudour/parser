# NumberBuilder.CreateEmptyNumberAsync - метод
...
C# __Копировать
     public ValueTask<INumberObject> CreateEmptyNumberAsync(
    	NumberTypeDescriptor numberType,
    	Dictionary<string, Object> info = null,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Public Function CreateEmptyNumberAsync ( 
...
C++ __Копировать
     public:
    virtual ValueTask<INumberObject^> CreateEmptyNumberAsync(
    	NumberTypeDescriptor^ numberType, 
...
F# __Копировать
    ...
    *)
    ...
    override CreateEmptyNumberAsync : 
            numberType : NumberTypeDescriptor * 
            ?info : Dictionary<string, Object> * 
            ?cancellationToken : CancellationToken 
    (* Defaults:
...
#### Реализации
[INumberBuilder.CreateEmptyNumberAsync(NumberTypeDescriptor,
Dictionary<String, Object>,
CancellationToken)](M_Tessa_Cards_Numbers_INumberBuilder_CreateEmptyNumberAsync.htm)  
##  __См. также
#### Ссылки
