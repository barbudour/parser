# UpdatePackageBuilderContext - класс
...
C# __Копировать
     public class UpdatePackageBuilderContext : IApplicationPackageBuilderContext
VB __Копировать
     Public Class UpdatePackageBuilderContext
    	Implements IApplicationPackageBuilderContext
C++ __Копировать
     public ref class UpdatePackageBuilderContext : IApplicationPackageBuilderContext
F# __Копировать
     type UpdatePackageBuilderContext = 
        class
            interface IApplicationPackageBuilderContext
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ UpdatePackageBuilderContext
Implements
    [IApplicationPackageBuilderContext](T_Tessa_Applications_Package_IApplicationPackageBuilderContext.htm)
##  __Конструкторы
[UpdatePackageBuilderContext](M_Tessa_Applications_Package_UpdatePackageBuilderContext__ctor.htm)|
Initializes a new instance of the UpdatePackageBuilderContext class.
...
## __Методы
[BuildAsync](M_Tessa_Applications_Package_UpdatePackageBuilderContext_BuildAsync.htm)|
