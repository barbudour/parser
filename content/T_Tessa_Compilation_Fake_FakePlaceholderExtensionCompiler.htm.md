# FakePlaceholderExtensionCompiler - класс
...
C# __Копировать
     public sealed class FakePlaceholderExtensionCompiler : IPlaceholderExtensionCompiler
VB __Копировать
     Public NotInheritable Class FakePlaceholderExtensionCompiler
    	Implements IPlaceholderExtensionCompiler
C++ __Копировать
     public ref class FakePlaceholderExtensionCompiler sealed : IPlaceholderExtensionCompiler
F# __Копировать
     [<SealedAttribute>]
    type FakePlaceholderExtensionCompiler = 
        class
            interface IPlaceholderExtensionCompiler
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FakePlaceholderExtensionCompiler
Implements
    [IPlaceholderExtensionCompiler](T_Tessa_Platform_Placeholders_Compilation_IPlaceholderExtensionCompiler.htm)
##  __Конструкторы
[FakePlaceholderExtensionCompiler](M_Tessa_Compilation_Fake_FakePlaceholderExtensionCompiler__ctor.htm)|
Инициализирует новый экземпляр класса FakePlaceholderExtensionCompiler  
---|---  
##  __Свойства
...
## __Методы
[Compile](M_Tessa_Compilation_Fake_FakePlaceholderExtensionCompiler_Compile.htm)|
Метод для компиляции расширений плейсхолдеров
