# WorkflowActionStateStorage - класс
...
C# __Копировать
    ...
    public sealed class WorkflowActionStateStorage : WorkflowStateStorageBase<WorkflowActionStorage>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowActionStateStorage
    	Inherits WorkflowStateStorageBase(Of WorkflowActionStorage)
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowActionStateStorage sealed : public WorkflowStateStorageBase<WorkflowActionStorage^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowActionStateStorage = 
        class
            inherit WorkflowStateStorageBase<WorkflowActionStorage>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __[WorkflowStateStorageBase](T_Tessa_Workflow_Storage_WorkflowStateStorageBase_1.htm)<[WorkflowActionStorage](T_Tessa_Workflow_Storage_WorkflowActionStorage.htm)> __ WorkflowActionStateStorage
##  __Конструкторы
[WorkflowActionStateStorage()](M_Tessa_Workflow_Storage_WorkflowActionStateStorage__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowActionStateStorage  
---|---  
[WorkflowActionStateStorage(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowActionStateStorage__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowActionStateStorage  
[WorkflowActionStateStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowActionStateStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowActionStateStorage  
[WorkflowActionStateStorage(WorkflowActionStorage)](M_Tessa_Workflow_Storage_WorkflowActionStateStorage__ctor_3.htm)|
Инициализирует новый экземпляр класса WorkflowActionStateStorage  
##  __Свойства
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[Clone](M_Tessa_Workflow_Storage_WorkflowActionStateStorage_Clone.htm)|  
(Переопределяет
