# ConfigurationVersionDeleteExtension - класс
...
C# __Копировать
     public sealed class ConfigurationVersionDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class ConfigurationVersionDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class ConfigurationVersionDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type ConfigurationVersionDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ ConfigurationVersionDeleteExtension
##  __Конструкторы
[ConfigurationVersionDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_ConfigurationVersionDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса ConfigurationVersionDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[AfterRequestFinally](M_Tessa_Extensions_Platform_Server_Cards_ConfigurationVersionDeleteExtension_AfterRequestFinally.htm)|  
(Переопределяет
