...
C# __Копировать
     public sealed class TemplateGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class TemplateGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class TemplateGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type TemplateGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ TemplateGetExtension
##  __Конструкторы
[TemplateGetExtension](M_Tessa_Extensions_Platform_Server_Cards_TemplateGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса TemplateGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_TemplateGetExtension_AfterRequest.htm)|  
(Переопределяет
