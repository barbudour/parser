# KrConstants.KrDialogStageTypeSettingsVirtual.KeepFiles - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly KeepFiles As String
C++ __Копировать
     public:
    static initonly String^ KeepFiles
F# __Копировать
     static val KeepFiles: string
#### Значение поля
