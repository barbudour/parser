# SchemeInitializationException - класс
##  __Definition
 **Пространство имён:** [Tessa.Scheme](N_Tessa_Scheme.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public class SchemeInitializationException : SchemeException
VB __Копировать
    <SerializableAttribute>
    Public Class SchemeInitializationException
    	Inherits SchemeException
C++ __Копировать
    [SerializableAttribute]
    public ref class SchemeInitializationException : public SchemeException
F# __Копировать
     [<SerializableAttribute>]
    type SchemeInitializationException = 
        class
            inherit SchemeException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[SchemeException](T_Tessa_Scheme_SchemeException.htm) __ SchemeInitializationException
Derived
[Tessa.Scheme.SchemeUpgradeException](T_Tessa_Scheme_SchemeUpgradeException.htm)
##  __Конструкторы
[SchemeInitializationException()](M_Tessa_Scheme_SchemeInitializationException__ctor.htm)|
Инициализирует новый экземпляр класса SchemeInitializationException  
---|---  
[SchemeInitializationException(String)](M_Tessa_Scheme_SchemeInitializationException__ctor_2.htm)|
Инициализирует новый экземпляр класса SchemeInitializationException  
[SchemeInitializationException(SerializationInfo,
StreamingContext)](M_Tessa_Scheme_SchemeInitializationException__ctor_1.htm)|
Инициализирует новый экземпляр класса SchemeInitializationException  
[SchemeInitializationException(String,
Exception)](M_Tessa_Scheme_SchemeInitializationException__ctor_3.htm)|
Инициализирует новый экземпляр класса SchemeInitializationException  
##  __Свойства
