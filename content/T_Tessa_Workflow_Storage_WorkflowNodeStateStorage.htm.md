# WorkflowNodeStateStorage - класс
...
C# __Копировать
    ...
    public sealed class WorkflowNodeStateStorage : WorkflowStateStorageBase<WorkflowNodeStorage>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowNodeStateStorage
    	Inherits WorkflowStateStorageBase(Of WorkflowNodeStorage)
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowNodeStateStorage sealed : public WorkflowStateStorageBase<WorkflowNodeStorage^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowNodeStateStorage = 
        class
            inherit WorkflowStateStorageBase<WorkflowNodeStorage>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __[WorkflowStateStorageBase](T_Tessa_Workflow_Storage_WorkflowStateStorageBase_1.htm)<[WorkflowNodeStorage](T_Tessa_Workflow_Storage_WorkflowNodeStorage.htm)> __ WorkflowNodeStateStorage
##  __Конструкторы
[WorkflowNodeStateStorage()](M_Tessa_Workflow_Storage_WorkflowNodeStateStorage__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowNodeStateStorage  
---|---  
[WorkflowNodeStateStorage(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowNodeStateStorage__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowNodeStateStorage  
[WorkflowNodeStateStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowNodeStateStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowNodeStateStorage  
[WorkflowNodeStateStorage(WorkflowNodeStorage,
Nullable<Guid>)](M_Tessa_Workflow_Storage_WorkflowNodeStateStorage__ctor_3.htm)|
Инициализирует новый экземпляр класса WorkflowNodeStateStorage  
##  __Свойства
[Actions](P_Tessa_Workflow_Storage_WorkflowNodeStateStorage_Actions.htm)|
Список экземпляров действий текущего узла  
---|---  
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[ProcessInstanceID](P_Tessa_Workflow_Storage_WorkflowNodeStateStorage_ProcessInstanceID.htm)|  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[ClearChanges](M_Tessa_Workflow_Storage_WorkflowNodeStateStorage_ClearChanges.htm)|  
(Переопределяет
[WorkflowStorageBase.ClearChanges()](M_Tessa_Workflow_Storage_WorkflowStorageBase_ClearChanges.htm))  
[Clone](M_Tessa_Workflow_Storage_WorkflowNodeStateStorage_Clone.htm)|  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[HasChanges](M_Tessa_Workflow_Storage_WorkflowNodeStateStorage_HasChanges.htm)|  
(Переопределяет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[UpdateData](M_Tessa_Workflow_Storage_WorkflowNodeStateStorage_UpdateData.htm)|  
(Переопределяет
