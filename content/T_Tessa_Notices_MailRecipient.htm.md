# MailRecipient - класс
Получатель письма (основной получатель, получатель в копии или получать в
скрытой копии).
## __Definition
...
C# __Копировать
    ...
    public sealed class MailRecipient : StorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class MailRecipient
    	Inherits StorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class MailRecipient sealed : public StorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ MailRecipient
Implements
    [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable)
##  __Конструкторы
[MailRecipient()](M_Tessa_Notices_MailRecipient__ctor.htm)|  Создаёт экземпляр
класса и пустое хранилище Dictionary<string, object>, декоратором для которого
является создаваемый объект.  
---|---  
[MailRecipient(Dictionary<String,
Object>)](M_Tessa_Notices_MailRecipient__ctor_1.htm)| Создаёт экземпляр класса
с указанием хранилища, декоратором для которого является создаваемый объект.  
[MailRecipient(IStorageObjectProvider)](M_Tessa_Notices_MailRecipient__ctor_2.htm)|
...
## __Свойства
[DisplayName](P_Tessa_Notices_MailRecipient_DisplayName.htm)|  Отображаемое
имя получателя. Может быть равно null или пустой строке. Заполнять свойство
необязательно.  
---|---  
[Email](P_Tessa_Notices_MailRecipient_Email.htm)|  Адрес получателя. Свойство
обязательно для заполнения.  
[Type](P_Tessa_Notices_MailRecipient_Type.htm)|  Тип получателя. По умолчанию
указывается [To](T_Tessa_Notices_MailRecipientType.htm).  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Notices_MailRecipient_Clone.htm)|  Выполняет глубокое
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
##  __Поля
[DisplayNameKey](F_Tessa_Notices_MailRecipient_DisplayNameKey.htm)|  
---|---  
[EmailKey](F_Tessa_Notices_MailRecipient_EmailKey.htm)|  
[TypeKey](F_Tessa_Notices_MailRecipient_TypeKey.htm)|  
## __Методы расширения
