# NotificationGetExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class NotificationGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class NotificationGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type NotificationGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ NotificationGetExtension
##  __Конструкторы
[NotificationGetExtension](M_Tessa_Extensions_Default_Server_Notices_NotificationGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса NotificationGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Notices_NotificationGetExtension_AfterRequest.htm)|  
(Переопределяет
