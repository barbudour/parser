# FixRoleGeneratorStoreExtension - класс
...
C# __Копировать
     public sealed class FixRoleGeneratorStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class FixRoleGeneratorStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class FixRoleGeneratorStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type FixRoleGeneratorStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ FixRoleGeneratorStoreExtension
##  __Конструкторы
[FixRoleGeneratorStoreExtension](M_Tessa_Extensions_Platform_Server_Roles_FixRoleGeneratorStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса FixRoleGeneratorStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Roles_FixRoleGeneratorStoreExtension_BeforeRequest.htm)|  
(Переопределяет
