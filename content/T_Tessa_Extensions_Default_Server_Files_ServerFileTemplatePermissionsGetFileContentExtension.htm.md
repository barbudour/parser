# ServerFileTemplatePermissionsGetFileContentExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class ServerFileTemplatePermissionsGetFileContentExtension : CardGetFileContentExtension
VB __Копировать
     Public NotInheritable Class ServerFileTemplatePermissionsGetFileContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class ServerFileTemplatePermissionsGetFileContentExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type ServerFileTemplatePermissionsGetFileContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ ServerFileTemplatePermissionsGetFileContentExtension
##  __Конструкторы
[ServerFileTemplatePermissionsGetFileContentExtension](M_Tessa_Extensions_Default_Server_Files_ServerFileTemplatePermissionsGetFileContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса
ServerFileTemplatePermissionsGetFileContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Files_ServerFileTemplatePermissionsGetFileContentExtension_BeforeRequest.htm)|  
(Переопределяет
