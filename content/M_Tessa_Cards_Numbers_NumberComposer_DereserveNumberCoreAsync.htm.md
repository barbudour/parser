# NumberComposer.DereserveNumberCoreAsync - метод
...
C# __Копировать
     protected virtual Task<bool> DereserveNumberCoreAsync(
    	INumberContext context,
    	INumberObject number,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Protected Overridable Function DereserveNumberCoreAsync ( 
...
C++ __Копировать
     protected:
    virtual Task<bool>^ DereserveNumberCoreAsync(
    	INumberContext^ context, 
    	INumberObject^ number, 
    	CancellationToken cancellationToken = CancellationToken()
    )
F# __Копировать
     abstract DereserveNumberCoreAsync : 
    ...
    *)
    -> Task<bool> 
    override DereserveNumberCoreAsync : 
            context : INumberContext * 
            number : INumberObject * 
            ?cancellationToken : CancellationToken 
    (* Defaults:
