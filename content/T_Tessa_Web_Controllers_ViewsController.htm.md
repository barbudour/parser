...
C# __Копировать
    ...
    public sealed class ViewsController : Controller
VB __Копировать
    <RouteAttribute("api/v1/views")>
    <AllowAnonymousAttribute>
    <ApiControllerAttribute>
    ...
    <ProducesResponseTypeAttribute(401)>
    <ProducesResponseTypeAttribute(403)>
    Public NotInheritable Class ViewsController
    	Inherits Controller
C++ __Копировать
    [RouteAttribute(L"api/v1/views")]
    [AllowAnonymousAttribute]
    [ApiControllerAttribute]
    [ProducesErrorResponseTypeAttribute(typeof(PlainValidationResult))]
    [ProducesResponseTypeAttribute(400)]
    [ProducesResponseTypeAttribute(401)]
    [ProducesResponseTypeAttribute(403)]
    public ref class ViewsController sealed : public Controller
F# __Копировать
     [<SealedAttribute>]
    [<RouteAttribute("api/v1/views")>]
    [<AllowAnonymousAttribute>]
    ...
    [<ProducesResponseTypeAttribute(401)>]
    [<ProducesResponseTypeAttribute(403)>]
    type ViewsController = 
        class
            inherit Controller
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase) __[Controller](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controller) __ ViewsController
##  __Конструкторы
[ViewsController](M_Tessa_Web_Controllers_ViewsController__ctor.htm)|
Инициализирует новый экземпляр класса ViewsController  
---|---  
##  __Свойства
...
(Унаследован от
[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase))  
[Delete](M_Tessa_Web_Controllers_ViewsController_Delete.htm)|  Удаляет одно
или несколько представлений. Метод доступен только администраторам.  
...
(Унаследован от
[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase))  
[GetAll](M_Tessa_Web_Controllers_ViewsController_GetAll.htm)|  Возвращает
общую метаинформацию по всем представлениям, доступным текущего сотруднику.
Такая метаинформация требуется для выполнения запросов к представлению, но не
содержит информации о внутреннем устройстве SQL запроса.  
...
(Унаследован от
[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase))  
[PostCreate](M_Tessa_Web_Controllers_ViewsController_PostCreate.htm)|
Сохраняет одно или несколько представлений. Метод доступен только
администраторам.  
[PostGetData](M_Tessa_Web_Controllers_ViewsController_PostGetData.htm)|
Выполняет представление и возвращает сериализованный результат выполнения.
Представление должно быть доступно для текущего пользователя.  
[PostGetModels](M_Tessa_Web_Controllers_ViewsController_PostGetModels.htm)|
Возвращает метаинформацию по запрошенным представлениям. Метод доступен только
администраторам.  
[PostImport](M_Tessa_Web_Controllers_ViewsController_PostImport.htm)|
Импортирует заданные представления. Метод доступен только администраторам.  
