# PersonalizationUserSettingsMetadataExtension - класс
...
C# __Копировать
     public sealed class PersonalizationUserSettingsMetadataExtension : CardTypeMetadataExtension
VB __Копировать
     Public NotInheritable Class PersonalizationUserSettingsMetadataExtension
    	Inherits CardTypeMetadataExtension
C++ __Копировать
     public ref class PersonalizationUserSettingsMetadataExtension sealed : public CardTypeMetadataExtension
F# __Копировать
     [<SealedAttribute>]
    type PersonalizationUserSettingsMetadataExtension = 
        class
            inherit CardTypeMetadataExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardMetadataExtension](T_Tessa_Cards_Extensions_CardMetadataExtension.htm) __[CardTypeMetadataExtension](T_Tessa_Cards_Extensions_CardTypeMetadataExtension.htm) __ PersonalizationUserSettingsMetadataExtension
##  __Конструкторы
[PersonalizationUserSettingsMetadataExtension()](M_Tessa_Extensions_Platform_Shared_Cards_PersonalizationUserSettingsMetadataExtension__ctor.htm)|
Инициализирует новый экземпляр класса
PersonalizationUserSettingsMetadataExtension  
---|---  
[PersonalizationUserSettingsMetadataExtension(ICardMetadata)](M_Tessa_Extensions_Platform_Shared_Cards_PersonalizationUserSettingsMetadataExtension__ctor_1.htm)|
Инициализирует новый экземпляр класса
PersonalizationUserSettingsMetadataExtension  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ModifyMetadata](M_Tessa_Extensions_Platform_Shared_Cards_PersonalizationUserSettingsMetadataExtension_ModifyMetadata.htm)|  
(Переопределяет
