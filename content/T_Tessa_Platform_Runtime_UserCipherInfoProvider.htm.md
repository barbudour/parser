...
C# __Копировать
     public sealed class UserCipherInfoProvider : IUserCipherInfoProvider
VB __Копировать
     Public NotInheritable Class UserCipherInfoProvider
    	Implements IUserCipherInfoProvider
C++ __Копировать
     public ref class UserCipherInfoProvider sealed : IUserCipherInfoProvider
F# __Копировать
     [<SealedAttribute>]
    type UserCipherInfoProvider = 
        class
            interface IUserCipherInfoProvider
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ UserCipherInfoProvider
Implements
    [IUserCipherInfoProvider](T_Tessa_Platform_Runtime_IUserCipherInfoProvider.htm)
##  __Конструкторы
[UserCipherInfoProvider](M_Tessa_Platform_Runtime_UserCipherInfoProvider__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetCipherInfoObjectAsync](M_Tessa_Platform_Runtime_UserCipherInfoProvider_GetCipherInfoObjectAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[StoreCipherInfoObjectAsync](M_Tessa_Platform_Runtime_UserCipherInfoProvider_StoreCipherInfoObjectAsync.htm)|
