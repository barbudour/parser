...
VB __Копировать
     Public NotInheritable Class NotificationContext
    	Implements INotificationContext
C++ __Копировать
     public ref class NotificationContext sealed : INotificationContext
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ NotificationContext
Implements
    [INotificationContext](T_Tessa_Extensions_Default_Shared_Notices_INotificationContext.htm)
##  __Конструкторы
[NotificationContext](M_Tessa_Extensions_Default_Shared_Notices_NotificationContext__ctor.htm)|
Инициализирует новый экземпляр класса NotificationContext  
---|---  
##  __Свойства
