# WorkflowTemplateStorageBase - класс
...
C# __Копировать
     public abstract class WorkflowTemplateStorageBase : WorkflowStorageBase, 
    	INotifyPropertyChanged
VB __Копировать
     Public MustInherit Class WorkflowTemplateStorageBase
    	Inherits WorkflowStorageBase
    	Implements INotifyPropertyChanged
C++ __Копировать
     public ref class WorkflowTemplateStorageBase abstract : public WorkflowStorageBase, 
    	INotifyPropertyChanged
F# __Копировать
     [<AbstractClassAttribute>]
    type WorkflowTemplateStorageBase = 
        class
            inherit WorkflowStorageBase
            interface INotifyPropertyChanged
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __ WorkflowTemplateStorageBase
Derived
[Tessa.Workflow.Storage.WorkflowActionStorage](T_Tessa_Workflow_Storage_WorkflowActionStorage.htm)
[Tessa.Workflow.Storage.WorkflowElementTemplateStorage](T_Tessa_Workflow_Storage_WorkflowElementTemplateStorage.htm)
[Tessa.Workflow.Storage.WorkflowLinkStorage](T_Tessa_Workflow_Storage_WorkflowLinkStorage.htm)
[Tessa.Workflow.Storage.WorkflowTemplateStorageWithDescriptionBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageWithDescriptionBase.htm)
Implements
    [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged)
##  __Конструкторы
[WorkflowTemplateStorageBase(Dictionary<String, Object>,
WorkflowTemplateStorageBase)](M_Tessa_Workflow_Storage_WorkflowTemplateStorageBase__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowTemplateStorageBase  
---|---  
[WorkflowTemplateStorageBase(SerializationInfo,
StreamingContext)](M_Tessa_Workflow_Storage_WorkflowTemplateStorageBase__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowTemplateStorageBase  
##  __Свойства
