# BackupCardDeleteExtension - класс
...
C# __Копировать
     public sealed class BackupCardDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class BackupCardDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class BackupCardDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type BackupCardDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ BackupCardDeleteExtension
##  __Конструкторы
[BackupCardDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_BackupCardDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса BackupCardDeleteExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Cards_BackupCardDeleteExtension_AfterBeginTransaction.htm)|  
(Переопределяет
...
---|---  
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_BackupCardDeleteExtension_AfterRequest.htm)|  
(Переопределяет
