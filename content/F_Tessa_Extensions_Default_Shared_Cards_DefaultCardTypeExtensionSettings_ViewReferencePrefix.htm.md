# DefaultCardTypeExtensionSettings.ViewReferencePrefix - поле
...
C# __Копировать
     public static readonly string ViewReferencePrefix
VB __Копировать
     Public Shared ReadOnly ViewReferencePrefix As String
C++ __Копировать
     public:
    static initonly String^ ViewReferencePrefix
F# __Копировать
     static val ViewReferencePrefix: string
#### Значение поля
