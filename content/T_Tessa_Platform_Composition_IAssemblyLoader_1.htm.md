...
## __Методы
[CreateInstance](M_Tessa_Platform_Composition_IAssemblyLoader_1_CreateInstance.htm)|
...
IAssemblyLoaderOptions)](M_Tessa_Platform_Composition_IAssemblyLoader_1_Export.htm)|
Экспортирует метаинформацию по заданному списку атрибутов.  
[Export<TAttribute>(IAssemblyLoaderOptions)](M_Tessa_Platform_Composition_IAssemblyLoader_1_Export__1.htm)|
Экспортирует метаинформацию по заданному атрибуту.  
[GetType](M_Tessa_Platform_Composition_IAssemblyLoader_1_GetType.htm)|
