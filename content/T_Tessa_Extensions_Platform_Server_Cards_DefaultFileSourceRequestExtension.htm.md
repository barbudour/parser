# DefaultFileSourceRequestExtension - класс
...
C# __Копировать
     public sealed class DefaultFileSourceRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class DefaultFileSourceRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class DefaultFileSourceRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type DefaultFileSourceRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ DefaultFileSourceRequestExtension
##  __Конструкторы
[DefaultFileSourceRequestExtension](M_Tessa_Extensions_Platform_Server_Cards_DefaultFileSourceRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса DefaultFileSourceRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_DefaultFileSourceRequestExtension_AfterRequest.htm)|  
(Переопределяет
