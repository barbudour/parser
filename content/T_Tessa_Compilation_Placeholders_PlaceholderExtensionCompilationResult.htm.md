# PlaceholderExtensionCompilationResult - класс
...
C# __Копировать
    ...
    public sealed class PlaceholderExtensionCompilationResult : IPlaceholderExtensionCompilationResult
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class PlaceholderExtensionCompilationResult
    	Implements IPlaceholderExtensionCompilationResult
C++ __Копировать
    [SerializableAttribute]
    public ref class PlaceholderExtensionCompilationResult sealed : IPlaceholderExtensionCompilationResult
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type PlaceholderExtensionCompilationResult = 
        class
            interface IPlaceholderExtensionCompilationResult
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ PlaceholderExtensionCompilationResult
Implements
...
##  __Конструкторы
[PlaceholderExtensionCompilationResult](M_Tessa_Compilation_Placeholders_PlaceholderExtensionCompilationResult__ctor.htm)|
Инициализирует новый экземпляр класса PlaceholderExtensionCompilationResult  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetExtensionScript](M_Tessa_Compilation_Placeholders_PlaceholderExtensionCompilationResult_GetExtensionScript.htm)|
