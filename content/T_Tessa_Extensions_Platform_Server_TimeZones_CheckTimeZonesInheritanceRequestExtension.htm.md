# CheckTimeZonesInheritanceRequestExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.TimeZones](N_Tessa_Extensions_Platform_Server_TimeZones.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class CheckTimeZonesInheritanceRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class CheckTimeZonesInheritanceRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class CheckTimeZonesInheritanceRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type CheckTimeZonesInheritanceRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ CheckTimeZonesInheritanceRequestExtension
##  __Конструкторы
[CheckTimeZonesInheritanceRequestExtension](M_Tessa_Extensions_Platform_Server_TimeZones_CheckTimeZonesInheritanceRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса
CheckTimeZonesInheritanceRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_TimeZones_CheckTimeZonesInheritanceRequestExtension_AfterRequest.htm)|  
(Переопределяет
