# AuthenticationServiceResolver - класс
...
C# __Копировать
     public sealed class AuthenticationServiceResolver : NamedResolver<IAuthenticationService>, 
    	IAuthenticationServiceResolver, IResolver<string, IAuthenticationService>
VB __Копировать
     Public NotInheritable Class AuthenticationServiceResolver
    	Inherits NamedResolver(Of IAuthenticationService)
    	Implements IAuthenticationServiceResolver, IResolver(Of String, IAuthenticationService)
C++ __Копировать
     public ref class AuthenticationServiceResolver sealed : public NamedResolver<IAuthenticationService^>, 
    	IAuthenticationServiceResolver, IResolver<String^, IAuthenticationService^>
F# __Копировать
     [<SealedAttribute>]
    type AuthenticationServiceResolver = 
        class
            inherit NamedResolver<IAuthenticationService>
            interface IAuthenticationServiceResolver
            interface IResolver<string, IAuthenticationService>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Resolver](T_Tessa_Platform_Resolver_2.htm)<[String](https://learn.microsoft.com/dotnet/api/system.string), [IAuthenticationService](T_Tessa_Platform_Runtime_IAuthenticationService.htm)> __[NamedResolver](T_Tessa_Platform_NamedResolver_1.htm)<[IAuthenticationService](T_Tessa_Platform_Runtime_IAuthenticationService.htm)> __ AuthenticationServiceResolver
Implements
    [IResolver](T_Tessa_Platform_IResolver_2.htm)<[String](https://learn.microsoft.com/dotnet/api/system.string), [IAuthenticationService](T_Tessa_Platform_Runtime_IAuthenticationService.htm)>, [IAuthenticationServiceResolver](T_Tessa_Platform_Runtime_IAuthenticationServiceResolver.htm)
##  __Конструкторы
[AuthenticationServiceResolver](M_Tessa_Platform_Runtime_AuthenticationServiceResolver__ctor.htm)|
