...
VB __Копировать
     Public Class PreprocessorResult
    	Implements IPreprocessorResult
C++ __Копировать
     public ref class PreprocessorResult : IPreprocessorResult
F# __Копировать
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ PreprocessorResult
Implements
    [IPreprocessorResult](T_Tessa_Compilation_IPreprocessorResult.htm)
##  __Конструкторы
[PreprocessorResult](M_Tessa_Compilation_PreprocessorResult__ctor.htm)|
