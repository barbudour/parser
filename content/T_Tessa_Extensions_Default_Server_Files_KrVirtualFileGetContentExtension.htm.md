# KrVirtualFileGetContentExtension - класс
...
C# __Копировать
     public sealed class KrVirtualFileGetContentExtension : CardGetFileContentExtension
VB __Копировать
     Public NotInheritable Class KrVirtualFileGetContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class KrVirtualFileGetContentExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type KrVirtualFileGetContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ KrVirtualFileGetContentExtension
##  __Конструкторы
[KrVirtualFileGetContentExtension](M_Tessa_Extensions_Default_Server_Files_KrVirtualFileGetContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrVirtualFileGetContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Files_KrVirtualFileGetContentExtension_BeforeRequest.htm)|  
(Переопределяет
