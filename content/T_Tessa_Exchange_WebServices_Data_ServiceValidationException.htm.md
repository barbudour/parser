# ServiceValidationException - класс
...
C++ __Копировать
     public ref class ServiceValidationException sealed : public ServiceLocalException
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceLocalException](T_Tessa_Exchange_WebServices_Data_ServiceLocalException.htm) __ ServiceValidationException
##  __Конструкторы
[ServiceValidationException()](M_Tessa_Exchange_WebServices_Data_ServiceValidationException__ctor.htm)|
ServiceValidationException Constructor.  
---|---  
[ServiceValidationException(String)](M_Tessa_Exchange_WebServices_Data_ServiceValidationException__ctor_1.htm)|
ServiceValidationException Constructor.  
[ServiceValidationException(String,
Exception)](M_Tessa_Exchange_WebServices_Data_ServiceValidationException__ctor_2.htm)|
ServiceValidationException Constructor.  
## __Свойства
