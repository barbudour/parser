...
VB __Копировать
     Public Interface ICardGetExtensionContext
    	Inherits ICardRequestExtensionContext(Of CardGetRequest, CardGetResponse), ICardExtensionContext, 
    	ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
C++ __Копировать
     public interface class ICardGetExtensionContext : ICardRequestExtensionContext<CardGetRequest^, CardGetResponse^>, 
    	ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
F# __Копировать
     type ICardGetExtensionContext = 
        interface
...
(Унаследован от
[ICardExtensionContext](T_Tessa_Cards_Extensions_ICardExtensionContext.htm))  
[Method](P_Tessa_Cards_Extensions_ICardGetExtensionContext_Method.htm)| Способ
загрузки карточки.  
