# HashingStream - класс
Поток для вычисления хеш-функции от входящего потока по завершению чтения. Не
поддерживает запись. Вызовите метод
...
VB __Копировать
     Public Class HashingStream
    	Inherits Stream
C++ __Копировать
     public ref class HashingStream : public Stream
F# __Копировать
     type HashingStream = 
        class
            inherit Stream
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[MarshalByRefObject](https://learn.microsoft.com/dotnet/api/system.marshalbyrefobject) __[Stream](https://learn.microsoft.com/dotnet/api/system.io.stream) __ HashingStream
##  __Конструкторы
[HashingStream](M_Tessa_Platform_IO_HashingStream__ctor.htm)|  Создаёт
экземпляр класса с указанием его параметров.  
---|---  
## __Свойства
[Buffer](P_Tessa_Platform_IO_HashingStream_Buffer.htm)|  Внутренний буфер, в
котором производится вычисление хеш-суммы.  
---|---  
[BufferActualSize](P_Tessa_Platform_IO_HashingStream_BufferActualSize.htm)|
Количество байт в буфере
[Buffer](P_Tessa_Platform_IO_HashingStream_Buffer.htm), которые заполнены
прочитанными данными. Равно -1 до начала чтения. Может быть равно меньше
размера массива [Buffer](P_Tessa_Platform_IO_HashingStream_Buffer.htm) для
последней итерации, т.к. данные для загрузки закончились.  
[BufferOffset](P_Tessa_Platform_IO_HashingStream_BufferOffset.htm)|  Текущее
смещение относительно начала буфера
[Buffer](P_Tessa_Platform_IO_HashingStream_Buffer.htm), данные которого будут
возвращены в этом потоке.  
[CanRead](P_Tessa_Platform_IO_HashingStream_CanRead.htm)| Признак того, что
поток поддерживает чтение данных.  
(Переопределяет
[Stream.CanRead](https://learn.microsoft.com/dotnet/api/system.io.stream.canread#system-
io-stream-canread))  
[CanSeek](P_Tessa_Platform_IO_HashingStream_CanSeek.htm)|  Признак того, что
...
[CanWrite](P_Tessa_Platform_IO_HashingStream_CanWrite.htm)|  Признак того, что
в поток можно записывать данные методом [System.IO.Stream.Write]. Свойство
всегда возвращает false.  
(Переопределяет
[Stream.CanWrite](https://learn.microsoft.com/dotnet/api/system.io.stream.canwrite#system-
io-stream-canwrite))  
[HashAlgorithm](P_Tessa_Platform_IO_HashingStream_HashAlgorithm.htm)|  Хеш-
алгоритм, используемый для вычисления хеш-суммы.  
[Length](P_Tessa_Platform_IO_HashingStream_Length.htm)| Общее количество
доступных в потоке байт.  
(Переопределяет
[Stream.Length](https://learn.microsoft.com/dotnet/api/system.io.stream.length#system-
io-stream-length))  
[Position](P_Tessa_Platform_IO_HashingStream_Position.htm)| Текущая позиция в
...
(Унаследован от
[Stream](https://learn.microsoft.com/dotnet/api/system.io.stream))  
[Stream](P_Tessa_Platform_IO_HashingStream_Stream.htm)|  Поток, при чтении из
которого вычисляется хеш-сумма.  
...
(Унаследован от
[Stream](https://learn.microsoft.com/dotnet/api/system.io.stream))  
[Dispose(Boolean)](M_Tessa_Platform_IO_HashingStream_Dispose.htm)| Освобождает
...
[Flush](M_Tessa_Platform_IO_HashingStream_Flush.htm)|  Записывает все данные
...
(Унаследован от
[Stream](https://learn.microsoft.com/dotnet/api/system.io.stream))  
[FlushAsync(CancellationToken)](M_Tessa_Platform_IO_HashingStream_FlushAsync.htm)|
...
(Унаследован от
[Stream](https://learn.microsoft.com/dotnet/api/system.io.stream))  
[Read(Byte[], Int32, Int32)](M_Tessa_Platform_IO_HashingStream_Read.htm)|
...
CancellationToken)](M_Tessa_Platform_IO_HashingStream_ReadAsync.htm)|
...
(Унаследован от
[Stream](https://learn.microsoft.com/dotnet/api/system.io.stream))  
[Seek](M_Tessa_Platform_IO_HashingStream_Seek.htm)| Изменяет текущую позицию в
...
[SetLength](M_Tessa_Platform_IO_HashingStream_SetLength.htm)| Устанавливает
...
(Унаследован от
[Stream](https://learn.microsoft.com/dotnet/api/system.io.stream))  
[Write(Byte[], Int32, Int32)](M_Tessa_Platform_IO_HashingStream_Write.htm)|
...
CancellationToken)](M_Tessa_Platform_IO_HashingStream_WriteAsync.htm)|
Записывает данные в поток из массива байт. Метод не поддерживается.  
