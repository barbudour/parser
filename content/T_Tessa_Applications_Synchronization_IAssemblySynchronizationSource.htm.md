# IAssemblySynchronizationSource - интерфейс
...
C# __Копировать
     public interface IAssemblySynchronizationSource : ISynchronizationSource, 
    	IValidationObject, IValidatable
VB __Копировать
     Public Interface IAssemblySynchronizationSource
    	Inherits ISynchronizationSource, IValidationObject, IValidatable
C++ __Копировать
     public interface class IAssemblySynchronizationSource : ISynchronizationSource, 
    	IValidationObject, IValidatable
F# __Копировать
     type IAssemblySynchronizationSource = 
        interface
