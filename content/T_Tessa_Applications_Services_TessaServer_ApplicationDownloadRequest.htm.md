# ApplicationDownloadRequest - класс
...
C# __Копировать
    ...
    public sealed class ApplicationDownloadRequest : StorageSerializable, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    <DataContractAttribute>
    Public NotInheritable Class ApplicationDownloadRequest
    	Inherits StorageSerializable
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    [DataContractAttribute]
    public ref class ApplicationDownloadRequest sealed : public StorageSerializable, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    [<DataContractAttribute>]
    type ApplicationDownloadRequest = 
        class
            inherit StorageSerializable
            interface ICloneable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageSerializable](T_Tessa_Platform_Storage_StorageSerializable.htm) __ ApplicationDownloadRequest
Implements
    [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable)
##  __Конструкторы
[ApplicationDownloadRequest](M_Tessa_Applications_Services_TessaServer_ApplicationDownloadRequest__ctor.htm)|
Инициализирует новый экземпляр класса ApplicationDownloadRequest  
---|---  
##  __Свойства
...
## __Методы
[Clone](M_Tessa_Applications_Services_TessaServer_ApplicationDownloadRequest_Clone.htm)|
The clone.  
---|---  
...
(Унаследован от
[StorageSerializable](T_Tessa_Platform_Storage_StorageSerializable.htm))  
[DeserializeCore](M_Tessa_Applications_Services_TessaServer_ApplicationDownloadRequest_DeserializeCore.htm)|
Выполняет десериализацию полей объекта из заданного хранилища.  
...
(Унаследован от
[StorageSerializable](T_Tessa_Platform_Storage_StorageSerializable.htm))  
[SerializeCore](M_Tessa_Applications_Services_TessaServer_ApplicationDownloadRequest_SerializeCore.htm)|
Выполняет сериализацию полей объекта в заданное хранилище.  
