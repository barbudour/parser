...
##  __Конструкторы
[Registrator](M_Tessa_Extensions_Platform_Client_Links_Registrator__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[FinalizeRegistration](M_Tessa_Extensions_Platform_Client_Links_Registrator_FinalizeRegistration.htm)|  
(Переопределяет
