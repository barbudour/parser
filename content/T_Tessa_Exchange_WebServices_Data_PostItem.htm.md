...
VB __Копировать
     Public NotInheritable Class PostItem
    	Inherits Item
C++ __Копировать
     public ref class PostItem sealed : public Item
F# __Копировать
     [<SealedAttribute>]
    type PostItem = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceObject](T_Tessa_Exchange_WebServices_Data_ServiceObject.htm) __[Item](T_Tessa_Exchange_WebServices_Data_Item.htm) __ PostItem
##  __Конструкторы
[PostItem](M_Tessa_Exchange_WebServices_Data_PostItem__ctor.htm)|  Initializes
an unsaved local instance of PostItem. To bind to an existing post item, use
...
(Унаследован от [Item](T_Tessa_Exchange_WebServices_Data_Item.htm))  
[ConversationIndex](P_Tessa_Exchange_WebServices_Data_PostItem_ConversationIndex.htm)|
Gets the conversation index of the post item.  
[ConversationTopic](P_Tessa_Exchange_WebServices_Data_PostItem_ConversationTopic.htm)|
...
value for this item.  
(Унаследован от [Item](T_Tessa_Exchange_WebServices_Data_Item.htm))  
[From](P_Tessa_Exchange_WebServices_Data_PostItem_From.htm)|  Gets or sets the
"on behalf" poster of the post item.  
...
(Унаследован от [Item](T_Tessa_Exchange_WebServices_Data_Item.htm))  
[InternetMessageId](P_Tessa_Exchange_WebServices_Data_PostItem_InternetMessageId.htm)|
...
(Унаследован от [Item](T_Tessa_Exchange_WebServices_Data_Item.htm))  
[IsRead](P_Tessa_Exchange_WebServices_Data_PostItem_IsRead.htm)|  Gets or sets
a value indicating whether the post item is read.  
...
sets the policy tag.  
(Унаследован от [Item](T_Tessa_Exchange_WebServices_Data_Item.htm))  
[PostedTime](P_Tessa_Exchange_WebServices_Data_PostItem_PostedTime.htm)|  Gets
the the date and time when the post item was posted.  
[Preview](P_Tessa_Exchange_WebServices_Data_Item_Preview.htm)|  Gets the item
Preview.  
(Унаследован от [Item](T_Tessa_Exchange_WebServices_Data_Item.htm))  
[References](P_Tessa_Exchange_WebServices_Data_PostItem_References.htm)|  Gets
or sets the references of the post item.  
...
(Унаследован от
[ServiceObject](T_Tessa_Exchange_WebServices_Data_ServiceObject.htm))  
[Sender](P_Tessa_Exchange_WebServices_Data_PostItem_Sender.htm)|  Gets or sets
the sender (poster) of the post item.  
...
ItemId)](M_Tessa_Exchange_WebServices_Data_PostItem_Bind.htm)|  Binds to an
existing post item and loads its first class properties. Calling this method
results in a call to EWS.  
---|---  
[Bind(ExchangeService, ItemId, PropertySet,
CancellationToken)](M_Tessa_Exchange_WebServices_Data_PostItem_Bind_1.htm)|
...
mailbox and a public folder.
(Унаследован от [Item](T_Tessa_Exchange_WebServices_Data_Item.htm))  
[CreateForward](M_Tessa_Exchange_WebServices_Data_PostItem_CreateForward.htm)|
Creates a forward response to the post item.  
[CreatePostReply](M_Tessa_Exchange_WebServices_Data_PostItem_CreatePostReply.htm)|
Creates a post reply to this post item.  
[CreateReply](M_Tessa_Exchange_WebServices_Data_PostItem_CreateReply.htm)|
...
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Forward(MessageBody,
IEnumerable<EmailAddress>)](M_Tessa_Exchange_WebServices_Data_PostItem_Forward.htm)|
Forwards the post item. Calling this method results in a call to EWS.  
[Forward(MessageBody,
EmailAddress[])](M_Tessa_Exchange_WebServices_Data_PostItem_Forward_1.htm)|
Forwards the post item. Calling this method results in a call to EWS.  
...
mailbox and a public folder.
(Унаследован от [Item](T_Tessa_Exchange_WebServices_Data_Item.htm))  
[PostReply](M_Tessa_Exchange_WebServices_Data_PostItem_PostReply.htm)|  Posts
a reply to this post item. Calling this method results in a call to EWS.  
[RemoveExtendedProperty](M_Tessa_Exchange_WebServices_Data_Item_RemoveExtendedProperty.htm)|
Removes an extended property.  
(Унаследован от [Item](T_Tessa_Exchange_WebServices_Data_Item.htm))  
[Reply](M_Tessa_Exchange_WebServices_Data_PostItem_Reply.htm)|  Replies to the
post item. Calling this method results in a call to EWS.  
