# KrConstants.KrCreateCardStageSettingsVirtual.TemplateCaption - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly TemplateCaption As String
C++ __Копировать
     public:
    static initonly String^ TemplateCaption
F# __Копировать
     static val TemplateCaption: string
#### Значение поля
