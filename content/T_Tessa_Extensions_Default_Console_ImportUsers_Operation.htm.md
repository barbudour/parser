...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ConsoleOperation](T_Tessa_Platform_ConsoleApps_ConsoleOperation_1.htm)<[OperationContext](T_Tessa_Extensions_Default_Console_ImportUsers_OperationContext.htm)> __ Operation
##  __Конструкторы
[Operation](M_Tessa_Extensions_Default_Console_ImportUsers_Operation__ctor.htm)|
...
[ExecuteAsync](M_Tessa_Extensions_Default_Console_ImportUsers_Operation_ExecuteAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[UpdateUserAsync](M_Tessa_Extensions_Default_Console_ImportUsers_Operation_UpdateUserAsync.htm)|
