...
C# __Копировать
     public sealed class ViewCardGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class ViewCardGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class ViewCardGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type ViewCardGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ ViewCardGetExtension
##  __Конструкторы
[ViewCardGetExtension](M_Tessa_Extensions_Platform_Server_Cards_ViewCardGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса ViewCardGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_ViewCardGetExtension_AfterRequest.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_ViewCardGetExtension_BeforeRequest.htm)|  
(Переопределяет
