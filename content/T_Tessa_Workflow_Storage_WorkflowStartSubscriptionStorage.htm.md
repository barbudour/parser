# WorkflowStartSubscriptionStorage - класс
...
C# __Копировать
    ...
    public sealed class WorkflowStartSubscriptionStorage : WorkflowSubscriptionStorageBase
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowStartSubscriptionStorage
    	Inherits WorkflowSubscriptionStorageBase
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowStartSubscriptionStorage sealed : public WorkflowSubscriptionStorageBase
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowStartSubscriptionStorage = 
        class
            inherit WorkflowSubscriptionStorageBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __[WorkflowSubscriptionStorageBase](T_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase.htm) __ WorkflowStartSubscriptionStorage
##  __Конструкторы
[WorkflowStartSubscriptionStorage()](M_Tessa_Workflow_Storage_WorkflowStartSubscriptionStorage__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[WorkflowStartSubscriptionStorage(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowStartSubscriptionStorage__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[WorkflowStartSubscriptionStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowStartSubscriptionStorage__ctor_3.htm)|
...
[WorkflowStartSubscriptionStorage(Guid,
String)](M_Tessa_Workflow_Storage_WorkflowStartSubscriptionStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowStartSubscriptionStorage.  
## __Свойства
...
---|---  
[EventName](P_Tessa_Workflow_Storage_WorkflowStartSubscriptionStorage_EventName.htm)|
Имя события.  
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[Clone](M_Tessa_Workflow_Storage_WorkflowStartSubscriptionStorage_Clone.htm)|
