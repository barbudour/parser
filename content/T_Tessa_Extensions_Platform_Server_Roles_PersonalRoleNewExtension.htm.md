# PersonalRoleNewExtension - класс
...
C# __Копировать
     public sealed class PersonalRoleNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class PersonalRoleNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class PersonalRoleNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type PersonalRoleNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ PersonalRoleNewExtension
##  __Конструкторы
[PersonalRoleNewExtension](M_Tessa_Extensions_Platform_Server_Roles_PersonalRoleNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса PersonalRoleNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_PersonalRoleNewExtension_AfterRequest.htm)|  
(Переопределяет
