...
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowLinkStorage
    	Inherits WorkflowTemplateStorageBase
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowLinkStorage sealed : public WorkflowTemplateStorageBase
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowLinkStorage = 
        class
            inherit WorkflowTemplateStorageBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __[WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm) __ WorkflowLinkStorage
##  __Конструкторы
[WorkflowLinkStorage()](M_Tessa_Workflow_Storage_WorkflowLinkStorage__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowLinkStorage  
---|---  
[WorkflowLinkStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowLinkStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowLinkStorage  
[WorkflowLinkStorage(Dictionary<String, Object>,
WorkflowProcessStorage)](M_Tessa_Workflow_Storage_WorkflowLinkStorage__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowLinkStorage  
##  __Свойства
[Anchors](P_Tessa_Workflow_Storage_WorkflowLinkStorage_Anchors.htm)|  Список
точек привязки стрелки  
---|---  
...
[CaptionAnchorOffsetX](P_Tessa_Workflow_Storage_WorkflowLinkStorage_CaptionAnchorOffsetX.htm)|
Положение подписи относительно якоря по оси X  
[CaptionAnchorOffsetY](P_Tessa_Workflow_Storage_WorkflowLinkStorage_CaptionAnchorOffsetY.htm)|
Положение подписи относительно якоря по оси Y  
[CaptionAnchorPosition](P_Tessa_Workflow_Storage_WorkflowLinkStorage_CaptionAnchorPosition.htm)|
Положения якоря на стрелке  
[CaptionAngle](P_Tessa_Workflow_Storage_WorkflowLinkStorage_CaptionAngle.htm)|
...
[FromNode](P_Tessa_Workflow_Storage_WorkflowLinkStorage_FromNode.htm)|
Идентификатор узла, откуда начинается стрелка  
[FromOrientation](P_Tessa_Workflow_Storage_WorkflowLinkStorage_FromOrientation.htm)|
Сторона узла, откуда начинается стрелка  
[FromPosition](P_Tessa_Workflow_Storage_WorkflowLinkStorage_FromPosition.htm)|
Позиция начала стрелки в долях на
[FromOrientation](P_Tessa_Workflow_Storage_WorkflowLinkStorage_FromOrientation.htm)
стороне  
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[InCondition](P_Tessa_Workflow_Storage_WorkflowLinkStorage_InCondition.htm)|
Условия для входа в узел по переходу  
[InDescription](P_Tessa_Workflow_Storage_WorkflowLinkStorage_InDescription.htm)|
Текстовое описание условия выхода из узла  
[Left](P_Tessa_Workflow_Storage_WorkflowLinkStorage_Left.htm)|  Left-
координата текущей связи  
[LinkMode](P_Tessa_Workflow_Storage_WorkflowLinkStorage_LinkMode.htm)|  Флаг
определяет, необходимо ли всегда создавать новый экземпляр узла при переходе  
[LockProcess](P_Tessa_Workflow_Storage_WorkflowLinkStorage_LockProcess.htm)|
Флаг определяет, должен ли процесс блокироваться при выполнении асинхронной
операции  
[Name](P_Tessa_Workflow_Storage_WorkflowTemplateStorageBase_Name.htm)|  Имя
объекта.  
(Унаследован от
[WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm))  
[OutCondition](P_Tessa_Workflow_Storage_WorkflowLinkStorage_OutCondition.htm)|
Условие для выхода из узла по переходу  
[OutDescription](P_Tessa_Workflow_Storage_WorkflowLinkStorage_OutDescription.htm)|
...
(Унаследован от
[WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm))  
[SignalProcessingMode](P_Tessa_Workflow_Storage_WorkflowLinkStorage_SignalProcessingMode.htm)|
Режим обработки сигнала.  
[ToNode](P_Tessa_Workflow_Storage_WorkflowLinkStorage_ToNode.htm)|
Идентификатор узла, где заканчивается стрелка  
[ToOrientation](P_Tessa_Workflow_Storage_WorkflowLinkStorage_ToOrientation.htm)|
Сторона узла, где заканчивается стрелка  
[Top](P_Tessa_Workflow_Storage_WorkflowLinkStorage_Top.htm)|  Top-координата
текущей связи  
[ToPosition](P_Tessa_Workflow_Storage_WorkflowLinkStorage_ToPosition.htm)|
Позиция конца стрелки в долях на
[ToOrientation](P_Tessa_Workflow_Storage_WorkflowLinkStorage_ToOrientation.htm)
стороне  
[UseAnchorPosition](P_Tessa_Workflow_Storage_WorkflowLinkStorage_UseAnchorPosition.htm)|
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[Clone](M_Tessa_Workflow_Storage_WorkflowLinkStorage_Clone.htm)|  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[OnPropertyChanged(PropertyChangedEventArgs)](M_Tessa_Workflow_Storage_WorkflowLinkStorage_OnPropertyChanged.htm)|  
(Переопределяет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[RemoveData](M_Tessa_Workflow_Storage_WorkflowLinkStorage_RemoveData.htm)|  
(Переопределяет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[UpdateData](M_Tessa_Workflow_Storage_WorkflowLinkStorage_UpdateData.htm)|  
(Переопределяет
