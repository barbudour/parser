...
VB __Копировать
     Public Interface INumberDirector
    	Inherits INumberDirectorBase, INumberExtendable, ISealable
C++ __Копировать
     public interface class INumberDirector : INumberDirectorBase, 
    	INumberExtendable, ISealable
F# __Копировать
     type INumberDirector = 
        interface
