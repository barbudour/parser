...
VB __Копировать
     Public NotInheritable Class KrScopeStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class KrScopeStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type KrScopeStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ KrScopeStoreExtension
##  __Конструкторы
[KrScopeStoreExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Scope_KrScopeStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrScopeStoreExtension.  
---|---  
## __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Scope_KrScopeStoreExtension_AfterRequest.htm)|
...
[AfterRequestFinally](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Scope_KrScopeStoreExtension_AfterRequestFinally.htm)|
...
[BeforeCommitTransaction](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Scope_KrScopeStoreExtension_BeforeCommitTransaction.htm)|
