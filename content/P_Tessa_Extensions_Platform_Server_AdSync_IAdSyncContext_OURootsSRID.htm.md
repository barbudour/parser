# IAdSyncContext.OURootsSRID - свойство
...
C# __Копировать
    HashSet<Guid> OURootsSRID { get; }
VB __Копировать
     ReadOnly Property OURootsSRID As HashSet(Of Guid)
    	Get
C++ __Копировать
    property HashSet<Guid>^ OURootsSRID {
    	HashSet<Guid>^ get ();
    }
F# __Копировать
     abstract OURootsSRID : HashSet<Guid> with get
#### Значение свойства
