# WorkflowEngineSignal - класс
Класс объекта сигнала
## __Definition
 **Пространство имён:** [Tessa.Workflow.Signals](N_Tessa_Workflow_Signals.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class WorkflowEngineSignal : StorageObject, 
    	IWorkflowEngineSignal
VB __Копировать
     Public Class WorkflowEngineSignal
    	Inherits StorageObject
    	Implements IWorkflowEngineSignal
C++ __Копировать
     public ref class WorkflowEngineSignal : public StorageObject, 
    	IWorkflowEngineSignal
F# __Копировать
     type WorkflowEngineSignal = 
        class
            inherit StorageObject
            interface IWorkflowEngineSignal
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ WorkflowEngineSignal
Derived
[Tessa.Workflow.Signals.WorkflowEngineExitSignal](T_Tessa_Workflow_Signals_WorkflowEngineExitSignal.htm)
[Tessa.Workflow.Signals.WorkflowEngineSubprocessSignal](T_Tessa_Workflow_Signals_WorkflowEngineSubprocessSignal.htm)
[Tessa.Workflow.Signals.WorkflowEngineTaskGroupControlSignal](T_Tessa_Workflow_Signals_WorkflowEngineTaskGroupControlSignal.htm)
[Tessa.Workflow.Signals.WorkflowEngineTaskSignal](T_Tessa_Workflow_Signals_WorkflowEngineTaskSignal.htm)
[Tessa.Workflow.Signals.WorkflowEngineTimerSignal](T_Tessa_Workflow_Signals_WorkflowEngineTimerSignal.htm)
Implements
    [IWorkflowEngineSignal](T_Tessa_Workflow_Signals_IWorkflowEngineSignal.htm)
##  __Конструкторы
[WorkflowEngineSignal(Dictionary<String,
Object>)](M_Tessa_Workflow_Signals_WorkflowEngineSignal__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowEngineSignal  
---|---  
[WorkflowEngineSignal(String, Dictionary<String,
Object>)](M_Tessa_Workflow_Signals_WorkflowEngineSignal__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowEngineSignal  
##  __Свойства
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[CreateDefaultSignal](M_Tessa_Workflow_Signals_WorkflowEngineSignal_CreateDefaultSignal.htm)|
Создаёт сигнал типа
[Default](F_Tessa_Workflow_Signals_WorkflowSignalTypes_Default.htm).  
[CreateExitSignal](M_Tessa_Workflow_Signals_WorkflowEngineSignal_CreateExitSignal.htm)|
Создаёт сигнал типа
