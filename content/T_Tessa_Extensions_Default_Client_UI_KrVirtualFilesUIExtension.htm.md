# KrVirtualFilesUIExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrVirtualFilesUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrVirtualFilesUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrVirtualFilesUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrVirtualFilesUIExtension
##  __Конструкторы
[KrVirtualFilesUIExtension](M_Tessa_Extensions_Default_Client_UI_KrVirtualFilesUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrVirtualFilesUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrVirtualFilesUIExtension_Initialized.htm)|  
(Переопределяет
