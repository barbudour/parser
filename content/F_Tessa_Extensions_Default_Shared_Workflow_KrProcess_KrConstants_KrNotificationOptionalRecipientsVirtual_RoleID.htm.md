# KrConstants.KrNotificationOptionalRecipientsVirtual.RoleID - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly RoleID As String
C++ __Копировать
     public:
    static initonly String^ RoleID
F# __Копировать
     static val RoleID: string
#### Значение поля
