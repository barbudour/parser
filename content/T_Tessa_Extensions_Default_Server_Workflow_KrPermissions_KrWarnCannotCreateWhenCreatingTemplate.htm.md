# KrWarnCannotCreateWhenCreatingTemplate - класс
...
VB __Копировать
     Public NotInheritable Class KrWarnCannotCreateWhenCreatingTemplate
    	Inherits CardNewExtension
C++ __Копировать
     public ref class KrWarnCannotCreateWhenCreatingTemplate sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type KrWarnCannotCreateWhenCreatingTemplate = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ KrWarnCannotCreateWhenCreatingTemplate
##  __Конструкторы
[KrWarnCannotCreateWhenCreatingTemplate](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrWarnCannotCreateWhenCreatingTemplate__ctor.htm)|
Инициализирует новый экземпляр класса KrWarnCannotCreateWhenCreatingTemplate  
---|---  
##  __Методы
...
(Унаследован от
[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrWarnCannotCreateWhenCreatingTemplate_BeforeRequest.htm)|  
(Переопределяет
