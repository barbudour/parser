# WfTaskSatelliteUIExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public class WfTaskSatelliteUIExtension : CardUIExtension
VB __Копировать
     Public Class WfTaskSatelliteUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class WfTaskSatelliteUIExtension : public CardUIExtension
F# __Копировать
     type WfTaskSatelliteUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ WfTaskSatelliteUIExtension
##  __Конструкторы
[WfTaskSatelliteUIExtension](M_Tessa_Extensions_Default_Client_Workflow_Wf_WfTaskSatelliteUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса WfTaskSatelliteUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_Workflow_Wf_WfTaskSatelliteUIExtension_Initialized.htm)|  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[OnCardModelInitialized](M_Tessa_Extensions_Default_Client_Workflow_Wf_WfTaskSatelliteUIExtension_OnCardModelInitialized.htm)|  
