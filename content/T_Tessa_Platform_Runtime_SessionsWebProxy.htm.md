...
VB __Копировать
     Public NotInheritable Class SessionsWebProxy
    	Inherits WebProxy
C++ __Копировать
     public ref class SessionsWebProxy sealed : public WebProxy
F# __Копировать
     [<SealedAttribute>]
    type SessionsWebProxy = 
        class
            inherit WebProxy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm) __ SessionsWebProxy
##  __Конструкторы
[SessionsWebProxy](M_Tessa_Platform_Runtime_SessionsWebProxy__ctor.htm)|
...
изменений.  
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[CloseSessionAsAdminAsync](M_Tessa_Platform_Runtime_SessionsWebProxy_CloseSessionAsAdminAsync.htm)|
...
[CloseSessionAsync](M_Tessa_Platform_Runtime_SessionsWebProxy_CloseSessionAsync.htm)|
...
[CloseSessionWithTokenAsync](M_Tessa_Platform_Runtime_SessionsWebProxy_CloseSessionWithTokenAsync.htm)|
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[IncrementConfigurationVersionAsync](M_Tessa_Platform_Runtime_SessionsWebProxy_IncrementConfigurationVersionAsync.htm)|
