...
VB __Копировать
     Public NotInheritable Class Exists
    	Inherits SearchFilter.PropertyBasedFilter
C++ __Копировать
     public ref class Exists sealed : public SearchFilter.PropertyBasedFilter
F# __Копировать
     [<SealedAttribute>]
    type Exists = 
        class
