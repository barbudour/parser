...
C# __Копировать
    ...
    where TItem : Item
VB __Копировать
     Public NotInheritable Class FindItemsResults(Of TItem As Item)
    	Implements IEnumerable(Of TItem), IEnumerable
C++ __Копировать
    generic<typename TItem>
    where TItem : Item
    public ref class FindItemsResults sealed : IEnumerable<TItem>, 
    	IEnumerable
F# __Копировать
     [<SealedAttribute>]
    type FindItemsResults<'TItem when 'TItem : Item> = 
        class
            interface IEnumerable<'TItem>
            interface IEnumerable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FindItemsResults<TItem>
Implements
    [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<TItem>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.ienumerable)
#### Параметры типа
TItem
    The type of item returned by the search operation.
##  __Свойства
[HighlightTerms](P_Tessa_Exchange_WebServices_Data_FindItemsResults_1_HighlightTerms.htm)|
Gets a collection containing the highlight terms that were found by the search
operation.  
---|---  
[Items](P_Tessa_Exchange_WebServices_Data_FindItemsResults_1_Items.htm)|  Gets
a collection containing the items that were found by the search operation.  
[MoreAvailable](P_Tessa_Exchange_WebServices_Data_FindItemsResults_1_MoreAvailable.htm)|
Gets a value indicating whether more items matching the search criteria are
available in the searched folder.  
[NextPageOffset](P_Tessa_Exchange_WebServices_Data_FindItemsResults_1_NextPageOffset.htm)|
Gets the offset that should be used with ItemView to retrieve the next page of
items in a FindItems operation.  
[TotalCount](P_Tessa_Exchange_WebServices_Data_FindItemsResults_1_TotalCount.htm)|
Gets the total number of items matching the search criteria available in the
searched folder.  
## __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetEnumerator](M_Tessa_Exchange_WebServices_Data_FindItemsResults_1_GetEnumerator.htm)|
