# WorkflowEngineDeleteExtension - класс
...
C# __Копировать
     public sealed class WorkflowEngineDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class WorkflowEngineDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class WorkflowEngineDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type WorkflowEngineDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ WorkflowEngineDeleteExtension
##  __Конструкторы
[WorkflowEngineDeleteExtension](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowEngineDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowEngineDeleteExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowEngineDeleteExtension_AfterBeginTransaction.htm)|  
(Переопределяет
