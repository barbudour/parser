# InternetMessageHeaderCollection - класс
...
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class InternetMessageHeaderCollection sealed : public ComplexPropertyCollection<InternetMessageHeader^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type InternetMessageHeaderCollection = 
        class
            inherit ComplexPropertyCollection<InternetMessageHeader>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[InternetMessageHeader](T_Tessa_Exchange_WebServices_Data_InternetMessageHeader.htm)> __ InternetMessageHeaderCollection
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Find](M_Tessa_Exchange_WebServices_Data_InternetMessageHeaderCollection_Find.htm)|
