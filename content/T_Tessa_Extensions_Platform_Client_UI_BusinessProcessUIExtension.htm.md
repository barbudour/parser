# BusinessProcessUIExtension - класс
...
C# __Копировать
     public class BusinessProcessUIExtension : CardUIExtension
VB __Копировать
     Public Class BusinessProcessUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class BusinessProcessUIExtension : public CardUIExtension
F# __Копировать
     type BusinessProcessUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ BusinessProcessUIExtension
##  __Конструкторы
[BusinessProcessUIExtension](M_Tessa_Extensions_Platform_Client_UI_BusinessProcessUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса BusinessProcessUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Finalized](M_Tessa_Extensions_Platform_Client_UI_BusinessProcessUIExtension_Finalized.htm)|  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_BusinessProcessUIExtension_Initialized.htm)|  
(Переопределяет
