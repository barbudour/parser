...
C# __Копировать
    ...
    public sealed class InitializationResponse : ValidationInfoStorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class InitializationResponse
    	Inherits ValidationInfoStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class InitializationResponse sealed : public ValidationInfoStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type InitializationResponse = 
        class
            inherit ValidationInfoStorageObject
            interface ICloneable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm) __ InitializationResponse
Implements
    [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable)
##  __Конструкторы
[InitializationResponse()](M_Tessa_Platform_Initialization_InitializationResponse__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[InitializationResponse(Dictionary<String,
Object>)](M_Tessa_Platform_Initialization_InitializationResponse__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[InitializationResponse(IStorageObjectProvider)](M_Tessa_Platform_Initialization_InitializationResponse__ctor_2.htm)|
...
## __Свойства
[BuildDate](P_Tessa_Platform_Initialization_InitializationResponse_BuildDate.htm)|
Строка с датой сборки платформы, которая передаётся от серверного приложения к
клиенту. По умолчанию заполняется как текущая дата сборки платформы.  
---|---  
[CipherInfo](P_Tessa_Platform_Initialization_InitializationResponse_CipherInfo.htm)|
Объект, содержащий настройки по шифрованию клиентских данных для текущего
пользователя.  
[ConfigurationCacheIsActual](P_Tessa_Platform_Initialization_InitializationResponse_ConfigurationCacheIsActual.htm)|
Признак того, что актуальная версия конфигурации уже добавлена в кэш на
клиенте, поэтому в ответе на запрос инициализации недоступна большая часть
информации, связанной с конфигурацией, клиент должен получить её из кэша. По
умолчанию значение равно false.  
[ConfigurationVersion](P_Tessa_Platform_Initialization_InitializationResponse_ConfigurationVersion.htm)|
Версия конфигурации, которая установлена на сервере. Значение обязательно для
установки. Значение равно 0, если версия конфигурации неизвестна на сервере
(при стандартных регистрациях на сервере она всегда известна).  
[Dbms](P_Tessa_Platform_Initialization_InitializationResponse_Dbms.htm)|
Используемая СУБД.  
[DefaultColors](P_Tessa_Platform_Initialization_InitializationResponse_DefaultColors.htm)|
Цвета палитры, настроенные по умолчанию для всех пользователей.  
[Dynamic](P_Tessa_Platform_Validation_ValidationInfoStorageObject_Dynamic.htm)|
Объект, осуществляющий доступ к текущему объекту через позднее связывание
свойств.  
(Унаследован от
[ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm))  
[DynamicInfo](P_Tessa_Platform_Validation_ValidationInfoStorageObject_DynamicInfo.htm)|
...
(Унаследован от
[ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm))  
[Info](P_Tessa_Platform_Validation_ValidationInfoStorageObject_Info.htm)|
Дополнительная пользовательская информация.  
(Унаследован от
[ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm))  
[PersonalRoleSatellite](P_Tessa_Platform_Initialization_InitializationResponse_PersonalRoleSatellite.htm)|
Карточка-сателлит для персональной роли текущего пользователя.  
[SessionInfo](P_Tessa_Platform_Initialization_InitializationResponse_SessionInfo.htm)|
Информация по текущей сессии. Может использоваться для определения того, что
кэш с метаинформацией необходимо не использовать, даже если версия
конфигурации совпадает (например, отличается язык сотрудника).  
[ValidationResult](P_Tessa_Platform_Initialization_InitializationResponse_ValidationResult.htm)|
Объект, используемый для построения результата валидации.  
[Version](P_Tessa_Platform_Initialization_InitializationResponse_Version.htm)|
Строка с версией платформы, которая передаётся от серверного приложения к
клиенту. По умолчанию заполняется как текущая версия платформы.  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Platform_Initialization_InitializationResponse_Clone.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Platform_Initialization_InitializationResponse_EnsureCacheResolved.htm)|
...
(Переопределяет
[ValidationInfoStorageObject.EnsureCacheResolved()](M_Tessa_Platform_Validation_ValidationInfoStorageObject_EnsureCacheResolved.htm))  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[RemoveSystemInfo](M_Tessa_Platform_Validation_ValidationInfoStorageObject_RemoveSystemInfo.htm)|
...
[SystemKeyPrefix](F_Tessa_Platform_Storage_StorageHelper_SystemKeyPrefix.htm).  
(Унаследован от
[ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm))  
[RemoveUserInfo](M_Tessa_Platform_Validation_ValidationInfoStorageObject_RemoveUserInfo.htm)|
...
[UserKeyPrefix](F_Tessa_Platform_Storage_StorageHelper_UserKeyPrefix.htm).  
(Унаследован от
[ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm))  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetCipherInfo](M_Tessa_Platform_Initialization_InitializationResponse_TryGetCipherInfo.htm)|
Возвращает объект, содержащий настройки по шифрованию клиентских данных для
текущего пользователя, или null, если объект ещё не был создан.  
[TryGetDefaultColors](M_Tessa_Platform_Initialization_InitializationResponse_TryGetDefaultColors.htm)|
Возвращает объект, содержащий цвета палитры, настроенные по умолчанию для всех
пользователей, или null, если объект ещё не был создан.  
...
не найден.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetInfo](M_Tessa_Platform_Validation_ValidationInfoStorageObject_TryGetInfo.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetSessionInfo](M_Tessa_Platform_Initialization_InitializationResponse_TryGetSessionInfo.htm)|
Возвращает информацию по текущей сессии или null, если информация ещё не была
задана.  
[TryGetSessionToken](M_Tessa_Platform_Initialization_InitializationResponse_TryGetSessionToken.htm)|
Возвращает информацию по текущей сессии
[SessionToken](T_Tessa_Platform_Runtime_SessionToken.htm) или null, если
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetValidationResult](M_Tessa_Platform_Initialization_InitializationResponse_TryGetValidationResult.htm)|
Возвращает объект, используемый для построения результата валидации, или null,
если объект ещё не был создан.  
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Platform_Validation_ValidationInfoStorageObject_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Унаследован от
[ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm))  
##  __Поля
[BuildDateKey](F_Tessa_Platform_Initialization_InitializationResponse_BuildDateKey.htm)|  
---|---  
[CipherInfoKey](F_Tessa_Platform_Initialization_InitializationResponse_CipherInfoKey.htm)|  
[ConfigurationCacheIsActualKey](F_Tessa_Platform_Initialization_InitializationResponse_ConfigurationCacheIsActualKey.htm)|  
[ConfigurationVersionKey](F_Tessa_Platform_Initialization_InitializationResponse_ConfigurationVersionKey.htm)|  
[DbmsKey](F_Tessa_Platform_Initialization_InitializationResponse_DbmsKey.htm)|  
[DefaultColorsKey](F_Tessa_Platform_Initialization_InitializationResponse_DefaultColorsKey.htm)|  
[PersonalRoleSatelliteKey](F_Tessa_Platform_Initialization_InitializationResponse_PersonalRoleSatelliteKey.htm)|  
[SessionInfoKey](F_Tessa_Platform_Initialization_InitializationResponse_SessionInfoKey.htm)|  
[ValidationResultKey](F_Tessa_Platform_Initialization_InitializationResponse_ValidationResultKey.htm)|  
[VersionKey](F_Tessa_Platform_Initialization_InitializationResponse_VersionKey.htm)|  
## __Методы расширения
...
заданном объекте InitializationResponse, или null, если информация недоступна.  
(Определяется
[InitializationExtensions](T_Tessa_Platform_Initialization_InitializationExtensions.htm))  
