# TimeZonesDeleteExtension - класс
...
C# __Копировать
     public class TimeZonesDeleteExtension : CardDeleteExtension
VB __Копировать
     Public Class TimeZonesDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class TimeZonesDeleteExtension : public CardDeleteExtension
F# __Копировать
     type TimeZonesDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ TimeZonesDeleteExtension
##  __Конструкторы
[TimeZonesDeleteExtension](M_Tessa_Extensions_Platform_Server_TimeZones_TimeZonesDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса TimeZonesDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_TimeZones_TimeZonesDeleteExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
