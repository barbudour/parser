...
C# __Копировать
    ...
    public sealed class CardTypeSectionColumn : CardSerializableEntry
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardTypeSectionColumn
    	Inherits CardSerializableEntry
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTypeSectionColumn sealed : public CardSerializableEntry
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardTypeSectionColumn = 
        class
            inherit CardSerializableEntry
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __[CardSerializableEntry](T_Tessa_Cards_CardSerializableEntry.htm) __ CardTypeSectionColumn
##  __Конструкторы
[CardTypeSectionColumn()](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn__ctor.htm)|
Создаёт экземпляр класса с параметрами по умолчанию.  
---|---  
[CardTypeSectionColumn(Guid, String, String, CardMetadataColumnType,
SchemeType, Object, String, Boolean,
Boolean)](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn__ctor_1.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeAttributeFromXml](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_DeserializeAttributeFromXml.htm)|
...
[DeserializeChildrenFromBinaryInternal](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_DeserializeChildrenFromBinaryInternal.htm)|
...
[DeserializeElementFromXml](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_DeserializeElementFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_DeserializeFromBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_DeserializeFromStorageInternal.htm)|
...
(Унаследован от
[CardSerializableEntry](T_Tessa_Cards_CardSerializableEntry.htm))  
[Equals(Object)](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_Equals.htm)|  
(Переопределяет
[CardSerializableEntry.Equals(Object)](M_Tessa_Cards_CardSerializableEntry_Equals.htm))  
[Finalize](https://learn.microsoft.com/dotnet/api/system.object.finalize#system-
object-finalize)| Allows an object to try to free resources and perform other
cleanup operations before it is reclaimed by garbage collection.  
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetHashCode](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_GetHashCode.htm)|  
(Переопределяет
[CardSerializableEntry.GetHashCode()](M_Tessa_Cards_CardSerializableEntry_GetHashCode.htm))  
...
(Унаследован от
[CardSerializableEntry](T_Tessa_Cards_CardSerializableEntry.htm))  
[OnDeserialized](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_OnDeserialized.htm)|
Выполняется после успешной десериализации объекта и всех его дочерних объектов
из элемента XML.  
(Переопределяет
[CardSerializableObject.OnDeserialized(SerializationMode)](M_Tessa_Cards_CardSerializableObject_OnDeserialized.htm))  
[OnDeserializing](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_OnDeserializing.htm)|
...
(Унаследован от
[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm))  
[RepairInternalAsync](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_RepairInternalAsync.htm)|
Метод восстанавливает объект к работоспособному состоянии в соответствии со
схемой. Этот процесс включает удаление данных из текущего объекта, которые
имеют отношение к схеме, но фактически в ней отсутствуют.  
(Переопределяет
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SealInternal](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_SealInternal.htm)|
Защищает объект от изменений.
Метод может быть переопределён в классах-наследниках.
(Переопределяет
[CardSerializableObject.SealInternal()](M_Tessa_Cards_CardSerializableObject_SealInternal.htm))  
[SerializeAttributesToXml](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_SerializeAttributesToXml.htm)|
...
[SerializeChildrenToBinaryInternal](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_SerializeChildrenToBinaryInternal.htm)|
...
[SerializeElementsToXml](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_SerializeElementsToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_SerializeToBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
...
(Унаследован от
[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm))  
[ValidateInternal](M_Tessa_Cards_VirtualScheme_CardTypeSectionColumn_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
