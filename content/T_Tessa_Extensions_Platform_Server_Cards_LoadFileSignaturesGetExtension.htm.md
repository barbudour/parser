# LoadFileSignaturesGetExtension - класс
...
C# __Копировать
     public sealed class LoadFileSignaturesGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class LoadFileSignaturesGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class LoadFileSignaturesGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type LoadFileSignaturesGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ LoadFileSignaturesGetExtension
##  __Конструкторы
[LoadFileSignaturesGetExtension](M_Tessa_Extensions_Platform_Server_Cards_LoadFileSignaturesGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса LoadFileSignaturesGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_LoadFileSignaturesGetExtension_AfterRequest.htm)|  
(Переопределяет
