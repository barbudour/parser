# KrConstants.EditStageTemplate - поле
...
VB __Копировать
     Public Shared ReadOnly EditStageTemplate As Guid
C++ __Копировать
     public:
    static initonly Guid EditStageTemplate
F# __Копировать
     static val EditStageTemplate: Guid
#### Значение поля
