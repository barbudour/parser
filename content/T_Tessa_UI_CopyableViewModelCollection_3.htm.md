# CopyableViewModelCollection<TItemModel, TItemViewModel, TItemData> \- класс
##  __Definition
 **Пространство имён:** [Tessa.UI](N_Tessa_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class CopyableViewModelCollection<TItemModel, TItemViewModel, TItemData> : EditableViewModelCollection<TItemModel, TItemViewModel>
    where TItemModel : class
    where TItemViewModel : ViewModel<TItemModel>
VB __Копировать
     Public MustInherit Class CopyableViewModelCollection(Of TItemModel As Class, TItemViewModel As ViewModel(Of TItemModel), TItemData)
    	Inherits EditableViewModelCollection(Of TItemModel, TItemViewModel)
C++ __Копировать
    generic<typename TItemModel, typename TItemViewModel, typename TItemData>
    where TItemModel : ref class
    where TItemViewModel : ViewModel<TItemModel>
    public ref class CopyableViewModelCollection abstract : public EditableViewModelCollection<TItemModel, TItemViewModel>
F# __Копировать
     [<AbstractClassAttribute>]
    type CopyableViewModelCollection<'TItemModel, 'TItemViewModel, 'TItemData when 'TItemModel : not struct when 'TItemViewModel : ViewModel<'TItemModel>> = 
        class
            inherit EditableViewModelCollection<'TItemModel, 'TItemViewModel>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ViewModelCollection](T_Tessa_UI_ViewModelCollection_2.htm)<TItemModel, TItemViewModel> __[EditableViewModelCollection](T_Tessa_UI_EditableViewModelCollection_2.htm)<TItemModel, TItemViewModel> __ CopyableViewModelCollection<TItemModel, TItemViewModel, TItemData>
Derived
[Tessa.UI.Cards.Editors.TabItemEditorViewModelCollection](T_Tessa_UI_Cards_Editors_TabItemEditorViewModelCollection.htm)
[Tessa.UI.Data.CopyableColumnViewModelCollection](T_Tessa_UI_Data_CopyableColumnViewModelCollection.htm)
[Tessa.UI.Localization.EntryViewModelCollection](T_Tessa_UI_Localization_EntryViewModelCollection.htm)
[Tessa.UI.Scheme.Legacy.CopyableTableViewModelCollection](T_Tessa_UI_Scheme_Legacy_CopyableTableViewModelCollection.htm)
#### Параметры типа
TItemModel
TItemViewModel
TItemData
...
TItemData>(ViewModelCollection<TItemModel,
TItemViewModel>)](M_Tessa_UI_CopyableViewModelCollection_3__ctor_2.htm)|
Инициализирует новый экземпляр класса CopyableViewModelCollection<TItemModel,
TItemViewModel, TItemData>  
---|---  
[CopyableViewModelCollection<TItemModel, TItemViewModel,
TItemData>(IList<TItemModel>,
ViewModelScope)](M_Tessa_UI_CopyableViewModelCollection_3__ctor.htm)|
Инициализирует новый экземпляр класса CopyableViewModelCollection<TItemModel,
TItemViewModel, TItemData>  
[CopyableViewModelCollection<TItemModel, TItemViewModel,
TItemData>(ViewModelCollection<TItemModel, TItemViewModel>, Boolean,
Boolean)](M_Tessa_UI_CopyableViewModelCollection_3__ctor_3.htm)|
Инициализирует новый экземпляр класса CopyableViewModelCollection<TItemModel,
TItemViewModel, TItemData>  
[CopyableViewModelCollection<TItemModel, TItemViewModel,
TItemData>(IList<TItemModel>, ViewModelScope, Boolean,
Boolean)](M_Tessa_UI_CopyableViewModelCollection_3__ctor_1.htm)|
Инициализирует новый экземпляр класса CopyableViewModelCollection<TItemModel,
TItemViewModel, TItemData>  
##  __Свойства
[AddCommand](P_Tessa_UI_EditableViewModelCollection_2_AddCommand.htm)|  
(Унаследован от [EditableViewModelCollection<TItemModel,
TItemViewModel>](T_Tessa_UI_EditableViewModelCollection_2.htm))  
---|---  
[CopyCommand](P_Tessa_UI_CopyableViewModelCollection_3_CopyCommand.htm)|  
...
[CutCommand](P_Tessa_UI_CopyableViewModelCollection_3_CutCommand.htm)|  
...
(Унаследован от [ViewModelCollection<TItemModel,
TItemViewModel>](T_Tessa_UI_ViewModelCollection_2.htm))  
[ItemDataFormat](P_Tessa_UI_CopyableViewModelCollection_3_ItemDataFormat.htm)|  
...
(Унаследован от [ViewModelCollection<TItemModel,
TItemViewModel>](T_Tessa_UI_ViewModelCollection_2.htm))  
[PasteCommand](P_Tessa_UI_CopyableViewModelCollection_3_PasteCommand.htm)|  
...
(Унаследован от [EditableViewModelCollection<TItemModel,
TItemViewModel>](T_Tessa_UI_EditableViewModelCollection_2.htm))  
[CanGetItemFromData](M_Tessa_UI_CopyableViewModelCollection_3_CanGetItemFromData.htm)|  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetDataFromItem](M_Tessa_UI_CopyableViewModelCollection_3_GetDataFromItem.htm)|  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetItemFromData](M_Tessa_UI_CopyableViewModelCollection_3_GetItemFromData.htm)|  
...
(Унаследован от [ViewModelCollection<TItemModel,
TItemViewModel>](T_Tessa_UI_ViewModelCollection_2.htm))  
[OnCanExecuteCopy](M_Tessa_UI_CopyableViewModelCollection_3_OnCanExecuteCopy.htm)|  
[OnCanExecuteCut](M_Tessa_UI_CopyableViewModelCollection_3_OnCanExecuteCut.htm)|  
[OnCanExecutePaste](M_Tessa_UI_CopyableViewModelCollection_3_OnCanExecutePaste.htm)|  
[OnCollectionChanged](M_Tessa_UI_ViewModelCollection_2_OnCollectionChanged.htm)|  
(Унаследован от [ViewModelCollection<TItemModel,
TItemViewModel>](T_Tessa_UI_ViewModelCollection_2.htm))  
[OnExecutedCopy](M_Tessa_UI_CopyableViewModelCollection_3_OnExecutedCopy.htm)|  
[OnExecutedCut](M_Tessa_UI_CopyableViewModelCollection_3_OnExecutedCut.htm)|  
[OnExecutedPaste](M_Tessa_UI_CopyableViewModelCollection_3_OnExecutedPaste.htm)|  
