# FmNotificationResponse - класс
##  __Definition
 **Пространство имён:**
[Tessa.Forums.Notifications](N_Tessa_Forums_Notifications.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class FmNotificationResponse : InfoStorageObject
VB __Копировать
     Public Class FmNotificationResponse
    	Inherits InfoStorageObject
C++ __Копировать
     public ref class FmNotificationResponse : public InfoStorageObject
F# __Копировать
     type FmNotificationResponse = 
        class
            inherit InfoStorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm) __ FmNotificationResponse
##  __Конструкторы
[FmNotificationResponse()](M_Tessa_Forums_Notifications_FmNotificationResponse__ctor.htm)|
Инициализирует новый экземпляр класса FmNotificationResponse  
---|---  
[FmNotificationResponse(Dictionary<String,
Object>)](M_Tessa_Forums_Notifications_FmNotificationResponse__ctor_1.htm)|
Инициализирует новый экземпляр класса FmNotificationResponse  
[FmNotificationResponse(SerializationInfo,
StreamingContext)](M_Tessa_Forums_Notifications_FmNotificationResponse__ctor_2.htm)|
Инициализирует новый экземпляр класса FmNotificationResponse  
##  __Свойства
...
(Унаследован от
[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm))  
[Notifications](P_Tessa_Forums_Notifications_FmNotificationResponse_Notifications.htm)|  
[UserStat](P_Tessa_Forums_Notifications_FmNotificationResponse_UserStat.htm)|  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Empty](M_Tessa_Forums_Notifications_FmNotificationResponse_Empty.htm)|  
