...
C# __Копировать
    ...
    public class FmNotificationItem : ValidationStorageObject
VB __Копировать
    <SerializableAttribute>
...
C++ __Копировать
    [SerializableAttribute]
    public ref class FmNotificationItem : public ValidationStorageObject
F# __Копировать
     [<SerializableAttribute>]
    type FmNotificationItem = 
        class
            inherit ValidationStorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __ FmNotificationItem
##  __Конструкторы
[FmNotificationItem()](M_Tessa_Forums_Notifications_FmNotificationItem__ctor.htm)|
Инициализирует новый экземпляр класса FmNotificationItem  
---|---  
[FmNotificationItem(Dictionary<String,
Object>)](M_Tessa_Forums_Notifications_FmNotificationItem__ctor_1.htm)|
Инициализирует новый экземпляр класса FmNotificationItem  
[FmNotificationItem(SerializationInfo,
StreamingContext)](M_Tessa_Forums_Notifications_FmNotificationItem__ctor_2.htm)|
Инициализирует новый экземпляр класса FmNotificationItem  
##  __Свойства
[ActiveBatch](P_Tessa_Forums_Notifications_FmNotificationItem_ActiveBatch.htm)|  
---|---  
[Batch0](P_Tessa_Forums_Notifications_FmNotificationItem_Batch0.htm)|  
[Batch1](P_Tessa_Forums_Notifications_FmNotificationItem_Batch1.htm)|  
[Count0](P_Tessa_Forums_Notifications_FmNotificationItem_Count0.htm)|  
[Count1](P_Tessa_Forums_Notifications_FmNotificationItem_Count1.htm)|  
[ReadMessages0](P_Tessa_Forums_Notifications_FmNotificationItem_ReadMessages0.htm)|  
[ReadMessages1](P_Tessa_Forums_Notifications_FmNotificationItem_ReadMessages1.htm)|  
[UserID](P_Tessa_Forums_Notifications_FmNotificationItem_UserID.htm)|  
## __Методы
