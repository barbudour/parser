# PartialGroupRecalcStageTypeHandler - класс
Обработчик этапа
...
C++ __Копировать
     public ref class PartialGroupRecalcStageTypeHandler : public StageTypeHandlerBase
F# __Копировать
     type PartialGroupRecalcStageTypeHandler = 
        class
            inherit StageTypeHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StageTypeHandlerBase](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTypeHandlerBase.htm) __ PartialGroupRecalcStageTypeHandler
##  __Конструкторы
[PartialGroupRecalcStageTypeHandler](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_PartialGroupRecalcStageTypeHandler__ctor.htm)|
Инициализирует новый экземпляр класса PartialGroupRecalcStageTypeHandler.  
---|---  
## __Свойства
[Executor](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_PartialGroupRecalcStageTypeHandler_Executor.htm)|  
---|---  
[KrCompilationCache](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_PartialGroupRecalcStageTypeHandler_KrCompilationCache.htm)|  
## __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[FindHeads](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_PartialGroupRecalcStageTypeHandler_FindHeads.htm)|
Выполняет поиск порядковых индексов этапов для определения начала области
обновления текущего процесса после пересчёта.  
...
(Унаследован от
[StageTypeHandlerBase](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTypeHandlerBase.htm))  
[HandleStageStartAsync](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_PartialGroupRecalcStageTypeHandler_HandleStageStartAsync.htm)|
