# LocalizationCache - класс
Потокобезопасный кэш локализации.
## __Definition
 **Пространство имён:** [Tessa.Localization](N_Tessa_Localization.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class LocalizationCache : GlobalCache<SharedEventArgs>
VB __Копировать
     Public NotInheritable Class LocalizationCache
    	Inherits GlobalCache(Of SharedEventArgs)
C++ __Копировать
     public ref class LocalizationCache sealed : public GlobalCache<SharedEventArgs^>
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[GlobalCache](T_Tessa_Platform_Caching_GlobalCache_1.htm)<[SharedEventArgs](T_Tessa_Platform_IPC_SharedEventArgs.htm)> __ LocalizationCache
##  __Конструкторы
[LocalizationCache](M_Tessa_Localization_LocalizationCache__ctor.htm)|
...
(Унаследован от
[GlobalCache<TEventArgs>](T_Tessa_Platform_Caching_GlobalCache_1.htm))  
[GetEntriesCacheAsync](M_Tessa_Localization_LocalizationCache_GetEntriesCacheAsync.htm)|  
[GetHashCode](https://learn.microsoft.com/dotnet/api/system.object.gethashcode#system-
object-gethashcode)| Serves as the default hash function.  
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetLibraryCacheAsync](M_Tessa_Localization_LocalizationCache_GetLibraryCacheAsync.htm)|  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InvalidateGlobalAsync](M_Tessa_Localization_LocalizationCache_InvalidateGlobalAsync.htm)|
Сбрасывает глобальный кэш с локализацией.  
...
(Унаследован от
[GlobalCache<TEventArgs>](T_Tessa_Platform_Caching_GlobalCache_1.htm))  
[InvalidateLocalAsync](M_Tessa_Localization_LocalizationCache_InvalidateLocalAsync.htm)|
Сбрасывает локальный кэш с локализацией. Этот метод следует использовать в
случае, если очистка производится внутри сброса другого глобального кэша,
например, глобального кэша схемы.  
...
(Унаследован от
[GlobalCache<TEventArgs>](T_Tessa_Platform_Caching_GlobalCache_1.htm))  
[InvalidateLocalCacheOverrideAsync](M_Tessa_Localization_LocalizationCache_InvalidateLocalCacheOverrideAsync.htm)|
Метод, реализующий сброс кэша в текущем экземпляре. Метод является
потокобезопасным и может обращаться к кэшу без дополнительной синхронизации.
