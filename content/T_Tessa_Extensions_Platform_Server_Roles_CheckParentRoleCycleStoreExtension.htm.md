# CheckParentRoleCycleStoreExtension - класс
...
C# __Копировать
     public sealed class CheckParentRoleCycleStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class CheckParentRoleCycleStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class CheckParentRoleCycleStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type CheckParentRoleCycleStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ CheckParentRoleCycleStoreExtension
##  __Конструкторы
[CheckParentRoleCycleStoreExtension](M_Tessa_Extensions_Platform_Server_Roles_CheckParentRoleCycleStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса CheckParentRoleCycleStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Roles_CheckParentRoleCycleStoreExtension_AfterBeginTransaction.htm)|  
(Переопределяет
