...
VB __Копировать
    <EditorBrowsableAttribute(EditorBrowsableState.Never)>
    Public NotInheritable Class AttendeeCollection
    	Inherits ComplexPropertyCollection(Of Attendee)
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class AttendeeCollection sealed : public ComplexPropertyCollection<Attendee^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type AttendeeCollection = 
        class
            inherit ComplexPropertyCollection<Attendee>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[Attendee](T_Tessa_Exchange_WebServices_Data_Attendee.htm)> __ AttendeeCollection
##  __Свойства
...
[ComplexPropertyCollection<TComplexProperty>](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm))  
##  __Методы
[Add(Attendee)](M_Tessa_Exchange_WebServices_Data_AttendeeCollection_Add_2.htm)|
Adds an attendee to the collection.  
---|---  
[Add(String)](M_Tessa_Exchange_WebServices_Data_AttendeeCollection_Add.htm)|
Adds a attendee to the collection.  
[Add(String,
String)](M_Tessa_Exchange_WebServices_Data_AttendeeCollection_Add_1.htm)|
Adds a attendee to the collection.  
[Clear](M_Tessa_Exchange_WebServices_Data_AttendeeCollection_Clear.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Remove](M_Tessa_Exchange_WebServices_Data_AttendeeCollection_Remove.htm)|
Removes an attendee from the collection.  
[RemoveAt](M_Tessa_Exchange_WebServices_Data_AttendeeCollection_RemoveAt.htm)|
Removes an attendee from the collection.  
