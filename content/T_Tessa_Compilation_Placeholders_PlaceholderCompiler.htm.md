...
C# __Копировать
     public sealed class PlaceholderCompiler : IPlaceholderCompiler
VB __Копировать
     Public NotInheritable Class PlaceholderCompiler
    	Implements IPlaceholderCompiler
C++ __Копировать
     public ref class PlaceholderCompiler sealed : IPlaceholderCompiler
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ PlaceholderCompiler
Implements
    [IPlaceholderCompiler](T_Tessa_Platform_Placeholders_Compilation_IPlaceholderCompiler.htm)
##  __Конструкторы
[PlaceholderCompiler](M_Tessa_Compilation_Placeholders_PlaceholderCompiler__ctor.htm)|
Инициализирует новый экземпляр класса PlaceholderCompiler  
---|---  
##  __Свойства
...
## __Методы
[Compile](M_Tessa_Compilation_Placeholders_PlaceholderCompiler_Compile.htm)|
Метод для компиляции текста с плейсхолдерами  
---|---  
[CreateContext](M_Tessa_Compilation_Placeholders_PlaceholderCompiler_CreateContext.htm)|
Создает контекст компиляции  
