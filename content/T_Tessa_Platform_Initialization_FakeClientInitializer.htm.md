...
C# __Копировать
     public sealed class FakeClientInitializer : IClientInitializer
VB __Копировать
     Public NotInheritable Class FakeClientInitializer
    	Implements IClientInitializer
C++ __Копировать
     public ref class FakeClientInitializer sealed : IClientInitializer
F# __Копировать
     [<SealedAttribute>]
    type FakeClientInitializer = 
        class
            interface IClientInitializer
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FakeClientInitializer
Implements
    [IClientInitializer](T_Tessa_Platform_Initialization_IClientInitializer.htm)
##  __Конструкторы
[FakeClientInitializer](M_Tessa_Platform_Initialization_FakeClientInitializer__ctor.htm)|
Инициализирует новый экземпляр класса FakeClientInitializer  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializeAsync](M_Tessa_Platform_Initialization_FakeClientInitializer_InitializeAsync.htm)|
