# WorkflowSubscriptionStorageBase - класс
##  __Definition
 **Пространство имён:** [Tessa.Workflow.Storage](N_Tessa_Workflow_Storage.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class WorkflowSubscriptionStorageBase : WorkflowStorageBase
VB __Копировать
     Public MustInherit Class WorkflowSubscriptionStorageBase
    	Inherits WorkflowStorageBase
C++ __Копировать
     public ref class WorkflowSubscriptionStorageBase abstract : public WorkflowStorageBase
F# __Копировать
     [<AbstractClassAttribute>]
    type WorkflowSubscriptionStorageBase = 
        class
            inherit WorkflowStorageBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __ WorkflowSubscriptionStorageBase
Derived
[Tessa.Workflow.Storage.WorkflowCommandSubscriptionStorage](T_Tessa_Workflow_Storage_WorkflowCommandSubscriptionStorage.htm)
[Tessa.Workflow.Storage.WorkflowStartSubscriptionStorage](T_Tessa_Workflow_Storage_WorkflowStartSubscriptionStorage.htm)
[Tessa.Workflow.Storage.WorkflowSubprocessSubscriptionStorage](T_Tessa_Workflow_Storage_WorkflowSubprocessSubscriptionStorage.htm)
[Tessa.Workflow.Storage.WorkflowTaskSubscriptionStorage](T_Tessa_Workflow_Storage_WorkflowTaskSubscriptionStorage.htm)
[Tessa.Workflow.Storage.WorkflowTimerSubscriptionStorage](T_Tessa_Workflow_Storage_WorkflowTimerSubscriptionStorage.htm)
##  __Конструкторы
[WorkflowSubscriptionStorageBase(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowSubscriptionStorageBase  
---|---  
[WorkflowSubscriptionStorageBase(Guid,
Nullable<Guid>)](M_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowSubscriptionStorageBase  
[WorkflowSubscriptionStorageBase(SerializationInfo,
StreamingContext)](M_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowSubscriptionStorageBase  
##  __Свойства
