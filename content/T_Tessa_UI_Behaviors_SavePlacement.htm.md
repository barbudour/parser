...
C# __Копировать
     public sealed class SavePlacement : Behavior<Window>
VB __Копировать
     Public NotInheritable Class SavePlacement
    	Inherits Behavior(Of Window)
C++ __Копировать
     public ref class SavePlacement sealed : public Behavior<Window^>
F# __Копировать
     [<SealedAttribute>]
    type SavePlacement = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[Window](https://learn.microsoft.com/dotnet/api/system.windows.window)> __ SavePlacement
##  __Конструкторы
[SavePlacement](M_Tessa_UI_Behaviors_SavePlacement__ctor.htm)| Инициализирует
новый экземпляр класса SavePlacement  
---|---  
##  __Свойства
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[RestoreLocation](P_Tessa_UI_Behaviors_SavePlacement_RestoreLocation.htm)|
Признак того, что помимо размеров и WindowState также требуется восстановить
предыдущее местоположение окна.  
## __Методы
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_SavePlacement_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_SavePlacement_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_SavePlacement_OnDetaching.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[RestoreLocationProperty](F_Tessa_UI_Behaviors_SavePlacement_RestoreLocationProperty.htm)|  
---|---  
## __См. также
#### Ссылки
