# WfHelper.ResolutionAuthorNameField - поле
...
VB __Копировать
     Public Const ResolutionAuthorNameField As String = "AuthorName"
C++ __Копировать
     public:
    literal String^ ResolutionAuthorNameField = "AuthorName"
F# __Копировать
     static val mutable ResolutionAuthorNameField: string
#### Значение поля
