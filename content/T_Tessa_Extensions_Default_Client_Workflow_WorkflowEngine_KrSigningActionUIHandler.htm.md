# KrSigningActionUIHandler - класс
...
VB __Копировать
     Public NotInheritable Class KrSigningActionUIHandler
    	Inherits WorkflowActionUIHandlerBase
C++ __Копировать
     public ref class KrSigningActionUIHandler sealed : public WorkflowActionUIHandlerBase
F# __Копировать
     [<SealedAttribute>]
    type KrSigningActionUIHandler = 
        class
            inherit WorkflowActionUIHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WorkflowActionUIHandlerBase](T_Tessa_UI_WorkflowViewer_Actions_WorkflowActionUIHandlerBase.htm) __ KrSigningActionUIHandler
##  __Конструкторы
[KrSigningActionUIHandler](M_Tessa_Extensions_Default_Client_Workflow_WorkflowEngine_KrSigningActionUIHandler__ctor.htm)|
Инициализирует новый экземпляр класса KrSigningActionUIHandler.  
---|---  
## __Свойства
...
(Унаследован от
[WorkflowActionUIHandlerBase](T_Tessa_UI_WorkflowViewer_Actions_WorkflowActionUIHandlerBase.htm))  
[AttachToCardCoreAsync](M_Tessa_Extensions_Default_Client_Workflow_WorkflowEngine_KrSigningActionUIHandler_AttachToCardCoreAsync.htm)|
...
(Унаследован от
[WorkflowActionUIHandlerBase](T_Tessa_UI_WorkflowViewer_Actions_WorkflowActionUIHandlerBase.htm))  
[InvalidateFormCore](M_Tessa_Extensions_Default_Client_Workflow_WorkflowEngine_KrSigningActionUIHandler_InvalidateFormCore.htm)|
...
(Унаследован от
[WorkflowActionUIHandlerBase](T_Tessa_UI_WorkflowViewer_Actions_WorkflowActionUIHandlerBase.htm))  
[UpdateFormCoreAsync](M_Tessa_Extensions_Default_Client_Workflow_WorkflowEngine_KrSigningActionUIHandler_UpdateFormCoreAsync.htm)|
