# ServiceNotFoundException - класс
...
C++ __Копировать
    [SerializableAttribute]
    public ref class ServiceNotFoundException : public ApplicationException
F# __Копировать
     [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception) __ ServiceNotFoundException
##  __Конструкторы
[ServiceNotFoundException(String)](M_Tessa_Platform_Runtime_ServiceNotFoundException__ctor_1.htm)|
Создаёт экземпляр класса с указанием результата валидации.  
---|---  
[ServiceNotFoundException(SerializationInfo,
StreamingContext)](M_Tessa_Platform_Runtime_ServiceNotFoundException__ctor.htm)|
...
Exception)](M_Tessa_Platform_Runtime_ServiceNotFoundException__ctor_2.htm)|
