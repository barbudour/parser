# WorkflowEngineCompilationResult - класс
...
C# __Копировать
     public sealed class WorkflowEngineCompilationResult : IWorkflowEngineCompilationResult
VB __Копировать
     Public NotInheritable Class WorkflowEngineCompilationResult
    	Implements IWorkflowEngineCompilationResult
C++ __Копировать
     public ref class WorkflowEngineCompilationResult sealed : IWorkflowEngineCompilationResult
F# __Копировать
     [<SealedAttribute>]
    type WorkflowEngineCompilationResult = 
        class
            interface IWorkflowEngineCompilationResult
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ WorkflowEngineCompilationResult
Implements
...
Инициализирует новый экземпляр класса WorkflowEngineCompilationResult  
---|---  
