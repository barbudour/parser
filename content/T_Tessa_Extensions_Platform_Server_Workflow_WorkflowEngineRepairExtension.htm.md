# WorkflowEngineRepairExtension - класс
...
C# __Копировать
     public sealed class WorkflowEngineRepairExtension : CardRepairExtension
VB __Копировать
     Public NotInheritable Class WorkflowEngineRepairExtension
    	Inherits CardRepairExtension
C++ __Копировать
     public ref class WorkflowEngineRepairExtension sealed : public CardRepairExtension
F# __Копировать
     [<SealedAttribute>]
    type WorkflowEngineRepairExtension = 
        class
            inherit CardRepairExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm) __ WorkflowEngineRepairExtension
##  __Конструкторы
[WorkflowEngineRepairExtension](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowEngineRepairExtension__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowEngineRepairExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowEngineRepairExtension_AfterRequest.htm)|  
(Переопределяет
