# FillCommentsVirtualSectionGetExtension - класс
...
C# __Копировать
     public sealed class FillCommentsVirtualSectionGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class FillCommentsVirtualSectionGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class FillCommentsVirtualSectionGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type FillCommentsVirtualSectionGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ FillCommentsVirtualSectionGetExtension
##  __Конструкторы
[FillCommentsVirtualSectionGetExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_FillCommentsVirtualSectionGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса FillCommentsVirtualSectionGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_FillCommentsVirtualSectionGetExtension_AfterRequest.htm)|  
(Переопределяет
