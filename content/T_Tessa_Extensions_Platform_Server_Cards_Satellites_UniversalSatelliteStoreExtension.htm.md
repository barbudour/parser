# UniversalSatelliteStoreExtension - класс
...
C# __Копировать
     public sealed class UniversalSatelliteStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class UniversalSatelliteStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class UniversalSatelliteStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type UniversalSatelliteStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ UniversalSatelliteStoreExtension
##  __Конструкторы
[UniversalSatelliteStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса UniversalSatelliteStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteStoreExtension_AfterBeginTransaction.htm)|
...
---|---  
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteStoreExtension_AfterRequest.htm)|
...
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteStoreExtension_BeforeCommitTransaction.htm)|
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteStoreExtension_BeforeRequest.htm)|
