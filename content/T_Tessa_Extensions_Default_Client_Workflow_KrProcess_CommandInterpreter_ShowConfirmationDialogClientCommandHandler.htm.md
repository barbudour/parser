# ShowConfirmationDialogClientCommandHandler - класс
...
VB __Копировать
     Public NotInheritable Class ShowConfirmationDialogClientCommandHandler
    	Inherits ClientCommandHandlerBase
C++ __Копировать
     public ref class ShowConfirmationDialogClientCommandHandler sealed : public ClientCommandHandlerBase
F# __Копировать
     [<SealedAttribute>]
    type ShowConfirmationDialogClientCommandHandler = 
        class
            inherit ClientCommandHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ClientCommandHandlerBase](T_Tessa_Extensions_Default_Shared_Workflow_KrProcess_ClientCommandInterpreter_ClientCommandHandlerBase.htm) __ ShowConfirmationDialogClientCommandHandler
##  __Конструкторы
[ShowConfirmationDialogClientCommandHandler](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_CommandInterpreter_ShowConfirmationDialogClientCommandHandler__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Handle](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_CommandInterpreter_ShowConfirmationDialogClientCommandHandler_Handle.htm)|
