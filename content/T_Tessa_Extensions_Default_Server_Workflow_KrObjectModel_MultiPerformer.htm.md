...
VB __Копировать
     Public NotInheritable Class MultiPerformer
    	Inherits Performer
C++ __Копировать
     public ref class MultiPerformer sealed : public Performer
F# __Копировать
     [<SealedAttribute>]
    type MultiPerformer = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[Performer](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer.htm) __ MultiPerformer
##  __Конструкторы
[MultiPerformer(Dictionary<String,
Object>)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MultiPerformer__ctor.htm)|
Установить хранилище для декорирования  
---|---  
[MultiPerformer(MultiPerformer)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MultiPerformer__ctor_4.htm)|
Конструктор копирования. Запечатанность не переносится.  
[MultiPerformer(Guid, String, Guid,
Boolean)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MultiPerformer__ctor_2.htm)|
Для использования внутри пользовательского кода  
[MultiPerformer(String, String, Guid,
Boolean)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MultiPerformer__ctor_3.htm)|
Для использования внутри пользовательского кода  
[MultiPerformer(Guid, Guid, String, Guid,
Boolean)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MultiPerformer__ctor_1.htm)|
Для использования внутри пользовательского кода  
## __Свойства
[IsSealed](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_IsSealed.htm)|
...
---|---  
[IsSql](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MultiPerformer_IsSql.htm)|
Признак того, что исполнитель подставлен через SQL  
(Переопределяет
[Performer.IsSql](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_IsSql.htm))  
[PerformerID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MultiPerformer_PerformerID.htm)|
ID роли исполнителя  
(Переопределяет
[Performer.PerformerID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_PerformerID.htm))  
[PerformerName](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MultiPerformer_PerformerName.htm)|
Имя роли исполнителя  
(Переопределяет
[Performer.PerformerName](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_PerformerName.htm))  
[RowID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MultiPerformer_RowID.htm)|
Идентификатор строки исполнителя. Используется только для представления в
виртуальных секциях  
(Переопределяет
[Performer.RowID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_RowID.htm))  
[StageRowID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MultiPerformer_StageRowID.htm)|
ID этапа.  
(Переопределяет
[Performer.StageRowID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_StageRowID.htm))  
##  __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Equals(Object)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_Equals.htm)|  
(Унаследован от
[Performer](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer.htm))  
[Equals(Performer)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_Equals_1.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[GetHashCode](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_GetHashCode.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Seal](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_Seal.htm)|
...
восстановить в методе FromTypedJson.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[ToString](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_ToString.htm)|  
(Унаследован от
[Performer](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer.htm))  
...
(Определяется
[ComHelper](T_Tessa_Extensions_Default_Client_EDS_ComHelper.htm))  
[ToStringDetailed](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_KrCompilersExtensions_ToStringDetailed.htm)|  
(Определяется
[KrCompilersExtensions](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_KrCompilersExtensions.htm))  
[ToStringSummary](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_KrCompilersExtensions_ToStringSummary.htm)|  
(Определяется
[KrCompilersExtensions](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_KrCompilersExtensions.htm))  
##  __См. также
#### Ссылки
