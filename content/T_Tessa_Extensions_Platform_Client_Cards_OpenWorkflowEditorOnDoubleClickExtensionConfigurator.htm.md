# OpenWorkflowEditorOnDoubleClickExtensionConfigurator - класс
...
C# __Копировать
     public sealed class OpenWorkflowEditorOnDoubleClickExtensionConfigurator : ExtensionSettingsConfiguratorBase
VB __Копировать
     Public NotInheritable Class OpenWorkflowEditorOnDoubleClickExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class OpenWorkflowEditorOnDoubleClickExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type OpenWorkflowEditorOnDoubleClickExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ OpenWorkflowEditorOnDoubleClickExtensionConfigurator
##  __Конструкторы
[OpenWorkflowEditorOnDoubleClickExtensionConfigurator](M_Tessa_Extensions_Platform_Client_Cards_OpenWorkflowEditorOnDoubleClickExtensionConfigurator__ctor.htm)|
