# CardStoreGlobalCachingStrategy - класс
...
C# __Копировать
     public sealed class CardStoreGlobalCachingStrategy : ICardStoreCachingStrategy
VB __Копировать
     Public NotInheritable Class CardStoreGlobalCachingStrategy
    	Implements ICardStoreCachingStrategy
C++ __Копировать
     public ref class CardStoreGlobalCachingStrategy sealed : ICardStoreCachingStrategy
F# __Копировать
     [<SealedAttribute>]
    type CardStoreGlobalCachingStrategy = 
        class
            interface ICardStoreCachingStrategy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardStoreGlobalCachingStrategy
Implements
...
## __Конструкторы
[CardStoreGlobalCachingStrategy](M_Tessa_Cards_ComponentModel_CardStoreGlobalCachingStrategy__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Методы
[AddRowRemover](M_Tessa_Cards_ComponentModel_CardStoreGlobalCachingStrategy_AddRowRemover.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetRowRemover](M_Tessa_Cards_ComponentModel_CardStoreGlobalCachingStrategy_TryGetRowRemover.htm)|
