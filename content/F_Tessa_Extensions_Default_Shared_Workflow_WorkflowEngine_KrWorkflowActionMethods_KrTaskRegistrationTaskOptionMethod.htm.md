# KrWorkflowActionMethods.KrTaskRegistrationTaskOptionMethod - поле
...
VB __Копировать
     Public Shared ReadOnly KrTaskRegistrationTaskOptionMethod As WorkflowActionMethodDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionMethodDescriptor^ KrTaskRegistrationTaskOptionMethod
F# __Копировать
     static val KrTaskRegistrationTaskOptionMethod: WorkflowActionMethodDescriptor
#### Значение поля
