...
VB __Копировать
    <EditorBrowsableAttribute(EditorBrowsableState.Never)>
    Public NotInheritable Class ContactEntityCollection
    	Inherits ComplexPropertyCollection(Of ContactEntity)
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class ContactEntityCollection sealed : public ComplexPropertyCollection<ContactEntity^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type ContactEntityCollection = 
        class
            inherit ComplexPropertyCollection<ContactEntity>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[ContactEntity](T_Tessa_Exchange_WebServices_Data_ContactEntity.htm)> __ ContactEntityCollection
##  __Свойства
