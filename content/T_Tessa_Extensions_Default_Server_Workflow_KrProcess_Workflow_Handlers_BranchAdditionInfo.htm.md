...
VB __Копировать
     Public NotInheritable Class BranchAdditionInfo
    	Inherits StorageObject
C++ __Копировать
     public ref class BranchAdditionInfo sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    type BranchAdditionInfo = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ BranchAdditionInfo
##  __Конструкторы
[BranchAdditionInfo(Dictionary<String,
Object>)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_BranchAdditionInfo__ctor.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
---|---  
[BranchAdditionInfo(SerializationInfo,
StreamingContext)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_BranchAdditionInfo__ctor_2.htm)|
...
[BranchAdditionInfo(Guid, String, Dictionary<String,
Object>)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_BranchAdditionInfo__ctor_1.htm)|
Инициализирует новый экземпляр класса BranchAdditionInfo  
##  __Свойства
[SecondaryProcessID](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_BranchAdditionInfo_SecondaryProcessID.htm)|  
---|---  
[SecondaryProcessName](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_BranchAdditionInfo_SecondaryProcessName.htm)|  
[StartingProcessInfo](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_BranchAdditionInfo_StartingProcessInfo.htm)|  
## __Методы
