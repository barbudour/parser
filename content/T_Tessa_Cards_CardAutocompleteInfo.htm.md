# CardAutocompleteInfo - класс
Информация по выбранной ссылке в элементах управления
...
C# __Копировать
    ...
    public sealed class CardAutocompleteInfo : CardStorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardAutocompleteInfo
    	Inherits CardStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardAutocompleteInfo sealed : public CardStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardAutocompleteInfo = 
        class
            inherit CardStorageObject
            interface ICloneable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __ CardAutocompleteInfo
Implements
    [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable)
##  __Конструкторы
[CardAutocompleteInfo()](M_Tessa_Cards_CardAutocompleteInfo__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[CardAutocompleteInfo(Dictionary<String,
Object>)](M_Tessa_Cards_CardAutocompleteInfo__ctor_1.htm)| Создаёт экземпляр
класса с указанием хранилища, декоратором для которого является создаваемый
объект.  
[CardAutocompleteInfo(IStorageObjectProvider)](M_Tessa_Cards_CardAutocompleteInfo__ctor_2.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_CardAutocompleteInfo_Clone.htm)|  Выполняет глубокое
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Cards_CardAutocompleteInfo_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Set(Dictionary<String, Object>)](M_Tessa_Cards_CardAutocompleteInfo_Set.htm)|
...
Object>)](M_Tessa_Cards_CardAutocompleteInfo_TryGet.htm)|  Возвращает
информацию по выбранной ссылке CardAutocompleteInfo или null, если такая
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetColumnValues](M_Tessa_Cards_CardAutocompleteInfo_TryGetColumnValues.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardAutocompleteInfo_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
