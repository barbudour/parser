# FixContextRoleStoreExtension - класс
...
C# __Копировать
     public sealed class FixContextRoleStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class FixContextRoleStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class FixContextRoleStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type FixContextRoleStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ FixContextRoleStoreExtension
##  __Конструкторы
[FixContextRoleStoreExtension](M_Tessa_Extensions_Platform_Server_Roles_FixContextRoleStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса FixContextRoleStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Roles_FixContextRoleStoreExtension_BeforeRequest.htm)|  
(Переопределяет
