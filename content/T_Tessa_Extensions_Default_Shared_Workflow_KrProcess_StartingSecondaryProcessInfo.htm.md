# StartingSecondaryProcessInfo - класс
...
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class StartingSecondaryProcessInfo
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class StartingSecondaryProcessInfo sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type StartingSecondaryProcessInfo = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ StartingSecondaryProcessInfo
##  __Конструкторы
...
Инициализирует новый экземпляр объекта StartingSecondaryProcessInfo.  
## __Свойства
