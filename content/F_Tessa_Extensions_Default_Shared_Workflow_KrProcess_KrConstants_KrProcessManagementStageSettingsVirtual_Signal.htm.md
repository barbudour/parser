# KrConstants.KrProcessManagementStageSettingsVirtual.Signal - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly Signal As String
C++ __Копировать
     public:
    static initonly String^ Signal
F# __Копировать
     static val Signal: string
#### Значение поля
