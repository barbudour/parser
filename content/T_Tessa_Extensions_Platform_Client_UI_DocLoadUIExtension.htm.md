# DocLoadUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class DocLoadUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class DocLoadUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class DocLoadUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type DocLoadUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ DocLoadUIExtension
##  __Конструкторы
[DocLoadUIExtension](M_Tessa_Extensions_Platform_Client_UI_DocLoadUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса DocLoadUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_DocLoadUIExtension_Initialized.htm)|  
(Переопределяет
