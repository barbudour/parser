...
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class RouteDiff
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class RouteDiff sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type RouteDiff = 
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ RouteDiff
##  __Конструкторы
[RouteDiff()](M_Tessa_Extensions_Default_Shared_Workflow_KrCompilers_RouteDiff__ctor.htm)|
Инициализирует новый экземпляр класса RouteDiff  
---|---  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[DeleteStage](M_Tessa_Extensions_Default_Shared_Workflow_KrCompilers_RouteDiff_DeleteStage.htm)|
Инициализирует новый экземпляр класса RouteDiff данными удалённого этапа.  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ModifyStage](M_Tessa_Extensions_Default_Shared_Workflow_KrCompilers_RouteDiff_ModifyStage.htm)|
Инициализирует новый экземпляр класса RouteDiff данными изменённого этапа.  
[NewStage](M_Tessa_Extensions_Default_Shared_Workflow_KrCompilers_RouteDiff_NewStage.htm)|
Инициализирует новый экземпляр класса RouteDiff данными нового этапа.  
