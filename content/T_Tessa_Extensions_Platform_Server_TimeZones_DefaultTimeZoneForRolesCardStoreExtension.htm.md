# DefaultTimeZoneForRolesCardStoreExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.TimeZones](N_Tessa_Extensions_Platform_Server_TimeZones.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class DefaultTimeZoneForRolesCardStoreExtension : CardStoreExtension
VB __Копировать
     Public Class DefaultTimeZoneForRolesCardStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class DefaultTimeZoneForRolesCardStoreExtension : public CardStoreExtension
F# __Копировать
     type DefaultTimeZoneForRolesCardStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ DefaultTimeZoneForRolesCardStoreExtension
##  __Конструкторы
[DefaultTimeZoneForRolesCardStoreExtension](M_Tessa_Extensions_Platform_Server_TimeZones_DefaultTimeZoneForRolesCardStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса
DefaultTimeZoneForRolesCardStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_TimeZones_DefaultTimeZoneForRolesCardStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_TimeZones_DefaultTimeZoneForRolesCardStoreExtension_BeforeRequest.htm)|  
(Переопределяет
