# WindowLocationChangedEventManager - класс
...
C# __Копировать
     public sealed class WindowLocationChangedEventManager : WeakEventManager<WindowLocationChangedEventManager, Window>
VB __Копировать
     Public NotInheritable Class WindowLocationChangedEventManager
    	Inherits WeakEventManager(Of WindowLocationChangedEventManager, Window)
C++ __Копировать
     public ref class WindowLocationChangedEventManager sealed : public WeakEventManager<WindowLocationChangedEventManager^, Window^>
F# __Копировать
     [<SealedAttribute>]
    type WindowLocationChangedEventManager = 
        class
            inherit WeakEventManager<WindowLocationChangedEventManager, Window>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[WeakEventManager](https://learn.microsoft.com/dotnet/api/system.windows.weakeventmanager) __[WeakEventManager](T_Tessa_UI_WeakEventManager_2.htm)<WindowLocationChangedEventManager, [Window](https://learn.microsoft.com/dotnet/api/system.windows.window)> __ WindowLocationChangedEventManager
##  __Свойства
...
[StartListening(Window)](M_Tessa_UI_Windows_WindowLocationChangedEventManager_StartListening.htm)|
Присоединяет обработчик события от текущего объекта для заданного источника.  
...
(Унаследован от [WeakEventManager<TManager,
TEventSource>](T_Tessa_UI_WeakEventManager_2.htm))  
[StopListening(Window)](M_Tessa_UI_Windows_WindowLocationChangedEventManager_StopListening.htm)|
Отсоединяет обработчик события от текущего объекта для заданного источника.  
(Переопределяет [WeakEventManager<TManager,
