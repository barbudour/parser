# GetUserSettingsResponseCollection - класс
...
C++ __Копировать
     public ref class GetUserSettingsResponseCollection sealed : public AutodiscoverResponseCollection<GetUserSettingsResponse^>
F# __Копировать
     [<SealedAttribute>]
    type GetUserSettingsResponseCollection = 
        class
            inherit AutodiscoverResponseCollection<GetUserSettingsResponse>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[AutodiscoverResponse](T_Tessa_Exchange_WebServices_Autodiscover_AutodiscoverResponse.htm) __[AutodiscoverResponseCollection](T_Tessa_Exchange_WebServices_Autodiscover_AutodiscoverResponseCollection_1.htm)<[GetUserSettingsResponse](T_Tessa_Exchange_WebServices_Autodiscover_GetUserSettingsResponse.htm)> __ GetUserSettingsResponseCollection
##  __Свойства
