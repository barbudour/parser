# ForumPermissionsRequestObject - класс
##  __Definition
 **Пространство имён:** [Tessa.Forums](N_Tessa_Forums.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class ForumPermissionsRequestObject : StorageObject
VB __Копировать
     Public NotInheritable Class ForumPermissionsRequestObject
    	Inherits StorageObject
C++ __Копировать
     public ref class ForumPermissionsRequestObject sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    type ForumPermissionsRequestObject = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForumPermissionsRequestObject
##  __Конструкторы
[ForumPermissionsRequestObject()](M_Tessa_Forums_ForumPermissionsRequestObject__ctor.htm)|
Инициализирует новый экземпляр класса ForumPermissionsRequestObject  
---|---  
[ForumPermissionsRequestObject(Dictionary<String,
Object>)](M_Tessa_Forums_ForumPermissionsRequestObject__ctor_1.htm)|
Инициализирует новый экземпляр класса ForumPermissionsRequestObject  
##  __Свойства
[CardID](P_Tessa_Forums_ForumPermissionsRequestObject_CardID.htm)|  
---|---  
[IsMyMessage](P_Tessa_Forums_ForumPermissionsRequestObject_IsMyMessage.htm)|  
[IsSuperModeratorModeEnabled](P_Tessa_Forums_ForumPermissionsRequestObject_IsSuperModeratorModeEnabled.htm)|  
[PermissionsToken](P_Tessa_Forums_ForumPermissionsRequestObject_PermissionsToken.htm)|  
[TopicID](P_Tessa_Forums_ForumPermissionsRequestObject_TopicID.htm)|  
## __Методы
