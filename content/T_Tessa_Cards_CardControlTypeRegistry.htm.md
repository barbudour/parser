# CardControlTypeRegistry - класс
Реестр типов элементов управления
...
C# __Копировать
     public sealed class CardControlTypeRegistry : Registry<Guid, CardControlType>, 
    	ICardControlTypeRegistry, IRegistry<Guid, CardControlType>
VB __Копировать
     Public NotInheritable Class CardControlTypeRegistry
    	Inherits Registry(Of Guid, CardControlType)
    	Implements ICardControlTypeRegistry, IRegistry(Of Guid, CardControlType)
C++ __Копировать
     public ref class CardControlTypeRegistry sealed : public Registry<Guid, CardControlType^>, 
    	ICardControlTypeRegistry, IRegistry<Guid, CardControlType^>
F# __Копировать
     [<SealedAttribute>]
    type CardControlTypeRegistry = 
        class
            inherit Registry<Guid, CardControlType>
            interface ICardControlTypeRegistry
            interface IRegistry<Guid, CardControlType>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Registry](T_Tessa_Platform_Registry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [CardControlType](T_Tessa_Cards_CardControlType.htm)> __ CardControlTypeRegistry
Implements
    [ICardControlTypeRegistry](T_Tessa_Cards_ICardControlTypeRegistry.htm), [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [CardControlType](T_Tessa_Cards_CardControlType.htm)>
##  __Свойства
