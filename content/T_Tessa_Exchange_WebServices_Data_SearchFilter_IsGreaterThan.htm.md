# SearchFilter.IsGreaterThan - класс
...
VB __Копировать
     Public NotInheritable Class IsGreaterThan
    	Inherits SearchFilter.RelationalFilter
C++ __Копировать
     public ref class IsGreaterThan sealed : public SearchFilter.RelationalFilter
F# __Копировать
     [<SealedAttribute>]
    type IsGreaterThan = 
        class
