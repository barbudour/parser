# CheckRoleSchedulingFieldsStoreExtension - класс
...
C# __Копировать
     public sealed class CheckRoleSchedulingFieldsStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class CheckRoleSchedulingFieldsStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class CheckRoleSchedulingFieldsStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type CheckRoleSchedulingFieldsStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ CheckRoleSchedulingFieldsStoreExtension
##  __Конструкторы
[CheckRoleSchedulingFieldsStoreExtension](M_Tessa_Extensions_Platform_Server_Roles_CheckRoleSchedulingFieldsStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса CheckRoleSchedulingFieldsStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Roles_CheckRoleSchedulingFieldsStoreExtension_AfterBeginTransaction.htm)|  
(Переопределяет
