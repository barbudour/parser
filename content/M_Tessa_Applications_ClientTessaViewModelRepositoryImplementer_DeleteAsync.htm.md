# ClientTessaViewModelRepositoryImplementer.DeleteAsync - метод
...
TResponse>.DeleteAsync(TChangeRequest,
CancellationToken)](M_Tessa_Views_IRepository_3_DeleteAsync.htm)  
##  __См. также
#### Ссылки
