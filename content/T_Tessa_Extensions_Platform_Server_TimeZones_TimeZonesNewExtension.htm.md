# TimeZonesNewExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.TimeZones](N_Tessa_Extensions_Platform_Server_TimeZones.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class TimeZonesNewExtension : CardNewExtension
VB __Копировать
     Public Class TimeZonesNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class TimeZonesNewExtension : public CardNewExtension
F# __Копировать
     type TimeZonesNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ TimeZonesNewExtension
##  __Конструкторы
[TimeZonesNewExtension](M_Tessa_Extensions_Platform_Server_TimeZones_TimeZonesNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса TimeZonesNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_TimeZones_TimeZonesNewExtension_AfterRequest.htm)|  
(Переопределяет
