# AcquaintanceGetExtension - класс
...
VB __Копировать
     Public NotInheritable Class AcquaintanceGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class AcquaintanceGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type AcquaintanceGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ AcquaintanceGetExtension
##  __Конструкторы
[AcquaintanceGetExtension](M_Tessa_Extensions_Default_Server_Acquaintance_AcquaintanceGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса AcquaintanceGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Acquaintance_AcquaintanceGetExtension_AfterRequest.htm)|  
(Переопределяет
