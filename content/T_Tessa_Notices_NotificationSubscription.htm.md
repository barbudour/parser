# NotificationSubscription - класс
##  __Definition
 **Пространство имён:** [Tessa.Notices](N_Tessa_Notices.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class NotificationSubscription : StorageObject
VB __Копировать
     Public NotInheritable Class NotificationSubscription
    	Inherits StorageObject
C++ __Копировать
     public ref class NotificationSubscription sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ NotificationSubscription
##  __Конструкторы
[NotificationSubscription()](M_Tessa_Notices_NotificationSubscription__ctor.htm)|
Инициализирует новый экземпляр класса NotificationSubscription  
---|---  
[NotificationSubscription(Dictionary<String,
Object>)](M_Tessa_Notices_NotificationSubscription__ctor_1.htm)|
Инициализирует новый экземпляр класса NotificationSubscription  
[NotificationSubscription(SerializationInfo,
StreamingContext)](M_Tessa_Notices_NotificationSubscription__ctor_2.htm)|
Инициализирует новый экземпляр класса NotificationSubscription  
##  __Свойства
[CardDigest](P_Tessa_Notices_NotificationSubscription_CardDigest.htm)|  
---|---  
[IsSubscription](P_Tessa_Notices_NotificationSubscription_IsSubscription.htm)|  
[NotificationTypeID](P_Tessa_Notices_NotificationSubscription_NotificationTypeID.htm)|  
[NotificationTypeName](P_Tessa_Notices_NotificationSubscription_NotificationTypeName.htm)|  
[SubscriptionID](P_Tessa_Notices_NotificationSubscription_SubscriptionID.htm)|  
[UserID](P_Tessa_Notices_NotificationSubscription_UserID.htm)|  
## __Методы
