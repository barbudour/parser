# PlatformCardExtensionHelper.RestoreDeletedCardAsync - метод
...
C# __Копировать
     public static Task RestoreDeletedCardAsync(
    	IUIContext context,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Public Shared Function RestoreDeletedCardAsync ( 
    	context As IUIContext,
    	Optional cancellationToken As CancellationToken = Nothing
    ) As Task
C++ __Копировать
     public:
    static Task^ RestoreDeletedCardAsync(
    	IUIContext^ context, 
    	CancellationToken cancellationToken = CancellationToken()
    )
F# __Копировать
     static member RestoreDeletedCardAsync : 
            context : IUIContext * 
