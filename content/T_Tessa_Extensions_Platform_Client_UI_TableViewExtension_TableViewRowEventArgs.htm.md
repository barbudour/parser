...
C# __Копировать
     public class TableViewRowEventArgs : RowEventArgs
VB __Копировать
     Public Class TableViewRowEventArgs
    	Inherits RowEventArgs
C++ __Копировать
     public ref class TableViewRowEventArgs : public RowEventArgs
F# __Копировать
     type TableViewRowEventArgs = 
        class
            inherit RowEventArgs
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[EventArgs](https://learn.microsoft.com/dotnet/api/system.eventargs) __[DeferredEventArgs](T_Tessa_Platform_DeferredEventArgs.htm) __[RowEventArgs](T_Tessa_UI_Cards_Controls_RowEventArgs.htm) __ TableViewRowEventArgs
##  __Конструкторы
[TableViewRowEventArgs](M_Tessa_Extensions_Platform_Client_UI_TableViewExtension_TableViewRowEventArgs__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[SetWindowTitle](M_Tessa_UI_Cards_Controls_RowEventArgs_SetWindowTitle.htm)|
Устанавливает заголовок окна и свойство `Automation.Name` равным переданному
значению.  
Если окно не установлено на момент вызова, не делает ничего.  
(Унаследован от [RowEventArgs](T_Tessa_UI_Cards_Controls_RowEventArgs.htm))  
