# KrRequestCommentUIExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrRequestCommentUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrRequestCommentUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrRequestCommentUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrRequestCommentUIExtension
##  __Конструкторы
[KrRequestCommentUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrRequestCommentUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrRequestCommentUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrRequestCommentUIExtension_Initialized.htm)|  
(Переопределяет
