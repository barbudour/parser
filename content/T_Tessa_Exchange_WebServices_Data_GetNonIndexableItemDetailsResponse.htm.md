# GetNonIndexableItemDetailsResponse - класс
...
C++ __Копировать
     public ref class GetNonIndexableItemDetailsResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ GetNonIndexableItemDetailsResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[NonIndexableItemsResult](P_Tessa_Exchange_WebServices_Data_GetNonIndexableItemDetailsResponse_NonIndexableItemsResult.htm)|
