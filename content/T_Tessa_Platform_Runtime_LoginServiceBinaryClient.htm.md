# LoginServiceBinaryClient - класс
...
C# __Копировать
     public sealed class LoginServiceBinaryClient : ILoginService
VB __Копировать
     Public NotInheritable Class LoginServiceBinaryClient
    	Implements ILoginService
C++ __Копировать
     public ref class LoginServiceBinaryClient sealed : ILoginService
F# __Копировать
     [<SealedAttribute>]
    type LoginServiceBinaryClient = 
        class
            interface ILoginService
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ LoginServiceBinaryClient
Implements
    [ILoginService](T_Tessa_Platform_Runtime_ILoginService.htm)
##  __Конструкторы
[LoginServiceBinaryClient](M_Tessa_Platform_Runtime_LoginServiceBinaryClient__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[OpenSessionAsync](M_Tessa_Platform_Runtime_LoginServiceBinaryClient_OpenSessionAsync.htm)|
...
[OpenSessionWindowsAuthAsync](M_Tessa_Platform_Runtime_LoginServiceBinaryClient_OpenSessionWindowsAuthAsync.htm)|
