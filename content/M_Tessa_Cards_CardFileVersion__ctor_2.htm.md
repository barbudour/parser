# CardFileVersion(IStorageObjectProvider) - конструктор
...
F# __Копировать
     new : 
            storageProvider : IStorageObjectProvider -> CardFileVersion
#### Параметры
storageProvider
...
[CardFileVersion - перегрузка](Overload_Tessa_Cards_CardFileVersion__ctor.htm)
