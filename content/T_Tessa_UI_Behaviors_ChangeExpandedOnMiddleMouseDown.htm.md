# ChangeExpandedOnMiddleMouseDown - класс
...
C# __Копировать
     public sealed class ChangeExpandedOnMiddleMouseDown : Behavior<TreeView>
VB __Копировать
     Public NotInheritable Class ChangeExpandedOnMiddleMouseDown
    	Inherits Behavior(Of TreeView)
C++ __Копировать
     public ref class ChangeExpandedOnMiddleMouseDown sealed : public Behavior<TreeView^>
F# __Копировать
     [<SealedAttribute>]
    type ChangeExpandedOnMiddleMouseDown = 
        class
            inherit Behavior<TreeView>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[TreeView](https://learn.microsoft.com/dotnet/api/system.windows.controls.treeview)> __ ChangeExpandedOnMiddleMouseDown
##  __Конструкторы
[ChangeExpandedOnMiddleMouseDown](M_Tessa_UI_Behaviors_ChangeExpandedOnMiddleMouseDown__ctor.htm)|
Инициализирует новый экземпляр класса ChangeExpandedOnMiddleMouseDown  
---|---  
##  __Свойства
...
(Унаследован от
[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject))  
[HandledEventsToo](P_Tessa_UI_Behaviors_ChangeExpandedOnMiddleMouseDown_HandledEventsToo.htm)|
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_ChangeExpandedOnMiddleMouseDown_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_ChangeExpandedOnMiddleMouseDown_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_ChangeExpandedOnMiddleMouseDown_OnDetaching.htm)|  
(Переопределяет
