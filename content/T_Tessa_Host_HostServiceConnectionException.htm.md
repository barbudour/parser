# HostServiceConnectionException - класс
...
C# __Копировать
    ...
    public class HostServiceConnectionException : ApplicationException
VB __Копировать
    <SerializableAttribute>
    Public Class HostServiceConnectionException
    	Inherits ApplicationException
C++ __Копировать
    [SerializableAttribute]
    public ref class HostServiceConnectionException : public ApplicationException
F# __Копировать
     [<SerializableAttribute>]
    type HostServiceConnectionException = 
        class
            inherit ApplicationException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception) __ HostServiceConnectionException
##  __Конструкторы
[HostServiceConnectionException()](M_Tessa_Host_HostServiceConnectionException__ctor.htm)|
Initializes a new instance of the
[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception)
class.  
---|---  
[HostServiceConnectionException(String)](M_Tessa_Host_HostServiceConnectionException__ctor_2.htm)|
Initializes a new instance of the
[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception)
class with a specified error message.  
[HostServiceConnectionException(SerializationInfo,
StreamingContext)](M_Tessa_Host_HostServiceConnectionException__ctor_1.htm)|
Initializes a new instance of the
[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception)
class with serialized data.  
[HostServiceConnectionException(String,
Exception)](M_Tessa_Host_HostServiceConnectionException__ctor_3.htm)|
Initializes a new instance of the
[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception)
