# FinalizeInvalidateCacheRequestExtension - класс
...
C# __Копировать
     public sealed class FinalizeInvalidateCacheRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class FinalizeInvalidateCacheRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class FinalizeInvalidateCacheRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type FinalizeInvalidateCacheRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ FinalizeInvalidateCacheRequestExtension
##  __Конструкторы
[FinalizeInvalidateCacheRequestExtension](M_Tessa_Extensions_Platform_Server_Caching_FinalizeInvalidateCacheRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса FinalizeInvalidateCacheRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Caching_FinalizeInvalidateCacheRequestExtension_AfterRequest.htm)|  
(Переопределяет
