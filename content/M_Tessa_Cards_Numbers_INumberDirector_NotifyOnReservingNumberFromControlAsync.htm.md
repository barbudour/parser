# INumberDirector.NotifyOnReservingNumberFromControlAsync - метод
...
C# __Копировать
     Task<bool> NotifyOnReservingNumberFromControlAsync(
    	INumberContext context,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Function NotifyOnReservingNumberFromControlAsync ( 
