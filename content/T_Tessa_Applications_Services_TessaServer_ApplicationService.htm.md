...
C++ __Копировать
     public ref class ApplicationService sealed : IApplicationService
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ApplicationService
Implements
    [IApplicationService](T_Tessa_Applications_Services_TessaServer_IApplicationService.htm)
##  __Конструкторы
[ApplicationService](M_Tessa_Applications_Services_TessaServer_ApplicationService__ctor.htm)|
Initializes a new instance of the ApplicationService class. Инициализирует
новый экземпляр класса
[Object](https://learn.microsoft.com/dotnet/api/system.object).  
---|---  
## __Методы
[DownloadAsync](M_Tessa_Applications_Services_TessaServer_ApplicationService_DownloadAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetApplicationsAsync](M_Tessa_Applications_Services_TessaServer_ApplicationService_GetApplicationsAsync.htm)|
Возвращает список всех приложений, доступных пользователю.  
[GetDownloadReaderFlags](M_Tessa_Applications_Services_TessaServer_ApplicationService_GetDownloadReaderFlags.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetApplicationIdAsync](M_Tessa_Applications_Services_TessaServer_ApplicationService_TryGetApplicationIdAsync.htm)|
Осуществляет попытку получения идентификатора приложения по его алиасу.  
[TryGetFaultedResultAsync](M_Tessa_Applications_Services_TessaServer_ApplicationService_TryGetFaultedResultAsync.htm)|
...
[TryGetModifiedAsync](M_Tessa_Applications_Services_TessaServer_ApplicationService_TryGetModifiedAsync.htm)|
