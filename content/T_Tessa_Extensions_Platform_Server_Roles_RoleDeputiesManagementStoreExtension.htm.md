# RoleDeputiesManagementStoreExtension - класс
...
C# __Копировать
     public sealed class RoleDeputiesManagementStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class RoleDeputiesManagementStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class RoleDeputiesManagementStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type RoleDeputiesManagementStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ RoleDeputiesManagementStoreExtension
##  __Конструкторы
[RoleDeputiesManagementStoreExtension](M_Tessa_Extensions_Platform_Server_Roles_RoleDeputiesManagementStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса RoleDeputiesManagementStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Roles_RoleDeputiesManagementStoreExtension_AfterBeginTransaction.htm)|  
(Переопределяет
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Roles_RoleDeputiesManagementStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Roles_RoleDeputiesManagementStoreExtension_BeforeRequest.htm)|  
(Переопределяет
