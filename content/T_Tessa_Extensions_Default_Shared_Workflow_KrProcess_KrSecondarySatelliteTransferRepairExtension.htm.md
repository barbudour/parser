# KrSecondarySatelliteTransferRepairExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class KrSecondarySatelliteTransferRepairExtension : CardSatelliteTransferRepairExtension
VB __Копировать
     Public NotInheritable Class KrSecondarySatelliteTransferRepairExtension
    	Inherits CardSatelliteTransferRepairExtension
C++ __Копировать
     public ref class KrSecondarySatelliteTransferRepairExtension sealed : public CardSatelliteTransferRepairExtension
F# __Копировать
     [<SealedAttribute>]
    type KrSecondarySatelliteTransferRepairExtension = 
        class
            inherit CardSatelliteTransferRepairExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm) __[CardSatelliteTransferRepairExtension](T_Tessa_Cards_Extensions_Templates_CardSatelliteTransferRepairExtension.htm) __ KrSecondarySatelliteTransferRepairExtension
##  __Конструкторы
[KrSecondarySatelliteTransferRepairExtension](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrSecondarySatelliteTransferRepairExtension__ctor.htm)|
...
(Унаследован от
[CardSatelliteTransferRepairExtension](T_Tessa_Cards_Extensions_Templates_CardSatelliteTransferRepairExtension.htm))  
[SatelliteSectionName](P_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrSecondarySatelliteTransferRepairExtension_SatelliteSectionName.htm)|  
(Переопределяет
...
[StoreKey](P_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrSecondarySatelliteTransferRepairExtension_StoreKey.htm)|  
(Переопределяет
