# KrConstants.KrSettingsRouteExtraTaskTypes.TaskTypeID - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Const TaskTypeID As String = "TaskTypeID"
C++ __Копировать
     public:
    literal String^ TaskTypeID = "TaskTypeID"
F# __Копировать
     static val mutable TaskTypeID: string
#### Значение поля
