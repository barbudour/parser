# DecompressCardGetExtension - класс
...
C# __Копировать
     public sealed class DecompressCardGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class DecompressCardGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class DecompressCardGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type DecompressCardGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ DecompressCardGetExtension
##  __Конструкторы
[DecompressCardGetExtension](M_Tessa_Extensions_Platform_Shared_Cards_DecompressCardGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса DecompressCardGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Shared_Cards_DecompressCardGetExtension_AfterRequest.htm)|  
(Переопределяет
