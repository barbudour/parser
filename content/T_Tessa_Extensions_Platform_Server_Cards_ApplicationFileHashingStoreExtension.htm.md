# ApplicationFileHashingStoreExtension - класс
...
C# __Копировать
     public sealed class ApplicationFileHashingStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class ApplicationFileHashingStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class ApplicationFileHashingStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type ApplicationFileHashingStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ ApplicationFileHashingStoreExtension
##  __Конструкторы
[ApplicationFileHashingStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_ApplicationFileHashingStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса ApplicationFileHashingStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_ApplicationFileHashingStoreExtension_BeforeRequest.htm)|  
(Переопределяет
