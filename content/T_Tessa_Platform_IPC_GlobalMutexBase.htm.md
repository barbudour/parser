...
[IGlobalMutex](T_Tessa_Platform_IPC_IGlobalMutex.htm).
## __Definition
...
Derived
[Tessa.Platform.IPC.DefaultGlobalMutex](T_Tessa_Platform_IPC_DefaultGlobalMutex.htm)
[Tessa.Platform.IPC.LinuxGlobalMutex](T_Tessa_Platform_IPC_LinuxGlobalMutex.htm)
Implements
    [IAsyncDisposable](https://learn.microsoft.com/dotnet/api/system.iasyncdisposable), [IGlobalMutex](T_Tessa_Platform_IPC_IGlobalMutex.htm)
##  __Конструкторы
[GlobalMutexBase](M_Tessa_Platform_IPC_GlobalMutexBase__ctor.htm)|
...
[ReleaseCoreAsync](M_Tessa_Platform_IPC_GlobalMutexBase_ReleaseCoreAsync.htm)|
Освобождает блокировку на текущий мьютекс. Не выполняет действий, если
блокировка не была взята.  
...
[WaitCoreAsync](M_Tessa_Platform_IPC_GlobalMutexBase_WaitCoreAsync.htm)|
