# StageSourceBuildTileExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class StageSourceBuildTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class StageSourceBuildTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type StageSourceBuildTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ StageSourceBuildTileExtension
##  __Конструкторы
[StageSourceBuildTileExtension](M_Tessa_Extensions_Default_Client_Tiles_StageSourceBuildTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса StageSourceBuildTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_StageSourceBuildTileExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[InitializingLocal](M_Tessa_Extensions_Default_Client_Tiles_StageSourceBuildTileExtension_InitializingLocal.htm)|  
(Переопределяет
