# KrWorkflowActionMethods.EditInterjectTaskInitMethod - поле
...
VB __Копировать
     Public Shared ReadOnly EditInterjectTaskInitMethod As WorkflowActionMethodDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionMethodDescriptor^ EditInterjectTaskInitMethod
F# __Копировать
     static val EditInterjectTaskInitMethod: WorkflowActionMethodDescriptor
#### Значение поля
