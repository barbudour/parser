# ReadOnlyText - класс
Определяет для контролов, содержащих текст, свойство
...
C# __Копировать
     public sealed class ReadOnlyText : Behavior<UIElement>
VB __Копировать
     Public NotInheritable Class ReadOnlyText
    	Inherits Behavior(Of UIElement)
C++ __Копировать
     public ref class ReadOnlyText sealed : public Behavior<UIElement^>
F# __Копировать
     [<SealedAttribute>]
    type ReadOnlyText = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement)> __ ReadOnlyText
##  __Конструкторы
[ReadOnlyText](M_Tessa_UI_Behaviors_ReadOnlyText__ctor.htm)| Инициализирует
новый экземпляр класса ReadOnlyText  
---|---  
##  __Свойства
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[IsReadOnly](P_Tessa_UI_Behaviors_ReadOnlyText_IsReadOnly.htm)|  Признак того,
что режим "только для чтения" активирован.  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_ReadOnlyText_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_ReadOnlyText_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_ReadOnlyText_OnDetaching.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[IsReadOnlyProperty](F_Tessa_UI_Behaviors_ReadOnlyText_IsReadOnlyProperty.htm)|  
---|---  
## __См. также
#### Ссылки
