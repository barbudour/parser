# KrEditModeToolbarUIExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrEditModeToolbarUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrEditModeToolbarUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrEditModeToolbarUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrEditModeToolbarUIExtension
##  __Конструкторы
[KrEditModeToolbarUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrEditModeToolbarUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrEditModeToolbarUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrEditModeToolbarUIExtension_Initialized.htm)|  
(Переопределяет
