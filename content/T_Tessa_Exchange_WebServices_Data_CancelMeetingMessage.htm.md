...
C++ __Копировать
     public ref class CancelMeetingMessage sealed : public CalendarResponseMessageBase<MeetingCancellation^>
F# __Копировать
     [<SealedAttribute>]
    type CancelMeetingMessage = 
        class
            inherit CalendarResponseMessageBase<MeetingCancellation>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceObject](T_Tessa_Exchange_WebServices_Data_ServiceObject.htm) __[ResponseObject](T_Tessa_Exchange_WebServices_Data_ResponseObject_1.htm)<[MeetingCancellation](T_Tessa_Exchange_WebServices_Data_MeetingCancellation.htm)> __[CalendarResponseMessageBase](T_Tessa_Exchange_WebServices_Data_CalendarResponseMessageBase_1.htm)<[MeetingCancellation](T_Tessa_Exchange_WebServices_Data_MeetingCancellation.htm)> __ CancelMeetingMessage
##  __Свойства
[Body](P_Tessa_Exchange_WebServices_Data_CancelMeetingMessage_Body.htm)|  Gets
or sets the body of the response.  
---|---  
