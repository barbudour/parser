...
C# __Копировать
     public class ViewWalker<TContext> : IViewWalker<TContext>
VB __Копировать
     Public Class ViewWalker(Of TContext)
    	Implements IViewWalker(Of TContext)
C++ __Копировать
    generic<typename TContext>
    public ref class ViewWalker : IViewWalker<TContext>
F# __Копировать
     type ViewWalker<'TContext> = 
        class
            interface IViewWalker<'TContext>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ViewWalker<TContext>
Implements
    [IViewWalker](T_Tessa_Views_AccessPolicy_IViewWalker_1.htm)<TContext>
#### Параметры типа
TContext
     Тип контекста 
## __Конструкторы
[ViewWalker<TContext>](M_Tessa_Views_AccessPolicy_ViewWalker_1__ctor.htm)|
Инициализирует новый экземпляр класса ViewWalker<TContext>  
---|---  
##  __Методы
