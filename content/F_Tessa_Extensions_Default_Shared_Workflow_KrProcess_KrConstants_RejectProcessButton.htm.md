# KrConstants.RejectProcessButton - поле
...
VB __Копировать
     Public Shared ReadOnly RejectProcessButton As Guid
C++ __Копировать
     public:
    static initonly Guid RejectProcessButton
F# __Копировать
     static val RejectProcessButton: Guid
#### Значение поля
