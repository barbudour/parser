# SealedApplicationStoreExtension - класс
...
C# __Копировать
     public sealed class SealedApplicationStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class SealedApplicationStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class SealedApplicationStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type SealedApplicationStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ SealedApplicationStoreExtension
##  __Конструкторы
[SealedApplicationStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_SealedApplicationStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса SealedApplicationStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_SealedApplicationStoreExtension_BeforeRequest.htm)|  
(Переопределяет
