# MoveFileRequestExtension - класс
...
VB __Копировать
     Public NotInheritable Class MoveFileRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class MoveFileRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type MoveFileRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ MoveFileRequestExtension
##  __Конструкторы
[MoveFileRequestExtension](M_Tessa_Extensions_Default_Server_Cards_MoveFileRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса MoveFileRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Cards_MoveFileRequestExtension_AfterRequest.htm)|  
(Переопределяет
