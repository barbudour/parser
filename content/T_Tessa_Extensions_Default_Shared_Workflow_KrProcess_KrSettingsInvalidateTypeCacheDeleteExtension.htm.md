# KrSettingsInvalidateTypeCacheDeleteExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class KrSettingsInvalidateTypeCacheDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class KrSettingsInvalidateTypeCacheDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class KrSettingsInvalidateTypeCacheDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type KrSettingsInvalidateTypeCacheDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ KrSettingsInvalidateTypeCacheDeleteExtension
##  __Конструкторы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrSettingsInvalidateTypeCacheDeleteExtension_AfterRequest.htm)|  
(Переопределяет
