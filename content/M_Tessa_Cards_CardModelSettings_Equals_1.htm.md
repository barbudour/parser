# CardModelSettings.Equals(ICardModelSettings) - метод
...
C# __Копировать
     public bool Equals(
    	ICardModelSettings other
    )
VB __Копировать
     Public Function Equals ( 
    	other As ICardModelSettings
    ) As Boolean
C++ __Копировать
     public:
    virtual bool Equals(
...
F# __Копировать
     abstract Equals : 
            other : ICardModelSettings -> bool 
    override Equals : 
            other : ICardModelSettings -> bool 
#### Параметры
other [ICardModelSettings](T_Tessa_Cards_ICardModelSettings.htm)
...
[Equals - перегрузка](Overload_Tessa_Cards_CardModelSettings_Equals.htm)
