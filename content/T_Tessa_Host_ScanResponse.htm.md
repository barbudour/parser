# ScanResponse - класс
Результат ответа от сервиса сканирования
## __Definition
 **Пространство имён:** [Tessa.Host](N_Tessa_Host.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class ScanResponse : StorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class ScanResponse
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class ScanResponse sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type ScanResponse = 
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ScanResponse
##  __Конструкторы
[ScanResponse()](M_Tessa_Host_ScanResponse__ctor.htm)|  Создаёт экземпляр
класса и пустое хранилище Dictionary<string, object>, декоратором для которого
является создаваемый объект.  
---|---  
[ScanResponse(Dictionary<String,
Object>)](M_Tessa_Host_ScanResponse__ctor_1.htm)| Создаёт экземпляр класса с
указанием хранилища, декоратором для которого является создаваемый объект.  
[ScanResponse(IStorageObjectProvider)](M_Tessa_Host_ScanResponse__ctor_2.htm)|
...
[ScanResponse(ValidationResult)](M_Tessa_Host_ScanResponse__ctor_3.htm)|
Создаёт экземпляр класса с указанием значений его свойств.  
## __Свойства
[ValidationResult](P_Tessa_Host_ScanResponse_ValidationResult.htm)|  Результат
валидации, полученный от сервера.  
---|---  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Host_ScanResponse_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
##  __Поля
[ValidationResultKey](F_Tessa_Host_ScanResponse_ValidationResultKey.htm)|  
---|---  
## __Методы расширения
