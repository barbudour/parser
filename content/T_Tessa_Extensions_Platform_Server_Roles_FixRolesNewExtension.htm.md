...
C# __Копировать
     public sealed class FixRolesNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class FixRolesNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class FixRolesNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type FixRolesNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ FixRolesNewExtension
##  __Конструкторы
[FixRolesNewExtension](M_Tessa_Extensions_Platform_Server_Roles_FixRolesNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса FixRolesNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_FixRolesNewExtension_AfterRequest.htm)|  
(Переопределяет
