# CardDeleteRequest(Dictionary<String, Object>) - конструктор
...
F# __Копировать
     new : 
            storage : Dictionary<string, Object> -> CardDeleteRequest
#### Параметры
storage
...
[CardDeleteRequest -
перегрузка](Overload_Tessa_Cards_CardDeleteRequest__ctor.htm)
