# ClientTessaViewModelRepositoryImplementer.ChangeAsync - метод
...
VB __Копировать
     Public Function ChangeAsync ( 
    	request As IStoreTessaViewRequest,
    	Optional cancellationToken As CancellationToken = Nothing
    ) As Task
C++ __Копировать
     public:
    virtual Task^ ChangeAsync(
    	IStoreTessaViewRequest^ request, 
    	CancellationToken cancellationToken = CancellationToken()
    ) sealed
F# __Копировать
     abstract ChangeAsync : 
...
TResponse>.ChangeAsync(TChangeRequest,
CancellationToken)](M_Tessa_Views_IRepository_3_ChangeAsync.htm)  
##  __См. также
#### Ссылки
