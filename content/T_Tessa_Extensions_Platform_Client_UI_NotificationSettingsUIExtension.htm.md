# NotificationSettingsUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class NotificationSettingsUIExtension : CardUIExtension, 
    	IMySettingsExtension, IExtension
VB __Копировать
     Public NotInheritable Class NotificationSettingsUIExtension
    	Inherits CardUIExtension
    	Implements IMySettingsExtension, IExtension
C++ __Копировать
     public ref class NotificationSettingsUIExtension sealed : public CardUIExtension, 
    	IMySettingsExtension, IExtension
F# __Копировать
     [<SealedAttribute>]
    type NotificationSettingsUIExtension = 
        class
            inherit CardUIExtension
            interface IMySettingsExtension
            interface IExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ NotificationSettingsUIExtension
Implements
    [IExtension](T_Tessa_Extensions_IExtension.htm), [IMySettingsExtension](T_Tessa_UI_Cards_IMySettingsExtension.htm)
##  __Конструкторы
[NotificationSettingsUIExtension](M_Tessa_Extensions_Platform_Client_UI_NotificationSettingsUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса NotificationSettingsUIExtension  
---|---  
##  __Методы
...
(Унаследован от [CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm))  
[Saved](M_Tessa_Extensions_Platform_Client_UI_NotificationSettingsUIExtension_Saved.htm)|  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[UserCancelled](M_Tessa_Extensions_Platform_Client_UI_NotificationSettingsUIExtension_UserCancelled.htm)|  
[Validating](M_Tessa_Extensions_Platform_Client_UI_NotificationSettingsUIExtension_Validating.htm)|  
## __Методы расширения
