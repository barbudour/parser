...
C# __Копировать
    [RouteAttribute("api/b/Views")]
    [AllowAnonymousAttribute]
    [ApiExplorerSettingsAttribute(IgnoreApi = true)]
    public sealed class ViewsBinaryController : Controller
VB __Копировать
    <RouteAttribute("api/b/Views")>
    <AllowAnonymousAttribute>
    <ApiExplorerSettingsAttribute(IgnoreApi := true)>
    Public NotInheritable Class ViewsBinaryController
    	Inherits Controller
C++ __Копировать
    [RouteAttribute(L"api/b/Views")]
    [AllowAnonymousAttribute]
    [ApiExplorerSettingsAttribute(IgnoreApi = true)]
    public ref class ViewsBinaryController sealed : public Controller
F# __Копировать
     [<SealedAttribute>]
    [<RouteAttribute("api/b/Views")>]
    [<AllowAnonymousAttribute>]
    [<ApiExplorerSettingsAttribute(IgnoreApi = true)>]
    type ViewsBinaryController = 
        class
            inherit Controller
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase) __[Controller](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controller) __ ViewsBinaryController
##  __Конструкторы
[ViewsBinaryController](M_Tessa_Web_Controllers_ViewsBinaryController__ctor.htm)|
Инициализирует новый экземпляр класса ViewsBinaryController  
---|---  
##  __Свойства
...
(Унаследован от
[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase))  
[PostGetData](M_Tessa_Web_Controllers_ViewsBinaryController_PostGetData.htm)|
Выполняет представление и возвращает сериализованный результат выполнения.
Используется клиентское API desktop-клиента для десериализации. Представление
должно быть доступно для текущего пользователя.  
[PostGetViewsMetadata](M_Tessa_Web_Controllers_ViewsBinaryController_PostGetViewsMetadata.htm)|
Метод возвращает фейковые данные и используется для обратной совместимости с
AppManager, не используйте его для целей получения метаданных представлений.  
Устарело.  
