...
C# __Копировать
    ...
    public sealed class OperationResponse : ValidationInfoStorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class OperationResponse
    	Inherits ValidationInfoStorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class OperationResponse sealed : public ValidationInfoStorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm) __ OperationResponse
##  __Конструкторы
[OperationResponse()](M_Tessa_Platform_Operations_OperationResponse__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[OperationResponse(Dictionary<String,
Object>)](M_Tessa_Platform_Operations_OperationResponse__ctor_1.htm)| Создаёт
экземпляр класса с указанием хранилища, декоратором для которого является
создаваемый объект.  
[OperationResponse(IStorageObjectProvider)](M_Tessa_Platform_Operations_OperationResponse__ctor_2.htm)|
...
(Унаследован от
[ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm))  
[ValidationResult](P_Tessa_Platform_Operations_OperationResponse_ValidationResult.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Platform_Operations_OperationResponse_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetValidationResult](M_Tessa_Platform_Operations_OperationResponse_TryGetValidationResult.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Platform_Operations_OperationResponse_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
[ValidationInfoStorageObject.ValidateInternal(IValidationResultBuilder)](M_Tessa_Platform_Validation_ValidationInfoStorageObject_ValidateInternal.htm))  
##  __Поля
[ValidationResultKey](F_Tessa_Platform_Operations_OperationResponse_ValidationResultKey.htm)|  
---|---  
## __Методы расширения
