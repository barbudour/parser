# DocumentNumberDirector.OnDeregisteringCardAsync - метод
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     protected override Task<bool> OnDeregisteringCardAsync(
    	INumberContext context,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Protected Overrides Function OnDeregisteringCardAsync ( 
