...
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class NestedProcessCommonInfo
    	Inherits ProcessCommonInfo
C++ __Копировать
    [SerializableAttribute]
    public ref class NestedProcessCommonInfo sealed : public ProcessCommonInfo
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type NestedProcessCommonInfo = 
        class
            inherit ProcessCommonInfo
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ProcessCommonInfo](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo.htm) __ NestedProcessCommonInfo
##  __Конструкторы
[NestedProcessCommonInfo(Dictionary<String,
Object>)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_NestedProcessCommonInfo__ctor.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
---|---  
[NestedProcessCommonInfo(Nullable<Guid>, IDictionary<String, Object>,
Nullable<Guid>, Guid, Guid,
Int32)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_NestedProcessCommonInfo__ctor_1.htm)|
Инициализирует новый экземпляр класса NestedProcessCommonInfo.  
## __Свойства
[AuthorID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_NestedProcessCommonInfo_AuthorID.htm)|
Возвращает или задаёт идентификатор инициатора процесса.  
(Переопределяет
[ProcessCommonInfo.AuthorID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_AuthorID.htm))  
---|---  
[AuthorName](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_NestedProcessCommonInfo_AuthorName.htm)|
Возвращает или задаёт имя инициатора процесса.  
(Переопределяет
[ProcessCommonInfo.AuthorName](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_AuthorName.htm))  
[AuthorTimestamp](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_NestedProcessCommonInfo_AuthorTimestamp.htm)|
Возвращает или задаёт штамп времени изменения инициатора процесса.  
(Переопределяет
[ProcessCommonInfo.AuthorTimestamp](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_AuthorTimestamp.htm))  
[CurrentStageRowID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_CurrentStageRowID.htm)|
...
[Info](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_Info.htm)|
Возвращает или задаёт дополнительную информацию по процессу.  
(Унаследован от
[ProcessCommonInfo](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo.htm))  
[NestedOrder](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_NestedProcessCommonInfo_NestedOrder.htm)|
Возвращает или задаёт порядковый номер дочернего процесса.  
[NestedProcessID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_NestedProcessCommonInfo_NestedProcessID.htm)|
Возвращает или задаёт идентификатор дочернего процесса.  
[ParentStageRowID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_NestedProcessCommonInfo_ParentStageRowID.htm)|
Возвращает или задаёт идентификатор родительского этапа.  
[ProcessOwnerID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_NestedProcessCommonInfo_ProcessOwnerID.htm)|
Возвращает или задаёт идентификатор владельца процесса.  
(Переопределяет
[ProcessCommonInfo.ProcessOwnerID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_ProcessOwnerID.htm))  
[ProcessOwnerName](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_NestedProcessCommonInfo_ProcessOwnerName.htm)|
Возвращает или задаёт имя владельца процесса.  
(Переопределяет
[ProcessCommonInfo.ProcessOwnerName](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_ProcessOwnerName.htm))  
[ProcessOwnerTimestamp](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_NestedProcessCommonInfo_ProcessOwnerTimestamp.htm)|
Возвращает или задаёт штамп времени изменения владельца процесса.  
(Переопределяет
[ProcessCommonInfo.ProcessOwnerTimestamp](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_ProcessOwnerTimestamp.htm))  
[SecondaryProcessID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_SecondaryProcessID.htm)|
