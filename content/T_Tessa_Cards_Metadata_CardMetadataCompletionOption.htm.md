# CardMetadataCompletionOption - класс
...
C# __Копировать
    ...
    public sealed class CardMetadataCompletionOption : CardSerializableEntryWithCaption
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardMetadataCompletionOption
    	Inherits CardSerializableEntryWithCaption
C++ __Копировать
    [SerializableAttribute]
    public ref class CardMetadataCompletionOption sealed : public CardSerializableEntryWithCaption
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardMetadataCompletionOption = 
        class
            inherit CardSerializableEntryWithCaption
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __[CardSerializableEntry](T_Tessa_Cards_CardSerializableEntry.htm) __[CardSerializableEntryWithCaption](T_Tessa_Cards_CardSerializableEntryWithCaption.htm) __ CardMetadataCompletionOption
##  __Конструкторы
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[XmlElementNameInternal](P_Tessa_Cards_Metadata_CardMetadataCompletionOption_XmlElementNameInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeAttributeFromXml](M_Tessa_Cards_CardSerializableEntryWithCaption_DeserializeAttributeFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_CardSerializableEntryWithCaption_DeserializeFromBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_CardSerializableEntryWithCaption_DeserializeFromStorageInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_CardSerializableEntryWithCaption_OnDeserializing.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeAttributesToXml](M_Tessa_Cards_CardSerializableEntryWithCaption_SerializeAttributesToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_CardSerializableEntryWithCaption_SerializeToBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_CardSerializableEntryWithCaption_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
