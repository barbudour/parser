# NumberStorageObject(IStorageObjectProvider) - конструктор
...
F# __Копировать
     new : 
            storageProvider : IStorageObjectProvider -> NumberStorageObject
#### Параметры
storageProvider
...
[NumberStorageObject -
перегрузка](Overload_Tessa_Cards_Numbers_NumberStorageObject__ctor.htm)
