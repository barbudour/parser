# IMenuActionCollection - интерфейс
...
C# __Копировать
     public interface IMenuActionCollection : INamedObservableCollection<IMenuAction, IMenuActionCollection>, 
    	IObservableCollection<IMenuAction, IMenuActionCollection>, IList<IMenuAction>, 
    	ICollection<IMenuAction>, IEnumerable<IMenuAction>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
VB __Копировать
     Public Interface IMenuActionCollection
    	Inherits INamedObservableCollection(Of IMenuAction, IMenuActionCollection), IObservableCollection(Of IMenuAction, IMenuActionCollection), 
    	IList(Of IMenuAction), ICollection(Of IMenuAction), IEnumerable(Of IMenuAction), 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
C++ __Копировать
     public interface class IMenuActionCollection : INamedObservableCollection<IMenuAction^, IMenuActionCollection^>, 
    	IObservableCollection<IMenuAction^, IMenuActionCollection^>, IList<IMenuAction^>, 
    	ICollection<IMenuAction^>, IEnumerable<IMenuAction^>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
F# __Копировать
     type IMenuActionCollection = 
        interface
...
(Унаследован от
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)>)  
---|---  
...
the specified index.  
(Унаследован от
[IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)>)  
[Item[String]](P_Tessa_Platform_Collections_INamedObservableCollection_2_Item.htm)|
Возвращает объект, содержащийся в коллекции по заданному имени.  
(Унаследован от [INamedObservableCollection<TItem,
...
(Унаследован от
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)>)  
[Contains(String)](M_Tessa_Platform_Collections_INamedObservableCollection_2_Contains.htm)|
...
(Унаследован от
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)>)  
[Remove(String)](M_Tessa_Platform_Collections_INamedObservableCollection_2_Remove.htm)|
...
(Унаследован от
[IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<[IMenuAction](T_Tessa_UI_Menu_IMenuAction.htm)>)  
[TryGet](M_Tessa_Platform_Collections_INamedObservableCollection_2_TryGet.htm)|
