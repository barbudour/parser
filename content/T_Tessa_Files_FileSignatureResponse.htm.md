# FileSignatureResponse - класс
Ответ на запрос на получение коллекции доступных версий файла.
## __Definition
 **Пространство имён:** [Tessa.Files](N_Tessa_Files.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class FileSignatureResponse : IFileSignatureResponse
VB __Копировать
     Public NotInheritable Class FileSignatureResponse
    	Implements IFileSignatureResponse
C++ __Копировать
     public ref class FileSignatureResponse sealed : IFileSignatureResponse
F# __Копировать
     [<SealedAttribute>]
    type FileSignatureResponse = 
        class
            interface IFileSignatureResponse
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FileSignatureResponse
Implements
    [IFileSignatureResponse](T_Tessa_Files_IFileSignatureResponse.htm)
##  __Конструкторы
[FileSignatureResponse](M_Tessa_Files_FileSignatureResponse__ctor.htm)|
