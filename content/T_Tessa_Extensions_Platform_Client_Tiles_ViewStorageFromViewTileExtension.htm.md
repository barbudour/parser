# ViewStorageFromViewTileExtension - класс
...
C# __Копировать
     public sealed class ViewStorageFromViewTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class ViewStorageFromViewTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class ViewStorageFromViewTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type ViewStorageFromViewTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ ViewStorageFromViewTileExtension
##  __Заметки
Расширение должно выполняться после
[ViewTileExtension](T_Tessa_Extensions_Platform_Client_Tiles_ViewTileExtension.htm).
## __Конструкторы
[ViewStorageFromViewTileExtension](M_Tessa_Extensions_Platform_Client_Tiles_ViewStorageFromViewTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса ViewStorageFromViewTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Platform_Client_Tiles_ViewStorageFromViewTileExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[InitializingLocal](M_Tessa_Extensions_Platform_Client_Tiles_ViewStorageFromViewTileExtension_InitializingLocal.htm)|  
(Переопределяет
