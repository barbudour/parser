...
VB __Копировать
     Public NotInheritable Class ItemView
    	Inherits PagedView
C++ __Копировать
     public ref class ItemView sealed : public PagedView
F# __Копировать
     [<SealedAttribute>]
    type ItemView = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ViewBase](T_Tessa_Exchange_WebServices_Data_ViewBase.htm) __[PagedView](T_Tessa_Exchange_WebServices_Data_PagedView.htm) __ ItemView
##  __Конструкторы
[ItemView(Int32)](M_Tessa_Exchange_WebServices_Data_ItemView__ctor.htm)|
Initializes a new instance of the ItemView class.  
---|---  
[ItemView(Int32,
Int32)](M_Tessa_Exchange_WebServices_Data_ItemView__ctor_1.htm)|  Initializes
a new instance of the ItemView class.  
[ItemView(Int32, Int32,
OffsetBasePoint)](M_Tessa_Exchange_WebServices_Data_ItemView__ctor_2.htm)|
Initializes a new instance of the ItemView class.  
## __Свойства
...
(Унаследован от [PagedView](T_Tessa_Exchange_WebServices_Data_PagedView.htm))  
[OrderBy](P_Tessa_Exchange_WebServices_Data_ItemView_OrderBy.htm)|  Gets the
properties against which the returned items should be ordered.  
...
[Traversal](P_Tessa_Exchange_WebServices_Data_ItemView_Traversal.htm)|  Gets
or sets the search traversal mode. Defaults to ItemTraversal.Shallow.  
## __Методы
