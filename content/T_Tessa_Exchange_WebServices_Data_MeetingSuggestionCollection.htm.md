# MeetingSuggestionCollection - класс
...
VB __Копировать
    <EditorBrowsableAttribute(EditorBrowsableState.Never)>
    Public NotInheritable Class MeetingSuggestionCollection
    	Inherits ComplexPropertyCollection(Of MeetingSuggestion)
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class MeetingSuggestionCollection sealed : public ComplexPropertyCollection<MeetingSuggestion^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type MeetingSuggestionCollection = 
        class
            inherit ComplexPropertyCollection<MeetingSuggestion>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[MeetingSuggestion](T_Tessa_Exchange_WebServices_Data_MeetingSuggestion.htm)> __ MeetingSuggestionCollection
##  __Свойства
