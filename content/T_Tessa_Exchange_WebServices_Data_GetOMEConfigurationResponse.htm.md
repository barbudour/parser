# GetOMEConfigurationResponse - класс
...
VB __Копировать
     Public NotInheritable Class GetOMEConfigurationResponse
    	Inherits ServiceResponse
C++ __Копировать
     public ref class GetOMEConfigurationResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ GetOMEConfigurationResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[Xml](P_Tessa_Exchange_WebServices_Data_GetOMEConfigurationResponse_Xml.htm)|
