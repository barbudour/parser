...
C# __Копировать
     public sealed class TemplateDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class TemplateDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class TemplateDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type TemplateDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ TemplateDeleteExtension
##  __Конструкторы
[TemplateDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_TemplateDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса TemplateDeleteExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Cards_TemplateDeleteExtension_AfterBeginTransaction.htm)|  
(Переопределяет
