# SingletonDeleteExtension - класс
...
C# __Копировать
     public sealed class SingletonDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class SingletonDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class SingletonDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type SingletonDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ SingletonDeleteExtension
##  __Конструкторы
[SingletonDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_SingletonDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса SingletonDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_SingletonDeleteExtension_BeforeRequest.htm)|  
(Переопределяет
