...
C# __Копировать
    ...
    public abstract class CardSerializableEntry : CardSchemeSerializableObject, 
    	ICardSerializableEntry, INamedEntry, INamedItem, IEquatable<ICardSerializableEntry>
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class CardSerializableEntry
    	Inherits CardSchemeSerializableObject
    	Implements ICardSerializableEntry, INamedEntry, INamedItem, IEquatable(Of ICardSerializableEntry)
C++ __Копировать
    [SerializableAttribute]
    public ref class CardSerializableEntry abstract : public CardSchemeSerializableObject, 
    	ICardSerializableEntry, INamedEntry, INamedItem, IEquatable<ICardSerializableEntry^>
F# __Копировать
     [<AbstractClassAttribute>]
    [<SerializableAttribute>]
    type CardSerializableEntry = 
        class
            inherit CardSchemeSerializableObject
            interface ICardSerializableEntry
            interface INamedEntry
            interface INamedItem
            interface IEquatable<ICardSerializableEntry>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __ CardSerializableEntry
Derived
[Tessa.Cards.CardSerializableEntryWithCaption](T_Tessa_Cards_CardSerializableEntryWithCaption.htm)
[Tessa.Cards.Metadata.CardMetadataColumn](T_Tessa_Cards_Metadata_CardMetadataColumn.htm)
[Tessa.Cards.Metadata.CardMetadataEnumeration](T_Tessa_Cards_Metadata_CardMetadataEnumeration.htm)
[Tessa.Cards.Metadata.CardMetadataEnumerationColumn](T_Tessa_Cards_Metadata_CardMetadataEnumerationColumn.htm)
[Tessa.Cards.Metadata.CardMetadataSection](T_Tessa_Cards_Metadata_CardMetadataSection.htm)
[Tessa.Cards.Metadata.CardMetadataSectionReference](T_Tessa_Cards_Metadata_CardMetadataSectionReference.htm)
[Tessa.Cards.VirtualScheme.CardTypeSection](T_Tessa_Cards_VirtualScheme_CardTypeSection.htm)
[Tessa.Cards.VirtualScheme.CardTypeSectionColumn](T_Tessa_Cards_VirtualScheme_CardTypeSectionColumn.htm)
Подробнее __Less __
Implements
    [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)<[ICardSerializableEntry](T_Tessa_Cards_ICardSerializableEntry.htm)>, [ICardSerializableEntry](T_Tessa_Cards_ICardSerializableEntry.htm), [INamedItem](T_Tessa_Platform_Collections_INamedItem.htm), [INamedEntry](T_Tessa_Platform_INamedEntry.htm)
##  __Конструкторы
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_CardSerializableEntry_DeserializeFromStorageInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_CardSerializableEntry_OnDeserializing.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_CardSerializableEntry_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
