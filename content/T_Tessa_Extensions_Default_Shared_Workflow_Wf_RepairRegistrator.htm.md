...
##  __Конструкторы
[RepairRegistrator](M_Tessa_Extensions_Default_Shared_Workflow_Wf_RepairRegistrator__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterExtensions](M_Tessa_Extensions_Default_Shared_Workflow_Wf_RepairRegistrator_RegisterExtensions.htm)|  
(Переопределяет
