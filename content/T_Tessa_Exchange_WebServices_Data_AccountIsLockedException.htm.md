# AccountIsLockedException - класс
...
C++ __Копировать
     public ref class AccountIsLockedException : public ServiceRemoteException
F# __Копировать
     type AccountIsLockedException = 
        class
            inherit ServiceRemoteException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceRemoteException](T_Tessa_Exchange_WebServices_Data_ServiceRemoteException.htm) __ AccountIsLockedException
##  __Конструкторы
[AccountIsLockedException(SerializationInfo,
StreamingContext)](M_Tessa_Exchange_WebServices_Data_AccountIsLockedException__ctor.htm)|
Initializes a new instance of the AccountIsLockedException class with
serialized data.  
---|---  
[AccountIsLockedException(String, Uri,
Exception)](M_Tessa_Exchange_WebServices_Data_AccountIsLockedException__ctor_1.htm)|
Initializes a new instance of the AccountIsLockedException class.  
## __Свойства
[AccountUnlockUrl](P_Tessa_Exchange_WebServices_Data_AccountIsLockedException_AccountUnlockUrl.htm)|
Gets the URL of a web page where the user can navigate to unlock his or her
account.  
---|---  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Exchange_WebServices_Data_AccountIsLockedException_GetObjectData.htm)|
Sets the
