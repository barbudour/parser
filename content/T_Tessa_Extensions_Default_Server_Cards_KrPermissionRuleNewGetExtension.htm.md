# KrPermissionRuleNewGetExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrPermissionRuleNewGetExtension
    	Inherits CardNewGetExtension
C++ __Копировать
     public ref class KrPermissionRuleNewGetExtension sealed : public CardNewGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrPermissionRuleNewGetExtension = 
        class
            inherit CardNewGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewGetExtension](T_Tessa_Cards_Extensions_CardNewGetExtension.htm) __ KrPermissionRuleNewGetExtension
##  __Конструкторы
[KrPermissionRuleNewGetExtension](M_Tessa_Extensions_Default_Server_Cards_KrPermissionRuleNewGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrPermissionRuleNewGetExtension  
---|---  
##  __Методы
[AfterRequest(ICardGetExtensionContext)](M_Tessa_Extensions_Default_Server_Cards_KrPermissionRuleNewGetExtension_AfterRequest.htm)|  
(Переопределяет
[CardNewGetExtension.AfterRequest(ICardGetExtensionContext)](M_Tessa_Cards_Extensions_CardNewGetExtension_AfterRequest.htm))  
---|---  
[AfterRequest(ICardNewExtensionContext)](M_Tessa_Extensions_Default_Server_Cards_KrPermissionRuleNewGetExtension_AfterRequest_1.htm)|  
(Переопределяет
