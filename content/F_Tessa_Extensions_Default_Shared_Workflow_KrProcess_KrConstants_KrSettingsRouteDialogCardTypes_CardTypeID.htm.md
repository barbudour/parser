# KrConstants.KrSettingsRouteDialogCardTypes.CardTypeID - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Const CardTypeID As String = "CardTypeID"
C++ __Копировать
     public:
    literal String^ CardTypeID = "CardTypeID"
F# __Копировать
     static val mutable CardTypeID: string
#### Значение поля
