# MessageModelBase - класс
##  __Definition
 **Пространство имён:** [Tessa.Forums.Models](N_Tessa_Forums_Models.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public abstract class MessageModelBase : StorageObject
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class MessageModelBase
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class MessageModelBase abstract : public StorageObject
F# __Копировать
     [<AbstractClassAttribute>]
    [<SerializableAttribute>]
    type MessageModelBase = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ MessageModelBase
Derived
[Tessa.Forums.Models.MessageModel](T_Tessa_Forums_Models_MessageModel.htm)
[Tessa.Forums.Notifications.NotificationModel](T_Tessa_Forums_Notifications_NotificationModel.htm)
##  __Конструкторы
[MessageModelBase()](M_Tessa_Forums_Models_MessageModelBase__ctor.htm)|
Инициализирует новый экземпляр класса MessageModelBase  
---|---  
[MessageModelBase(Dictionary<String,
Object>)](M_Tessa_Forums_Models_MessageModelBase__ctor_1.htm)| Инициализирует
новый экземпляр класса MessageModelBase  
[MessageModelBase(SerializationInfo,
StreamingContext)](M_Tessa_Forums_Models_MessageModelBase__ctor_2.htm)|
Инициализирует новый экземпляр класса MessageModelBase  
##  __Свойства
