# LauncherSplashWindow - класс
Interaction logic for LauncherSplashWindow.xaml
## __Definition
 **Пространство имён:** [Tessa.UI.Runtime](N_Tessa_UI_Runtime.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public class LauncherSplashWindow : Window, 
    	ISplashWindow, IComponentConnector
VB __Копировать
     Public Class LauncherSplashWindow
    	Inherits Window
    	Implements ISplashWindow, IComponentConnector
C++ __Копировать
     public ref class LauncherSplashWindow : public Window, 
    	ISplashWindow, IComponentConnector
F# __Копировать
     type LauncherSplashWindow = 
        class
            inherit Window
            interface ISplashWindow
            interface IComponentConnector
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Visual](https://learn.microsoft.com/dotnet/api/system.windows.media.visual) __[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement) __[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement) __[Control](https://learn.microsoft.com/dotnet/api/system.windows.controls.control) __[ContentControl](https://learn.microsoft.com/dotnet/api/system.windows.controls.contentcontrol) __[Window](https://learn.microsoft.com/dotnet/api/system.windows.window) __ LauncherSplashWindow
Implements
    [IComponentConnector](https://learn.microsoft.com/dotnet/api/system.windows.markup.icomponentconnector), [ISplashWindow](T_Tessa_UI_Runtime_ISplashWindow.htm)
##  __Конструкторы
[LauncherSplashWindow](M_Tessa_UI_Runtime_LauncherSplashWindow__ctor.htm)|
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[IsCollapsed](P_Tessa_UI_Runtime_LauncherSplashWindow_IsCollapsed.htm)|
Признак того, что экран загрузки скрыт от конечного пользователя.  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[Text](P_Tessa_UI_Runtime_LauncherSplashWindow_Text.htm)| Текст сообщения на
экране загрузки.  
...
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[HideFrame](M_Tessa_UI_Runtime_LauncherSplashWindow_HideFrame.htm)|  Скрывает
рамку вокруг логотипа и текста.  
[HideProgress](M_Tessa_UI_Runtime_LauncherSplashWindow_HideProgress.htm)|
Скрывает прогресс бар (движущиеся точки).  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[InitializeComponent](M_Tessa_UI_Runtime_LauncherSplashWindow_InitializeComponent.htm)|
InitializeComponent  
...
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[OnActivated(EventArgs)](M_Tessa_UI_Runtime_LauncherSplashWindow_OnActivated.htm)|  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[OnSourceInitialized](https://learn.microsoft.com/dotnet/api/system.windows.window.onsourceinitialized#system-
...
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[OnStateChanged](https://learn.microsoft.com/dotnet/api/system.windows.window.onstatechanged#system-
...
(Унаследован от
[Visual](https://learn.microsoft.com/dotnet/api/system.windows.media.visual))  
[SetBackground](M_Tessa_UI_Runtime_LauncherSplashWindow_SetBackground.htm)|
Устанавливает цвет фона у логотипа.  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[SetForeground](M_Tessa_UI_Runtime_LauncherSplashWindow_SetForeground.htm)|
Устанавливает цвет текста и прогресс бара, выводимого под логотипом, в т.ч.
текст с версией.  
[SetImage](M_Tessa_UI_Runtime_LauncherSplashWindow_SetImage.htm)|
Устанавливает Uri для выводимого изображения.  
[SetLogoText](M_Tessa_UI_Runtime_LauncherSplashWindow_SetLogoText.htm)|
Устанавливает текст, выводимый под логотипом.  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[SetVersionInfo](M_Tessa_UI_Runtime_LauncherSplashWindow_SetVersionInfo.htm)|
Устанавливает информацию по версиям сборки.  
