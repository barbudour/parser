# KrVirtualFileStoreExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrVirtualFileStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class KrVirtualFileStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type KrVirtualFileStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ KrVirtualFileStoreExtension
##  __Конструкторы
[KrVirtualFileStoreExtension](M_Tessa_Extensions_Default_Server_Cards_KrVirtualFileStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrVirtualFileStoreExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Server_Cards_KrVirtualFileStoreExtension_AfterRequest.htm)|  
(Переопределяет
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Default_Server_Cards_KrVirtualFileStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Default_Server_Cards_KrVirtualFileStoreExtension_BeforeRequest.htm)|  
(Переопределяет
