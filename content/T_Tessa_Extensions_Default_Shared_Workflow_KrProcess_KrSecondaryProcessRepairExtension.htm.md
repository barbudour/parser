# KrSecondaryProcessRepairExtension - класс
...
C# __Копировать
     public sealed class KrSecondaryProcessRepairExtension : CardRepairExtension
VB __Копировать
     Public NotInheritable Class KrSecondaryProcessRepairExtension
    	Inherits CardRepairExtension
C++ __Копировать
     public ref class KrSecondaryProcessRepairExtension sealed : public CardRepairExtension
F# __Копировать
     [<SealedAttribute>]
    type KrSecondaryProcessRepairExtension = 
        class
            inherit CardRepairExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm) __ KrSecondaryProcessRepairExtension
##  __Конструкторы
[KrSecondaryProcessRepairExtension](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrSecondaryProcessRepairExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrSecondaryProcessRepairExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrSecondaryProcessRepairExtension_BeforeRequest.htm)|  
(Переопределяет
