...
VB __Копировать
     Public NotInheritable Class KrTilesUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrTilesUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrTilesUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrTilesUIExtension
##  __Конструкторы
[KrTilesUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrTilesUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrTilesUIExtension  
---|---  
##  __Методы
[ContextInitialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrTilesUIExtension_ContextInitialized.htm)|
