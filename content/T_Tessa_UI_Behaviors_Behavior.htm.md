...
C# __Копировать
     public abstract class Behavior : LinkedFreezable
VB __Копировать
     Public MustInherit Class Behavior
    	Inherits LinkedFreezable
C++ __Копировать
     public ref class Behavior abstract : public LinkedFreezable
F# __Копировать
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __ Behavior
Derived
[Tessa.UI.Behaviors.Behavior<T>](T_Tessa_UI_Behaviors_Behavior_1.htm)
[Tessa.UI.Behaviors.CollectionBinding](T_Tessa_UI_Behaviors_CollectionBinding.htm)
[Tessa.UI.Behaviors.CommandOnEventBehaviorBase](T_Tessa_UI_Behaviors_CommandOnEventBehaviorBase.htm)
[Tessa.UI.Behaviors.DelegatedCommandBinding](T_Tessa_UI_Behaviors_DelegatedCommandBinding.htm)
##  __Конструкторы
[Behavior](M_Tessa_UI_Behaviors_Behavior__ctor.htm)| Инициализирует новый
...
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
##  __Методы
[Attach](M_Tessa_UI_Behaviors_Behavior_Attach.htm)|  
---|---  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[Detach](M_Tessa_UI_Behaviors_Behavior_Detach.htm)|  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[GetBehaviors](M_Tessa_UI_Behaviors_Behavior_GetBehaviors.htm)|  
