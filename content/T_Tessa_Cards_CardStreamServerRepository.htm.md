...
VB __Копировать
     Public NotInheritable Class CardStreamServerRepository
    	Implements ICardStreamServerRepository
C++ __Копировать
     public ref class CardStreamServerRepository sealed : ICardStreamServerRepository
F# __Копировать
     [<SealedAttribute>]
    type CardStreamServerRepository = 
        class
            interface ICardStreamServerRepository
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardStreamServerRepository
Implements
    [ICardStreamServerRepository](T_Tessa_Cards_ICardStreamServerRepository.htm)
##  __Конструкторы
[CardStreamServerRepository](M_Tessa_Cards_CardStreamServerRepository__ctor.htm)|
Создаёт новый экземпляр класса с указанием метаинформации по типам карточек,
объекта сессии и компонентов репозитория.  
---|---  
## __Методы
[CreateDefault](M_Tessa_Cards_CardStreamServerRepository_CreateDefault.htm)|
...
---|---  
[CreateExtended](M_Tessa_Cards_CardStreamServerRepository_CreateExtended.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetFileContentAsAggregatedStreamAsync](M_Tessa_Cards_CardStreamServerRepository_GetFileContentAsAggregatedStreamAsync.htm)|
Получает контент версии файла в виде агрегированного потока, в котором
содержится ответ на запрос и собственно контент.  
[GetFileContentAsync](M_Tessa_Cards_CardStreamServerRepository_GetFileContentAsync.htm)|
