...
C# __Копировать
     public class AboutView : UserControl, IComponentConnector
VB __Копировать
     Public Class AboutView
    	Inherits UserControl
    	Implements IComponentConnector
C++ __Копировать
     public ref class AboutView : public UserControl, 
    	IComponentConnector
F# __Копировать
     type AboutView = 
        class
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[InitializeComponent](M_Tessa_Extensions_Platform_Client_Views_AboutView_InitializeComponent.htm)|
InitializeComponent  
