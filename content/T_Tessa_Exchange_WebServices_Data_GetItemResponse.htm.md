...
C++ __Копировать
     public ref class GetItemResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ GetItemResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[Item](P_Tessa_Exchange_WebServices_Data_GetItemResponse_Item.htm)|  Gets the
