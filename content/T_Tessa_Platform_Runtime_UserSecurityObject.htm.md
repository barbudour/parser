# UserSecurityObject - класс
Объект с настройками безопасности сотрудника, сериализованный в BSON. Содержит
...
C# __Копировать
    ...
    public sealed class UserSecurityObject : InfoStorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class UserSecurityObject
    	Inherits InfoStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class UserSecurityObject sealed : public InfoStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type UserSecurityObject = 
        class
            inherit InfoStorageObject
            interface ICloneable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm) __ UserSecurityObject
Implements
    [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable)
##  __Конструкторы
[UserSecurityObject()](M_Tessa_Platform_Runtime_UserSecurityObject__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[UserSecurityObject(Dictionary<String,
Object>)](M_Tessa_Platform_Runtime_UserSecurityObject__ctor_1.htm)| Создаёт
экземпляр класса с указанием хранилища, декоратором для которого является
создаваемый объект.  
[UserSecurityObject(IStorageObjectProvider)](M_Tessa_Platform_Runtime_UserSecurityObject__ctor_2.htm)|
...
(Унаследован от
[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm))  
[FailedLoginAttempts](P_Tessa_Platform_Runtime_UserSecurityObject_FailedLoginAttempts.htm)|
Количество неудачных попыток входа. Обнуляется при успешном входе. По
умолчанию 0.  
[FailedLoginAttemptSeriesDates](P_Tessa_Platform_Runtime_UserSecurityObject_FailedLoginAttemptSeriesDates.htm)|
Список последних попыток неудачного входа, которые образуют серию. Очищается
при успешном входе. По умолчанию пустой.  
[Info](P_Tessa_Platform_Storage_InfoStorageObject_Info.htm)|  Дополнительная
пользовательская информация.  
(Унаследован от
[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm))  
[PreviousPasswordHashList](P_Tessa_Platform_Runtime_UserSecurityObject_PreviousPasswordHashList.htm)|
Список объектов с информацией по хешам предыдущих паролей, которые были
изменены пользователями. По умолчанию список пуст.  
[PreviousPasswordKeyList](P_Tessa_Platform_Runtime_UserSecurityObject_PreviousPasswordKeyList.htm)|
Список объектов с информацией по ключам (хеш-солям) предыдущих паролей,
которые были изменены пользователями. По умолчанию список пуст.  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Platform_Runtime_UserSecurityObject_Clone.htm)|  Выполняет
...
не найден.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetFailedLoginAttemptSeriesDates](M_Tessa_Platform_Runtime_UserSecurityObject_TryGetFailedLoginAttemptSeriesDates.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetPreviousPasswordHashList](M_Tessa_Platform_Runtime_UserSecurityObject_TryGetPreviousPasswordHashList.htm)|
Возвращает список объектов с информацией по хешам предыдущих паролей, которые
были изменены пользователями, или null, если список ещё не был задан. По
умолчанию null.  
[TryGetPreviousPasswordKey](M_Tessa_Platform_Runtime_UserSecurityObject_TryGetPreviousPasswordKey.htm)|
Возвращает список объектов с информацией по ключам (хеш-солям) предыдущих
паролей, которые были изменены пользователями, или null, если список ещё не
был задан. По умолчанию null.  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
##  __Поля
[FailedLoginAttemptSeriesDatesKey](F_Tessa_Platform_Runtime_UserSecurityObject_FailedLoginAttemptSeriesDatesKey.htm)|  
---|---  
[FailedLoginAttemptsKey](F_Tessa_Platform_Runtime_UserSecurityObject_FailedLoginAttemptsKey.htm)|  
[PreviousPasswordHashListKey](F_Tessa_Platform_Runtime_UserSecurityObject_PreviousPasswordHashListKey.htm)|  
[PreviousPasswordKeyListKey](F_Tessa_Platform_Runtime_UserSecurityObject_PreviousPasswordKeyListKey.htm)|  
## __Методы расширения
