# BusinessProcessTemplateRepairExtension - класс
...
C# __Копировать
     public sealed class BusinessProcessTemplateRepairExtension : CardRepairExtension
VB __Копировать
     Public NotInheritable Class BusinessProcessTemplateRepairExtension
    	Inherits CardRepairExtension
C++ __Копировать
     public ref class BusinessProcessTemplateRepairExtension sealed : public CardRepairExtension
F# __Копировать
     [<SealedAttribute>]
    type BusinessProcessTemplateRepairExtension = 
        class
            inherit CardRepairExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm) __ BusinessProcessTemplateRepairExtension
##  __Конструкторы
[BusinessProcessTemplateRepairExtension](M_Tessa_Extensions_Platform_Shared_Cards_BusinessProcessTemplateRepairExtension__ctor.htm)|
Инициализирует новый экземпляр класса BusinessProcessTemplateRepairExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Shared_Cards_BusinessProcessTemplateRepairExtension_AfterRequest.htm)|
