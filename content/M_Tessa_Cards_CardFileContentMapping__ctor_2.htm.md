# CardFileContentMapping(IStorageObjectProvider) - конструктор
...
F# __Копировать
     new : 
            storageProvider : IStorageObjectProvider -> CardFileContentMapping
#### Параметры
storageProvider
...
[CardFileContentMapping -
перегрузка](Overload_Tessa_Cards_CardFileContentMapping__ctor.htm)
