# WorkflowSubprocessSubscriptionStorage - класс
##  __Definition
 **Пространство имён:** [Tessa.Workflow.Storage](N_Tessa_Workflow_Storage.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class WorkflowSubprocessSubscriptionStorage : WorkflowSubscriptionStorageBase
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowSubprocessSubscriptionStorage
    	Inherits WorkflowSubscriptionStorageBase
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowSubprocessSubscriptionStorage sealed : public WorkflowSubscriptionStorageBase
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowSubprocessSubscriptionStorage = 
        class
            inherit WorkflowSubscriptionStorageBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __[WorkflowSubscriptionStorageBase](T_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase.htm) __ WorkflowSubprocessSubscriptionStorage
##  __Конструкторы
[WorkflowSubprocessSubscriptionStorage()](M_Tessa_Workflow_Storage_WorkflowSubprocessSubscriptionStorage__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowSubprocessSubscriptionStorage  
---|---  
[WorkflowSubprocessSubscriptionStorage(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowSubprocessSubscriptionStorage__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowSubprocessSubscriptionStorage  
[WorkflowSubprocessSubscriptionStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowSubprocessSubscriptionStorage__ctor_3.htm)|
Инициализирует новый экземпляр класса WorkflowSubprocessSubscriptionStorage  
[WorkflowSubprocessSubscriptionStorage(Guid, Guid,
Guid)](M_Tessa_Workflow_Storage_WorkflowSubprocessSubscriptionStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowSubprocessSubscriptionStorage  
##  __Свойства
...
(Унаследован от
[WorkflowSubscriptionStorageBase](T_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase.htm))  
[SubprocessID](P_Tessa_Workflow_Storage_WorkflowSubprocessSubscriptionStorage_SubprocessID.htm)|
ID подпроцесса  
## __Методы
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[Clone](M_Tessa_Workflow_Storage_WorkflowSubprocessSubscriptionStorage_Clone.htm)|  
(Переопределяет
