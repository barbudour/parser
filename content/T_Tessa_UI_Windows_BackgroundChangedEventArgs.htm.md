# BackgroundChangedEventArgs - класс
...
C# __Копировать
     public class BackgroundChangedEventArgs : DeferredEventArgs
VB __Копировать
     Public Class BackgroundChangedEventArgs
    	Inherits DeferredEventArgs
C++ __Копировать
     public ref class BackgroundChangedEventArgs : public DeferredEventArgs
F# __Копировать
     type BackgroundChangedEventArgs = 
        class
            inherit DeferredEventArgs
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[EventArgs](https://learn.microsoft.com/dotnet/api/system.eventargs) __[DeferredEventArgs](T_Tessa_Platform_DeferredEventArgs.htm) __ BackgroundChangedEventArgs
##  __Конструкторы
[BackgroundChangedEventArgs](M_Tessa_UI_Windows_BackgroundChangedEventArgs__ctor.htm)|
Инициализирует новый экземпляр класса BackgroundChangedEventArgs  
---|---  
##  __Свойства
[Exception](P_Tessa_UI_Windows_BackgroundChangedEventArgs_Exception.htm)|
Исключение, которое возникло при изменении фона.  
---|---  
## __Методы
