...
VB __Копировать
     Public NotInheritable Class KrAmendingAction
    	Inherits KrWorkflowTaskActionBase
C++ __Копировать
     public ref class KrAmendingAction sealed : public KrWorkflowTaskActionBase
F# __Копировать
     [<SealedAttribute>]
    type KrAmendingAction = 
        class
            inherit KrWorkflowTaskActionBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WorkflowActionBase](T_Tessa_Workflow_Actions_WorkflowActionBase.htm) __[KrWorkflowActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowActionBase.htm) __[KrWorkflowTaskActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowTaskActionBase.htm) __ KrAmendingAction
##  __Конструкторы
[KrAmendingAction](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrAmendingAction__ctor.htm)|
Инициализирует новый экземпляр класса KrAmendingAction  
---|---  
##  __Свойства
...
[CheckActive](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrAmendingAction_CheckActive.htm)|
...
[Compile](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrAmendingAction_Compile.htm)|
...
(Унаследован от
[KrWorkflowTaskActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowTaskActionBase.htm))  
[CompleteTaskCoreAsync](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrAmendingAction_CompleteTaskCoreAsync.htm)|  
(Переопределяет
...
[ExecuteAsync](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrAmendingAction_ExecuteAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetResultAsync](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrAmendingAction_GetResultAsync.htm)|  
(Переопределяет
...
(Унаследован от
[KrWorkflowTaskActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowTaskActionBase.htm))  
[Validate](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrAmendingAction_Validate.htm)|
