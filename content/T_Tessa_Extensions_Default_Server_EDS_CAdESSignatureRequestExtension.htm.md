# CAdESSignatureRequestExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class CAdESSignatureRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class CAdESSignatureRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type CAdESSignatureRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ CAdESSignatureRequestExtension
##  __Конструкторы
[CAdESSignatureRequestExtension](M_Tessa_Extensions_Default_Server_EDS_CAdESSignatureRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса CAdESSignatureRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_EDS_CAdESSignatureRequestExtension_AfterRequest.htm)|  
(Переопределяет
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Server.EDS - пространство
имён](N_Tessa_Extensions_Default_Server_EDS.htm)
