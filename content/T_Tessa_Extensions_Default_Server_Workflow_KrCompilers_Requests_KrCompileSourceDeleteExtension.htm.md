# KrCompileSourceDeleteExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrCompileSourceDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class KrCompileSourceDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type KrCompileSourceDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ KrCompileSourceDeleteExtension
##  __Конструкторы
[KrCompileSourceDeleteExtension](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrCompileSourceDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrCompileSourceDeleteExtension.  
---|---  
## __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrCompileSourceDeleteExtension_AfterRequest.htm)|
