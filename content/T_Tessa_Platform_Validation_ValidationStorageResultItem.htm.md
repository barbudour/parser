# ValidationStorageResultItem - класс
...
C# __Копировать
    ...
    public sealed class ValidationStorageResultItem : ValidationStorageObject, 
    	IValidationResultItem, IEquatable<IValidationResultItem>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class ValidationStorageResultItem
    	Inherits ValidationStorageObject
    	Implements IValidationResultItem, IEquatable(Of IValidationResultItem)
C++ __Копировать
    [SerializableAttribute]
    public ref class ValidationStorageResultItem sealed : public ValidationStorageObject, 
    	IValidationResultItem, IEquatable<IValidationResultItem^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type ValidationStorageResultItem = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __ ValidationStorageResultItem
Implements
    [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)<[IValidationResultItem](T_Tessa_Platform_Validation_IValidationResultItem.htm)>, [IValidationResultItem](T_Tessa_Platform_Validation_IValidationResultItem.htm)
##  __Конструкторы
[ValidationStorageResultItem](M_Tessa_Platform_Validation_ValidationStorageResultItem__ctor.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
---|---  
##  __Свойства
[Details](P_Tessa_Platform_Validation_ValidationStorageResultItem_Details.htm)|
...
---|---  
[FieldName](P_Tessa_Platform_Validation_ValidationStorageResultItem_FieldName.htm)|
Имя поля объекта, к которому относится сообщение валидации, или null, если
поле неизвестно.  
[Key](P_Tessa_Platform_Validation_ValidationStorageResultItem_Key.htm)| Ключ
сообщения, возникшего при валидации.  
[Message](P_Tessa_Platform_Validation_ValidationStorageResultItem_Message.htm)|
Текст сообщения, возникшего при валидации.  
[ObjectName](P_Tessa_Platform_Validation_ValidationStorageResultItem_ObjectName.htm)|
Имя объекта, к которому относится сообщение валидации, или null, если имя
неизвестно.  
[ObjectType](P_Tessa_Platform_Validation_ValidationStorageResultItem_ObjectType.htm)|
Тип объекта, к которому относится сообщение валидации, или null, если тип
неизвестен.  
[Type](P_Tessa_Platform_Validation_ValidationStorageResultItem_Type.htm)| Тип
сообщения, возникшего при валидации.  
##  __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Equals(IValidationResultItem)](M_Tessa_Platform_Validation_ValidationStorageResultItem_Equals_1.htm)|
Сравнивает текущий объект с заданным.  
[Equals(Object)](M_Tessa_Platform_Validation_ValidationStorageResultItem_Equals.htm)|
Сравнивает текущий объект с заданным.  
(Переопределяет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[GetHashCode](M_Tessa_Platform_Validation_ValidationStorageResultItem_GetHashCode.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[RepairStorage](M_Tessa_Platform_Validation_ValidationStorageResultItem_RepairStorage.htm)|
...
были изменения.  
[Set(IValidationResultItem)](M_Tessa_Platform_Validation_ValidationStorageResultItem_Set.htm)|
...
восстановить в методе FromTypedJson.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[ToString](M_Tessa_Platform_Validation_ValidationStorageResultItem_ToString.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Platform_Validation_ValidationStorageResultItem_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
...
##  __Поля
[DetailsKey](F_Tessa_Platform_Validation_ValidationStorageResultItem_DetailsKey.htm)|  
---|---  
[FieldNameKey](F_Tessa_Platform_Validation_ValidationStorageResultItem_FieldNameKey.htm)|  
[KeyKey](F_Tessa_Platform_Validation_ValidationStorageResultItem_KeyKey.htm)|  
[MessageKey](F_Tessa_Platform_Validation_ValidationStorageResultItem_MessageKey.htm)|  
[ObjectNameKey](F_Tessa_Platform_Validation_ValidationStorageResultItem_ObjectNameKey.htm)|  
[ObjectTypeKey](F_Tessa_Platform_Validation_ValidationStorageResultItem_ObjectTypeKey.htm)|  
[TypeKey](F_Tessa_Platform_Validation_ValidationStorageResultItem_TypeKey.htm)|  
## __Методы расширения
