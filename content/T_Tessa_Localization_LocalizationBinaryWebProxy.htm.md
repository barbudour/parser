# LocalizationBinaryWebProxy - класс
##  __Definition
 **Пространство имён:** [Tessa.Localization](N_Tessa_Localization.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class LocalizationBinaryWebProxy : WebProxy
VB __Копировать
     Public NotInheritable Class LocalizationBinaryWebProxy
    	Inherits WebProxy
C++ __Копировать
     public ref class LocalizationBinaryWebProxy sealed : public WebProxy
F# __Копировать
     [<SealedAttribute>]
    type LocalizationBinaryWebProxy = 
        class
            inherit WebProxy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm) __ LocalizationBinaryWebProxy
##  __Конструкторы
[LocalizationBinaryWebProxy](M_Tessa_Localization_LocalizationBinaryWebProxy__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetEntriesAsync](M_Tessa_Localization_LocalizationBinaryWebProxy_GetEntriesAsync.htm)|  
