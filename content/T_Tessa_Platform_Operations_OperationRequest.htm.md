...
C# __Копировать
    ...
    public sealed class OperationRequest : ValidationInfoStorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class OperationRequest
    	Inherits ValidationInfoStorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class OperationRequest sealed : public ValidationInfoStorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm) __ OperationRequest
##  __Конструкторы
[OperationRequest()](M_Tessa_Platform_Operations_OperationRequest__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[OperationRequest(Dictionary<String,
Object>)](M_Tessa_Platform_Operations_OperationRequest__ctor_1.htm)| Создаёт
экземпляр класса с указанием хранилища, декоратором для которого является
создаваемый объект.  
[OperationRequest(IStorageObjectProvider)](M_Tessa_Platform_Operations_OperationRequest__ctor_2.htm)|
