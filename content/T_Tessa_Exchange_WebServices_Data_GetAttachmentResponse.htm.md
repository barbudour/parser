...
VB __Копировать
     Public NotInheritable Class GetAttachmentResponse
    	Inherits ServiceResponse
C++ __Копировать
     public ref class GetAttachmentResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ GetAttachmentResponse
##  __Свойства
[Attachment](P_Tessa_Exchange_WebServices_Data_GetAttachmentResponse_Attachment.htm)|
