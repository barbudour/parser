...
C# __Копировать
     public sealed class LicenseGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class LicenseGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class LicenseGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type LicenseGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ LicenseGetExtension
##  __Конструкторы
[LicenseGetExtension](M_Tessa_Extensions_Platform_Server_Cards_LicenseGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса LicenseGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_LicenseGetExtension_AfterRequest.htm)|  
(Переопределяет
