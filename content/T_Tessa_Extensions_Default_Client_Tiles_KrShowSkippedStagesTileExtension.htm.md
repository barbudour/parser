# KrShowSkippedStagesTileExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrShowSkippedStagesTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class KrShowSkippedStagesTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type KrShowSkippedStagesTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ KrShowSkippedStagesTileExtension
##  __Конструкторы
[KrShowSkippedStagesTileExtension](M_Tessa_Extensions_Default_Client_Tiles_KrShowSkippedStagesTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrShowSkippedStagesTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_KrShowSkippedStagesTileExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[InitializingLocal](M_Tessa_Extensions_Default_Client_Tiles_KrShowSkippedStagesTileExtension_InitializingLocal.htm)|  
(Переопределяет
