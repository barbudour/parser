# KrProcessSharedExtensions.TryGetStageStateNameAsync - метод
...
C# __Копировать
     public static ValueTask<string> TryGetStageStateNameAsync(
...
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function TryGetStageStateNameAsync ( 
...
C++ __Копировать
     public:
    [ExtensionAttribute]
    static ValueTask<String^> TryGetStageStateNameAsync(
...
F# __Копировать
     [<ExtensionAttribute>]
    static member TryGetStageStateNameAsync : 
...
Название состояния этапа или значение null, если заданное состояние не
найдено.
