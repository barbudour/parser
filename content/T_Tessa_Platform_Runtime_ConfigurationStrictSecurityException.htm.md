# ConfigurationStrictSecurityException - класс
...
C# __Копировать
    ...
    public sealed class ConfigurationStrictSecurityException : ApplicationException
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class ConfigurationStrictSecurityException
    	Inherits ApplicationException
C++ __Копировать
    [SerializableAttribute]
    public ref class ConfigurationStrictSecurityException sealed : public ApplicationException
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type ConfigurationStrictSecurityException = 
        class
            inherit ApplicationException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception) __ ConfigurationStrictSecurityException
##  __Конструкторы
[ConfigurationStrictSecurityException()](M_Tessa_Platform_Runtime_ConfigurationStrictSecurityException__ctor.htm)|
Создаёт экземпляр класса с параметрами по умолчанию.  
---|---  
[ConfigurationStrictSecurityException(String)](M_Tessa_Platform_Runtime_ConfigurationStrictSecurityException__ctor_1.htm)|
Создаёт экземпляр класса с указанием сообщения, описывающего возникшее
исключение.  
[ConfigurationStrictSecurityException(String,
Exception)](M_Tessa_Platform_Runtime_ConfigurationStrictSecurityException__ctor_2.htm)|
Создаёт экземпляр класса с указанием сообщения, описывающего возникшее
