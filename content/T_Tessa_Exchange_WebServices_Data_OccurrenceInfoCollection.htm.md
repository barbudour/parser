# OccurrenceInfoCollection - класс
...
VB __Копировать
    <EditorBrowsableAttribute(EditorBrowsableState.Never)>
    Public NotInheritable Class OccurrenceInfoCollection
    	Inherits ComplexPropertyCollection(Of OccurrenceInfo)
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class OccurrenceInfoCollection sealed : public ComplexPropertyCollection<OccurrenceInfo^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type OccurrenceInfoCollection = 
        class
            inherit ComplexPropertyCollection<OccurrenceInfo>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[OccurrenceInfo](T_Tessa_Exchange_WebServices_Data_OccurrenceInfo.htm)> __ OccurrenceInfoCollection
##  __Свойства
