# SearchFilter.IsNotEqualTo - класс
...
VB __Копировать
     Public NotInheritable Class IsNotEqualTo
    	Inherits SearchFilter.RelationalFilter
C++ __Копировать
     public ref class IsNotEqualTo sealed : public SearchFilter.RelationalFilter
F# __Копировать
     [<SealedAttribute>]
    type IsNotEqualTo = 
        class
