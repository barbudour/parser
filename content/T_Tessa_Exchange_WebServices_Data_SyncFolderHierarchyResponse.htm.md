# SyncFolderHierarchyResponse - класс
...
C++ __Копировать
     public ref class SyncFolderHierarchyResponse sealed : public SyncResponse<Folder^, FolderChange^>
F# __Копировать
     [<SealedAttribute>]
    type SyncFolderHierarchyResponse = 
        class
            inherit SyncResponse<Folder, FolderChange>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __[SyncResponse](T_Tessa_Exchange_WebServices_Data_SyncResponse_2.htm)<[Folder](T_Tessa_Exchange_WebServices_Data_Folder.htm), [FolderChange](T_Tessa_Exchange_WebServices_Data_FolderChange.htm)> __ SyncFolderHierarchyResponse
##  __Свойства
...
(Унаследован от [SyncResponse<TServiceObject,
