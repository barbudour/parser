...
##  __Конструкторы
[OperationRegistrator](M_Tessa_Extensions_Default_Console_CreateFromTemplate_OperationRegistrator__ctor.htm)|
...
в этом объекте.  
(Унаследован от [RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm))  
[RegisterUnity](M_Tessa_Extensions_Default_Console_CreateFromTemplate_OperationRegistrator_RegisterUnity.htm)|  
(Переопределяет
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Console.CreateFromTemplate - пространство
имён](N_Tessa_Extensions_Default_Console_CreateFromTemplate.htm)
