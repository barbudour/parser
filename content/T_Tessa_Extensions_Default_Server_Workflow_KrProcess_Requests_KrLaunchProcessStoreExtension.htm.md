# KrLaunchProcessStoreExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrLaunchProcessStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class KrLaunchProcessStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type KrLaunchProcessStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ KrLaunchProcessStoreExtension
##  __Конструкторы
[KrLaunchProcessStoreExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrLaunchProcessStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrLaunchProcessStoreExtension.  
---|---  
## __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrLaunchProcessStoreExtension_AfterRequest.htm)|
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrLaunchProcessStoreExtension_BeforeCommitTransaction.htm)|
...
[BeforeRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrLaunchProcessStoreExtension_BeforeRequest.htm)|
