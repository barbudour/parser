...
C# __Копировать
     public static readonly Task<int> Int32One
VB __Копировать
     Public Shared ReadOnly Int32One As Task(Of Integer)
C++ __Копировать
     public:
    static initonly Task<int>^ Int32One
F# __Копировать
     static val Int32One: Task<int>
#### Значение поля
