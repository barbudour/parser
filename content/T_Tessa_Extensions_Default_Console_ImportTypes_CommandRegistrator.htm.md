...
##  __Конструкторы
[CommandRegistrator](M_Tessa_Extensions_Default_Console_ImportTypes_CommandRegistrator__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterCommands](M_Tessa_Extensions_Default_Console_ImportTypes_CommandRegistrator_RegisterCommands.htm)|  
(Переопределяет
