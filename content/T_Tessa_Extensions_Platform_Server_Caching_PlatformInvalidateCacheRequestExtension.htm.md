# PlatformInvalidateCacheRequestExtension - класс
...
C# __Копировать
     public sealed class PlatformInvalidateCacheRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class PlatformInvalidateCacheRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class PlatformInvalidateCacheRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type PlatformInvalidateCacheRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ PlatformInvalidateCacheRequestExtension
##  __Конструкторы
[PlatformInvalidateCacheRequestExtension](M_Tessa_Extensions_Platform_Server_Caching_PlatformInvalidateCacheRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса PlatformInvalidateCacheRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Caching_PlatformInvalidateCacheRequestExtension_AfterRequest.htm)|  
(Переопределяет
