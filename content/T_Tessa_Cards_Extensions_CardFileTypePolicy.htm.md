...
C# __Копировать
     public sealed class CardFileTypePolicy : CardTypePolicyBase, 
    	ICardFileTypePolicy, IExtensionPolicy
VB __Копировать
     Public NotInheritable Class CardFileTypePolicy
    	Inherits CardTypePolicyBase
    	Implements ICardFileTypePolicy, IExtensionPolicy
C++ __Копировать
     public ref class CardFileTypePolicy sealed : public CardTypePolicyBase, 
    	ICardFileTypePolicy, IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type CardFileTypePolicy = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardTypePolicyBase](T_Tessa_Cards_Extensions_CardTypePolicyBase.htm) __ CardFileTypePolicy
Implements
