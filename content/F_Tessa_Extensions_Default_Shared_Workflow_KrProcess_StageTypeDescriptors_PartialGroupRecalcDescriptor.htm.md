# StageTypeDescriptors.PartialGroupRecalcDescriptor - поле
...
VB __Копировать
     Public Shared ReadOnly PartialGroupRecalcDescriptor As StageTypeDescriptor
C++ __Копировать
     public:
    static initonly StageTypeDescriptor^ PartialGroupRecalcDescriptor
F# __Копировать
     static val PartialGroupRecalcDescriptor: StageTypeDescriptor
#### Значение поля
