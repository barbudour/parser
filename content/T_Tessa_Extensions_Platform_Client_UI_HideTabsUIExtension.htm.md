...
C# __Копировать
     public sealed class HideTabsUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class HideTabsUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class HideTabsUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type HideTabsUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ HideTabsUIExtension
##  __Конструкторы
[HideTabsUIExtension](M_Tessa_Extensions_Platform_Client_UI_HideTabsUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса HideTabsUIExtension  
---|---  
##  __Методы
