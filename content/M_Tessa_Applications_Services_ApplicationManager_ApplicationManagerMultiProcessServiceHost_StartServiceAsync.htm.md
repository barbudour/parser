# ApplicationManagerMultiProcessServiceHost.StartServiceAsync - метод
##  __Definition
 **Пространство имён:**
...
#### Реализации
[IApplicationManagerServiceHost.StartServiceAsync(CancellationToken)](M_Tessa_Applications_Services_ApplicationManager_IApplicationManagerServiceHost_StartServiceAsync.htm)  
##  __См. также
#### Ссылки
