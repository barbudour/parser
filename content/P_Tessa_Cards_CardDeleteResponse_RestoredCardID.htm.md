# CardDeleteResponse.RestoredCardID - свойство
...
VB __Копировать
     Public Property RestoredCardID As Guid?
    	Get
    	Set
C++ __Копировать
     public:
    property Nullable<Guid> RestoredCardID {
    	Nullable<Guid> get ();
    	void set (Nullable<Guid> value);
    }
F# __Копировать
     member RestoredCardID : Nullable<Guid> with get, set
#### Значение свойства
