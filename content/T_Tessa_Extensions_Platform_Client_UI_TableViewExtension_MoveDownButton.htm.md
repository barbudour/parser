...
C# __Копировать
     public sealed class MoveDownButton : MoveButtonBase
VB __Копировать
     Public NotInheritable Class MoveDownButton
    	Inherits MoveButtonBase
C++ __Копировать
     public ref class MoveDownButton sealed : public MoveButtonBase
F# __Копировать
     [<SealedAttribute>]
    type MoveDownButton = 
        class
            inherit MoveButtonBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NotificationObject](T_Tessa_Platform_NotificationObject.htm) __[MoveButtonBase](T_Tessa_Extensions_Platform_Client_UI_TableViewExtension_MoveButtonBase.htm) __ MoveDownButton
##  __Конструкторы
[MoveDownButton](M_Tessa_Extensions_Platform_Client_UI_TableViewExtension_MoveDownButton__ctor.htm)|
Инициализирует новый экземпляр класса MoveDownButton  
---|---  
##  __Свойства
