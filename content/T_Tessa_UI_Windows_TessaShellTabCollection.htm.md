...
C# __Копировать
     public sealed class TessaShellTabCollection : UIObservableCollection<ITessaShellTab, ITessaShellTabCollection>, 
    	ITessaShellTabCollection, IObservableCollection<ITessaShellTab, ITessaShellTabCollection>, IList<ITessaShellTab>, 
    	ICollection<ITessaShellTab>, IEnumerable<ITessaShellTab>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
VB __Копировать
     Public NotInheritable Class TessaShellTabCollection
    	Inherits UIObservableCollection(Of ITessaShellTab, ITessaShellTabCollection)
    	Implements ITessaShellTabCollection, IObservableCollection(Of ITessaShellTab, ITessaShellTabCollection), 
    	IList(Of ITessaShellTab), ICollection(Of ITessaShellTab), IEnumerable(Of ITessaShellTab), 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
C++ __Копировать
     public ref class TessaShellTabCollection sealed : public UIObservableCollection<ITessaShellTab^, ITessaShellTabCollection^>, 
    	ITessaShellTabCollection, IObservableCollection<ITessaShellTab^, ITessaShellTabCollection^>, IList<ITessaShellTab^>, 
    	ICollection<ITessaShellTab^>, IEnumerable<ITessaShellTab^>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
F# __Копировать
     [<SealedAttribute>]
    type TessaShellTabCollection = 
        class
            inherit UIObservableCollection<ITessaShellTab, ITessaShellTabCollection>
            interface ITessaShellTabCollection
            interface IObservableCollection<ITessaShellTab, ITessaShellTabCollection>
            interface IList<ITessaShellTab>
            interface ICollection<ITessaShellTab>
            interface IEnumerable<ITessaShellTab>
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)> __[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)> __[SuspendableObservableCollection](T_Tessa_Platform_Collections_SuspendableObservableCollection_1.htm)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)> __[ObservableCollection](T_Tessa_Platform_Collections_ObservableCollection_2.htm)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm), [ITessaShellTabCollection](T_Tessa_UI_Windows_ITessaShellTabCollection.htm)> __[UIObservableCollection](T_Tessa_UI_UIObservableCollection_2.htm)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm), [ITessaShellTabCollection](T_Tessa_UI_Windows_ITessaShellTabCollection.htm)> __ TessaShellTabCollection
Implements
    [ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)>, [IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.ienumerable), [INotifyCollectionChanged](https://learn.microsoft.com/dotnet/api/system.collections.specialized.inotifycollectionchanged), [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged), [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable), [IObservableCollection](T_Tessa_Platform_Collections_IObservableCollection_2.htm)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm), [ITessaShellTabCollection](T_Tessa_UI_Windows_ITessaShellTabCollection.htm)>, [ITessaShellTabCollection](T_Tessa_UI_Windows_ITessaShellTabCollection.htm)
##  __Конструкторы
[TessaShellTabCollection()](M_Tessa_UI_Windows_TessaShellTabCollection__ctor.htm)|
Создаёт экземпляр коллекции с параметрами по умолчанию.  
---|---  
[TessaShellTabCollection(IEnumerable<ITessaShellTab>)](M_Tessa_UI_Windows_TessaShellTabCollection__ctor_1.htm)|
...
[TessaShellTabCollection(List<ITessaShellTab>)](M_Tessa_UI_Windows_TessaShellTabCollection__ctor_2.htm)|
...
(Унаследован от
[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)>)  
...
(Унаследован от
[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)>)  
...
(Унаследован от
[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)>)  
[Clone](M_Tessa_UI_Windows_TessaShellTabCollection_Clone.htm)|  Выполняет
...
[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)>)  
##  __Методы расширения
[AddRange<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_AddRange__1.htm)|
Добавляет значения items в коллекцию collection.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
---|---  
[AddRange<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_AddRange__1_1.htm)|
Добавляет значения items в коллекцию collection.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[AsArray<ITessaShellTab>](M_Tessa_Platform_Collections_EnumerableExtensions_AsArray__1.htm)|
...
[ConvertToListDictionaries<ITessaShellTab>](M_Tessa_Views_Mapping_DictionaryConverter_ConvertToListDictionaries__1.htm)|
...
[ConvertToListDictionaries<ITessaShellTab>](M_Tessa_Views_Mapping_DictionaryConverter_ConvertToListDictionaries__1_1.htm)|
Осуществляет сопоставлению коллекции source на коллекцию коллекций ключ-
значение в соответствии с контекстом сопоставления context  
(Определяется
[DictionaryConverter](T_Tessa_Views_Mapping_DictionaryConverter.htm))  
[ForEach<ITessaShellTab>](M_Tessa_Platform_Collections_EnumerableExtensions_ForEach__1.htm)|
Выполняет указанное действие с каждым элементом коллекции
[IEnumerable<T>](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1).  
(Определяется
[EnumerableExtensions](T_Tessa_Platform_Collections_EnumerableExtensions.htm))  
[FullOuterJoin<ITessaShellTab, TInner, TKey,
TResult>](M_Tessa_Platform_Collections_Extensions_FullOuterJoin__4.htm)|  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[IndexOf<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_IndexOf__1.htm)|
Возвращает индекс первого вхождения элемента в последовательность,
определяемый посредством заданного выражения.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[IndexOf<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_IndexOf__1_2.htm)|
...
элементом.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[IndexOf<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_IndexOf__1_1.htm)|
Возвращает индекс первого вхождения элемента в последовательность,
...
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[IndexOf<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_IndexOf__1_3.htm)|
Выполняет поиск элемента, удовлетворяющего условиям указанного предиката, и
возвращает отсчитываемый от нуля индекс первого вхождения в диапазоне
элементов списка, начинающемся с заданного индекса и содержащем указанное
число элементов.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[InsertRange<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_InsertRange__1.htm)|
Вставляет диапазон элементов в заданный список items, начиная с указанного
индекса index.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[OrderByDependencies<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_OrderByDependencies__1.htm)|  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[OrderByDependencies<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_OrderByDependencies__1_1.htm)|  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[OrderByDependencies<ITessaShellTab,
...
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[OrderByLocalized<ITessaShellTab>](M_Tessa_Platform_PlatformExtensions_OrderByLocalized__1.htm)|
Сортирует значения последовательности по возрастанию по локализованному ключу,
который определяется для каждого элемента.  
(Определяется [PlatformExtensions](T_Tessa_Platform_PlatformExtensions.htm))  
[OrderByLocalizedDescending<ITessaShellTab>](M_Tessa_Platform_PlatformExtensions_OrderByLocalizedDescending__1.htm)|
Сортирует значения последовательности по убыванию по локализованному ключу,
который определяется для каждого элемента.  
(Определяется [PlatformExtensions](T_Tessa_Platform_PlatformExtensions.htm))  
[RemoveAll<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_RemoveAll__1.htm)|
Удаляет все элементы, совпадающие по заданному предикату. Возвращает
количество удалённых элементов.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[RemoveRange<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_RemoveRange__1.htm)|
Удаляет значения items из коллекции collection.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[RemoveRange<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_RemoveRange__1_1.htm)|
Удаляет значения items из коллекции collection.  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[RunWithMaxDegreeOfParallelismAsync<ITessaShellTab>](M_Tessa_Platform_PlatformExtensions_RunWithMaxDegreeOfParallelismAsync__1.htm)|
Выполняет асинхронную обработку элементов с ограничением на максимальное
количество параллельных задач.  
(Определяется [PlatformExtensions](T_Tessa_Platform_PlatformExtensions.htm))  
[ToDictionaryAsync<ITessaShellTab, TKey,
...
(Определяется [PlatformExtensions](T_Tessa_Platform_PlatformExtensions.htm))  
[ToObservableCollection<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_ToObservableCollection__1.htm)|
Преобразует коллекцию IEnumerable в ObservableCollection  
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[ToSealableList<ITessaShellTab>](M_Tessa_Platform_Collections_Extensions_ToSealableList__1.htm)|
...
(Определяется [Extensions](T_Tessa_Platform_Collections_Extensions.htm))  
[TryFirst<ITessaShellTab>](M_Tessa_Platform_Collections_EnumerableExtensions_TryFirst__1.htm)|
Возвращает первый элемент последовательности, удовлетворяющий условию.  
(Определяется
[EnumerableExtensions](T_Tessa_Platform_Collections_EnumerableExtensions.htm))  
[TrySingleOrDefault<ITessaShellTab>](M_Tessa_Platform_Collections_EnumerableExtensions_TrySingleOrDefault__1.htm)|
