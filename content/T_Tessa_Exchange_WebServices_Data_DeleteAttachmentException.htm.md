# DeleteAttachmentException - класс
...
C++ __Копировать
     public ref class DeleteAttachmentException sealed : public BatchServiceResponseException<DeleteAttachmentResponse^>
F# __Копировать
     [<SealedAttribute>]
    type DeleteAttachmentException = 
        class
            inherit BatchServiceResponseException<DeleteAttachmentResponse>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceRemoteException](T_Tessa_Exchange_WebServices_Data_ServiceRemoteException.htm) __[BatchServiceResponseException](T_Tessa_Exchange_WebServices_Data_BatchServiceResponseException_1.htm)<[DeleteAttachmentResponse](T_Tessa_Exchange_WebServices_Data_DeleteAttachmentResponse.htm)> __ DeleteAttachmentException
##  __Свойства
