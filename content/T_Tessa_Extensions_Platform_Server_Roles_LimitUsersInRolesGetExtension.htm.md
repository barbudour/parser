# LimitUsersInRolesGetExtension - класс
...
C# __Копировать
     public sealed class LimitUsersInRolesGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class LimitUsersInRolesGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class LimitUsersInRolesGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type LimitUsersInRolesGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ LimitUsersInRolesGetExtension
##  __Конструкторы
[LimitUsersInRolesGetExtension](M_Tessa_Extensions_Platform_Server_Roles_LimitUsersInRolesGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса LimitUsersInRolesGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_LimitUsersInRolesGetExtension_AfterRequest.htm)|  
(Переопределяет
