# MakeViewTaskHistoryUIExtension - класс
...
C# __Копировать
     public sealed class MakeViewTaskHistoryUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class MakeViewTaskHistoryUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class MakeViewTaskHistoryUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type MakeViewTaskHistoryUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ MakeViewTaskHistoryUIExtension
##  __Конструкторы
[MakeViewTaskHistoryUIExtension](M_Tessa_Extensions_Platform_Client_UI_TaskHistory_MakeViewTaskHistoryUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса MakeViewTaskHistoryUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_TaskHistory_MakeViewTaskHistoryUIExtension_Initialized.htm)|  
(Переопределяет
...
(Унаследован от [CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm))  
[Initializing](M_Tessa_Extensions_Platform_Client_UI_TaskHistory_MakeViewTaskHistoryUIExtension_Initializing.htm)|  
(Переопределяет
