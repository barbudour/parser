# CardNewExtensionContext - класс
Контекст процесса создания структуры карточки.
## __Definition
 **Пространство имён:** [Tessa.Cards.Extensions](N_Tessa_Cards_Extensions.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class CardNewExtensionContext : CardExtensionContext, 
    	ICardNewExtensionContext, ICardRequestExtensionContext<CardNewRequest, CardNewResponse>, ICardExtensionContext, 
    	ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
VB __Копировать
     Public NotInheritable Class CardNewExtensionContext
    	Inherits CardExtensionContext
    	Implements ICardNewExtensionContext, ICardRequestExtensionContext(Of CardNewRequest, CardNewResponse), 
    	ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
C++ __Копировать
     public ref class CardNewExtensionContext sealed : public CardExtensionContext, 
    	ICardNewExtensionContext, ICardRequestExtensionContext<CardNewRequest^, CardNewResponse^>, ICardExtensionContext, 
    	ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
F# __Копировать
     [<SealedAttribute>]
    type CardNewExtensionContext = 
        class
            inherit CardExtensionContext
            interface ICardNewExtensionContext
...
(Унаследован от
[CardExtensionContext](T_Tessa_Cards_Extensions_CardExtensionContext.htm))  
[Method](P_Tessa_Cards_Extensions_CardNewExtensionContext_Method.htm)| Способ
создания карточки.  
[Request](P_Tessa_Cards_Extensions_CardNewExtensionContext_Request.htm)|
...
(Унаследован от
[CardExtensionContext](T_Tessa_Cards_Extensions_CardExtensionContext.htm))  
[Response](P_Tessa_Cards_Extensions_CardNewExtensionContext_Response.htm)|
