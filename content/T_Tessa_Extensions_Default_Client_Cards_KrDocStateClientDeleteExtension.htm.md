# KrDocStateClientDeleteExtension - класс
...
C# __Копировать
     public sealed class KrDocStateClientDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class KrDocStateClientDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class KrDocStateClientDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type KrDocStateClientDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ KrDocStateClientDeleteExtension
##  __Конструкторы
[KrDocStateClientDeleteExtension](M_Tessa_Extensions_Default_Client_Cards_KrDocStateClientDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrDocStateClientDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Client_Cards_KrDocStateClientDeleteExtension_BeforeRequest.htm)|  
(Переопределяет
