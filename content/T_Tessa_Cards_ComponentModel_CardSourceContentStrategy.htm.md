# CardSourceContentStrategy - класс
...
C# __Копировать
     public sealed class CardSourceContentStrategy : ICardContentStrategy
VB __Копировать
     Public NotInheritable Class CardSourceContentStrategy
    	Implements ICardContentStrategy
C++ __Копировать
     public ref class CardSourceContentStrategy sealed : ICardContentStrategy
F# __Копировать
     [<SealedAttribute>]
    type CardSourceContentStrategy = 
        class
            interface ICardContentStrategy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardSourceContentStrategy
Implements
    [ICardContentStrategy](T_Tessa_Cards_ComponentModel_ICardContentStrategy.htm)
##  __Конструкторы
[CardSourceContentStrategy](M_Tessa_Cards_ComponentModel_CardSourceContentStrategy__ctor.htm)|
...
Создаёт экземпляр класса CardSourceContentStrategy с параметрами по умолчанию
при создании без контейнера Unity.  
