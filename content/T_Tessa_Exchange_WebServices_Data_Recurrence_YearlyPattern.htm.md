# Recurrence.YearlyPattern - класс
...
VB __Копировать
     Public NotInheritable Class YearlyPattern
    	Inherits Recurrence
C++ __Копировать
     public ref class YearlyPattern sealed : public Recurrence
F# __Копировать
     [<SealedAttribute>]
    type YearlyPattern = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[Recurrence](T_Tessa_Exchange_WebServices_Data_Recurrence.htm) __ Recurrence.YearlyPattern
##  __Конструкторы
[Recurrence.YearlyPattern()](M_Tessa_Exchange_WebServices_Data_Recurrence_YearlyPattern__ctor.htm)|
Initializes a new instance of the Recurrence.YearlyPattern class.  
---|---  
[Recurrence.YearlyPattern(DateTime, Month,
Int32)](M_Tessa_Exchange_WebServices_Data_Recurrence_YearlyPattern__ctor_1.htm)|
Initializes a new instance of the Recurrence.YearlyPattern class.  
## __Свойства
[DayOfMonth](P_Tessa_Exchange_WebServices_Data_Recurrence_YearlyPattern_DayOfMonth.htm)|
Gets or sets the day of the month when each occurrence happens. DayOfMonth
...
(Унаследован от
[Recurrence](T_Tessa_Exchange_WebServices_Data_Recurrence.htm))  
[Month](P_Tessa_Exchange_WebServices_Data_Recurrence_YearlyPattern_Month.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsSame](M_Tessa_Exchange_WebServices_Data_Recurrence_YearlyPattern_IsSame.htm)|
