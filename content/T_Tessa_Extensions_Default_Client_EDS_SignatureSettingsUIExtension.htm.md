# SignatureSettingsUIExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class SignatureSettingsUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class SignatureSettingsUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type SignatureSettingsUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ SignatureSettingsUIExtension
##  __Конструкторы
[SignatureSettingsUIExtension](M_Tessa_Extensions_Default_Client_EDS_SignatureSettingsUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса SignatureSettingsUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_EDS_SignatureSettingsUIExtension_Initialized.htm)|  
(Переопределяет
