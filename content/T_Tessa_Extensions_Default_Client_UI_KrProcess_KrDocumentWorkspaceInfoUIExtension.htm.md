# KrDocumentWorkspaceInfoUIExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class KrDocumentWorkspaceInfoUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class KrDocumentWorkspaceInfoUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrDocumentWorkspaceInfoUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrDocumentWorkspaceInfoUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrDocumentWorkspaceInfoUIExtension
##  __Конструкторы
[KrDocumentWorkspaceInfoUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrDocumentWorkspaceInfoUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrDocumentWorkspaceInfoUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrDocumentWorkspaceInfoUIExtension_Initialized.htm)|  
(Переопределяет
