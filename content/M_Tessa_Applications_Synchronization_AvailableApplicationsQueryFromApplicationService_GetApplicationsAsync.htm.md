# AvailableApplicationsQueryFromApplicationService.GetApplicationsAsync -
метод
...
#### Реализации
[IAvailableApplicationsQuery.GetApplicationsAsync(CancellationToken)](M_Tessa_Applications_Synchronization_IAvailableApplicationsQuery_GetApplicationsAsync.htm)  
##  __См. также
#### Ссылки
