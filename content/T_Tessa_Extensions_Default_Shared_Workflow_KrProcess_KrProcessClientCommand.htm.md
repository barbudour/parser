...
VB __Копировать
     Public NotInheritable Class KrProcessClientCommand
    	Inherits StorageObject
C++ __Копировать
     public ref class KrProcessClientCommand sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    type KrProcessClientCommand = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ KrProcessClientCommand
##  __Конструкторы
...
Инициализируе новый экземпляр класса KrProcessClientCommand.  
## __Свойства
