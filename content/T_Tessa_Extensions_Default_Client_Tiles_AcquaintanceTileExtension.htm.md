# AcquaintanceTileExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class AcquaintanceTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class AcquaintanceTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class AcquaintanceTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type AcquaintanceTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ AcquaintanceTileExtension
##  __Конструкторы
[AcquaintanceTileExtension](M_Tessa_Extensions_Default_Client_Tiles_AcquaintanceTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса AcquaintanceTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_AcquaintanceTileExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[InitializingLocal](M_Tessa_Extensions_Default_Client_Tiles_AcquaintanceTileExtension_InitializingLocal.htm)|  
(Переопределяет
