# FillTimeZoneInRolesNewExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.TimeZones](N_Tessa_Extensions_Platform_Server_TimeZones.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class FillTimeZoneInRolesNewExtension : CardNewExtension
VB __Копировать
     Public Class FillTimeZoneInRolesNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class FillTimeZoneInRolesNewExtension : public CardNewExtension
F# __Копировать
     type FillTimeZoneInRolesNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ FillTimeZoneInRolesNewExtension
##  __Конструкторы
[FillTimeZoneInRolesNewExtension](M_Tessa_Extensions_Platform_Server_TimeZones_FillTimeZoneInRolesNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса FillTimeZoneInRolesNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_TimeZones_FillTimeZoneInRolesNewExtension_AfterRequest.htm)|  
(Переопределяет
