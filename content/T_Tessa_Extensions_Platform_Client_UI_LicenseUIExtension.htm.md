...
C# __Копировать
     public sealed class LicenseUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class LicenseUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class LicenseUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type LicenseUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ LicenseUIExtension
##  __Конструкторы
[LicenseUIExtension](M_Tessa_Extensions_Platform_Client_UI_LicenseUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса LicenseUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_LicenseUIExtension_Initialized.htm)|  
(Переопределяет
