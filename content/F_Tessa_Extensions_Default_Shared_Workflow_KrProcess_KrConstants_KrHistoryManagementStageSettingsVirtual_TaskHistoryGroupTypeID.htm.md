...
C# __Копировать
     public static readonly string TaskHistoryGroupTypeID
VB __Копировать
     Public Shared ReadOnly TaskHistoryGroupTypeID As String
C++ __Копировать
     public:
    static initonly String^ TaskHistoryGroupTypeID
F# __Копировать
     static val TaskHistoryGroupTypeID: string
#### Значение поля
