# DepartmentEmployeesTimeZonesStoreExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.TimeZones](N_Tessa_Extensions_Platform_Server_TimeZones.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class DepartmentEmployeesTimeZonesStoreExtension : CardStoreExtension
VB __Копировать
     Public Class DepartmentEmployeesTimeZonesStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class DepartmentEmployeesTimeZonesStoreExtension : public CardStoreExtension
F# __Копировать
     type DepartmentEmployeesTimeZonesStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ DepartmentEmployeesTimeZonesStoreExtension
##  __Конструкторы
[DepartmentEmployeesTimeZonesStoreExtension](M_Tessa_Extensions_Platform_Server_TimeZones_DepartmentEmployeesTimeZonesStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса
DepartmentEmployeesTimeZonesStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_TimeZones_DepartmentEmployeesTimeZonesStoreExtension_AfterBeginTransaction.htm)|  
(Переопределяет
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_TimeZones_DepartmentEmployeesTimeZonesStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Platform.Server.TimeZones - пространство
имён](N_Tessa_Extensions_Platform_Server_TimeZones.htm)
