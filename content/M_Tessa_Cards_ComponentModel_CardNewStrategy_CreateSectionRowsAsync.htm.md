# CardNewStrategy.CreateSectionRowsAsync - метод
...
C# __Копировать
     public ValueTask<StringDictionaryStorage<CardRow>> CreateSectionRowsAsync(
    	CardNewContext context,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Public Function CreateSectionRowsAsync ( 
    	context As CardNewContext,
    	Optional cancellationToken As CancellationToken = Nothing
    ) As ValueTask(Of StringDictionaryStorage(Of CardRow))
C++ __Копировать
     public:
    virtual ValueTask<StringDictionaryStorage<CardRow^>^> CreateSectionRowsAsync(
    	CardNewContext^ context, 
...
F# __Копировать
    ...
    *)
    ...
    override CreateSectionRowsAsync : 
            context : CardNewContext * 
            ?cancellationToken : CancellationToken 
    (* Defaults:
            let _cancellationToken = defaultArg cancellationToken new CancellationToken()
...
#### Реализации
[ICardNewStrategy.CreateSectionRowsAsync(CardNewContext,
CancellationToken)](M_Tessa_Cards_ComponentModel_ICardNewStrategy_CreateSectionRowsAsync.htm)  
##  __См. также
#### Ссылки
