...
VB __Копировать
     Public Class ScriptStageTypeHandler
    	Inherits StageTypeHandlerBase
C++ __Копировать
     public ref class ScriptStageTypeHandler : public StageTypeHandlerBase
F# __Копировать
     type ScriptStageTypeHandler = 
        class
            inherit StageTypeHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StageTypeHandlerBase](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTypeHandlerBase.htm) __ ScriptStageTypeHandler
##  __Конструкторы
[ScriptStageTypeHandler](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_ScriptStageTypeHandler__ctor.htm)|
Инициализирует новый экземпляр класса ScriptStageTypeHandler  
---|---  
##  __Методы
...
(Унаследован от
[StageTypeHandlerBase](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTypeHandlerBase.htm))  
[HandleStageStartAsync](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_ScriptStageTypeHandler_HandleStageStartAsync.htm)|
