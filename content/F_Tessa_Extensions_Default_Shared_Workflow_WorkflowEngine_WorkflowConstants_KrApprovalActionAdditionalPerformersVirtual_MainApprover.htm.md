...
C# __Копировать
     public const string MainApprover = "MainApprover"
VB __Копировать
     Public Const MainApprover As String = "MainApprover"
C++ __Копировать
     public:
    literal String^ MainApprover = "MainApprover"
F# __Копировать
     static val mutable MainApprover: string
#### Значение поля
