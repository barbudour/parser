# KrClientCommandStoreExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrClientCommandStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class KrClientCommandStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type KrClientCommandStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ KrClientCommandStoreExtension
##  __Конструкторы
[KrClientCommandStoreExtension](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_Requests_KrClientCommandStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrClientCommandStoreExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_Requests_KrClientCommandStoreExtension_AfterRequest.htm)|
