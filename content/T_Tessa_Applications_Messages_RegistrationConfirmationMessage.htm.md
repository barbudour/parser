# RegistrationConfirmationMessage - класс
...
C# __Копировать
     public sealed class RegistrationConfirmationMessage : ApplicationMessage
VB __Копировать
     Public NotInheritable Class RegistrationConfirmationMessage
    	Inherits ApplicationMessage
C++ __Копировать
     public ref class RegistrationConfirmationMessage sealed : public ApplicationMessage
F# __Копировать
     [<SealedAttribute>]
    type RegistrationConfirmationMessage = 
        class
            inherit ApplicationMessage
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ApplicationMessage](T_Tessa_Applications_Messages_ApplicationMessage.htm) __ RegistrationConfirmationMessage
##  __Конструкторы
[RegistrationConfirmationMessage](M_Tessa_Applications_Messages_RegistrationConfirmationMessage__ctor.htm)|
Initializes a new instance of the RegistrationConfirmationMessage class.  
---|---  
## __Свойства
