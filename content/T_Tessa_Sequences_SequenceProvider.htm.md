...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ SequenceProvider
Implements
    [ISequenceProvider](T_Tessa_Sequences_ISequenceProvider.htm)
##  __Конструкторы
[SequenceProvider](M_Tessa_Sequences_SequenceProvider__ctor.htm)|
Инициализирует новый экземпляр класса SequenceProvider  
---|---  
##  __Методы
