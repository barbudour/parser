...
C++ __Копировать
     public ref class OAuthCredentials sealed : public ExchangeCredentials
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExchangeCredentials](T_Tessa_Exchange_WebServices_Data_ExchangeCredentials.htm) __ OAuthCredentials
##  __Конструкторы
[OAuthCredentials(ICredentials)](M_Tessa_Exchange_WebServices_Data_OAuthCredentials__ctor.htm)|
Initializes a new instance of the OAuthCredentials class using specified
credentials.  
---|---  
[OAuthCredentials(String)](M_Tessa_Exchange_WebServices_Data_OAuthCredentials__ctor_1.htm)|
