# KrCreateBasedOnHandler - методы
##  __Методы
[CopyFilesAsync](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrCreateBasedOnHandler_CopyFilesAsync.htm)|
Выполняет копирование невиртуальных файлов из карточки baseCard в карточку
newCard.  
---|---  
[CopyInfoAsync](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrCreateBasedOnHandler_CopyInfoAsync.htm)|
