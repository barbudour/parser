# CardRequest(IStorageObjectProvider) - конструктор
...
F# __Копировать
     new : 
            storageProvider : IStorageObjectProvider -> CardRequest
#### Параметры
storageProvider
...
[CardRequest - перегрузка](Overload_Tessa_Cards_CardRequest__ctor.htm)
