...
VB __Копировать
     Public NotInheritable Class CardStoreExecutionStrategy
    	Implements ICardStoreExecutionStrategy
C++ __Копировать
     public ref class CardStoreExecutionStrategy sealed : ICardStoreExecutionStrategy
F# __Копировать
     [<SealedAttribute>]
    type CardStoreExecutionStrategy = 
        class
            interface ICardStoreExecutionStrategy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardStoreExecutionStrategy
Implements
    [ICardStoreExecutionStrategy](T_Tessa_Cards_ComponentModel_ICardStoreExecutionStrategy.htm)
##  __Конструкторы
[CardStoreExecutionStrategy](M_Tessa_Cards_ComponentModel_CardStoreExecutionStrategy__ctor.htm)|
