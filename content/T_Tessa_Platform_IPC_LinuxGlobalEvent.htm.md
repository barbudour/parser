...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[GlobalEventBase](T_Tessa_Platform_IPC_GlobalEventBase.htm) __ LinuxGlobalEvent
##  __Конструкторы
[LinuxGlobalEvent](M_Tessa_Platform_IPC_LinuxGlobalEvent__ctor.htm)|  Создаёт
экземпляр класса с указанием его параметров.  
---|---  
## __Свойства
[EventFileName](P_Tessa_Platform_IPC_LinuxGlobalEvent_EventFileName.htm)|  Имя
файла, используемое для генерации события.  
---|---  
[EventFilePath](P_Tessa_Platform_IPC_LinuxGlobalEvent_EventFilePath.htm)|
Полный путь к файлу, используемому для генерации события.  
[EventFolderPath](P_Tessa_Platform_IPC_LinuxGlobalEvent_EventFolderPath.htm)|
...
(Унаследован от [GlobalEventBase](T_Tessa_Platform_IPC_GlobalEventBase.htm))  
[CleanCoreAsync](M_Tessa_Platform_IPC_LinuxGlobalEvent_CleanCoreAsync.htm)|
Освобождает ресурсы события, делая невозможным его дальнейшее использование, и
удаляет связанный с ним файл при его наличии. В реализации по умолчанию
выполняет работу по очистке на Linux и игнорируется на Windows.  
(Переопределяет
[GlobalEventBase.CleanCoreAsync(CancellationToken)](M_Tessa_Platform_IPC_GlobalEventBase_CleanCoreAsync.htm))  
...
(Унаследован от [GlobalEventBase](T_Tessa_Platform_IPC_GlobalEventBase.htm))  
[CloseFromMainProcessCoreAsync](M_Tessa_Platform_IPC_LinuxGlobalEvent_CloseFromMainProcessCoreAsync.htm)|
Выполняет глобальное закрытие всех ресурсов, связанных с событием. Процессы,
выполняющие ожидание события, могут прекратить ожидание, но на это поведение
нельзя опираться. Рекомендуется не вызывать этот метод, если нельзя определить
текущий процесс как единственный процесс, переводящий событие в сигнальное
...
(Унаследован от [GlobalEventBase](T_Tessa_Platform_IPC_GlobalEventBase.htm))  
[DisposeAsync(Boolean)](M_Tessa_Platform_IPC_LinuxGlobalEvent_DisposeAsync.htm)|
Освобождает ресурсы, занимаемые объектом.  
(Переопределяет
...
управление.  
(Унаследован от [GlobalEventBase](T_Tessa_Platform_IPC_GlobalEventBase.htm))  
[ResetCore](M_Tessa_Platform_IPC_LinuxGlobalEvent_ResetCore.htm)|  Переводит
...
управление.  
(Унаследован от [GlobalEventBase](T_Tessa_Platform_IPC_GlobalEventBase.htm))  
[SetCore](M_Tessa_Platform_IPC_LinuxGlobalEvent_SetCore.htm)|  Переводит
...
[ToString](M_Tessa_Platform_IPC_LinuxGlobalEvent_ToString.htm)|  
(Переопределяет
...
(Унаследован от [GlobalEventBase](T_Tessa_Platform_IPC_GlobalEventBase.htm))  
[WaitCoreAsync](M_Tessa_Platform_IPC_LinuxGlobalEvent_WaitCoreAsync.htm)|
