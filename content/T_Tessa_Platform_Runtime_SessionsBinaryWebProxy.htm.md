...
C# __Копировать
     public sealed class SessionsBinaryWebProxy : WebProxy
VB __Копировать
     Public NotInheritable Class SessionsBinaryWebProxy
    	Inherits WebProxy
C++ __Копировать
     public ref class SessionsBinaryWebProxy sealed : public WebProxy
F# __Копировать
     [<SealedAttribute>]
    type SessionsBinaryWebProxy = 
        class
            inherit WebProxy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm) __ SessionsBinaryWebProxy
##  __Конструкторы
[SessionsBinaryWebProxy](M_Tessa_Platform_Runtime_SessionsBinaryWebProxy__ctor.htm)|
...
изменений.  
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[CloseSessionAsAdminAsync](M_Tessa_Platform_Runtime_SessionsBinaryWebProxy_CloseSessionAsAdminAsync.htm)|
...
[CloseSessionAsync](M_Tessa_Platform_Runtime_SessionsBinaryWebProxy_CloseSessionAsync.htm)|
...
[CloseSessionWithTokenAsync](M_Tessa_Platform_Runtime_SessionsBinaryWebProxy_CloseSessionWithTokenAsync.htm)|
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[IncrementConfigurationVersionAsync](M_Tessa_Platform_Runtime_SessionsBinaryWebProxy_IncrementConfigurationVersionAsync.htm)|
