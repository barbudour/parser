...
C# __Копировать
    ...
    public sealed class WorkflowNodeStorage : WorkflowTemplateStorageWithDescriptionBase
VB __Копировать
    <SerializableAttribute>
...
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowNodeStorage sealed : public WorkflowTemplateStorageWithDescriptionBase
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __[WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm) __[WorkflowTemplateStorageWithDescriptionBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageWithDescriptionBase.htm) __ WorkflowNodeStorage
##  __Конструкторы
[WorkflowNodeStorage()](M_Tessa_Workflow_Storage_WorkflowNodeStorage__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowNodeStorage  
---|---  
[WorkflowNodeStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowNodeStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowNodeStorage  
[WorkflowNodeStorage(Dictionary<String, Object>,
WorkflowProcessStorage)](M_Tessa_Workflow_Storage_WorkflowNodeStorage__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowNodeStorage  
##  __Свойства
[Actions](P_Tessa_Workflow_Storage_WorkflowNodeStorage_Actions.htm)|  Список
действий узла  
---|---  
[ActionsByID](P_Tessa_Workflow_Storage_WorkflowNodeStorage_ActionsByID.htm)|  
...
[DefaultSignals](P_Tessa_Workflow_Storage_WorkflowNodeStorage_DefaultSignals.htm)|
Список сигналов, на которые подписан узел по умолчанию При работе со списком
на клиенте следует использовать
[ObservableDefaultSignals](P_Tessa_Workflow_Storage_WorkflowNodeStorage_ObservableDefaultSignals.htm)  
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[Height](P_Tessa_Workflow_Storage_WorkflowNodeStorage_Height.htm)|  Высота
узла  
[Icon](P_Tessa_Workflow_Storage_WorkflowNodeStorage_Icon.htm)|  
[ID](P_Tessa_Workflow_Storage_WorkflowStorageBase_ID.htm)|  ID объекта  
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[IsStandAlone](P_Tessa_Workflow_Storage_WorkflowNodeStorage_IsStandAlone.htm)|
Признак того, что узел является одиночным (может содержать только одно
действие)  
[Left](P_Tessa_Workflow_Storage_WorkflowNodeStorage_Left.htm)|  Left-
координата узла  
...
[WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm))  
[ObservableDefaultSignals](P_Tessa_Workflow_Storage_WorkflowNodeStorage_ObservableDefaultSignals.htm)|  
[OrderedActions](P_Tessa_Workflow_Storage_WorkflowNodeStorage_OrderedActions.htm)|  
[OutLinks](P_Tessa_Workflow_Storage_WorkflowNodeStorage_OutLinks.htm)|  
[ParentObject](P_Tessa_Workflow_Storage_WorkflowTemplateStorageBase_ParentObject.htm)|
Родительский объект.  
(Унаследован от
[WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm))  
[Top](P_Tessa_Workflow_Storage_WorkflowNodeStorage_Top.htm)|  Top-координата
узла  
[Width](P_Tessa_Workflow_Storage_WorkflowNodeStorage_Width.htm)|  Ширина узла  
## __Методы
[CallIsChangedChanged](M_Tessa_Workflow_Storage_WorkflowStorageBase_CallIsChangedChanged.htm)|  
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
---|---  
[CheckName](M_Tessa_Workflow_Storage_WorkflowNodeStorage_CheckName.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[ClearChanges](M_Tessa_Workflow_Storage_WorkflowNodeStorage_ClearChanges.htm)|
Метод для очистки информации об изменении объекта  
(Переопределяет
[WorkflowStorageBase.ClearChanges()](M_Tessa_Workflow_Storage_WorkflowStorageBase_ClearChanges.htm))  
[Clone](M_Tessa_Workflow_Storage_WorkflowNodeStorage_Clone.htm)|  Метод для
...
(Унаследован от
[WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm))  
[EnsureCacheResolved](M_Tessa_Workflow_Storage_WorkflowNodeStorage_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[GetNextOrder](M_Tessa_Workflow_Storage_WorkflowNodeStorage_GetNextOrder.htm)|
Метод для получения следующего номера в списке действий.  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[HasChanges](M_Tessa_Workflow_Storage_WorkflowNodeStorage_HasChanges.htm)|
Метод для проверки наличия изменений у объекта  
(Переопределяет
[WorkflowStorageBase.HasChanges()](M_Tessa_Workflow_Storage_WorkflowStorageBase_HasChanges.htm))  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Initialize](M_Tessa_Workflow_Storage_WorkflowNodeStorage_Initialize.htm)|
Метод для инициализации узла.  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[OnPropertyChanged(PropertyChangedEventArgs)](M_Tessa_Workflow_Storage_WorkflowNodeStorage_OnPropertyChanged.htm)|
Уведомляет об изменении свойства с именем, заданным в аргументах события.  
(Переопределяет
[WorkflowStorageBase.OnPropertyChanged(PropertyChangedEventArgs)](M_Tessa_Workflow_Storage_WorkflowStorageBase_OnPropertyChanged.htm))  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[RemoveData](M_Tessa_Workflow_Storage_WorkflowNodeStorage_RemoveData.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[UpdateData](M_Tessa_Workflow_Storage_WorkflowNodeStorage_UpdateData.htm)|  
(Переопределяет
