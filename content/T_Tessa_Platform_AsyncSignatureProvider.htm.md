...
C# __Копировать
     public sealed class AsyncSignatureProvider : ISignatureProvider
VB __Копировать
     Public NotInheritable Class AsyncSignatureProvider
    	Implements ISignatureProvider
C++ __Копировать
     public ref class AsyncSignatureProvider sealed : ISignatureProvider
F# __Копировать
     [<SealedAttribute>]
    type AsyncSignatureProvider = 
        class
            interface ISignatureProvider
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ AsyncSignatureProvider
Implements
    [ISignatureProvider](T_Tessa_Platform_ISignatureProvider.htm)
##  __Методы
[CreateWithBothKeys](M_Tessa_Platform_AsyncSignatureProvider_CreateWithBothKeys.htm)|
Создаёт объект, предоставляющий криптографические средства для управления
лицензиями, с указанием и закрытого, и открытого ключей.  
---|---  
[CreateWithPrivateKey](M_Tessa_Platform_AsyncSignatureProvider_CreateWithPrivateKey.htm)|
Создаёт объект, предоставляющий криптографические средства для управления
лицензиями, с указанием закрытого ключа.  
[CreateWithPublicKey](M_Tessa_Platform_AsyncSignatureProvider_CreateWithPublicKey.htm)|
Создаёт объект, предоставляющий криптографические средства для управления
лицензиями, с указанием открытого ключа.  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Sign](M_Tessa_Platform_AsyncSignatureProvider_Sign.htm)|  Возвращает
электронную цифровую подпись для заданных бинарных данных лицензии.  
[ToString](https://learn.microsoft.com/dotnet/api/system.object.tostring#system-
object-tostring)| Returns a string that represents the current object.  
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Verify](M_Tessa_Platform_AsyncSignatureProvider_Verify.htm)|  Проверяет
