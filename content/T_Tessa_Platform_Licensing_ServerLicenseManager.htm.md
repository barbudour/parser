...
C# __Копировать
     public sealed class ServerLicenseManager : ILicenseManager
VB __Копировать
     Public NotInheritable Class ServerLicenseManager
    	Implements ILicenseManager
C++ __Копировать
     public ref class ServerLicenseManager sealed : ILicenseManager
F# __Копировать
     [<SealedAttribute>]
    type ServerLicenseManager = 
        class
            interface ILicenseManager
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ServerLicenseManager
Implements
    [ILicenseManager](T_Tessa_Platform_Licensing_ILicenseManager.htm)
##  __Конструкторы
[ServerLicenseManager](M_Tessa_Platform_Licensing_ServerLicenseManager__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetLicenseAsync](M_Tessa_Platform_Licensing_ServerLicenseManager_GetLicenseAsync.htm)|
