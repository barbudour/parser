# KrDescriptors.KrApprovalDescriptor - поле
Согласование.
## __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly KrApprovalDescriptor As WorkflowActionDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionDescriptor^ KrApprovalDescriptor
F# __Копировать
     static val KrApprovalDescriptor: WorkflowActionDescriptor
#### Значение поля
