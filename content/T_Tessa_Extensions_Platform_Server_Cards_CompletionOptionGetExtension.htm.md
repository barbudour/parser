# CompletionOptionGetExtension - класс
...
C# __Копировать
     public sealed class CompletionOptionGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class CompletionOptionGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class CompletionOptionGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type CompletionOptionGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ CompletionOptionGetExtension
##  __Конструкторы
[CompletionOptionGetExtension](M_Tessa_Extensions_Platform_Server_Cards_CompletionOptionGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса CompletionOptionGetExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_CompletionOptionGetExtension_BeforeRequest.htm)|  
(Переопределяет
