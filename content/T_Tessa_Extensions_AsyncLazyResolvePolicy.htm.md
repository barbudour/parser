...
C# __Копировать
     public sealed class AsyncLazyResolvePolicy : IResolvePolicy, 
    	IExtensionPolicy
VB __Копировать
     Public NotInheritable Class AsyncLazyResolvePolicy
    	Implements IResolvePolicy, IExtensionPolicy
C++ __Копировать
     public ref class AsyncLazyResolvePolicy sealed : IResolvePolicy, 
    	IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type AsyncLazyResolvePolicy = 
        class
            interface IResolvePolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ AsyncLazyResolvePolicy
Implements
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ResolveAsync](M_Tessa_Extensions_AsyncLazyResolvePolicy_ResolveAsync.htm)|
