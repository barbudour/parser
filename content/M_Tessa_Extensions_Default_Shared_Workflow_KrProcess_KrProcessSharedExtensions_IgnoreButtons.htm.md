# KrProcessSharedExtensions.IgnoreButtons - метод
...
VB __Копировать
    <ExtensionAttribute>
    Public Shared Sub IgnoreButtons ( 
...
(Optional)
    Значение true, если при загрузке карточки не надо добавлять в ответ информацию по тайлам вторичных процессов, иначе - false.
