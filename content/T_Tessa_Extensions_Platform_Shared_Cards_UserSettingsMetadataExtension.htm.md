# UserSettingsMetadataExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Shared.Cards](N_Tessa_Extensions_Platform_Shared_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class UserSettingsMetadataExtension : CardTypeMetadataExtension
VB __Копировать
     Public NotInheritable Class UserSettingsMetadataExtension
    	Inherits CardTypeMetadataExtension
C++ __Копировать
     public ref class UserSettingsMetadataExtension sealed : public CardTypeMetadataExtension
F# __Копировать
     [<SealedAttribute>]
    type UserSettingsMetadataExtension = 
        class
            inherit CardTypeMetadataExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardMetadataExtension](T_Tessa_Cards_Extensions_CardMetadataExtension.htm) __[CardTypeMetadataExtension](T_Tessa_Cards_Extensions_CardTypeMetadataExtension.htm) __ UserSettingsMetadataExtension
##  __Конструкторы
[UserSettingsMetadataExtension(ISettingsProvider)](M_Tessa_Extensions_Platform_Shared_Cards_UserSettingsMetadataExtension__ctor_1.htm)|
Инициализирует новый экземпляр класса UserSettingsMetadataExtension  
---|---  
[UserSettingsMetadataExtension(ICardMetadata,
ISettingsProvider)](M_Tessa_Extensions_Platform_Shared_Cards_UserSettingsMetadataExtension__ctor.htm)|
Инициализирует новый экземпляр класса UserSettingsMetadataExtension  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ModifyMetadata](M_Tessa_Extensions_Platform_Shared_Cards_UserSettingsMetadataExtension_ModifyMetadata.htm)|
...
[ModifyTypes](M_Tessa_Extensions_Platform_Shared_Cards_UserSettingsMetadataExtension_ModifyTypes.htm)|
