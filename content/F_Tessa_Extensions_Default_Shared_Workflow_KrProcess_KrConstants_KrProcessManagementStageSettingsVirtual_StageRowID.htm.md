# KrConstants.KrProcessManagementStageSettingsVirtual.StageRowID - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly StageRowID As String
C++ __Копировать
     public:
    static initonly String^ StageRowID
F# __Копировать
     static val StageRowID: string
#### Значение поля
