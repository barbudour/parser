# ApplicationManagerAddressGenerator - класс
Объект
...
C# __Копировать
     public sealed class ApplicationManagerAddressGenerator : HostServiceAddressGenerator
VB __Копировать
     Public NotInheritable Class ApplicationManagerAddressGenerator
    	Inherits HostServiceAddressGenerator
C++ __Копировать
     public ref class ApplicationManagerAddressGenerator sealed : public HostServiceAddressGenerator
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[HostServiceAddressGenerator](T_Tessa_Host_HostServiceAddressGenerator.htm) __ ApplicationManagerAddressGenerator
##  __Конструкторы
[ApplicationManagerAddressGenerator](M_Tessa_Applications_Services_ApplicationManager_ApplicationManagerAddressGenerator__ctor.htm)|
Инициализирует новый экземпляр класса ApplicationManagerAddressGenerator  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetActualHandlerType](M_Tessa_Applications_Services_ApplicationManager_ApplicationManagerAddressGenerator_GetActualHandlerType.htm)|  
(Переопределяет
