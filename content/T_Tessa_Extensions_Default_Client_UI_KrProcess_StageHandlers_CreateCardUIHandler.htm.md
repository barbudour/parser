...
VB __Копировать
     Public NotInheritable Class CreateCardUIHandler
    	Inherits StageTypeUIHandlerBase
C++ __Копировать
     public ref class CreateCardUIHandler sealed : public StageTypeUIHandlerBase
F# __Копировать
     [<SealedAttribute>]
    type CreateCardUIHandler = 
        class
            inherit StageTypeUIHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StageTypeUIHandlerBase](T_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_StageTypeUIHandlerBase.htm) __ CreateCardUIHandler
##  __Конструкторы
[CreateCardUIHandler](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_CreateCardUIHandler__ctor.htm)|
Инициализирует новый экземпляр класса CreateCardUIHandler  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Finalize(IKrStageTypeUIHandlerContext)](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_CreateCardUIHandler_Finalize.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialize](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_CreateCardUIHandler_Initialize.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Validate](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_CreateCardUIHandler_Validate.htm)|
