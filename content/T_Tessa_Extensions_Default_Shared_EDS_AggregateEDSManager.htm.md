...
VB __Копировать
     Public Class AggregateEDSManager
    	Inherits CAdESManager
C++ __Копировать
     public ref class AggregateEDSManager : public CAdESManager
F# __Копировать
     type AggregateEDSManager = 
        class
            inherit CAdESManager
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CAdESManager](T_Tessa_Extensions_Default_Shared_EDS_CAdESManager.htm) __ AggregateEDSManager
##  __Конструкторы
[AggregateEDSManager](M_Tessa_Extensions_Default_Shared_EDS_AggregateEDSManager__ctor.htm)|
Инициализирует новый экземпляр класса AggregateEDSManager  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GenerateSignatureAsync](M_Tessa_Extensions_Default_Shared_EDS_AggregateEDSManager_GenerateSignatureAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[SignDocumentAsync](M_Tessa_Extensions_Default_Shared_EDS_AggregateEDSManager_SignDocumentAsync.htm)|  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[VerifySignatureAsync](M_Tessa_Extensions_Default_Shared_EDS_AggregateEDSManager_VerifySignatureAsync.htm)|
