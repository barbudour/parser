# ForumProviderExtensions.ForumProviderCheckPermissionRequest - класс
##  __Definition
 **Пространство имён:** [Tessa.Forums](N_Tessa_Forums.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class ForumProviderCheckPermissionRequest : StorageObject
VB __Копировать
     Public Class ForumProviderCheckPermissionRequest
    	Inherits StorageObject
C++ __Копировать
     public ref class ForumProviderCheckPermissionRequest : public StorageObject
F# __Копировать
     type ForumProviderCheckPermissionRequest = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForumProviderExtensions.ForumProviderCheckPermissionRequest
##  __Конструкторы
[ForumProviderExtensions.ForumProviderCheckPermissionRequest()](M_Tessa_Forums_ForumProviderExtensions_ForumProviderCheckPermissionRequest__ctor.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderCheckPermissionRequest  
---|---  
[ForumProviderExtensions.ForumProviderCheckPermissionRequest(Dictionary<String,
Object>)](M_Tessa_Forums_ForumProviderExtensions_ForumProviderCheckPermissionRequest__ctor_1.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderCheckPermissionRequest  
##  __Свойства
[FileID](P_Tessa_Forums_ForumProviderExtensions_ForumProviderCheckPermissionRequest_FileID.htm)|  
---|---  
[IsSuperModerator](P_Tessa_Forums_ForumProviderExtensions_ForumProviderCheckPermissionRequest_IsSuperModerator.htm)|  
[TopicID](P_Tessa_Forums_ForumProviderExtensions_ForumProviderCheckPermissionRequest_TopicID.htm)|  
## __Методы
