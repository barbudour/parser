...
C# __Копировать
     public sealed class ContextRoleGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class ContextRoleGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class ContextRoleGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type ContextRoleGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ ContextRoleGetExtension
##  __Конструкторы
[ContextRoleGetExtension](M_Tessa_Extensions_Platform_Server_Roles_ContextRoleGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса ContextRoleGetExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Roles_ContextRoleGetExtension_BeforeRequest.htm)|  
(Переопределяет
