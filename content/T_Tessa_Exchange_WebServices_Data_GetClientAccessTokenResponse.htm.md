# GetClientAccessTokenResponse - класс
...
C++ __Копировать
     public ref class GetClientAccessTokenResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ GetClientAccessTokenResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[Id](P_Tessa_Exchange_WebServices_Data_GetClientAccessTokenResponse_Id.htm)|
Gets the Id.  
[Result](P_Tessa_Exchange_WebServices_Data_ServiceResponse_Result.htm)|  Gets
the result associated with this response.  
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[TokenType](P_Tessa_Exchange_WebServices_Data_GetClientAccessTokenResponse_TokenType.htm)|
Gets the token type.  
[TokenValue](P_Tessa_Exchange_WebServices_Data_GetClientAccessTokenResponse_TokenValue.htm)|
Gets the token value.  
[TTL](P_Tessa_Exchange_WebServices_Data_GetClientAccessTokenResponse_TTL.htm)|
