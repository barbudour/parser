# ExtendedDefaultTypeGroupCaptionsTileExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class ExtendedDefaultTypeGroupCaptionsTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class ExtendedDefaultTypeGroupCaptionsTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type ExtendedDefaultTypeGroupCaptionsTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ ExtendedDefaultTypeGroupCaptionsTileExtension
##  __Конструкторы
[ExtendedDefaultTypeGroupCaptionsTileExtension](M_Tessa_Extensions_Default_Client_Tiles_ExtendedDefaultTypeGroupCaptionsTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса
ExtendedDefaultTypeGroupCaptionsTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_ExtendedDefaultTypeGroupCaptionsTileExtension_InitializingGlobal.htm)|  
(Переопределяет
