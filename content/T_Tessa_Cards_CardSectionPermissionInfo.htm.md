# CardSectionPermissionInfo - класс
...
C# __Копировать
    ...
    public sealed class CardSectionPermissionInfo : CardStorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardSectionPermissionInfo
    	Inherits CardStorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class CardSectionPermissionInfo sealed : public CardStorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardSectionPermissionInfo = 
        class
            inherit CardStorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __ CardSectionPermissionInfo
##  __Конструкторы
[CardSectionPermissionInfo](M_Tessa_Cards_CardSectionPermissionInfo__ctor.htm)|
...
определённых полей.  
## __Методы
[Clean](M_Tessa_Cards_CardSectionPermissionInfo_Clean.htm)| Выполняет очистку
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Cards_CardSectionPermissionInfo_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[IsEmpty](M_Tessa_Cards_CardSectionPermissionInfo_IsEmpty.htm)|  Возвращает
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[RepairStorage](M_Tessa_Cards_CardSectionPermissionInfo_RepairStorage.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[SetFieldPermissions](M_Tessa_Cards_CardSectionPermissionInfo_SetFieldPermissions.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[SetSectionPermissions](M_Tessa_Cards_CardSectionPermissionInfo_SetSectionPermissions.htm)|
...
не найден.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetFieldPermissions](M_Tessa_Cards_CardSectionPermissionInfo_TryGetFieldPermissions.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetRows](M_Tessa_Cards_CardSectionPermissionInfo_TryGetRows.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardSectionPermissionInfo_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
