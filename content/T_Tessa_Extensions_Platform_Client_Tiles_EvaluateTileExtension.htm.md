...
C# __Копировать
     public sealed class EvaluateTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class EvaluateTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class EvaluateTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type EvaluateTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ EvaluateTileExtension
##  __Конструкторы
[EvaluateTileExtension](M_Tessa_Extensions_Platform_Client_Tiles_EvaluateTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса EvaluateTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[OpeningLocal](M_Tessa_Extensions_Platform_Client_Tiles_EvaluateTileExtension_OpeningLocal.htm)|  
(Переопределяет
