...
C# __Копировать
     public sealed class NumberDirectorContainer : INumberDirectorContainer
VB __Копировать
     Public NotInheritable Class NumberDirectorContainer
    	Implements INumberDirectorContainer
C++ __Копировать
     public ref class NumberDirectorContainer sealed : INumberDirectorContainer
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ NumberDirectorContainer
Implements
    [INumberDirectorContainer](T_Tessa_Cards_Numbers_INumberDirectorContainer.htm)
##  __Конструкторы
[NumberDirectorContainer](M_Tessa_Cards_Numbers_NumberDirectorContainer__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetProvider](M_Tessa_Cards_Numbers_NumberDirectorContainer_GetProvider.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Register](M_Tessa_Cards_Numbers_NumberDirectorContainer_Register.htm)|
...
[Reset](M_Tessa_Cards_Numbers_NumberDirectorContainer_Reset.htm)|  Сбрасывает
