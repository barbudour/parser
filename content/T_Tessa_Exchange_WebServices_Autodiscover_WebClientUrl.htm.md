...
VB __Копировать
     Public NotInheritable Class WebClientUrl
C++ __Копировать
     public ref class WebClientUrl sealed
F# __Копировать
     [<SealedAttribute>]
    type WebClientUrl = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ WebClientUrl
##  __Свойства
