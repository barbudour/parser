# DefaultAuthenticationService - класс
...
VB __Копировать
     Public NotInheritable Class DefaultAuthenticationService
    	Implements IAuthenticationService
C++ __Копировать
     public ref class DefaultAuthenticationService sealed : IAuthenticationService
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ DefaultAuthenticationService
Implements
    [IAuthenticationService](T_Tessa_Platform_Runtime_IAuthenticationService.htm)
##  __Конструкторы
[DefaultAuthenticationService](M_Tessa_Platform_Runtime_DefaultAuthenticationService__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[LoginAsync](M_Tessa_Platform_Runtime_DefaultAuthenticationService_LoginAsync.htm)|
