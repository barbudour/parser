...
C++ __Копировать
     public ref class MarkAsJunkResponse : public ServiceResponse
F# __Копировать
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ MarkAsJunkResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[MovedItemId](P_Tessa_Exchange_WebServices_Data_MarkAsJunkResponse_MovedItemId.htm)|
