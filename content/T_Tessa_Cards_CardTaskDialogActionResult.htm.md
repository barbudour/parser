# CardTaskDialogActionResult - класс
...
C# __Копировать
    ...
    public sealed class CardTaskDialogActionResult : StorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardTaskDialogActionResult
    	Inherits StorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTaskDialogActionResult sealed : public StorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardTaskDialogActionResult = 
        class
            inherit StorageObject
            interface ICloneable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ CardTaskDialogActionResult
Implements
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_CardTaskDialogActionResult_Clone.htm)| Creates a new
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[DeepClone](M_Tessa_Cards_CardTaskDialogActionResult_DeepClone.htm)|  Создаёт
новый объект, являющийся копией текущего экземпляра.  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[SetDialogCard](M_Tessa_Cards_CardTaskDialogActionResult_SetDialogCard.htm)|
Устанавливает карточку диалога. Вместе с этим будет обновлен идентификатор
карточки
[DialogCardID](P_Tessa_Cards_CardTaskDialogActionResult_DialogCardID.htm).  
[SetDialogCardID](M_Tessa_Cards_CardTaskDialogActionResult_SetDialogCardID.htm)|
