# NotificationSubscriptionsCardDeleteExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Cards](N_Tessa_Extensions_Platform_Server_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class NotificationSubscriptionsCardDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class NotificationSubscriptionsCardDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class NotificationSubscriptionsCardDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type NotificationSubscriptionsCardDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ NotificationSubscriptionsCardDeleteExtension
##  __Конструкторы
[NotificationSubscriptionsCardDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_NotificationSubscriptionsCardDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса
NotificationSubscriptionsCardDeleteExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Cards_NotificationSubscriptionsCardDeleteExtension_AfterBeginTransaction.htm)|  
(Переопределяет
