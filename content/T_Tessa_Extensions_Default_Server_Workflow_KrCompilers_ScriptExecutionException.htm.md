# ScriptExecutionException - класс
##  __Definition
 **Пространство имён:**
...
C++ __Копировать
    [SerializableAttribute]
    public ref class ScriptExecutionException : public ExecutionExceptionBase
F# __Копировать
     [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ExecutionExceptionBase](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExecutionExceptionBase.htm) __ ScriptExecutionException
##  __Конструкторы
[ScriptExecutionException(SerializationInfo,
StreamingContext)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ScriptExecutionException__ctor.htm)|
Инициализирует новый экземпляр класса ScriptExecutionException  
---|---  
[ScriptExecutionException(String,
String)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ScriptExecutionException__ctor_1.htm)|
Инициализирует новый экземпляр класса ScriptExecutionException  
[ScriptExecutionException(String, String,
Exception)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ScriptExecutionException__ctor_2.htm)|
Инициализирует новый экземпляр класса ScriptExecutionException  
##  __Свойства
