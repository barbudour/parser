...
C# __Копировать
     public class TaskNotificationInfo : TaskNotificationStorage
VB __Копировать
     Public Class TaskNotificationInfo
    	Inherits TaskNotificationStorage
C++ __Копировать
     public ref class TaskNotificationInfo : public TaskNotificationStorage
F# __Копировать
     type TaskNotificationInfo = 
        class
            inherit TaskNotificationStorage
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[TaskNotificationStorage](T_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage.htm) __ TaskNotificationInfo
##  __Конструкторы
[TaskNotificationInfo](M_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationInfo__ctor.htm)|
Инициализирует новый экземпляр класса TaskNotificationInfo  
---|---  
##  __Свойства
[AuthorRole](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationInfo_AuthorRole.htm)|
Автор задания.  
---|---  
[AutoApproveDate](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationInfo_AutoApproveDate.htm)|
Планируемое время автозавершения.  
[AutoApproveString](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationInfo_AutoApproveString.htm)|
Строка, предупреждающая об автозавершении.  
[CardID](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage_CardID.htm)|
ID карточки.  
(Унаследован от
[TaskNotificationStorage](T_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage.htm))  
[CardNumber](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationInfo_CardNumber.htm)|
Номер карточки.  
[CardSubject](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationInfo_CardSubject.htm)|
Тема карточки.  
[Created](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationInfo_Created.htm)|
Дата создания.  
[InProgress](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationInfo_InProgress.htm)|
Признак, что задание взято в работу.  
[Link](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage_Link.htm)|
Ссылка.  
(Унаследован от
[TaskNotificationStorage](T_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage.htm))  
[LinkText](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage_LinkText.htm)|
Текст для ссылки.  
(Унаследован от
[TaskNotificationStorage](T_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage.htm))  
[Planned](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationInfo_Planned.htm)|
Запланированная дата выполнения.  
[RoleID](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage_RoleID.htm)|
ID исполнителя.  
(Унаследован от
[TaskNotificationStorage](T_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage.htm))  
[RoleName](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage_RoleName.htm)|
Имя исполнителя.  
(Унаследован от
[TaskNotificationStorage](T_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage.htm))  
[TaskID](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationInfo_TaskID.htm)|
ID задания.  
[TaskInfo](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationInfo_TaskInfo.htm)|
Информация о задании.  
[TypeCaption](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationInfo_TypeCaption.htm)|
Тип задания.  
[WebLink](P_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage_WebLink.htm)|
