...
C# __Копировать
     public class ExtensionsView : UserControl, 
    	IComponentConnector
VB __Копировать
...
C++ __Копировать
     public ref class ExtensionsView : public UserControl, 
    	IComponentConnector
F# __Копировать
     type ExtensionsView = 
        class
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[InitializeComponent](M_Tessa_Extensions_Platform_Client_Views_ExtensionsView_InitializeComponent.htm)|
InitializeComponent  
