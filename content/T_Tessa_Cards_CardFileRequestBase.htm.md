# CardFileRequestBase - класс
Запрос на получение информации по файлу, прикреплённому к карточке, от сервиса
карточек.
## __Definition
...
C# __Копировать
    ...
    public abstract class CardFileRequestBase : CardRequestBase
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class CardFileRequestBase
    	Inherits CardRequestBase
C++ __Копировать
    [SerializableAttribute]
    public ref class CardFileRequestBase abstract : public CardRequestBase
F# __Копировать
     [<AbstractClassAttribute>]
    [<SerializableAttribute>]
    type CardFileRequestBase = 
        class
            inherit CardRequestBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm) __[CardRequestBase](T_Tessa_Cards_CardRequestBase.htm) __ CardFileRequestBase
Derived
[Tessa.Cards.CardGetFileContentRequest](T_Tessa_Cards_CardGetFileContentRequest.htm)
[Tessa.Cards.CardGetFileVersionsRequest](T_Tessa_Cards_CardGetFileVersionsRequest.htm)
##  __Конструкторы
