# EntryTaskSectionTreeNode - класс
##  __Definition
 **Пространство имён:**
[Tessa.Cards.SmartMerge.Nodes.TaskSections](N_Tessa_Cards_SmartMerge_Nodes_TaskSections.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class EntryTaskSectionTreeNode : TaskTreeNodeBase
VB __Копировать
     Public Class EntryTaskSectionTreeNode
    	Inherits TaskTreeNodeBase
C++ __Копировать
     public ref class EntryTaskSectionTreeNode : public TaskTreeNodeBase
F# __Копировать
     type EntryTaskSectionTreeNode = 
        class
            inherit TaskTreeNodeBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TreeNodeBase](T_Tessa_SmartMerge_TreeNodeBase_1.htm)<[Card](T_Tessa_Cards_Card.htm)> __[CardTreeNodeBase](T_Tessa_Cards_SmartMerge_Nodes_CardTreeNodeBase.htm) __[CardSectionTreeNodeBase](T_Tessa_Cards_SmartMerge_Nodes_CardSectionTreeNodeBase.htm) __[TaskTreeNodeBase](T_Tessa_Cards_SmartMerge_Nodes_TaskSections_TaskTreeNodeBase.htm) __ EntryTaskSectionTreeNode
##  __Конструкторы
[EntryTaskSectionTreeNode](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_EntryTaskSectionTreeNode__ctor.htm)|
Инициализирует новый экземпляр класса EntryTaskSectionTreeNode  
---|---  
##  __Свойства
...
его.  
(Унаследован от [TreeNodeBase<T>](T_Tessa_SmartMerge_TreeNodeBase_1.htm))  
[Clone](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_EntryTaskSectionTreeNode_Clone.htm)|
Клонирует узел.  
(Переопределяет
[TreeNodeBase<T>.Clone()](M_Tessa_SmartMerge_TreeNodeBase_1_Clone.htm))  
[Equals(ITreeNode<Card>)](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_EntryTaskSectionTreeNode_Equals.htm)|
...
[EqualsByKey](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_EntryTaskSectionTreeNode_EqualsByKey.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetHashCode(Int32)](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_EntryTaskSectionTreeNode_GetHashCode.htm)|
...
[GetMergeResult](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_EntryTaskSectionTreeNode_GetMergeResult.htm)|
...
состояние узла.  
(Унаследован от [TreeNodeBase<T>](T_Tessa_SmartMerge_TreeNodeBase_1.htm))  
[ToString](M_Tessa_Cards_SmartMerge_Nodes_TaskSections_EntryTaskSectionTreeNode_ToString.htm)|
