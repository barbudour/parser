...
C# __Копировать
    ...
    [TableAttribute("ContextRoles", IsColumnAttributeRequired = false)]
    public sealed class ContextRole : Role
VB __Копировать
    <DataContractAttribute>
    <TableAttribute("ContextRoles", IsColumnAttributeRequired := false)>
    Public NotInheritable Class ContextRole
    	Inherits Role
C++ __Копировать
    [DataContractAttribute]
    [TableAttribute(L"ContextRoles", IsColumnAttributeRequired = false)]
    public ref class ContextRole sealed : public Role
F# __Копировать
     [<SealedAttribute>]
    [<DataContractAttribute>]
    [<TableAttribute("ContextRoles", IsColumnAttributeRequired = false)>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NamedEntry](T_Tessa_Platform_NamedEntry.htm) __[Role](T_Tessa_Roles_Role.htm) __ ContextRole
##  __Конструкторы
[ContextRole](M_Tessa_Roles_ContextRole__ctor.htm)| Создаёт экземпляр класса с
...
(Унаследован от [Role](T_Tessa_Roles_Role.htm))  
[SqlText](P_Tessa_Roles_ContextRole_SqlText.htm)|  Текст SQL-запроса
статической роли.  
[SqlTextForCard](P_Tessa_Roles_ContextRole_SqlTextForCard.htm)|
Текст SQL-запроса, возвращающего состав контекстной роли для заданной
карточки.
Значение получается парсингом свойства
[SqlText](P_Tessa_Roles_ContextRole_SqlText.htm).  
[SqlTextForUser](P_Tessa_Roles_ContextRole_SqlTextForUser.htm)|
Текст SQL-запроса, возвращающего признак того, что заданный пользователь
входит в состав контекстной роли для заданной карточки.
Значение получается парсингом свойства
[SqlText](P_Tessa_Roles_ContextRole_SqlText.htm).  
...
установлены ссылки.  
(Унаследован от [Role](T_Tessa_Roles_Role.htm))  
[UpdateParsedQueriesAsync](M_Tessa_Roles_ContextRole_UpdateParsedQueriesAsync.htm)|
Выполняет парсинг свойства [SqlText](P_Tessa_Roles_ContextRole_SqlText.htm) и
присваивает значения свойствам
[SqlTextForCard](P_Tessa_Roles_ContextRole_SqlTextForCard.htm) и
[SqlTextForUser](P_Tessa_Roles_ContextRole_SqlTextForUser.htm).  
## __Методы расширения
