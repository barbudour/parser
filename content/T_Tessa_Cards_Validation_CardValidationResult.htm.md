# CardValidationResult - класс
Представляет отсутствующий результат валидации.
## __Definition
 **Пространство имён:** [Tessa.Cards.Validation](N_Tessa_Cards_Validation.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class CardValidationResult : ICardValidationResult
VB __Копировать
     Public NotInheritable Class CardValidationResult
    	Implements ICardValidationResult
C++ __Копировать
     public ref class CardValidationResult sealed : ICardValidationResult
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardValidationResult
Implements
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetCardResult](M_Tessa_Cards_Validation_CardValidationResult_GetCardResult.htm)|
...
[GetEntryFieldResult](M_Tessa_Cards_Validation_CardValidationResult_GetEntryFieldResult.htm)|
Возвращает результат валидации для заданного поля строковой секции.  
[GetHashCode](https://learn.microsoft.com/dotnet/api/system.object.gethashcode#system-
object-gethashcode)| Serves as the default hash function.  
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetSectionResult](M_Tessa_Cards_Validation_CardValidationResult_GetSectionResult.htm)|
...
[GetTableFieldResult](M_Tessa_Cards_Validation_CardValidationResult_GetTableFieldResult.htm)|
Возвращает результат валидации для заданного поля строки коллекционной или
древовидной секции.  
[GetTableRowResult](M_Tessa_Cards_Validation_CardValidationResult_GetTableRowResult.htm)|
