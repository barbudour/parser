# CardTaskTypeFilterPolicy - класс
...
C# __Копировать
     public sealed class CardTaskTypeFilterPolicy : IFilterPolicy, 
    	IExtensionPolicy
VB __Копировать
     Public NotInheritable Class CardTaskTypeFilterPolicy
    	Implements IFilterPolicy, IExtensionPolicy
C++ __Копировать
     public ref class CardTaskTypeFilterPolicy sealed : IFilterPolicy, 
    	IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type CardTaskTypeFilterPolicy = 
        class
            interface IFilterPolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardTaskTypeFilterPolicy
Implements
    [IExtensionPolicy](T_Tessa_Extensions_IExtensionPolicy.htm), [IFilterPolicy](T_Tessa_Extensions_IFilterPolicy.htm)
##  __Конструкторы
[CardTaskTypeFilterPolicy](M_Tessa_Cards_Extensions_CardTaskTypeFilterPolicy__ctor.htm)|
Инициализирует новый экземпляр класса CardTaskTypeFilterPolicy  
---|---  
##  __Свойства
[Instance](P_Tessa_Cards_Extensions_CardTaskTypeFilterPolicy_Instance.htm)|
Экземпляр класса.  
---|---  
##  __Методы
...
---|---  
[FilterAsync](M_Tessa_Cards_Extensions_CardTaskTypeFilterPolicy_FilterAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetFilterContextAsync](M_Tessa_Cards_Extensions_CardTaskTypeFilterPolicy_GetFilterContextAsync.htm)|
