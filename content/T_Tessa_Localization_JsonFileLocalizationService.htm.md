# JsonFileLocalizationService - класс
##  __Definition
 **Пространство имён:** [Tessa.Localization](N_Tessa_Localization.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class JsonFileLocalizationService : LocalizationServiceBase
VB __Копировать
     Public Class JsonFileLocalizationService
    	Inherits LocalizationServiceBase
C++ __Копировать
     public ref class JsonFileLocalizationService : public LocalizationServiceBase
F# __Копировать
     type JsonFileLocalizationService = 
        class
            inherit LocalizationServiceBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[LocalizationServiceBase](T_Tessa_Localization_LocalizationServiceBase.htm) __ JsonFileLocalizationService
Derived
[Tessa.Localization.JsonResourceFileLocalizationService](T_Tessa_Localization_JsonResourceFileLocalizationService.htm)
##  __Конструкторы
[JsonFileLocalizationService()](M_Tessa_Localization_JsonFileLocalizationService__ctor.htm)|
Инициализирует новый экземпляр класса JsonFileLocalizationService  
---|---  
[JsonFileLocalizationService(IEnumerable<String>)](M_Tessa_Localization_JsonFileLocalizationService__ctor_1.htm)|
Инициализирует новый экземпляр класса JsonFileLocalizationService  
[JsonFileLocalizationService(String)](M_Tessa_Localization_JsonFileLocalizationService__ctor_2.htm)|
Инициализирует новый экземпляр класса JsonFileLocalizationService  
##  __Свойства
...
(Унаследован от
[LocalizationServiceBase](T_Tessa_Localization_LocalizationServiceBase.htm))  
[CreateStreamForRead](M_Tessa_Localization_JsonFileLocalizationService_CreateStreamForRead.htm)|  
[CreateStreamForWrite](M_Tessa_Localization_JsonFileLocalizationService_CreateStreamForWrite.htm)|  
...
[FileExists](M_Tessa_Localization_JsonFileLocalizationService_FileExists.htm)|  
...
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
##  __Поля
[FileNameExtension](F_Tessa_Localization_JsonFileLocalizationService_FileNameExtension.htm)|  
---|---  
[FileSearchPattern](F_Tessa_Localization_JsonFileLocalizationService_FileSearchPattern.htm)|  
## __Методы расширения
