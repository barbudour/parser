# Recurrence.YearlyRegenerationPattern - класс
...
VB __Копировать
     Public NotInheritable Class YearlyRegenerationPattern
    	Inherits Recurrence.IntervalPattern
C++ __Копировать
     public ref class YearlyRegenerationPattern sealed : public Recurrence.IntervalPattern
F# __Копировать
     [<SealedAttribute>]
    type YearlyRegenerationPattern = 
        class
            inherit Recurrence.IntervalPattern
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[Recurrence](T_Tessa_Exchange_WebServices_Data_Recurrence.htm) __[Recurrence.IntervalPattern](T_Tessa_Exchange_WebServices_Data_Recurrence_IntervalPattern.htm) __ Recurrence.YearlyRegenerationPattern
##  __Конструкторы
[Recurrence.YearlyRegenerationPattern()](M_Tessa_Exchange_WebServices_Data_Recurrence_YearlyRegenerationPattern__ctor.htm)|
Initializes a new instance of the Recurrence.YearlyRegenerationPattern class.  
---|---  
[Recurrence.YearlyRegenerationPattern(DateTime,
Int32)](M_Tessa_Exchange_WebServices_Data_Recurrence_YearlyRegenerationPattern__ctor_1.htm)|
Initializes a new instance of the Recurrence.YearlyRegenerationPattern class.  
## __Свойства
