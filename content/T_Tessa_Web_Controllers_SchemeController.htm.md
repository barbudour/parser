...
C# __Копировать
    [RouteAttribute("api/b/Scheme")]
    [AllowAnonymousAttribute]
    [ApiExplorerSettingsAttribute(IgnoreApi = true)]
    public sealed class SchemeController : Controller
VB __Копировать
    <RouteAttribute("api/b/Scheme")>
    <AllowAnonymousAttribute>
    <ApiExplorerSettingsAttribute(IgnoreApi := true)>
    Public NotInheritable Class SchemeController
    	Inherits Controller
C++ __Копировать
    [RouteAttribute(L"api/b/Scheme")]
    [AllowAnonymousAttribute]
    [ApiExplorerSettingsAttribute(IgnoreApi = true)]
    public ref class SchemeController sealed : public Controller
F# __Копировать
     [<SealedAttribute>]
    [<RouteAttribute("api/b/Scheme")>]
    [<AllowAnonymousAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase) __[Controller](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controller) __ SchemeController
##  __Конструкторы
[SchemeController](M_Tessa_Web_Controllers_SchemeController__ctor.htm)|
Инициализирует новый экземпляр класса SchemeController  
---|---  
##  __Свойства
...
(Унаследован от
[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase))  
[PostGetDatabaseProperties](M_Tessa_Web_Controllers_SchemeController_PostGetDatabaseProperties.htm)|
Возвращает информацию по базе данных, связанную со схемой.  
[PostGetFunctionByID](M_Tessa_Web_Controllers_SchemeController_PostGetFunctionByID.htm)|
Загружает функцию схемы данных по идентификатору. Возвращает null, если
функция не найдена.  
[PostGetFunctionByName](M_Tessa_Web_Controllers_SchemeController_PostGetFunctionByName.htm)|
Загружает функцию схемы данных по уникальному имени. Возвращает null, если
функция не найдена.  
[PostGetFunctions](M_Tessa_Web_Controllers_SchemeController_PostGetFunctions.htm)|
Возвращает все существующие функции схемы данных. Метод может вернуть null,
если список пуст.  
[PostGetMigrationByID](M_Tessa_Web_Controllers_SchemeController_PostGetMigrationByID.htm)|
Загружает миграцию схемы данных по идентификатору. Возвращает null, если
миграция не найдена.  
[PostGetMigrationByName](M_Tessa_Web_Controllers_SchemeController_PostGetMigrationByName.htm)|
Загружает миграцию схемы данных по уникальному имени. Возвращает null, если
миграция не найдена.  
[PostGetMigrations](M_Tessa_Web_Controllers_SchemeController_PostGetMigrations.htm)|
Возвращает все существующие миграции схемы данных. Метод может вернуть null,
если список пуст.  
[PostGetPartitionByID](M_Tessa_Web_Controllers_SchemeController_PostGetPartitionByID.htm)|
Загружает библиотеку схемы данных по идентификатору. Возвращает null, если
библиотека не найдена.  
[PostGetPartitionByName](M_Tessa_Web_Controllers_SchemeController_PostGetPartitionByName.htm)|
Загружает библиотеку схемы данных по уникальному имени. Возвращает null, если
библиотека не найдена.  
[PostGetPartitions](M_Tessa_Web_Controllers_SchemeController_PostGetPartitions.htm)|
Возвращает все существующие библиотеки схемы данных. Метод может вернуть null,
если список пуст.  
[PostGetProcedureByID](M_Tessa_Web_Controllers_SchemeController_PostGetProcedureByID.htm)|
Загружает процедуру схемы данных по идентификатору. Возвращает null, если
процедура не найдена.  
[PostGetProcedureByName](M_Tessa_Web_Controllers_SchemeController_PostGetProcedureByName.htm)|
Загружает процедуру схемы данных по уникальному имени. Возвращает null, если
процедура не найдена.  
[PostGetProcedures](M_Tessa_Web_Controllers_SchemeController_PostGetProcedures.htm)|
Возвращает все существующие процедуры схемы данных. Метод может вернуть null,
если список пуст.  
[PostGetTableByID](M_Tessa_Web_Controllers_SchemeController_PostGetTableByID.htm)|
Загружает таблицу схемы данных по идентификатору. Возвращает null, если
таблица не найдена.  
[PostGetTableByName](M_Tessa_Web_Controllers_SchemeController_PostGetTableByName.htm)|
Загружает таблицу схемы данных по уникальному имени. Возвращает null, если
таблица не найдена.  
[PostGetTables](M_Tessa_Web_Controllers_SchemeController_PostGetTables.htm)|
Возвращает все существующие таблицы схемы данных. Метод может вернуть null,
если список пуст.  
[PostInvalidateCache](M_Tessa_Web_Controllers_SchemeController_PostInvalidateCache.htm)|
Сбрасывает кэш схемы данных на сервере. Метод доступен только администраторам.  
[PostInvalidateCacheIfChanged](M_Tessa_Web_Controllers_SchemeController_PostInvalidateCacheIfChanged.htm)|
Сбрасывает кэш схемы данных на сервере, если были зарегистрированы изменения в
схеме. Возвращает признак того, что кэш был сброшен. Метод доступен только
администраторам.  
[PostRemoveFunction](M_Tessa_Web_Controllers_SchemeController_PostRemoveFunction.htm)|
Удаляет функцию схемы данных. Функция десериализуется из тела запроса.
Возвращает признак того, что функция существовала и была удалена. Метод
доступен только администраторам.  
[PostRemoveMigration](M_Tessa_Web_Controllers_SchemeController_PostRemoveMigration.htm)|
Удаляет миграцию схемы данных. Миграция десериализуется из тела запроса.
Возвращает признак того, что миграция существовала и была удалена. Метод
доступен только администраторам.  
[PostRemovePartition](M_Tessa_Web_Controllers_SchemeController_PostRemovePartition.htm)|
Удаляет библиотеку схемы данных. Возвращает признак того, что библиотека
существовала и была удалена. Метод доступен только администраторам.  
[PostRemoveProcedure](M_Tessa_Web_Controllers_SchemeController_PostRemoveProcedure.htm)|
Удаляет процедуру схемы данных. Процедура десериализуется из тела запроса.
Возвращает признак того, что процедура существовала и была удалена. Метод
доступен только администраторам.  
[PostRemoveTable](M_Tessa_Web_Controllers_SchemeController_PostRemoveTable.htm)|
Удаляет таблицу схемы данных. Таблица десериализуется из тела запроса.
Возвращает признак того, что таблица существовала и была удалена. Метод
доступен только администраторам.  
[PostSaveDatabaseProperties](M_Tessa_Web_Controllers_SchemeController_PostSaveDatabaseProperties.htm)|
Сохраняет информацию по схеме данных, связанную со схемой. Метод доступен
только администраторам.  
[PostSaveFunction](M_Tessa_Web_Controllers_SchemeController_PostSaveFunction.htm)|
Сохраняет функцию схемы данных. Функция десериализуется из тела запроса. Метод
доступен только администраторам.  
[PostSaveMigration](M_Tessa_Web_Controllers_SchemeController_PostSaveMigration.htm)|
Сохраняет миграцию схемы данных. Миграция десериализуется из тела запроса.
Метод доступен только администраторам.  
[PostSavePartition](M_Tessa_Web_Controllers_SchemeController_PostSavePartition.htm)|
Сохраняет библиотеку схемы данных. Метод доступен только администраторам.  
[PostSaveProcedure](M_Tessa_Web_Controllers_SchemeController_PostSaveProcedure.htm)|
Сохраняет процедуру схемы данных. Процедура десериализуется из тела запроса.
Метод доступен только администраторам.  
[PostSaveTable](M_Tessa_Web_Controllers_SchemeController_PostSaveTable.htm)|
Сохраняет таблицу схемы данных. Таблица десериализуется из тела запроса. Метод
доступен только администраторам.  
