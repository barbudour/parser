...
C# __Копировать
    ...
    public sealed class CardTypesController : Controller
VB __Копировать
    <RouteAttribute("api/v1/types")>
    <AllowAnonymousAttribute>
    <ApiControllerAttribute>
    ...
    <ProducesResponseTypeAttribute(401)>
    <ProducesResponseTypeAttribute(403)>
    Public NotInheritable Class CardTypesController
    	Inherits Controller
C++ __Копировать
    [RouteAttribute(L"api/v1/types")]
    [AllowAnonymousAttribute]
    [ApiControllerAttribute]
    [ProducesErrorResponseTypeAttribute(typeof(PlainValidationResult))]
    [ProducesResponseTypeAttribute(400)]
    [ProducesResponseTypeAttribute(401)]
    [ProducesResponseTypeAttribute(403)]
    public ref class CardTypesController sealed : public Controller
F# __Копировать
     [<SealedAttribute>]
    [<RouteAttribute("api/v1/types")>]
    [<AllowAnonymousAttribute>]
    ...
    [<ProducesResponseTypeAttribute(401)>]
    [<ProducesResponseTypeAttribute(403)>]
    type CardTypesController = 
        class
            inherit Controller
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase) __[Controller](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controller) __ CardTypesController
##  __Конструкторы
[CardTypesController](M_Tessa_Web_Controllers_CardTypesController__ctor.htm)|
Инициализирует новый экземпляр класса CardTypesController  
---|---  
##  __Свойства
...
(Унаследован от
[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase))  
[GetAllCardTypes](M_Tessa_Web_Controllers_CardTypesController_GetAllCardTypes.htm)|
Загружает все типы карточек в системе.  
[GetCardType](M_Tessa_Web_Controllers_CardTypesController_GetCardType.htm)|
Загружает тип карточки с заданным идентификатором. Возвращает статус 204 (No
Content), если тип не найден.  
[GetMetadata](M_Tessa_Web_Controllers_CardTypesController_GetMetadata.htm)|
Загружает объект метаинформации по карточкам
...
(Унаследован от
[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase))  
[PostStore](M_Tessa_Web_Controllers_CardTypesController_PostStore.htm)|
Создаёт или изменяет заданные типы карточек, а также удаляет типы с указанными
идентификаторами в рамках единственного изменения конфигурации. Метод доступен
