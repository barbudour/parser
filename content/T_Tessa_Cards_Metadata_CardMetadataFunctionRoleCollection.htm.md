# CardMetadataFunctionRoleCollection - класс
...
C# __Копировать
    ...
    public sealed class CardMetadataFunctionRoleCollection : CardSerializableEntryCollection<CardMetadataFunctionRole>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardMetadataFunctionRoleCollection
    	Inherits CardSerializableEntryCollection(Of CardMetadataFunctionRole)
C++ __Копировать
    [SerializableAttribute]
    public ref class CardMetadataFunctionRoleCollection sealed : public CardSerializableEntryCollection<CardMetadataFunctionRole^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardMetadataFunctionRoleCollection = 
        class
            inherit CardSerializableEntryCollection<CardMetadataFunctionRole>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __[CardSerializableEntryCollection](T_Tessa_Cards_CardSerializableEntryCollection_1.htm)<[CardMetadataFunctionRole](T_Tessa_Cards_Metadata_CardMetadataFunctionRole.htm)> __ CardMetadataFunctionRoleCollection
##  __Конструкторы
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[XmlElementNameInternal](P_Tessa_Cards_Metadata_CardMetadataFunctionRoleCollection_XmlElementNameInternal.htm)|
...
[XmlItemNameInternal](P_Tessa_Cards_Metadata_CardMetadataFunctionRoleCollection_XmlItemNameInternal.htm)|
...
[CardSerializableEntryCollection<T>](T_Tessa_Cards_CardSerializableEntryCollection_1.htm))  
##  __Поля
[XmlElementName](F_Tessa_Cards_Metadata_CardMetadataFunctionRoleCollection_XmlElementName.htm)|
Имя XML-элемента.  
---|---  
## __Методы расширения
