...
VB __Копировать
     Public Class ServiceEDSManagerForCAdES
    	Inherits DefaultEDSManager
C++ __Копировать
     public ref class ServiceEDSManagerForCAdES : public DefaultEDSManager
F# __Копировать
     type ServiceEDSManagerForCAdES = 
        class
            inherit DefaultEDSManager
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CAdESManager](T_Tessa_Extensions_Default_Shared_EDS_CAdESManager.htm) __[DefaultEDSManager](T_Tessa_Extensions_Default_Shared_EDS_DefaultEDSManager.htm) __ ServiceEDSManagerForCAdES
##  __Конструкторы
[ServiceEDSManagerForCAdES](M_Tessa_Extensions_Default_Client_EDS_ServiceEDSManagerForCAdES__ctor.htm)|
Инициализирует новый экземпляр класса ServiceEDSManagerForCAdES  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GenerateSignatureAsync](M_Tessa_Extensions_Default_Client_EDS_ServiceEDSManagerForCAdES_GenerateSignatureAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[SignDocumentAsync](M_Tessa_Extensions_Default_Client_EDS_ServiceEDSManagerForCAdES_SignDocumentAsync.htm)|  
(Переопределяет [CAdESManager.SignDocumentAsync(Byte[], ISignatureFile,
CancellationToken)](M_Tessa_Extensions_Default_Shared_EDS_CAdESManager_SignDocumentAsync.htm))  
[ToString](https://learn.microsoft.com/dotnet/api/system.object.tostring#system-
object-tostring)| Returns a string that represents the current object.  
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[VerifySignatureAsync](M_Tessa_Extensions_Default_Client_EDS_ServiceEDSManagerForCAdES_VerifySignatureAsync.htm)|
