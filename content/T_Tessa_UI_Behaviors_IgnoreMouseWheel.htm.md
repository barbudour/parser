# IgnoreMouseWheel - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Behaviors](N_Tessa_UI_Behaviors.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class IgnoreMouseWheel : Behavior<UIElement>
VB __Копировать
     Public NotInheritable Class IgnoreMouseWheel
    	Inherits Behavior(Of UIElement)
C++ __Копировать
     public ref class IgnoreMouseWheel sealed : public Behavior<UIElement^>
F# __Копировать
     [<SealedAttribute>]
    type IgnoreMouseWheel = 
        class
            inherit Behavior<UIElement>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement)> __ IgnoreMouseWheel
##  __Конструкторы
[IgnoreMouseWheel](M_Tessa_UI_Behaviors_IgnoreMouseWheel__ctor.htm)|
Инициализирует новый экземпляр класса IgnoreMouseWheel  
---|---  
##  __Свойства
...
(Унаследован от
[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject))  
[EnableMouseScrolling](P_Tessa_UI_Behaviors_IgnoreMouseWheel_EnableMouseScrolling.htm)|
Разрешить прокрутку мышью. Отключает поведение по игнорированию скролла.  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[ScrollWithModifiers](P_Tessa_UI_Behaviors_IgnoreMouseWheel_ScrollWithModifiers.htm)|
Не игнорировать скролл, если нажата хотя бы одна клавиша-модификатор.  
## __Методы
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_IgnoreMouseWheel_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_IgnoreMouseWheel_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_IgnoreMouseWheel_OnDetaching.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[EnableMouseScrollingProperty](F_Tessa_UI_Behaviors_IgnoreMouseWheel_EnableMouseScrollingProperty.htm)|  
---|---  
[ScrollWithModifiersProperty](F_Tessa_UI_Behaviors_IgnoreMouseWheel_ScrollWithModifiersProperty.htm)|  
## __См. также
#### Ссылки
