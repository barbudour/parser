# KrConstants.KrDialogStageTypeSettingsVirtual.DialogTypeName - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly DialogTypeName As String
C++ __Копировать
     public:
    static initonly String^ DialogTypeName
F# __Копировать
     static val DialogTypeName: string
#### Значение поля
