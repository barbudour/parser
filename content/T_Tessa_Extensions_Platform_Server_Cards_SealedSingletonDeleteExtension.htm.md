# SealedSingletonDeleteExtension - класс
...
C# __Копировать
     public sealed class SealedSingletonDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class SealedSingletonDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class SealedSingletonDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type SealedSingletonDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ SealedSingletonDeleteExtension
##  __Конструкторы
[SealedSingletonDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_SealedSingletonDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса SealedSingletonDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_SealedSingletonDeleteExtension_BeforeRequest.htm)|  
(Переопределяет
