...
C# __Копировать
    ...
    public class ForumData : StorageObject, IForumData, 
    	IStorageObjectProvider, IStorageDictionaryProvider, IStorageProvider
VB __Копировать
    <SerializableAttribute>
    Public Class ForumData
    	Inherits StorageObject
    	Implements IForumData, IStorageObjectProvider, IStorageDictionaryProvider, IStorageProvider
C++ __Копировать
    [SerializableAttribute]
    public ref class ForumData : public StorageObject, 
    	IForumData, IStorageObjectProvider, IStorageDictionaryProvider, IStorageProvider
F# __Копировать
     [<SerializableAttribute>]
    type ForumData = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForumData
Implements
    [IForumData](T_Tessa_Forums_ForumCached_IForumData.htm), [IStorageDictionaryProvider](T_Tessa_Platform_Storage_IStorageDictionaryProvider.htm), [IStorageObjectProvider](T_Tessa_Platform_Storage_IStorageObjectProvider.htm), [IStorageProvider](T_Tessa_Platform_Storage_IStorageProvider.htm)
##  __Конструкторы
[ForumData()](M_Tessa_Forums_ForumCached_ForumData__ctor.htm)| Инициализирует
новый экземпляр класса ForumData  
---|---  
[ForumData(Dictionary<String,
Object>)](M_Tessa_Forums_ForumCached_ForumData__ctor_1.htm)| Инициализирует
новый экземпляр класса ForumData  
[ForumData(SerializationInfo,
StreamingContext)](M_Tessa_Forums_ForumCached_ForumData__ctor_2.htm)|
Инициализирует новый экземпляр класса ForumData  
##  __Свойства
[ReadTopicStatusList](P_Tessa_Forums_ForumCached_ForumData_ReadTopicStatusList.htm)|  
---|---  
[TopicTypes](P_Tessa_Forums_ForumCached_ForumData_TopicTypes.htm)|  
## __Методы
