...
C# __Копировать
     public class LoginDialog : TessaWindow, 
    	IComponentConnector
VB __Копировать
     Public Class LoginDialog
    	Inherits TessaWindow
    	Implements IComponentConnector
C++ __Копировать
     public ref class LoginDialog : public TessaWindow, 
    	IComponentConnector
F# __Копировать
     type LoginDialog = 
        class
...
(Унаследован от [TessaWindow](T_Tessa_UI_Windows_TessaWindow.htm))  
...
(Унаследован от [TessaWindow](T_Tessa_UI_Windows_TessaWindow.htm))  
[CanSaveCredentials](P_Tessa_UI_Runtime_LoginDialog_CanSaveCredentials.htm)|
Признак того, что доступен флажок для сохранения пароля.  
...
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[Login](P_Tessa_UI_Runtime_LoginDialog_Login.htm)|  Введённый логин.  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[Password](P_Tessa_UI_Runtime_LoginDialog_Password.htm)|  Введённый пароль.  
...
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[SaveCredentials](P_Tessa_UI_Runtime_LoginDialog_SaveCredentials.htm)|
Признак того, что поставлен флажок для сохранения пароля.  
[ServerLabel](P_Tessa_UI_Runtime_LoginDialog_ServerLabel.htm)|  Информация по
серверу, к которому выполняется подключение.  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[InitializeComponent](M_Tessa_UI_Runtime_LoginDialog_InitializeComponent.htm)|
InitializeComponent  
