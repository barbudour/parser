# IObservableCollectionLookup<TKey, TItem, TCollection> \- интерфейс
...
C# __Копировать
     public interface IObservableCollectionLookup<in TKey, TItem, out TCollection> : IObservableCollection<TItem, TCollection>, 
...
VB __Копировать
     Public Interface IObservableCollectionLookup(Of In TKey, TItem As Class, Out TCollection As {Class, Object, IObservableCollectionLookup(Of TKey, TItem, TCollection)})
...
C++ __Копировать
    ...
    public interface class IObservableCollectionLookup : IObservableCollection<TItem, TCollection>, 
    	IList<TItem>, ICollection<TItem>, IEnumerable<TItem>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer<TKey, TItem>
F# __Копировать
     type IObservableCollectionLookup<'TKey, 'TItem, 'TCollection when 'TItem : not struct when 'TCollection : not struct and Object and IObservableCollectionLookup<'TKey, 'TItem, 'TCollection>> = 
        interface
