# KrPermissionsHelper.MandatoryValidationType.OnTaskCompletion - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Const OnTaskCompletion As Integer = 1
C++ __Копировать
     public:
    literal int OnTaskCompletion = 1
F# __Копировать
     static val mutable OnTaskCompletion: int
#### Значение поля
