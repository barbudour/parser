# ApplyUserSettingsToRolesRequestExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Roles](N_Tessa_Extensions_Platform_Server_Roles.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class ApplyUserSettingsToRolesRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class ApplyUserSettingsToRolesRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class ApplyUserSettingsToRolesRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type ApplyUserSettingsToRolesRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ ApplyUserSettingsToRolesRequestExtension
##  __Конструкторы
[ApplyUserSettingsToRolesRequestExtension](M_Tessa_Extensions_Platform_Server_Roles_ApplyUserSettingsToRolesRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса ApplyUserSettingsToRolesRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_ApplyUserSettingsToRolesRequestExtension_AfterRequest.htm)|  
(Переопределяет
