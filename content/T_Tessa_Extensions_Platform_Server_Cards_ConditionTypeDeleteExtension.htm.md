# ConditionTypeDeleteExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Cards](N_Tessa_Extensions_Platform_Server_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class ConditionTypeDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class ConditionTypeDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class ConditionTypeDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type ConditionTypeDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ ConditionTypeDeleteExtension
##  __Конструкторы
[ConditionTypeDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_ConditionTypeDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса ConditionTypeDeleteExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_ConditionTypeDeleteExtension_AfterRequest.htm)|  
(Переопределяет
