# PipeXmlResponseParser - класс
Объект, выполняющий десериализацию объекта ответа на запрос из текста.
## __Definition
 **Пространство имён:** [Tessa.Platform.Pipes](N_Tessa_Platform_Pipes.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class PipeXmlResponseParser : IPipeResponseParser
VB __Копировать
     Public Class PipeXmlResponseParser
    	Implements IPipeResponseParser
C++ __Копировать
     public ref class PipeXmlResponseParser : IPipeResponseParser
F# __Копировать
     type PipeXmlResponseParser = 
        class
            interface IPipeResponseParser
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ PipeXmlResponseParser
Implements
    [IPipeResponseParser](T_Tessa_Platform_Pipes_IPipeResponseParser.htm)
##  __Заметки
Наследники класса могут переопределить методы объекта.
## __Конструкторы
[PipeXmlResponseParser](M_Tessa_Platform_Pipes_PipeXmlResponseParser__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Свойства
[MessageFactory](P_Tessa_Platform_Pipes_PipeXmlResponseParser_MessageFactory.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryParse](M_Tessa_Platform_Pipes_PipeXmlResponseParser_TryParse.htm)|
...
[TryParseCore](M_Tessa_Platform_Pipes_PipeXmlResponseParser_TryParseCore.htm)|
