# AttributedStringCollection - класс
...
VB __Копировать
     Public NotInheritable Class AttributedStringCollection
    	Inherits ComplexPropertyCollection(Of AttributedString)
C++ __Копировать
     public ref class AttributedStringCollection sealed : public ComplexPropertyCollection<AttributedString^>
F# __Копировать
     [<SealedAttribute>]
    type AttributedStringCollection = 
        class
            inherit ComplexPropertyCollection<AttributedString>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[AttributedString](T_Tessa_Exchange_WebServices_Data_AttributedString.htm)> __ AttributedStringCollection
##  __Свойства
...
[ComplexPropertyCollection<TComplexProperty>](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm))  
##  __Методы
[Add(AttributedString)](M_Tessa_Exchange_WebServices_Data_AttributedStringCollection_Add_2.htm)|
Adds an attributed string to the collection.  
---|---  
[Add(String)](M_Tessa_Exchange_WebServices_Data_AttributedStringCollection_Add.htm)|
Adds an attributed string to the collection.  
[Add(String,
IList<String>)](M_Tessa_Exchange_WebServices_Data_AttributedStringCollection_Add_1.htm)|
Adds a string value and list of attributions  
[AddRange](M_Tessa_Exchange_WebServices_Data_AttributedStringCollection_AddRange.htm)|
Adds multiple attributed strings to the collection.  
[Clear](M_Tessa_Exchange_WebServices_Data_AttributedStringCollection_Clear.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Remove](M_Tessa_Exchange_WebServices_Data_AttributedStringCollection_Remove.htm)|
