# MakeViewTableControlUIExtension - класс
...
C# __Копировать
     public sealed class MakeViewTableControlUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class MakeViewTableControlUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class MakeViewTableControlUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type MakeViewTableControlUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ MakeViewTableControlUIExtension
##  __Конструкторы
[MakeViewTableControlUIExtension](M_Tessa_Extensions_Platform_Client_UI_TableViewExtension_MakeViewTableControlUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса MakeViewTableControlUIExtension  
---|---  
##  __Методы
...
(Унаследован от [CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm))  
[Initializing](M_Tessa_Extensions_Platform_Client_UI_TableViewExtension_MakeViewTableControlUIExtension_Initializing.htm)|  
(Переопределяет
