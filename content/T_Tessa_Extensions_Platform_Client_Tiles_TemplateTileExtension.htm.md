...
C# __Копировать
     public sealed class TemplateTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class TemplateTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class TemplateTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type TemplateTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ TemplateTileExtension
##  __Конструкторы
[TemplateTileExtension](M_Tessa_Extensions_Platform_Client_Tiles_TemplateTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса TemplateTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Platform_Client_Tiles_TemplateTileExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[InitializingLocal](M_Tessa_Extensions_Platform_Client_Tiles_TemplateTileExtension_InitializingLocal.htm)|  
(Переопределяет
