# RoleTypesMetadataExtension - класс
...
C# __Копировать
     public sealed class RoleTypesMetadataExtension : CardTypeMetadataExtension
VB __Копировать
     Public NotInheritable Class RoleTypesMetadataExtension
    	Inherits CardTypeMetadataExtension
C++ __Копировать
     public ref class RoleTypesMetadataExtension sealed : public CardTypeMetadataExtension
F# __Копировать
     [<SealedAttribute>]
    type RoleTypesMetadataExtension = 
        class
            inherit CardTypeMetadataExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardMetadataExtension](T_Tessa_Cards_Extensions_CardMetadataExtension.htm) __[CardTypeMetadataExtension](T_Tessa_Cards_Extensions_CardTypeMetadataExtension.htm) __ RoleTypesMetadataExtension
##  __Конструкторы
[RoleTypesMetadataExtension(IRoleTypePermissionsManager)](M_Tessa_Extensions_Platform_Shared_Roles_RoleTypesMetadataExtension__ctor_1.htm)|
Инициализирует новый экземпляр класса RoleTypesMetadataExtension  
---|---  
[RoleTypesMetadataExtension(ICardMetadata,
IRoleTypePermissionsManager)](M_Tessa_Extensions_Platform_Shared_Roles_RoleTypesMetadataExtension__ctor.htm)|
Инициализирует новый экземпляр класса RoleTypesMetadataExtension  
##  __Свойства
...
[ModifyTypes](M_Tessa_Extensions_Platform_Shared_Roles_RoleTypesMetadataExtension_ModifyTypes.htm)|  
(Переопределяет
