...
VB __Копировать
     Public Structure ProcessRef
    	Implements IEquatable(Of ProcessRef)
C++ __Копировать
     public value class ProcessRef : IEquatable<ProcessRef>
F# __Копировать
     [<SealedAttribute>]
    type ProcessRef = 
        struct
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) __ ProcessRef
Implements
    [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)<ProcessRef>
##  __Свойства
...
[GetHashCode](M_Chronos_Platform_Processes_ProcessRef_GetHashCode.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ToString](M_Chronos_Platform_Processes_ProcessRef_ToString.htm)|  Возвращает
