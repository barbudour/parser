# TaskSatelliteBackupExtension - класс
...
C# __Копировать
     public abstract class TaskSatelliteBackupExtension : MultitypeSatelliteBackupExtension
VB __Копировать
     Public MustInherit Class TaskSatelliteBackupExtension
    	Inherits MultitypeSatelliteBackupExtension
C++ __Копировать
     public ref class TaskSatelliteBackupExtension abstract : public MultitypeSatelliteBackupExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type TaskSatelliteBackupExtension = 
        class
            inherit MultitypeSatelliteBackupExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __[MultitypeSatelliteBackupExtension](T_Tessa_Cards_Extensions_Templates_MultitypeSatelliteBackupExtension.htm) __ TaskSatelliteBackupExtension
##  __Конструкторы
[TaskSatelliteBackupExtension](M_Tessa_Cards_Extensions_Templates_TaskSatelliteBackupExtension__ctor.htm)|
