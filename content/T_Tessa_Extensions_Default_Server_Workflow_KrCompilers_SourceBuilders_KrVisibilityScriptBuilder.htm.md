# KrVisibilityScriptBuilder - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrVisibilityScriptBuilder
    	Inherits KrSingleScriptBuilder(Of IVisibilitySources)
C++ __Копировать
     public ref class KrVisibilityScriptBuilder sealed : public KrSingleScriptBuilder<IVisibilitySources^>
F# __Копировать
     [<SealedAttribute>]
    type KrVisibilityScriptBuilder = 
        class
            inherit KrSingleScriptBuilder<IVisibilitySources>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[KrSourceBuilder](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_KrSourceBuilder_1.htm)<[IVisibilitySources](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_IVisibilitySources.htm)> __[KrSingleScriptBuilder](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_KrSingleScriptBuilder_1.htm)<[IVisibilitySources](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_IVisibilitySources.htm)> __ KrVisibilityScriptBuilder
##  __Конструкторы
[KrVisibilityScriptBuilder](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_KrVisibilityScriptBuilder__ctor.htm)|
Инициализирует новый экземпляр класса KrVisibilityScriptBuilder  
---|---  
##  __Свойства
...
(Унаследован от
[KrSourceBuilder<T>](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_KrSourceBuilder_1.htm))  
[ClassPrefix](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_KrVisibilityScriptBuilder_ClassPrefix.htm)|  
(Переопределяет
...
(Унаследован от
[KrSourceBuilder<T>](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_KrSourceBuilder_1.htm))  
[ErrorPrefix](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_KrVisibilityScriptBuilder_ErrorPrefix.htm)|  
(Переопределяет
...
(Унаследован от
[KrSourceBuilder<T>](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_KrSourceBuilder_1.htm))  
[MethodName](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_KrVisibilityScriptBuilder_MethodName.htm)|  
(Переопределяет
...
(Унаследован от
[KrSourceBuilder<T>](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_KrSourceBuilder_1.htm))  
[SetSources](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_KrVisibilityScriptBuilder_SetSources.htm)|
