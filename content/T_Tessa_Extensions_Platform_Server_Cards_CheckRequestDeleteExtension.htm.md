# CheckRequestDeleteExtension - класс
...
C# __Копировать
     public sealed class CheckRequestDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class CheckRequestDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class CheckRequestDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type CheckRequestDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ CheckRequestDeleteExtension
##  __Конструкторы
[CheckRequestDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_CheckRequestDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса CheckRequestDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_CheckRequestDeleteExtension_BeforeRequest.htm)|  
(Переопределяет
