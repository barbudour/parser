# CardTaskHistoryItem.CompletedByID - свойство
...
VB __Копировать
     Public Property CompletedByID As Guid?
    	Get
    	Set
C++ __Копировать
     public:
    property Nullable<Guid> CompletedByID {
    	Nullable<Guid> get ();
    	void set (Nullable<Guid> value);
    }
F# __Копировать
     member CompletedByID : Nullable<Guid> with get, set
#### Значение свойства
