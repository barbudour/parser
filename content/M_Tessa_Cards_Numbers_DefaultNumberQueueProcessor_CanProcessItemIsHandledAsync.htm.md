# DefaultNumberQueueProcessor.CanProcessItemIsHandledAsync - метод
...
C# __Копировать
     protected virtual Task<bool> CanProcessItemIsHandledAsync(
...
VB __Копировать
     Protected Overridable Function CanProcessItemIsHandledAsync ( 
...
C++ __Копировать
     protected:
    virtual Task<bool>^ CanProcessItemIsHandledAsync(
    	INumberObject^ number, 
    	INumberContext^ context, 
    	NumberQueue^ queue, 
    	NumberQueueItem^ queueItem, 
...
F# __Копировать
     abstract CanProcessItemIsHandledAsync : 
    ...
    *)
    -> Task<bool> 
    override CanProcessItemIsHandledAsync : 
            number : INumberObject * 
            context : INumberContext * 
            queue : NumberQueue * 
            queueItem : NumberQueueItem * 
