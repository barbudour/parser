...
##  __Конструкторы
[ClientAndConsoleRegistrator](M_Tessa_Extensions_Platform_Shared_Roles_ClientAndConsoleRegistrator__ctor.htm)|
...
в этом объекте.  
(Унаследован от [RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm))  
[RegisterUnity](M_Tessa_Extensions_Platform_Shared_Roles_ClientAndConsoleRegistrator_RegisterUnity.htm)|  
(Переопределяет
