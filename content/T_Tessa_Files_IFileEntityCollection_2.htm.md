# IFileEntityCollection<TItem, TCollection> \- интерфейс
...
C# __Копировать
     public interface IFileEntityCollection<TItem, out TCollection> : IObservableCollectionLookup<Guid, TItem, TCollection>, 
...
VB __Копировать
     Public Interface IFileEntityCollection(Of TItem As {Class, IFileEntity}, Out TCollection As {Class, Object, IFileEntityCollection(Of TItem, TCollection)})
    	Inherits IObservableCollectionLookup(Of Guid, TItem, TCollection), 
...
C++ __Копировать
    ...
    public interface class IFileEntityCollection : IObservableCollectionLookup<Guid, TItem, TCollection>, 
    	IObservableCollection<TItem, TCollection>, IList<TItem>, ICollection<TItem>, 
    	IEnumerable<TItem>, IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, 
    	ILookupContainer<Guid, TItem>, IControllableCollection<TItem>
F# __Копировать
     type IFileEntityCollection<'TItem, 'TCollection when 'TItem : not struct and IFileEntity when 'TCollection : not struct and Object and IFileEntityCollection<'TItem, 'TCollection>> = 
        interface
...
Implements
    [ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<TItem>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<TItem>, [IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<TItem>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.ienumerable), [INotifyCollectionChanged](https://learn.microsoft.com/dotnet/api/system.collections.specialized.inotifycollectionchanged), [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged), [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable), [IControllableCollection](T_Tessa_Platform_Collections_IControllableCollection_1.htm)<TItem>, [ILookupContainer](T_Tessa_Platform_Collections_ILookupContainer_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), TItem>, [IObservableCollection](T_Tessa_Platform_Collections_IObservableCollection_2.htm)<TItem, TCollection>, [IObservableCollectionLookup](T_Tessa_Platform_Collections_IObservableCollectionLookup_3.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), TItem, TCollection>
#### Параметры типа
TItem
