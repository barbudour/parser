# FullTextSearchServerInstanceGetExtension - класс
...
C# __Копировать
     public sealed class FullTextSearchServerInstanceGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class FullTextSearchServerInstanceGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class FullTextSearchServerInstanceGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type FullTextSearchServerInstanceGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ FullTextSearchServerInstanceGetExtension
##  __Конструкторы
[FullTextSearchServerInstanceGetExtension](M_Tessa_Extensions_Platform_Server_Forums_FullTextSearchServerInstanceGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса FullTextSearchServerInstanceGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Forums_FullTextSearchServerInstanceGetExtension_AfterRequest.htm)|  
(Переопределяет
