...
C# __Копировать
     public sealed class KrPermissionExtendedCardSettingsStorage : StorageObject, 
    	IKrPermissionExtendedCardSettings
VB __Копировать
     Public NotInheritable Class KrPermissionExtendedCardSettingsStorage
    	Inherits StorageObject
    	Implements IKrPermissionExtendedCardSettings
C++ __Копировать
     public ref class KrPermissionExtendedCardSettingsStorage sealed : public StorageObject, 
    	IKrPermissionExtendedCardSettings
F# __Копировать
     [<SealedAttribute>]
    type KrPermissionExtendedCardSettingsStorage = 
        class
            inherit StorageObject
            interface IKrPermissionExtendedCardSettings
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ KrPermissionExtendedCardSettingsStorage
Implements
...
Инициализирует новый экземпляр класса KrPermissionExtendedCardSettingsStorage  
---|---  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[GetCardSettings](M_Tessa_Extensions_Default_Shared_Workflow_KrPermissions_KrPermissionExtendedCardSettingsStorage_GetCardSettings.htm)|  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[GetFileSettings](M_Tessa_Extensions_Default_Shared_Workflow_KrPermissions_KrPermissionExtendedCardSettingsStorage_GetFileSettings.htm)|  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[GetTasksSettings](M_Tessa_Extensions_Default_Shared_Workflow_KrPermissions_KrPermissionExtendedCardSettingsStorage_GetTasksSettings.htm)|  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetVisibilitySettings](M_Tessa_Extensions_Default_Shared_Workflow_KrPermissions_KrPermissionExtendedCardSettingsStorage_GetVisibilitySettings.htm)|  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[SetCardAccess](M_Tessa_Extensions_Default_Shared_Workflow_KrPermissions_KrPermissionExtendedCardSettingsStorage_SetCardAccess.htm)|  
