# CleanupFieldsCardUIExtension - класс
...
C# __Копировать
     public class CleanupFieldsCardUIExtension : CardUIExtension
VB __Копировать
     Public Class CleanupFieldsCardUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class CleanupFieldsCardUIExtension : public CardUIExtension
F# __Копировать
     type CleanupFieldsCardUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ CleanupFieldsCardUIExtension
##  __Конструкторы
[CleanupFieldsCardUIExtension](M_Tessa_Extensions_Platform_Client_UI_CleanupFields_CleanupFieldsCardUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса CleanupFieldsCardUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Finalized](M_Tessa_Extensions_Platform_Client_UI_CleanupFields_CleanupFieldsCardUIExtension_Finalized.htm)|  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_CleanupFields_CleanupFieldsCardUIExtension_Initialized.htm)|  
(Переопределяет
