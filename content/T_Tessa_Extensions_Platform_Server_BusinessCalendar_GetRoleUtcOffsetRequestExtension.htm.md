# GetRoleUtcOffsetRequestExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.BusinessCalendar](N_Tessa_Extensions_Platform_Server_BusinessCalendar.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class GetRoleUtcOffsetRequestExtension : CardRequestExtension
VB __Копировать
     Public Class GetRoleUtcOffsetRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class GetRoleUtcOffsetRequestExtension : public CardRequestExtension
F# __Копировать
     type GetRoleUtcOffsetRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ GetRoleUtcOffsetRequestExtension
##  __Конструкторы
[GetRoleUtcOffsetRequestExtension](M_Tessa_Extensions_Platform_Server_BusinessCalendar_GetRoleUtcOffsetRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса GetRoleUtcOffsetRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_BusinessCalendar_GetRoleUtcOffsetRequestExtension_AfterRequest.htm)|  
(Переопределяет
