...
VB __Копировать
     Public NotInheritable Class KrProcessRunnerProvider
    	Implements IKrProcessRunnerProvider
C++ __Копировать
     public ref class KrProcessRunnerProvider sealed : IKrProcessRunnerProvider
F# __Копировать
     [<SealedAttribute>]
    type KrProcessRunnerProvider = 
        class
            interface IKrProcessRunnerProvider
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ KrProcessRunnerProvider
Implements
    [IKrProcessRunnerProvider](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_IKrProcessRunnerProvider.htm)
##  __Конструкторы
[KrProcessRunnerProvider](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_KrProcessRunnerProvider__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetRunner](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_KrProcessRunnerProvider_GetRunner.htm)|
Возвращает
[IKrProcessRunner](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_IKrProcessRunner.htm).  
