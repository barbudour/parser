...
C# __Копировать
     public sealed class CardStoreComponent : ICardStoreComponent
VB __Копировать
     Public NotInheritable Class CardStoreComponent
    	Implements ICardStoreComponent
C++ __Копировать
     public ref class CardStoreComponent sealed : ICardStoreComponent
F# __Копировать
     [<SealedAttribute>]
    type CardStoreComponent = 
        class
            interface ICardStoreComponent
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardStoreComponent
Implements
    [ICardStoreComponent](T_Tessa_Cards_ComponentModel_ICardStoreComponent.htm)
##  __Конструкторы
[CardStoreComponent](M_Tessa_Cards_ComponentModel_CardStoreComponent__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[StoreAsync](M_Tessa_Cards_ComponentModel_CardStoreComponent_StoreAsync.htm)|
