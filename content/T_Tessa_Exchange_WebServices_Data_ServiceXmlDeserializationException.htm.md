# ServiceXmlDeserializationException - класс
...
C++ __Копировать
     public ref class ServiceXmlDeserializationException sealed : public ServiceLocalException
F# __Копировать
     [<SealedAttribute>]
    type ServiceXmlDeserializationException = 
        class
            inherit ServiceLocalException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceLocalException](T_Tessa_Exchange_WebServices_Data_ServiceLocalException.htm) __ ServiceXmlDeserializationException
##  __Конструкторы
[ServiceXmlDeserializationException()](M_Tessa_Exchange_WebServices_Data_ServiceXmlDeserializationException__ctor.htm)|
ServiceXmlDeserializationException Constructor.  
---|---  
[ServiceXmlDeserializationException(String)](M_Tessa_Exchange_WebServices_Data_ServiceXmlDeserializationException__ctor_1.htm)|
ServiceXmlDeserializationException Constructor.  
[ServiceXmlDeserializationException(String,
Exception)](M_Tessa_Exchange_WebServices_Data_ServiceXmlDeserializationException__ctor_2.htm)|
ServiceXmlDeserializationException Constructor.  
## __Свойства
