# WorkflowTileExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.Tiles](N_Tessa_Extensions_Platform_Client_Tiles.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public class WorkflowTileExtension : TileExtension
VB __Копировать
     Public Class WorkflowTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class WorkflowTileExtension : public TileExtension
F# __Копировать
     type WorkflowTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ WorkflowTileExtension
##  __Конструкторы
[WorkflowTileExtension](M_Tessa_Extensions_Platform_Client_Tiles_WorkflowTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Platform_Client_Tiles_WorkflowTileExtension_InitializingGlobal.htm)|  
(Переопределяет
