# NumberDigestRequestExtension - класс
...
C# __Копировать
     public sealed class NumberDigestRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class NumberDigestRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class NumberDigestRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type NumberDigestRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ NumberDigestRequestExtension
##  __Конструкторы
[NumberDigestRequestExtension](M_Tessa_Extensions_Platform_Shared_Numbers_NumberDigestRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса NumberDigestRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Shared_Numbers_NumberDigestRequestExtension_AfterRequest.htm)|  
(Переопределяет
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Platform.Shared.Numbers - пространство
имён](N_Tessa_Extensions_Platform_Shared_Numbers.htm)
