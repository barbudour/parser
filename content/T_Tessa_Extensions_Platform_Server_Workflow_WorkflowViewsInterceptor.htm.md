# WorkflowViewsInterceptor - класс
...
C# __Копировать
     public sealed class WorkflowViewsInterceptor : ViewInterceptorBase
VB __Копировать
     Public NotInheritable Class WorkflowViewsInterceptor
    	Inherits ViewInterceptorBase
C++ __Копировать
     public ref class WorkflowViewsInterceptor sealed : public ViewInterceptorBase
F# __Копировать
     [<SealedAttribute>]
    type WorkflowViewsInterceptor = 
        class
            inherit ViewInterceptorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ViewInterceptorBase](T_Tessa_Views_ViewInterceptorBase.htm) __ WorkflowViewsInterceptor
##  __Конструкторы
[WorkflowViewsInterceptor](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowViewsInterceptor__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowViewsInterceptor  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetDataAsync](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowViewsInterceptor_GetDataAsync.htm)|
