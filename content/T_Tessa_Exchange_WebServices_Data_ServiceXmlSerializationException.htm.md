# ServiceXmlSerializationException - класс
...
C++ __Копировать
     public ref class ServiceXmlSerializationException : public ServiceLocalException
F# __Копировать
     type ServiceXmlSerializationException = 
        class
            inherit ServiceLocalException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceLocalException](T_Tessa_Exchange_WebServices_Data_ServiceLocalException.htm) __ ServiceXmlSerializationException
##  __Конструкторы
[ServiceXmlSerializationException()](M_Tessa_Exchange_WebServices_Data_ServiceXmlSerializationException__ctor.htm)|
ServiceXmlSerializationException Constructor.  
---|---  
[ServiceXmlSerializationException(String)](M_Tessa_Exchange_WebServices_Data_ServiceXmlSerializationException__ctor_2.htm)|
ServiceXmlSerializationException Constructor.  
[ServiceXmlSerializationException(SerializationInfo,
StreamingContext)](M_Tessa_Exchange_WebServices_Data_ServiceXmlSerializationException__ctor_1.htm)|
Initializes a new instance of the ServiceXmlSerializationException class with
serialized data.  
[ServiceXmlSerializationException(String,
Exception)](M_Tessa_Exchange_WebServices_Data_ServiceXmlSerializationException__ctor_3.htm)|
ServiceXmlSerializationException Constructor.  
## __Свойства
