# FileConverterCacheGetExtension - класс
...
C# __Копировать
     public sealed class FileConverterCacheGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class FileConverterCacheGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class FileConverterCacheGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type FileConverterCacheGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ FileConverterCacheGetExtension
##  __Конструкторы
[FileConverterCacheGetExtension](M_Tessa_Extensions_Platform_Server_Cards_FileConverterCacheGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса FileConverterCacheGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_FileConverterCacheGetExtension_AfterRequest.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_FileConverterCacheGetExtension_BeforeRequest.htm)|  
(Переопределяет
