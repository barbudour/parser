# SchemeObjectNotFoundException - класс
##  __Definition
 **Пространство имён:** [Tessa.Scheme](N_Tessa_Scheme.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public class SchemeObjectNotFoundException : SchemeException
VB __Копировать
    <SerializableAttribute>
    Public Class SchemeObjectNotFoundException
    	Inherits SchemeException
C++ __Копировать
    [SerializableAttribute]
    public ref class SchemeObjectNotFoundException : public SchemeException
F# __Копировать
     [<SerializableAttribute>]
    type SchemeObjectNotFoundException = 
        class
            inherit SchemeException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[SchemeException](T_Tessa_Scheme_SchemeException.htm) __ SchemeObjectNotFoundException
##  __Конструкторы
[SchemeObjectNotFoundException(Guid,
String)](M_Tessa_Scheme_SchemeObjectNotFoundException__ctor.htm)|
Инициализирует новый экземпляр класса SchemeObjectNotFoundException  
---|---  
[SchemeObjectNotFoundException(SerializationInfo,
StreamingContext)](M_Tessa_Scheme_SchemeObjectNotFoundException__ctor_1.htm)|
Инициализирует новый экземпляр класса SchemeObjectNotFoundException  
[SchemeObjectNotFoundException(String, Guid,
String)](M_Tessa_Scheme_SchemeObjectNotFoundException__ctor_2.htm)|
Инициализирует новый экземпляр класса SchemeObjectNotFoundException  
[SchemeObjectNotFoundException(String, Guid, String,
Exception)](M_Tessa_Scheme_SchemeObjectNotFoundException__ctor_3.htm)|
Инициализирует новый экземпляр класса SchemeObjectNotFoundException  
##  __Свойства
...
(Унаследован от
[Exception](https://learn.microsoft.com/dotnet/api/system.exception))  
[ObjectId](P_Tessa_Scheme_SchemeObjectNotFoundException_ObjectId.htm)|  
[ObjectName](P_Tessa_Scheme_SchemeObjectNotFoundException_ObjectName.htm)|  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Scheme_SchemeObjectNotFoundException_GetObjectData.htm)|  
