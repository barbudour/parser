...
VB __Копировать
    <RegistratorAttribute(ExtensionStage.AfterPlatform, Type := SessionType.Client, 
    	Tag := RegistratorTag.ConsoleClient)>
    Public NotInheritable Class ConsoleRegistrator
    	Inherits RegistratorBase
C++ __Копировать
    [RegistratorAttribute(ExtensionStage::AfterPlatform, Type = SessionType::Client, 
    	Tag = RegistratorTag::ConsoleClient)]
    public ref class ConsoleRegistrator sealed : public RegistratorBase
F# __Копировать
     [<SealedAttribute>]
    [<RegistratorAttribute(ExtensionStage.AfterPlatform, Type = SessionType.Client, 
    	Tag = RegistratorTag.ConsoleClient)>]
    type ConsoleRegistrator = 
        class
            inherit RegistratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm) __ ConsoleRegistrator
##  __Конструкторы
[ConsoleRegistrator](M_Tessa_Extensions_Default_Shared_Initialization_ConsoleRegistrator__ctor.htm)|
Инициализирует новый экземпляр класса ConsoleRegistrator  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterExtensions](M_Tessa_Extensions_Default_Shared_Initialization_ConsoleRegistrator_RegisterExtensions.htm)|  
(Переопределяет
[RegistratorBase.RegisterExtensions(IExtensionContainer)](M_Tessa_Extensions_RegistratorBase_RegisterExtensions.htm))  
[RegisterUnity](M_Tessa_Extensions_Default_Shared_Initialization_ConsoleRegistrator_RegisterUnity.htm)|  
(Переопределяет
