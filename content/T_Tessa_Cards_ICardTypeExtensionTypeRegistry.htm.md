# ICardTypeExtensionTypeRegistry - интерфейс
...
C# __Копировать
     public interface ICardTypeExtensionTypeRegistry : IRegistry<Guid, CardTypeExtensionType>
VB __Копировать
     Public Interface ICardTypeExtensionTypeRegistry
    	Inherits IRegistry(Of Guid, CardTypeExtensionType)
C++ __Копировать
     public interface class ICardTypeExtensionTypeRegistry : IRegistry<Guid, CardTypeExtensionType^>
F# __Копировать
     type ICardTypeExtensionTypeRegistry = 
        interface
            interface IRegistry<Guid, CardTypeExtensionType>
        end
Implements
    [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [CardTypeExtensionType](T_Tessa_Cards_CardTypeExtensionType.htm)>
##  __Методы
