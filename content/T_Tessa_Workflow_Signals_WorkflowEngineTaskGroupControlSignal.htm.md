# WorkflowEngineTaskGroupControlSignal - класс
##  __Definition
 **Пространство имён:** [Tessa.Workflow.Signals](N_Tessa_Workflow_Signals.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class WorkflowEngineTaskGroupControlSignal : WorkflowEngineSignal
VB __Копировать
     Public NotInheritable Class WorkflowEngineTaskGroupControlSignal
    	Inherits WorkflowEngineSignal
C++ __Копировать
     public ref class WorkflowEngineTaskGroupControlSignal sealed : public WorkflowEngineSignal
F# __Копировать
     [<SealedAttribute>]
    type WorkflowEngineTaskGroupControlSignal = 
        class
            inherit WorkflowEngineSignal
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowEngineSignal](T_Tessa_Workflow_Signals_WorkflowEngineSignal.htm) __ WorkflowEngineTaskGroupControlSignal
##  __Конструкторы
[WorkflowEngineTaskGroupControlSignal()](M_Tessa_Workflow_Signals_WorkflowEngineTaskGroupControlSignal__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowEngineTaskGroupControlSignal  
---|---  
[WorkflowEngineTaskGroupControlSignal(Dictionary<String,
Object>)](M_Tessa_Workflow_Signals_WorkflowEngineTaskGroupControlSignal__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowEngineTaskGroupControlSignal  
##  __Свойства
[CancelGroup](P_Tessa_Workflow_Signals_WorkflowEngineTaskGroupControlSignal_CancelGroup.htm)|  
---|---  
[CancelOptionID](P_Tessa_Workflow_Signals_WorkflowEngineTaskGroupControlSignal_CancelOptionID.htm)|  
...
(Унаследован от
[WorkflowEngineSignal](T_Tessa_Workflow_Signals_WorkflowEngineSignal.htm))  
[NextRoles](P_Tessa_Workflow_Signals_WorkflowEngineTaskGroupControlSignal_NextRoles.htm)|  
[PauseGroup](P_Tessa_Workflow_Signals_WorkflowEngineTaskGroupControlSignal_PauseGroup.htm)|  
[ResumeGroup](P_Tessa_Workflow_Signals_WorkflowEngineTaskGroupControlSignal_ResumeGroup.htm)|  
[Type](P_Tessa_Workflow_Signals_WorkflowEngineSignal_Type.htm)|  Вид
передаваемого сигнала  
(Унаследован от
[WorkflowEngineSignal](T_Tessa_Workflow_Signals_WorkflowEngineSignal.htm))  
[UseAsNextRole](P_Tessa_Workflow_Signals_WorkflowEngineTaskGroupControlSignal_UseAsNextRole.htm)|  
## __Методы
