...
C# __Копировать
     public sealed class SetDigestStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class SetDigestStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class SetDigestStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type SetDigestStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ SetDigestStoreExtension
##  __Конструкторы
[SetDigestStoreExtension](M_Tessa_Extensions_Platform_Client_Cards_SetDigestStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса SetDigestStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Client_Cards_SetDigestStoreExtension_BeforeRequest.htm)|  
(Переопределяет
