# CardTaskDialogUIExtension - класс
...
C# __Копировать
     public sealed class CardTaskDialogUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class CardTaskDialogUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class CardTaskDialogUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type CardTaskDialogUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ CardTaskDialogUIExtension
##  __Конструкторы
[CardTaskDialogUIExtension](M_Tessa_Extensions_Platform_Client_UI_CardTaskDialogUIExtension__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_CardTaskDialogUIExtension_Initialized.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Reopened](M_Tessa_Extensions_Platform_Client_UI_CardTaskDialogUIExtension_Reopened.htm)|
...
(Переопределяет
[CardUIExtension.Reopened(ICardUIExtensionContext)](M_Tessa_UI_Cards_CardUIExtension_Reopened.htm))  
...
(Унаследован от [CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm))  
[Saving](M_Tessa_Extensions_Platform_Client_UI_CardTaskDialogUIExtension_Saving.htm)|
