# CardPermissionsGetExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class CardPermissionsGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class CardPermissionsGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class CardPermissionsGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type CardPermissionsGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ CardPermissionsGetExtension
##  __Конструкторы
[CardPermissionsGetExtension](M_Tessa_Extensions_Default_Server_Cards_CardPermissionsGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса CardPermissionsGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Cards_CardPermissionsGetExtension_AfterRequest.htm)|  
(Переопределяет
