...
VB __Копировать
     Public Class ServiceLocalException
    	Inherits Exception
C++ __Копировать
     public ref class ServiceLocalException : public Exception
F# __Копировать
     type ServiceLocalException = 
        class
            inherit Exception
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __ ServiceLocalException
Derived
[Tessa.Exchange.WebServices.Data.AutodiscoverLocalException](T_Tessa_Exchange_WebServices_Data_AutodiscoverLocalException.htm)
[Tessa.Exchange.WebServices.Data.PropertyException](T_Tessa_Exchange_WebServices_Data_PropertyException.htm)
[Tessa.Exchange.WebServices.Data.ServiceValidationException](T_Tessa_Exchange_WebServices_Data_ServiceValidationException.htm)
[Tessa.Exchange.WebServices.Data.ServiceVersionException](T_Tessa_Exchange_WebServices_Data_ServiceVersionException.htm)
[Tessa.Exchange.WebServices.Data.ServiceXmlDeserializationException](T_Tessa_Exchange_WebServices_Data_ServiceXmlDeserializationException.htm)
[Tessa.Exchange.WebServices.Data.ServiceXmlSerializationException](T_Tessa_Exchange_WebServices_Data_ServiceXmlSerializationException.htm)
[Tessa.Exchange.WebServices.Data.TimeZoneConversionException](T_Tessa_Exchange_WebServices_Data_TimeZoneConversionException.htm)
Подробнее __Less __
##  __Конструкторы
[ServiceLocalException()](M_Tessa_Exchange_WebServices_Data_ServiceLocalException__ctor.htm)|
ServiceLocalException Constructor.  
---|---  
[ServiceLocalException(String)](M_Tessa_Exchange_WebServices_Data_ServiceLocalException__ctor_2.htm)|
ServiceLocalException Constructor.  
[ServiceLocalException(SerializationInfo,
StreamingContext)](M_Tessa_Exchange_WebServices_Data_ServiceLocalException__ctor_1.htm)|
Initializes a new instance of the ServiceLocalException class with serialized
data.  
[ServiceLocalException(String,
Exception)](M_Tessa_Exchange_WebServices_Data_ServiceLocalException__ctor_3.htm)|
ServiceLocalException Constructor.  
## __Свойства
