# CAdESSignatureHelper.GetToBeSignedInfo - метод
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public static byte[] GetToBeSignedInfo(
    	CardResponse response
    )
VB __Копировать
     Public Shared Function GetToBeSignedInfo ( 
    	response As CardResponse
    ) As Byte()
C++ __Копировать
     public:
    static array<unsigned char>^ GetToBeSignedInfo(
    	CardResponse^ response
    )
F# __Копировать
     static member GetToBeSignedInfo : 
