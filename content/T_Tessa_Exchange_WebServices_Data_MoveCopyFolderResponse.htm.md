...
C++ __Копировать
     public ref class MoveCopyFolderResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
    type MoveCopyFolderResponse = 
        class
            inherit ServiceResponse
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ MoveCopyFolderResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[Folder](P_Tessa_Exchange_WebServices_Data_MoveCopyFolderResponse_Folder.htm)|
