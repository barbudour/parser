...
##  __Конструкторы
[SequenceGetExtension](M_Tessa_Extensions_Platform_Server_Cards_SequenceGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса SequenceGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_SequenceGetExtension_AfterRequest.htm)|  
(Переопределяет
