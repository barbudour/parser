...
C# __Копировать
     public sealed class NumberDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class NumberDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class NumberDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type NumberDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ NumberDeleteExtension
##  __Конструкторы
[NumberDeleteExtension](M_Tessa_Extensions_Platform_Server_Numbers_NumberDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса NumberDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Numbers_NumberDeleteExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Numbers_NumberDeleteExtension_BeforeRequest.htm)|  
(Переопределяет
