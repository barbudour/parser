...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ WorkflowStoreExtension
Derived
[Tessa.Extensions.Default.Server.Workflow.KrWorkflowStoreExtension](T_Tessa_Extensions_Default_Server_Workflow_KrWorkflowStoreExtension.htm)
[Tessa.Extensions.Default.Server.Workflow.Wf.WfWorkflowStoreExtension](T_Tessa_Extensions_Default_Server_Workflow_Wf_WfWorkflowStoreExtension.htm)
[Tessa.Extensions.Platform.Server.Workflow.WorkflowEngineStoreExtension](T_Tessa_Extensions_Platform_Server_Workflow_WorkflowEngineStoreExtension.htm)
##  __Конструкторы
[WorkflowStoreExtension](M_Tessa_Cards_Workflow_WorkflowStoreExtension__ctor.htm)|
