# AccessGetFileContentExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Cards](N_Tessa_Extensions_Platform_Server_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class AccessGetFileContentExtension : CardGetFileContentExtension
VB __Копировать
     Public NotInheritable Class AccessGetFileContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class AccessGetFileContentExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type AccessGetFileContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ AccessGetFileContentExtension
##  __Конструкторы
[AccessGetFileContentExtension](M_Tessa_Extensions_Platform_Server_Cards_AccessGetFileContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса AccessGetFileContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_AccessGetFileContentExtension_BeforeRequest.htm)|  
(Переопределяет
