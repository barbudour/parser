# KrCheckStageRowModifiedStoreExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrCheckStageRowModifiedStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class KrCheckStageRowModifiedStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type KrCheckStageRowModifiedStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ KrCheckStageRowModifiedStoreExtension
##  __Конструкторы
[KrCheckStageRowModifiedStoreExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrCheckStageRowModifiedStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrCheckStageRowModifiedStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrCheckStageRowModifiedStoreExtension_AfterBeginTransaction.htm)|
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrCheckStageRowModifiedStoreExtension_BeforeCommitTransaction.htm)|
