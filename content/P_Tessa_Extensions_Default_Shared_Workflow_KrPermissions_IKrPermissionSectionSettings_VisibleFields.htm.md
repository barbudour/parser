# IKrPermissionSectionSettings.VisibleFields - свойство
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Property VisibleFields As IReadOnlyCollection(Of Guid)
    	Get
    	Set
C++ __Копировать
    property IReadOnlyCollection<Guid>^ VisibleFields {
    	IReadOnlyCollection<Guid>^ get ();
    	void set (IReadOnlyCollection<Guid>^ value);
    }
F# __Копировать
     abstract VisibleFields : IReadOnlyCollection<Guid> with get, set
#### Значение свойства
