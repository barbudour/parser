# ServerKrPermissionsGetFileContentExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class ServerKrPermissionsGetFileContentExtension : CardGetFileContentExtension
VB __Копировать
     Public NotInheritable Class ServerKrPermissionsGetFileContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class ServerKrPermissionsGetFileContentExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type ServerKrPermissionsGetFileContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ ServerKrPermissionsGetFileContentExtension
##  __Конструкторы
[ServerKrPermissionsGetFileContentExtension](M_Tessa_Extensions_Default_Server_Files_ServerKrPermissionsGetFileContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса
ServerKrPermissionsGetFileContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Files_ServerKrPermissionsGetFileContentExtension_BeforeRequest.htm)|  
(Переопределяет
