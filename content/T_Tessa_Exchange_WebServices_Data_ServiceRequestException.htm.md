...
C++ __Копировать
     public ref class ServiceRequestException : public ServiceRemoteException
F# __Копировать
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceRemoteException](T_Tessa_Exchange_WebServices_Data_ServiceRemoteException.htm) __ ServiceRequestException
##  __Конструкторы
[ServiceRequestException()](M_Tessa_Exchange_WebServices_Data_ServiceRequestException__ctor.htm)|
ServiceRequestException Constructor.  
---|---  
[ServiceRequestException(String)](M_Tessa_Exchange_WebServices_Data_ServiceRequestException__ctor_2.htm)|
ServiceRequestException Constructor.  
[ServiceRequestException(SerializationInfo,
StreamingContext)](M_Tessa_Exchange_WebServices_Data_ServiceRequestException__ctor_1.htm)|
Initializes a new instance of the ServiceRequestException class with
serialized data.  
[ServiceRequestException(String,
Exception)](M_Tessa_Exchange_WebServices_Data_ServiceRequestException__ctor_3.htm)|
ServiceRequestException Constructor.  
## __Свойства
