# TemplateCardNewExtension - класс
...
C# __Копировать
     public sealed class TemplateCardNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class TemplateCardNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class TemplateCardNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type TemplateCardNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ TemplateCardNewExtension
##  __Конструкторы
[TemplateCardNewExtension](M_Tessa_Extensions_Platform_Server_Cards_TemplateCardNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса TemplateCardNewExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_TemplateCardNewExtension_BeforeRequest.htm)|  
(Переопределяет
