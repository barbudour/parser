# CardTypeCompletionOption - класс
...
C# __Копировать
    ...
    public sealed class CardTypeCompletionOption : CardSerializableObject, 
    	IEquatable<CardTypeCompletionOption>, ICardMetadataOrderable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardTypeCompletionOption
    	Inherits CardSerializableObject
    	Implements IEquatable(Of CardTypeCompletionOption), ICardMetadataOrderable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTypeCompletionOption sealed : public CardSerializableObject, 
    	IEquatable<CardTypeCompletionOption^>, ICardMetadataOrderable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardTypeCompletionOption = 
        class
            inherit CardSerializableObject
            interface IEquatable<CardTypeCompletionOption>
            interface ICardMetadataOrderable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __ CardTypeCompletionOption
Implements
    [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)<CardTypeCompletionOption>, [ICardMetadataOrderable](T_Tessa_Cards_ICardMetadataOrderable.htm)
##  __Конструкторы
[CardTypeCompletionOption](M_Tessa_Cards_CardTypeCompletionOption__ctor.htm)|
Создаёт экземпляр класса с параметрами по умолчанию.  
---|---  
##  __Свойства
[Flags](P_Tessa_Cards_CardTypeCompletionOption_Flags.htm)|  Флаги варианта
завершения.  
---|---  
[FormName](P_Tessa_Cards_CardTypeCompletionOption_FormName.htm)|  Имя формы,
которая выводится для варианта завершения, или null, если выводится форма,
...
[Order](P_Tessa_Cards_CardTypeCompletionOption_Order.htm)|  Порядок
отображения варианта завершения в интерфейсе карточки.  
[Reference](P_Tessa_Cards_CardSerializableObject_Reference.htm)|  Имя
глобального объекта, на который ссылается данный объект.  
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[TypeID](P_Tessa_Cards_CardTypeCompletionOption_TypeID.htm)|  Идентификатор
варианта завершения.  
[Validators](P_Tessa_Cards_CardTypeCompletionOption_Validators.htm)|  Список
валидаторов, используемых для варианта завершения.  
[XmlElementNameInternal](P_Tessa_Cards_CardTypeCompletionOption_XmlElementNameInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeAttributeFromXml](M_Tessa_Cards_CardTypeCompletionOption_DeserializeAttributeFromXml.htm)|
...
[DeserializeChildrenFromBinaryInternal](M_Tessa_Cards_CardTypeCompletionOption_DeserializeChildrenFromBinaryInternal.htm)|
...
[DeserializeElementFromXml](M_Tessa_Cards_CardTypeCompletionOption_DeserializeElementFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_CardTypeCompletionOption_DeserializeFromBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_CardTypeCompletionOption_DeserializeFromStorageInternal.htm)|
...
[GetHashCode](M_Tessa_Cards_CardTypeCompletionOption_GetHashCode.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetValidationName](M_Tessa_Cards_CardTypeCompletionOption_GetValidationName.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_CardTypeCompletionOption_OnDeserializing.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SealInternal](M_Tessa_Cards_CardTypeCompletionOption_SealInternal.htm)|
Защищает объект от изменений.
Метод может быть переопределён в классах-наследниках.
(Переопределяет
[CardSerializableObject.SealInternal()](M_Tessa_Cards_CardSerializableObject_SealInternal.htm))  
[SerializeAttributesToXml](M_Tessa_Cards_CardTypeCompletionOption_SerializeAttributesToXml.htm)|
...
[SerializeChildrenToBinaryInternal](M_Tessa_Cards_CardTypeCompletionOption_SerializeChildrenToBinaryInternal.htm)|
...
[SerializeElementsToXml](M_Tessa_Cards_CardTypeCompletionOption_SerializeElementsToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_CardTypeCompletionOption_SerializeToBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_CardTypeCompletionOption_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
...
(Унаследован от
[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardTypeCompletionOption_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
...
##  __Поля
[XmlElementName](F_Tessa_Cards_CardTypeCompletionOption_XmlElementName.htm)|
Имя XML-элемента.  
---|---  
## __Методы расширения
...
---|---  
[GetID](M_Tessa_Cards_CardExtensions_GetID.htm)|  Получить уникальный
идентификатор объекта на основе хэш-кода его типа и настроек.  
...
(Определяется
[ComHelper](T_Tessa_Extensions_Default_Client_EDS_ComHelper.htm))  
[MakeGlobal](M_Tessa_Cards_CardExtensions_MakeGlobal_7.htm)|  Сделать
