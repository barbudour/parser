# KrConstants.KrDialogStageTypeSettingsVirtual.DialogName - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly DialogName As String
C++ __Копировать
     public:
    static initonly String^ DialogName
F# __Копировать
     static val DialogName: string
#### Значение поля
