...
C# __Копировать
     public sealed class LicenseNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class LicenseNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class LicenseNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type LicenseNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ LicenseNewExtension
##  __Конструкторы
[LicenseNewExtension](M_Tessa_Extensions_Platform_Server_Cards_LicenseNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса LicenseNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_LicenseNewExtension_AfterRequest.htm)|  
(Переопределяет
