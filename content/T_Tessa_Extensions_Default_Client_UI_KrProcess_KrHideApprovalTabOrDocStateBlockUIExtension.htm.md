# KrHideApprovalTabOrDocStateBlockUIExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrHideApprovalTabOrDocStateBlockUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrHideApprovalTabOrDocStateBlockUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrHideApprovalTabOrDocStateBlockUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrHideApprovalTabOrDocStateBlockUIExtension
##  __Конструкторы
[KrHideApprovalTabOrDocStateBlockUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrHideApprovalTabOrDocStateBlockUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса
KrHideApprovalTabOrDocStateBlockUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrHideApprovalTabOrDocStateBlockUIExtension_Initialized.htm)|  
(Переопределяет
