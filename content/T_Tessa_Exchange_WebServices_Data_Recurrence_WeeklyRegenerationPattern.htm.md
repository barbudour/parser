# Recurrence.WeeklyRegenerationPattern - класс
...
VB __Копировать
     Public NotInheritable Class WeeklyRegenerationPattern
    	Inherits Recurrence.IntervalPattern
C++ __Копировать
     public ref class WeeklyRegenerationPattern sealed : public Recurrence.IntervalPattern
F# __Копировать
     [<SealedAttribute>]
    type WeeklyRegenerationPattern = 
        class
            inherit Recurrence.IntervalPattern
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[Recurrence](T_Tessa_Exchange_WebServices_Data_Recurrence.htm) __[Recurrence.IntervalPattern](T_Tessa_Exchange_WebServices_Data_Recurrence_IntervalPattern.htm) __ Recurrence.WeeklyRegenerationPattern
##  __Конструкторы
[Recurrence.WeeklyRegenerationPattern()](M_Tessa_Exchange_WebServices_Data_Recurrence_WeeklyRegenerationPattern__ctor.htm)|
Initializes a new instance of the Recurrence.WeeklyRegenerationPattern class.  
---|---  
[Recurrence.WeeklyRegenerationPattern(DateTime,
Int32)](M_Tessa_Exchange_WebServices_Data_Recurrence_WeeklyRegenerationPattern__ctor_1.htm)|
Initializes a new instance of the Recurrence.WeeklyRegenerationPattern class.  
## __Свойства
