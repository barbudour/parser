...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ SourceProviderBase
Derived
[Tessa.Platform.SourceProviders.AssemblySourceProviderBase](T_Tessa_Platform_SourceProviders_AssemblySourceProviderBase.htm)
[Tessa.Platform.SourceProviders.FileSourceProviderBase](T_Tessa_Platform_SourceProviders_FileSourceProviderBase.htm)
Implements
    [ISourceProviderBase](T_Tessa_Platform_SourceProviders_ISourceProviderBase.htm)
##  __Конструкторы
[SourceProviderBase](M_Tessa_Platform_SourceProviders_SourceProviderBase__ctor.htm)|
Инициализирует новый экземпляр класса SourceProviderBase  
---|---  
##  __Свойства
