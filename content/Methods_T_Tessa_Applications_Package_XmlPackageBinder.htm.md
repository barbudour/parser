# XmlPackageBinder - методы
##  __Методы
[BindAsync](M_Tessa_Applications_Package_XmlPackageBinder_BindAsync.htm)|
...
[FileSource](M_Tessa_Applications_Package_XmlPackageBinder_FileSource.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Source](M_Tessa_Applications_Package_XmlPackageBinder_Source.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[WithFiles](M_Tessa_Applications_Package_XmlPackageBinder_WithFiles.htm)|
Устанавливает признак необходимости выполнения загрузки фактической информации
о файлах.  
[WithFilesFromPackage](M_Tessa_Applications_Package_XmlPackageBinder_WithFilesFromPackage.htm)|
