# IFileSignatureCollection - интерфейс
Коллекция подписей для версии файла.
## __Definition
 **Пространство имён:** [Tessa.Files](N_Tessa_Files.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public interface IFileSignatureCollection : IFileSignatureCollectionBase<IFileSignatureCollection>, 
    	IFileEntityCollection<IFileSignature, IFileSignatureCollection>, IObservableCollectionLookup<Guid, IFileSignature, IFileSignatureCollection>, 
    	IObservableCollection<IFileSignature, IFileSignatureCollection>, IList<IFileSignature>, 
...
VB __Копировать
     Public Interface IFileSignatureCollection
    	Inherits IFileSignatureCollectionBase(Of IFileSignatureCollection), IFileEntityCollection(Of IFileSignature, IFileSignatureCollection), 
    	IObservableCollectionLookup(Of Guid, IFileSignature, IFileSignatureCollection), IObservableCollection(Of IFileSignature, IFileSignatureCollection), 
...
C++ __Копировать
     public interface class IFileSignatureCollection : IFileSignatureCollectionBase<IFileSignatureCollection^>, 
    	IFileEntityCollection<IFileSignature^, IFileSignatureCollection^>, IObservableCollectionLookup<Guid, IFileSignature^, IFileSignatureCollection^>, 
    	IObservableCollection<IFileSignature^, IFileSignatureCollection^>, IList<IFileSignature^>, 
    	ICollection<IFileSignature^>, IEnumerable<IFileSignature^>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer<Guid, IFileSignature^>, 
