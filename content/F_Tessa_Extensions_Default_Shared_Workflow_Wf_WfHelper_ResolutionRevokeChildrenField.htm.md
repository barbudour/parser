# WfHelper.ResolutionRevokeChildrenField - поле
...
VB __Копировать
     Public Const ResolutionRevokeChildrenField As String = "RevokeChildren"
C++ __Копировать
     public:
    literal String^ ResolutionRevokeChildrenField = "RevokeChildren"
F# __Копировать
     static val mutable ResolutionRevokeChildrenField: string
#### Значение поля
