# ReaderLockWrapper - структура
Структура, обеспечивающая синхронизацию доступа к ресурсу на чтение.
## __Definition
 **Пространство имён:** [Tessa.Platform](N_Tessa_Platform.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public readonly struct ReaderLockWrapper : IDisposable
VB __Копировать
     Public Structure ReaderLockWrapper
    	Implements IDisposable
C++ __Копировать
     public value class ReaderLockWrapper : IDisposable
F# __Копировать
     [<SealedAttribute>]
    type ReaderLockWrapper = 
        struct
            inherit ValueType
            interface IDisposable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) __ ReaderLockWrapper
Implements
    [IDisposable](https://learn.microsoft.com/dotnet/api/system.idisposable)
##  __Конструкторы
[ReaderLockWrapper](M_Tessa_Platform_ReaderLockWrapper__ctor.htm)|  Создаёт
экземпляр структуры с указанием объекта, обеспечивающего синхронизацию доступа
по чтению и изменению ресурса.  
---|---  
## __Методы
[Dispose](M_Tessa_Platform_ReaderLockWrapper_Dispose.htm)| Освобождает
