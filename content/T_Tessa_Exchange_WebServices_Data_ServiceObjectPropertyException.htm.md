# ServiceObjectPropertyException - класс
...
C++ __Копировать
     public ref class ServiceObjectPropertyException : public PropertyException
F# __Копировать
     type ServiceObjectPropertyException = 
        class
            inherit PropertyException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceLocalException](T_Tessa_Exchange_WebServices_Data_ServiceLocalException.htm) __[PropertyException](T_Tessa_Exchange_WebServices_Data_PropertyException.htm) __ ServiceObjectPropertyException
##  __Конструкторы
[ServiceObjectPropertyException(PropertyDefinitionBase)](M_Tessa_Exchange_WebServices_Data_ServiceObjectPropertyException__ctor_3.htm)|
ServiceObjectPropertyException constructor.  
---|---  
[ServiceObjectPropertyException(SerializationInfo,
StreamingContext)](M_Tessa_Exchange_WebServices_Data_ServiceObjectPropertyException__ctor.htm)|
Initializes a new instance of the ServiceObjectPropertyException class with
serialized data.  
[ServiceObjectPropertyException(String,
PropertyDefinitionBase)](M_Tessa_Exchange_WebServices_Data_ServiceObjectPropertyException__ctor_1.htm)|
ServiceObjectPropertyException Constructor.  
[ServiceObjectPropertyException(String, PropertyDefinitionBase,
Exception)](M_Tessa_Exchange_WebServices_Data_ServiceObjectPropertyException__ctor_2.htm)|
ServiceObjectPropertyException Constructor.  
## __Свойства
...
(Унаследован от
[Exception](https://learn.microsoft.com/dotnet/api/system.exception))  
[Name](P_Tessa_Exchange_WebServices_Data_PropertyException_Name.htm)|  Gets
...
[PropertyDefinition](P_Tessa_Exchange_WebServices_Data_ServiceObjectPropertyException_PropertyDefinition.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Exchange_WebServices_Data_ServiceObjectPropertyException_GetObjectData.htm)|
Sets the
...
(Переопределяет [PropertyException.GetObjectData(SerializationInfo,
StreamingContext)](M_Tessa_Exchange_WebServices_Data_PropertyException_GetObjectData.htm))  
