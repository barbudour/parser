...
C# __Копировать
    ...
    public sealed class WorkflowActionStorage : WorkflowTemplateStorageBase
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowActionStorage
    	Inherits WorkflowTemplateStorageBase
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowActionStorage sealed : public WorkflowTemplateStorageBase
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowActionStorage = 
        class
            inherit WorkflowTemplateStorageBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __[WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm) __ WorkflowActionStorage
##  __Конструкторы
[WorkflowActionStorage()](M_Tessa_Workflow_Storage_WorkflowActionStorage__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowActionStorage  
---|---  
[WorkflowActionStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowActionStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowActionStorage  
[WorkflowActionStorage(Dictionary<String, Object>,
WorkflowNodeStorage)](M_Tessa_Workflow_Storage_WorkflowActionStorage__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowActionStorage  
##  __Свойства
[ActionTypeID](P_Tessa_Workflow_Storage_WorkflowActionStorage_ActionTypeID.htm)|
...
(Унаследован от
[WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm))  
[Order](P_Tessa_Workflow_Storage_WorkflowActionStorage_Order.htm)|  Порядок
действия внутри узла. Определяет порядок выполнения действий при обработке
узла  
[ParentObject](P_Tessa_Workflow_Storage_WorkflowTemplateStorageBase_ParentObject.htm)|
Родительский объект.  
(Унаследован от
[WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm))  
[PostScript](P_Tessa_Workflow_Storage_WorkflowActionStorage_PostScript.htm)|
Постскрипт  
[PostScriptProcessAnySignal](P_Tessa_Workflow_Storage_WorkflowActionStorage_PostScriptProcessAnySignal.htm)|
Постскрипт обрабатывается на любой сигнал  
[PreConditions](P_Tessa_Workflow_Storage_WorkflowActionStorage_PreConditions.htm)|
Предусловие  
[PreScript](P_Tessa_Workflow_Storage_WorkflowActionStorage_PreScript.htm)|
Предскрипт  
[PreScriptProcessAnySignal](P_Tessa_Workflow_Storage_WorkflowActionStorage_PreScriptProcessAnySignal.htm)|
Предскрипт обрабатывается на любой сигнал  
## __Методы
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[Clone](M_Tessa_Workflow_Storage_WorkflowActionStorage_Clone.htm)|  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[OnPropertyChanged(PropertyChangedEventArgs)](M_Tessa_Workflow_Storage_WorkflowActionStorage_OnPropertyChanged.htm)|  
(Переопределяет
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[PreConditionsChanged](M_Tessa_Workflow_Storage_WorkflowActionStorage_PreConditionsChanged.htm)|
Метод для вызова события, когда меняется список PreConditions  
[Remove](M_Tessa_Platform_Storage_StorageObject_Remove.htm)|  Удаляет объект с
заданным ключом из хранилища.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[RemoveData](M_Tessa_Workflow_Storage_WorkflowActionStorage_RemoveData.htm)|  
(Переопределяет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[UpdateData](M_Tessa_Workflow_Storage_WorkflowActionStorage_UpdateData.htm)|  
(Переопределяет
