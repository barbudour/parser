# SchemeWebProxy - класс
##  __Definition
 **Пространство имён:** [Tessa.Scheme](N_Tessa_Scheme.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class SchemeWebProxy : WebProxy
VB __Копировать
     Public NotInheritable Class SchemeWebProxy
    	Inherits WebProxy
C++ __Копировать
     public ref class SchemeWebProxy sealed : public WebProxy
F# __Копировать
     [<SealedAttribute>]
    type SchemeWebProxy = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm) __ SchemeWebProxy
##  __Конструкторы
[SchemeWebProxy](M_Tessa_Scheme_SchemeWebProxy__ctor.htm)| Создаёт экземпляр
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetDatabasePropertiesAsync](M_Tessa_Scheme_SchemeWebProxy_GetDatabasePropertiesAsync.htm)|  
[GetFunctionAsync(Guid,
CancellationToken)](M_Tessa_Scheme_SchemeWebProxy_GetFunctionAsync.htm)|  
[GetFunctionAsync(String,
CancellationToken)](M_Tessa_Scheme_SchemeWebProxy_GetFunctionAsync_1.htm)|  
[GetFunctionsAsync](M_Tessa_Scheme_SchemeWebProxy_GetFunctionsAsync.htm)|  
[GetHashCode](https://learn.microsoft.com/dotnet/api/system.object.gethashcode#system-
object-gethashcode)| Serves as the default hash function.  
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetMigrationAsync(Guid,
CancellationToken)](M_Tessa_Scheme_SchemeWebProxy_GetMigrationAsync.htm)|  
[GetMigrationAsync(String,
CancellationToken)](M_Tessa_Scheme_SchemeWebProxy_GetMigrationAsync_1.htm)|  
[GetMigrationsAsync](M_Tessa_Scheme_SchemeWebProxy_GetMigrationsAsync.htm)|  
[GetPartitionAsync(Guid,
CancellationToken)](M_Tessa_Scheme_SchemeWebProxy_GetPartitionAsync.htm)|  
[GetPartitionAsync(String,
CancellationToken)](M_Tessa_Scheme_SchemeWebProxy_GetPartitionAsync_1.htm)|  
[GetPartitionsAsync](M_Tessa_Scheme_SchemeWebProxy_GetPartitionsAsync.htm)|  
[GetProcedureAsync(Guid,
CancellationToken)](M_Tessa_Scheme_SchemeWebProxy_GetProcedureAsync.htm)|  
[GetProcedureAsync(String,
CancellationToken)](M_Tessa_Scheme_SchemeWebProxy_GetProcedureAsync_1.htm)|  
[GetProceduresAsync](M_Tessa_Scheme_SchemeWebProxy_GetProceduresAsync.htm)|  
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[GetTableAsync(Guid,
CancellationToken)](M_Tessa_Scheme_SchemeWebProxy_GetTableAsync.htm)|  
[GetTableAsync(String,
CancellationToken)](M_Tessa_Scheme_SchemeWebProxy_GetTableAsync_1.htm)|  
[GetTablesAsync](M_Tessa_Scheme_SchemeWebProxy_GetTablesAsync.htm)|  
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[InvalidateCacheAsync](M_Tessa_Scheme_SchemeWebProxy_InvalidateCacheAsync.htm)|  
[InvalidateCacheIfChangedAsync](M_Tessa_Scheme_SchemeWebProxy_InvalidateCacheIfChangedAsync.htm)|  
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[RemoveFunctionAsync](M_Tessa_Scheme_SchemeWebProxy_RemoveFunctionAsync.htm)|  
[RemoveMigrationAsync](M_Tessa_Scheme_SchemeWebProxy_RemoveMigrationAsync.htm)|  
[RemovePartitionAsync](M_Tessa_Scheme_SchemeWebProxy_RemovePartitionAsync.htm)|  
[RemoveProcedureAsync](M_Tessa_Scheme_SchemeWebProxy_RemoveProcedureAsync.htm)|  
[RemoveTableAsync](M_Tessa_Scheme_SchemeWebProxy_RemoveTableAsync.htm)|  
[SaveDatabasePropertiesAsync](M_Tessa_Scheme_SchemeWebProxy_SaveDatabasePropertiesAsync.htm)|  
[SaveFunctionAsync](M_Tessa_Scheme_SchemeWebProxy_SaveFunctionAsync.htm)|  
[SaveMigrationAsync](M_Tessa_Scheme_SchemeWebProxy_SaveMigrationAsync.htm)|  
[SavePartitionAsync](M_Tessa_Scheme_SchemeWebProxy_SavePartitionAsync.htm)|  
[SaveProcedureAsync](M_Tessa_Scheme_SchemeWebProxy_SaveProcedureAsync.htm)|  
[SaveTableAsync](M_Tessa_Scheme_SchemeWebProxy_SaveTableAsync.htm)|  
