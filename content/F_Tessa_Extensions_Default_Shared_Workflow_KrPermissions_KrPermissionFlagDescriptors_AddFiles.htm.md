# KrPermissionFlagDescriptors.AddFiles - поле
...
C# __Копировать
     public static readonly KrPermissionFlagDescriptor AddFiles
VB __Копировать
     Public Shared ReadOnly AddFiles As KrPermissionFlagDescriptor
C++ __Копировать
     public:
    static initonly KrPermissionFlagDescriptor^ AddFiles
F# __Копировать
     static val AddFiles: KrPermissionFlagDescriptor
#### Значение поля
