...
##  __Конструкторы
[Registrator](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Serialization_Registrator__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializeExtensions](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Serialization_Registrator_InitializeExtensions.htm)|
Выполняет инициализацию заданного контейнера расширений. Рекомендуется не
выполнять регистрацию Unity в этом объекте.  
(Переопределяет
[RegistratorBase.InitializeExtensions(IExtensionContainer)](M_Tessa_Extensions_RegistratorBase_InitializeExtensions.htm))  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterExtensions](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Serialization_Registrator_RegisterExtensions.htm)|
...
[RegisterUnity](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Serialization_Registrator_RegisterUnity.htm)|
