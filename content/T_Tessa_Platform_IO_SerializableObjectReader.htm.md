# SerializableObjectReader - класс
Обеспечивает чтение сериализуемых объектов из потока.
## __Definition
 **Пространство имён:** [Tessa.Platform.IO](N_Tessa_Platform_IO.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class SerializableObjectReader
VB __Копировать
     Public MustInherit Class SerializableObjectReader
C++ __Копировать
     public ref class SerializableObjectReader abstract
F# __Копировать
     [<AbstractClassAttribute>]
    type SerializableObjectReader = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ SerializableObjectReader
Derived
[Tessa.Cards.ComponentModel.CardReader](T_Tessa_Cards_ComponentModel_CardReader.htm)
[Tessa.Platform.Initialization.InitializationReader](T_Tessa_Platform_Initialization_InitializationReader.htm)
##  __Конструкторы
[SerializableObjectReader](M_Tessa_Platform_IO_SerializableObjectReader__ctor.htm)|
