# AlternateMailboxCollection - класс
...
VB __Копировать
     Public NotInheritable Class AlternateMailboxCollection
C++ __Копировать
     public ref class AlternateMailboxCollection sealed
F# __Копировать
     [<SealedAttribute>]
    type AlternateMailboxCollection = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ AlternateMailboxCollection
##  __Свойства
