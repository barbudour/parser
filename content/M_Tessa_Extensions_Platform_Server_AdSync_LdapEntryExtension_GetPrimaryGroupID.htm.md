# LdapEntryExtension.GetPrimaryGroupID - метод
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.AdSync](N_Tessa_Extensions_Platform_Server_AdSync.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public static int GetPrimaryGroupID(
    	this LdapEntry entry
    )
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function GetPrimaryGroupID ( 
    	entry As LdapEntry
    ) As Integer
C++ __Копировать
     public:
    [ExtensionAttribute]
    static int GetPrimaryGroupID(
    	LdapEntry^ entry
    )
F# __Копировать
     [<ExtensionAttribute>]
    static member GetPrimaryGroupID : 
            entry : LdapEntry -> int 
#### Параметры
entry LdapEntry
