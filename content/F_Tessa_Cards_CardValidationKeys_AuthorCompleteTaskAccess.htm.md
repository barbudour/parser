# CardValidationKeys.AuthorCompleteTaskAccess - поле
...
C# __Копировать
     public static readonly ValidationKey AuthorCompleteTaskAccess
VB __Копировать
     Public Shared ReadOnly AuthorCompleteTaskAccess As ValidationKey
C++ __Копировать
     public:
    static initonly ValidationKey^ AuthorCompleteTaskAccess
F# __Копировать
     static val AuthorCompleteTaskAccess: ValidationKey
#### Значение поля
