# MultitypeSatelliteDeleteExtension.IsSatelliteCardTypeAsync - метод
...
C# __Копировать
     protected abstract ValueTask<bool> IsSatelliteCardTypeAsync(
    	CardType cardType,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Protected MustOverride Function IsSatelliteCardTypeAsync ( 
