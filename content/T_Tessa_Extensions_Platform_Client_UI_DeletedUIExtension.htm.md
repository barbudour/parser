# DeletedUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class DeletedUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class DeletedUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class DeletedUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type DeletedUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ DeletedUIExtension
##  __Конструкторы
[DeletedUIExtension](M_Tessa_Extensions_Platform_Client_UI_DeletedUIExtension__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_DeletedUIExtension_Initialized.htm)|  
(Переопределяет
