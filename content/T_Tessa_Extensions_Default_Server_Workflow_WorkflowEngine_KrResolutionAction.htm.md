...
VB __Копировать
     Public NotInheritable Class KrResolutionAction
    	Inherits KrWorkflowTaskActionBase
C++ __Копировать
     public ref class KrResolutionAction sealed : public KrWorkflowTaskActionBase
F# __Копировать
     [<SealedAttribute>]
    type KrResolutionAction = 
        class
            inherit KrWorkflowTaskActionBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WorkflowActionBase](T_Tessa_Workflow_Actions_WorkflowActionBase.htm) __[KrWorkflowActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowActionBase.htm) __[KrWorkflowTaskActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowTaskActionBase.htm) __ KrResolutionAction
##  __Конструкторы
[KrResolutionAction](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrResolutionAction__ctor.htm)|
Инициализирует новый экземпляр класса KrResolutionAction  
---|---  
##  __Свойства
...
[CheckActive](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrResolutionAction_CheckActive.htm)|
...
[Compile](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrResolutionAction_Compile.htm)|
...
(Унаследован от
[KrWorkflowTaskActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowTaskActionBase.htm))  
[CompleteTaskCoreAsync](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrResolutionAction_CompleteTaskCoreAsync.htm)|  
(Переопределяет
...
[ExecuteAsync](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrResolutionAction_ExecuteAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetResultAsync](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrResolutionAction_GetResultAsync.htm)|  
(Переопределяет
