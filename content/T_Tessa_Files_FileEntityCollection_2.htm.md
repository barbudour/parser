# FileEntityCollection<TItem, TCollection> \- класс
Коллекция объектов, реализующих интерфейс
[IFileEntity](T_Tessa_Files_IFileEntity.htm), для которой доступны уведомление
об изменениях и клонирование, а также идентификация по неуникальному ключу
[ID](P_Tessa_Files_IFileEntity_ID.htm).
## __Definition
 **Пространство имён:** [Tessa.Files](N_Tessa_Files.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class FileEntityCollection<TItem, TCollection> : ObservableCollectionLookup<Guid, TItem, TCollection>, 
    	IFileEntityCollection<TItem, TCollection>, IObservableCollectionLookup<Guid, TItem, TCollection>, 
    	IObservableCollection<TItem, TCollection>, IList<TItem>, ICollection<TItem>, 
    	IEnumerable<TItem>, IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, 
    	ILookupContainer<Guid, TItem>, IControllableCollection<TItem>
    where TItem : class, IFileEntity
    where TCollection : class, Object, IFileEntityCollection<TItem, TCollection>
VB __Копировать
     Public MustInherit Class FileEntityCollection(Of TItem As {Class, IFileEntity}, TCollection As {Class, Object, IFileEntityCollection(Of TItem, TCollection)})
    	Inherits ObservableCollectionLookup(Of Guid, TItem, TCollection)
    	Implements IFileEntityCollection(Of TItem, TCollection), IObservableCollectionLookup(Of Guid, TItem, TCollection), 
    	IObservableCollection(Of TItem, TCollection), IList(Of TItem), 
    	ICollection(Of TItem), IEnumerable(Of TItem), IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer(Of Guid, TItem), 
    	IControllableCollection(Of TItem)
C++ __Копировать
    generic<typename TItem, typename TCollection>
    where TItem : ref class, IFileEntity
    where TCollection : ref class, Object, IFileEntityCollection<TItem, TCollection>
    public ref class FileEntityCollection abstract : public ObservableCollectionLookup<Guid, TItem, TCollection>, 
    	IFileEntityCollection<TItem, TCollection>, IObservableCollectionLookup<Guid, TItem, TCollection>, 
    	IObservableCollection<TItem, TCollection>, IList<TItem>, ICollection<TItem>, 
    	IEnumerable<TItem>, IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, 
    	ILookupContainer<Guid, TItem>, IControllableCollection<TItem>
F# __Копировать
    ...
    type FileEntityCollection<'TItem, 'TCollection when 'TItem : not struct and IFileEntity when 'TCollection : not struct and Object and IFileEntityCollection<'TItem, 'TCollection>> = 
        class
            inherit ObservableCollectionLookup<Guid, 'TItem, 'TCollection>
            interface IFileEntityCollection<'TItem, 'TCollection>
            interface IObservableCollectionLookup<Guid, 'TItem, 'TCollection>
            ...
            interface ILookupContainer<Guid, 'TItem>
            interface IControllableCollection<'TItem>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<TItem> __[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<TItem> __[SuspendableObservableCollection](T_Tessa_Platform_Collections_SuspendableObservableCollection_1.htm)<TItem> __[ObservableCollection](T_Tessa_Platform_Collections_ObservableCollection_2.htm)<TItem, TCollection> __[ObservableCollectionLookup](T_Tessa_Platform_Collections_ObservableCollectionLookup_3.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), TItem, TCollection> __ FileEntityCollection<TItem, TCollection>
Derived
[Tessa.Files.FileCollection](T_Tessa_Files_FileCollection.htm)
[Tessa.Files.FileSignatureCollectionBase<TCollection>](T_Tessa_Files_FileSignatureCollectionBase_1.htm)
[Tessa.Files.FileVersionCollection](T_Tessa_Files_FileVersionCollection.htm)
Implements
    [ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<TItem>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<TItem>, [IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<TItem>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.ienumerable), [INotifyCollectionChanged](https://learn.microsoft.com/dotnet/api/system.collections.specialized.inotifycollectionchanged), [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged), [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable), [IFileEntityCollection](T_Tessa_Files_IFileEntityCollection_2.htm)<TItem, TCollection>, [IControllableCollection](T_Tessa_Platform_Collections_IControllableCollection_1.htm)<TItem>, [ILookupContainer](T_Tessa_Platform_Collections_ILookupContainer_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), TItem>, [IObservableCollection](T_Tessa_Platform_Collections_IObservableCollection_2.htm)<TItem, TCollection>, [IObservableCollectionLookup](T_Tessa_Platform_Collections_IObservableCollectionLookup_3.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), TItem, TCollection>
#### Параметры типа
TItem
     Ссылочный тип объектов в коллекции, реализующий интерфейс [IFileEntity](T_Tessa_Files_IFileEntity.htm). 
TCollection
