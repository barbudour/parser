# TaskSatelliteRepairExtension - класс
...
C# __Копировать
     public abstract class TaskSatelliteRepairExtension : CardRepairExtension
VB __Копировать
     Public MustInherit Class TaskSatelliteRepairExtension
    	Inherits CardRepairExtension
C++ __Копировать
     public ref class TaskSatelliteRepairExtension abstract : public CardRepairExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type TaskSatelliteRepairExtension = 
        class
            inherit CardRepairExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm) __ TaskSatelliteRepairExtension
##  __Конструкторы
[TaskSatelliteRepairExtension](M_Tessa_Cards_Extensions_Templates_TaskSatelliteRepairExtension__ctor.htm)|
Инициализирует новый экземпляр класса TaskSatelliteRepairExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Cards_Extensions_Templates_TaskSatelliteRepairExtension_AfterRequest.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsMainCardTypeAsync](M_Tessa_Cards_Extensions_Templates_TaskSatelliteRepairExtension_IsMainCardTypeAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetSatelliteCardListAsync](M_Tessa_Cards_Extensions_Templates_TaskSatelliteRepairExtension_TryGetSatelliteCardListAsync.htm)|
