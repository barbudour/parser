# AddWorkingQuantsToDateRequestExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.BusinessCalendar](N_Tessa_Extensions_Platform_Server_BusinessCalendar.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class AddWorkingQuantsToDateRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class AddWorkingQuantsToDateRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class AddWorkingQuantsToDateRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type AddWorkingQuantsToDateRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ AddWorkingQuantsToDateRequestExtension
##  __Конструкторы
[AddWorkingQuantsToDateRequestExtension](M_Tessa_Extensions_Platform_Server_BusinessCalendar_AddWorkingQuantsToDateRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса AddWorkingQuantsToDateRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_BusinessCalendar_AddWorkingQuantsToDateRequestExtension_AfterRequest.htm)|  
(Переопределяет
