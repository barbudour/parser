# AutodiscoverResponseException - класс
...
C++ __Копировать
     public ref class AutodiscoverResponseException : public ServiceRemoteException
F# __Копировать
     type AutodiscoverResponseException = 
        class
            inherit ServiceRemoteException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceRemoteException](T_Tessa_Exchange_WebServices_Data_ServiceRemoteException.htm) __ AutodiscoverResponseException
##  __Конструкторы
[AutodiscoverResponseException](M_Tessa_Exchange_WebServices_Autodiscover_AutodiscoverResponseException__ctor.htm)|
Initializes a new instance of the AutodiscoverResponseException class with
serialized data.  
---|---  
## __Свойства
...
---|---  
[ErrorCode](P_Tessa_Exchange_WebServices_Autodiscover_AutodiscoverResponseException_ErrorCode.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Exchange_WebServices_Autodiscover_AutodiscoverResponseException_GetObjectData.htm)|
Sets the
