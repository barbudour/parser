# ForkStageTypeHandler.BranchInfo - класс
...
C++ __Копировать
     public ref class BranchInfo : public StorageObject
F# __Копировать
     type BranchInfo = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForkStageTypeHandler.BranchInfo
##  __Конструкторы
[ForkStageTypeHandler.BranchInfo(Dictionary<String,
Object>)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_ForkStageTypeHandler_BranchInfo__ctor.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
---|---  
[ForkStageTypeHandler.BranchInfo(SerializationInfo,
StreamingContext)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_ForkStageTypeHandler_BranchInfo__ctor_2.htm)|
...
[ForkStageTypeHandler.BranchInfo(Guid, Guid, Guid,
Boolean)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_ForkStageTypeHandler_BranchInfo__ctor_1.htm)|
Инициализирует новый экземпляр класса ForkStageTypeHandler.BranchInfo.  
## __Свойства
[Completed](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_ForkStageTypeHandler_BranchInfo_Completed.htm)|
Возвращает значение, показывающее, что вложенный процесс завершён.  
---|---  
[ProcessID](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_ForkStageTypeHandler_BranchInfo_ProcessID.htm)|
Возвращает идентификатор экземпляра вложенного процесса или значение
[Empty](https://learn.microsoft.com/dotnet/api/system.guid.empty), если при
запуске процесса произошла ошибка.  
[RowID](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_ForkStageTypeHandler_BranchInfo_RowID.htm)|
Возвращает идентификатор строки вложенного процесса в
...
[SecondaryProcessID](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_ForkStageTypeHandler_BranchInfo_SecondaryProcessID.htm)|
Возвращает идентификатор вторичного процесса из
