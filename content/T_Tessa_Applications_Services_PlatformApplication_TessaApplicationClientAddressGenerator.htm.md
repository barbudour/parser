# TessaApplicationClientAddressGenerator - класс
Объект
...
C# __Копировать
     public class TessaApplicationClientAddressGenerator : TessaApplicationAddressGenerator
VB __Копировать
     Public Class TessaApplicationClientAddressGenerator
    	Inherits TessaApplicationAddressGenerator
C++ __Копировать
     public ref class TessaApplicationClientAddressGenerator : public TessaApplicationAddressGenerator
F# __Копировать
     type TessaApplicationClientAddressGenerator = 
        class
            inherit TessaApplicationAddressGenerator
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[HostServiceAddressGenerator](T_Tessa_Host_HostServiceAddressGenerator.htm) __[TessaApplicationAddressGenerator](T_Tessa_Applications_Services_PlatformApplication_TessaApplicationAddressGenerator.htm) __ TessaApplicationClientAddressGenerator
##  __Конструкторы
[TessaApplicationClientAddressGenerator](M_Tessa_Applications_Services_PlatformApplication_TessaApplicationClientAddressGenerator__ctor.htm)|
Инициализирует новый экземпляр класса TessaApplicationClientAddressGenerator  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetNextServiceAddress](M_Tessa_Applications_Services_PlatformApplication_TessaApplicationClientAddressGenerator_GetNextServiceAddress.htm)|
Возвращает адрес сервиса  
(Переопределяет [HostServiceAddressGenerator.GetNextServiceAddress(Object,
String)](M_Tessa_Host_HostServiceAddressGenerator_GetNextServiceAddress.htm))  
