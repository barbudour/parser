...
## __Конструкторы
[AssemblyLoaderOptions](M_Chronos_Platform_Composition_AssemblyLoaderOptions__ctor.htm)|
Инициализирует новый экземпляр класса AssemblyLoaderOptions  
---|---  
##  __Свойства
...
---|---  
##  __Методы
[CheckInterface<T>](M_Chronos_Platform_Composition_AssemblyLoaderOptions_CheckInterface__1.htm)|
