...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[ScrollRatio](P_Tessa_UI_Behaviors_ScrollRatioBehaviorBase_ScrollRatio.htm)|  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnConnected](M_Tessa_UI_Behaviors_ScrollRatioBehaviorBase_OnConnected.htm)|  
(Переопределяет
...
(Унаследован от
[ScrollViewerBehaviorBase](T_Tessa_UI_Behaviors_ScrollViewerBehaviorBase.htm))  
[OnDisconnected](M_Tessa_UI_Behaviors_ScrollRatioBehaviorBase_OnDisconnected.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[ScrollRatioProperty](F_Tessa_UI_Behaviors_ScrollRatioBehaviorBase_ScrollRatioProperty.htm)|  
---|---  
## __См. также
#### Ссылки
