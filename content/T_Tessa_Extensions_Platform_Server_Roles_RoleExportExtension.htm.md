...
C# __Копировать
     public sealed class RoleExportExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class RoleExportExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class RoleExportExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type RoleExportExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ RoleExportExtension
##  __Конструкторы
[RoleExportExtension](M_Tessa_Extensions_Platform_Server_Roles_RoleExportExtension__ctor.htm)|
Инициализирует новый экземпляр класса RoleExportExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_RoleExportExtension_AfterRequest.htm)|  
(Переопределяет
