# CardTypeValidator.Equals(CardTypeValidator) - метод
...
C# __Копировать
     public bool Equals(
    	CardTypeValidator other
    )
VB __Копировать
     Public Function Equals ( 
    	other As CardTypeValidator
    ) As Boolean
C++ __Копировать
     public:
    virtual bool Equals(
...
F# __Копировать
     abstract Equals : 
            other : CardTypeValidator -> bool 
    override Equals : 
            other : CardTypeValidator -> bool 
#### Параметры
other [CardTypeValidator](T_Tessa_Cards_CardTypeValidator.htm)
