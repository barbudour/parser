# InvalidateSingletonDeleteExtension - класс
...
C# __Копировать
     public sealed class InvalidateSingletonDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class InvalidateSingletonDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class InvalidateSingletonDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type InvalidateSingletonDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ InvalidateSingletonDeleteExtension
##  __Конструкторы
[InvalidateSingletonDeleteExtension](M_Tessa_Extensions_Platform_Shared_Cards_InvalidateSingletonDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса InvalidateSingletonDeleteExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Platform_Shared_Cards_InvalidateSingletonDeleteExtension_AfterRequest.htm)|  
(Переопределяет
