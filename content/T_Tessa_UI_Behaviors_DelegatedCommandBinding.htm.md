# DelegatedCommandBinding - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Behaviors](N_Tessa_UI_Behaviors.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class DelegatedCommandBinding : Behavior
VB __Копировать
     Public NotInheritable Class DelegatedCommandBinding
    	Inherits Behavior
C++ __Копировать
     public ref class DelegatedCommandBinding sealed : public Behavior
F# __Копировать
     [<SealedAttribute>]
    type DelegatedCommandBinding = 
        class
            inherit Behavior
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __ DelegatedCommandBinding
##  __Конструкторы
[DelegatedCommandBinding](M_Tessa_UI_Behaviors_DelegatedCommandBinding__ctor.htm)|
Инициализирует новый экземпляр класса DelegatedCommandBinding  
---|---  
##  __Свойства
...
[Command](P_Tessa_UI_Behaviors_DelegatedCommandBinding_Command.htm)|  
[DelegatedCommand](P_Tessa_UI_Behaviors_DelegatedCommandBinding_DelegatedCommand.htm)|  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_DelegatedCommandBinding_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[GetRequiredType](M_Tessa_UI_Behaviors_DelegatedCommandBinding_GetRequiredType.htm)|  
(Переопределяет
[Behavior.GetRequiredType(Int32)](M_Tessa_UI_Behaviors_Behavior_GetRequiredType.htm))  
[GetRequiredTypeCount](M_Tessa_UI_Behaviors_DelegatedCommandBinding_GetRequiredTypeCount.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_DelegatedCommandBinding_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_DelegatedCommandBinding_OnDetaching.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[CommandProperty](F_Tessa_UI_Behaviors_DelegatedCommandBinding_CommandProperty.htm)|  
---|---  
[DelegatedCommandProperty](F_Tessa_UI_Behaviors_DelegatedCommandBinding_DelegatedCommandProperty.htm)|  
## __См. также
#### Ссылки
