...
C# __Копировать
     public sealed class CardValidatorRegistry : ICardValidatorRegistry
VB __Копировать
     Public NotInheritable Class CardValidatorRegistry
    	Implements ICardValidatorRegistry
C++ __Копировать
     public ref class CardValidatorRegistry sealed : ICardValidatorRegistry
F# __Копировать
     [<SealedAttribute>]
    type CardValidatorRegistry = 
        class
            interface ICardValidatorRegistry
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardValidatorRegistry
Implements
    [ICardValidatorRegistry](T_Tessa_Cards_Validation_ICardValidatorRegistry.htm)
##  __Конструкторы
[CardValidatorRegistry](M_Tessa_Cards_Validation_CardValidatorRegistry__ctor.htm)|
Инициализирует новый экземпляр класса CardValidatorRegistry  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Get](M_Tessa_Cards_Validation_CardValidatorRegistry_Get.htm)| Возвращает
экземпляр валидатора, тип которого был зарегистрирован в реестре по
метаинформации о типе этого валидатора.  
[GetAll](M_Tessa_Cards_Validation_CardValidatorRegistry_GetAll.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Register](M_Tessa_Cards_Validation_CardValidatorRegistry_Register.htm)|
