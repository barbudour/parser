# NumberBuilder.CreateNumberAsync - метод
...
C# __Копировать
     public ValueTask<INumberObject> CreateNumberAsync(
    	long? number,
    	string fullNumber,
    	string sequenceName,
...
VB __Копировать
     Public Function CreateNumberAsync ( 
    	number As Long?,
...
C++ __Копировать
     public:
    virtual ValueTask<INumberObject^> CreateNumberAsync(
...
#### Реализации
[INumberBuilder.CreateNumberAsync(Nullable<Int64>, String, String,
NumberTypeDescriptor, Dictionary<String, Object>,
CancellationToken)](M_Tessa_Cards_Numbers_INumberBuilder_CreateNumberAsync.htm)  
##  __См. также
#### Ссылки
