...
C# __Копировать
     public sealed class ChangeFocusOnDisabling : Behavior<UIElement>
VB __Копировать
     Public NotInheritable Class ChangeFocusOnDisabling
    	Inherits Behavior(Of UIElement)
C++ __Копировать
     public ref class ChangeFocusOnDisabling sealed : public Behavior<UIElement^>
F# __Копировать
     [<SealedAttribute>]
    type ChangeFocusOnDisabling = 
        class
            inherit Behavior<UIElement>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement)> __ ChangeFocusOnDisabling
##  __Конструкторы
[ChangeFocusOnDisabling](M_Tessa_UI_Behaviors_ChangeFocusOnDisabling__ctor.htm)|
Инициализирует новый экземпляр класса ChangeFocusOnDisabling  
---|---  
##  __Свойства
...
[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject))  
[FocusElement](P_Tessa_UI_Behaviors_ChangeFocusOnDisabling_FocusElement.htm)|
Элемент, на который изменяется фокус при потере фокуса с текущего элемента при
отключении его доступности. Если указанный элемент недоступен для фокуса, то в
качестве элемента для фокуса выбирается первый доступный для фокуса дочерний
элемент.  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_ChangeFocusOnDisabling_CreateInstanceCore.htm)|
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_ChangeFocusOnDisabling_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_ChangeFocusOnDisabling_OnDetaching.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[FocusElementProperty](F_Tessa_UI_Behaviors_ChangeFocusOnDisabling_FocusElementProperty.htm)|  
---|---  
## __См. также
#### Ссылки
