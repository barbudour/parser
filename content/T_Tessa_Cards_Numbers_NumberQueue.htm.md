...
C# __Копировать
    ...
    public sealed class NumberQueue : CardInfoStorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class NumberQueue
    	Inherits CardInfoStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class NumberQueue sealed : public CardInfoStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
##  __Конструкторы
[NumberQueue()](M_Tessa_Cards_Numbers_NumberQueue__ctor.htm)|  Создаёт
экземпляр класса и пустое хранилище Dictionary<string, object>, декоратором
для которого является создаваемый объект.  
---|---  
[NumberQueue(Dictionary<String,
Object>)](M_Tessa_Cards_Numbers_NumberQueue__ctor_1.htm)| Создаёт экземпляр
класса с указанием хранилища, декоратором для которого является создаваемый
объект.  
[NumberQueue(IStorageObjectProvider)](M_Tessa_Cards_Numbers_NumberQueue__ctor_2.htm)|
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[IsEmpty](P_Tessa_Cards_Numbers_NumberQueue_IsEmpty.htm)|  Возвращает признак
того, что объект не содержит действий с номерами.  
[Items](P_Tessa_Cards_Numbers_NumberQueue_Items.htm)|  Список действий с
номерами в порядке их поступления. Эти действия были отложены для выполнения
на сервере.  
## __Методы
...
[Clean](M_Tessa_Cards_Numbers_NumberQueue_Clean.htm)| Выполняет очистку
...
[Clear](M_Tessa_Cards_Numbers_NumberQueue_Clear.htm)|  Очищает очередь
действий с номерами.  
[ClearCache](M_Tessa_Platform_Storage_StorageObject_ClearCache.htm)|  Очищает
внутренний кэш декораторов.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_Numbers_NumberQueue_Clone.htm)|  Выполняет глубокое
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Cards_Numbers_NumberQueue_EnsureCacheResolved.htm)|
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[TryGetItems](M_Tessa_Cards_Numbers_NumberQueue_TryGetItems.htm)|  Возвращает
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_Numbers_NumberQueue_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
