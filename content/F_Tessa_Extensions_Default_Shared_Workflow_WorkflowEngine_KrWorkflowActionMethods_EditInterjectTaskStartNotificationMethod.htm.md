# KrWorkflowActionMethods.EditInterjectTaskStartNotificationMethod - поле
...
VB __Копировать
     Public Shared ReadOnly EditInterjectTaskStartNotificationMethod As WorkflowActionMethodDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionMethodDescriptor^ EditInterjectTaskStartNotificationMethod
F# __Копировать
     static val EditInterjectTaskStartNotificationMethod: WorkflowActionMethodDescriptor
#### Значение поля
