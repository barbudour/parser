# TimeZonesTileExtensions - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.Tiles](N_Tessa_Extensions_Platform_Client_Tiles.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public class TimeZonesTileExtensions : TileExtension
VB __Копировать
     Public Class TimeZonesTileExtensions
    	Inherits TileExtension
C++ __Копировать
     public ref class TimeZonesTileExtensions : public TileExtension
F# __Копировать
     type TimeZonesTileExtensions = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ TimeZonesTileExtensions
##  __Конструкторы
[TimeZonesTileExtensions](M_Tessa_Extensions_Platform_Client_Tiles_TimeZonesTileExtensions__ctor.htm)|
Инициализирует новый экземпляр класса TimeZonesTileExtensions  
---|---  
##  __Методы
...
(Унаследован от
[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm))  
[InitializingLocal](M_Tessa_Extensions_Platform_Client_Tiles_TimeZonesTileExtensions_InitializingLocal.htm)|  
(Переопределяет
