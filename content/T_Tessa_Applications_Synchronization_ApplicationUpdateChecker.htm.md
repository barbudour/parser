# ApplicationUpdateChecker - класс
...
VB __Копировать
     Public NotInheritable Class ApplicationUpdateChecker
    	Implements IApplicationUpdateChecker
C++ __Копировать
     public ref class ApplicationUpdateChecker sealed : IApplicationUpdateChecker
F# __Копировать
     [<SealedAttribute>]
    type ApplicationUpdateChecker = 
        class
            interface IApplicationUpdateChecker
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ApplicationUpdateChecker
Implements
    [IApplicationUpdateChecker](T_Tessa_Applications_Synchronization_IApplicationUpdateChecker.htm)
##  __Конструкторы
[ApplicationUpdateChecker](M_Tessa_Applications_Synchronization_ApplicationUpdateChecker__ctor.htm)|
Initializes a new instance of the ApplicationUpdateChecker class.
