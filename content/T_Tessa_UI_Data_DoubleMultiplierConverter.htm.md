# DoubleMultiplierConverter - класс
...
C# __Копировать
     public sealed class DoubleMultiplierConverter : ValueConverter<double, double>
VB __Копировать
     Public NotInheritable Class DoubleMultiplierConverter
    	Inherits ValueConverter(Of Double, Double)
C++ __Копировать
     public ref class DoubleMultiplierConverter sealed : public ValueConverter<double, double>
F# __Копировать
     [<SealedAttribute>]
    type DoubleMultiplierConverter = 
        class
            inherit ValueConverter<float, float>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueConverter](T_Tessa_UI_Data_ValueConverter_2.htm)<[Double](https://learn.microsoft.com/dotnet/api/system.double), [Double](https://learn.microsoft.com/dotnet/api/system.double)> __ DoubleMultiplierConverter
##  __Конструкторы
[DoubleMultiplierConverter](M_Tessa_UI_Data_DoubleMultiplierConverter__ctor.htm)|
Инициализирует новый экземпляр класса DoubleMultiplierConverter  
---|---  
##  __Методы
...
CultureInfo)](M_Tessa_UI_Data_DoubleMultiplierConverter_Convert.htm)|  
