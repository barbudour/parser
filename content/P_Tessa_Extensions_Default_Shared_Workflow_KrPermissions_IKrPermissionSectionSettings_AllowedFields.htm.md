# IKrPermissionSectionSettings.AllowedFields - свойство
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Property AllowedFields As IReadOnlyCollection(Of Guid)
    	Get
    	Set
C++ __Копировать
    property IReadOnlyCollection<Guid>^ AllowedFields {
