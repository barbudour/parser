...
VB __Копировать
     Public Const NextCardIDKey As String = "NextCardID"
C++ __Копировать
     public:
    literal String^ NextCardIDKey = "NextCardID"
F# __Копировать
     static val mutable NextCardIDKey: string
#### Значение поля
