# ForumProviderExtensions.ForumProviderParticipantsRequest - класс
##  __Definition
 **Пространство имён:** [Tessa.Forums](N_Tessa_Forums.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class ForumProviderParticipantsRequest : StorageObject
VB __Копировать
     Public Class ForumProviderParticipantsRequest
    	Inherits StorageObject
C++ __Копировать
     public ref class ForumProviderParticipantsRequest : public StorageObject
F# __Копировать
     type ForumProviderParticipantsRequest = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForumProviderExtensions.ForumProviderParticipantsRequest
##  __Конструкторы
[ForumProviderExtensions.ForumProviderParticipantsRequest()](M_Tessa_Forums_ForumProviderExtensions_ForumProviderParticipantsRequest__ctor.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderParticipantsRequest  
---|---  
[ForumProviderExtensions.ForumProviderParticipantsRequest(Dictionary<String,
Object>)](M_Tessa_Forums_ForumProviderExtensions_ForumProviderParticipantsRequest__ctor_1.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderParticipantsRequest  
##  __Свойства
[IsReadOnly](P_Tessa_Forums_ForumProviderExtensions_ForumProviderParticipantsRequest_IsReadOnly.htm)|  
---|---  
[IsSubscribed](P_Tessa_Forums_ForumProviderExtensions_ForumProviderParticipantsRequest_IsSubscribed.htm)|  
[Participants](P_Tessa_Forums_ForumProviderExtensions_ForumProviderParticipantsRequest_Participants.htm)|  
[ServiceMessageMode](P_Tessa_Forums_ForumProviderExtensions_ForumProviderParticipantsRequest_ServiceMessageMode.htm)|
Режим добавления служебного сообщения о произошедшем событии (например, о
добавлении участника или роли в топик). По умолчанию
[Enabled](T_Tessa_Forums_ForumServiceMessageMode.htm). Игнорируется при
отправке с клиента.  
[TopicID](P_Tessa_Forums_ForumProviderExtensions_ForumProviderParticipantsRequest_TopicID.htm)|  
[Type](P_Tessa_Forums_ForumProviderExtensions_ForumProviderParticipantsRequest_Type.htm)|  
## __Методы
