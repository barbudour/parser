...
C# __Копировать
    ...
    public class PlainGetModelRequest : StorageSerializable
VB __Копировать
    <SerializableAttribute>
    <DataContractAttribute>
    Public Class PlainGetModelRequest
    	Inherits StorageSerializable
C++ __Копировать
    [SerializableAttribute]
    [DataContractAttribute]
    public ref class PlainGetModelRequest : public StorageSerializable
F# __Копировать
     [<SerializableAttribute>]
    [<DataContractAttribute>]
    type PlainGetModelRequest = 
        class
            inherit StorageSerializable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageSerializable](T_Tessa_Platform_Storage_StorageSerializable.htm) __ PlainGetModelRequest
##  __Конструкторы
[PlainGetModelRequest()](M_Tessa_Views_PlainObjects_PlainGetModelRequest__ctor.htm)|
Конструктор без параметров.  
---|---  
[PlainGetModelRequest(IGetModelRequest)](M_Tessa_Views_PlainObjects_PlainGetModelRequest__ctor_1.htm)|
Конструктор с передачей запроса к сервису представлений для получения списка
...
(Унаследован от
[StorageSerializable](T_Tessa_Platform_Storage_StorageSerializable.htm))  
[DeserializeCore](M_Tessa_Views_PlainObjects_PlainGetModelRequest_DeserializeCore.htm)|
Выполняет десериализацию полей объекта из заданного хранилища.  
...
(Унаследован от
[StorageSerializable](T_Tessa_Platform_Storage_StorageSerializable.htm))  
[SerializeCore](M_Tessa_Views_PlainObjects_PlainGetModelRequest_SerializeCore.htm)|
Выполняет сериализацию полей объекта в заданное хранилище.  
...
[ToGetModelRequest](M_Tessa_Views_PlainObjects_PlainGetModelRequest_ToGetModelRequest.htm)|
Извлечение запроса к сервису представлений для получения списка моделей
представлений.  
