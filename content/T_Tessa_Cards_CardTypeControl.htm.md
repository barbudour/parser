...
Базовый объект, который может включаться в состав блока типа карточки
...
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class CardTypeControl
    	Inherits CardTypeContent
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTypeControl abstract : public CardTypeContent
F# __Копировать
     [<AbstractClassAttribute>]
    [<SerializableAttribute>]
    type CardTypeControl = 
        class
            inherit CardTypeContent
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __[CardTypeContent](T_Tessa_Cards_CardTypeContent.htm) __ CardTypeControl
Derived
[Tessa.Cards.CardTypeCustomControl](T_Tessa_Cards_CardTypeCustomControl.htm)
[Tessa.Cards.CardTypeEntryControl](T_Tessa_Cards_CardTypeEntryControl.htm)
[Tessa.Cards.CardTypeParamControl](T_Tessa_Cards_CardTypeParamControl.htm)
[Tessa.Cards.CardTypeTabControl](T_Tessa_Cards_CardTypeTabControl.htm)
[Tessa.Cards.CardTypeTableControl](T_Tessa_Cards_CardTypeTableControl.htm)
##  __Конструкторы
[CardTypeControl()](M_Tessa_Cards_CardTypeControl__ctor.htm)| Создаёт
экземпляр класса с параметрами по умолчанию.  
---|---  
[CardTypeControl(SerializationInfo,
StreamingContext)](M_Tessa_Cards_CardTypeControl__ctor_1.htm)|  Создаёт
...
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
---|---  
[Create](M_Tessa_Cards_CardTypeControl_Create.htm)|  Создаёт экземпляр класса,
унаследованного от CardTypeControl и описываемого кодом typeCode.  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetTypeCode](M_Tessa_Cards_CardTypeControl_GetTypeCode.htm)|  Возвращает код,
при помощи которого можно определить тип класса, унаследованного от
CardTypeControl.  
...
(Унаследован от [CardTypeContent](T_Tessa_Cards_CardTypeContent.htm))  
[IsRequired](M_Tessa_Cards_CardTypeControl_IsRequired.htm)|  Возвращает
...
[IsVisible](M_Tessa_Cards_CardTypeControl_IsVisible.htm)| Возвращает признак
того, что элемент управления является видимым в интерфейсе.  
...
(Унаследован от
[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm))  
[ResolveControlTypeOrUnknown](M_Tessa_Cards_CardTypeControl_ResolveControlTypeOrUnknown.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SetRequired](M_Tessa_Cards_CardTypeControl_SetRequired.htm)|  Устанавливает
признак того, что значение, редактируемое элементом управления, является
обязательным для заполнения. Если элемент управления не поддерживает установку
такого признака, то действий не выполняется.  
[SetVisible](M_Tessa_Cards_CardTypeControl_SetVisible.htm)|  Устанавливает
...
являющегося наследником для CardTypeControl.  
---|---  
...
наследником для CardTypeControl.  
## __Методы расширения
[DeepClone](M_Tessa_Cards_CardExtensions_DeepClone.htm)|  Выполняет глубокое
клонирование метаинформации по элементу управления CardTypeControl за счёт его
полной сериализации / десериализации.  
