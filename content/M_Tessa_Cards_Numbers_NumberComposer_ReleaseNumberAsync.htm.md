# NumberComposer.ReleaseNumberAsync - метод
...
C# __Копировать
     public Task<bool> ReleaseNumberAsync(
    	INumberContext context,
    	INumberObject number,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Public Function ReleaseNumberAsync ( 
...
C++ __Копировать
     public:
    virtual Task<bool>^ ReleaseNumberAsync(
    	INumberContext^ context, 
    	INumberObject^ number, 
...
#### Реализации
[INumberComposer.ReleaseNumberAsync(INumberContext, INumberObject,
CancellationToken)](M_Tessa_Cards_Numbers_INumberComposer_ReleaseNumberAsync.htm)  
##  __См. также
#### Ссылки
