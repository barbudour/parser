# WfTaskHistoryViewUIExtension - класс
...
C# __Копировать
     public sealed class WfTaskHistoryViewUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class WfTaskHistoryViewUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class WfTaskHistoryViewUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type WfTaskHistoryViewUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ WfTaskHistoryViewUIExtension
##  __Конструкторы
[WfTaskHistoryViewUIExtension](M_Tessa_Extensions_Default_Client_Workflow_Wf_WfTaskHistoryViewUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса WfTaskHistoryViewUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_Workflow_Wf_WfTaskHistoryViewUIExtension_Initialized.htm)|  
(Переопределяет
