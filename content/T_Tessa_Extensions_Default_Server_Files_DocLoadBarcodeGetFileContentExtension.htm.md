# DocLoadBarcodeGetFileContentExtension - класс
...
C# __Копировать
     public sealed class DocLoadBarcodeGetFileContentExtension : CardGetFileContentExtension
VB __Копировать
     Public NotInheritable Class DocLoadBarcodeGetFileContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class DocLoadBarcodeGetFileContentExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type DocLoadBarcodeGetFileContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ DocLoadBarcodeGetFileContentExtension
##  __Конструкторы
[DocLoadBarcodeGetFileContentExtension](M_Tessa_Extensions_Default_Server_Files_DocLoadBarcodeGetFileContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса DocLoadBarcodeGetFileContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Files_DocLoadBarcodeGetFileContentExtension_BeforeRequest.htm)|  
(Переопределяет
