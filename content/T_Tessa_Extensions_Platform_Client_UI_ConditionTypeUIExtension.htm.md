# ConditionTypeUIExtension - класс
...
C# __Копировать
     public sealed class ConditionTypeUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class ConditionTypeUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class ConditionTypeUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type ConditionTypeUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ ConditionTypeUIExtension
##  __Конструкторы
[ConditionTypeUIExtension](M_Tessa_Extensions_Platform_Client_UI_ConditionTypeUIExtension__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_ConditionTypeUIExtension_Initialized.htm)|
