# NumberQueueActionTypeRegistry - класс
...
C# __Копировать
     public sealed class NumberQueueActionTypeRegistry : Registry<Guid, NumberQueueActionType>, 
    	INumberQueueActionTypeRegistry, IRegistry<Guid, NumberQueueActionType>
VB __Копировать
     Public NotInheritable Class NumberQueueActionTypeRegistry
    	Inherits Registry(Of Guid, NumberQueueActionType)
    	Implements INumberQueueActionTypeRegistry, IRegistry(Of Guid, NumberQueueActionType)
C++ __Копировать
     public ref class NumberQueueActionTypeRegistry sealed : public Registry<Guid, NumberQueueActionType^>, 
    	INumberQueueActionTypeRegistry, IRegistry<Guid, NumberQueueActionType^>
F# __Копировать
     [<SealedAttribute>]
    type NumberQueueActionTypeRegistry = 
        class
            inherit Registry<Guid, NumberQueueActionType>
            interface INumberQueueActionTypeRegistry
            interface IRegistry<Guid, NumberQueueActionType>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Registry](T_Tessa_Platform_Registry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [NumberQueueActionType](T_Tessa_Cards_Numbers_NumberQueueActionType.htm)> __ NumberQueueActionTypeRegistry
Implements
    [INumberQueueActionTypeRegistry](T_Tessa_Cards_Numbers_INumberQueueActionTypeRegistry.htm), [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [NumberQueueActionType](T_Tessa_Cards_Numbers_NumberQueueActionType.htm)>
##  __Свойства
