# KrWorkflowActionMethods.KrSigningInitMethod - поле
...
VB __Копировать
     Public Shared ReadOnly KrSigningInitMethod As WorkflowActionMethodDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionMethodDescriptor^ KrSigningInitMethod
F# __Копировать
     static val KrSigningInitMethod: WorkflowActionMethodDescriptor
#### Значение поля
