# PlaceholderCompilationDependencies - класс
...
C# __Копировать
     public sealed class PlaceholderCompilationDependencies : IPlaceholderCompilationDependencies
VB __Копировать
     Public NotInheritable Class PlaceholderCompilationDependencies
    	Implements IPlaceholderCompilationDependencies
C++ __Копировать
     public ref class PlaceholderCompilationDependencies sealed : IPlaceholderCompilationDependencies
F# __Копировать
     [<SealedAttribute>]
    type PlaceholderCompilationDependencies = 
        class
            interface IPlaceholderCompilationDependencies
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ PlaceholderCompilationDependencies
Implements
    [IPlaceholderCompilationDependencies](T_Tessa_Platform_Placeholders_Compilation_IPlaceholderCompilationDependencies.htm)
##  __Конструкторы
[PlaceholderCompilationDependencies](M_Tessa_Compilation_Placeholders_PlaceholderCompilationDependencies__ctor.htm)|
