...
C# __Копировать
     public sealed class KrDocStateNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class KrDocStateNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class KrDocStateNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type KrDocStateNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ KrDocStateNewExtension
##  __Конструкторы
[KrDocStateNewExtension](M_Tessa_Extensions_Default_Server_Cards_KrDocStateNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrDocStateNewExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Cards_KrDocStateNewExtension_BeforeRequest.htm)|  
(Переопределяет
