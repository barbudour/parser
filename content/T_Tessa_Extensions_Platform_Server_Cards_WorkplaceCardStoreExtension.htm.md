# WorkplaceCardStoreExtension - класс
...
C# __Копировать
     public sealed class WorkplaceCardStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class WorkplaceCardStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class WorkplaceCardStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type WorkplaceCardStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ WorkplaceCardStoreExtension
##  __Конструкторы
[WorkplaceCardStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_WorkplaceCardStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса WorkplaceCardStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_WorkplaceCardStoreExtension_BeforeRequest.htm)|  
(Переопределяет
