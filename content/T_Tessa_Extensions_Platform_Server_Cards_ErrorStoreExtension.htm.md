...
C# __Копировать
     public sealed class ErrorStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class ErrorStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class ErrorStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type ErrorStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ ErrorStoreExtension
##  __Конструкторы
[ErrorStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_ErrorStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса ErrorStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Cards_ErrorStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_ErrorStoreExtension_BeforeRequest.htm)|  
(Переопределяет
