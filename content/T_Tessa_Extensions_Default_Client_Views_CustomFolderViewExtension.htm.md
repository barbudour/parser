# CustomFolderViewExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class CustomFolderViewExtension
    	Implements ITreeItemExtension, IWorkplaceExtension(Of ITreeItem)
C++ __Копировать
     public ref class CustomFolderViewExtension sealed : ITreeItemExtension, 
    	IWorkplaceExtension<ITreeItem^>
F# __Копировать
     [<SealedAttribute>]
    type CustomFolderViewExtension = 
        class
            interface ITreeItemExtension
            interface IWorkplaceExtension<ITreeItem>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CustomFolderViewExtension
Implements
...
##  __Конструкторы
[CustomFolderViewExtension](M_Tessa_Extensions_Default_Client_Views_CustomFolderViewExtension__ctor.htm)|
Инициализирует новый экземпляр класса CustomFolderViewExtension  
---|---  
##  __Методы
[Clone](M_Tessa_Extensions_Default_Client_Views_CustomFolderViewExtension_Clone.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialize](M_Tessa_Extensions_Default_Client_Views_CustomFolderViewExtension_Initialize.htm)|
Вызывается после создания модели model  
[Initialized](M_Tessa_Extensions_Default_Client_Views_CustomFolderViewExtension_Initialized.htm)|
