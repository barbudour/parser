# CreateAndSelectToolbarUIExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class CreateAndSelectToolbarUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class CreateAndSelectToolbarUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type CreateAndSelectToolbarUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ CreateAndSelectToolbarUIExtension
##  __Конструкторы
[CreateAndSelectToolbarUIExtension](M_Tessa_Extensions_Default_Client_UI_CreateAndSelectToolbarUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса CreateAndSelectToolbarUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_CreateAndSelectToolbarUIExtension_Initialized.htm)|  
(Переопределяет
