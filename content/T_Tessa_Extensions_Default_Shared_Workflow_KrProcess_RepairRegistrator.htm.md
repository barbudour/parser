...
##  __Конструкторы
[RepairRegistrator](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_RepairRegistrator__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterExtensions](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_RepairRegistrator_RegisterExtensions.htm)|  
(Переопределяет
