...
C# __Копировать
     public abstract class TaskNotificationStorage : StorageObject, 
    	ITaskNotificationInfo
VB __Копировать
     Public MustInherit Class TaskNotificationStorage
    	Inherits StorageObject
    	Implements ITaskNotificationInfo
C++ __Копировать
     public ref class TaskNotificationStorage abstract : public StorageObject, 
    	ITaskNotificationInfo
F# __Копировать
     [<AbstractClassAttribute>]
    type TaskNotificationStorage = 
        class
            inherit StorageObject
            interface ITaskNotificationInfo
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ TaskNotificationStorage
Derived
[Tessa.Extensions.Default.Chronos.Notices.AutoAprovedTaskNotificationInfo](T_Tessa_Extensions_Default_Chronos_Notices_AutoAprovedTaskNotificationInfo.htm)
[Tessa.Extensions.Default.Chronos.Notices.TaskNotificationInfo](T_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationInfo.htm)
Implements
    [ITaskNotificationInfo](T_Tessa_Extensions_Default_Chronos_Notices_ITaskNotificationInfo.htm)
##  __Конструкторы
[TaskNotificationStorage](M_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage__ctor.htm)|
Инициализирует новый экземпляр класса TaskNotificationStorage  
---|---  
##  __Свойства
