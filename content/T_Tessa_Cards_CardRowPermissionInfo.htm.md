# CardRowPermissionInfo - класс
Содержит права доступа на отдельные строки коллекционной или древовидной
секции.
## __Definition
...
C# __Копировать
    ...
    public sealed class CardRowPermissionInfo : CardStorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardRowPermissionInfo
    	Inherits CardStorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class CardRowPermissionInfo sealed : public CardStorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardRowPermissionInfo = 
        class
            inherit CardStorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __ CardRowPermissionInfo
##  __Конструкторы
[CardRowPermissionInfo](M_Tessa_Cards_CardRowPermissionInfo__ctor.htm)|
...
## __Методы
[Clean](M_Tessa_Cards_CardRowPermissionInfo_Clean.htm)| Выполняет очистку
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Cards_CardRowPermissionInfo_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[IsEmpty](M_Tessa_Cards_CardRowPermissionInfo_IsEmpty.htm)|  Возвращает
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[RepairStorage](M_Tessa_Cards_CardRowPermissionInfo_RepairStorage.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[SetFieldPermissions](M_Tessa_Cards_CardRowPermissionInfo_SetFieldPermissions.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[SetRowPermissions](M_Tessa_Cards_CardRowPermissionInfo_SetRowPermissions.htm)|
...
не найден.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetFieldPermissions](M_Tessa_Cards_CardRowPermissionInfo_TryGetFieldPermissions.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardRowPermissionInfo_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
