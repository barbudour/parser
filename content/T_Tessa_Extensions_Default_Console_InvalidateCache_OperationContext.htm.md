...
##  __Конструкторы
[OperationContext](M_Tessa_Extensions_Default_Console_InvalidateCache_OperationContext__ctor.htm)|
Инициализирует новый экземпляр класса OperationContext  
---|---  
##  __Свойства
[CacheNames](P_Tessa_Extensions_Default_Console_InvalidateCache_OperationContext_CacheNames.htm)|
Не равно null. Пустой массив приводит к сбросу кэшей.  
---|---  
## __Методы
