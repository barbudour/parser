# WorkflowProcessInstanceUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class WorkflowProcessInstanceUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class WorkflowProcessInstanceUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class WorkflowProcessInstanceUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type WorkflowProcessInstanceUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ WorkflowProcessInstanceUIExtension
##  __Конструкторы
[WorkflowProcessInstanceUIExtension](M_Tessa_Extensions_Platform_Client_UI_WorkflowProcessInstanceUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowProcessInstanceUIExtension  
---|---  
##  __Методы
[ContextInitialized](M_Tessa_Extensions_Platform_Client_UI_WorkflowProcessInstanceUIExtension_ContextInitialized.htm)|  
(Переопределяет
[CardUIExtension.ContextInitialized(ICardUIExtensionContext)](M_Tessa_UI_Cards_CardUIExtension_ContextInitialized.htm))  
---|---  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_WorkflowProcessInstanceUIExtension_Initialized.htm)|  
(Переопределяет
