# WorkflowTaskSubscriptionStorage - класс
##  __Definition
 **Пространство имён:** [Tessa.Workflow.Storage](N_Tessa_Workflow_Storage.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class WorkflowTaskSubscriptionStorage : WorkflowSubscriptionStorageBase
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowTaskSubscriptionStorage
    	Inherits WorkflowSubscriptionStorageBase
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowTaskSubscriptionStorage sealed : public WorkflowSubscriptionStorageBase
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowTaskSubscriptionStorage = 
        class
            inherit WorkflowSubscriptionStorageBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __[WorkflowSubscriptionStorageBase](T_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase.htm) __ WorkflowTaskSubscriptionStorage
##  __Конструкторы
[WorkflowTaskSubscriptionStorage()](M_Tessa_Workflow_Storage_WorkflowTaskSubscriptionStorage__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowTaskSubscriptionStorage  
---|---  
[WorkflowTaskSubscriptionStorage(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowTaskSubscriptionStorage__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowTaskSubscriptionStorage  
[WorkflowTaskSubscriptionStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowTaskSubscriptionStorage__ctor_3.htm)|
Инициализирует новый экземпляр класса WorkflowTaskSubscriptionStorage  
[WorkflowTaskSubscriptionStorage(Guid, Guid,
Guid)](M_Tessa_Workflow_Storage_WorkflowTaskSubscriptionStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowTaskSubscriptionStorage  
##  __Свойства
...
(Унаследован от
[WorkflowSubscriptionStorageBase](T_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase.htm))  
[TaskID](P_Tessa_Workflow_Storage_WorkflowTaskSubscriptionStorage_TaskID.htm)|
ID задания  
## __Методы
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[Clone](M_Tessa_Workflow_Storage_WorkflowTaskSubscriptionStorage_Clone.htm)|  
(Переопределяет
