# KrPermissionRuleDeleteExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Class KrPermissionRuleDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class KrPermissionRuleDeleteExtension : public CardDeleteExtension
F# __Копировать
     type KrPermissionRuleDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ KrPermissionRuleDeleteExtension
##  __Конструкторы
[KrPermissionRuleDeleteExtension](M_Tessa_Extensions_Default_Server_Cards_KrPermissionRuleDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrPermissionRuleDeleteExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Server_Cards_KrPermissionRuleDeleteExtension_AfterRequest.htm)|  
(Переопределяет
