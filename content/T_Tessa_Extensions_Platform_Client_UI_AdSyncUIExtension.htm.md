# AdSyncUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class AdSyncUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class AdSyncUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class AdSyncUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type AdSyncUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ AdSyncUIExtension
##  __Конструкторы
[AdSyncUIExtension](M_Tessa_Extensions_Platform_Client_UI_AdSyncUIExtension__ctor.htm)|
