# KrConstants.KrProcessManagementStageSettingsVirtual.StageGroupName - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly StageGroupName As String
C++ __Копировать
     public:
    static initonly String^ StageGroupName
F# __Копировать
     static val StageGroupName: string
#### Значение поля
