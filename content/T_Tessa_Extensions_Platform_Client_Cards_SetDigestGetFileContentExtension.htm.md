# SetDigestGetFileContentExtension - класс
...
C# __Копировать
     public sealed class SetDigestGetFileContentExtension : CardGetFileContentExtension
VB __Копировать
     Public NotInheritable Class SetDigestGetFileContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class SetDigestGetFileContentExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type SetDigestGetFileContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ SetDigestGetFileContentExtension
##  __Конструкторы
[SetDigestGetFileContentExtension](M_Tessa_Extensions_Platform_Client_Cards_SetDigestGetFileContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса SetDigestGetFileContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Client_Cards_SetDigestGetFileContentExtension_BeforeRequest.htm)|  
(Переопределяет
