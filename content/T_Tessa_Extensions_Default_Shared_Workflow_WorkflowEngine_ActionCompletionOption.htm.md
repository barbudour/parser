...
VB __Копировать
     Public NotInheritable Class ActionCompletionOption
C++ __Копировать
     public ref class ActionCompletionOption sealed
F# __Копировать
     [<SealedAttribute>]
    type ActionCompletionOption = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ActionCompletionOption
##  __Конструкторы
[ActionCompletionOption](M_Tessa_Extensions_Default_Shared_Workflow_WorkflowEngine_ActionCompletionOption__ctor.htm)|
Инициализирует новый экземпляр класса ActionCompletionOption.  
---|---  
## __Свойства
