...
C# __Копировать
     public sealed class EdsManagerInterceptor : ViewInterceptorBase
VB __Копировать
     Public NotInheritable Class EdsManagerInterceptor
    	Inherits ViewInterceptorBase
C++ __Копировать
     public ref class EdsManagerInterceptor sealed : public ViewInterceptorBase
F# __Копировать
     [<SealedAttribute>]
    type EdsManagerInterceptor = 
        class
            inherit ViewInterceptorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ViewInterceptorBase](T_Tessa_Views_ViewInterceptorBase.htm) __ EdsManagerInterceptor
##  __Конструкторы
[EdsManagerInterceptor](M_Tessa_Extensions_Default_Server_EDS_EdsManagerInterceptor__ctor.htm)|
Инициализирует новый экземпляр класса EdsManagerInterceptor  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetDataAsync](M_Tessa_Extensions_Default_Server_EDS_EdsManagerInterceptor_GetDataAsync.htm)|
