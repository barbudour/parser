...
C# __Копировать
     public sealed class DeletedCardGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class DeletedCardGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class DeletedCardGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type DeletedCardGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ DeletedCardGetExtension
##  __Конструкторы
[DeletedCardGetExtension](M_Tessa_Extensions_Platform_Server_Cards_DeletedCardGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса DeletedCardGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_DeletedCardGetExtension_AfterRequest.htm)|  
(Переопределяет
