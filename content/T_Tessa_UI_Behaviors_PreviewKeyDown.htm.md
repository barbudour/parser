# PreviewKeyDown - класс
Реагирует при нажатии клавиши по событию
...
C# __Копировать
     public sealed class PreviewKeyDown : Behavior<UIElement>
VB __Копировать
     Public NotInheritable Class PreviewKeyDown
    	Inherits Behavior(Of UIElement)
C++ __Копировать
     public ref class PreviewKeyDown sealed : public Behavior<UIElement^>
F# __Копировать
     [<SealedAttribute>]
    type PreviewKeyDown = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement)> __ PreviewKeyDown
##  __Конструкторы
[PreviewKeyDown](M_Tessa_UI_Behaviors_PreviewKeyDown__ctor.htm)|
Инициализирует новый экземпляр класса PreviewKeyDown  
---|---  
##  __Свойства
...
[Command](P_Tessa_UI_Behaviors_PreviewKeyDown_Command.htm)|  Команда, которая
выполняется при нажатии клавиши. В параметрах команды передаётся объект
[KeyEventArgs](https://learn.microsoft.com/dotnet/api/system.windows.input.keyeventargs)
с информацией по нажатой клавише.  
...
(Унаследован от
[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject))  
[HandleEvents](P_Tessa_UI_Behaviors_PreviewKeyDown_HandleEvents.htm)|  Признак
того, что для успешно выполненной команды в аргументах события
[KeyEventArgs](https://learn.microsoft.com/dotnet/api/system.windows.input.keyeventargs)
ставится
[Handled](https://learn.microsoft.com/dotnet/api/system.windows.routedeventargs.handled#system-
windows-routedeventargs-handled) равный true.  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_PreviewKeyDown_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_PreviewKeyDown_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_PreviewKeyDown_OnDetaching.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[CommandProperty](F_Tessa_UI_Behaviors_PreviewKeyDown_CommandProperty.htm)|  
---|---  
[HandleEventsProperty](F_Tessa_UI_Behaviors_PreviewKeyDown_HandleEventsProperty.htm)|  
## __См. также
#### Ссылки
