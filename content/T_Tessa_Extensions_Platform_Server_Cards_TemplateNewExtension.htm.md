...
C# __Копировать
     public sealed class TemplateNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class TemplateNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class TemplateNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type TemplateNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ TemplateNewExtension
##  __Конструкторы
[TemplateNewExtension](M_Tessa_Extensions_Platform_Server_Cards_TemplateNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса TemplateNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_TemplateNewExtension_AfterRequest.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_TemplateNewExtension_BeforeRequest.htm)|  
(Переопределяет
