# CardInTemplateUIExtension - класс
...
C# __Копировать
     public sealed class CardInTemplateUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class CardInTemplateUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class CardInTemplateUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type CardInTemplateUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ CardInTemplateUIExtension
##  __Конструкторы
[CardInTemplateUIExtension](M_Tessa_Extensions_Platform_Client_UI_CardInTemplateUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса CardInTemplateUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Reopened](M_Tessa_Extensions_Platform_Client_UI_CardInTemplateUIExtension_Reopened.htm)|  
(Переопределяет
[CardUIExtension.Reopened(ICardUIExtensionContext)](M_Tessa_UI_Cards_CardUIExtension_Reopened.htm))  
[Reopening](M_Tessa_Extensions_Platform_Client_UI_CardInTemplateUIExtension_Reopening.htm)|  
(Переопределяет
[CardUIExtension.Reopening(ICardUIExtensionContext)](M_Tessa_UI_Cards_CardUIExtension_Reopening.htm))  
[Saving](M_Tessa_Extensions_Platform_Client_UI_CardInTemplateUIExtension_Saving.htm)|  
(Переопределяет
