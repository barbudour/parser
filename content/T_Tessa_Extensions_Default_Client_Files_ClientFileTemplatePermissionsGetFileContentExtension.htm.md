# ClientFileTemplatePermissionsGetFileContentExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class ClientFileTemplatePermissionsGetFileContentExtension : CardGetFileContentExtension
VB __Копировать
     Public NotInheritable Class ClientFileTemplatePermissionsGetFileContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class ClientFileTemplatePermissionsGetFileContentExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type ClientFileTemplatePermissionsGetFileContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ ClientFileTemplatePermissionsGetFileContentExtension
##  __Конструкторы
[ClientFileTemplatePermissionsGetFileContentExtension](M_Tessa_Extensions_Default_Client_Files_ClientFileTemplatePermissionsGetFileContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса
ClientFileTemplatePermissionsGetFileContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Client_Files_ClientFileTemplatePermissionsGetFileContentExtension_BeforeRequest.htm)|  
(Переопределяет
