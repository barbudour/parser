...
VB __Копировать
     Public NotInheritable Class CardFileManager
    	Implements ICardFileManager
C++ __Копировать
     public ref class CardFileManager sealed : ICardFileManager
F# __Копировать
     [<SealedAttribute>]
    type CardFileManager = 
        class
            interface ICardFileManager
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardFileManager
Implements
    [ICardFileManager](T_Tessa_Cards_ICardFileManager.htm)
##  __Конструкторы
[CardFileManager](M_Tessa_Cards_CardFileManager__ctor.htm)|  Создаёт экземпляр
