# ConfigurationSealedException - класс
...
C# __Копировать
    ...
    public sealed class ConfigurationSealedException : ApplicationException
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class ConfigurationSealedException
    	Inherits ApplicationException
C++ __Копировать
    [SerializableAttribute]
    public ref class ConfigurationSealedException sealed : public ApplicationException
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type ConfigurationSealedException = 
        class
            inherit ApplicationException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception) __ ConfigurationSealedException
##  __Конструкторы
[ConfigurationSealedException()](M_Tessa_Platform_Runtime_ConfigurationSealedException__ctor.htm)|
Создаёт экземпляр класса с параметрами по умолчанию.  
---|---  
[ConfigurationSealedException(String)](M_Tessa_Platform_Runtime_ConfigurationSealedException__ctor_1.htm)|
Создаёт экземпляр класса с указанием сообщения, описывающего возникшее
исключение.  
[ConfigurationSealedException(String,
Exception)](M_Tessa_Platform_Runtime_ConfigurationSealedException__ctor_2.htm)|
Создаёт экземпляр класса с указанием сообщения, описывающего возникшее
