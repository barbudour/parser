# ExportGetFileContentExtension - класс
...
C# __Копировать
     public sealed class ExportGetFileContentExtension : CardGetFileContentExtension
VB __Копировать
     Public NotInheritable Class ExportGetFileContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class ExportGetFileContentExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type ExportGetFileContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ ExportGetFileContentExtension
##  __Конструкторы
[ExportGetFileContentExtension](M_Tessa_Extensions_Platform_Server_Export_ExportGetFileContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса ExportGetFileContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Export_ExportGetFileContentExtension_BeforeRequest.htm)|
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Platform.Server.Export - пространство
имён](N_Tessa_Extensions_Platform_Server_Export.htm)
