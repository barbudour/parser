# ValidationInfoStorageObject - класс
...
C# __Копировать
    ...
    public abstract class ValidationInfoStorageObject : ValidationStorageObject
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class ValidationInfoStorageObject
    	Inherits ValidationStorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class ValidationInfoStorageObject abstract : public ValidationStorageObject
F# __Копировать
     [<AbstractClassAttribute>]
    [<SerializableAttribute>]
    type ValidationInfoStorageObject = 
        class
            inherit ValidationStorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __ ValidationInfoStorageObject
Derived
[Tessa.Platform.Initialization.InitializationRequest](T_Tessa_Platform_Initialization_InitializationRequest.htm)
[Tessa.Platform.Initialization.InitializationResponse](T_Tessa_Platform_Initialization_InitializationResponse.htm)
[Tessa.Platform.Operations.OperationRequest](T_Tessa_Platform_Operations_OperationRequest.htm)
[Tessa.Platform.Operations.OperationResponse](T_Tessa_Platform_Operations_OperationResponse.htm)
##  __Конструкторы
[ValidationInfoStorageObject(Dictionary<String,
Object>)](M_Tessa_Platform_Validation_ValidationInfoStorageObject__ctor.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
---|---  
[ValidationInfoStorageObject(SerializationInfo,
StreamingContext)](M_Tessa_Platform_Validation_ValidationInfoStorageObject__ctor_1.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Platform_Validation_ValidationInfoStorageObject_EnsureCacheResolved.htm)|
...
##  __Поля
[InfoKey](F_Tessa_Platform_Validation_ValidationInfoStorageObject_InfoKey.htm)|  
---|---  
## __Методы расширения
