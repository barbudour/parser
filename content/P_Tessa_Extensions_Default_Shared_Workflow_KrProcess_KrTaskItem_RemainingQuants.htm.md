# KrTaskItem.RemainingQuants - свойство
...
VB __Копировать
     Public Property RemainingQuants As Integer?
    	Get
    	Set
C++ __Копировать
     public:
    property Nullable<int> RemainingQuants {
    	Nullable<int> get ();
    	void set (Nullable<int> value);
    }
F# __Копировать
     member RemainingQuants : Nullable<int> with get, set
#### Значение свойства
