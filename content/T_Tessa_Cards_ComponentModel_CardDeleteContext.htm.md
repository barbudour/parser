...
C# __Копировать
     public sealed class CardDeleteContext
VB __Копировать
     Public NotInheritable Class CardDeleteContext
C++ __Копировать
     public ref class CardDeleteContext sealed
F# __Копировать
     [<SealedAttribute>]
    type CardDeleteContext = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardDeleteContext
##  __Конструкторы
[CardDeleteContext](M_Tessa_Cards_ComponentModel_CardDeleteContext__ctor.htm)|
