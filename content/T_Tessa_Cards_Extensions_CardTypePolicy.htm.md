# CardTypePolicy - класс
Политика, определяющая допустимость любого из заданных имён или
идентификаторов типов карточек для выполнения методов расширения.
## __Definition
 **Пространство имён:** [Tessa.Cards.Extensions](N_Tessa_Cards_Extensions.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class CardTypePolicy : CardTypePolicyBase, 
    	ICardTypePolicy, IExtensionPolicy
VB __Копировать
     Public NotInheritable Class CardTypePolicy
    	Inherits CardTypePolicyBase
    	Implements ICardTypePolicy, IExtensionPolicy
C++ __Копировать
     public ref class CardTypePolicy sealed : public CardTypePolicyBase, 
    	ICardTypePolicy, IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type CardTypePolicy = 
        class
            inherit CardTypePolicyBase
            interface ICardTypePolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardTypePolicyBase](T_Tessa_Cards_Extensions_CardTypePolicyBase.htm) __ CardTypePolicy
Implements
    [ICardTypePolicy](T_Tessa_Cards_Extensions_ICardTypePolicy.htm), [IExtensionPolicy](T_Tessa_Extensions_IExtensionPolicy.htm)
##  __Заметки
