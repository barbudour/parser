...
C# __Копировать
     public sealed class CardContentContext
VB __Копировать
     Public NotInheritable Class CardContentContext
C++ __Копировать
     public ref class CardContentContext sealed
F# __Копировать
     [<SealedAttribute>]
    type CardContentContext = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardContentContext
##  __Конструкторы
