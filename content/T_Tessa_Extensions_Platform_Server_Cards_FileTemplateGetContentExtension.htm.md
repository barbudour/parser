# FileTemplateGetContentExtension - класс
...
C# __Копировать
     public sealed class FileTemplateGetContentExtension : CardGetFileContentExtension
VB __Копировать
     Public NotInheritable Class FileTemplateGetContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class FileTemplateGetContentExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type FileTemplateGetContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ FileTemplateGetContentExtension
##  __Конструкторы
[FileTemplateGetContentExtension](M_Tessa_Extensions_Platform_Server_Cards_FileTemplateGetContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса FileTemplateGetContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_FileTemplateGetContentExtension_BeforeRequest.htm)|  
(Переопределяет
