# GetClientExtensionResponse - класс
...
C++ __Копировать
     public ref class GetClientExtensionResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ GetClientExtensionResponse
##  __Свойства
[ClientExtensions](P_Tessa_Exchange_WebServices_Data_GetClientExtensionResponse_ClientExtensions.htm)|
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[RawMasterTableXml](P_Tessa_Exchange_WebServices_Data_GetClientExtensionResponse_RawMasterTableXml.htm)|
