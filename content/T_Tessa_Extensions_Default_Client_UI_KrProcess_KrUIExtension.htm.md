...
VB __Копировать
     Public NotInheritable Class KrUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrUIExtension = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrUIExtension
##  __Конструкторы
[KrUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrUIExtension_Initialized.htm)|
