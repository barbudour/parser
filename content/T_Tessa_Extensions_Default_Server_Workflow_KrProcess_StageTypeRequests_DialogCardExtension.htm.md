...
VB __Копировать
     Public NotInheritable Class DialogCardExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class DialogCardExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type DialogCardExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ DialogCardExtension
##  __Конструкторы
[DialogCardExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_StageTypeRequests_DialogCardExtension__ctor.htm)|
Инициализирует новый экземпляр класса DialogCardExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_StageTypeRequests_DialogCardExtension_AfterRequest.htm)|
