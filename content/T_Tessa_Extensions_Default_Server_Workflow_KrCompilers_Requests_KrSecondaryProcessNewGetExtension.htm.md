# KrSecondaryProcessNewGetExtension - класс
Класс расширений
...
VB __Копировать
     Public NotInheritable Class KrSecondaryProcessNewGetExtension
    	Inherits KrTemplateNewGetExtension
C++ __Копировать
     public ref class KrSecondaryProcessNewGetExtension sealed : public KrTemplateNewGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrSecondaryProcessNewGetExtension = 
        class
            inherit KrTemplateNewGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewGetExtension](T_Tessa_Cards_Extensions_CardNewGetExtension.htm) __[KrTemplateNewGetExtension](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrTemplateNewGetExtension.htm) __ KrSecondaryProcessNewGetExtension
##  __Конструкторы
[KrSecondaryProcessNewGetExtension](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrSecondaryProcessNewGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrSecondaryProcessNewGetExtension.  
---|---  
## __Методы
[AfterRequest(ICardGetExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrSecondaryProcessNewGetExtension_AfterRequest.htm)|
Действие, выполняемое после получения карточки как при успешном, так и при
неудачном результате.  
(Переопределяет
[KrTemplateNewGetExtension.AfterRequest(ICardGetExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrTemplateNewGetExtension_AfterRequest.htm))  
---|---  
[AfterRequest(ICardNewExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrSecondaryProcessNewGetExtension_AfterRequest_1.htm)|
Действие, выполняемое после создания структуры карточки как при успешном, так
и при неудачном результате.  
(Переопределяет
[KrTemplateNewGetExtension.AfterRequest(ICardNewExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrTemplateNewGetExtension_AfterRequest_1.htm))  
