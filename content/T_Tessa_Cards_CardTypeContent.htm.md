# CardTypeContent - класс
Базовый объект для [CardTypeControl](T_Tessa_Cards_CardTypeControl.htm) и
...
C# __Копировать
    ...
    public abstract class CardTypeContent : CardSchemeSerializableObject, 
    	IEquatable<CardTypeContent>, ICardMetadataOrderable
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class CardTypeContent
    	Inherits CardSchemeSerializableObject
    	Implements IEquatable(Of CardTypeContent), ICardMetadataOrderable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTypeContent abstract : public CardSchemeSerializableObject, 
    	IEquatable<CardTypeContent^>, ICardMetadataOrderable
F# __Копировать
    ...
    type CardTypeContent = 
        class
            ...
            interface IEquatable<CardTypeContent>
            interface ICardMetadataOrderable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __ CardTypeContent
Derived
[Tessa.Cards.CardTypeBlock](T_Tessa_Cards_CardTypeBlock.htm)
[Tessa.Cards.CardTypeColumn](T_Tessa_Cards_CardTypeColumn.htm)
[Tessa.Cards.CardTypeControl](T_Tessa_Cards_CardTypeControl.htm)
Implements
    [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)<CardTypeContent>, [ICardMetadataOrderable](T_Tessa_Cards_ICardMetadataOrderable.htm)
##  __Конструкторы
[CardTypeContent()](M_Tessa_Cards_CardTypeContent__ctor.htm)| Создаёт
экземпляр класса с параметрами по умолчанию.  
---|---  
[CardTypeContent(SerializationInfo,
StreamingContext)](M_Tessa_Cards_CardTypeContent__ctor_1.htm)|  Создаёт
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeAttributeFromXml](M_Tessa_Cards_CardTypeContent_DeserializeAttributeFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_CardTypeContent_DeserializeFromBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_CardTypeContent_DeserializeFromStorageInternal.htm)|
...
[EqualsInternal](M_Tessa_Cards_CardTypeContent_EqualsInternal.htm)| Сравнивает
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_CardTypeContent_OnDeserializing.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeAttributesToXml](M_Tessa_Cards_CardTypeContent_SerializeAttributesToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_CardTypeContent_SerializeToBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_CardTypeContent_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
