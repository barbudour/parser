# SaveCardModelSettingsRequestExtension - класс
...
C# __Копировать
     public sealed class SaveCardModelSettingsRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class SaveCardModelSettingsRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class SaveCardModelSettingsRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type SaveCardModelSettingsRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ SaveCardModelSettingsRequestExtension
##  __Конструкторы
[SaveCardModelSettingsRequestExtension](M_Tessa_Extensions_Platform_Server_Roles_SaveCardModelSettingsRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса SaveCardModelSettingsRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_SaveCardModelSettingsRequestExtension_AfterRequest.htm)|  
(Переопределяет
