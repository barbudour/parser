# CheckRequestGetExtension - класс
...
C# __Копировать
     public sealed class CheckRequestGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class CheckRequestGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class CheckRequestGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type CheckRequestGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ CheckRequestGetExtension
##  __Конструкторы
[CheckRequestGetExtension](M_Tessa_Extensions_Platform_Server_Cards_CheckRequestGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса CheckRequestGetExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_CheckRequestGetExtension_BeforeRequest.htm)|  
(Переопределяет
