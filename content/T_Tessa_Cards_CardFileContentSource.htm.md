# CardFileContentSource - класс
Информация по источнику контента для файла. Используется, например, для того,
чтобы файлы карточки, созданной из шаблона, указывали на файлы шаблона.
## __Definition
 **Пространство имён:** [Tessa.Cards](N_Tessa_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class CardFileContentSource : CardStorageObject, 
    	ICardFileContentSource, ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardFileContentSource
    	Inherits CardStorageObject
    	Implements ICardFileContentSource, ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardFileContentSource sealed : public CardStorageObject, 
    	ICardFileContentSource, ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardFileContentSource = 
        class
            inherit CardStorageObject
            interface ICardFileContentSource
            interface ICloneable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __ CardFileContentSource
Implements
    [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable), [ICardFileContentSource](T_Tessa_Cards_ICardFileContentSource.htm)
##  __Конструкторы
[CardFileContentSource()](M_Tessa_Cards_CardFileContentSource__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[CardFileContentSource(Dictionary<String,
Object>)](M_Tessa_Cards_CardFileContentSource__ctor_1.htm)| Создаёт экземпляр
класса с указанием хранилища, декоратором для которого является создаваемый
объект.  
[CardFileContentSource(ICardFileContentSource)](M_Tessa_Cards_CardFileContentSource__ctor_2.htm)|
Создаёт экземпляр класса с копированием всех свойств в текущий объект.  
[CardFileContentSource(IStorageObjectProvider)](M_Tessa_Cards_CardFileContentSource__ctor_3.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_CardFileContentSource_Clone.htm)|  Выполняет глубокое
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[RepairStorage](M_Tessa_Cards_CardFileContentSource_RepairStorage.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardFileContentSource_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
