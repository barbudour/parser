# NumberExtensions.AcquireReservedNumberAsync - метод
...
C# __Копировать
     public static Task<bool> AcquireReservedNumberAsync(
...
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function AcquireReservedNumberAsync ( 
...
C++ __Копировать
     public:
    [ExtensionAttribute]
    static Task<bool>^ AcquireReservedNumberAsync(
...
F# __Копировать
     [<ExtensionAttribute>]
    static member AcquireReservedNumberAsync : 
...
true, если номер, указанный в объекте context, успешно выделен; false в
противном случае.
