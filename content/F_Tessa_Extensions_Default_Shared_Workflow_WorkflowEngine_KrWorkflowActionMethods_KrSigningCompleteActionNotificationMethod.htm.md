# KrWorkflowActionMethods.KrSigningCompleteActionNotificationMethod - поле
...
VB __Копировать
     Public Shared ReadOnly KrSigningCompleteActionNotificationMethod As WorkflowActionMethodDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionMethodDescriptor^ KrSigningCompleteActionNotificationMethod
F# __Копировать
     static val KrSigningCompleteActionNotificationMethod: WorkflowActionMethodDescriptor
#### Значение поля
