...
Коллекция, содержащая объекты [CardType](T_Tessa_Cards_CardType.htm).
## __Definition
 **Пространство имён:** [Tessa.Cards](N_Tessa_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class CardTypeCollection : CardSerializableEntryCollection<CardType>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardTypeCollection
    	Inherits CardSerializableEntryCollection(Of CardType)
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTypeCollection sealed : public CardSerializableEntryCollection<CardType^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardTypeCollection = 
        class
            inherit CardSerializableEntryCollection<CardType>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __[CardSerializableEntryCollection](T_Tessa_Cards_CardSerializableEntryCollection_1.htm)<[CardType](T_Tessa_Cards_CardType.htm)> __ CardTypeCollection
##  __Конструкторы
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[XmlElementNameInternal](P_Tessa_Cards_CardTypeCollection_XmlElementNameInternal.htm)|
...
[XmlItemNameInternal](P_Tessa_Cards_CardTypeCollection_XmlItemNameInternal.htm)|
