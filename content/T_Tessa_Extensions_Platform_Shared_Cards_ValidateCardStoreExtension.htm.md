# ValidateCardStoreExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Shared.Cards](N_Tessa_Extensions_Platform_Shared_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class ValidateCardStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class ValidateCardStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class ValidateCardStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type ValidateCardStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ ValidateCardStoreExtension
##  __Конструкторы
[ValidateCardStoreExtension](M_Tessa_Extensions_Platform_Shared_Cards_ValidateCardStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса ValidateCardStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Shared_Cards_ValidateCardStoreExtension_BeforeRequest.htm)|  
(Переопределяет
