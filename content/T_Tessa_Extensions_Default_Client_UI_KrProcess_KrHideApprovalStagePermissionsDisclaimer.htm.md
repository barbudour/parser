# KrHideApprovalStagePermissionsDisclaimer - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class KrHideApprovalStagePermissionsDisclaimer : CardUIExtension
VB __Копировать
     Public NotInheritable Class KrHideApprovalStagePermissionsDisclaimer
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrHideApprovalStagePermissionsDisclaimer sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrHideApprovalStagePermissionsDisclaimer = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrHideApprovalStagePermissionsDisclaimer
##  __Конструкторы
[KrHideApprovalStagePermissionsDisclaimer](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrHideApprovalStagePermissionsDisclaimer__ctor.htm)|
Инициализирует новый экземпляр класса KrHideApprovalStagePermissionsDisclaimer  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrHideApprovalStagePermissionsDisclaimer_Initialized.htm)|  
(Переопределяет
