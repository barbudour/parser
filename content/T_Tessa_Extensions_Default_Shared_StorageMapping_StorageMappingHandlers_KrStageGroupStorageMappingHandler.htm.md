# KrStageGroupStorageMappingHandler - класс
...
VB __Копировать
     Public Class KrStageGroupStorageMappingHandler
    	Implements IStorageMappingHandler
C++ __Копировать
     public ref class KrStageGroupStorageMappingHandler : IStorageMappingHandler
F# __Копировать
     type KrStageGroupStorageMappingHandler = 
        class
            interface IStorageMappingHandler
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ KrStageGroupStorageMappingHandler
Implements
    [IStorageMappingHandler](T_Tessa_Platform_Storage_Mapping_IStorageMappingHandler.htm)
##  __Конструкторы
[KrStageGroupStorageMappingHandler](M_Tessa_Extensions_Default_Shared_StorageMapping_StorageMappingHandlers_KrStageGroupStorageMappingHandler__ctor.htm)|
Инициализирует новый экземпляр класса KrStageGroupStorageMappingHandler  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetContentMappings](M_Tessa_Extensions_Default_Shared_StorageMapping_StorageMappingHandlers_KrStageGroupStorageMappingHandler_GetContentMappings.htm)|
