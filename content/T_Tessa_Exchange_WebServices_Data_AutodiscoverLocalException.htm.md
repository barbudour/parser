# AutodiscoverLocalException - класс
...
C++ __Копировать
     public ref class AutodiscoverLocalException : public ServiceLocalException
F# __Копировать
     type AutodiscoverLocalException = 
        class
            inherit ServiceLocalException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceLocalException](T_Tessa_Exchange_WebServices_Data_ServiceLocalException.htm) __ AutodiscoverLocalException
##  __Конструкторы
[AutodiscoverLocalException()](M_Tessa_Exchange_WebServices_Data_AutodiscoverLocalException__ctor.htm)|
Initializes a new instance of the AutodiscoverLocalException class.  
---|---  
[AutodiscoverLocalException(String)](M_Tessa_Exchange_WebServices_Data_AutodiscoverLocalException__ctor_2.htm)|
Initializes a new instance of the AutodiscoverLocalException class.  
[AutodiscoverLocalException(SerializationInfo,
StreamingContext)](M_Tessa_Exchange_WebServices_Data_AutodiscoverLocalException__ctor_1.htm)|
Initializes a new instance of the AutodiscoverLocalException class with
serialized data.  
[AutodiscoverLocalException(String,
Exception)](M_Tessa_Exchange_WebServices_Data_AutodiscoverLocalException__ctor_3.htm)|
Initializes a new instance of the AutodiscoverLocalException class.  
## __Свойства
