# PartnersCardMetadataExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Class PartnersCardMetadataExtension
    	Inherits CardTypeMetadataExtension
C++ __Копировать
     public ref class PartnersCardMetadataExtension : public CardTypeMetadataExtension
F# __Копировать
     type PartnersCardMetadataExtension = 
        class
            inherit CardTypeMetadataExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardMetadataExtension](T_Tessa_Cards_Extensions_CardMetadataExtension.htm) __[CardTypeMetadataExtension](T_Tessa_Cards_Extensions_CardTypeMetadataExtension.htm) __ PartnersCardMetadataExtension
##  __Конструкторы
...
Инициализирует новый экземпляр класса PartnersCardMetadataExtension  
---|---  
...
[ModifyTypes](M_Tessa_Extensions_Default_Shared_Settings_PartnersCardMetadataExtension_ModifyTypes.htm)|  
(Переопределяет
