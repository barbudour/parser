# CheckRoleDeputiesStoreExtension - класс
...
C# __Копировать
     public sealed class CheckRoleDeputiesStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class CheckRoleDeputiesStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class CheckRoleDeputiesStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type CheckRoleDeputiesStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ CheckRoleDeputiesStoreExtension
##  __Конструкторы
[CheckRoleDeputiesStoreExtension](M_Tessa_Extensions_Platform_Server_Roles_CheckRoleDeputiesStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса CheckRoleDeputiesStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Roles_CheckRoleDeputiesStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Roles_CheckRoleDeputiesStoreExtension_BeforeRequest.htm)|  
(Переопределяет
