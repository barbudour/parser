# CardStreamServerStoreComponent - класс
...
C# __Копировать
     public sealed class CardStreamServerStoreComponent : ICardStreamServerStoreComponent
VB __Копировать
     Public NotInheritable Class CardStreamServerStoreComponent
    	Implements ICardStreamServerStoreComponent
C++ __Копировать
     public ref class CardStreamServerStoreComponent sealed : ICardStreamServerStoreComponent
F# __Копировать
     [<SealedAttribute>]
    type CardStreamServerStoreComponent = 
        class
            interface ICardStreamServerStoreComponent
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardStreamServerStoreComponent
Implements
    [ICardStreamServerStoreComponent](T_Tessa_Cards_ComponentModel_ICardStreamServerStoreComponent.htm)
##  __Конструкторы
[CardStreamServerStoreComponent](M_Tessa_Cards_ComponentModel_CardStreamServerStoreComponent__ctor.htm)|
