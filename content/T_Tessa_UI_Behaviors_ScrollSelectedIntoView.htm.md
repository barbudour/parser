# ScrollSelectedIntoView - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Behaviors](N_Tessa_UI_Behaviors.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class ScrollSelectedIntoView : Behavior<ListBox>, 
    	IWeakEventListener
VB __Копировать
     Public NotInheritable Class ScrollSelectedIntoView
    	Inherits Behavior(Of ListBox)
    	Implements IWeakEventListener
C++ __Копировать
     public ref class ScrollSelectedIntoView sealed : public Behavior<ListBox^>, 
    	IWeakEventListener
F# __Копировать
     [<SealedAttribute>]
    type ScrollSelectedIntoView = 
        class
            inherit Behavior<ListBox>
            interface IWeakEventListener
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[ListBox](https://learn.microsoft.com/dotnet/api/system.windows.controls.listbox)> __ ScrollSelectedIntoView
Implements
    [IWeakEventListener](https://learn.microsoft.com/dotnet/api/system.windows.iweakeventlistener)
##  __Конструкторы
[ScrollSelectedIntoView](M_Tessa_UI_Behaviors_ScrollSelectedIntoView__ctor.htm)|
Инициализирует новый экземпляр класса ScrollSelectedIntoView  
---|---  
##  __Свойства
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_ScrollSelectedIntoView_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_ScrollSelectedIntoView_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_ScrollSelectedIntoView_OnDetaching.htm)|  
(Переопределяет
