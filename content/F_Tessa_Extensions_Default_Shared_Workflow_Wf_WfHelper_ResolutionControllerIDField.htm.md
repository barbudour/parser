# WfHelper.ResolutionControllerIDField - поле
...
VB __Копировать
     Public Const ResolutionControllerIDField As String = "ControllerID"
C++ __Копировать
     public:
    literal String^ ResolutionControllerIDField = "ControllerID"
F# __Копировать
     static val mutable ResolutionControllerIDField: string
#### Значение поля
