# KrWorkflowActionMethods.KrAmendingInitMethod - поле
...
VB __Копировать
     Public Shared ReadOnly KrAmendingInitMethod As WorkflowActionMethodDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionMethodDescriptor^ KrAmendingInitMethod
F# __Копировать
     static val KrAmendingInitMethod: WorkflowActionMethodDescriptor
#### Значение поля
