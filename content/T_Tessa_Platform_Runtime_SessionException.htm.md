...
C++ __Копировать
    [SerializableAttribute]
    public ref class SessionException : public ApplicationException
F# __Копировать
     [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception) __ SessionException
##  __Конструкторы
[SessionException(SerializationInfo,
StreamingContext)](M_Tessa_Platform_Runtime_SessionException__ctor.htm)|
...
---|---  
[SessionException(SessionExceptionCode,
String)](M_Tessa_Platform_Runtime_SessionException__ctor_1.htm)|  Создаёт
экземпляр класса с указанием кода ошибки и сообщения, описывающего возникшее
исключение.  
[SessionException(SessionExceptionCode, String,
Exception)](M_Tessa_Platform_Runtime_SessionException__ctor_2.htm)|  Создаёт
экземпляр класса с указанием кода ошибки, сообщения, описывающего возникшее
исключение, и внутреннее исключение, послужившее причиной этому.  
## __Свойства
[Code](P_Tessa_Platform_Runtime_SessionException_Code.htm)|  Код ошибки.  
---|---  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Platform_Runtime_SessionException_GetObjectData.htm)|
...
Возвращает код исключения, выброшенного на сервере как SessionException, или
...
Преобразует исключение SessionException в исключение
[FaultException](https://learn.microsoft.com/dotnet/api/system.servicemodel.faultexception)
