# KrTypesAndCreateBasedOnTileExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrTypesAndCreateBasedOnTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class KrTypesAndCreateBasedOnTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type KrTypesAndCreateBasedOnTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ KrTypesAndCreateBasedOnTileExtension
##  __Конструкторы
[KrTypesAndCreateBasedOnTileExtension](M_Tessa_Extensions_Default_Client_Tiles_KrTypesAndCreateBasedOnTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrTypesAndCreateBasedOnTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_KrTypesAndCreateBasedOnTileExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
##  __Поля
[InitialCaptionKey](F_Tessa_Extensions_Default_Client_Tiles_KrTypesAndCreateBasedOnTileExtension_InitialCaptionKey.htm)|  
---|---  
## __Методы расширения
