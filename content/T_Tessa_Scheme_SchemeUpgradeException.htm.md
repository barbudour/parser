# SchemeUpgradeException - класс
##  __Definition
 **Пространство имён:** [Tessa.Scheme](N_Tessa_Scheme.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public class SchemeUpgradeException : SchemeInitializationException
VB __Копировать
    <SerializableAttribute>
    Public Class SchemeUpgradeException
    	Inherits SchemeInitializationException
C++ __Копировать
    [SerializableAttribute]
    public ref class SchemeUpgradeException : public SchemeInitializationException
F# __Копировать
     [<SerializableAttribute>]
    type SchemeUpgradeException = 
        class
            inherit SchemeInitializationException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[SchemeException](T_Tessa_Scheme_SchemeException.htm) __[SchemeInitializationException](T_Tessa_Scheme_SchemeInitializationException.htm) __ SchemeUpgradeException
##  __Конструкторы
[SchemeUpgradeException](M_Tessa_Scheme_SchemeUpgradeException__ctor.htm)|
Инициализирует новый экземпляр класса SchemeUpgradeException  
---|---  
##  __Свойства
