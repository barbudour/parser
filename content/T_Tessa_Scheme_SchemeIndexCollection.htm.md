# SchemeIndexCollection - класс
##  __Definition
 **Пространство имён:** [Tessa.Scheme](N_Tessa_Scheme.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class SchemeIndexCollection : SchemeNamedObjectCollection<SchemeIndex>
VB __Копировать
     Public NotInheritable Class SchemeIndexCollection
    	Inherits SchemeNamedObjectCollection(Of SchemeIndex)
C++ __Копировать
     public ref class SchemeIndexCollection sealed : public SchemeNamedObjectCollection<SchemeIndex^>
F# __Копировать
     [<SealedAttribute>]
    type SchemeIndexCollection = 
        class
            inherit SchemeNamedObjectCollection<SchemeIndex>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[SchemeObjectCollection](T_Tessa_Scheme_SchemeObjectCollection_1.htm)<[SchemeIndex](T_Tessa_Scheme_SchemeIndex.htm)> __[SchemeNamedObjectCollection](T_Tessa_Scheme_SchemeNamedObjectCollection_1.htm)<[SchemeIndex](T_Tessa_Scheme_SchemeIndex.htm)> __ SchemeIndexCollection
##  __Свойства
...
(Унаследован от
[SchemeObjectCollection<T>](T_Tessa_Scheme_SchemeObjectCollection_1.htm))  
[Construct](M_Tessa_Scheme_SchemeIndexCollection_Construct.htm)|  
(Переопределяет
...
(Унаследован от
[SchemeNamedObjectCollection<T>](T_Tessa_Scheme_SchemeNamedObjectCollection_1.htm))  
[ValidateInsertingItem](M_Tessa_Scheme_SchemeIndexCollection_ValidateInsertingItem.htm)|  
...
(Унаследован от
[SchemeNamedObjectCollection<T>](T_Tessa_Scheme_SchemeNamedObjectCollection_1.htm))  
[ValidateRemovingItem](M_Tessa_Scheme_SchemeIndexCollection_ValidateRemovingItem.htm)|  
(Переопределяет
[SchemeObjectCollection<T>.ValidateRemovingItem(T)](M_Tessa_Scheme_SchemeObjectCollection_1_ValidateRemovingItem.htm))  
##  __События
