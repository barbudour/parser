...
VB __Копировать
     Public NotInheritable Class WorkflowEngineCache
    	Implements IWorkflowEngineCache
C++ __Копировать
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ WorkflowEngineCache
Implements
    [IWorkflowEngineCache](T_Tessa_Workflow_IWorkflowEngineCache.htm)
##  __Конструкторы
[WorkflowEngineCache](M_Tessa_Workflow_WorkflowEngineCache__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowEngineCache  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetAsync](M_Tessa_Workflow_WorkflowEngineCache_GetAsync.htm)|  Метод для
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InvalidateAllAsync](M_Tessa_Workflow_WorkflowEngineCache_InvalidateAllAsync.htm)|
Метод для сброса всех шаблонов процесса из кеша  
[InvalidateAsync](M_Tessa_Workflow_WorkflowEngineCache_InvalidateAsync.htm)|
