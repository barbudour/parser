# IFileEntityCollection<TItem, TCollection> \- методы
##  __Методы
...
(Унаследован от
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<[TItem](T_Tessa_Files_IFileEntityCollection_2.htm)>)  
---|---  
...
(Унаследован от
[IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<[TItem](T_Tessa_Files_IFileEntityCollection_2.htm)>)  
...
(Унаследован от
[IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<[TItem](T_Tessa_Files_IFileEntityCollection_2.htm)>)  
...
##  __См. также
#### Ссылки
[IFileEntityCollection<TItem, TCollection> \-
](T_Tessa_Files_IFileEntityCollection_2.htm)
