# DefaultNumberQueueProcessor.ProcessReleaseAsync - метод
...
C# __Копировать
     protected virtual Task<bool> ProcessReleaseAsync(
...
VB __Копировать
     Protected Overridable Function ProcessReleaseAsync ( 
...
C++ __Копировать
     protected:
    virtual Task<bool>^ ProcessReleaseAsync(
    	INumberContext^ context, 
    	NumberQueue^ queue, 
    	NumberQueueItem^ queueItem, 
    	NumberQueueEventType^ queueEventType, 
