...
C# __Копировать
     public class CustomFolderView : UserControl, 
    	IComponentConnector
VB __Копировать
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[InitializeComponent](M_Tessa_Extensions_Default_Client_Views_CustomFolderView_InitializeComponent.htm)|
InitializeComponent  
