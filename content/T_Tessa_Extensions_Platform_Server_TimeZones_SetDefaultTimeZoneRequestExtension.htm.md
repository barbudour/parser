# SetDefaultTimeZoneRequestExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.TimeZones](N_Tessa_Extensions_Platform_Server_TimeZones.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class SetDefaultTimeZoneRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class SetDefaultTimeZoneRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class SetDefaultTimeZoneRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type SetDefaultTimeZoneRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ SetDefaultTimeZoneRequestExtension
##  __Конструкторы
[SetDefaultTimeZoneRequestExtension](M_Tessa_Extensions_Platform_Server_TimeZones_SetDefaultTimeZoneRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса SetDefaultTimeZoneRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_TimeZones_SetDefaultTimeZoneRequestExtension_AfterRequest.htm)|  
(Переопределяет
