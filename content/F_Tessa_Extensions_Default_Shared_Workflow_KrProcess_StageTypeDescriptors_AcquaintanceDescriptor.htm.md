# StageTypeDescriptors.AcquaintanceDescriptor - поле
...
VB __Копировать
     Public Shared ReadOnly AcquaintanceDescriptor As StageTypeDescriptor
C++ __Копировать
     public:
    static initonly StageTypeDescriptor^ AcquaintanceDescriptor
F# __Копировать
     static val AcquaintanceDescriptor: StageTypeDescriptor
#### Значение поля
