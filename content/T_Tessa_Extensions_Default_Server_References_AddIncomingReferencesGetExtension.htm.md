# AddIncomingReferencesGetExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class AddIncomingReferencesGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class AddIncomingReferencesGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type AddIncomingReferencesGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ AddIncomingReferencesGetExtension
##  __Конструкторы
[AddIncomingReferencesGetExtension](M_Tessa_Extensions_Default_Server_References_AddIncomingReferencesGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса AddIncomingReferencesGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_References_AddIncomingReferencesGetExtension_AfterRequest.htm)|  
(Переопределяет
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Server.References - пространство
имён](N_Tessa_Extensions_Default_Server_References.htm)
