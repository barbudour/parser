...
C# __Копировать
    ...
    public sealed class Card : CardInfoStorageObject, ICloneable
VB __Копировать
    <SerializableAttribute>
...
C++ __Копировать
    [SerializableAttribute]
    public ref class Card sealed : public CardInfoStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Card.[Info](P_Tessa_Cards_CardInfoStorageObject_Info.htm) содержится
информация о позиции этапов.  
(Определяется
[KrProcessSharedExtensions](T_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrProcessSharedExtensions.htm))  
...
Удаляет из Card.[Info](P_Tessa_Cards_CardInfoStorageObject_Info.htm)
...
Задаёт в Card.[Info](P_Tessa_Cards_CardInfoStorageObject_Info.htm) информацию
о позиции этапов.  
(Определяется
[KrProcessSharedExtensions](T_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrProcessSharedExtensions.htm))  
