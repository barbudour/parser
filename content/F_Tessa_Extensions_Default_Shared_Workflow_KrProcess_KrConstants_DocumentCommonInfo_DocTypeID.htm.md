# KrConstants.DocumentCommonInfo.DocTypeID - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Const DocTypeID As String = "DocTypeID"
C++ __Копировать
     public:
    literal String^ DocTypeID = "DocTypeID"
F# __Копировать
     static val mutable DocTypeID: string
#### Значение поля
