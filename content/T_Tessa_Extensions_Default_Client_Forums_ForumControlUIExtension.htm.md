...
VB __Копировать
     Public NotInheritable Class ForumControlUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class ForumControlUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type ForumControlUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ ForumControlUIExtension
##  __Конструкторы
[ForumControlUIExtension](M_Tessa_Extensions_Default_Client_Forums_ForumControlUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса ForumControlUIExtension  
---|---  
##  __Методы
...
(Унаследован от [CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm))  
[Initializing](M_Tessa_Extensions_Default_Client_Forums_ForumControlUIExtension_Initializing.htm)|  
(Переопределяет
