...
C# __Копировать
     public struct KrCompilationOutput
VB __Копировать
     Public Structure KrCompilationOutput
C++ __Копировать
     public value class KrCompilationOutput
F# __Копировать
     [<SealedAttribute>]
    type KrCompilationOutput = 
        struct
            inherit ValueType
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) __ KrCompilationOutput
##  __Свойства
[Global](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_KrCompilationOutput_Global.htm)|  
---|---  
[Local](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_KrCompilationOutput_Local.htm)|  
## __Методы
