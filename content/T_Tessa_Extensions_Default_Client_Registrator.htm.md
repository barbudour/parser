...
##  __Конструкторы
[Registrator](M_Tessa_Extensions_Default_Client_Registrator__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[FinalizeRegistration](M_Tessa_Extensions_Default_Client_Registrator_FinalizeRegistration.htm)|  
(Переопределяет
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Client - пространство
имён](N_Tessa_Extensions_Default_Client.htm)
