# ConfigurationVersionStoreExtension - класс
...
C# __Копировать
     public sealed class ConfigurationVersionStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class ConfigurationVersionStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class ConfigurationVersionStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type ConfigurationVersionStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ ConfigurationVersionStoreExtension
##  __Конструкторы
[ConfigurationVersionStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_ConfigurationVersionStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса ConfigurationVersionStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[AfterRequestFinally](M_Tessa_Extensions_Platform_Server_Cards_ConfigurationVersionStoreExtension_AfterRequestFinally.htm)|  
(Переопределяет
