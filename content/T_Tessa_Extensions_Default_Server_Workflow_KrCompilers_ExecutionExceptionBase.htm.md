...
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class ExecutionExceptionBase
    	Inherits Exception
C++ __Копировать
    [SerializableAttribute]
    public ref class ExecutionExceptionBase abstract : public Exception
F# __Копировать
     [<AbstractClassAttribute>]
    [<SerializableAttribute>]
    type ExecutionExceptionBase = 
        class
            inherit Exception
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __ ExecutionExceptionBase
Derived
[Tessa.Extensions.Default.Server.Workflow.KrCompilers.ScriptExecutionException](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ScriptExecutionException.htm)
[Tessa.Extensions.Default.Server.Workflow.KrCompilers.SqlProcessing.QueryExecutionException](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SqlProcessing_QueryExecutionException.htm)
##  __Конструкторы
[ExecutionExceptionBase(SerializationInfo,
StreamingContext)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExecutionExceptionBase__ctor.htm)|
Инициализирует новый экземпляр класса ExecutionExceptionBase  
---|---  
[ExecutionExceptionBase(String,
String)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExecutionExceptionBase__ctor_1.htm)|
Инициализирует новый экземпляр класса ExecutionExceptionBase  
[ExecutionExceptionBase(String, String,
Exception)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExecutionExceptionBase__ctor_2.htm)|
Инициализирует новый экземпляр класса ExecutionExceptionBase  
##  __Свойства
