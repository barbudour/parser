# KrPermissionSectionSettings.DisallowedFields - свойство
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public HashSet<Guid> DisallowedFields { get; set; }
VB __Копировать
     Public Property DisallowedFields As HashSet(Of Guid)
    	Get
    	Set
C++ __Копировать
     public:
    property HashSet<Guid>^ DisallowedFields {
    	HashSet<Guid>^ get ();
    	void set (HashSet<Guid>^ value);
    }
F# __Копировать
     member DisallowedFields : HashSet<Guid> with get, set
#### Значение свойства
