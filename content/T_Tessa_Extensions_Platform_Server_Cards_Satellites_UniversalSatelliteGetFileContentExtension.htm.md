# UniversalSatelliteGetFileContentExtension - класс
...
C# __Копировать
     public sealed class UniversalSatelliteGetFileContentExtension : CardGetFileContentExtension
VB __Копировать
     Public NotInheritable Class UniversalSatelliteGetFileContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class UniversalSatelliteGetFileContentExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type UniversalSatelliteGetFileContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ UniversalSatelliteGetFileContentExtension
##  __Конструкторы
[UniversalSatelliteGetFileContentExtension](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteGetFileContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса
UniversalSatelliteGetFileContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteGetFileContentExtension_BeforeRequest.htm)|
