...
VB __Копировать
     Public NotInheritable Class AttributionCollection
    	Inherits ComplexPropertyCollection(Of Attribution)
C++ __Копировать
     public ref class AttributionCollection sealed : public ComplexPropertyCollection<Attribution^>
F# __Копировать
     [<SealedAttribute>]
    type AttributionCollection = 
        class
            inherit ComplexPropertyCollection<Attribution>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[Attribution](T_Tessa_Exchange_WebServices_Data_Attribution.htm)> __ AttributionCollection
##  __Свойства
...
[ComplexPropertyCollection<TComplexProperty>](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm))  
##  __Методы
[Add](M_Tessa_Exchange_WebServices_Data_AttributionCollection_Add.htm)|  Adds
an attribution to the collection.  
---|---  
[AddRange](M_Tessa_Exchange_WebServices_Data_AttributionCollection_AddRange.htm)|
Adds multiple attributions to the collection.  
[Clear](M_Tessa_Exchange_WebServices_Data_AttributionCollection_Clear.htm)|
