# IncrementDoubleConverter - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Data](N_Tessa_UI_Data.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class IncrementDoubleConverter : ValueConverter<double, double>
VB __Копировать
     Public NotInheritable Class IncrementDoubleConverter
    	Inherits ValueConverter(Of Double, Double)
C++ __Копировать
     public ref class IncrementDoubleConverter sealed : public ValueConverter<double, double>
F# __Копировать
     [<SealedAttribute>]
    type IncrementDoubleConverter = 
        class
            inherit ValueConverter<float, float>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueConverter](T_Tessa_UI_Data_ValueConverter_2.htm)<[Double](https://learn.microsoft.com/dotnet/api/system.double), [Double](https://learn.microsoft.com/dotnet/api/system.double)> __ IncrementDoubleConverter
##  __Конструкторы
[IncrementDoubleConverter](M_Tessa_UI_Data_IncrementDoubleConverter__ctor.htm)|
Инициализирует новый экземпляр класса IncrementDoubleConverter  
---|---  
##  __Методы
...
CultureInfo)](M_Tessa_UI_Data_IncrementDoubleConverter_Convert.htm)|  
