# ViewsContextMenuExtensionConfigurator - класс
...
C# __Копировать
     public sealed class ViewsContextMenuExtensionConfigurator : ExtensionSettingsConfiguratorBase
VB __Копировать
     Public NotInheritable Class ViewsContextMenuExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class ViewsContextMenuExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type ViewsContextMenuExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ ViewsContextMenuExtensionConfigurator
##  __Конструкторы
[ViewsContextMenuExtensionConfigurator](M_Tessa_Extensions_Default_Client_Views_ViewsContextMenuExtensionConfigurator__ctor.htm)|
Инициализирует новый экземпляр класса ViewsContextMenuExtensionConfigurator  
---|---  
##  __Свойства
