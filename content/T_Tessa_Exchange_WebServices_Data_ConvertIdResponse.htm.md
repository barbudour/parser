...
C++ __Копировать
     public ref class ConvertIdResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ ConvertIdResponse
##  __Свойства
[ConvertedId](P_Tessa_Exchange_WebServices_Data_ConvertIdResponse_ConvertedId.htm)|
