...
C# __Копировать
     public sealed class ColumnCommand : LinkedFreezable, 
    	ICommandSource
VB __Копировать
     Public NotInheritable Class ColumnCommand
    	Inherits LinkedFreezable
    	Implements ICommandSource
C++ __Копировать
     public ref class ColumnCommand sealed : public LinkedFreezable, 
    	ICommandSource
F# __Копировать
     [<SealedAttribute>]
    type ColumnCommand = 
        class
            inherit LinkedFreezable
            interface ICommandSource
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __ ColumnCommand
Implements
    [ICommandSource](https://learn.microsoft.com/dotnet/api/system.windows.input.icommandsource)
##  __Конструкторы
[ColumnCommand](M_Tessa_UI_Behaviors_ColumnCommand__ctor.htm)| Инициализирует
новый экземпляр класса ColumnCommand  
---|---  
##  __Свойства
...
---|---  
[Command](P_Tessa_UI_Behaviors_ColumnCommand_Command.htm)|  
[CommandParameter](P_Tessa_UI_Behaviors_ColumnCommand_CommandParameter.htm)|  
[CommandTarget](P_Tessa_UI_Behaviors_ColumnCommand_CommandTarget.htm)|  
...
(Унаследован от
[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject))  
[Event](P_Tessa_UI_Behaviors_ColumnCommand_Event.htm)|  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_ColumnCommand_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[GetCommands](M_Tessa_UI_Behaviors_ColumnCommand_GetCommands.htm)|  
...
---|---  
##  __Поля
[CommandParameterProperty](F_Tessa_UI_Behaviors_ColumnCommand_CommandParameterProperty.htm)|  
---|---  
[CommandProperty](F_Tessa_UI_Behaviors_ColumnCommand_CommandProperty.htm)|  
[CommandTargetProperty](F_Tessa_UI_Behaviors_ColumnCommand_CommandTargetProperty.htm)|  
## __См. также
#### Ссылки
