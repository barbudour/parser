# INumberDirector.NotifyOnDeletingCardWithoutBackupAsync - метод
...
C# __Копировать
     Task<bool> NotifyOnDeletingCardWithoutBackupAsync(
    	INumberContext context,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Function NotifyOnDeletingCardWithoutBackupAsync ( 
