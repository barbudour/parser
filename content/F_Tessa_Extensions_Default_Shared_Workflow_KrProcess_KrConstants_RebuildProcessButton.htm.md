# KrConstants.RebuildProcessButton - поле
...
VB __Копировать
     Public Shared ReadOnly RebuildProcessButton As Guid
C++ __Копировать
     public:
    static initonly Guid RebuildProcessButton
F# __Копировать
     static val RebuildProcessButton: Guid
#### Значение поля
