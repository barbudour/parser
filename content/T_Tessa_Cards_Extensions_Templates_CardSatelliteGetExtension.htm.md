# CardSatelliteGetExtension - класс
...
C# __Копировать
     public abstract class CardSatelliteGetExtension : CardGetExtension
VB __Копировать
     Public MustInherit Class CardSatelliteGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class CardSatelliteGetExtension abstract : public CardGetExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type CardSatelliteGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ CardSatelliteGetExtension
##  __Конструкторы
[CardSatelliteGetExtension](M_Tessa_Cards_Extensions_Templates_CardSatelliteGetExtension__ctor.htm)|
...
##  __Методы
[AfterRequest](M_Tessa_Cards_Extensions_Templates_CardSatelliteGetExtension_AfterRequest.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Cards_Extensions_Templates_CardSatelliteGetExtension_BeforeRequest.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[SetSatelliteMainCardIDAsync](M_Tessa_Cards_Extensions_Templates_CardSatelliteGetExtension_SetSatelliteMainCardIDAsync.htm)|
Устанавливает идентификатор основной карточки в карточке-сателлите.  
[ToString](https://learn.microsoft.com/dotnet/api/system.object.tostring#system-
object-tostring)| Returns a string that represents the current object.  
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetSatelliteIDAsync](M_Tessa_Cards_Extensions_Templates_CardSatelliteGetExtension_TryGetSatelliteIDAsync.htm)|
