...
C# __Копировать
     public sealed class NumberNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class NumberNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class NumberNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type NumberNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ NumberNewExtension
##  __Конструкторы
[NumberNewExtension](M_Tessa_Extensions_Platform_Server_Numbers_NumberNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса NumberNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Numbers_NumberNewExtension_AfterRequest.htm)|  
(Переопределяет
