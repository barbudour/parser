# KrTokenToTaskHistoryUIExtension - класс
...
C# __Копировать
     public sealed class KrTokenToTaskHistoryUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class KrTokenToTaskHistoryUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrTokenToTaskHistoryUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrTokenToTaskHistoryUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrTokenToTaskHistoryUIExtension
##  __Конструкторы
[KrTokenToTaskHistoryUIExtension](M_Tessa_Extensions_Default_Client_Workflow_KrPermissions_KrTokenToTaskHistoryUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrTokenToTaskHistoryUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_Workflow_KrPermissions_KrTokenToTaskHistoryUIExtension_Initialized.htm)|
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Client.Workflow.KrPermissions - пространство
имён](N_Tessa_Extensions_Default_Client_Workflow_KrPermissions.htm)
