# CardResponse(IStorageObjectProvider) - конструктор
...
F# __Копировать
     new : 
            storageProvider : IStorageObjectProvider -> CardResponse
#### Параметры
storageProvider
...
[CardResponse - перегрузка](Overload_Tessa_Cards_CardResponse__ctor.htm)
