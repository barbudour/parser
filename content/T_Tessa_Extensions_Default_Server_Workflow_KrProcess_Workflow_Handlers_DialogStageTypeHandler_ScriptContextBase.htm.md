# DialogStageTypeHandler.ScriptContextBase - класс
...
VB __Копировать
     Public MustInherit Class ScriptContextBase
C++ __Копировать
     public ref class ScriptContextBase abstract
F# __Копировать
     [<AbstractClassAttribute>]
    type ScriptContextBase = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ DialogStageTypeHandler.ScriptContextBase
Derived
[Tessa.Extensions.Default.Server.Workflow.KrProcess.Workflow.Handlers.DialogStageTypeHandler.SavingScriptContext](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_DialogStageTypeHandler_SavingScriptContext.htm)
[Tessa.Extensions.Default.Server.Workflow.KrProcess.Workflow.Handlers.DialogStageTypeHandler.ScriptContext](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_DialogStageTypeHandler_ScriptContext.htm)
##  __Конструкторы
[DialogStageTypeHandler.ScriptContextBase](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_DialogStageTypeHandler_ScriptContextBase__ctor.htm)|
Инициализирует новый экземпляр класса
DialogStageTypeHandler.ScriptContextBase.  
---|---  
## __Свойства
