...
VB __Копировать
     Public NotInheritable Class CardStoreExtensionContext
    	Inherits CardExtensionContext
    	Implements ICardStoreExtensionContext, ICardRequestExtensionContext(Of CardStoreRequest, CardStoreResponse), 
    	ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
C++ __Копировать
     public ref class CardStoreExtensionContext sealed : public CardExtensionContext, 
    	ICardStoreExtensionContext, ICardRequestExtensionContext<CardStoreRequest^, CardStoreResponse^>, ICardExtensionContext, 
    	ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
F# __Копировать
     [<SealedAttribute>]
    type CardStoreExtensionContext = 
        class
            inherit CardExtensionContext
            interface ICardStoreExtensionContext
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardExtensionContext](T_Tessa_Cards_Extensions_CardExtensionContext.htm) __ CardStoreExtensionContext
Implements
    [ICardExtensionContext](T_Tessa_Cards_Extensions_ICardExtensionContext.htm), [ICardRequestExtensionContext](T_Tessa_Cards_Extensions_ICardRequestExtensionContext_2.htm)<[CardStoreRequest](T_Tessa_Cards_CardStoreRequest.htm), [CardStoreResponse](T_Tessa_Cards_CardStoreResponse.htm)>, [ICardStoreExtensionContext](T_Tessa_Cards_Extensions_ICardStoreExtensionContext.htm), [ICardTypeExtensionContext](T_Tessa_Cards_Extensions_ICardTypeExtensionContext.htm), [IExtensionContext](T_Tessa_Extensions_IExtensionContext.htm), [ITraceableExtensionContext](T_Tessa_Extensions_ITraceableExtensionContext.htm)
##  __Конструкторы
[CardStoreExtensionContext](M_Tessa_Cards_Extensions_CardStoreExtensionContext__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InvokeContentStoreCompletedAsync](M_Tessa_Cards_Extensions_CardStoreExtensionContext_InvokeContentStoreCompletedAsync.htm)|
...
[InvokeOnContentStoringAsync](M_Tessa_Cards_Extensions_CardStoreExtensionContext_InvokeOnContentStoringAsync.htm)|
...
(Определяется
[ComHelper](T_Tessa_Extensions_Default_Client_EDS_ComHelper.htm))  
[IsWithoutTransaction](M_Tessa_Cards_Extensions_CardExtensionContextExtensions_IsWithoutTransaction_1.htm)|
