...
##  __Конструкторы
[Registrator](M_Tessa_Extensions_Platform_Server_AdSync_Registrator__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterExtensions](M_Tessa_Extensions_Platform_Server_AdSync_Registrator_RegisterExtensions.htm)|  
(Переопределяет
