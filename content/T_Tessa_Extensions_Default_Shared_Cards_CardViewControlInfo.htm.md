...
C# __Копировать
    ...
    public sealed class CardViewControlInfo : CardStorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardViewControlInfo
    	Inherits CardStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardViewControlInfo sealed : public CardStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardViewControlInfo = 
        class
            inherit CardStorageObject
            interface ICloneable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __ CardViewControlInfo
Implements
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Extensions_Default_Shared_Cards_CardViewControlInfo_Clone.htm)|
...
Object>)](M_Tessa_Extensions_Default_Shared_Cards_CardViewControlInfo_Set.htm)|
Устанавливает для карточки информацию по выбранной ссылке CardViewControlInfo.  
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Extensions_Default_Shared_Cards_CardViewControlInfo_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
