# MergeWithBilletCardNewExtension - класс
...
C# __Копировать
     public sealed class MergeWithBilletCardNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class MergeWithBilletCardNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class MergeWithBilletCardNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type MergeWithBilletCardNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ MergeWithBilletCardNewExtension
##  __Конструкторы
[MergeWithBilletCardNewExtension](M_Tessa_Extensions_Platform_Server_Cards_MergeWithBilletCardNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса.  
---|---  
## __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_MergeWithBilletCardNewExtension_AfterRequest.htm)|
