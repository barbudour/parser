# CardExtensions.WhenMethod(IExtensionPolicyContainer, CardDeleteMethod[]) -
метод
...
C++ __Копировать
    ...
    static IExtensionPolicyContainer^ WhenMethod(
    	...
    	... array<CardDeleteMethod>^ methods
    )
F# __Копировать
     [<ExtensionAttribute>]
    static member WhenMethod : 
            policyContainer : IExtensionPolicyContainer * 
            methods : CardDeleteMethod[] -> IExtensionPolicyContainer 
#### Параметры
policyContainer
...
methods [CardDeleteMethod](T_Tessa_Cards_CardDeleteMethod.htm)[]
