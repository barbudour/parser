...
VB __Копировать
     Public Class DelayBindingController
    	Inherits Freezable
C++ __Копировать
     public ref class DelayBindingController : public Freezable
F# __Копировать
     type DelayBindingController = 
        class
            inherit Freezable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __ DelayBindingController
##  __Конструкторы
[DelayBindingController()](M_Tessa_UI_Markup_DelayBindingController__ctor.htm)|
Инициализирует новый экземпляр класса DelayBindingController  
---|---  
[DelayBindingController(DependencyObject, DependencyProperty, TimeSpan,
TimeSpan, BindingBase,
BindingMode)](M_Tessa_UI_Markup_DelayBindingController__ctor_1.htm)|
Инициализирует новый экземпляр класса DelayBindingController  
##  __Свойства
[Binding](P_Tessa_UI_Markup_DelayBindingController_Binding.htm)|  
---|---  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[SourcePropertyMirror](P_Tessa_UI_Markup_DelayBindingController_SourcePropertyMirror.htm)|  
[StringSourcePropertyMirror](P_Tessa_UI_Markup_DelayBindingController_StringSourcePropertyMirror.htm)|  
[TargetObject](P_Tessa_UI_Markup_DelayBindingController_TargetObject.htm)|  
[TargetProperty](P_Tessa_UI_Markup_DelayBindingController_TargetProperty.htm)|  
[TargetPropertyMirror](P_Tessa_UI_Markup_DelayBindingController_TargetPropertyMirror.htm)|  
## __Методы
...
[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject))  
---|---  
[ClearBinding](M_Tessa_UI_Markup_DelayBindingController_ClearBinding.htm)|  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Markup_DelayBindingController_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[SetupBindingListeners](M_Tessa_UI_Markup_DelayBindingController_SetupBindingListeners.htm)|  
...
---|---  
##  __Поля
[SourcePropertyMirrorProperty](F_Tessa_UI_Markup_DelayBindingController_SourcePropertyMirrorProperty.htm)|  
---|---  
[StringSourcePropertyMirrorProperty](F_Tessa_UI_Markup_DelayBindingController_StringSourcePropertyMirrorProperty.htm)|  
[TargetPropertyMirrorProperty](F_Tessa_UI_Markup_DelayBindingController_TargetPropertyMirrorProperty.htm)|  
## __См. также
#### Ссылки
