# RepairRegistrator - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Shared.Conditions](N_Tessa_Extensions_Platform_Shared_Conditions.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [RegistratorAttribute(ExtensionStage.Platform, IsPlatform = true, Tag = RegistratorTag.DefaultForRepair)]
    public sealed class RepairRegistrator : RegistratorBase
VB __Копировать
    <RegistratorAttribute(ExtensionStage.Platform, IsPlatform := true, Tag := RegistratorTag.DefaultForRepair)>
    Public NotInheritable Class RepairRegistrator
    	Inherits RegistratorBase
C++ __Копировать
    [RegistratorAttribute(ExtensionStage::Platform, IsPlatform = true, Tag = RegistratorTag::DefaultForRepair)]
    public ref class RepairRegistrator sealed : public RegistratorBase
F# __Копировать
     [<SealedAttribute>]
    [<RegistratorAttribute(ExtensionStage.Platform, IsPlatform = true, Tag = RegistratorTag.DefaultForRepair)>]
    type RepairRegistrator = 
        class
            inherit RegistratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm) __ RepairRegistrator
##  __Конструкторы
[RepairRegistrator](M_Tessa_Extensions_Platform_Shared_Conditions_RepairRegistrator__ctor.htm)|
Инициализирует новый экземпляр класса RepairRegistrator  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[FinalizeRegistration](M_Tessa_Extensions_Platform_Shared_Conditions_RepairRegistrator_FinalizeRegistration.htm)|  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterExtensions](M_Tessa_Extensions_Platform_Shared_Conditions_RepairRegistrator_RegisterExtensions.htm)|  
(Переопределяет
[RegistratorBase.RegisterExtensions(IExtensionContainer)](M_Tessa_Extensions_RegistratorBase_RegisterExtensions.htm))  
[RegisterUnity](M_Tessa_Extensions_Platform_Shared_Conditions_RepairRegistrator_RegisterUnity.htm)|  
(Переопределяет
