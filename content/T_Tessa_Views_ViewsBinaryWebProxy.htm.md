...
C# __Копировать
     public sealed class ViewsBinaryWebProxy : WebProxy
VB __Копировать
     Public NotInheritable Class ViewsBinaryWebProxy
    	Inherits WebProxy
C++ __Копировать
     public ref class ViewsBinaryWebProxy sealed : public WebProxy
F# __Копировать
     [<SealedAttribute>]
    type ViewsBinaryWebProxy = 
        class
            inherit WebProxy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm) __ ViewsBinaryWebProxy
##  __Конструкторы
[ViewsBinaryWebProxy](M_Tessa_Views_ViewsBinaryWebProxy__ctor.htm)| Создаёт
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetDataAsync](M_Tessa_Views_ViewsBinaryWebProxy_GetDataAsync.htm)|  
