# KrConstants.KrTransitionPrevGroup - поле
...
C# __Копировать
     public const string KrTransitionPrevGroup = "KrTransitionPrevGroup"
VB __Копировать
     Public Const KrTransitionPrevGroup As String = "KrTransitionPrevGroup"
C++ __Копировать
     public:
    literal String^ KrTransitionPrevGroup = "KrTransitionPrevGroup"
F# __Копировать
     static val mutable KrTransitionPrevGroup: string
#### Значение поля
