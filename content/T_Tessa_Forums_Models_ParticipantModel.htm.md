...
C++ __Копировать
    [SerializableAttribute]
    public ref class ParticipantModel : public StorageObject
F# __Копировать
     [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ParticipantModel
##  __Конструкторы
[ParticipantModel()](M_Tessa_Forums_Models_ParticipantModel__ctor.htm)|
Инициализирует новый экземпляр класса ParticipantModel  
---|---  
[ParticipantModel(Dictionary<String,
Object>)](M_Tessa_Forums_Models_ParticipantModel__ctor_1.htm)| Инициализирует
новый экземпляр класса ParticipantModel  
[ParticipantModel(SerializationInfo,
StreamingContext)](M_Tessa_Forums_Models_ParticipantModel__ctor_2.htm)|
Инициализирует новый экземпляр класса ParticipantModel  
##  __Свойства
[IsReadOnly](P_Tessa_Forums_Models_ParticipantModel_IsReadOnly.htm)|  
---|---  
[IsSubscribed](P_Tessa_Forums_Models_ParticipantModel_IsSubscribed.htm)|  
[TopicID](P_Tessa_Forums_Models_ParticipantModel_TopicID.htm)|  
[Type](P_Tessa_Forums_Models_ParticipantModel_Type.htm)|  
[UserID](P_Tessa_Forums_Models_ParticipantModel_UserID.htm)|  
[UserName](P_Tessa_Forums_Models_ParticipantModel_UserName.htm)|  
## __Методы
