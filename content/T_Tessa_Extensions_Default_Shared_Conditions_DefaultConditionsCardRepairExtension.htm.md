# DefaultConditionsCardRepairExtension - класс
...
VB __Копировать
     Public NotInheritable Class DefaultConditionsCardRepairExtension
    	Inherits ConditionsCardRepairExtensionBase
C++ __Копировать
     public ref class DefaultConditionsCardRepairExtension sealed : public ConditionsCardRepairExtensionBase
F# __Копировать
     [<SealedAttribute>]
    type DefaultConditionsCardRepairExtension = 
        class
            inherit ConditionsCardRepairExtensionBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm) __[ConditionsCardRepairExtensionBase](T_Tessa_Extensions_Platform_Shared_Conditions_ConditionsCardRepairExtensionBase.htm) __ DefaultConditionsCardRepairExtension
##  __Конструкторы
[DefaultConditionsCardRepairExtension](M_Tessa_Extensions_Default_Shared_Conditions_DefaultConditionsCardRepairExtension__ctor.htm)|
