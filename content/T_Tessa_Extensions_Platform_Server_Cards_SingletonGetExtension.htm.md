...
C# __Копировать
     public sealed class SingletonGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class SingletonGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class SingletonGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type SingletonGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ SingletonGetExtension
##  __Конструкторы
[SingletonGetExtension](M_Tessa_Extensions_Platform_Server_Cards_SingletonGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса SingletonGetExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_SingletonGetExtension_BeforeRequest.htm)|  
(Переопределяет
