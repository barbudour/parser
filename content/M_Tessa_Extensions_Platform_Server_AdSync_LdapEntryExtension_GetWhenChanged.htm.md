# LdapEntryExtension.GetWhenChanged - метод
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.AdSync](N_Tessa_Extensions_Platform_Server_AdSync.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public static DateTime GetWhenChanged(
    	this LdapEntry entry
    )
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function GetWhenChanged ( 
    	entry As LdapEntry
    ) As DateTime
C++ __Копировать
     public:
    [ExtensionAttribute]
    static DateTime GetWhenChanged(
    	LdapEntry^ entry
    )
F# __Копировать
     [<ExtensionAttribute>]
    static member GetWhenChanged : 
            entry : LdapEntry -> DateTime 
#### Параметры
entry LdapEntry
