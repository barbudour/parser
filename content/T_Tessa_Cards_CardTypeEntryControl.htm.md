...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeAttributeFromXml](M_Tessa_Cards_CardTypeEntryControl_DeserializeAttributeFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_CardTypeEntryControl_DeserializeFromBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_CardTypeEntryControl_DeserializeFromStorageInternal.htm)|
...
[ControlSettings](P_Tessa_Cards_CardTypeControl_ControlSettings.htm).  
(Унаследован от [CardTypeControl](T_Tessa_Cards_CardTypeControl.htm))  
[EqualsInternal](M_Tessa_Cards_CardTypeEntryControl_EqualsInternal.htm)|
...
(Унаследован от [CardTypeContent](T_Tessa_Cards_CardTypeContent.htm))  
[IsRequired](M_Tessa_Cards_CardTypeEntryControl_IsRequired.htm)|  Возвращает
...
[IsVisible](M_Tessa_Cards_CardTypeEntryControl_IsVisible.htm)| Возвращает
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_CardTypeEntryControl_OnDeserializing.htm)|
...
(Унаследован от
[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm))  
[RepairInternalAsync](M_Tessa_Cards_CardTypeEntryControl_RepairInternalAsync.htm)|
Метод восстанавливает объект к работоспособному состоянии в соответствии со
схемой. Этот процесс включает удаление данных из текущего объекта, которые
имеют отношение к схеме, но фактически в ней отсутствуют.  
(Переопределяет
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SealInternal](M_Tessa_Cards_CardTypeEntryControl_SealInternal.htm)|
Защищает объект от изменений.
Метод может быть переопределён в классах-наследниках.
(Переопределяет
[CardTypeControl.SealInternal()](M_Tessa_Cards_CardTypeControl_SealInternal.htm))  
[SerializeAttributesToXml](M_Tessa_Cards_CardTypeEntryControl_SerializeAttributesToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_CardTypeEntryControl_SerializeToBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_CardTypeEntryControl_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SetRequired](M_Tessa_Cards_CardTypeEntryControl_SetRequired.htm)|
...
[SetVisible](M_Tessa_Cards_CardTypeEntryControl_SetVisible.htm)|
...
(Унаследован от
[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardTypeEntryControl_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
[CardTypeContent.ValidateInternal(IValidationResultBuilder)](M_Tessa_Cards_CardTypeContent_ValidateInternal.htm))  
##  __Поля
[XmlElementName](F_Tessa_Cards_CardTypeEntryControl_XmlElementName.htm)|  Имя
XML-элемента.  
---|---  
## __Методы расширения
...
имена полей, с которыми связан контрол CardTypeEntryControl.  
(Определяется [CardExtensions](T_Tessa_Cards_CardExtensions.htm))  
