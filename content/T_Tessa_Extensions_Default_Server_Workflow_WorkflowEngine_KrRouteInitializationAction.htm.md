# KrRouteInitializationAction - класс
Обработчик действия
...
C# __Копировать
     public sealed class KrRouteInitializationAction : KrWorkflowActionBase
VB __Копировать
     Public NotInheritable Class KrRouteInitializationAction
    	Inherits KrWorkflowActionBase
C++ __Копировать
     public ref class KrRouteInitializationAction sealed : public KrWorkflowActionBase
F# __Копировать
     [<SealedAttribute>]
    type KrRouteInitializationAction = 
        class
            inherit KrWorkflowActionBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WorkflowActionBase](T_Tessa_Workflow_Actions_WorkflowActionBase.htm) __[KrWorkflowActionBase](T_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrWorkflowActionBase.htm) __ KrRouteInitializationAction
##  __Конструкторы
[KrRouteInitializationAction](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrRouteInitializationAction__ctor.htm)|
Инициализирует новый экземпляр класса KrRouteInitializationAction.  
---|---  
## __Свойства
...
[ExecuteAsync](M_Tessa_Extensions_Default_Server_Workflow_WorkflowEngine_KrRouteInitializationAction_ExecuteAsync.htm)|
