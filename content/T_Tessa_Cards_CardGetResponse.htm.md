# CardGetResponse - класс
Ответ на запрос на получение информации по карточке от сервиса карточек.
Содержит информацию о карточке и объект, осуществляющий валидацию.
## __Definition
 **Пространство имён:** [Tessa.Cards](N_Tessa_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class CardGetResponse : CardValueResponseBase, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardGetResponse
    	Inherits CardValueResponseBase
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardGetResponse sealed : public CardValueResponseBase, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
## __Свойства
[CancelOpening](P_Tessa_Cards_CardGetResponse_CancelOpening.htm)|  Признак
того, что загруженную карточку не следует открывать стандартными средствами,
как будто бы при её загрузке произошла ошибка. Это позволяет заменить операцию
на открытие карточки операцией на выполнение действий с открытой карточкой,
например, по созданию карточки из загруженного шаблона.  
---|---  
[Card](P_Tessa_Cards_CardValueResponseBase_Card.htm)|  Карточка.  
(Унаследован от
[CardValueResponseBase](T_Tessa_Cards_CardValueResponseBase.htm))  
[Compressed](P_Tessa_Cards_CardGetResponse_Compressed.htm)|  Признак того, что
карточка [Card](P_Tessa_Cards_CardValueResponseBase_Card.htm) была сжата.  
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[SectionRows](P_Tessa_Cards_CardValueResponseBase_SectionRows.htm)|  Пустые
строки коллекционных и древовидных секций, доступные по имени секции. Могут
использоваться для редактирования полученной карточки.  
(Унаследован от
[CardValueResponseBase](T_Tessa_Cards_CardValueResponseBase.htm))  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_CardGetResponse_Clone.htm)|  Выполняет глубокое
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[CreateDefaultCard](M_Tessa_Cards_CardGetResponse_CreateDefaultCard.htm)|
Создаёт объект карточки по заданному хранилищу. Может автоматически изменить
тип карточки InstanceType после создания.  
(Переопределяет [CardValueResponseBase.CreateDefaultCard(Dictionary<String,
Object>)](M_Tessa_Cards_CardValueResponseBase_CreateDefaultCard.htm))  
...
[EraseOnError](M_Tessa_Cards_CardGetResponse_EraseOnError.htm)|  Удаляет
...
(Переопределяет
[CardValueResponseBase.EraseOnError()](M_Tessa_Cards_CardValueResponseBase_EraseOnError.htm))  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[FromTypedJson](M_Tessa_Cards_CardGetResponse_FromTypedJson.htm)|
Устанавливает содержимое объекта в соответствии с данными, десериализованными
...
(Определяется
[CardRequestExtensions](T_Tessa_Cards_CardRequestExtensions.htm))  
[GetForbidStoringHistory](M_Tessa_Cards_CardRequestExtensions_GetForbidStoringHistory_3.htm)|
...
(Определяется
[CardRequestExtensions](T_Tessa_Cards_CardRequestExtensions.htm))  
[SetForbidStoringHistory](M_Tessa_Cards_CardRequestExtensions_SetForbidStoringHistory_3.htm)|
