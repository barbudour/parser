# FileSatelliteGetFileContentExtension - класс
...
C# __Копировать
     public sealed class FileSatelliteGetFileContentExtension : CardGetFileContentExtension
VB __Копировать
     Public NotInheritable Class FileSatelliteGetFileContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class FileSatelliteGetFileContentExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type FileSatelliteGetFileContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ FileSatelliteGetFileContentExtension
##  __Конструкторы
[FileSatelliteGetFileContentExtension](M_Tessa_Extensions_Platform_Server_Cards_FileSatelliteGetFileContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса FileSatelliteGetFileContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_FileSatelliteGetFileContentExtension_BeforeRequest.htm)|  
(Переопределяет
