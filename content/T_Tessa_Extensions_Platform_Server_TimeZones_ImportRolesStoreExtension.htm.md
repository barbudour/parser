# ImportRolesStoreExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.TimeZones](N_Tessa_Extensions_Platform_Server_TimeZones.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class ImportRolesStoreExtension : CardStoreExtension
VB __Копировать
     Public Class ImportRolesStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class ImportRolesStoreExtension : public CardStoreExtension
F# __Копировать
     type ImportRolesStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ ImportRolesStoreExtension
##  __Конструкторы
[ImportRolesStoreExtension](M_Tessa_Extensions_Platform_Server_TimeZones_ImportRolesStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса ImportRolesStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_TimeZones_ImportRolesStoreExtension_BeforeRequest.htm)|  
(Переопределяет
