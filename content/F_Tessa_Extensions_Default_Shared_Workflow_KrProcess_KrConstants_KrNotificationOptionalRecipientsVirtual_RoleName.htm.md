# KrConstants.KrNotificationOptionalRecipientsVirtual.RoleName - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly RoleName As String
C++ __Копировать
     public:
    static initonly String^ RoleName
F# __Копировать
     static val RoleName: string
#### Значение поля
