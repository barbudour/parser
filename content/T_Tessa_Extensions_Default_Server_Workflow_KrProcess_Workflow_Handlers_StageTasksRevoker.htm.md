...
VB __Копировать
     Public NotInheritable Class StageTasksRevoker
    	Implements IStageTasksRevoker
C++ __Копировать
     public ref class StageTasksRevoker sealed : IStageTasksRevoker
F# __Копировать
     [<SealedAttribute>]
    type StageTasksRevoker = 
        class
            interface IStageTasksRevoker
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ StageTasksRevoker
Implements
    [IStageTasksRevoker](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_IStageTasksRevoker.htm)
##  __Конструкторы
[StageTasksRevoker](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTasksRevoker__ctor.htm)|
Инициализирует новый экземпляр класса StageTasksRevoker.  
---|---  
## __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RevokeAllStageTasksAsync](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTasksRevoker_RevokeAllStageTasksAsync.htm)|
Отзывает все задания этапа.  
[RevokeTaskAsync](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTasksRevoker_RevokeTaskAsync.htm)|
...
[RevokeTasksAsync](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTasksRevoker_RevokeTasksAsync.htm)|
