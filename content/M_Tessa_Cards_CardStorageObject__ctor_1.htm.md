# CardStorageObject(SerializationInfo, StreamingContext) - конструктор
...
F# __Копировать
     new : 
            ...
            context : StreamingContext -> CardStorageObject
#### Параметры
info
...
[CardStorageObject -
перегрузка](Overload_Tessa_Cards_CardStorageObject__ctor.htm)
