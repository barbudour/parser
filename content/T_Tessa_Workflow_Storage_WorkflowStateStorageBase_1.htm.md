# WorkflowStateStorageBase<T> \- класс
...
C# __Копировать
     public abstract class WorkflowStateStorageBase<T> : WorkflowStorageBase
    where T : WorkflowTemplateStorageBase
VB __Копировать
     Public MustInherit Class WorkflowStateStorageBase(Of T As WorkflowTemplateStorageBase)
    	Inherits WorkflowStorageBase
C++ __Копировать
    generic<typename T>
    where T : WorkflowTemplateStorageBase
    public ref class WorkflowStateStorageBase abstract : public WorkflowStorageBase
F# __Копировать
     [<AbstractClassAttribute>]
    type WorkflowStateStorageBase<'T when 'T : WorkflowTemplateStorageBase> = 
        class
            inherit WorkflowStorageBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __ WorkflowStateStorageBase<T>
Derived
[Tessa.Workflow.Storage.WorkflowActionStateStorage](T_Tessa_Workflow_Storage_WorkflowActionStateStorage.htm)
[Tessa.Workflow.Storage.WorkflowNodeStateStorage](T_Tessa_Workflow_Storage_WorkflowNodeStateStorage.htm)
[Tessa.Workflow.Storage.WorkflowProcessStateStorage](T_Tessa_Workflow_Storage_WorkflowProcessStateStorage.htm)
#### Параметры типа
T
##  __Конструкторы
[WorkflowStateStorageBase<T>(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowStateStorageBase_1__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowStateStorageBase<T>  
---|---  
[WorkflowStateStorageBase<T>(SerializationInfo,
StreamingContext)](M_Tessa_Workflow_Storage_WorkflowStateStorageBase_1__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowStateStorageBase<T>  
[WorkflowStateStorageBase<T>(T,
Nullable<Guid>)](M_Tessa_Workflow_Storage_WorkflowStateStorageBase_1__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowStateStorageBase<T>  
##  __Свойства
