# NullToVisibilityConverter - класс
The null to visibility converter.
## __Definition
 **Пространство имён:** [Tessa.UI.Data](N_Tessa_UI_Data.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
    [ValueConversionAttribute(typeof(Object), typeof(Visibility))]
    public class NullToVisibilityConverter : ValueConverter<Object, Visibility>
VB __Копировать
    <ValueConversionAttribute(GetType(Object), GetType(Visibility))>
    Public Class NullToVisibilityConverter
    	Inherits ValueConverter(Of Object, Visibility)
C++ __Копировать
    [ValueConversionAttribute(typeof(Object), typeof(Visibility))]
    public ref class NullToVisibilityConverter : public ValueConverter<Object^, Visibility^>
F# __Копировать
     [<ValueConversionAttribute(typeof(Object), typeof(Visibility))>]
    type NullToVisibilityConverter = 
        class
            inherit ValueConverter<Object, Visibility>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueConverter](T_Tessa_UI_Data_ValueConverter_2.htm)<[Object](https://learn.microsoft.com/dotnet/api/system.object), [Visibility](https://learn.microsoft.com/dotnet/api/system.windows.visibility)> __ NullToVisibilityConverter
##  __Конструкторы
[NullToVisibilityConverter](M_Tessa_UI_Data_NullToVisibilityConverter__ctor.htm)|
Инициализирует новый экземпляр класса NullToVisibilityConverter  
---|---  
##  __Свойства
[VisibilityIfNull](P_Tessa_UI_Data_NullToVisibilityConverter_VisibilityIfNull.htm)|
Gets or sets the visibility if value is null.  
---|---  
## __Методы
...
---|---  
[BoxTargetValue](M_Tessa_UI_Data_NullToVisibilityConverter_BoxTargetValue.htm)|  
...
CultureInfo)](M_Tessa_UI_Data_NullToVisibilityConverter_Convert.htm)|  
