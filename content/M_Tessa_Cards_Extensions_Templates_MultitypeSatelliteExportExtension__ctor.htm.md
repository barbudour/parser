# MultitypeSatelliteExportExtension - конструктор
...
C# __Копировать
     protected MultitypeSatelliteExportExtension(
...
F# __Копировать
     new : 
            cardRepository : ICardRepository -> MultitypeSatelliteExportExtension
#### Параметры
