# HistoryManagementStageTypeHandler - класс
Обработчик этапа
...
VB __Копировать
     Public Class HistoryManagementStageTypeHandler
    	Inherits StageTypeHandlerBase
C++ __Копировать
     public ref class HistoryManagementStageTypeHandler : public StageTypeHandlerBase
F# __Копировать
     type HistoryManagementStageTypeHandler = 
        class
            inherit StageTypeHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StageTypeHandlerBase](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTypeHandlerBase.htm) __ HistoryManagementStageTypeHandler
##  __Конструкторы
[HistoryManagementStageTypeHandler](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_HistoryManagementStageTypeHandler__ctor.htm)|
Инициализирует новый экземпляр класса HistoryManagementStageTypeHandler.  
---|---  
## __Свойства
[KrScope](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_HistoryManagementStageTypeHandler_KrScope.htm)|
...
(Унаследован от
[StageTypeHandlerBase](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTypeHandlerBase.htm))  
[HandleStageStartAsync](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_HistoryManagementStageTypeHandler_HandleStageStartAsync.htm)|
