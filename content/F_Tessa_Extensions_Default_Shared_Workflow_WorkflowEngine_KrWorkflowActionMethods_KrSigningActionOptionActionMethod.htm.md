# KrWorkflowActionMethods.KrSigningActionOptionActionMethod - поле
...
VB __Копировать
     Public Shared ReadOnly KrSigningActionOptionActionMethod As WorkflowActionMethodDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionMethodDescriptor^ KrSigningActionOptionActionMethod
F# __Копировать
     static val KrSigningActionOptionActionMethod: WorkflowActionMethodDescriptor
#### Значение поля
