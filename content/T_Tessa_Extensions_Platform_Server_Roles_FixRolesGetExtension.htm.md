# FixRolesGetExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Roles](N_Tessa_Extensions_Platform_Server_Roles.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class FixRolesGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class FixRolesGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class FixRolesGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type FixRolesGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ FixRolesGetExtension
##  __Конструкторы
[FixRolesGetExtension](M_Tessa_Extensions_Platform_Server_Roles_FixRolesGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса FixRolesGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_FixRolesGetExtension_AfterRequest.htm)|  
(Переопределяет
