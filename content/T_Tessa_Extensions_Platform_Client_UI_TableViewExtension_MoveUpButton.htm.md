...
C# __Копировать
     public sealed class MoveUpButton : MoveButtonBase
VB __Копировать
     Public NotInheritable Class MoveUpButton
    	Inherits MoveButtonBase
C++ __Копировать
     public ref class MoveUpButton sealed : public MoveButtonBase
F# __Копировать
     [<SealedAttribute>]
    type MoveUpButton = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NotificationObject](T_Tessa_Platform_NotificationObject.htm) __[MoveButtonBase](T_Tessa_Extensions_Platform_Client_UI_TableViewExtension_MoveButtonBase.htm) __ MoveUpButton
##  __Конструкторы
[MoveUpButton](M_Tessa_Extensions_Platform_Client_UI_TableViewExtension_MoveUpButton__ctor.htm)|
Инициализирует новый экземпляр класса MoveUpButton  
---|---  
##  __Свойства
