...
C# __Копировать
    ...
    public sealed class ExtraSource : StorageObject, 
    	IExtraSource
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class ExtraSource
    	Inherits StorageObject
    	Implements IExtraSource
C++ __Копировать
    [SerializableAttribute]
    public ref class ExtraSource sealed : public StorageObject, 
    	IExtraSource
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ExtraSource
Implements
    [IExtraSource](T_Tessa_Extensions_Default_Shared_Workflow_KrCompilers_IExtraSource.htm)
##  __Конструкторы
[ExtraSource()](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExtraSource__ctor.htm)|
Инициализирует новый пустой экземпляр класса ExtraSource.  
---|---  
[ExtraSource(Dictionary<String,
Object>)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExtraSource__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[ExtraSource(SerializationInfo,
StreamingContext)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExtraSource__ctor_2.htm)|
...
[ExtraSource(String, String, String, String, String,
String)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExtraSource__ctor_3.htm)|
Инициализирует новый экземпляр класса ExtraSource.  
## __Свойства
[DisplayName](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExtraSource_DisplayName.htm)|
Отображаемое имя метода.  
---|---  
[Name](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExtraSource_Name.htm)|
Имя метода.  
[ParameterName](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExtraSource_ParameterName.htm)|
Имя параметра.  
[ParameterType](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExtraSource_ParameterType.htm)|
Тип параметра.  
[ReturnType](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExtraSource_ReturnType.htm)|
Тип возвращаемого значения.  
[Source](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExtraSource_Source.htm)|
Исходный код.  
## __Методы
...
восстановить в методе FromTypedJson.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[ToMutable](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExtraSource_ToMutable.htm)|
Преобразует объект к изменяемому типу.  
[ToReadonly](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_ExtraSource_ToReadonly.htm)|
