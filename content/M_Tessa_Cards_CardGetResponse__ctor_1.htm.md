# CardGetResponse(Dictionary<String, Object>) - конструктор
...
F# __Копировать
     new : 
            storage : Dictionary<string, Object> -> CardGetResponse
#### Параметры
storage
...
[CardGetResponse - перегрузка](Overload_Tessa_Cards_CardGetResponse__ctor.htm)
