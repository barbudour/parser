# CardGetFileVersionsResponse.FromTypedJson - метод
...
C# __Копировать
     public CardGetFileVersionsResponse FromTypedJson(
    	string json
    )
VB __Копировать
...
C++ __Копировать
     public:
    CardGetFileVersionsResponse^ FromTypedJson(
    	String^ json
    )
F# __Копировать
     member FromTypedJson : 
            json : string -> CardGetFileVersionsResponse 
#### Параметры
