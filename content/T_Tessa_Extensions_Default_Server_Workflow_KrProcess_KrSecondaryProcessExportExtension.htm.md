# KrSecondaryProcessExportExtension - класс
...
C# __Копировать
     public sealed class KrSecondaryProcessExportExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class KrSecondaryProcessExportExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class KrSecondaryProcessExportExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrSecondaryProcessExportExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ KrSecondaryProcessExportExtension
##  __Конструкторы
[KrSecondaryProcessExportExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrSecondaryProcessExportExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrSecondaryProcessExportExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrSecondaryProcessExportExtension_AfterRequest.htm)|  
(Переопределяет
