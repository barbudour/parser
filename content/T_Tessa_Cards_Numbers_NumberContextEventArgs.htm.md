# NumberContextEventArgs - класс
Аргументы события, связанного с действием с номером.
## __Definition
 **Пространство имён:** [Tessa.Cards.Numbers](N_Tessa_Cards_Numbers.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class NumberContextEventArgs : DeferredEventArgs
VB __Копировать
     Public Class NumberContextEventArgs
    	Inherits DeferredEventArgs
C++ __Копировать
     public ref class NumberContextEventArgs : public DeferredEventArgs
F# __Копировать
     type NumberContextEventArgs = 
        class
            inherit DeferredEventArgs
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[EventArgs](https://learn.microsoft.com/dotnet/api/system.eventargs) __[DeferredEventArgs](T_Tessa_Platform_DeferredEventArgs.htm) __ NumberContextEventArgs
##  __Конструкторы
[NumberContextEventArgs](M_Tessa_Cards_Numbers_NumberContextEventArgs__ctor.htm)|
