# CardExtensions.DeleteAsync(ICardTypeService, ICardSerializableEntry,
...
F# __Копировать
    ...
    *)
    -> Task 
#### Параметры
service [ICardTypeService](T_Tessa_Cards_ICardTypeService.htm)
...
объекта типа [ICardTypeService](T_Tessa_Cards_ICardTypeService.htm). При
