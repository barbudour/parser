# TreeItemFilteringSettings.Parameters - свойство
Список параметров
## __Definition
 **Пространство имён:**
...
C++ __Копировать
     public:
    virtual property List<String^>^ Parameters {
    	List<String^>^ get () sealed;
    	void set (List<String^>^ value) sealed;
    }
F# __Копировать
     abstract Parameters : List<string> with get, set
    override Parameters : List<string> with get, set
#### Значение свойства
[List](https://learn.microsoft.com/dotnet/api/system.collections.generic.list-1)<[String](https://learn.microsoft.com/dotnet/api/system.string)>
#### Реализации
[ITreeItemFilteringSettings.Parameters](P_Tessa_Extensions_Default_Shared_Workplaces_ITreeItemFilteringSettings_Parameters.htm)  
##  __См. также
#### Ссылки
