# CardTypeSection - класс
Секция виртуальной схемы карточки.
## __Definition
 **Пространство имён:**
...
## __Свойства
[Columns](P_Tessa_Cards_VirtualScheme_CardTypeSection_Columns.htm)|  Колонки
секции.  
---|---  
[Description](P_Tessa_Cards_VirtualScheme_CardTypeSection_Description.htm)|
Описание секции.  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[TableType](P_Tessa_Cards_VirtualScheme_CardTypeSection_TableType.htm)|  Тип
таблицы из перечисления
[SchemeTableContentType](T_Tessa_Scheme_SchemeTableContentType.htm).  
[XmlElementNameInternal](P_Tessa_Cards_VirtualScheme_CardTypeSection_XmlElementNameInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeAttributeFromXml](M_Tessa_Cards_VirtualScheme_CardTypeSection_DeserializeAttributeFromXml.htm)|
...
[DeserializeChildrenFromBinaryInternal](M_Tessa_Cards_VirtualScheme_CardTypeSection_DeserializeChildrenFromBinaryInternal.htm)|
...
[DeserializeElementFromXml](M_Tessa_Cards_VirtualScheme_CardTypeSection_DeserializeElementFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_VirtualScheme_CardTypeSection_DeserializeFromBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_VirtualScheme_CardTypeSection_DeserializeFromStorageInternal.htm)|
...
(Унаследован от
[CardSerializableEntry](T_Tessa_Cards_CardSerializableEntry.htm))  
[Equals(Object)](M_Tessa_Cards_VirtualScheme_CardTypeSection_Equals.htm)|  
(Переопределяет
...
[GetHashCode](M_Tessa_Cards_VirtualScheme_CardTypeSection_GetHashCode.htm)|  
(Переопределяет
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_VirtualScheme_CardTypeSection_OnDeserializing.htm)|
...
(Унаследован от
[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm))  
[RepairInternalAsync](M_Tessa_Cards_VirtualScheme_CardTypeSection_RepairInternalAsync.htm)|
Метод восстанавливает объект к работоспособному состоянии в соответствии со
схемой. Этот процесс включает удаление данных из текущего объекта, которые
имеют отношение к схеме, но фактически в ней отсутствуют.  
(Переопределяет
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SealInternal](M_Tessa_Cards_VirtualScheme_CardTypeSection_SealInternal.htm)|
Защищает объект от изменений.
Метод может быть переопределён в классах-наследниках.
(Переопределяет
[CardSerializableObject.SealInternal()](M_Tessa_Cards_CardSerializableObject_SealInternal.htm))  
[SerializeAttributesToXml](M_Tessa_Cards_VirtualScheme_CardTypeSection_SerializeAttributesToXml.htm)|
...
[SerializeChildrenToBinaryInternal](M_Tessa_Cards_VirtualScheme_CardTypeSection_SerializeChildrenToBinaryInternal.htm)|
...
[SerializeElementsToXml](M_Tessa_Cards_VirtualScheme_CardTypeSection_SerializeElementsToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_VirtualScheme_CardTypeSection_SerializeToBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_VirtualScheme_CardTypeSection_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
...
(Унаследован от
[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm))  
[ValidateInternal](M_Tessa_Cards_VirtualScheme_CardTypeSection_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
