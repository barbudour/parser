# KrConstants.KrSecondaryProcesses.ModeName - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Const ModeName As String = "ModeName"
C++ __Копировать
     public:
    literal String^ ModeName = "ModeName"
F# __Копировать
     static val mutable ModeName: string
#### Значение поля
