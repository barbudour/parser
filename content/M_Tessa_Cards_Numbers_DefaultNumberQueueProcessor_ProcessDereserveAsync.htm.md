# DefaultNumberQueueProcessor.ProcessDereserveAsync - метод
...
C# __Копировать
     protected virtual Task<bool> ProcessDereserveAsync(
...
VB __Копировать
     Protected Overridable Function ProcessDereserveAsync ( 
...
C++ __Копировать
     protected:
    virtual Task<bool>^ ProcessDereserveAsync(
    	INumberContext^ context, 
    	NumberQueue^ queue, 
    	NumberQueueItem^ queueItem, 
    	NumberQueueEventType^ queueEventType, 
...
F# __Копировать
     abstract ProcessDereserveAsync : 
    ...
    *)
    -> Task<bool> 
    override ProcessDereserveAsync : 
            context : INumberContext * 
            queue : NumberQueue * 
            queueItem : NumberQueueItem * 
            queueEventType : NumberQueueEventType * 
