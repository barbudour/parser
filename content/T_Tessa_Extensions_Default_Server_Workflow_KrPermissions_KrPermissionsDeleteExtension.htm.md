# KrPermissionsDeleteExtension - класс
...
C# __Копировать
     public sealed class KrPermissionsDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class KrPermissionsDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class KrPermissionsDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type KrPermissionsDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ KrPermissionsDeleteExtension
##  __Конструкторы
[KrPermissionsDeleteExtension](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrPermissionsDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrPermissionsDeleteExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrPermissionsDeleteExtension_AfterBeginTransaction.htm)|  
(Переопределяет
