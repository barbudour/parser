# FixSignatureVersionsStoreExtension - класс
...
C# __Копировать
     public sealed class FixSignatureVersionsStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class FixSignatureVersionsStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class FixSignatureVersionsStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type FixSignatureVersionsStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ FixSignatureVersionsStoreExtension
##  __Конструкторы
[FixSignatureVersionsStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_FixSignatureVersionsStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса FixSignatureVersionsStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_FixSignatureVersionsStoreExtension_BeforeRequest.htm)|  
(Переопределяет
