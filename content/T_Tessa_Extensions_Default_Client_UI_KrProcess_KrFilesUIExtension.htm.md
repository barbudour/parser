...
VB __Копировать
     Public Class KrFilesUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrFilesUIExtension : public CardUIExtension
F# __Копировать
     type KrFilesUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrFilesUIExtension
##  __Конструкторы
[KrFilesUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrFilesUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrFilesUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrFilesUIExtension_Initialized.htm)|  
(Переопределяет
