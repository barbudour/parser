# SchemeGroupableObject - класс
##  __Definition
 **Пространство имён:** [Tessa.Scheme](N_Tessa_Scheme.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class SchemeGroupableObject : SchemeNamedObject
VB __Копировать
     Public MustInherit Class SchemeGroupableObject
    	Inherits SchemeNamedObject
C++ __Копировать
     public ref class SchemeGroupableObject abstract : public SchemeNamedObject
F# __Копировать
     [<AbstractClassAttribute>]
    type SchemeGroupableObject = 
        class
            inherit SchemeNamedObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[SchemeObject](T_Tessa_Scheme_SchemeObject.htm) __[SchemePartionableObject](T_Tessa_Scheme_SchemePartionableObject.htm) __[SchemeNamedObject](T_Tessa_Scheme_SchemeNamedObject.htm) __ SchemeGroupableObject
Derived
[Tessa.Scheme.SchemeProgrammableObject](T_Tessa_Scheme_SchemeProgrammableObject.htm)
[Tessa.Scheme.SchemeTable](T_Tessa_Scheme_SchemeTable.htm)
##  __Свойства
...
(Унаследован от [SchemeNamedObject](T_Tessa_Scheme_SchemeNamedObject.htm))  
---|---  
[Copy](M_Tessa_Scheme_SchemeGroupableObject_Copy.htm)|  
(Переопределяет
...
(Унаследован от [SchemeObject](T_Tessa_Scheme_SchemeObject.htm))  
[EndDeserializationOverride](M_Tessa_Scheme_SchemeGroupableObject_EndDeserializationOverride.htm)|  
(Переопределяет
...
(Унаследован от
[SchemePartionableObject](T_Tessa_Scheme_SchemePartionableObject.htm))  
[GetObjectData](M_Tessa_Scheme_SchemeGroupableObject_GetObjectData.htm)|  
(Переопределяет
