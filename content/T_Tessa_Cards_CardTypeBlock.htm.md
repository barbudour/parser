# CardTypeBlock - класс
Блок типа карточки, содержащий отображаемые единым образом контролы для полей
и секций карточки.
## __Definition
...
C# __Копировать
    ...
    public sealed class CardTypeBlock : CardTypeContent
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardTypeBlock
    	Inherits CardTypeContent
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTypeBlock sealed : public CardTypeContent
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardTypeBlock = 
...
имя класса [BlockClass](P_Tessa_Cards_CardTypeBlock_BlockClass.htm) и его
настройки [BlockSettings](P_Tessa_Cards_CardTypeBlock_BlockSettings.htm).
## __Конструкторы
[CardTypeBlock](M_Tessa_Cards_CardTypeBlock__ctor.htm)| Создаёт экземпляр
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeAttributeFromXml](M_Tessa_Cards_CardTypeBlock_DeserializeAttributeFromXml.htm)|
...
[DeserializeChildrenFromBinaryInternal](M_Tessa_Cards_CardTypeBlock_DeserializeChildrenFromBinaryInternal.htm)|
...
[DeserializeElementFromXml](M_Tessa_Cards_CardTypeBlock_DeserializeElementFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_CardTypeBlock_DeserializeFromBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_CardTypeBlock_DeserializeFromStorageInternal.htm)|
...
объект с заданным.  
(Унаследован от [CardTypeContent](T_Tessa_Cards_CardTypeContent.htm))  
[EqualsByBlockSettings](M_Tessa_Cards_CardTypeBlock_EqualsByBlockSettings.htm)|
Сравнивает сериализованные значения свойств
[BlockSettings](P_Tessa_Cards_CardTypeBlock_BlockSettings.htm).  
[EqualsByFormSettings](M_Tessa_Cards_CardTypeBlock_EqualsByFormSettings.htm)|
Сравнивает сериализованные значения свойств
[FormSettings](P_Tessa_Cards_CardTypeBlock_FormSettings.htm).  
[EqualsInternal](M_Tessa_Cards_CardTypeBlock_EqualsInternal.htm)| Сравнивает
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetValidationName](M_Tessa_Cards_CardTypeBlock_GetValidationName.htm)|
Возвращает строку, определяющую имя объекта, или null, если имя объекта ещё
неизвестно или объект не содержит имени.  
(Переопределяет
[CardTypeContent.GetValidationName()](M_Tessa_Cards_CardTypeContent_GetValidationName.htm))  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_CardTypeBlock_OnDeserializing.htm)|
...
(Унаследован от
[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm))  
[RepairInternalAsync](M_Tessa_Cards_CardTypeBlock_RepairInternalAsync.htm)|
Метод восстанавливает объект к работоспособному состоянии в соответствии со
схемой. Этот процесс включает удаление данных из текущего объекта, которые
имеют отношение к схеме, но фактически в ней отсутствуют.  
(Переопределяет
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SealInternal](M_Tessa_Cards_CardTypeBlock_SealInternal.htm)|
Защищает объект от изменений.
Метод может быть переопределён в классах-наследниках.
(Переопределяет
[CardSerializableObject.SealInternal()](M_Tessa_Cards_CardSerializableObject_SealInternal.htm))  
[SerializeAttributesToXml](M_Tessa_Cards_CardTypeBlock_SerializeAttributesToXml.htm)|
...
[SerializeChildrenToBinaryInternal](M_Tessa_Cards_CardTypeBlock_SerializeChildrenToBinaryInternal.htm)|
...
[SerializeElementsToXml](M_Tessa_Cards_CardTypeBlock_SerializeElementsToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_CardTypeBlock_SerializeToBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_CardTypeBlock_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
...
(Унаследован от
[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardTypeBlock_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
[CardTypeContent.ValidateInternal(IValidationResultBuilder)](M_Tessa_Cards_CardTypeContent_ValidateInternal.htm))  
##  __Поля
[XmlElementName](F_Tessa_Cards_CardTypeBlock_XmlElementName.htm)|  Имя XML-
элемента.  
---|---  
## __Методы расширения
...
---|---  
[GetCaptionVisibility](M_Tessa_UI_Cards_CardUIExtensions_GetCaptionVisibility.htm)|
Возвращает отображаемое состояние для заголовка блока, заданного по указанной
метаинформации.  
...
(Определяется
[ComHelper](T_Tessa_Extensions_Default_Client_EDS_ComHelper.htm))  
[MakeGlobal](M_Tessa_Cards_CardExtensions_MakeGlobal_6.htm)|  Сделать
указанный объект глобальным.  
(Определяется [CardExtensions](T_Tessa_Cards_CardExtensions.htm))  
[ReplaceControls](M_Tessa_Cards_CardExtensions_ReplaceControls_1.htm)|
