# BackupForAdminGetExtension - класс
...
C# __Копировать
     public class BackupForAdminGetExtension : CardGetExtension
VB __Копировать
     Public Class BackupForAdminGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class BackupForAdminGetExtension : public CardGetExtension
F# __Копировать
     type BackupForAdminGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ BackupForAdminGetExtension
##  __Конструкторы
[BackupForAdminGetExtension](M_Tessa_Extensions_Platform_Server_Cards_BackupForAdminGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса BackupForAdminGetExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_BackupForAdminGetExtension_BeforeRequest.htm)|  
(Переопределяет
