# TessaShellControlCollection - класс
...
C# __Копировать
     public sealed class TessaShellControlCollection : UIObservableCollection<ITessaShellControl, ITessaShellControlCollection>, 
    	ITessaShellControlCollection, IObservableCollection<ITessaShellControl, ITessaShellControlCollection>, IList<ITessaShellControl>, 
    	ICollection<ITessaShellControl>, IEnumerable<ITessaShellControl>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
VB __Копировать
     Public NotInheritable Class TessaShellControlCollection
    	Inherits UIObservableCollection(Of ITessaShellControl, ITessaShellControlCollection)
    	Implements ITessaShellControlCollection, IObservableCollection(Of ITessaShellControl, ITessaShellControlCollection), 
    	IList(Of ITessaShellControl), ICollection(Of ITessaShellControl), IEnumerable(Of ITessaShellControl), 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
C++ __Копировать
     public ref class TessaShellControlCollection sealed : public UIObservableCollection<ITessaShellControl^, ITessaShellControlCollection^>, 
    	ITessaShellControlCollection, IObservableCollection<ITessaShellControl^, ITessaShellControlCollection^>, IList<ITessaShellControl^>, 
    	ICollection<ITessaShellControl^>, IEnumerable<ITessaShellControl^>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
F# __Копировать
     [<SealedAttribute>]
    type TessaShellControlCollection = 
        class
            inherit UIObservableCollection<ITessaShellControl, ITessaShellControlCollection>
            interface ITessaShellControlCollection
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<[ITessaShellControl](T_Tessa_UI_Windows_ITessaShellControl.htm)> __[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[ITessaShellControl](T_Tessa_UI_Windows_ITessaShellControl.htm)> __[SuspendableObservableCollection](T_Tessa_Platform_Collections_SuspendableObservableCollection_1.htm)<[ITessaShellControl](T_Tessa_UI_Windows_ITessaShellControl.htm)> __[ObservableCollection](T_Tessa_Platform_Collections_ObservableCollection_2.htm)<[ITessaShellControl](T_Tessa_UI_Windows_ITessaShellControl.htm), [ITessaShellControlCollection](T_Tessa_UI_Windows_ITessaShellControlCollection.htm)> __[UIObservableCollection](T_Tessa_UI_UIObservableCollection_2.htm)<[ITessaShellControl](T_Tessa_UI_Windows_ITessaShellControl.htm), [ITessaShellControlCollection](T_Tessa_UI_Windows_ITessaShellControlCollection.htm)> __ TessaShellControlCollection
Implements
    [ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<[ITessaShellControl](T_Tessa_UI_Windows_ITessaShellControl.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<[ITessaShellControl](T_Tessa_UI_Windows_ITessaShellControl.htm)>, [IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<[ITessaShellControl](T_Tessa_UI_Windows_ITessaShellControl.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.ienumerable), [INotifyCollectionChanged](https://learn.microsoft.com/dotnet/api/system.collections.specialized.inotifycollectionchanged), [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged), [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable), [IObservableCollection](T_Tessa_Platform_Collections_IObservableCollection_2.htm)<[ITessaShellControl](T_Tessa_UI_Windows_ITessaShellControl.htm), [ITessaShellControlCollection](T_Tessa_UI_Windows_ITessaShellControlCollection.htm)>, [ITessaShellControlCollection](T_Tessa_UI_Windows_ITessaShellControlCollection.htm)
##  __Конструкторы
[TessaShellControlCollection()](M_Tessa_UI_Windows_TessaShellControlCollection__ctor.htm)|
Создаёт экземпляр коллекции с параметрами по умолчанию.  
---|---  
[TessaShellControlCollection(IEnumerable<ITessaShellControl>)](M_Tessa_UI_Windows_TessaShellControlCollection__ctor_1.htm)|
...
[TessaShellControlCollection(List<ITessaShellControl>)](M_Tessa_UI_Windows_TessaShellControlCollection__ctor_2.htm)|
...
(Унаследован от
[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<[ITessaShellControl](T_Tessa_UI_Windows_ITessaShellControl.htm)>)  
...
(Унаследован от
[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[ITessaShellControl](T_Tessa_UI_Windows_ITessaShellControl.htm)>)  
...
(Унаследован от
[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[ITessaShellControl](T_Tessa_UI_Windows_ITessaShellControl.htm)>)  
[Clone](M_Tessa_UI_Windows_TessaShellControlCollection_Clone.htm)| Создаёт
полную коллекции и её элементов, если они поддерживают клонирование.  
