...
C# __Копировать
    ...
    public class ForumModel : StorageObject
VB __Копировать
    <SerializableAttribute>
...
C++ __Копировать
    [SerializableAttribute]
    public ref class ForumModel : public StorageObject
F# __Копировать
     [<SerializableAttribute>]
    type ForumModel = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForumModel
##  __Конструкторы
[ForumModel(Dictionary<String,
Object>)](M_Tessa_Forums_Models_ForumModel__ctor.htm)| Инициализирует новый
экземпляр класса ForumModel  
---|---  
[ForumModel(Guid)](M_Tessa_Forums_Models_ForumModel__ctor_1.htm)|
Инициализирует новый экземпляр класса ForumModel  
[ForumModel(SerializationInfo,
StreamingContext)](M_Tessa_Forums_Models_ForumModel__ctor_2.htm)|
Инициализирует новый экземпляр класса ForumModel  
##  __Свойства
[CardID](P_Tessa_Forums_Models_ForumModel_CardID.htm)|  
---|---  
[ForumSettings](P_Tessa_Forums_Models_ForumModel_ForumSettings.htm)|  
[Info](P_Tessa_Forums_Models_ForumModel_Info.htm)|  
[SatelliteID](P_Tessa_Forums_Models_ForumModel_SatelliteID.htm)|  
[Topics](P_Tessa_Forums_Models_ForumModel_Topics.htm)|  
## __Методы
