...
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class SingletonNotFoundInCacheException
    	Inherits ApplicationException
C++ __Копировать
    [SerializableAttribute]
    public ref class SingletonNotFoundInCacheException sealed : public ApplicationException
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type SingletonNotFoundInCacheException = 
        class
            inherit ApplicationException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception) __ SingletonNotFoundInCacheException
##  __Конструкторы
[SingletonNotFoundInCacheException](M_Tessa_Cards_Caching_SingletonNotFoundInCacheException__ctor.htm)|
Создаёт экземпляр класса с указанием значений его свойств.  
---|---  
## __Свойства
[CardTypeName](P_Tessa_Cards_Caching_SingletonNotFoundInCacheException_CardTypeName.htm)|
...
(Унаследован от
[Exception](https://learn.microsoft.com/dotnet/api/system.exception))  
[ValidationResult](P_Tessa_Cards_Caching_SingletonNotFoundInCacheException_ValidationResult.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Cards_Caching_SingletonNotFoundInCacheException_GetObjectData.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ToString](M_Tessa_Cards_Caching_SingletonNotFoundInCacheException_ToString.htm)|
Возвращает строковое представление объекта.  
(Переопределяет
[Exception.ToString()](https://learn.microsoft.com/dotnet/api/system.exception.tostring#system-
exception-tostring))  
##  __События
