# PrepareCardDeleteExtension - класс
...
C# __Копировать
     public sealed class PrepareCardDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class PrepareCardDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class PrepareCardDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type PrepareCardDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ PrepareCardDeleteExtension
##  __Конструкторы
[PrepareCardDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_PrepareCardDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса PrepareCardDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_PrepareCardDeleteExtension_BeforeRequest.htm)|  
(Переопределяет
