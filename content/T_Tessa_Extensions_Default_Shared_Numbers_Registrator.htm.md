...
##  __Конструкторы
[Registrator](M_Tessa_Extensions_Default_Shared_Numbers_Registrator__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[FinalizeRegistration](M_Tessa_Extensions_Default_Shared_Numbers_Registrator_FinalizeRegistration.htm)|  
(Переопределяет
...
в этом объекте.  
(Унаследован от [RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm))  
[RegisterUnity](M_Tessa_Extensions_Default_Shared_Numbers_Registrator_RegisterUnity.htm)|  
(Переопределяет
