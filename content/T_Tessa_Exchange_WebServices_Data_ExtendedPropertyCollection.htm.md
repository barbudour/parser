# ExtendedPropertyCollection - класс
...
C# __Копировать
    ...
    public sealed class ExtendedPropertyCollection : ComplexPropertyCollection<ExtendedProperty>
VB __Копировать
    <EditorBrowsableAttribute(EditorBrowsableState.Never)>
...
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class ExtendedPropertyCollection sealed : public ComplexPropertyCollection<ExtendedProperty^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type ExtendedPropertyCollection = 
        class
            inherit ComplexPropertyCollection<ExtendedProperty>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[ExtendedProperty](T_Tessa_Exchange_WebServices_Data_ExtendedProperty.htm)> __ ExtendedPropertyCollection
##  __Конструкторы
[ExtendedPropertyCollection](M_Tessa_Exchange_WebServices_Data_ExtendedPropertyCollection__ctor.htm)|
Инициализирует новый экземпляр класса ExtendedPropertyCollection  
---|---  
##  __Свойства
