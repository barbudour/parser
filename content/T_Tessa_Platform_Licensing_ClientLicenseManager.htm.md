...
C# __Копировать
     public class ClientLicenseManager : ILicenseManager
VB __Копировать
     Public Class ClientLicenseManager
    	Implements ILicenseManager
C++ __Копировать
     public ref class ClientLicenseManager : ILicenseManager
F# __Копировать
     type ClientLicenseManager = 
        class
            interface ILicenseManager
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ClientLicenseManager
Implements
    [ILicenseManager](T_Tessa_Platform_Licensing_ILicenseManager.htm)
##  __Заметки
Наследник класса может переопределить его методы и свойства.
## __Конструкторы
[ClientLicenseManager](M_Tessa_Platform_Licensing_ClientLicenseManager__ctor.htm)|
Инициализирует новый экземпляр класса ClientLicenseManager  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetLicenseAsync](M_Tessa_Platform_Licensing_ClientLicenseManager_GetLicenseAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[SetLicense](M_Tessa_Platform_Licensing_ClientLicenseManager_SetLicense.htm)|
