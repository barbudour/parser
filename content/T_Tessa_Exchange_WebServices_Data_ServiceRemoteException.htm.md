...
VB __Копировать
     Public Class ServiceRemoteException
    	Inherits Exception
C++ __Копировать
     public ref class ServiceRemoteException : public Exception
F# __Копировать
     type ServiceRemoteException = 
        class
            inherit Exception
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __ ServiceRemoteException
Derived
[Tessa.Exchange.WebServices.Autodiscover.AutodiscoverRemoteException](T_Tessa_Exchange_WebServices_Autodiscover_AutodiscoverRemoteException.htm)
[Tessa.Exchange.WebServices.Autodiscover.AutodiscoverResponseException](T_Tessa_Exchange_WebServices_Autodiscover_AutodiscoverResponseException.htm)
[Tessa.Exchange.WebServices.Data.AccountIsLockedException](T_Tessa_Exchange_WebServices_Data_AccountIsLockedException.htm)
[Tessa.Exchange.WebServices.Data.BatchServiceResponseException<TResponse>](T_Tessa_Exchange_WebServices_Data_BatchServiceResponseException_1.htm)
[Tessa.Exchange.WebServices.Data.ServiceRequestException](T_Tessa_Exchange_WebServices_Data_ServiceRequestException.htm)
[Tessa.Exchange.WebServices.Data.ServiceResponseException](T_Tessa_Exchange_WebServices_Data_ServiceResponseException.htm)
[Tessa.Exchange.WebServices.Data.UpdateInboxRulesException](T_Tessa_Exchange_WebServices_Data_UpdateInboxRulesException.htm)
Подробнее __Less __
##  __Конструкторы
[ServiceRemoteException()](M_Tessa_Exchange_WebServices_Data_ServiceRemoteException__ctor.htm)|
ServiceRemoteException Constructor.  
---|---  
[ServiceRemoteException(String)](M_Tessa_Exchange_WebServices_Data_ServiceRemoteException__ctor_2.htm)|
ServiceRemoteException Constructor.  
[ServiceRemoteException(SerializationInfo,
StreamingContext)](M_Tessa_Exchange_WebServices_Data_ServiceRemoteException__ctor_1.htm)|
Initializes a new instance of the ServiceRemoteException class with serialized
data.  
[ServiceRemoteException(String,
Exception)](M_Tessa_Exchange_WebServices_Data_ServiceRemoteException__ctor_3.htm)|
ServiceRemoteException Constructor.  
## __Свойства
