...
C# __Копировать
     public const string SecondaryProcessName = "SecondaryProcessName"
VB __Копировать
     Public Const SecondaryProcessName As String = "SecondaryProcessName"
C++ __Копировать
     public:
    literal String^ SecondaryProcessName = "SecondaryProcessName"
F# __Копировать
     static val mutable SecondaryProcessName: string
#### Значение поля
