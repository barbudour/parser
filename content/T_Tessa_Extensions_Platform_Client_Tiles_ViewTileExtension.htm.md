...
C# __Копировать
     public sealed class ViewTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class ViewTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class ViewTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type ViewTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ ViewTileExtension
##  __Конструкторы
[ViewTileExtension](M_Tessa_Extensions_Platform_Client_Tiles_ViewTileExtension__ctor.htm)|
Initializes a new instance of the ViewTileExtension class.  
---|---  
## __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Platform_Client_Tiles_ViewTileExtension_InitializingGlobal.htm)|
...
[InitializingLocal](M_Tessa_Extensions_Platform_Client_Tiles_ViewTileExtension_InitializingLocal.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[OpeningLocal](M_Tessa_Extensions_Platform_Client_Tiles_ViewTileExtension_OpeningLocal.htm)|
