...
VB __Копировать
     Public NotInheritable Class KrCardNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class KrCardNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type KrCardNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ KrCardNewExtension
##  __Конструкторы
[KrCardNewExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrCardNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrCardNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrCardNewExtension_AfterRequest.htm)|
