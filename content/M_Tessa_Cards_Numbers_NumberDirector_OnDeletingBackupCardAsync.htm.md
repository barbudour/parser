# NumberDirector.OnDeletingBackupCardAsync - метод
...
C# __Копировать
     protected virtual Task<bool> OnDeletingBackupCardAsync(
    	INumberContext context,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Protected Overridable Function OnDeletingBackupCardAsync ( 
