# CardLibraryItem - класс
Запись в библиотеке с карточками.
## __Definition
 **Пространство имён:** [Tessa.Cards](N_Tessa_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class CardLibraryItem : CardSerializableObject, 
    	IEquatable<CardLibraryItem>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardLibraryItem
    	Inherits CardSerializableObject
    	Implements IEquatable(Of CardLibraryItem)
C++ __Копировать
    [SerializableAttribute]
    public ref class CardLibraryItem sealed : public CardSerializableObject, 
    	IEquatable<CardLibraryItem^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardLibraryItem = 
        class
            ...
            interface IEquatable<CardLibraryItem>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __ CardLibraryItem
Implements
    [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)<CardLibraryItem>
##  __Конструкторы
...
## __Свойства
[Description](P_Tessa_Cards_CardLibraryItem_Description.htm)|  Описание
карточки.  
---|---  
...
[Options](P_Tessa_Cards_CardLibraryItem_Options.htm)|  Относительный путь от
файла библиотеки до файла с опциями слияния.  
[Path](P_Tessa_Cards_CardLibraryItem_Path.htm)|  Относительный путь от файла
библиотеки до файла с карточкой.  
[Reference](P_Tessa_Cards_CardSerializableObject_Reference.htm)|  Имя
глобального объекта, на который ссылается данный объект.  
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[XmlElementNameInternal](P_Tessa_Cards_CardLibraryItem_XmlElementNameInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeAttributeFromXml](M_Tessa_Cards_CardLibraryItem_DeserializeAttributeFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeElementFromXml](M_Tessa_Cards_CardLibraryItem_DeserializeElementFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_CardLibraryItem_DeserializeFromBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_CardLibraryItem_DeserializeFromStorageInternal.htm)|
...
[GetHashCode](M_Tessa_Cards_CardLibraryItem_GetHashCode.htm)| Возвращает хеш-
код объекта.  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetValidationName](M_Tessa_Cards_CardLibraryItem_GetValidationName.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_CardLibraryItem_OnDeserializing.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeAttributesToXml](M_Tessa_Cards_CardLibraryItem_SerializeAttributesToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeElementsToXml](M_Tessa_Cards_CardLibraryItem_SerializeElementsToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_CardLibraryItem_SerializeToBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_CardLibraryItem_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
...
(Унаследован от
[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardLibraryItem_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
...
##  __Поля
[XmlElementName](F_Tessa_Cards_CardLibraryItem_XmlElementName.htm)|  Имя XML-
элемента.  
---|---  
## __Методы расширения
