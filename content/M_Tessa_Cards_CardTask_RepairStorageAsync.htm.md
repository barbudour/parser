# CardTask.RepairStorageAsync - метод
...
cardMetadata [ICardMetadata](T_Tessa_Cards_ICardMetadata.htm)
     Метаинформация по всем типам карточек. Если она не содержит метаинформацию по текущему заданию или по его файлам, то соответствующие объекты не будут исправлены, но ошибок при этом не возникнет. 
cancellationToken
