...
C++ __Копировать
     public ref class PerformanceCounter sealed : IPerformanceCounter
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ PerformanceCounter
Implements
    [IPerformanceCounter](T_Tessa_Diagnostics_IPerformanceCounter.htm)
##  __Конструкторы
[PerformanceCounter](M_Tessa_Diagnostics_PerformanceCounter__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Measure](M_Tessa_Diagnostics_PerformanceCounter_Measure.htm)|  
[MemberwiseClone](https://learn.microsoft.com/dotnet/api/system.object.memberwiseclone#system-
object-memberwiseclone)| Creates a shallow copy of the current
[Object](https://learn.microsoft.com/dotnet/api/system.object).  
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Reset](M_Tessa_Diagnostics_PerformanceCounter_Reset.htm)|  
