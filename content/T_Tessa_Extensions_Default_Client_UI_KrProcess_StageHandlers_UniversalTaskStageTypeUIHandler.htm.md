# UniversalTaskStageTypeUIHandler - класс
...
C++ __Копировать
     public ref class UniversalTaskStageTypeUIHandler : public StageTypeUIHandlerBase
F# __Копировать
     type UniversalTaskStageTypeUIHandler = 
        class
            inherit StageTypeUIHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StageTypeUIHandlerBase](T_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_StageTypeUIHandlerBase.htm) __ UniversalTaskStageTypeUIHandler
##  __Конструкторы
[UniversalTaskStageTypeUIHandler](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_UniversalTaskStageTypeUIHandler__ctor.htm)|
Инициализирует новый экземпляр класса UniversalTaskStageTypeUIHandler  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Finalize(IKrStageTypeUIHandlerContext)](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_UniversalTaskStageTypeUIHandler_Finalize.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialize](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_UniversalTaskStageTypeUIHandler_Initialize.htm)|
