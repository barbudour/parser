# FileTemplateCompilationStoreExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Cards](N_Tessa_Extensions_Platform_Server_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class FileTemplateCompilationStoreExtension : PlaceholderCompilationStoreRequestExtension
VB __Копировать
     Public NotInheritable Class FileTemplateCompilationStoreExtension
    	Inherits PlaceholderCompilationStoreRequestExtension
C++ __Копировать
     public ref class FileTemplateCompilationStoreExtension sealed : public PlaceholderCompilationStoreRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type FileTemplateCompilationStoreExtension = 
        class
            inherit PlaceholderCompilationStoreRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __[PlaceholderCompilationStoreRequestExtension](T_Tessa_Extensions_Platform_Server_Cards_PlaceholderCompilationStoreRequestExtension.htm) __ FileTemplateCompilationStoreExtension
##  __Конструкторы
[FileTemplateCompilationStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_FileTemplateCompilationStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса FileTemplateCompilationStoreExtension  
---|---  
##  __Свойства
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Cards_FileTemplateCompilationStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
[PlaceholderCompilationStoreRequestExtension.BeforeCommitTransaction(ICardStoreExtensionContext)](M_Tessa_Extensions_Platform_Server_Cards_PlaceholderCompilationStoreRequestExtension_BeforeCommitTransaction.htm))  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetDocumentsAsync](M_Tessa_Extensions_Platform_Server_Cards_FileTemplateCompilationStoreExtension_GetDocumentsAsync.htm)|  
(Переопределяет
[PlaceholderCompilationStoreRequestExtension.GetDocumentsAsync(ICardExtensionContext,
Guid)](M_Tessa_Extensions_Platform_Server_Cards_PlaceholderCompilationStoreRequestExtension_GetDocumentsAsync.htm))  
[GetExtensionScriptDescriptionAsync](M_Tessa_Extensions_Platform_Server_Cards_FileTemplateCompilationStoreExtension_GetExtensionScriptDescriptionAsync.htm)|  
(Переопределяет
[PlaceholderCompilationStoreRequestExtension.GetExtensionScriptDescriptionAsync(ICardExtensionContext)](M_Tessa_Extensions_Platform_Server_Cards_PlaceholderCompilationStoreRequestExtension_GetExtensionScriptDescriptionAsync.htm))  
