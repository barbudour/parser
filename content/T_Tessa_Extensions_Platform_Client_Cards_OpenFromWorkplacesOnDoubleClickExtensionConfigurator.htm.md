# OpenFromWorkplacesOnDoubleClickExtensionConfigurator - класс
...
C# __Копировать
     public sealed class OpenFromWorkplacesOnDoubleClickExtensionConfigurator : ExtensionSettingsConfiguratorBase
VB __Копировать
     Public NotInheritable Class OpenFromWorkplacesOnDoubleClickExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class OpenFromWorkplacesOnDoubleClickExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type OpenFromWorkplacesOnDoubleClickExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ OpenFromWorkplacesOnDoubleClickExtensionConfigurator
##  __Конструкторы
[OpenFromWorkplacesOnDoubleClickExtensionConfigurator](M_Tessa_Extensions_Platform_Client_Cards_OpenFromWorkplacesOnDoubleClickExtensionConfigurator__ctor.htm)|
