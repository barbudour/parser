...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FileResolverContext
Implements
    [IFileResolverContext](T_Tessa_Files_IFileResolverContext.htm)
##  __Конструкторы
[FileResolverContext](M_Tessa_Files_FileResolverContext__ctor.htm)|  Создаёт
...
## __Методы
[Create](M_Tessa_Files_FileResolverContext_Create.htm)|  Создаёт область
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ResolveFileSource](M_Tessa_Files_FileResolverContext_ResolveFileSource.htm)|
