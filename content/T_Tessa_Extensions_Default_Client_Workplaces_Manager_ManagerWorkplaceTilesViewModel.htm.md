# ManagerWorkplaceTilesViewModel - класс
...
VB __Копировать
     Public NotInheritable Class ManagerWorkplaceTilesViewModel
    	Inherits ViewModel(Of EmptyModel)
C++ __Копировать
     public ref class ManagerWorkplaceTilesViewModel sealed : public ViewModel<EmptyModel^>
F# __Копировать
     [<SealedAttribute>]
    type ManagerWorkplaceTilesViewModel = 
        class
            inherit ViewModel<EmptyModel>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NotificationObject](T_Tessa_Platform_NotificationObject.htm) __[NotificationUIObject](T_Tessa_UI_NotificationUIObject.htm) __[ViewModel](T_Tessa_UI_ViewModel_1.htm)<[EmptyModel](T_Tessa_UI_EmptyModel.htm)> __ ManagerWorkplaceTilesViewModel
##  __Конструкторы
[ManagerWorkplaceTilesViewModel](M_Tessa_Extensions_Default_Client_Workplaces_Manager_ManagerWorkplaceTilesViewModel__ctor.htm)|
Инициализирует новый экземпляр класса ManagerWorkplaceTilesViewModel  
---|---  
##  __Свойства
...
(Унаследован от [ViewModel<TModel>](T_Tessa_UI_ViewModel_1.htm))  
[Selector](P_Tessa_Extensions_Default_Client_Workplaces_Manager_ManagerWorkplaceTilesViewModel_Selector.htm)|
Gets the tiles.  
## __Методы
