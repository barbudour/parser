# ActionHistoryGetExtension - класс
...
C# __Копировать
     public sealed class ActionHistoryGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class ActionHistoryGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class ActionHistoryGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type ActionHistoryGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ ActionHistoryGetExtension
##  __Конструкторы
[ActionHistoryGetExtension](M_Tessa_Extensions_Platform_Server_Cards_ActionHistoryGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса ActionHistoryGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_ActionHistoryGetExtension_AfterRequest.htm)|  
(Переопределяет
