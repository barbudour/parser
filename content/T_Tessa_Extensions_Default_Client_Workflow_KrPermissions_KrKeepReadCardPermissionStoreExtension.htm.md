# KrKeepReadCardPermissionStoreExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrKeepReadCardPermissionStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class KrKeepReadCardPermissionStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type KrKeepReadCardPermissionStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ KrKeepReadCardPermissionStoreExtension
##  __Конструкторы
[KrKeepReadCardPermissionStoreExtension](M_Tessa_Extensions_Default_Client_Workflow_KrPermissions_KrKeepReadCardPermissionStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrKeepReadCardPermissionStoreExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Client_Workflow_KrPermissions_KrKeepReadCardPermissionStoreExtension_AfterRequest.htm)|  
(Переопределяет
