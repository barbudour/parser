# EmptyFilterPolicy - класс
Политика, определяющая отсутствие фильтра для выполнения метода расширения.
Может использоваться для замещения существующей политики
[IFilterPolicy](T_Tessa_Extensions_IFilterPolicy.htm).
## __Definition
 **Пространство имён:** [Tessa.Extensions](N_Tessa_Extensions.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class EmptyFilterPolicy : IFilterPolicy, 
    	IExtensionPolicy
VB __Копировать
     Public NotInheritable Class EmptyFilterPolicy
    	Implements IFilterPolicy, IExtensionPolicy
C++ __Копировать
     public ref class EmptyFilterPolicy sealed : IFilterPolicy, 
    	IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type EmptyFilterPolicy = 
        class
            interface IFilterPolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ EmptyFilterPolicy
Implements
    [IExtensionPolicy](T_Tessa_Extensions_IExtensionPolicy.htm), [IFilterPolicy](T_Tessa_Extensions_IFilterPolicy.htm)
##  __Конструкторы
[EmptyFilterPolicy](M_Tessa_Extensions_EmptyFilterPolicy__ctor.htm)|
Инициализирует новый экземпляр класса EmptyFilterPolicy  
---|---  
##  __Свойства
...
---|---  
[FilterAsync](M_Tessa_Extensions_EmptyFilterPolicy_FilterAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetFilterContextAsync](M_Tessa_Extensions_EmptyFilterPolicy_GetFilterContextAsync.htm)|
