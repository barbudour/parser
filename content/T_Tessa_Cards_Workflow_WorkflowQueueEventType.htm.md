...
C# __Копировать
    ...
    public sealed class WorkflowQueueEventType : RegistryItem<Guid, WorkflowQueueEventType>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowQueueEventType
    	Inherits RegistryItem(Of Guid, WorkflowQueueEventType)
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowQueueEventType sealed : public RegistryItem<Guid, WorkflowQueueEventType^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowQueueEventType = 
        class
            inherit RegistryItem<Guid, WorkflowQueueEventType>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[RegistryItem](T_Tessa_Platform_RegistryItem_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), WorkflowQueueEventType> __ WorkflowQueueEventType
##  __Конструкторы
[WorkflowQueueEventType](M_Tessa_Cards_Workflow_WorkflowQueueEventType__ctor.htm)|
...
(Унаследован от [RegistryItem<TIdentifier,
TItem>](T_Tessa_Platform_RegistryItem_2.htm))  
[Registry](P_Tessa_Cards_Workflow_WorkflowQueueEventType_Registry.htm)|
...
[FromGuid](M_Tessa_Cards_Workflow_WorkflowQueueEventType_FromGuid.htm)|
