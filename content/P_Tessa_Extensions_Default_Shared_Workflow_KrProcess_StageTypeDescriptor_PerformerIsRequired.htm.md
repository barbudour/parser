# StageTypeDescriptor.PerformerIsRequired - свойство
...
VB __Копировать
     Public ReadOnly Property PerformerIsRequired As Boolean
    	Get
C++ __Копировать
     public:
    property bool PerformerIsRequired {
    	bool get ();
    }
F# __Копировать
     member PerformerIsRequired : bool with get
#### Значение свойства
