...
C# __Копировать
     public interface IFileCollection : IFileEntityCollection<IFile, IFileCollection>, 
    	IObservableCollectionLookup<Guid, IFile, IFileCollection>, IObservableCollection<IFile, IFileCollection>, 
    	IList<IFile>, ICollection<IFile>, IEnumerable<IFile>, 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer<Guid, IFile>, 
    	IControllableCollection<IFile>
VB __Копировать
     Public Interface IFileCollection
    	Inherits IFileEntityCollection(Of IFile, IFileCollection), IObservableCollectionLookup(Of Guid, IFile, IFileCollection), 
    	IObservableCollection(Of IFile, IFileCollection), IList(Of IFile), 
    	ICollection(Of IFile), IEnumerable(Of IFile), IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer(Of Guid, IFile), 
    	IControllableCollection(Of IFile)
C++ __Копировать
     public interface class IFileCollection : IFileEntityCollection<IFile^, IFileCollection^>, 
    	IObservableCollectionLookup<Guid, IFile^, IFileCollection^>, IObservableCollection<IFile^, IFileCollection^>, 
    	IList<IFile^>, ICollection<IFile^>, IEnumerable<IFile^>, 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer<Guid, IFile^>, 
    	IControllableCollection<IFile^>
F# __Копировать
     type IFileCollection = 
        interface
...
Implements
    [ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<[IFile](T_Tessa_Files_IFile.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<[IFile](T_Tessa_Files_IFile.htm)>, [IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<[IFile](T_Tessa_Files_IFile.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.ienumerable), [INotifyCollectionChanged](https://learn.microsoft.com/dotnet/api/system.collections.specialized.inotifycollectionchanged), [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged), [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable), [IFileEntityCollection](T_Tessa_Files_IFileEntityCollection_2.htm)<[IFile](T_Tessa_Files_IFile.htm), IFileCollection>, [IControllableCollection](T_Tessa_Platform_Collections_IControllableCollection_1.htm)<[IFile](T_Tessa_Files_IFile.htm)>, [ILookupContainer](T_Tessa_Platform_Collections_ILookupContainer_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [IFile](T_Tessa_Files_IFile.htm)>, [IObservableCollection](T_Tessa_Platform_Collections_IObservableCollection_2.htm)<[IFile](T_Tessa_Files_IFile.htm), IFileCollection>, [IObservableCollectionLookup](T_Tessa_Platform_Collections_IObservableCollectionLookup_3.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [IFile](T_Tessa_Files_IFile.htm), IFileCollection>
##  __Свойства
