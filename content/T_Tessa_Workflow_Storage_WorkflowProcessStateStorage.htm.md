# WorkflowProcessStateStorage - класс
...
C# __Копировать
    ...
    public sealed class WorkflowProcessStateStorage : WorkflowStateStorageBase<WorkflowProcessStorage>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowProcessStateStorage
    	Inherits WorkflowStateStorageBase(Of WorkflowProcessStorage)
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowProcessStateStorage sealed : public WorkflowStateStorageBase<WorkflowProcessStorage^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowProcessStateStorage = 
        class
            inherit WorkflowStateStorageBase<WorkflowProcessStorage>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __[WorkflowStateStorageBase](T_Tessa_Workflow_Storage_WorkflowStateStorageBase_1.htm)<[WorkflowProcessStorage](T_Tessa_Workflow_Storage_WorkflowProcessStorage.htm)> __ WorkflowProcessStateStorage
##  __Конструкторы
[WorkflowProcessStateStorage()](M_Tessa_Workflow_Storage_WorkflowProcessStateStorage__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowProcessStateStorage  
---|---  
[WorkflowProcessStateStorage(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowProcessStateStorage__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowProcessStateStorage  
[WorkflowProcessStateStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowProcessStateStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowProcessStateStorage  
[WorkflowProcessStateStorage(WorkflowProcessStorage, Guid, String,
Nullable<Guid>)](M_Tessa_Workflow_Storage_WorkflowProcessStateStorage__ctor_3.htm)|
Инициализирует новый экземпляр класса WorkflowProcessStateStorage  
##  __Свойства
[ActiveNodes](P_Tessa_Workflow_Storage_WorkflowProcessStateStorage_ActiveNodes.htm)|  
---|---  
[CardDigest](P_Tessa_Workflow_Storage_WorkflowProcessStateStorage_CardDigest.htm)|  
[CardID](P_Tessa_Workflow_Storage_WorkflowProcessStateStorage_CardID.htm)|  
[Created](P_Tessa_Workflow_Storage_WorkflowStateStorageBase_1_Created.htm)|
Дата/вермя создания экземпляра  
(Унаследован от
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[LogLevel](P_Tessa_Workflow_Storage_WorkflowProcessStateStorage_LogLevel.htm)|  
[Name](P_Tessa_Workflow_Storage_WorkflowProcessStateStorage_Name.htm)|  
[ParentID](P_Tessa_Workflow_Storage_WorkflowProcessStateStorage_ParentID.htm)|
ID родительского процесса  
[ProcessedNodes](P_Tessa_Workflow_Storage_WorkflowProcessStateStorage_ProcessedNodes.htm)|  
[TemplateCardID](P_Tessa_Workflow_Storage_WorkflowProcessStateStorage_TemplateCardID.htm)|
ID карточки шаблона  
[TemplateID](P_Tessa_Workflow_Storage_WorkflowStateStorageBase_1_TemplateID.htm)|
ID шаблона объекта, на базе которого построен данный экземпляр  
(Унаследован от
[WorkflowStateStorageBase<T>](T_Tessa_Workflow_Storage_WorkflowStateStorageBase_1.htm))  
[WorkflowCardID](P_Tessa_Workflow_Storage_WorkflowProcessStateStorage_WorkflowCardID.htm)|  
## __Методы
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[Clone](M_Tessa_Workflow_Storage_WorkflowProcessStateStorage_Clone.htm)|  
(Переопределяет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[UpdateData](M_Tessa_Workflow_Storage_WorkflowProcessStateStorage_UpdateData.htm)|  
(Переопределяет
[WorkflowStorageBase.UpdateData(WorkflowStorageBase)](M_Tessa_Workflow_Storage_WorkflowStorageBase_UpdateData.htm))  
##  __События
