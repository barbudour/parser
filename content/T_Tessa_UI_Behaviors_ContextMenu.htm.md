# ContextMenu - класс
Поведение, отображающее контекстное меню по правой клавише мыши, если по
логическому дереву элементов, в котором произошёл клик, в свойстве DataContext
можно найти объект, реализующий интерфейс
...
C# __Копировать
     public sealed class ContextMenu : Behavior<UIElement>
VB __Копировать
     Public NotInheritable Class ContextMenu
    	Inherits Behavior(Of UIElement)
C++ __Копировать
     public ref class ContextMenu sealed : public Behavior<UIElement^>
F# __Копировать
     [<SealedAttribute>]
    type ContextMenu = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement)> __ ContextMenu
##  __Конструкторы
[ContextMenu](M_Tessa_UI_Behaviors_ContextMenu__ctor.htm)| Инициализирует
новый экземпляр класса ContextMenu  
---|---  
##  __Свойства
...
(Унаследован от
[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject))  
[HandledEventsToo](P_Tessa_UI_Behaviors_ContextMenu_HandledEventsToo.htm)|  
[HandleEvents](P_Tessa_UI_Behaviors_ContextMenu_HandleEvents.htm)|  Признак
того, что для событий нажатия правой кнопки мыши свойство
[Handled](https://learn.microsoft.com/dotnet/api/system.windows.routedeventargs.handled#system-
windows-routedeventargs-handled) будет установленным равным true, если
контекстное меню будет открыто. По умолчанию значение равно true.  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[MinWidth](P_Tessa_UI_Behaviors_ContextMenu_MinWidth.htm)|  Минимальная ширина
меню  
[PlacementTargetType](P_Tessa_UI_Behaviors_ContextMenu_PlacementTargetType.htm)|
Тип для PlacementTarget.  
[ShowAsync](P_Tessa_UI_Behaviors_ContextMenu_ShowAsync.htm)|  Признак того,
что контекстное меню отображается асинхронно после того, как закончится
обработка нажатия правой кнопки мыши. Рекомендуется устанавливать значение
равным true, если также установлено значение
[HandleEvents](P_Tessa_UI_Behaviors_ContextMenu_HandleEvents.htm) равным true.
По умолчанию значение равно false.  
[ShowMenuEvent](P_Tessa_UI_Behaviors_ContextMenu_ShowMenuEvent.htm)|  Событие,
по которому отображается меню  
## __Методы
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CloneCore](M_Tessa_UI_Behaviors_ContextMenu_CloneCore.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CloneCurrentValueCore](M_Tessa_UI_Behaviors_ContextMenu_CloneCurrentValueCore.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_ContextMenu_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[GetAsFrozenCore](M_Tessa_UI_Behaviors_ContextMenu_GetAsFrozenCore.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[GetCurrentValueAsFrozenCore](M_Tessa_UI_Behaviors_ContextMenu_GetCurrentValueAsFrozenCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[GetItemContainerStyle](M_Tessa_UI_Behaviors_ContextMenu_GetItemContainerStyle.htm)|  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[GetPlacementMode](M_Tessa_UI_Behaviors_ContextMenu_GetPlacementMode.htm)|  
...
(Унаследован от [Behavior<T>](T_Tessa_UI_Behaviors_Behavior_1.htm))  
[GetStyle](M_Tessa_UI_Behaviors_ContextMenu_GetStyle.htm)|  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_ContextMenu_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_ContextMenu_OnDetaching.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[SetItemContainerStyle](M_Tessa_UI_Behaviors_ContextMenu_SetItemContainerStyle.htm)|  
[SetPlacementMode](M_Tessa_UI_Behaviors_ContextMenu_SetPlacementMode.htm)|  
[SetStyle](M_Tessa_UI_Behaviors_ContextMenu_SetStyle.htm)|  
...
---|---  
##  __Поля
[ItemContainerStyleProperty](F_Tessa_UI_Behaviors_ContextMenu_ItemContainerStyleProperty.htm)|
Стиль элементов контекстного меню или null, если используется стиль по
умолчанию.  
---|---  
[PlacementModeProperty](F_Tessa_UI_Behaviors_ContextMenu_PlacementModeProperty.htm)|  
[StyleProperty](F_Tessa_UI_Behaviors_ContextMenu_StyleProperty.htm)|  Стиль
контекстного меню или null, если используется стиль по умолчанию.  
## __Вложенные свойства
[ItemContainerStyle](P_Tessa_UI_Behaviors_ContextMenu_ItemContainerStyle.htm)|
Стиль элементов контекстного меню или null, если используется стиль по
умолчанию.  
---|---  
[PlacementMode](P_Tessa_UI_Behaviors_ContextMenu_PlacementMode.htm)|  
[Style](P_Tessa_UI_Behaviors_ContextMenu_Style.htm)|  Стиль контекстного меню
или null, если используется стиль по умолчанию.  
## __См. также
#### Ссылки
