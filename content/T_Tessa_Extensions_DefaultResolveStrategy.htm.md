...
C# __Копировать
     public sealed class DefaultResolveStrategy : IExtensionStrategy
VB __Копировать
     Public NotInheritable Class DefaultResolveStrategy
    	Implements IExtensionStrategy
C++ __Копировать
     public ref class DefaultResolveStrategy sealed : IExtensionStrategy
F# __Копировать
     [<SealedAttribute>]
    type DefaultResolveStrategy = 
        class
            interface IExtensionStrategy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ DefaultResolveStrategy
Implements
    [IExtensionStrategy](T_Tessa_Extensions_IExtensionStrategy.htm)
##  __Конструкторы
[DefaultResolveStrategy](M_Tessa_Extensions_DefaultResolveStrategy__ctor.htm)|
Инициализирует новый экземпляр класса DefaultResolveStrategy  
---|---  
##  __Свойства
...
---|---  
##  __Методы
[ApplyAsync](M_Tessa_Extensions_DefaultResolveStrategy_ApplyAsync.htm)|
