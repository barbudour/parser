# FileSignaturesStoreExtension - класс
...
C# __Копировать
     public sealed class FileSignaturesStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class FileSignaturesStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class FileSignaturesStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type FileSignaturesStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ FileSignaturesStoreExtension
##  __Конструкторы
[FileSignaturesStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_FileSignaturesStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса FileSignaturesStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_FileSignaturesStoreExtension_BeforeRequest.htm)|  
(Переопределяет
