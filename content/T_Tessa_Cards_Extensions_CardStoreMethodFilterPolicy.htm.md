# CardStoreMethodFilterPolicy - класс
...
C# __Копировать
     public sealed class CardStoreMethodFilterPolicy : IFilterPolicy, 
    	IExtensionPolicy
VB __Копировать
     Public NotInheritable Class CardStoreMethodFilterPolicy
    	Implements IFilterPolicy, IExtensionPolicy
C++ __Копировать
     public ref class CardStoreMethodFilterPolicy sealed : IFilterPolicy, 
    	IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type CardStoreMethodFilterPolicy = 
        class
            interface IFilterPolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardStoreMethodFilterPolicy
Implements
    [IExtensionPolicy](T_Tessa_Extensions_IExtensionPolicy.htm), [IFilterPolicy](T_Tessa_Extensions_IFilterPolicy.htm)
##  __Конструкторы
[CardStoreMethodFilterPolicy](M_Tessa_Cards_Extensions_CardStoreMethodFilterPolicy__ctor.htm)|
Инициализирует новый экземпляр класса CardStoreMethodFilterPolicy  
---|---  
##  __Свойства
...
---|---  
[FilterAsync](M_Tessa_Cards_Extensions_CardStoreMethodFilterPolicy_FilterAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetFilterContextAsync](M_Tessa_Cards_Extensions_CardStoreMethodFilterPolicy_GetFilterContextAsync.htm)|
