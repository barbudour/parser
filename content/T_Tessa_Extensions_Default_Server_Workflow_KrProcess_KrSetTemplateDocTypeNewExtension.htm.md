# KrSetTemplateDocTypeNewExtension - класс
...
C# __Копировать
     public sealed class KrSetTemplateDocTypeNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class KrSetTemplateDocTypeNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class KrSetTemplateDocTypeNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type KrSetTemplateDocTypeNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ KrSetTemplateDocTypeNewExtension
##  __Конструкторы
[KrSetTemplateDocTypeNewExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrSetTemplateDocTypeNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrSetTemplateDocTypeNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrSetTemplateDocTypeNewExtension_AfterRequest.htm)|  
(Переопределяет
