# CardMethodPolicy<TMethod> \- класс
...
C# __Копировать
     public sealed class CardMethodPolicy<TMethod> : ICardMethodPolicy<TMethod>, 
    	IExtensionPolicy
    where TMethod : struct, new()
VB __Копировать
     Public NotInheritable Class CardMethodPolicy(Of TMethod As {Structure, New})
    	Implements ICardMethodPolicy(Of TMethod), IExtensionPolicy
C++ __Копировать
    generic<typename TMethod>
    where TMethod : value class, gcnew()
    public ref class CardMethodPolicy sealed : ICardMethodPolicy<TMethod>, 
    	IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type CardMethodPolicy<'TMethod when 'TMethod : struct, new()> = 
        class
            interface ICardMethodPolicy<'TMethod>
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardMethodPolicy<TMethod>
Implements
...
##  __Конструкторы
[CardMethodPolicy<TMethod>](M_Tessa_Cards_Extensions_CardMethodPolicy_1__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsAllowed](M_Tessa_Cards_Extensions_CardMethodPolicy_1_IsAllowed.htm)|
