# ServiceResponseException - класс
...
C++ __Копировать
     public ref class ServiceResponseException : public ServiceRemoteException
F# __Копировать
     type ServiceResponseException = 
        class
            inherit ServiceRemoteException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceRemoteException](T_Tessa_Exchange_WebServices_Data_ServiceRemoteException.htm) __ ServiceResponseException
Derived
[Tessa.Exchange.WebServices.Data.ServerBusyException](T_Tessa_Exchange_WebServices_Data_ServerBusyException.htm)
##  __Конструкторы
[ServiceResponseException](M_Tessa_Exchange_WebServices_Data_ServiceResponseException__ctor.htm)|
Initializes a new instance of the ServiceResponseException class with
serialized data.  
---|---  
## __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Exchange_WebServices_Data_ServiceResponseException_GetObjectData.htm)|
Sets the
