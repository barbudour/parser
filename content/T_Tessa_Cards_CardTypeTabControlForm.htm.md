# CardTypeTabControlForm - класс
Объект, описывающий пользовательский интерфейс для вкладки карточки, который
...
C# __Копировать
    ...
    public sealed class CardTypeTabControlForm : CardTypeTabForm, 
    	IEquatable<CardTypeTabControlForm>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardTypeTabControlForm
    	Inherits CardTypeTabForm
    	Implements IEquatable(Of CardTypeTabControlForm)
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTypeTabControlForm sealed : public CardTypeTabForm, 
    	IEquatable<CardTypeTabControlForm^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardTypeTabControlForm = 
        class
            inherit CardTypeTabForm
            interface IEquatable<CardTypeTabControlForm>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __[CardTypeForm](T_Tessa_Cards_CardTypeForm.htm) __[CardTypeTabForm](T_Tessa_Cards_CardTypeTabForm.htm) __ CardTypeTabControlForm
Implements
    [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)<CardTypeTabControlForm>
##  __Конструкторы
[CardTypeTabControlForm](M_Tessa_Cards_CardTypeTabControlForm__ctor.htm)|
...
[Name](P_Tessa_Cards_CardTypeTabControlForm_Name.htm)| Отображаемое имя
объекта.  
(Переопределяет
...
(Унаследован от [CardTypeTabForm](T_Tessa_Cards_CardTypeTabForm.htm))  
[XmlElementNameInternal](P_Tessa_Cards_CardTypeTabControlForm_XmlElementNameInternal.htm)|
...
(Унаследован от [CardTypeForm](T_Tessa_Cards_CardTypeForm.htm))  
[GetHashCode](M_Tessa_Cards_CardTypeTabControlForm_GetHashCode.htm)|
...
(Унаследован от
[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardTypeTabControlForm_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
