...
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class FolderIdCollection sealed : public ComplexPropertyCollection<FolderId^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type FolderIdCollection = 
        class
            inherit ComplexPropertyCollection<FolderId>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[FolderId](T_Tessa_Exchange_WebServices_Data_FolderId.htm)> __ FolderIdCollection
##  __Свойства
...
[ComplexPropertyCollection<TComplexProperty>](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm))  
##  __Методы
[Add(FolderId)](M_Tessa_Exchange_WebServices_Data_FolderIdCollection_Add.htm)|
Adds a folder Id to the collection.  
---|---  
[Add(WellKnownFolderName)](M_Tessa_Exchange_WebServices_Data_FolderIdCollection_Add_1.htm)|
Adds a well-known folder to the collection.  
[Clear](M_Tessa_Exchange_WebServices_Data_FolderIdCollection_Clear.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Remove(FolderId)](M_Tessa_Exchange_WebServices_Data_FolderIdCollection_Remove.htm)|
Removes the specified folder Id from the collection.  
[Remove(WellKnownFolderName)](M_Tessa_Exchange_WebServices_Data_FolderIdCollection_Remove_1.htm)|
Removes the specified well-known folder from the collection.  
[RemoveAt](M_Tessa_Exchange_WebServices_Data_FolderIdCollection_RemoveAt.htm)|
