# ForumProviderExtensions.ForumProviderArchiveTopicRequest - класс
##  __Definition
 **Пространство имён:** [Tessa.Forums](N_Tessa_Forums.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class ForumProviderArchiveTopicRequest : StorageObject
VB __Копировать
     Public Class ForumProviderArchiveTopicRequest
    	Inherits StorageObject
C++ __Копировать
     public ref class ForumProviderArchiveTopicRequest : public StorageObject
F# __Копировать
     type ForumProviderArchiveTopicRequest = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForumProviderExtensions.ForumProviderArchiveTopicRequest
##  __Конструкторы
[ForumProviderExtensions.ForumProviderArchiveTopicRequest()](M_Tessa_Forums_ForumProviderExtensions_ForumProviderArchiveTopicRequest__ctor.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderArchiveTopicRequest  
---|---  
[ForumProviderExtensions.ForumProviderArchiveTopicRequest(Dictionary<String,
Object>)](M_Tessa_Forums_ForumProviderExtensions_ForumProviderArchiveTopicRequest__ctor_1.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderArchiveTopicRequest  
##  __Свойства
[IsArchived](P_Tessa_Forums_ForumProviderExtensions_ForumProviderArchiveTopicRequest_IsArchived.htm)|  
---|---  
[TopicID](P_Tessa_Forums_ForumProviderExtensions_ForumProviderArchiveTopicRequest_TopicID.htm)|  
## __Методы
