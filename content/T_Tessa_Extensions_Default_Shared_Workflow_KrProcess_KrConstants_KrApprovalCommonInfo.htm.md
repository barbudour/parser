# KrConstants.KrApprovalCommonInfo - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public abstract class KrApprovalCommonInfo : KrConstants.KrProcessCommonInfo
VB __Копировать
     Public MustInherit Class KrApprovalCommonInfo
    	Inherits KrConstants.KrProcessCommonInfo
C++ __Копировать
     public ref class KrApprovalCommonInfo abstract : public KrConstants.KrProcessCommonInfo
F# __Копировать
     [<AbstractClassAttribute>]
    type KrApprovalCommonInfo = 
        class
            inherit KrConstants.KrProcessCommonInfo
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[KrConstants.KrProcessCommonInfo](T_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrConstants_KrProcessCommonInfo.htm) __ KrConstants.KrApprovalCommonInfo
##  __Конструкторы
[KrConstants.KrApprovalCommonInfo](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrConstants_KrApprovalCommonInfo__ctor.htm)|
Инициализирует новый экземпляр класса KrConstants.KrApprovalCommonInfo  
---|---  
##  __Методы
