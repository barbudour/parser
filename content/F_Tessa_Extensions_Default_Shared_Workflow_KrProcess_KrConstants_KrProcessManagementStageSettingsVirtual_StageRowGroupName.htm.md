# KrConstants.KrProcessManagementStageSettingsVirtual.StageRowGroupName - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly StageRowGroupName As String
C++ __Копировать
     public:
    static initonly String^ StageRowGroupName
F# __Копировать
     static val StageRowGroupName: string
#### Значение поля
