...
C# __Копировать
     public sealed class FakeServerInitializer : IServerInitializer
VB __Копировать
     Public NotInheritable Class FakeServerInitializer
    	Implements IServerInitializer
C++ __Копировать
     public ref class FakeServerInitializer sealed : IServerInitializer
F# __Копировать
     [<SealedAttribute>]
    type FakeServerInitializer = 
        class
            interface IServerInitializer
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FakeServerInitializer
Implements
    [IServerInitializer](T_Tessa_Platform_Initialization_IServerInitializer.htm)
##  __Конструкторы
[FakeServerInitializer](M_Tessa_Platform_Initialization_FakeServerInitializer__ctor.htm)|
Инициализирует новый экземпляр класса FakeServerInitializer  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetInitializationResponseAsync](M_Tessa_Platform_Initialization_FakeServerInitializer_GetInitializationResponseAsync.htm)|
