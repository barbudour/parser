# CardPermissionsDeleteExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class CardPermissionsDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class CardPermissionsDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class CardPermissionsDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type CardPermissionsDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ CardPermissionsDeleteExtension
##  __Конструкторы
[CardPermissionsDeleteExtension](M_Tessa_Extensions_Default_Server_Cards_CardPermissionsDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса CardPermissionsDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Cards_CardPermissionsDeleteExtension_BeforeRequest.htm)|  
(Переопределяет
