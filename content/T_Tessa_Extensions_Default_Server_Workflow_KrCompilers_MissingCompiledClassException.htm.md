# MissingCompiledClassException - класс
...
VB __Копировать
    <SerializableAttribute>
    Public Class MissingCompiledClassException
    	Inherits Exception
C++ __Копировать
    [SerializableAttribute]
    public ref class MissingCompiledClassException : public Exception
F# __Копировать
     [<SerializableAttribute>]
    type MissingCompiledClassException = 
        class
            inherit Exception
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __ MissingCompiledClassException
##  __Конструкторы
[MissingCompiledClassException(String)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_MissingCompiledClassException__ctor_1.htm)|
Инициализирует новый экземпляр класса MissingCompiledClassException.  
---|---  
[MissingCompiledClassException(SerializationInfo,
StreamingContext)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_MissingCompiledClassException__ctor.htm)|
Инициализирует новый экземпляр класса MissingCompiledClassException  
[MissingCompiledClassException(String,
Exception)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_MissingCompiledClassException__ctor_2.htm)|
Инициализирует новый экземпляр класса MissingCompiledClassException.  
## __Свойства
...
(Унаследован от
[Exception](https://learn.microsoft.com/dotnet/api/system.exception))  
[Message](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_MissingCompiledClassException_Message.htm)|
Gets a message that describes the current exception.  
(Переопределяет
[Exception.Message](https://learn.microsoft.com/dotnet/api/system.exception.message#system-
exception-message))  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_MissingCompiledClassException_GetObjectData.htm)|
