# KrPermissionsNewGetExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrPermissionsNewGetExtension
    	Inherits CardNewGetExtension
C++ __Копировать
     public ref class KrPermissionsNewGetExtension sealed : public CardNewGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrPermissionsNewGetExtension = 
        class
            inherit CardNewGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewGetExtension](T_Tessa_Cards_Extensions_CardNewGetExtension.htm) __ KrPermissionsNewGetExtension
##  __Конструкторы
[KrPermissionsNewGetExtension](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrPermissionsNewGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrPermissionsNewGetExtension  
---|---  
##  __Методы
[AfterRequest(ICardGetExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrPermissionsNewGetExtension_AfterRequest.htm)|
...
---|---  
[AfterRequest(ICardNewExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrPermissionsNewGetExtension_AfterRequest_1.htm)|
...
(Унаследован от
[CardNewGetExtension](T_Tessa_Cards_Extensions_CardNewGetExtension.htm))  
[BeforeRequest(ICardNewExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrPermissionsNewGetExtension_BeforeRequest.htm)|
