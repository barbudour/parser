# CardTypeControl.ControlSettings - свойство
...
C# __Копировать
     public ISerializableObject ControlSettings { get; set; }
VB __Копировать
     Public Property ControlSettings As ISerializableObject
    	Get
    	Set
C++ __Копировать
     public:
    property ISerializableObject^ ControlSettings {
    	ISerializableObject^ get ();
    	void set (ISerializableObject^ value);
    }
F# __Копировать
     member ControlSettings : ISerializableObject with get, set
#### Значение свойства
