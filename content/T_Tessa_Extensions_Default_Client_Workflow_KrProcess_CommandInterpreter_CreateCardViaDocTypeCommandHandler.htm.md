# CreateCardViaDocTypeCommandHandler - класс
...
VB __Копировать
     Public NotInheritable Class CreateCardViaDocTypeCommandHandler
    	Inherits ClientCommandHandlerBase
C++ __Копировать
     public ref class CreateCardViaDocTypeCommandHandler sealed : public ClientCommandHandlerBase
F# __Копировать
     [<SealedAttribute>]
    type CreateCardViaDocTypeCommandHandler = 
        class
            inherit ClientCommandHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ClientCommandHandlerBase](T_Tessa_Extensions_Default_Shared_Workflow_KrProcess_ClientCommandInterpreter_ClientCommandHandlerBase.htm) __ CreateCardViaDocTypeCommandHandler
##  __Конструкторы
[CreateCardViaDocTypeCommandHandler](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_CommandInterpreter_CreateCardViaDocTypeCommandHandler__ctor.htm)|
Инициализирует новый экземпляр класса CreateCardViaDocTypeCommandHandler  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Handle](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_CommandInterpreter_CreateCardViaDocTypeCommandHandler_Handle.htm)|
