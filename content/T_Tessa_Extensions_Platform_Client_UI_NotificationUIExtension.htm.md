# NotificationUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class NotificationUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class NotificationUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class NotificationUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type NotificationUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ NotificationUIExtension
##  __Конструкторы
[NotificationUIExtension](M_Tessa_Extensions_Platform_Client_UI_NotificationUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса NotificationUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_NotificationUIExtension_Initialized.htm)|  
(Переопределяет
