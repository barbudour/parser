...
VB __Копировать
     Public MustInherit Class ProcessCommonInfo
    	Inherits StorageObject
C++ __Копировать
     public ref class ProcessCommonInfo abstract : public StorageObject
F# __Копировать
     [<AbstractClassAttribute>]
    type ProcessCommonInfo = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ProcessCommonInfo
Derived
[Tessa.Extensions.Default.Server.Workflow.KrObjectModel.MainProcessCommonInfo](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MainProcessCommonInfo.htm)
[Tessa.Extensions.Default.Server.Workflow.KrObjectModel.NestedProcessCommonInfo](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_NestedProcessCommonInfo.htm)
##  __Конструкторы
[ProcessCommonInfo(Dictionary<String,
Object>)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo__ctor.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
---|---  
[ProcessCommonInfo(SerializationInfo,
StreamingContext)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo__ctor_2.htm)|
...
[ProcessCommonInfo(Nullable<Guid>, IDictionary<String, Object>,
Nullable<Guid>, Nullable<Guid>, String, Nullable<Guid>,
String)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo__ctor_1.htm)|
Инициализирует новый экземпляр класса ProcessCommonInfo.  
## __Свойства
