# ApplicationStoreExtension - класс
...
C# __Копировать
     public sealed class ApplicationStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class ApplicationStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class ApplicationStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type ApplicationStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ ApplicationStoreExtension
##  __Конструкторы
[ApplicationStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_ApplicationStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса ApplicationStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Cards_ApplicationStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_ApplicationStoreExtension_BeforeRequest.htm)|  
(Переопределяет
