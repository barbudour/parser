...
Ответ на запрос на сохранение информации по карточке посредством сервиса
карточек. Содержит объект, осуществляющий валидацию результата сохранения.
## __Definition
 **Пространство имён:** [Tessa.Cards](N_Tessa_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class CardStoreResponse : CardResponseBase, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardStoreResponse
    	Inherits CardResponseBase
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardStoreResponse sealed : public CardResponseBase, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardStoreResponse = 
        class
            inherit CardResponseBase
            interface ICloneable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm) __[CardResponseBase](T_Tessa_Cards_CardResponseBase.htm) __ CardStoreResponse
Implements
...
## __Свойства
[CardID](P_Tessa_Cards_CardStoreResponse_CardID.htm)|  Идентификатор
сохранённой карточки. Свойство обязательно для заполнения при формировании
ответа на запрос для виртуальной карточки.  
---|---  
[CardTypeID](P_Tessa_Cards_CardStoreResponse_CardTypeID.htm)|  Идентификатор
типа сохранённой карточки. Свойство обязательно для заполнения при
формировании ответа на запрос для виртуальной карточки.  
[CardVersion](P_Tessa_Cards_CardStoreResponse_CardVersion.htm)|  Версия
карточки после сохранения. Свойство обязательно для заполнения при
формировании ответа на запрос для виртуальной карточки.  
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[StoreDateTime](P_Tessa_Cards_CardStoreResponse_StoreDateTime.htm)|  Дата
сохранения карточки (которая записана как дата изменения карточки), или null,
если карточка не была изменена, сохранение не было выполнено успешно или
...
##  __Методы
[Clean](M_Tessa_Cards_CardResponseBase_Clean.htm)| Выполняет очистку хранилища
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_CardStoreResponse_Clone.htm)|  Выполняет глубокое
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Cards_CardResponseBase_EnsureCacheResolved.htm)|
...
[EraseOnError](M_Tessa_Cards_CardResponseBase_EraseOnError.htm)|  Удаляет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[FromTypedJson](M_Tessa_Cards_CardStoreResponse_FromTypedJson.htm)|
Устанавливает содержимое объекта в соответствии с данными, десериализованными
...
(Унаследован от [CardResponseBase](T_Tessa_Cards_CardResponseBase.htm))  
[TryInitFromContext](M_Tessa_Cards_CardStoreResponse_TryInitFromContext.htm)|
Инициализирует объект для данных, полученных из заданного контекста действия с
карточкой.  
(Переопределяет
[CardResponseBase.TryInitFromContext(Object)](M_Tessa_Cards_CardResponseBase_TryInitFromContext.htm))  
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardStoreResponse_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
[CardResponseBase.ValidateInternal(IValidationResultBuilder)](M_Tessa_Cards_CardResponseBase_ValidateInternal.htm))  
##  __Поля
...
(Определяется
[KrProcessSharedExtensions](T_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrProcessSharedExtensions.htm))  
[GetKrProcessLaunchFullResult](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrProcessSharedExtensions_GetKrProcessLaunchFullResult_1.htm)|
