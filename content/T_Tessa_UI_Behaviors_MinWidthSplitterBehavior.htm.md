# MinWidthSplitterBehavior - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Behaviors](N_Tessa_UI_Behaviors.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class MinWidthSplitterBehavior : Behavior<Grid>
VB __Копировать
     Public NotInheritable Class MinWidthSplitterBehavior
    	Inherits Behavior(Of Grid)
C++ __Копировать
     public ref class MinWidthSplitterBehavior sealed : public Behavior<Grid^>
F# __Копировать
     [<SealedAttribute>]
    type MinWidthSplitterBehavior = 
        class
            inherit Behavior<Grid>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[Grid](https://learn.microsoft.com/dotnet/api/system.windows.controls.grid)> __ MinWidthSplitterBehavior
##  __Конструкторы
[MinWidthSplitterBehavior](M_Tessa_UI_Behaviors_MinWidthSplitterBehavior__ctor.htm)|
Инициализирует новый экземпляр класса MinWidthSplitterBehavior  
---|---  
##  __Свойства
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_MinWidthSplitterBehavior_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_MinWidthSplitterBehavior_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_MinWidthSplitterBehavior_OnDetaching.htm)|  
(Переопределяет
