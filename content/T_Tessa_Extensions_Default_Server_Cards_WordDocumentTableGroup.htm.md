...
VB __Копировать
     Public NotInheritable Class WordDocumentTableGroup
    	Inherits StorageObject
C++ __Копировать
     public ref class WordDocumentTableGroup sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    type WordDocumentTableGroup = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ WordDocumentTableGroup
##  __Конструкторы
[WordDocumentTableGroup](M_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup__ctor.htm)|
Инициализирует новый экземпляр класса WordDocumentTableGroup  
---|---  
##  __Свойства
[BaseElements](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_BaseElements.htm)|
Те элементы, что копируются, в которых потом производится замена плейсхолдеров  
---|---  
[EndIndex](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_EndIndex.htm)|
Индекс метки конца закладки в тексте ее родительского элемента  
[EndPosition](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_EndPosition.htm)|
Позиция метки конца закладки в структуре документа  
[GroupType](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_GroupType.htm)|
Тип группы  
[ID](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_ID.htm)|
Идентификатор закладки в Word  
[InnerTableGroups](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_InnerTableGroups.htm)|
Внутренняя таблица  
[InParagraph](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_InParagraph.htm)|
Определяет, что вся закладка находится внутри параграфа  
[IsPrepared](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_IsPrepared.htm)|
Определяет, подготовлена ли группа для обработки связей.  
[Name](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_Name.htm)|
Имя закладки в Word  
[StartIndex](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_StartIndex.htm)|
Индекс метки начала закладки в тексте ее родительского элемента  
[StartPosition](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_StartPosition.htm)|
Позиция метки начала закладки в структуре документа  
[TableElement](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_TableElement.htm)|
Родительский элемент по отношению ко всем
[BaseElements](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_BaseElements.htm)  
[TableEndPosition](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_TableEndPosition.htm)|
Позиция окончания элемента таблицы  
[TablePlaceholders](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_TablePlaceholders.htm)|
Табличные плейсхолдеры  
[TableStartPosition](P_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_TableStartPosition.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Contains(IList)](M_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_Contains.htm)|  
[Contains(WordDocumentTableGroup)](M_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_Contains_1.htm)|  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[ContainsPlaceholder](M_Tessa_Extensions_Default_Server_Cards_WordDocumentTableGroup_ContainsPlaceholder.htm)|  
