...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TreeNodeBase](T_Tessa_SmartMerge_TreeNodeBase_1.htm)<[Card](T_Tessa_Cards_Card.htm)> __[CardTreeNodeBase](T_Tessa_Cards_SmartMerge_Nodes_CardTreeNodeBase.htm) __ CardTaskHistoryTreeNode
##  __Конструкторы
[CardTaskHistoryTreeNode](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryTreeNode__ctor.htm)|
Инициализирует новый экземпляр класса CardTaskHistoryTreeNode  
---|---  
##  __Свойства
...
его.  
(Унаследован от [TreeNodeBase<T>](T_Tessa_SmartMerge_TreeNodeBase_1.htm))  
[Clone](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryTreeNode_Clone.htm)|
Клонирует узел.  
(Переопределяет
[TreeNodeBase<T>.Clone()](M_Tessa_SmartMerge_TreeNodeBase_1_Clone.htm))  
[Equals(ITreeNode<Card>)](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryTreeNode_Equals.htm)|
...
[EqualsByKey](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryTreeNode_EqualsByKey.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetHashCode(Int32)](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryTreeNode_GetHashCode.htm)|
...
[GetMergeResult](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryTreeNode_GetMergeResult.htm)|
...
состояние узла.  
(Унаследован от [TreeNodeBase<T>](T_Tessa_SmartMerge_TreeNodeBase_1.htm))  
[ToString](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryTreeNode_ToString.htm)|
