...
C# __Копировать
    ...
    public sealed class SchemeStoreRequest : StorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class SchemeStoreRequest
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class SchemeStoreRequest sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type SchemeStoreRequest = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ SchemeStoreRequest
##  __Конструкторы
[SchemeStoreRequest()](M_Tessa_Platform_Configuration_SchemeStoreRequest__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[SchemeStoreRequest(Dictionary<String,
Object>)](M_Tessa_Platform_Configuration_SchemeStoreRequest__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[SchemeStoreRequest(IStorageObjectProvider)](M_Tessa_Platform_Configuration_SchemeStoreRequest__ctor_2.htm)|
...
[SchemeStoreRequest(SchemeObject,
ActionType)](M_Tessa_Platform_Configuration_SchemeStoreRequest__ctor_3.htm)|
Инициализирует новый экземпляр класса SchemeStoreRequest  
##  __Свойства
[Action](P_Tessa_Platform_Configuration_SchemeStoreRequest_Action.htm)|  
---|---  
[Data](P_Tessa_Platform_Configuration_SchemeStoreRequest_Data.htm)|  
[ID](P_Tessa_Platform_Configuration_SchemeStoreRequest_ID.htm)|  
[Name](P_Tessa_Platform_Configuration_SchemeStoreRequest_Name.htm)|  
## __Методы
