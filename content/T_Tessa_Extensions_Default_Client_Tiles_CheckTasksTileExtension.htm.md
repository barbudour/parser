...
C# __Копировать
     public sealed class CheckTasksTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class CheckTasksTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class CheckTasksTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type CheckTasksTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ CheckTasksTileExtension
##  __Конструкторы
[CheckTasksTileExtension](M_Tessa_Extensions_Default_Client_Tiles_CheckTasksTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса CheckTasksTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_CheckTasksTileExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[InitializingLocal](M_Tessa_Extensions_Default_Client_Tiles_CheckTasksTileExtension_InitializingLocal.htm)|  
(Переопределяет
