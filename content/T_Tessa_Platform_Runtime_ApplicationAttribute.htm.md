...
VB __Копировать
    <AttributeUsageAttribute(AttributeTargets.Assembly)>
    Public NotInheritable Class ApplicationAttribute
    	Inherits Attribute
C++ __Копировать
    [AttributeUsageAttribute(AttributeTargets::Assembly)]
    public ref class ApplicationAttribute sealed : public Attribute
F# __Копировать
     [<SealedAttribute>]
    [<AttributeUsageAttribute(AttributeTargets.Assembly)>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Attribute](https://learn.microsoft.com/dotnet/api/system.attribute) __ ApplicationAttribute
##  __Конструкторы
[ApplicationAttribute](M_Tessa_Platform_Runtime_ApplicationAttribute__ctor.htm)|
Создаёт экземпляр класса с указанием значений его свойств.  
---|---  
## __Свойства
[Alias](P_Tessa_Platform_Runtime_ApplicationAttribute_Alias.htm)|  Алиас
приложения, используемый для формирования пути к папкам приложения или в
ссылках.  
---|---  
