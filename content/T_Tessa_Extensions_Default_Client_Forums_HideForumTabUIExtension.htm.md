...
VB __Копировать
     Public Class HideForumTabUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class HideForumTabUIExtension : public CardUIExtension
F# __Копировать
     type HideForumTabUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ HideForumTabUIExtension
##  __Конструкторы
[HideForumTabUIExtension](M_Tessa_Extensions_Default_Client_Forums_HideForumTabUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса HideForumTabUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_Forums_HideForumTabUIExtension_Initialized.htm)|  
(Переопределяет
