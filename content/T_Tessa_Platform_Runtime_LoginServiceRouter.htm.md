...
C# __Копировать
     public sealed class LoginServiceRouter : ILoginService
VB __Копировать
     Public NotInheritable Class LoginServiceRouter
    	Implements ILoginService
C++ __Копировать
     public ref class LoginServiceRouter sealed : ILoginService
F# __Копировать
     [<SealedAttribute>]
    type LoginServiceRouter = 
        class
            interface ILoginService
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ LoginServiceRouter
Implements
    [ILoginService](T_Tessa_Platform_Runtime_ILoginService.htm)
##  __Конструкторы
[LoginServiceRouter](M_Tessa_Platform_Runtime_LoginServiceRouter__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[OpenSessionAsync](M_Tessa_Platform_Runtime_LoginServiceRouter_OpenSessionAsync.htm)|
...
[OpenSessionWindowsAuthAsync](M_Tessa_Platform_Runtime_LoginServiceRouter_OpenSessionWindowsAuthAsync.htm)|
