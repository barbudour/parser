# SettingsCardTileExtension - класс
...
C# __Копировать
     public sealed class SettingsCardTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class SettingsCardTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class SettingsCardTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type SettingsCardTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ SettingsCardTileExtension
##  __Конструкторы
[SettingsCardTileExtension](M_Tessa_Extensions_Platform_Client_Tiles_SettingsCardTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса SettingsCardTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Platform_Client_Tiles_SettingsCardTileExtension_InitializingGlobal.htm)|  
(Переопределяет
