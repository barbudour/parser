...
C++ __Копировать
     public ref class PropertyException : public ServiceLocalException
F# __Копировать
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceLocalException](T_Tessa_Exchange_WebServices_Data_ServiceLocalException.htm) __ PropertyException
Derived
[Tessa.Exchange.WebServices.Data.ServiceObjectPropertyException](T_Tessa_Exchange_WebServices_Data_ServiceObjectPropertyException.htm)
##  __Конструкторы
[PropertyException(String)](M_Tessa_Exchange_WebServices_Data_PropertyException__ctor_1.htm)|
PropertyException constructor.  
---|---  
[PropertyException(SerializationInfo,
StreamingContext)](M_Tessa_Exchange_WebServices_Data_PropertyException__ctor.htm)|
Initializes a new instance of the PropertyException class with serialized
data.  
[PropertyException(String,
String)](M_Tessa_Exchange_WebServices_Data_PropertyException__ctor_2.htm)|
PropertyException Constructor.  
[PropertyException(String, String,
Exception)](M_Tessa_Exchange_WebServices_Data_PropertyException__ctor_3.htm)|
PropertyException Constructor.  
## __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Exchange_WebServices_Data_PropertyException_GetObjectData.htm)|
Sets the
