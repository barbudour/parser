# WfHelper.ResolutionPerformerRoleIDField - поле
...
VB __Копировать
     Public Const ResolutionPerformerRoleIDField As String = "RoleID"
C++ __Копировать
     public:
    literal String^ ResolutionPerformerRoleIDField = "RoleID"
F# __Копировать
     static val mutable ResolutionPerformerRoleIDField: string
#### Значение поля
