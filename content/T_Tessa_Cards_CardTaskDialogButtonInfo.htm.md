# CardTaskDialogButtonInfo - класс
...
C# __Копировать
    ...
    public sealed class CardTaskDialogButtonInfo : StorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardTaskDialogButtonInfo
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTaskDialogButtonInfo sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardTaskDialogButtonInfo = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ CardTaskDialogButtonInfo
##  __Конструкторы
[CardTaskDialogButtonInfo()](M_Tessa_Cards_CardTaskDialogButtonInfo__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[CardTaskDialogButtonInfo(Dictionary<String,
Object>)](M_Tessa_Cards_CardTaskDialogButtonInfo__ctor_1.htm)| Создаёт
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
##  __Поля
[ItemFactory](F_Tessa_Cards_CardTaskDialogButtonInfo_ItemFactory.htm)|  
---|---  
## __Методы расширения
