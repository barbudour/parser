# CardFileContentProvider - класс
Объект, предоставляющий контент сохраняемого файла.
## __Definition
 **Пространство имён:** [Tessa.Cards](N_Tessa_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class CardFileContentProvider : ICardFileContentProvider
VB __Копировать
     Public NotInheritable Class CardFileContentProvider
    	Implements ICardFileContentProvider
C++ __Копировать
     public ref class CardFileContentProvider sealed : ICardFileContentProvider
F# __Копировать
     [<SealedAttribute>]
    type CardFileContentProvider = 
        class
            interface ICardFileContentProvider
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardFileContentProvider
Implements
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetContentAsync](M_Tessa_Cards_CardFileContentProvider_GetContentAsync.htm)|
