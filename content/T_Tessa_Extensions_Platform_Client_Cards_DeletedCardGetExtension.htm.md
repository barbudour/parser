...
##  __Конструкторы
[DeletedCardGetExtension](M_Tessa_Extensions_Platform_Client_Cards_DeletedCardGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса DeletedCardGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Client_Cards_DeletedCardGetExtension_AfterRequest.htm)|  
(Переопределяет
