# KrLocalTilesNewGetExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrLocalTilesNewGetExtension
    	Inherits CardNewGetExtension
C++ __Копировать
     public ref class KrLocalTilesNewGetExtension sealed : public CardNewGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrLocalTilesNewGetExtension = 
        class
            inherit CardNewGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewGetExtension](T_Tessa_Cards_Extensions_CardNewGetExtension.htm) __ KrLocalTilesNewGetExtension
##  __Конструкторы
[KrLocalTilesNewGetExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrLocalTilesNewGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrLocalTilesNewGetExtension.  
---|---  
## __Методы
[AfterRequest(ICardGetExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrLocalTilesNewGetExtension_AfterRequest.htm)|
...
---|---  
[AfterRequest(ICardNewExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrLocalTilesNewGetExtension_AfterRequest_1.htm)|
