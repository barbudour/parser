# DeletedOccurrenceInfoCollection - класс
...
VB __Копировать
    <EditorBrowsableAttribute(EditorBrowsableState.Never)>
    Public NotInheritable Class DeletedOccurrenceInfoCollection
    	Inherits ComplexPropertyCollection(Of DeletedOccurrenceInfo)
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class DeletedOccurrenceInfoCollection sealed : public ComplexPropertyCollection<DeletedOccurrenceInfo^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type DeletedOccurrenceInfoCollection = 
        class
            inherit ComplexPropertyCollection<DeletedOccurrenceInfo>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[DeletedOccurrenceInfo](T_Tessa_Exchange_WebServices_Data_DeletedOccurrenceInfo.htm)> __ DeletedOccurrenceInfoCollection
##  __Свойства
