# FileEntityCollection<TItem, TCollection> \- методы
##  __Методы
...
(Унаследован от
[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<[TItem](T_Tessa_Files_FileEntityCollection_2.htm)>)  
---|---  
...
(Унаследован от
[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[TItem](T_Tessa_Files_FileEntityCollection_2.htm)>)  
