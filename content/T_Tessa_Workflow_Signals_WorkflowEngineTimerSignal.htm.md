# WorkflowEngineTimerSignal - класс
##  __Definition
 **Пространство имён:** [Tessa.Workflow.Signals](N_Tessa_Workflow_Signals.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class WorkflowEngineTimerSignal : WorkflowEngineSignal
VB __Копировать
     Public NotInheritable Class WorkflowEngineTimerSignal
    	Inherits WorkflowEngineSignal
C++ __Копировать
     public ref class WorkflowEngineTimerSignal sealed : public WorkflowEngineSignal
F# __Копировать
     [<SealedAttribute>]
    type WorkflowEngineTimerSignal = 
        class
            inherit WorkflowEngineSignal
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowEngineSignal](T_Tessa_Workflow_Signals_WorkflowEngineSignal.htm) __ WorkflowEngineTimerSignal
##  __Конструкторы
[WorkflowEngineTimerSignal](M_Tessa_Workflow_Signals_WorkflowEngineTimerSignal__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowEngineTimerSignal  
---|---  
##  __Свойства
[Cron](P_Tessa_Workflow_Signals_WorkflowEngineTimerSignal_Cron.htm)|  Cron-
выражение таймера.  
---|---  
[Date](P_Tessa_Workflow_Signals_WorkflowEngineTimerSignal_Date.htm)|  Дата
выполнения таймера.  
...
(Унаследован от
[WorkflowEngineSignal](T_Tessa_Workflow_Signals_WorkflowEngineSignal.htm))  
[Period](P_Tessa_Workflow_Signals_WorkflowEngineTimerSignal_Period.htm)|
Период выполнения таймера.  
[TimerIDs](P_Tessa_Workflow_Signals_WorkflowEngineTimerSignal_TimerIDs.htm)|
Список идентификаторов таймеров, которые должны обрабатываться, или null, если
