...
C# __Копировать
     public sealed class SearchQueriesWebProxy : WebProxy
VB __Копировать
     Public NotInheritable Class SearchQueriesWebProxy
    	Inherits WebProxy
C++ __Копировать
     public ref class SearchQueriesWebProxy sealed : public WebProxy
F# __Копировать
     [<SealedAttribute>]
    type SearchQueriesWebProxy = 
        class
            inherit WebProxy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm) __ SearchQueriesWebProxy
##  __Конструкторы
[SearchQueriesWebProxy](M_Tessa_Views_SearchQueries_SearchQueriesWebProxy__ctor.htm)|
...
изменений.  
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[DeleteAsync](M_Tessa_Views_SearchQueries_SearchQueriesWebProxy_DeleteAsync.htm)|
Удаляет поисковые запросы с указанными идентификаторами. Пользователи без
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetAllAsync](M_Tessa_Views_SearchQueries_SearchQueriesWebProxy_GetAllAsync.htm)|
...
[GetAsync](M_Tessa_Views_SearchQueries_SearchQueriesWebProxy_GetAsync.htm)|
Возвращает поисковый запрос по заданному идентификатору.  
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[ImportAsync](M_Tessa_Views_SearchQueries_SearchQueriesWebProxy_ImportAsync.htm)|
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[StoreAsync](M_Tessa_Views_SearchQueries_SearchQueriesWebProxy_StoreAsync.htm)|
