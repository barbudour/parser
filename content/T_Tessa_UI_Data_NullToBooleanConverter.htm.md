...
C++ __Копировать
    [ValueConversionAttribute(typeof(Object), typeof(bool))]
    public ref class NullToBooleanConverter : public ValueConverter<Object^, bool>
F# __Копировать
     [<ValueConversionAttribute(typeof(Object), typeof(bool))>]
    type NullToBooleanConverter = 
        class
            inherit ValueConverter<Object, bool>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueConverter](T_Tessa_UI_Data_ValueConverter_2.htm)<[Object](https://learn.microsoft.com/dotnet/api/system.object), [Boolean](https://learn.microsoft.com/dotnet/api/system.boolean)> __ NullToBooleanConverter
##  __Конструкторы
[NullToBooleanConverter](M_Tessa_UI_Data_NullToBooleanConverter__ctor.htm)|
Инициализирует новый экземпляр класса NullToBooleanConverter  
---|---  
##  __Свойства
[Instance](P_Tessa_UI_Data_NullToBooleanConverter_Instance.htm)| Экземпляр
класса.  
---|---  
##  __Методы
...
---|---  
[BoxTargetValue](M_Tessa_UI_Data_NullToBooleanConverter_BoxTargetValue.htm)|  
...
CultureInfo)](M_Tessa_UI_Data_NullToBooleanConverter_Convert.htm)|  
