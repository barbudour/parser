# KrConstants.KrCreateCardStageSettingsVirtual.TemplateID - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly TemplateID As String
C++ __Копировать
     public:
    static initonly String^ TemplateID
F# __Копировать
     static val TemplateID: string
#### Значение поля
