...
VB __Копировать
     Public Shared ReadOnly KrTaskRegistrationTaskCompleteNotificationMethod As WorkflowActionMethodDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionMethodDescriptor^ KrTaskRegistrationTaskCompleteNotificationMethod
F# __Копировать
     static val KrTaskRegistrationTaskCompleteNotificationMethod: WorkflowActionMethodDescriptor
#### Значение поля
