# PipeAggregateClientTraceListener - класс
...
C# __Копировать
     public sealed class PipeAggregateClientTraceListener : PipeClientTraceListener
VB __Копировать
     Public NotInheritable Class PipeAggregateClientTraceListener
    	Inherits PipeClientTraceListener
C++ __Копировать
     public ref class PipeAggregateClientTraceListener sealed : public PipeClientTraceListener
F# __Копировать
     [<SealedAttribute>]
    type PipeAggregateClientTraceListener = 
        class
            inherit PipeClientTraceListener
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[PipeClientTraceListener](T_Tessa_Platform_Pipes_PipeClientTraceListener.htm) __ PipeAggregateClientTraceListener
##  __Конструкторы
[PipeAggregateClientTraceListener](M_Tessa_Platform_Pipes_PipeAggregateClientTraceListener__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[OnClientConnectedAsync](M_Tessa_Platform_Pipes_PipeAggregateClientTraceListener_OnClientConnectedAsync.htm)|
...
[OnClientDisconnectedAsync](M_Tessa_Platform_Pipes_PipeAggregateClientTraceListener_OnClientDisconnectedAsync.htm)|
...
[OnExceptionAsync](M_Tessa_Platform_Pipes_PipeAggregateClientTraceListener_OnExceptionAsync.htm)|
...
[OnRequestPreparedAsync](M_Tessa_Platform_Pipes_PipeAggregateClientTraceListener_OnRequestPreparedAsync.htm)|
...
[OnResponseReceivedAsync](M_Tessa_Platform_Pipes_PipeAggregateClientTraceListener_OnResponseReceivedAsync.htm)|
