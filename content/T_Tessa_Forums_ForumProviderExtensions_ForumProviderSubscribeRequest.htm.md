# ForumProviderExtensions.ForumProviderSubscribeRequest - класс
##  __Definition
 **Пространство имён:** [Tessa.Forums](N_Tessa_Forums.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class ForumProviderSubscribeRequest : StorageObject
VB __Копировать
     Public Class ForumProviderSubscribeRequest
    	Inherits StorageObject
C++ __Копировать
     public ref class ForumProviderSubscribeRequest : public StorageObject
F# __Копировать
     type ForumProviderSubscribeRequest = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForumProviderExtensions.ForumProviderSubscribeRequest
##  __Конструкторы
[ForumProviderExtensions.ForumProviderSubscribeRequest()](M_Tessa_Forums_ForumProviderExtensions_ForumProviderSubscribeRequest__ctor.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderSubscribeRequest  
---|---  
[ForumProviderExtensions.ForumProviderSubscribeRequest(Dictionary<String,
Object>)](M_Tessa_Forums_ForumProviderExtensions_ForumProviderSubscribeRequest__ctor_1.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderSubscribeRequest  
##  __Свойства
[IsSubscribed](P_Tessa_Forums_ForumProviderExtensions_ForumProviderSubscribeRequest_IsSubscribed.htm)|  
---|---  
[TopicID](P_Tessa_Forums_ForumProviderExtensions_ForumProviderSubscribeRequest_TopicID.htm)|  
## __Методы
