...
VB __Копировать
     Public NotInheritable Class TopicsUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class TopicsUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type TopicsUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ TopicsUIExtension
##  __Конструкторы
[TopicsUIExtension](M_Tessa_Extensions_Default_Client_Forums_TopicsUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса TopicsUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_Forums_TopicsUIExtension_Initialized.htm)|  
(Переопределяет
