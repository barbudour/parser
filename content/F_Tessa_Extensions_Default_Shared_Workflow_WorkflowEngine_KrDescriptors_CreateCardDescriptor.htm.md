# KrDescriptors.CreateCardDescriptor - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly CreateCardDescriptor As WorkflowActionDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionDescriptor^ CreateCardDescriptor
F# __Копировать
     static val CreateCardDescriptor: WorkflowActionDescriptor
#### Значение поля
