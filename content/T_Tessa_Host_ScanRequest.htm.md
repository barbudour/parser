# ScanRequest - класс
Запрос к сервису сканирования
## __Definition
 **Пространство имён:** [Tessa.Host](N_Tessa_Host.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class ScanRequest : StorageObject, 
    	IScanRequest
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class ScanRequest
    	Inherits StorageObject
    	Implements IScanRequest
C++ __Копировать
    [SerializableAttribute]
    public ref class ScanRequest sealed : public StorageObject, 
    	IScanRequest
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ScanRequest
Implements
    [IScanRequest](T_Tessa_Host_IScanRequest.htm)
##  __Конструкторы
[ScanRequest()](M_Tessa_Host_ScanRequest__ctor.htm)|  Создаёт экземпляр класса
и пустое хранилище Dictionary<string, object>, декоратором для которого
является создаваемый объект.  
---|---  
[ScanRequest(Dictionary<String,
Object>)](M_Tessa_Host_ScanRequest__ctor_1.htm)| Создаёт экземпляр класса с
указанием хранилища, декоратором для которого является создаваемый объект.  
[ScanRequest(IScanRequest)](M_Tessa_Host_ScanRequest__ctor_2.htm)|  Создаёт
экземпляр класса, копируя в него свойства из заданного запроса
[IScanRequest](T_Tessa_Host_IScanRequest.htm).  
[ScanRequest(IStorageObjectProvider)](M_Tessa_Host_ScanRequest__ctor_3.htm)|
...
## __Свойства
[ScanSource](P_Tessa_Host_ScanRequest_ScanSource.htm)|  Gets or sets Источник
сканирования  
---|---  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Host_ScanRequest_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
##  __Поля
[ScanSourceKey](F_Tessa_Host_ScanRequest_ScanSourceKey.htm)|  
---|---  
## __Методы расширения
