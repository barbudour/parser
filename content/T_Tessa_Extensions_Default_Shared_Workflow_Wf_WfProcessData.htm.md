...
C# __Копировать
    ...
    public sealed class WfProcessData : CardInfoStorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WfProcessData
    	Inherits CardInfoStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class WfProcessData sealed : public CardInfoStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Инициализирует новый экземпляр класса WfProcessData  
---|---  
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[ID](P_Tessa_Extensions_Default_Shared_Workflow_Wf_WfProcessData_ID.htm)|
Идентификатор процесса.  
[Info](P_Tessa_Cards_CardInfoStorageObject_Info.htm)|  Дополнительная
пользовательская информация.  
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[TypeName](P_Tessa_Extensions_Default_Shared_Workflow_Wf_WfProcessData_TypeName.htm)|
Имя типа процесса.  
## __Методы
