...
C# __Копировать
    ...
    public sealed class KrDocType : StorageObject, 
    	IKrType
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class KrDocType
    	Inherits StorageObject
    	Implements IKrType
C++ __Копировать
    [SerializableAttribute]
    public ref class KrDocType sealed : public StorageObject, 
    	IKrType
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ KrDocType
Implements
    [IKrType](T_Tessa_Extensions_Default_Shared_Workflow_KrProcess_IKrType.htm)
##  __Конструкторы
[KrDocType](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrDocType__ctor.htm)|
Инициализирует новый экземпляр класса KrDocType  
---|---  
##  __Свойства
