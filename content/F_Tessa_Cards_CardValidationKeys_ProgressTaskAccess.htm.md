# CardValidationKeys.ProgressTaskAccess - поле
...
C# __Копировать
     public static readonly ValidationKey ProgressTaskAccess
VB __Копировать
     Public Shared ReadOnly ProgressTaskAccess As ValidationKey
C++ __Копировать
     public:
    static initonly ValidationKey^ ProgressTaskAccess
F# __Копировать
     static val ProgressTaskAccess: ValidationKey
#### Значение поля
