# CardTypeServiceClient.GetCardTypeAsync - метод
...
#### Реализации
[ICardTypeService.GetCardTypeAsync(Guid,
CancellationToken)](M_Tessa_Cards_ICardTypeService_GetCardTypeAsync.htm)  
##  __См. также
#### Ссылки
