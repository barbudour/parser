...
(Унаследован от [CardTypeControl](T_Tessa_Cards_CardTypeControl.htm))  
[Flags](P_Tessa_Cards_CardTypeCustomControl_Flags.htm)|  Флаги, определяющие
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[RequiredText](P_Tessa_Cards_CardTypeCustomControl_RequiredText.htm)|
...
управления.  
(Унаследован от [CardTypeControl](T_Tessa_Cards_CardTypeControl.htm))  
[XmlElementNameInternal](P_Tessa_Cards_CardTypeCustomControl_XmlElementNameInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeAttributeFromXml](M_Tessa_Cards_CardTypeCustomControl_DeserializeAttributeFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_CardTypeCustomControl_DeserializeFromBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_CardTypeCustomControl_DeserializeFromStorageInternal.htm)|
...
[ControlSettings](P_Tessa_Cards_CardTypeControl_ControlSettings.htm).  
(Унаследован от [CardTypeControl](T_Tessa_Cards_CardTypeControl.htm))  
[EqualsInternal](M_Tessa_Cards_CardTypeCustomControl_EqualsInternal.htm)|
...
(Унаследован от [CardTypeContent](T_Tessa_Cards_CardTypeContent.htm))  
[IsRequired](M_Tessa_Cards_CardTypeCustomControl_IsRequired.htm)|  Возвращает
...
[IsVisible](M_Tessa_Cards_CardTypeCustomControl_IsVisible.htm)| Возвращает
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_CardTypeCustomControl_OnDeserializing.htm)|
...
(Унаследован от [CardTypeControl](T_Tessa_Cards_CardTypeControl.htm))  
[SerializeAttributesToXml](M_Tessa_Cards_CardTypeCustomControl_SerializeAttributesToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_CardTypeCustomControl_SerializeToBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_CardTypeCustomControl_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SetRequired](M_Tessa_Cards_CardTypeCustomControl_SetRequired.htm)|
...
[SetVisible](M_Tessa_Cards_CardTypeCustomControl_SetVisible.htm)|
...
(Унаследован от
[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardTypeCustomControl_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
[CardTypeContent.ValidateInternal(IValidationResultBuilder)](M_Tessa_Cards_CardTypeContent_ValidateInternal.htm))  
##  __Поля
[XmlElementName](F_Tessa_Cards_CardTypeCustomControl_XmlElementName.htm)|  Имя
XML-элемента.  
---|---  
## __Методы расширения
