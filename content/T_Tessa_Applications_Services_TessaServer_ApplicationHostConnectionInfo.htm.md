# ApplicationHostConnectionInfo - класс
...
C# __Копировать
    ...
    public class ApplicationHostConnectionInfo : StorageObject
VB __Копировать
    <SerializableAttribute>
    Public Class ApplicationHostConnectionInfo
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class ApplicationHostConnectionInfo : public StorageObject
F# __Копировать
     [<SerializableAttribute>]
    type ApplicationHostConnectionInfo = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ApplicationHostConnectionInfo
##  __Конструкторы
[ApplicationHostConnectionInfo()](M_Tessa_Applications_Services_TessaServer_ApplicationHostConnectionInfo__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[ApplicationHostConnectionInfo(Dictionary<String,
Object>)](M_Tessa_Applications_Services_TessaServer_ApplicationHostConnectionInfo__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[ApplicationHostConnectionInfo(IStorageObjectProvider)](M_Tessa_Applications_Services_TessaServer_ApplicationHostConnectionInfo__ctor_3.htm)|
...
[ApplicationHostConnectionInfo(IConnectionSettings,
ISessionToken)](M_Tessa_Applications_Services_TessaServer_ApplicationHostConnectionInfo__ctor_2.htm)|
...
## __Методы
[Apply](M_Tessa_Applications_Services_TessaServer_ApplicationHostConnectionInfo_Apply.htm)|
Применяет настройки из объекта к заданным настройкам
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[SetToken](M_Tessa_Applications_Services_TessaServer_ApplicationHostConnectionInfo_SetToken.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetToken](M_Tessa_Applications_Services_TessaServer_ApplicationHostConnectionInfo_TryGetToken.htm)|
