...
C# __Копировать
    [RegistratorAttribute(ExtensionStage.AfterPlatform, Type = SessionType.Client, 
    	Tag = RegistratorTag.ConsoleClient)]
    public sealed class OperationRegistrator : RegistratorBase
VB __Копировать
    <RegistratorAttribute(ExtensionStage.AfterPlatform, Type := SessionType.Client, 
    	Tag := RegistratorTag.ConsoleClient)>
    Public NotInheritable Class OperationRegistrator
    	Inherits RegistratorBase
C++ __Копировать
    [RegistratorAttribute(ExtensionStage::AfterPlatform, Type = SessionType::Client, 
    	Tag = RegistratorTag::ConsoleClient)]
    public ref class OperationRegistrator sealed : public RegistratorBase
F# __Копировать
     [<SealedAttribute>]
    [<RegistratorAttribute(ExtensionStage.AfterPlatform, Type = SessionType.Client, 
    	Tag = RegistratorTag.ConsoleClient)>]
    type OperationRegistrator = 
        class
            inherit RegistratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm) __ OperationRegistrator
##  __Конструкторы
[OperationRegistrator](M_Tessa_Extensions_Default_Console_ExportSearchQueries_OperationRegistrator__ctor.htm)|
Инициализирует новый экземпляр класса OperationRegistrator  
---|---  
##  __Свойства
...
в этом объекте.  
(Унаследован от [RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm))  
[RegisterUnity](M_Tessa_Extensions_Default_Console_ExportSearchQueries_OperationRegistrator_RegisterUnity.htm)|  
(Переопределяет
