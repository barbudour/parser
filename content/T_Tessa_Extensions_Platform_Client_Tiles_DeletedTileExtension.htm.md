...
C# __Копировать
     public sealed class DeletedTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class DeletedTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class DeletedTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type DeletedTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ DeletedTileExtension
##  __Конструкторы
[DeletedTileExtension](M_Tessa_Extensions_Platform_Client_Tiles_DeletedTileExtension__ctor.htm)|
...
(Унаследован от
[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm))  
[InitializingLocal](M_Tessa_Extensions_Platform_Client_Tiles_DeletedTileExtension_InitializingLocal.htm)|  
(Переопределяет
