# KrAdditionalApprovalCardUIExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class KrAdditionalApprovalCardUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class KrAdditionalApprovalCardUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrAdditionalApprovalCardUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrAdditionalApprovalCardUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrAdditionalApprovalCardUIExtension
##  __Конструкторы
[KrAdditionalApprovalCardUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrAdditionalApprovalCardUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrAdditionalApprovalCardUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrAdditionalApprovalCardUIExtension_Initialized.htm)|
