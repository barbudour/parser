# GetVersionSignaturesRequestExtension - класс
...
C# __Копировать
     public sealed class GetVersionSignaturesRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class GetVersionSignaturesRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class GetVersionSignaturesRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type GetVersionSignaturesRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ GetVersionSignaturesRequestExtension
##  __Конструкторы
[GetVersionSignaturesRequestExtension](M_Tessa_Extensions_Platform_Server_Cards_GetVersionSignaturesRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса GetVersionSignaturesRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_GetVersionSignaturesRequestExtension_AfterRequest.htm)|  
(Переопределяет
