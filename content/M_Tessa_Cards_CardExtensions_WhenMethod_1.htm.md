...
CardGetFileContentMethod[]) - метод
...
C# __Копировать
     public static IExtensionPolicyContainer WhenMethod(
    	...
    	params CardGetFileContentMethod[] methods
    )
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function WhenMethod ( 
    	policyContainer As IExtensionPolicyContainer,
    	ParamArray methods As CardGetFileContentMethod()
...
C++ __Копировать
    ...
    static IExtensionPolicyContainer^ WhenMethod(
    	...
    	... array<CardGetFileContentMethod>^ methods
    )
F# __Копировать
     [<ExtensionAttribute>]
    static member WhenMethod : 
            policyContainer : IExtensionPolicyContainer * 
            methods : CardGetFileContentMethod[] -> IExtensionPolicyContainer 
#### Параметры
policyContainer
