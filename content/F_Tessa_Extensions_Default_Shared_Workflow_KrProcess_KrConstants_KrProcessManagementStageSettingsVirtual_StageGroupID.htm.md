# KrConstants.KrProcessManagementStageSettingsVirtual.StageGroupID - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly StageGroupID As String
C++ __Копировать
     public:
    static initonly String^ StageGroupID
F# __Копировать
     static val StageGroupID: string
#### Значение поля
