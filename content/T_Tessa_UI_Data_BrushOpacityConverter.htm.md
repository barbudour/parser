...
C# __Копировать
     public sealed class BrushOpacityConverter : ValueConverter<Object, Brush>
VB __Копировать
     Public NotInheritable Class BrushOpacityConverter
    	Inherits ValueConverter(Of Object, Brush)
C++ __Копировать
     public ref class BrushOpacityConverter sealed : public ValueConverter<Object^, Brush^>
F# __Копировать
     [<SealedAttribute>]
    type BrushOpacityConverter = 
        class
            inherit ValueConverter<Object, Brush>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueConverter](T_Tessa_UI_Data_ValueConverter_2.htm)<[Object](https://learn.microsoft.com/dotnet/api/system.object), [Brush](https://learn.microsoft.com/dotnet/api/system.windows.media.brush)> __ BrushOpacityConverter
##  __Конструкторы
[BrushOpacityConverter](M_Tessa_UI_Data_BrushOpacityConverter__ctor.htm)|
Инициализирует новый экземпляр класса BrushOpacityConverter  
---|---  
##  __Свойства
[Opacity](P_Tessa_UI_Data_BrushOpacityConverter_Opacity.htm)|  
---|---  
## __Методы
...
CultureInfo)](M_Tessa_UI_Data_BrushOpacityConverter_Convert.htm)|  
