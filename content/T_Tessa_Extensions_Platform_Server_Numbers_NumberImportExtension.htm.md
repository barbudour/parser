...
C# __Копировать
     public sealed class NumberImportExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class NumberImportExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class NumberImportExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type NumberImportExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ NumberImportExtension
##  __Конструкторы
[NumberImportExtension](M_Tessa_Extensions_Platform_Server_Numbers_NumberImportExtension__ctor.htm)|
Инициализирует новый экземпляр класса NumberImportExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Numbers_NumberImportExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
