# CardLibrary.Equals(CardLibrary) - метод
...
F# __Копировать
     abstract Equals : 
            other : CardLibrary -> bool 
    override Equals : 
            other : CardLibrary -> bool 
#### Параметры
other [CardLibrary](T_Tessa_Cards_CardLibrary.htm)
...
[Equals - перегрузка](Overload_Tessa_Cards_CardLibrary_Equals.htm)
