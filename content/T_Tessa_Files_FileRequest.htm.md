...
C++ __Копировать
     public ref class FileRequest : IFileRequest
F# __Копировать
     type FileRequest = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FileRequest
Implements
    [IFileRequest](T_Tessa_Files_IFileRequest.htm)
##  __Заметки
Наследники класса могут добавлять свойства.
## __Конструкторы
[FileRequest](M_Tessa_Files_FileRequest__ctor.htm)| Инициализирует новый
экземпляр класса FileRequest  
---|---  
##  __Свойства
