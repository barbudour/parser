...
F# __Копировать
    ...
    *)
    -> Task 
    override SetCanModifyTypeAsync : 
            value : bool * 
            ?executePropertyChangedAsync : Func<Action, CancellationToken, Task> * 
            ?cancellationToken : CancellationToken 
    (* Defaults:
...
value [Boolean](https://learn.microsoft.com/dotnet/api/system.boolean)
     Устанавливаемый признак того, что тип файла может быть изменён. 
...
Асинхронная задача.
#### Реализации
[IFilePermissions.SetCanModifyTypeAsync(Boolean, Func<Action,
CancellationToken, Task>,
CancellationToken)](M_Tessa_Files_IFilePermissions_SetCanModifyTypeAsync.htm)  
##  __Исключения
