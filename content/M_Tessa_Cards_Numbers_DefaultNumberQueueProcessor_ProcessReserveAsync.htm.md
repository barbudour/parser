# DefaultNumberQueueProcessor.ProcessReserveAsync - метод
...
C# __Копировать
     protected virtual Task<bool> ProcessReserveAsync(
...
VB __Копировать
     Protected Overridable Function ProcessReserveAsync ( 
...
C++ __Копировать
     protected:
    virtual Task<bool>^ ProcessReserveAsync(
    	INumberContext^ context, 
    	NumberQueue^ queue, 
    	NumberQueueItem^ queueItem, 
    	NumberQueueEventType^ queueEventType, 
