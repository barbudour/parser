...
C# __Копировать
     public class WfCardUIExtension : CardUIExtension
VB __Копировать
     Public Class WfCardUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class WfCardUIExtension : public CardUIExtension
F# __Копировать
     type WfCardUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ WfCardUIExtension
##  __Конструкторы
[WfCardUIExtension](M_Tessa_Extensions_Default_Client_Workflow_Wf_WfCardUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса WfCardUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_Workflow_Wf_WfCardUIExtension_Initialized.htm)|  
(Переопределяет
...
(Унаследован от [CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm))  
[Reopening](M_Tessa_Extensions_Default_Client_Workflow_Wf_WfCardUIExtension_Reopening.htm)|  
(Переопределяет
