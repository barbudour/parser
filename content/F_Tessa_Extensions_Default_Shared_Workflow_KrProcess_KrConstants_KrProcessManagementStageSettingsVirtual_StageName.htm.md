# KrConstants.KrProcessManagementStageSettingsVirtual.StageName - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly StageName As String
C++ __Копировать
     public:
    static initonly String^ StageName
F# __Копировать
     static val StageName: string
#### Значение поля
