# NumberFinalDeleteExtension - класс
...
C# __Копировать
     public sealed class NumberFinalDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class NumberFinalDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class NumberFinalDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type NumberFinalDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ NumberFinalDeleteExtension
##  __Конструкторы
[NumberFinalDeleteExtension](M_Tessa_Extensions_Platform_Server_Numbers_NumberFinalDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса NumberFinalDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Numbers_NumberFinalDeleteExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
