...
C# __Копировать
     public class ForumResponse : InfoStorageObject
VB __Копировать
     Public Class ForumResponse
    	Inherits InfoStorageObject
C++ __Копировать
     public ref class ForumResponse : public InfoStorageObject
F# __Копировать
     type ForumResponse = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm) __ ForumResponse
##  __Конструкторы
[ForumResponse()](M_Tessa_Forums_ForumResponse__ctor.htm)| Инициализирует
новый экземпляр класса ForumResponse  
---|---  
[ForumResponse(Dictionary<String,
Object>)](M_Tessa_Forums_ForumResponse__ctor_1.htm)| Инициализирует новый
экземпляр класса ForumResponse  
[ForumResponse(SerializationInfo,
StreamingContext)](M_Tessa_Forums_ForumResponse__ctor_2.htm)| Инициализирует
новый экземпляр класса ForumResponse  
##  __Свойства
...
(Унаследован от
[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm))  
[ForumSettings](P_Tessa_Forums_ForumResponse_ForumSettings.htm)|  
[Info](P_Tessa_Platform_Storage_InfoStorageObject_Info.htm)|  Дополнительная
пользовательская информация.  
(Унаследован от
[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm))  
[Message](P_Tessa_Forums_ForumResponse_Message.htm)|  
[Messages](P_Tessa_Forums_ForumResponse_Messages.htm)|  
[SatelliteID](P_Tessa_Forums_ForumResponse_SatelliteID.htm)|  
[Topics](P_Tessa_Forums_ForumResponse_Topics.htm)|  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Empty](M_Tessa_Forums_ForumResponse_Empty.htm)|  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[GetTopics](M_Tessa_Forums_ForumResponse_GetTopics.htm)|  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[IsEmpty](M_Tessa_Forums_ForumResponse_IsEmpty.htm)|  Возвращает признак того,
