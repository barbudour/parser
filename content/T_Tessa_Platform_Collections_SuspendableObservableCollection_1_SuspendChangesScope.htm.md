# SuspendableObservableCollection<T>.SuspendChangesScope - структура
##  __Definition
 **Пространство имён:**
[Tessa.Platform.Collections](N_Tessa_Platform_Collections.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public readonly struct SuspendChangesScope : IDisposable
VB __Копировать
     Public Structure SuspendChangesScope
    	Implements IDisposable
C++ __Копировать
     public value class SuspendChangesScope : IDisposable
F# __Копировать
     [<SealedAttribute>]
    type SuspendChangesScope = 
        struct
            inherit ValueType
            interface IDisposable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) __ SuspendableObservableCollection<T>.SuspendChangesScope
Implements
