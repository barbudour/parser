# CollectionBinding - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Behaviors](N_Tessa_UI_Behaviors.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class CollectionBinding : Behavior, 
    	IWeakEventListener
VB __Копировать
     Public NotInheritable Class CollectionBinding
    	Inherits Behavior
    	Implements IWeakEventListener
C++ __Копировать
     public ref class CollectionBinding sealed : public Behavior, 
    	IWeakEventListener
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __ CollectionBinding
Implements
    [IWeakEventListener](https://learn.microsoft.com/dotnet/api/system.windows.iweakeventlistener)
##  __Конструкторы
[CollectionBinding](M_Tessa_UI_Behaviors_CollectionBinding__ctor.htm)|
Инициализирует новый экземпляр класса CollectionBinding  
---|---  
##  __Свойства
[AssociatedObject](P_Tessa_UI_Behaviors_Behavior_AssociatedObject.htm)|  
...
[Converter](P_Tessa_UI_Behaviors_CollectionBinding_Converter.htm)|  
[ConverterCulture](P_Tessa_UI_Behaviors_CollectionBinding_ConverterCulture.htm)|  
[ConverterParameter](P_Tessa_UI_Behaviors_CollectionBinding_ConverterParameter.htm)|  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[ItemsSource](P_Tessa_UI_Behaviors_CollectionBinding_ItemsSource.htm)|  
[Mode](P_Tessa_UI_Behaviors_CollectionBinding_Mode.htm)|  
[PropertyName](P_Tessa_UI_Behaviors_CollectionBinding_PropertyName.htm)|  
## __Методы
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CloneCore](M_Tessa_UI_Behaviors_CollectionBinding_CloneCore.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CloneCurrentValueCore](M_Tessa_UI_Behaviors_CollectionBinding_CloneCurrentValueCore.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_CollectionBinding_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[GetAsFrozenCore](M_Tessa_UI_Behaviors_CollectionBinding_GetAsFrozenCore.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[GetCurrentValueAsFrozenCore](M_Tessa_UI_Behaviors_CollectionBinding_GetCurrentValueAsFrozenCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[GetRequiredType](M_Tessa_UI_Behaviors_Behavior_GetRequiredType.htm)|  
(Унаследован от [Behavior](T_Tessa_UI_Behaviors_Behavior.htm))  
[GetRequiredTypeCount](M_Tessa_UI_Behaviors_Behavior_GetRequiredTypeCount.htm)|  
(Унаследован от [Behavior](T_Tessa_UI_Behaviors_Behavior.htm))  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_CollectionBinding_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_CollectionBinding_OnDetaching.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[ItemsSourceProperty](F_Tessa_UI_Behaviors_CollectionBinding_ItemsSourceProperty.htm)|  
---|---  
## __См. также
#### Ссылки
