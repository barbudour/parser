# KrRecalcStagesUIExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrRecalcStagesUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrRecalcStagesUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrRecalcStagesUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrRecalcStagesUIExtension
##  __Конструкторы
[KrRecalcStagesUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrRecalcStagesUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrRecalcStagesUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrRecalcStagesUIExtension_Initialized.htm)|
