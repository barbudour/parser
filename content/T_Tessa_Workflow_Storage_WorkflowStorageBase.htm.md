# WorkflowStorageBase - класс
##  __Definition
 **Пространство имён:** [Tessa.Workflow.Storage](N_Tessa_Workflow_Storage.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class WorkflowStorageBase : StorageObject, 
    	INotifyPropertyChanged
VB __Копировать
     Public MustInherit Class WorkflowStorageBase
    	Inherits StorageObject
    	Implements INotifyPropertyChanged
C++ __Копировать
     public ref class WorkflowStorageBase abstract : public StorageObject, 
    	INotifyPropertyChanged
F# __Копировать
     [<AbstractClassAttribute>]
    type WorkflowStorageBase = 
        class
            inherit StorageObject
            interface INotifyPropertyChanged
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ WorkflowStorageBase
Derived
[Tessa.Workflow.Storage.WorkflowAnnotationStorage](T_Tessa_Workflow_Storage_WorkflowAnnotationStorage.htm)
[Tessa.Workflow.Storage.WorkflowStateStorageBase<T>](T_Tessa_Workflow_Storage_WorkflowStateStorageBase_1.htm)
[Tessa.Workflow.Storage.WorkflowSubscriptionStorageBase](T_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase.htm)
[Tessa.Workflow.Storage.WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm)
Implements
    [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged)
##  __Конструкторы
[WorkflowStorageBase(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowStorageBase__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowStorageBase  
---|---  
[WorkflowStorageBase(SerializationInfo,
StreamingContext)](M_Tessa_Workflow_Storage_WorkflowStorageBase__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowStorageBase  
##  __Свойства
