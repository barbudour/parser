# SessionServiceBinaryClient - класс
...
C# __Копировать
     public sealed class SessionServiceBinaryClient : ISessionService
VB __Копировать
     Public NotInheritable Class SessionServiceBinaryClient
    	Implements ISessionService
C++ __Копировать
     public ref class SessionServiceBinaryClient sealed : ISessionService
F# __Копировать
     [<SealedAttribute>]
    type SessionServiceBinaryClient = 
        class
            interface ISessionService
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ SessionServiceBinaryClient
Implements
    [ISessionService](T_Tessa_Platform_Runtime_ISessionService.htm)
##  __Конструкторы
[SessionServiceBinaryClient](M_Tessa_Platform_Runtime_SessionServiceBinaryClient__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Методы
[CloseSessionAsAdminAsync](M_Tessa_Platform_Runtime_SessionServiceBinaryClient_CloseSessionAsAdminAsync.htm)|
...
---|---  
[CloseSessionAsync](M_Tessa_Platform_Runtime_SessionServiceBinaryClient_CloseSessionAsync.htm)|
...
[CloseSessionWithTokenAsync](M_Tessa_Platform_Runtime_SessionServiceBinaryClient_CloseSessionWithTokenAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IncrementConfigurationVersionAsync](M_Tessa_Platform_Runtime_SessionServiceBinaryClient_IncrementConfigurationVersionAsync.htm)|
