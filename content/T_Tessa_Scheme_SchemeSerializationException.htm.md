# SchemeSerializationException - класс
##  __Definition
 **Пространство имён:** [Tessa.Scheme](N_Tessa_Scheme.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public class SchemeSerializationException : SchemeException
VB __Копировать
    <SerializableAttribute>
    Public Class SchemeSerializationException
    	Inherits SchemeException
C++ __Копировать
    [SerializableAttribute]
    public ref class SchemeSerializationException : public SchemeException
F# __Копировать
     [<SerializableAttribute>]
    type SchemeSerializationException = 
        class
            inherit SchemeException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[SchemeException](T_Tessa_Scheme_SchemeException.htm) __ SchemeSerializationException
##  __Конструкторы
[SchemeSerializationException()](M_Tessa_Scheme_SchemeSerializationException__ctor.htm)|
Инициализирует новый экземпляр класса SchemeSerializationException  
---|---  
[SchemeSerializationException(String)](M_Tessa_Scheme_SchemeSerializationException__ctor_2.htm)|
Инициализирует новый экземпляр класса SchemeSerializationException  
[SchemeSerializationException(SerializationInfo,
StreamingContext)](M_Tessa_Scheme_SchemeSerializationException__ctor_1.htm)|
Инициализирует новый экземпляр класса SchemeSerializationException  
[SchemeSerializationException(String,
Exception)](M_Tessa_Scheme_SchemeSerializationException__ctor_3.htm)|
Инициализирует новый экземпляр класса SchemeSerializationException  
##  __Свойства
