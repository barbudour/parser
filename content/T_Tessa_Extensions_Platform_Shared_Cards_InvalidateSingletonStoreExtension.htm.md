# InvalidateSingletonStoreExtension - класс
...
C# __Копировать
     public sealed class InvalidateSingletonStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class InvalidateSingletonStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class InvalidateSingletonStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type InvalidateSingletonStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ InvalidateSingletonStoreExtension
##  __Конструкторы
[InvalidateSingletonStoreExtension](M_Tessa_Extensions_Platform_Shared_Cards_InvalidateSingletonStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса InvalidateSingletonStoreExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Platform_Shared_Cards_InvalidateSingletonStoreExtension_AfterRequest.htm)|  
(Переопределяет
