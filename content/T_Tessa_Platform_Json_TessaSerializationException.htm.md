# TessaSerializationException - класс
...
C# __Копировать
    ...
    public sealed class TessaSerializationException : ApplicationException
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class TessaSerializationException
    	Inherits ApplicationException
C++ __Копировать
    [SerializableAttribute]
    public ref class TessaSerializationException sealed : public ApplicationException
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type TessaSerializationException = 
        class
            inherit ApplicationException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception) __ TessaSerializationException
##  __Конструкторы
[TessaSerializationException()](M_Tessa_Platform_Json_TessaSerializationException__ctor.htm)|
Создаёт экземпляр класса с параметрами по умолчанию.  
---|---  
[TessaSerializationException(String)](M_Tessa_Platform_Json_TessaSerializationException__ctor_1.htm)|
Создаёт экземпляр класса с указанием сообщения, описывающего возникшее
исключение.  
[TessaSerializationException(String,
Exception)](M_Tessa_Platform_Json_TessaSerializationException__ctor_2.htm)|
Создаёт экземпляр класса с указанием сообщения, описывающего возникшее
