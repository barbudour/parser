# HideEmptyIncomingReferencesControl - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class HideEmptyIncomingReferencesControl
    	Inherits CardUIExtension
C++ __Копировать
     public ref class HideEmptyIncomingReferencesControl sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type HideEmptyIncomingReferencesControl = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ HideEmptyIncomingReferencesControl
##  __Конструкторы
[HideEmptyIncomingReferencesControl](M_Tessa_Extensions_Default_Client_Documents_HideEmptyIncomingReferencesControl__ctor.htm)|
Инициализирует новый экземпляр класса HideEmptyIncomingReferencesControl  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_Documents_HideEmptyIncomingReferencesControl_Initialized.htm)|  
(Переопределяет
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Client.Documents - пространство
имён](N_Tessa_Extensions_Default_Client_Documents.htm)
