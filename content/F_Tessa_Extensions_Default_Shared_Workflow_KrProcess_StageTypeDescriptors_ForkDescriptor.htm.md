# StageTypeDescriptors.ForkDescriptor - поле
...
VB __Копировать
     Public Shared ReadOnly ForkDescriptor As StageTypeDescriptor
C++ __Копировать
     public:
    static initonly StageTypeDescriptor^ ForkDescriptor
F# __Копировать
     static val ForkDescriptor: StageTypeDescriptor
#### Значение поля
