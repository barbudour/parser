# PaletteSelectorViewModel - класс
##  __Definition
 **Пространство имён:**
...
C++ __Копировать
     public ref class PaletteSelectorViewModel : public ViewModel<EmptyModel^>
F# __Копировать
     type PaletteSelectorViewModel = 
        class
            inherit ViewModel<EmptyModel>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NotificationObject](T_Tessa_Platform_NotificationObject.htm) __[NotificationUIObject](T_Tessa_UI_NotificationUIObject.htm) __[ViewModel](T_Tessa_UI_ViewModel_1.htm)<[EmptyModel](T_Tessa_UI_EmptyModel.htm)> __ PaletteSelectorViewModel
##  __Конструкторы
[PaletteSelectorViewModel](M_Tessa_Extensions_Default_Client_Workplaces_WebChart_Palette_PaletteSelectorViewModel__ctor.htm)|
Инициализирует новый экземпляр класса PaletteSelectorViewModel  
---|---  
##  __Свойства
...
---|---  
[Palettes](P_Tessa_Extensions_Default_Client_Workplaces_WebChart_Palette_PaletteSelectorViewModel_Palettes.htm)|
Gets Список палтир  
[Scope](P_Tessa_UI_ViewModel_1_Scope.htm)|  
(Унаследован от [ViewModel<TModel>](T_Tessa_UI_ViewModel_1.htm))  
[SelectedPalette](P_Tessa_Extensions_Default_Client_Workplaces_WebChart_Palette_PaletteSelectorViewModel_SelectedPalette.htm)|
