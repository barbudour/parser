# CardStrictSecurityResolver - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Cards](N_Tessa_Extensions_Platform_Server_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class CardStrictSecurityResolver : NamedResolver<ICardStrictSecurity>, 
    	ICardStrictSecurityResolver, IResolver<string, ICardStrictSecurity>
VB __Копировать
     Public NotInheritable Class CardStrictSecurityResolver
    	Inherits NamedResolver(Of ICardStrictSecurity)
    	Implements ICardStrictSecurityResolver, IResolver(Of String, ICardStrictSecurity)
C++ __Копировать
     public ref class CardStrictSecurityResolver sealed : public NamedResolver<ICardStrictSecurity^>, 
    	ICardStrictSecurityResolver, IResolver<String^, ICardStrictSecurity^>
F# __Копировать
     [<SealedAttribute>]
    type CardStrictSecurityResolver = 
        class
            inherit NamedResolver<ICardStrictSecurity>
            interface ICardStrictSecurityResolver
            interface IResolver<string, ICardStrictSecurity>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Resolver](T_Tessa_Platform_Resolver_2.htm)<[String](https://learn.microsoft.com/dotnet/api/system.string), [ICardStrictSecurity](T_Tessa_Extensions_Platform_Server_Cards_ICardStrictSecurity.htm)> __[NamedResolver](T_Tessa_Platform_NamedResolver_1.htm)<[ICardStrictSecurity](T_Tessa_Extensions_Platform_Server_Cards_ICardStrictSecurity.htm)> __ CardStrictSecurityResolver
Implements
    [ICardStrictSecurityResolver](T_Tessa_Extensions_Platform_Server_Cards_ICardStrictSecurityResolver.htm), [IResolver](T_Tessa_Platform_IResolver_2.htm)<[String](https://learn.microsoft.com/dotnet/api/system.string), [ICardStrictSecurity](T_Tessa_Extensions_Platform_Server_Cards_ICardStrictSecurity.htm)>
##  __Конструкторы
[CardStrictSecurityResolver](M_Tessa_Extensions_Platform_Server_Cards_CardStrictSecurityResolver__ctor.htm)|
Инициализирует новый экземпляр класса CardStrictSecurityResolver  
---|---  
##  __Свойства
