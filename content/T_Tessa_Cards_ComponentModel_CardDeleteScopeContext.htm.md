...
C# __Копировать
     public sealed class CardDeleteScopeContext : ICardDeleteScopeContext
VB __Копировать
     Public NotInheritable Class CardDeleteScopeContext
    	Implements ICardDeleteScopeContext
C++ __Копировать
     public ref class CardDeleteScopeContext sealed : ICardDeleteScopeContext
F# __Копировать
     [<SealedAttribute>]
    type CardDeleteScopeContext = 
        class
            interface ICardDeleteScopeContext
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardDeleteScopeContext
Implements
    [ICardDeleteScopeContext](T_Tessa_Cards_ComponentModel_ICardDeleteScopeContext.htm)
##  __Конструкторы
[CardDeleteScopeContext](M_Tessa_Cards_ComponentModel_CardDeleteScopeContext__ctor.htm)|
...
[ICardDeleteScopeContext](T_Tessa_Cards_ComponentModel_ICardDeleteScopeContext.htm).  
## __Методы
[Create](M_Tessa_Cards_ComponentModel_CardDeleteScopeContext_Create.htm)|
