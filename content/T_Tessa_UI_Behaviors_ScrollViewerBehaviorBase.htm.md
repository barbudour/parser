# ScrollViewerBehaviorBase - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Behaviors](N_Tessa_UI_Behaviors.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class ScrollViewerBehaviorBase : Behavior<FrameworkElement>
VB __Копировать
     Public MustInherit Class ScrollViewerBehaviorBase
    	Inherits Behavior(Of FrameworkElement)
C++ __Копировать
     public ref class ScrollViewerBehaviorBase abstract : public Behavior<FrameworkElement^>
F# __Копировать
     [<AbstractClassAttribute>]
    type ScrollViewerBehaviorBase = 
        class
            inherit Behavior<FrameworkElement>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement)> __ ScrollViewerBehaviorBase
Derived
[Tessa.UI.Behaviors.HorizontalWheelScroll](T_Tessa_UI_Behaviors_HorizontalWheelScroll.htm)
[Tessa.UI.Behaviors.ScrollRatioBehaviorBase](T_Tessa_UI_Behaviors_ScrollRatioBehaviorBase.htm)
[Tessa.UI.Behaviors.ScrollViewerVisibility](T_Tessa_UI_Behaviors_ScrollViewerVisibility.htm)
[Tessa.UI.Behaviors.VerticalWheelScroll](T_Tessa_UI_Behaviors_VerticalWheelScroll.htm)
##  __Конструкторы
[ScrollViewerBehaviorBase](M_Tessa_UI_Behaviors_ScrollViewerBehaviorBase__ctor.htm)|
Инициализирует новый экземпляр класса ScrollViewerBehaviorBase  
---|---  
##  __Свойства
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[GetHorizontalAction](M_Tessa_UI_Behaviors_ScrollViewerBehaviorBase_GetHorizontalAction.htm)|  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[GetVerticalAction](M_Tessa_UI_Behaviors_ScrollViewerBehaviorBase_GetVerticalAction.htm)|  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnConnected](M_Tessa_UI_Behaviors_ScrollViewerBehaviorBase_OnConnected.htm)|  
...
[OnDisconnected](M_Tessa_UI_Behaviors_ScrollViewerBehaviorBase_OnDisconnected.htm)|  
