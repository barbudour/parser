...
C# __Копировать
    [RegistratorAttribute(ExtensionStage.Platform, Type = SessionType.Client, IsPlatform = true, 
    	Tag = RegistratorTag.AppManagerClient)]
    public sealed class AppManagerRegistrator : RegistratorBase
VB __Копировать
    <RegistratorAttribute(ExtensionStage.Platform, Type := SessionType.Client, IsPlatform := true, 
    	Tag := RegistratorTag.AppManagerClient)>
    Public NotInheritable Class AppManagerRegistrator
    	Inherits RegistratorBase
C++ __Копировать
    [RegistratorAttribute(ExtensionStage::Platform, Type = SessionType::Client, 
    	IsPlatform = true, Tag = RegistratorTag::AppManagerClient)]
    public ref class AppManagerRegistrator sealed : public RegistratorBase
F# __Копировать
     [<SealedAttribute>]
    [<RegistratorAttribute(ExtensionStage.Platform, Type = SessionType.Client, IsPlatform = true, 
    	Tag = RegistratorTag.AppManagerClient)>]
    type AppManagerRegistrator = 
        class
            inherit RegistratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm) __ AppManagerRegistrator
##  __Конструкторы
[AppManagerRegistrator](M_Tessa_Extensions_Platform_Client_Initialization_AppManagerRegistrator__ctor.htm)|
Инициализирует новый экземпляр класса AppManagerRegistrator  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterExtensions](M_Tessa_Extensions_Platform_Client_Initialization_AppManagerRegistrator_RegisterExtensions.htm)|  
(Переопределяет
[RegistratorBase.RegisterExtensions(IExtensionContainer)](M_Tessa_Extensions_RegistratorBase_RegisterExtensions.htm))  
[RegisterUnity](M_Tessa_Extensions_Platform_Client_Initialization_AppManagerRegistrator_RegisterUnity.htm)|  
(Переопределяет
