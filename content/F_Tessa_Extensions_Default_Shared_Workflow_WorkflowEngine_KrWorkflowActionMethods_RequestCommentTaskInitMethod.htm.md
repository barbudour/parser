# KrWorkflowActionMethods.RequestCommentTaskInitMethod - поле
...
VB __Копировать
     Public Shared ReadOnly RequestCommentTaskInitMethod As WorkflowActionMethodDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionMethodDescriptor^ RequestCommentTaskInitMethod
F# __Копировать
     static val RequestCommentTaskInitMethod: WorkflowActionMethodDescriptor
#### Значение поля
