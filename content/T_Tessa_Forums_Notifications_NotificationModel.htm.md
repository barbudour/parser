...
VB __Копировать
    ...
    Public Class NotificationModel
    	Inherits MessageModelBase
C++ __Копировать
    [SerializableAttribute]
    public ref class NotificationModel : public MessageModelBase
F# __Копировать
     [<SerializableAttribute>]
    type NotificationModel = 
        class
            inherit MessageModelBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm) __ NotificationModel
##  __Конструкторы
[NotificationModel()](M_Tessa_Forums_Notifications_NotificationModel__ctor.htm)|
Инициализирует новый экземпляр класса NotificationModel  
---|---  
[NotificationModel(Dictionary<String,
Object>)](M_Tessa_Forums_Notifications_NotificationModel__ctor_1.htm)|
Инициализирует новый экземпляр класса NotificationModel  
[NotificationModel(SerializationInfo,
StreamingContext)](M_Tessa_Forums_Notifications_NotificationModel__ctor_2.htm)|
Инициализирует новый экземпляр класса NotificationModel  
##  __Свойства
[AuthorID](P_Tessa_Forums_Models_MessageModelBase_AuthorID.htm)|  
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
---|---  
[AuthorName](P_Tessa_Forums_Models_MessageModelBase_AuthorName.htm)|  
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
[Batch](P_Tessa_Forums_Notifications_NotificationModel_Batch.htm)|  
[Body](P_Tessa_Forums_Models_MessageModelBase_Body.htm)|  
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
[CardDigest](P_Tessa_Forums_Notifications_NotificationModel_CardDigest.htm)|  
[CardID](P_Tessa_Forums_Notifications_NotificationModel_CardID.htm)|  
[CountAttachments](P_Tessa_Forums_Notifications_NotificationModel_CountAttachments.htm)|  
[Created](P_Tessa_Forums_Models_MessageModelBase_Created.htm)|  
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
[CurrentParticipantInfo](P_Tessa_Forums_Notifications_NotificationModel_CurrentParticipantInfo.htm)|  
[FirstName](P_Tessa_Forums_Notifications_NotificationModel_FirstName.htm)|  
[ID](P_Tessa_Forums_Models_MessageModelBase_ID.htm)|  
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
[IsRead](P_Tessa_Forums_Notifications_NotificationModel_IsRead.htm)|  
[LastName](P_Tessa_Forums_Notifications_NotificationModel_LastName.htm)|  
[MessageType](P_Tessa_Forums_Notifications_NotificationModel_MessageType.htm)|  
[ModifiedAt](P_Tessa_Forums_Models_MessageModelBase_ModifiedAt.htm)|  
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
[ModifiedByID](P_Tessa_Forums_Models_MessageModelBase_ModifiedByID.htm)|  
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
[ModifiedByName](P_Tessa_Forums_Models_MessageModelBase_ModifiedByName.htm)|  
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
[Time](P_Tessa_Forums_Notifications_NotificationModel_Time.htm)|  
[TopicID](P_Tessa_Forums_Models_MessageModelBase_TopicID.htm)|  
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
[TopicName](P_Tessa_Forums_Notifications_NotificationModel_TopicName.htm)|  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[GetMessageText](M_Tessa_Forums_Models_MessageModelBase_GetMessageText.htm)|  
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
