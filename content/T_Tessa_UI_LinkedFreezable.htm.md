# LinkedFreezable - класс
##  __Definition
 **Пространство имён:** [Tessa.UI](N_Tessa_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class LinkedFreezable : Freezable
VB __Копировать
     Public MustInherit Class LinkedFreezable
    	Inherits Freezable
C++ __Копировать
     public ref class LinkedFreezable abstract : public Freezable
F# __Копировать
     [<AbstractClassAttribute>]
    type LinkedFreezable = 
        class
            inherit Freezable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __ LinkedFreezable
Derived
[Tessa.UI.Behaviors.Behavior](T_Tessa_UI_Behaviors_Behavior.htm)
[Tessa.UI.Behaviors.ColumnCommand](T_Tessa_UI_Behaviors_ColumnCommand.htm)
##  __Конструкторы
[LinkedFreezable](M_Tessa_UI_LinkedFreezable__ctor.htm)| Инициализирует новый
экземпляр класса LinkedFreezable  
---|---  
##  __Свойства
