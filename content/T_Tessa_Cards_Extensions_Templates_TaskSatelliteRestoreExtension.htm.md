# TaskSatelliteRestoreExtension - класс
...
C# __Копировать
     public abstract class TaskSatelliteRestoreExtension : CardDeleteExtension
VB __Копировать
     Public MustInherit Class TaskSatelliteRestoreExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class TaskSatelliteRestoreExtension abstract : public CardDeleteExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type TaskSatelliteRestoreExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ TaskSatelliteRestoreExtension
##  __Конструкторы
[TaskSatelliteRestoreExtension](M_Tessa_Cards_Extensions_Templates_TaskSatelliteRestoreExtension__ctor.htm)|
