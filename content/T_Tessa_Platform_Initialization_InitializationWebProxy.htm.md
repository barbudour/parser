...
C# __Копировать
     public sealed class InitializationWebProxy : WebProxy
VB __Копировать
     Public NotInheritable Class InitializationWebProxy
    	Inherits WebProxy
C++ __Копировать
     public ref class InitializationWebProxy sealed : public WebProxy
F# __Копировать
     [<SealedAttribute>]
    type InitializationWebProxy = 
        class
            inherit WebProxy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm) __ InitializationWebProxy
##  __Конструкторы
[InitializationWebProxy](M_Tessa_Platform_Initialization_InitializationWebProxy__ctor.htm)|
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[InitializeAsync](M_Tessa_Platform_Initialization_InitializationWebProxy_InitializeAsync.htm)|
