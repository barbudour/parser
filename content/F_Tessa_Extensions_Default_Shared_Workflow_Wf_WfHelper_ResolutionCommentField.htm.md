# WfHelper.ResolutionCommentField - поле
...
VB __Копировать
     Public Const ResolutionCommentField As String = "Comment"
C++ __Копировать
     public:
    literal String^ ResolutionCommentField = "Comment"
F# __Копировать
     static val mutable ResolutionCommentField: string
#### Значение поля
