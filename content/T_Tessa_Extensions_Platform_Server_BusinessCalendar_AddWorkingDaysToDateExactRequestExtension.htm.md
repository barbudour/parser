# AddWorkingDaysToDateExactRequestExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.BusinessCalendar](N_Tessa_Extensions_Platform_Server_BusinessCalendar.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class AddWorkingDaysToDateExactRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class AddWorkingDaysToDateExactRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class AddWorkingDaysToDateExactRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type AddWorkingDaysToDateExactRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ AddWorkingDaysToDateExactRequestExtension
##  __Конструкторы
[AddWorkingDaysToDateExactRequestExtension](M_Tessa_Extensions_Platform_Server_BusinessCalendar_AddWorkingDaysToDateExactRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса
AddWorkingDaysToDateExactRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_BusinessCalendar_AddWorkingDaysToDateExactRequestExtension_AfterRequest.htm)|  
(Переопределяет
