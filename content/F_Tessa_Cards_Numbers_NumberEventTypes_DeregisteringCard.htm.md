# NumberEventTypes.DeregisteringCard - поле
...
C# __Копировать
     public static readonly NumberEventType DeregisteringCard
VB __Копировать
     Public Shared ReadOnly DeregisteringCard As NumberEventType
C++ __Копировать
     public:
    static initonly NumberEventType^ DeregisteringCard
F# __Копировать
     static val DeregisteringCard: NumberEventType
#### Значение поля
