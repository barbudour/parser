# KrStageSourceUIExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrStageSourceUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrStageSourceUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrStageSourceUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrStageSourceUIExtension
##  __Конструкторы
[KrStageSourceUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrStageSourceUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrStageSourceUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrStageSourceUIExtension_Initialized.htm)|  
(Переопределяет
