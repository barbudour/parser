# VirtualFileVersion - класс
Версия виртуального файла, указываемая при добавлении.
## __Definition
 **Пространство имён:** [Tessa.Files](N_Tessa_Files.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class VirtualFileVersion
VB __Копировать
     Public NotInheritable Class VirtualFileVersion
C++ __Копировать
     public ref class VirtualFileVersion sealed
F# __Копировать
     [<SealedAttribute>]
    type VirtualFileVersion = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ VirtualFileVersion
##  __Конструкторы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ModifyAsync](M_Tessa_Files_VirtualFileVersion_ModifyAsync.htm)|  Изменяет
токен создаваемой версии файла в соответствии с настройками текущего объекта.  
