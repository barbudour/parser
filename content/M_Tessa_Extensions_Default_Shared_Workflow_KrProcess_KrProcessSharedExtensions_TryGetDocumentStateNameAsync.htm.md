# KrProcessSharedExtensions.TryGetDocumentStateNameAsync - метод
...
C# __Копировать
     public static ValueTask<string> TryGetDocumentStateNameAsync(
...
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function TryGetDocumentStateNameAsync ( 
...
C++ __Копировать
     public:
    [ExtensionAttribute]
    static ValueTask<String^> TryGetDocumentStateNameAsync(
...
F# __Копировать
     [<ExtensionAttribute>]
    static member TryGetDocumentStateNameAsync : 
...
Название состояния согласования документа или значение null, если заданное
