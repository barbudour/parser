...
Implements
    [IAssemblyLoaderResult](T_Chronos_Platform_Composition_IAssemblyLoaderResult_1.htm)<TMetadata>
#### Параметры типа
TMetadata
...
## __Конструкторы
[AssemblyLoaderResult<TMetadata>](M_Chronos_Platform_Composition_AssemblyLoaderResult_1__ctor.htm)|
