...
##  __Конструкторы
[GlobalEventAwaiter](M_Tessa_Platform_IPC_GlobalEventAwaiter__ctor.htm)|
Создаёт экземпляр класса с указанием глобального события, ожидание которого
будет выполняться.  
---|---  
## __Свойства
[GlobalEvent](P_Tessa_Platform_IPC_GlobalEventAwaiter_GlobalEvent.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[WaitAnyAsync](M_Tessa_Platform_IPC_GlobalEventAwaiter_WaitAnyAsync.htm)|
Выполняет ожидание либо глобального события
[GlobalEvent](P_Tessa_Platform_IPC_GlobalEventAwaiter_GlobalEvent.htm), либо
