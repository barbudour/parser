...
C# __Копировать
     public sealed class CarUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class CarUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class CarUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type CarUIExtension = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ CarUIExtension
##  __Конструкторы
[CarUIExtension](M_Tessa_Extensions_Default_Client_UI_CarUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса CarUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_CarUIExtension_Initialized.htm)|  
(Переопределяет
...
(Унаследован от [CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm))  
[Saving](M_Tessa_Extensions_Default_Client_UI_CarUIExtension_Saving.htm)|  
(Переопределяет
