# KrUpdateDialogTypeMetadataExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrUpdateDialogTypeMetadataExtension
    	Inherits CardTypeMetadataExtension
C++ __Копировать
     public ref class KrUpdateDialogTypeMetadataExtension sealed : public CardTypeMetadataExtension
F# __Копировать
     [<SealedAttribute>]
    type KrUpdateDialogTypeMetadataExtension = 
        class
            inherit CardTypeMetadataExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardMetadataExtension](T_Tessa_Cards_Extensions_CardMetadataExtension.htm) __[CardTypeMetadataExtension](T_Tessa_Cards_Extensions_CardTypeMetadataExtension.htm) __ KrUpdateDialogTypeMetadataExtension
##  __Конструкторы
[KrUpdateDialogTypeMetadataExtension](M_Tessa_Extensions_Default_Shared_Workflow_WorkflowEngine_KrUpdateDialogTypeMetadataExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrUpdateDialogTypeMetadataExtension  
---|---  
##  __Свойства
...
[ModifyTypes](M_Tessa_Extensions_Default_Shared_Workflow_WorkflowEngine_KrUpdateDialogTypeMetadataExtension_ModifyTypes.htm)|  
(Переопределяет
