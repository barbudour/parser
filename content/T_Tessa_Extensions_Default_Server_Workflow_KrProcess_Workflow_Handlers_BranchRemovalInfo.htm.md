...
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class BranchRemovalInfo
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class BranchRemovalInfo sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type BranchRemovalInfo = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ BranchRemovalInfo
##  __Конструкторы
[BranchRemovalInfo(Dictionary<String,
Object>)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_BranchRemovalInfo__ctor.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
---|---  
[BranchRemovalInfo(SerializationInfo,
StreamingContext)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_BranchRemovalInfo__ctor_2.htm)|
...
[BranchRemovalInfo(IEnumerable<Guid>, IEnumerable<Guid>,
DirectionAfterInterrupt)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_BranchRemovalInfo__ctor_1.htm)|
Инициализирует новый экземпляр класса BranchRemovalInfo  
##  __Свойства
[DirectionAfterInterrupt](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_BranchRemovalInfo_DirectionAfterInterrupt.htm)|  
---|---  
[NestedProcesses](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_BranchRemovalInfo_NestedProcesses.htm)|  
[SecondaryProcesses](P_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_BranchRemovalInfo_SecondaryProcesses.htm)|  
## __Методы
