# FmNotificationsRequestObject - класс
##  __Definition
 **Пространство имён:**
[Tessa.Forums.Notifications](N_Tessa_Forums_Notifications.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class FmNotificationsRequestObject : StorageObject
VB __Копировать
     Public Class FmNotificationsRequestObject
    	Inherits StorageObject
C++ __Копировать
     public ref class FmNotificationsRequestObject : public StorageObject
F# __Копировать
     type FmNotificationsRequestObject = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ FmNotificationsRequestObject
##  __Конструкторы
[FmNotificationsRequestObject()](M_Tessa_Forums_Notifications_FmNotificationsRequestObject__ctor.htm)|
Инициализирует новый экземпляр класса FmNotificationsRequestObject  
---|---  
[FmNotificationsRequestObject(Dictionary<String,
Object>)](M_Tessa_Forums_Notifications_FmNotificationsRequestObject__ctor_1.htm)|
Инициализирует новый экземпляр класса FmNotificationsRequestObject  
##  __Свойства
[LastPostTime](P_Tessa_Forums_Notifications_FmNotificationsRequestObject_LastPostTime.htm)|  
---|---  
[MessageID](P_Tessa_Forums_Notifications_FmNotificationsRequestObject_MessageID.htm)|  
[TopicID](P_Tessa_Forums_Notifications_FmNotificationsRequestObject_TopicID.htm)|  
## __Методы
