# ApplicationLaunchingException - класс
...
C# __Копировать
    ...
    public class ApplicationLaunchingException : Exception
VB __Копировать
    <SerializableAttribute>
    Public Class ApplicationLaunchingException
    	Inherits Exception
C++ __Копировать
    [SerializableAttribute]
    public ref class ApplicationLaunchingException : public Exception
F# __Копировать
     [<SerializableAttribute>]
    type ApplicationLaunchingException = 
        class
            inherit Exception
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __ ApplicationLaunchingException
##  __Конструкторы
