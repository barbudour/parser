# SequenceGetExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.Cards](N_Tessa_Extensions_Platform_Client_Cards.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class SequenceGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class SequenceGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class SequenceGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type SequenceGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ SequenceGetExtension
##  __Конструкторы
[SequenceGetExtension](M_Tessa_Extensions_Platform_Client_Cards_SequenceGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса SequenceGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Client_Cards_SequenceGetExtension_AfterRequest.htm)|  
(Переопределяет
