# CardDeleteExtensionContext - класс
Контекст процесса удаления карточки.
## __Definition
 **Пространство имён:** [Tessa.Cards.Extensions](N_Tessa_Cards_Extensions.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class CardDeleteExtensionContext : CardExtensionContext, 
    	ICardDeleteExtensionContext, ICardRequestExtensionContext<CardDeleteRequest, CardDeleteResponse>, ICardExtensionContext, 
    	ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
VB __Копировать
     Public NotInheritable Class CardDeleteExtensionContext
    	Inherits CardExtensionContext
    	Implements ICardDeleteExtensionContext, ICardRequestExtensionContext(Of CardDeleteRequest, CardDeleteResponse), 
    	ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
C++ __Копировать
     public ref class CardDeleteExtensionContext sealed : public CardExtensionContext, 
    	ICardDeleteExtensionContext, ICardRequestExtensionContext<CardDeleteRequest^, CardDeleteResponse^>, ICardExtensionContext, 
    	ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
F# __Копировать
     [<SealedAttribute>]
    type CardDeleteExtensionContext = 
        class
            inherit CardExtensionContext
            interface ICardDeleteExtensionContext
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardExtensionContext](T_Tessa_Cards_Extensions_CardExtensionContext.htm) __ CardDeleteExtensionContext
Implements
    [ICardDeleteExtensionContext](T_Tessa_Cards_Extensions_ICardDeleteExtensionContext.htm), [ICardExtensionContext](T_Tessa_Cards_Extensions_ICardExtensionContext.htm), [ICardRequestExtensionContext](T_Tessa_Cards_Extensions_ICardRequestExtensionContext_2.htm)<[CardDeleteRequest](T_Tessa_Cards_CardDeleteRequest.htm), [CardDeleteResponse](T_Tessa_Cards_CardDeleteResponse.htm)>, [ICardTypeExtensionContext](T_Tessa_Cards_Extensions_ICardTypeExtensionContext.htm), [IExtensionContext](T_Tessa_Extensions_IExtensionContext.htm), [ITraceableExtensionContext](T_Tessa_Extensions_ITraceableExtensionContext.htm)
##  __Конструкторы
[CardDeleteExtensionContext](M_Tessa_Cards_Extensions_CardDeleteExtensionContext__ctor.htm)|
...
(Унаследован от
[CardExtensionContext](T_Tessa_Cards_Extensions_CardExtensionContext.htm))  
[Method](P_Tessa_Cards_Extensions_CardDeleteExtensionContext_Method.htm)|
Способ удаления карточки.  
[Request](P_Tessa_Cards_Extensions_CardDeleteExtensionContext_Request.htm)|
...
(Унаследован от
[CardExtensionContext](T_Tessa_Cards_Extensions_CardExtensionContext.htm))  
[Response](P_Tessa_Cards_Extensions_CardDeleteExtensionContext_Response.htm)|
...
(Унаследован от
[CardExtensionContext](T_Tessa_Cards_Extensions_CardExtensionContext.htm))  
[TransactionStrategy](P_Tessa_Cards_Extensions_CardDeleteExtensionContext_TransactionStrategy.htm)|
