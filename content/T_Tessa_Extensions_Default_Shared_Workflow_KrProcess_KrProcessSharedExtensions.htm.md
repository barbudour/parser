...
VB __Копировать
    <ExtensionAttribute>
    Public NotInheritable Class KrProcessSharedExtensions
C++ __Копировать
    [ExtensionAttribute]
    public ref class KrProcessSharedExtensions abstract sealed
F# __Копировать
     [<AbstractClassAttribute>]
    [<SealedAttribute>]
    [<ExtensionAttribute>]
    type KrProcessSharedExtensions = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ KrProcessSharedExtensions
##  __Методы
...
Возвращает параметры запускаемого процесса.  
## __Поля
[KrProcessClientCommandInfoMark](F_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrProcessSharedExtensions_KrProcessClientCommandInfoMark.htm)|  
---|---  
## __См. также
#### Ссылки
