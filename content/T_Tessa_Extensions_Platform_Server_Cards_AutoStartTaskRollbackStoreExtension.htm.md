# AutoStartTaskRollbackStoreExtension - класс
...
C# __Копировать
     public sealed class AutoStartTaskRollbackStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class AutoStartTaskRollbackStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class AutoStartTaskRollbackStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type AutoStartTaskRollbackStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ AutoStartTaskRollbackStoreExtension
##  __Заметки
Расширение должно выполняться после всех других расширений для обеспечения
корректной отмены в случае возникновения ошибок обработки.
##  __Конструкторы
[AutoStartTaskRollbackStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_AutoStartTaskRollbackStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса AutoStartTaskRollbackStoreExtension.  
---|---  
## __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[AfterRequestFinally](M_Tessa_Extensions_Platform_Server_Cards_AutoStartTaskRollbackStoreExtension_AfterRequestFinally.htm)|
