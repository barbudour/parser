# CardTaskHistoryItem(IStorageObjectProvider) - конструктор
...
F# __Копировать
     new : 
            storageProvider : IStorageObjectProvider -> CardTaskHistoryItem
#### Параметры
storageProvider
...
[CardTaskHistoryItem -
перегрузка](Overload_Tessa_Cards_CardTaskHistoryItem__ctor.htm)
