# XmlFrom1CRequestExtension - класс
...
C# __Копировать
     public sealed class XmlFrom1CRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class XmlFrom1CRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class XmlFrom1CRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type XmlFrom1CRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ XmlFrom1CRequestExtension
##  __Конструкторы
[XmlFrom1CRequestExtension](M_Tessa_Extensions_Default_Server_Test_XmlFrom1CRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса XmlFrom1CRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Test_XmlFrom1CRequestExtension_AfterRequest.htm)|  
(Переопределяет
