# CardRequestClientComponent - класс
...
C# __Копировать
     public sealed class CardRequestClientComponent : ICardRequestComponent
VB __Копировать
     Public NotInheritable Class CardRequestClientComponent
    	Implements ICardRequestComponent
C++ __Копировать
     public ref class CardRequestClientComponent sealed : ICardRequestComponent
F# __Копировать
     [<SealedAttribute>]
    type CardRequestClientComponent = 
        class
            interface ICardRequestComponent
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardRequestClientComponent
Implements
    [ICardRequestComponent](T_Tessa_Cards_ComponentModel_ICardRequestComponent.htm)
##  __Конструкторы
[CardRequestClientComponent](M_Tessa_Cards_ComponentModel_CardRequestClientComponent__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RequestAsync](M_Tessa_Cards_ComponentModel_CardRequestClientComponent_RequestAsync.htm)|
