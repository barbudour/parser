# KrInfoForInitiatorGetExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrInfoForInitiatorGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class KrInfoForInitiatorGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrInfoForInitiatorGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ KrInfoForInitiatorGetExtension
##  __Конструкторы
[KrInfoForInitiatorGetExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrInfoForInitiatorGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrInfoForInitiatorGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrInfoForInitiatorGetExtension_AfterRequest.htm)|  
(Переопределяет
