...
C++ __Копировать
    [ValueConversionAttribute(typeof(String), typeof(String))]
    public ref class StringTrimConverter : public ValueConverter<String^, String^>
F# __Копировать
     [<ValueConversionAttribute(typeof(string), typeof(string))>]
    type StringTrimConverter = 
        class
            inherit ValueConverter<string, string>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueConverter](T_Tessa_UI_Data_ValueConverter_2.htm)<[String](https://learn.microsoft.com/dotnet/api/system.string), [String](https://learn.microsoft.com/dotnet/api/system.string)> __ StringTrimConverter
##  __Конструкторы
[StringTrimConverter](M_Tessa_UI_Data_StringTrimConverter__ctor.htm)|
Инициализирует новый экземпляр класса StringTrimConverter  
---|---  
##  __Свойства
[Instance](P_Tessa_UI_Data_StringTrimConverter_Instance.htm)|  
---|---  
## __Методы
...
CultureInfo)](M_Tessa_UI_Data_StringTrimConverter_Convert.htm)|  
...
CultureInfo)](M_Tessa_UI_Data_StringTrimConverter_ConvertBack.htm)|  
