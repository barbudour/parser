...
C# __Копировать
     public abstract class CardTypePolicyBase
VB __Копировать
     Public MustInherit Class CardTypePolicyBase
C++ __Копировать
     public ref class CardTypePolicyBase abstract
F# __Копировать
     [<AbstractClassAttribute>]
    type CardTypePolicyBase = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardTypePolicyBase
Derived
[Tessa.Cards.Extensions.CardFileTypePolicy](T_Tessa_Cards_Extensions_CardFileTypePolicy.htm)
[Tessa.Cards.Extensions.CardTaskTypePolicy](T_Tessa_Cards_Extensions_CardTaskTypePolicy.htm)
[Tessa.Cards.Extensions.CardTypePolicy](T_Tessa_Cards_Extensions_CardTypePolicy.htm)
##  __Конструкторы
