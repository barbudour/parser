# DocumentSharingLocationCollection - класс
...
VB __Копировать
     Public NotInheritable Class DocumentSharingLocationCollection
C++ __Копировать
     public ref class DocumentSharingLocationCollection sealed
F# __Копировать
     [<SealedAttribute>]
    type DocumentSharingLocationCollection = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ DocumentSharingLocationCollection
##  __Свойства
