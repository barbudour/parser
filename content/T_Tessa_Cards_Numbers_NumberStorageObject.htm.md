# NumberStorageObject - класс
Объект, сохраняющий информацию по номеру
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[FullNumber](P_Tessa_Cards_Numbers_NumberStorageObject_FullNumber.htm)|
Строковое представление номера или null, если номер является пустым.  
[Info](P_Tessa_Cards_CardInfoStorageObject_Info.htm)|  Дополнительная
пользовательская информация.  
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[Number](P_Tessa_Cards_Numbers_NumberStorageObject_Number.htm)|  Числовое
представление номера или null, если номер является пустым.  
[SequenceName](P_Tessa_Cards_Numbers_NumberStorageObject_SequenceName.htm)|
Имя последовательности, из которой был взят номер, или null, если номер
является пустым.  
[Type](P_Tessa_Cards_Numbers_NumberStorageObject_Type.htm)|  Информация по
типу номера с дополнительной информацией.  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_Numbers_NumberStorageObject_Clone.htm)|  Выполняет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Cards_Numbers_NumberStorageObject_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[IsEmpty](M_Tessa_Cards_Numbers_NumberStorageObject_IsEmpty.htm)|  Возвращает
признак того, что объект не содержит значимых данных для метода очистки
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[NumberIsEmpty](M_Tessa_Cards_Numbers_NumberStorageObject_NumberIsEmpty.htm)|
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[Set(INumberObject)](M_Tessa_Cards_Numbers_NumberStorageObject_Set.htm)|
...
восстановить в методе FromTypedJson.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[ToNumberObjectAsync](M_Tessa_Cards_Numbers_NumberStorageObject_ToNumberObjectAsync.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetType](M_Tessa_Cards_Numbers_NumberStorageObject_TryGetType.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_Numbers_NumberStorageObject_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
