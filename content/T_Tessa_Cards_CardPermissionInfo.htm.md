...
C# __Копировать
    ...
    public sealed class CardPermissionInfo : CardStorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardPermissionInfo
    	Inherits CardStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardPermissionInfo sealed : public CardStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardPermissionInfo = 
        class
            inherit CardStorageObject
            interface ICloneable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __ CardPermissionInfo
Implements
    [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable)
##  __Конструкторы
[CardPermissionInfo()](M_Tessa_Cards_CardPermissionInfo__ctor.htm)|  Создаёт
экземпляр класса и пустое хранилище Dictionary<string, object>, декоратором
для которого является создаваемый объект.  
---|---  
[CardPermissionInfo(Dictionary<String,
Object>)](M_Tessa_Cards_CardPermissionInfo__ctor_1.htm)| Создаёт экземпляр
класса с указанием хранилища, декоратором для которого является создаваемый
объект.  
[CardPermissionInfo(IStorageObjectProvider)](M_Tessa_Cards_CardPermissionInfo__ctor_2.htm)|
...
## __Методы
[Clean](M_Tessa_Cards_CardPermissionInfo_Clean.htm)| Выполняет очистку
...
[Clear](M_Tessa_Cards_CardPermissionInfo_Clear.htm)|  Удаляет всю информацию о
правах доступа.  
[ClearCache](M_Tessa_Platform_Storage_StorageObject_ClearCache.htm)|  Очищает
внутренний кэш декораторов.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_CardPermissionInfo_Clone.htm)|  Выполняет глубокое
клонирование хранилища прав доступа карточки и возвращает созданный строго
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[CreateResolver](M_Tessa_Cards_CardPermissionInfo_CreateResolver.htm)|
Создаёт объект, осуществляющий поиск и кэширование прав доступа для полей и
строк.  
[EnsureCacheResolved](M_Tessa_Cards_CardPermissionInfo_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[IsEmpty](M_Tessa_Cards_CardPermissionInfo_IsEmpty.htm)|  Возвращает признак
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Merge](M_Tessa_Cards_CardPermissionInfo_Merge.htm)|  Копирует права доступа
из заданного объекта, выполняя слияние с текущим объектом с перезаписью уже
существующих прав.  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[RepairStorage](M_Tessa_Cards_CardPermissionInfo_RepairStorage.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[SetCardPermissions](M_Tessa_Cards_CardPermissionInfo_SetCardPermissions.htm)|
Устанавливает заданные разрешения или запреты для карточки.  
[SetFilePermissions](M_Tessa_Cards_CardPermissionInfo_SetFilePermissions.htm)|
...
не найден.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetFilePermissions](M_Tessa_Cards_CardPermissionInfo_TryGetFilePermissions.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetSections](M_Tessa_Cards_CardPermissionInfo_TryGetSections.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardPermissionInfo_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
