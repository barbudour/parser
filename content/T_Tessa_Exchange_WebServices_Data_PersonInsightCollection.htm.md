...
VB __Копировать
     Public NotInheritable Class PersonInsightCollection
    	Inherits ComplexPropertyCollection(Of PersonInsight)
C++ __Копировать
     public ref class PersonInsightCollection sealed : public ComplexPropertyCollection<PersonInsight^>
F# __Копировать
     [<SealedAttribute>]
    type PersonInsightCollection = 
        class
            inherit ComplexPropertyCollection<PersonInsight>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[PersonInsight](T_Tessa_Exchange_WebServices_Data_PersonInsight.htm)> __ PersonInsightCollection
##  __Свойства
...
[ComplexPropertyCollection<TComplexProperty>](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm))  
##  __Методы
[Add](M_Tessa_Exchange_WebServices_Data_PersonInsightCollection_Add.htm)|
Adds an insight to the collection.  
---|---  
[AddRange](M_Tessa_Exchange_WebServices_Data_PersonInsightCollection_AddRange.htm)|
Adds multiple person insights to the collection.  
[Clear](M_Tessa_Exchange_WebServices_Data_PersonInsightCollection_Clear.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Remove](M_Tessa_Exchange_WebServices_Data_PersonInsightCollection_Remove.htm)|
Removes a person insight from the collection.  
[RemoveAt](M_Tessa_Exchange_WebServices_Data_PersonInsightCollection_RemoveAt.htm)|
Removes a person insight from the collection.  
