# MultitypeSatelliteExportExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Cards.Extensions.Templates](N_Tessa_Cards_Extensions_Templates.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class MultitypeSatelliteExportExtension : CardGetExtension
VB __Копировать
     Public MustInherit Class MultitypeSatelliteExportExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class MultitypeSatelliteExportExtension abstract : public CardGetExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type MultitypeSatelliteExportExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ MultitypeSatelliteExportExtension
Derived
[Tessa.Cards.Extensions.Templates.TaskSatelliteExportExtension](T_Tessa_Cards_Extensions_Templates_TaskSatelliteExportExtension.htm)
##  __Конструкторы
[MultitypeSatelliteExportExtension](M_Tessa_Cards_Extensions_Templates_MultitypeSatelliteExportExtension__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetSatelliteInfoListAsync](M_Tessa_Cards_Extensions_Templates_MultitypeSatelliteExportExtension_TryGetSatelliteInfoListAsync.htm)|
