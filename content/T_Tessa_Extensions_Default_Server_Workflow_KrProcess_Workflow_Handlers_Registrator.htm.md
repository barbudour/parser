...
##  __Конструкторы
[Registrator](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_Registrator__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[FinalizeRegistration](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_Registrator_FinalizeRegistration.htm)|  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterExtensions](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_Registrator_RegisterExtensions.htm)|
...
[RegisterUnity](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_Registrator_RegisterUnity.htm)|  
(Переопределяет
