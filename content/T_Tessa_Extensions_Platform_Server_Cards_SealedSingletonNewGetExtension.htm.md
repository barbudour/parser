# SealedSingletonNewGetExtension - класс
...
C# __Копировать
     public sealed class SealedSingletonNewGetExtension : CardNewGetExtension
VB __Копировать
     Public NotInheritable Class SealedSingletonNewGetExtension
    	Inherits CardNewGetExtension
C++ __Копировать
     public ref class SealedSingletonNewGetExtension sealed : public CardNewGetExtension
F# __Копировать
     [<SealedAttribute>]
    type SealedSingletonNewGetExtension = 
        class
            inherit CardNewGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewGetExtension](T_Tessa_Cards_Extensions_CardNewGetExtension.htm) __ SealedSingletonNewGetExtension
##  __Конструкторы
[SealedSingletonNewGetExtension](M_Tessa_Extensions_Platform_Server_Cards_SealedSingletonNewGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса SealedSingletonNewGetExtension  
---|---  
##  __Методы
[AfterRequest(ICardGetExtensionContext)](M_Tessa_Extensions_Platform_Server_Cards_SealedSingletonNewGetExtension_AfterRequest.htm)|  
(Переопределяет
[CardNewGetExtension.AfterRequest(ICardGetExtensionContext)](M_Tessa_Cards_Extensions_CardNewGetExtension_AfterRequest.htm))  
---|---  
[AfterRequest(ICardNewExtensionContext)](M_Tessa_Extensions_Platform_Server_Cards_SealedSingletonNewGetExtension_AfterRequest_1.htm)|  
(Переопределяет
