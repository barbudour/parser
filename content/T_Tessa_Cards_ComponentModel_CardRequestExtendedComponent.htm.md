# CardRequestExtendedComponent - класс
...
C# __Копировать
     public sealed class CardRequestExtendedComponent : ICardRequestComponent
VB __Копировать
     Public NotInheritable Class CardRequestExtendedComponent
    	Implements ICardRequestComponent
C++ __Копировать
     public ref class CardRequestExtendedComponent sealed : ICardRequestComponent
F# __Копировать
     [<SealedAttribute>]
    type CardRequestExtendedComponent = 
        class
            interface ICardRequestComponent
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardRequestExtendedComponent
Implements
    [ICardRequestComponent](T_Tessa_Cards_ComponentModel_ICardRequestComponent.htm)
##  __Конструкторы
[CardRequestExtendedComponent](M_Tessa_Cards_ComponentModel_CardRequestExtendedComponent__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RequestAsync](M_Tessa_Cards_ComponentModel_CardRequestExtendedComponent_RequestAsync.htm)|
