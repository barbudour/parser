# CardCacheCollectionBase<T>.TryGetAlreadyCachedAsync - метод
...
[ValueTask](https://learn.microsoft.com/dotnet/api/system.threading.tasks.valuetask-1)<[T](T_Tessa_Cards_Caching_CardCacheCollectionBase_1.htm)>  
