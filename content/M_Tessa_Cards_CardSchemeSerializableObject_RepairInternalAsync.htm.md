# CardSchemeSerializableObject.RepairInternalAsync - метод
...
C# __Копировать
     protected virtual ValueTask RepairInternalAsync(
    	ICardSchemeInfoProvider cardSchemeInfoProvider,
    	IValidationResultBuilder validationResult,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Protected Overridable Function RepairInternalAsync ( 
