...
C# __Копировать
     public class TopicNotificationInfo : InfoStorageObject, 
    	ITopicNotificationInfo
VB __Копировать
     Public Class TopicNotificationInfo
    	Inherits InfoStorageObject
    	Implements ITopicNotificationInfo
C++ __Копировать
     public ref class TopicNotificationInfo : public InfoStorageObject, 
    	ITopicNotificationInfo
F# __Копировать
     type TopicNotificationInfo = 
        class
            inherit InfoStorageObject
            interface ITopicNotificationInfo
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm) __ TopicNotificationInfo
Implements
    [ITopicNotificationInfo](T_Tessa_Forums_Notifications_ITopicNotificationInfo.htm)
##  __Конструкторы
[TopicNotificationInfo()](M_Tessa_Forums_Notifications_TopicNotificationInfo__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[TopicNotificationInfo(Dictionary<String,
Object>)](M_Tessa_Forums_Notifications_TopicNotificationInfo__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[TopicNotificationInfo(ITopicNotificationInfo)](M_Tessa_Forums_Notifications_TopicNotificationInfo__ctor_2.htm)|
Создаёт экземпляр класса с указанием объекта, свойства которого используются
для заполнения свойств создаваемого объекта.  
## __Свойства
[AuthorName](P_Tessa_Forums_Notifications_TopicNotificationInfo_AuthorName.htm)|
Имя автора сообщения или null, если автор неизвестен.  
---|---  
[CardID](P_Tessa_Forums_Notifications_TopicNotificationInfo_CardID.htm)|
...
(Унаследован от
[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm))  
[HtmlText](P_Tessa_Forums_Notifications_TopicNotificationInfo_HtmlText.htm)|
Текст сообщения в формате HTML.  
[Info](P_Tessa_Platform_Storage_InfoStorageObject_Info.htm)|  Дополнительная
пользовательская информация.  
(Унаследован от
[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm))  
[Link](P_Tessa_Forums_Notifications_TopicNotificationInfo_Link.htm)|  Ссылка
для открытия топика в desktop-клиенте или null, если ссылка не указана.  
[MessageDate](P_Tessa_Forums_Notifications_TopicNotificationInfo_MessageDate.htm)|
Дата сообщения или null, если дата не указана.  
[MessageID](P_Tessa_Forums_Notifications_TopicNotificationInfo_MessageID.htm)|
Идентификатор сообщения.  
[TopicDescription](P_Tessa_Forums_Notifications_TopicNotificationInfo_TopicDescription.htm)|
Описание топика.  
[TopicID](P_Tessa_Forums_Notifications_TopicNotificationInfo_TopicID.htm)|
Идентификатор топика.  
[TopicTitle](P_Tessa_Forums_Notifications_TopicNotificationInfo_TopicTitle.htm)|
Заголовок топика.  
[Type](P_Tessa_Forums_Notifications_TopicNotificationInfo_Type.htm)|  Тип
уведомления.  
[UserID](P_Tessa_Forums_Notifications_TopicNotificationInfo_UserID.htm)|
Идентификатор текущего сотрудника.  
[WebLink](P_Tessa_Forums_Notifications_TopicNotificationInfo_WebLink.htm)|
