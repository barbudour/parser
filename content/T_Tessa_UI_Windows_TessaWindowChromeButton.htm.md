...
C# __Копировать
     public sealed class TessaWindowChromeButton : Button
VB __Копировать
     Public NotInheritable Class TessaWindowChromeButton
    	Inherits Button
C++ __Копировать
     public ref class TessaWindowChromeButton sealed : public Button
F# __Копировать
     [<SealedAttribute>]
    type TessaWindowChromeButton = 
        class
            inherit Button
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Visual](https://learn.microsoft.com/dotnet/api/system.windows.media.visual) __[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement) __[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement) __[Control](https://learn.microsoft.com/dotnet/api/system.windows.controls.control) __[ContentControl](https://learn.microsoft.com/dotnet/api/system.windows.controls.contentcontrol) __[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase) __[Button](https://learn.microsoft.com/dotnet/api/system.windows.controls.button) __ TessaWindowChromeButton
##  __Конструкторы
[TessaWindowChromeButton](M_Tessa_UI_Windows_TessaWindowChromeButton__ctor.htm)|
Инициализирует новый экземпляр класса TessaWindowChromeButton  
---|---  
##  __Свойства
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[ClickMode](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.clickmode#system-
windows-controls-primitives-buttonbase-clickmode)| Gets or sets when the
[Click](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.click)
event occurs.  
(Унаследован от
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[Command](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.command#system-
windows-controls-primitives-buttonbase-command)| Gets or sets the command to
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[CommandParameter](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.commandparameter#system-
windows-controls-primitives-buttonbase-commandparameter)| Gets or sets the
parameter to pass to the
[Command](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.command#system-
windows-controls-primitives-buttonbase-command) property.  
(Унаследован от
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase))  
[CommandTarget](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.commandtarget#system-
windows-controls-primitives-buttonbase-commandtarget)| Gets or sets the
element on which to raise the specified command.  
(Унаследован от
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase))  
...
(Унаследован от
[Control](https://learn.microsoft.com/dotnet/api/system.windows.controls.control))  
[GeometryHeight](P_Tessa_UI_Windows_TessaWindowChromeButton_GeometryHeight.htm)|
Высота геометрии, которая рисуется внутри кнопки.  
[GeometryWidth](P_Tessa_UI_Windows_TessaWindowChromeButton_GeometryWidth.htm)|
Ширина геометрии, которая рисуется внутри кнопки.  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[IsCancel](https://learn.microsoft.com/dotnet/api/system.windows.controls.button.iscancel#system-
windows-controls-button-iscancel)| Gets or sets a value that indicates whether
a
[Button](https://learn.microsoft.com/dotnet/api/system.windows.controls.button)
is a Cancel button. A user can activate the Cancel button by pressing the ESC
key.  
(Унаследован от
[Button](https://learn.microsoft.com/dotnet/api/system.windows.controls.button))  
[IsDefault](https://learn.microsoft.com/dotnet/api/system.windows.controls.button.isdefault#system-
windows-controls-button-isdefault)| Gets or sets a value that indicates
whether a
[Button](https://learn.microsoft.com/dotnet/api/system.windows.controls.button)
is the default button. A user invokes the default button by pressing the ENTER
key.  
(Унаследован от
[Button](https://learn.microsoft.com/dotnet/api/system.windows.controls.button))  
[IsDefaulted](https://learn.microsoft.com/dotnet/api/system.windows.controls.button.isdefaulted#system-
windows-controls-button-isdefaulted)| Gets a value that indicates whether a
[Button](https://learn.microsoft.com/dotnet/api/system.windows.controls.button)
is the button that is activated when a user presses ENTER.  
(Унаследован от
[Button](https://learn.microsoft.com/dotnet/api/system.windows.controls.button))  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[IsEnabledCore](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.isenabledcore#system-
windows-controls-primitives-buttonbase-isenabledcore)| Gets the value of the
[IsEnabled](https://learn.microsoft.com/dotnet/api/system.windows.contentelement.isenabled#system-
windows-contentelement-isenabled) property.  
(Унаследован от
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase))  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[IsPressed](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.ispressed#system-
windows-controls-primitives-buttonbase-ispressed)| Gets a value that indicates
whether a
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase)
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[OnAccessKey](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onaccesskey#system-
windows-controls-primitives-buttonbase-onaccesskey\(system-windows-input-
accesskeyeventargs\))| Responds when the
[AccessKey](https://learn.microsoft.com/dotnet/api/system.windows.controls.accesstext.accesskey#system-
windows-controls-accesstext-accesskey) for this control is called.  
(Унаследован от
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase))  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnClick](https://learn.microsoft.com/dotnet/api/system.windows.controls.button.onclick#system-
windows-controls-button-onclick)| Called when a
[Button](https://learn.microsoft.com/dotnet/api/system.windows.controls.button)
is clicked.  
(Унаследован от
[Button](https://learn.microsoft.com/dotnet/api/system.windows.controls.button))  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[OnCreateAutomationPeer](https://learn.microsoft.com/dotnet/api/system.windows.controls.button.oncreateautomationpeer#system-
windows-controls-button-oncreateautomationpeer)| Creates an appropriate
[ButtonAutomationPeer](https://learn.microsoft.com/dotnet/api/system.windows.automation.peers.buttonautomationpeer)
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnIsPressedChanged](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onispressedchanged#system-
windows-controls-primitives-buttonbase-onispressedchanged\(system-windows-
dependencypropertychangedeventargs\))| Called when the
[IsPressed](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.ispressed#system-
windows-controls-primitives-buttonbase-ispressed) property changes.  
(Унаследован от
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase))  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnKeyDown](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onkeydown#system-
windows-controls-primitives-buttonbase-onkeydown\(system-windows-input-
keyeventargs\))| Provides class handling for the
[KeyDown](https://learn.microsoft.com/dotnet/api/system.windows.uielement.keydown)
routed event that occurs when the user presses a key while this control has
focus.  
(Унаследован от
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase))  
[OnKeyUp](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onkeyup#system-
windows-controls-primitives-buttonbase-onkeyup\(system-windows-input-
keyeventargs\))| Provides class handling for the
[KeyUp](https://learn.microsoft.com/dotnet/api/system.windows.uielement.keyup)
routed event that occurs when the user releases a key while this control has
focus.  
(Унаследован от
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase))  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnLostKeyboardFocus](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onlostkeyboardfocus#system-
windows-controls-primitives-buttonbase-onlostkeyboardfocus\(system-windows-
input-keyboardfocuschangedeventargs\))| Called when an element loses keyboard
focus.  
(Унаследован от
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase))  
[OnLostMouseCapture](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onlostmousecapture#system-
windows-controls-primitives-buttonbase-onlostmousecapture\(system-windows-
input-mouseeventargs\))| Provides class handling for the
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnMouseEnter](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onmouseenter#system-
windows-controls-primitives-buttonbase-onmouseenter\(system-windows-input-
mouseeventargs\))| Provides class handling for the
[ClickMode](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.clickmode#system-
windows-controls-primitives-buttonbase-clickmode) routed event that occurs
when the mouse enters this control.  
(Унаследован от
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase))  
[OnMouseLeave](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onmouseleave#system-
windows-controls-primitives-buttonbase-onmouseleave\(system-windows-input-
mouseeventargs\))| Provides class handling for the
...
(Унаследован от
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase))  
[OnMouseLeftButtonDown](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onmouseleftbuttondown#system-
windows-controls-primitives-buttonbase-onmouseleftbuttondown\(system-windows-
input-mousebuttoneventargs\))| Provides class handling for the
...
(Унаследован от
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase))  
[OnMouseLeftButtonUp](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onmouseleftbuttonup#system-
windows-controls-primitives-buttonbase-onmouseleftbuttonup\(system-windows-
input-mousebuttoneventargs\))| Provides class handling for the
[MouseLeftButtonUp](https://learn.microsoft.com/dotnet/api/system.windows.uielement.mouseleftbuttonup)
routed event that occurs when the left mouse button is released while the
mouse pointer is over this control.  
(Унаследован от
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase))  
[OnMouseMove](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onmousemove#system-
windows-controls-primitives-buttonbase-onmousemove\(system-windows-input-
mouseeventargs\))| Provides class handling for the
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnRenderSizeChanged](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onrendersizechanged#system-
windows-controls-primitives-buttonbase-onrendersizechanged\(system-windows-
sizechangedinfo\))| Called when the rendered size of a control changes.  
(Унаследован от
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase))  
...
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
##  __Поля
[GeometryHeightProperty](F_Tessa_UI_Windows_TessaWindowChromeButton_GeometryHeightProperty.htm)|
Высота геометрии, которая рисуется внутри кнопки.  
---|---  
[GeometryWidthProperty](F_Tessa_UI_Windows_TessaWindowChromeButton_GeometryWidthProperty.htm)|
Ширина геометрии, которая рисуется внутри кнопки.  
## __Методы расширения
