# PersonalRoleImportExtension - класс
...
C# __Копировать
     public sealed class PersonalRoleImportExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class PersonalRoleImportExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class PersonalRoleImportExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type PersonalRoleImportExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ PersonalRoleImportExtension
##  __Конструкторы
[PersonalRoleImportExtension](M_Tessa_Extensions_Platform_Server_Roles_PersonalRoleImportExtension__ctor.htm)|
Инициализирует новый экземпляр класса PersonalRoleImportExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Roles_PersonalRoleImportExtension_BeforeRequest.htm)|  
(Переопределяет
