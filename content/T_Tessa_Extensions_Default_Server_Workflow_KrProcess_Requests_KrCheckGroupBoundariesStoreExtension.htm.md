# KrCheckGroupBoundariesStoreExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrCheckGroupBoundariesStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class KrCheckGroupBoundariesStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type KrCheckGroupBoundariesStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ KrCheckGroupBoundariesStoreExtension
##  __Конструкторы
[KrCheckGroupBoundariesStoreExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrCheckGroupBoundariesStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrCheckGroupBoundariesStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrCheckGroupBoundariesStoreExtension_BeforeRequest.htm)|
