# PipeRouter - класс
Базовый класс для объекта, выполняющего маршрутизацию сообщений, полученных по
каналу.
## __Definition
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ PipeRouter
Derived
[Tessa.Platform.Pipes.PipeServiceRouter](T_Tessa_Platform_Pipes_PipeServiceRouter.htm)
Implements
    [IPipeRouter](T_Tessa_Platform_Pipes_IPipeRouter.htm)
##  __Конструкторы
[PipeRouter](M_Tessa_Platform_Pipes_PipeRouter__ctor.htm)| Инициализирует
новый экземпляр класса PipeRouter  
---|---  
##  __Методы
...
[TryGetHandlerCoreAsync](M_Tessa_Platform_Pipes_PipeRouter_TryGetHandlerCoreAsync.htm)|
Возвращает объект, выполняющий обработку запроса в канале, или null, если
подходящий объект не зарегистрирован.  
## __Методы расширения
