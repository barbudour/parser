# CardManagerTileExtension - класс
...
C# __Копировать
     public sealed class CardManagerTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class CardManagerTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class CardManagerTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type CardManagerTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ CardManagerTileExtension
##  __Конструкторы
[CardManagerTileExtension](M_Tessa_Extensions_Platform_Client_Tiles_CardManagerTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса CardManagerTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Platform_Client_Tiles_CardManagerTileExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[InitializingLocal](M_Tessa_Extensions_Platform_Client_Tiles_CardManagerTileExtension_InitializingLocal.htm)|  
(Переопределяет
