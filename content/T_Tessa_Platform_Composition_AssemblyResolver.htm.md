...
C++ __Копировать
     public ref class AssemblyResolver sealed : IAssemblyResolver
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ AssemblyResolver
Implements
    [IAssemblyResolver](T_Tessa_Platform_Composition_IAssemblyResolver.htm)
##  __Конструкторы
[AssemblyResolver](M_Tessa_Platform_Composition_AssemblyResolver__ctor.htm)|
Создаёт экземпляр класса с указанием значений его свойств и методов.  
---|---  
## __Свойства
[FilePath](P_Tessa_Platform_Composition_AssemblyResolver_FilePath.htm)|  Путь
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryResolve](M_Tessa_Platform_Composition_AssemblyResolver_TryResolve.htm)|
