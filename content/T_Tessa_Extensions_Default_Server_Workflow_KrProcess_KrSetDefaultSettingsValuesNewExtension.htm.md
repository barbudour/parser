# KrSetDefaultSettingsValuesNewExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrSetDefaultSettingsValuesNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class KrSetDefaultSettingsValuesNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type KrSetDefaultSettingsValuesNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ KrSetDefaultSettingsValuesNewExtension
##  __Конструкторы
[KrSetDefaultSettingsValuesNewExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrSetDefaultSettingsValuesNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrSetDefaultSettingsValuesNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrSetDefaultSettingsValuesNewExtension_AfterRequest.htm)|  
(Переопределяет
