...
C++ __Копировать
    [SerializableAttribute]
    public ref class SchemeException : public Exception
F# __Копировать
     [<SerializableAttribute>]
    type SchemeException = 
        class
            inherit Exception
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __ SchemeException
Derived
[Tessa.Scheme.SchemeInitializationException](T_Tessa_Scheme_SchemeInitializationException.htm)
[Tessa.Scheme.SchemeObjectNotFoundException](T_Tessa_Scheme_SchemeObjectNotFoundException.htm)
[Tessa.Scheme.SchemeOperationException](T_Tessa_Scheme_SchemeOperationException.htm)
[Tessa.Scheme.SchemeSerializationException](T_Tessa_Scheme_SchemeSerializationException.htm)
##  __Конструкторы
[SchemeException()](M_Tessa_Scheme_SchemeException__ctor.htm)| Инициализирует
новый экземпляр класса SchemeException  
---|---  
[SchemeException(String)](M_Tessa_Scheme_SchemeException__ctor_2.htm)|
Инициализирует новый экземпляр класса SchemeException  
[SchemeException(SerializationInfo,
StreamingContext)](M_Tessa_Scheme_SchemeException__ctor_1.htm)| Инициализирует
новый экземпляр класса SchemeException  
[SchemeException(String,
Exception)](M_Tessa_Scheme_SchemeException__ctor_3.htm)| Инициализирует новый
экземпляр класса SchemeException  
##  __Свойства
