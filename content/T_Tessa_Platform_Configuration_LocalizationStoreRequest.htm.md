# LocalizationStoreRequest - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
    ...
    public sealed class LocalizationStoreRequest : StorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class LocalizationStoreRequest
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class LocalizationStoreRequest sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type LocalizationStoreRequest = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ LocalizationStoreRequest
##  __Конструкторы
[LocalizationStoreRequest()](M_Tessa_Platform_Configuration_LocalizationStoreRequest__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[LocalizationStoreRequest(Dictionary<String,
Object>)](M_Tessa_Platform_Configuration_LocalizationStoreRequest__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[LocalizationStoreRequest(IStorageObjectProvider)](M_Tessa_Platform_Configuration_LocalizationStoreRequest__ctor_2.htm)|
...
## __Свойства
[Action](P_Tessa_Platform_Configuration_LocalizationStoreRequest_Action.htm)|  
---|---  
[ID](P_Tessa_Platform_Configuration_LocalizationStoreRequest_ID.htm)|  
[Name](P_Tessa_Platform_Configuration_LocalizationStoreRequest_Name.htm)|  
[Priority](P_Tessa_Platform_Configuration_LocalizationStoreRequest_Priority.htm)|  
## __Методы
