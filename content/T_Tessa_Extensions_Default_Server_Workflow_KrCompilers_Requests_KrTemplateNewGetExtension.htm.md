# KrTemplateNewGetExtension - класс
...
VB __Копировать
     Public MustInherit Class KrTemplateNewGetExtension
    	Inherits CardNewGetExtension
C++ __Копировать
     public ref class KrTemplateNewGetExtension abstract : public CardNewGetExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type KrTemplateNewGetExtension = 
        class
            inherit CardNewGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewGetExtension](T_Tessa_Cards_Extensions_CardNewGetExtension.htm) __ KrTemplateNewGetExtension
Derived
[Tessa.Extensions.Default.Server.Workflow.KrCompilers.Requests.KrSecondaryProcessNewGetExtension](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrSecondaryProcessNewGetExtension.htm)
[Tessa.Extensions.Default.Server.Workflow.KrCompilers.Requests.KrStageTemplateNewGetExtension](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrStageTemplateNewGetExtension.htm)
##  __Конструкторы
[KrTemplateNewGetExtension](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrTemplateNewGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrTemplateNewGetExtension.  
---|---  
## __Методы
