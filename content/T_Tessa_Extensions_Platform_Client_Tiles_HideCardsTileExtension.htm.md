...
C# __Копировать
     public sealed class HideCardsTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class HideCardsTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class HideCardsTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type HideCardsTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ HideCardsTileExtension
##  __Конструкторы
[HideCardsTileExtension](M_Tessa_Extensions_Platform_Client_Tiles_HideCardsTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса HideCardsTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Platform_Client_Tiles_HideCardsTileExtension_InitializingGlobal.htm)|  
(Переопределяет
