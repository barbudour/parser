# INumberQueuePredicateTypeRegistry - интерфейс
...
C# __Копировать
     public interface INumberQueuePredicateTypeRegistry : IRegistry<Guid, NumberQueuePredicateType>
VB __Копировать
     Public Interface INumberQueuePredicateTypeRegistry
    	Inherits IRegistry(Of Guid, NumberQueuePredicateType)
C++ __Копировать
     public interface class INumberQueuePredicateTypeRegistry : IRegistry<Guid, NumberQueuePredicateType^>
F# __Копировать
     type INumberQueuePredicateTypeRegistry = 
        interface
            interface IRegistry<Guid, NumberQueuePredicateType>
        end
Implements
    [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [NumberQueuePredicateType](T_Tessa_Cards_Numbers_NumberQueuePredicateType.htm)>
##  __Методы
