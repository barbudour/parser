...
VB __Копировать
     Public NotInheritable Class ConditionExecutor
    	Implements IConditionExecutor
C++ __Копировать
     public ref class ConditionExecutor sealed : IConditionExecutor
F# __Копировать
     [<SealedAttribute>]
    type ConditionExecutor = 
        class
            interface IConditionExecutor
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ConditionExecutor
Implements
    [IConditionExecutor](T_Tessa_Platform_Conditions_IConditionExecutor.htm)
##  __Конструкторы
[ConditionExecutor](M_Tessa_Platform_Conditions_ConditionExecutor__ctor.htm)|
Инициализирует новый экземпляр класса ConditionExecutor  
---|---  
##  __Методы
[CheckConditionAsync](M_Tessa_Platform_Conditions_ConditionExecutor_CheckConditionAsync.htm)|
