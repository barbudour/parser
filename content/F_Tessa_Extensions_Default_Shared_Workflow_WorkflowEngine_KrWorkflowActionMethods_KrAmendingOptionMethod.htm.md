# KrWorkflowActionMethods.KrAmendingOptionMethod - поле
...
VB __Копировать
     Public Shared ReadOnly KrAmendingOptionMethod As WorkflowActionMethodDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionMethodDescriptor^ KrAmendingOptionMethod
F# __Копировать
     static val KrAmendingOptionMethod: WorkflowActionMethodDescriptor
#### Значение поля
