# KrConstants.KrSecondaryProcesses.TileGroup - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Const TileGroup As String = "TileGroup"
C++ __Копировать
     public:
    literal String^ TileGroup = "TileGroup"
F# __Копировать
     static val mutable TileGroup: string
#### Значение поля
