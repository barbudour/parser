...
##  __Конструкторы
[LazyProcessManager](M_Tessa_Platform_Runtime_LazyProcessManager__ctor.htm)|
Создаёт экземпляр класса с указанием функции, создающей объект
[IProcessManager](T_Tessa_Platform_Runtime_IProcessManager.htm).
Гарантируется, что функция не будет вызвана более одного раза.  
---|---  
## __Методы
[Dispose](M_Tessa_Platform_Runtime_LazyProcessManager_Dispose.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[HasProcessesRunning](M_Tessa_Platform_Runtime_LazyProcessManager_HasProcessesRunning.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[StartProcess](M_Tessa_Platform_Runtime_LazyProcessManager_StartProcess.htm)|
