# KrStagePositionInfo.ShiftedOrder - свойство
...
VB __Копировать
     Public ReadOnly Property ShiftedOrder As Integer?
    	Get
C++ __Копировать
     public:
    property Nullable<int> ShiftedOrder {
    	Nullable<int> get ();
    }
F# __Копировать
     member ShiftedOrder : Nullable<int> with get
#### Значение свойства
