...
C# __Копировать
     public sealed class NumberCloseUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class NumberCloseUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class NumberCloseUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type NumberCloseUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ NumberCloseUIExtension
##  __Конструкторы
[NumberCloseUIExtension](M_Tessa_Extensions_Platform_Client_UI_NumberCloseUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса NumberCloseUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Finalized](M_Tessa_Extensions_Platform_Client_UI_NumberCloseUIExtension_Finalized.htm)|  
(Переопределяет
