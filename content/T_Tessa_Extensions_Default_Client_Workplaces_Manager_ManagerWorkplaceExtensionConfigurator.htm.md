# ManagerWorkplaceExtensionConfigurator - класс
...
VB __Копировать
     Public NotInheritable Class ManagerWorkplaceExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class ManagerWorkplaceExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type ManagerWorkplaceExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ ManagerWorkplaceExtensionConfigurator
##  __Конструкторы
[ManagerWorkplaceExtensionConfigurator](M_Tessa_Extensions_Default_Client_Workplaces_Manager_ManagerWorkplaceExtensionConfigurator__ctor.htm)|
Инициализирует новый экземпляр класса ManagerWorkplaceExtensionConfigurator  
---|---  
##  __Свойства
...
(Унаследован от
[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm))  
[GetConfiguratorFormAsync](M_Tessa_Extensions_Default_Client_Workplaces_Manager_ManagerWorkplaceExtensionConfigurator_GetConfiguratorFormAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialize](M_Tessa_Extensions_Default_Client_Workplaces_Manager_ManagerWorkplaceExtensionConfigurator_Initialize.htm)|
