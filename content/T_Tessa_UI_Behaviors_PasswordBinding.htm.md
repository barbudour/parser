# PasswordBinding - класс
Поведение, добавляющее возможность связать введённый пароль с полем в модели
...
C# __Копировать
     public sealed class PasswordBinding : Behavior<PasswordBox>
VB __Копировать
     Public NotInheritable Class PasswordBinding
    	Inherits Behavior(Of PasswordBox)
C++ __Копировать
     public ref class PasswordBinding sealed : public Behavior<PasswordBox^>
F# __Копировать
     [<SealedAttribute>]
    type PasswordBinding = 
        class
            inherit Behavior<PasswordBox>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[PasswordBox](https://learn.microsoft.com/dotnet/api/system.windows.controls.passwordbox)> __ PasswordBinding
##  __Конструкторы
[PasswordBinding](M_Tessa_UI_Behaviors_PasswordBinding__ctor.htm)|
Инициализирует новый экземпляр класса PasswordBinding  
---|---  
##  __Свойства
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[Text](P_Tessa_UI_Behaviors_PasswordBinding_Text.htm)|  Строка пароля,
привязка которого выполняется.  
## __Методы
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_PasswordBinding_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_PasswordBinding_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_PasswordBinding_OnDetaching.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[TextProperty](F_Tessa_UI_Behaviors_PasswordBinding_TextProperty.htm)|  
---|---  
## __См. также
#### Ссылки
