# PluginImportingResult.RemovedPlugins - свойство
...
C# __Копировать
     public IList<PluginImportingItem> RemovedPlugins { get; }
VB __Копировать
     Public ReadOnly Property RemovedPlugins As IList(Of PluginImportingItem)
    	Get
C++ __Копировать
     public:
    property IList<PluginImportingItem^>^ RemovedPlugins {
    	IList<PluginImportingItem^>^ get ();
    }
F# __Копировать
     member RemovedPlugins : IList<PluginImportingItem> with get
#### Значение свойства
