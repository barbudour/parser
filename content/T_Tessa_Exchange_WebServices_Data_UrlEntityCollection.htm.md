...
VB __Копировать
    <EditorBrowsableAttribute(EditorBrowsableState.Never)>
    Public NotInheritable Class UrlEntityCollection
    	Inherits ComplexPropertyCollection(Of UrlEntity)
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class UrlEntityCollection sealed : public ComplexPropertyCollection<UrlEntity^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type UrlEntityCollection = 
        class
            inherit ComplexPropertyCollection<UrlEntity>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[UrlEntity](T_Tessa_Exchange_WebServices_Data_UrlEntity.htm)> __ UrlEntityCollection
##  __Свойства
