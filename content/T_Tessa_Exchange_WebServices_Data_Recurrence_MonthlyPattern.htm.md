# Recurrence.MonthlyPattern - класс
...
VB __Копировать
     Public NotInheritable Class MonthlyPattern
    	Inherits Recurrence.IntervalPattern
C++ __Копировать
     public ref class MonthlyPattern sealed : public Recurrence.IntervalPattern
F# __Копировать
     [<SealedAttribute>]
    type MonthlyPattern = 
        class
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsSame](M_Tessa_Exchange_WebServices_Data_Recurrence_MonthlyPattern_IsSame.htm)|
