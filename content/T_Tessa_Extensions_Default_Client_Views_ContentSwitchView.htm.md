...
C# __Копировать
     public class ContentSwitchView : UserControl, 
    	IContentItem, INotifyPropertyChanged, IComponentConnector
VB __Копировать
     Public Class ContentSwitchView
    	Inherits UserControl
    	Implements IContentItem, INotifyPropertyChanged, IComponentConnector
C++ __Копировать
     public ref class ContentSwitchView : public UserControl, 
    	IContentItem, INotifyPropertyChanged, IComponentConnector
F# __Копировать
     type ContentSwitchView = 
        class
            inherit UserControl
...
##  __Конструкторы
[ContentSwitchView](M_Tessa_Extensions_Default_Client_Views_ContentSwitchView__ctor.htm)|
Initializes a new instance of the ContentSwitchView class.  
---|---  
## __Свойства
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[Order](P_Tessa_Extensions_Default_Client_Views_ContentSwitchView_Order.htm)|
...
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
Устарело.  
[PlaceAreas](P_Tessa_Extensions_Default_Client_Views_ContentSwitchView_PlaceAreas.htm)|
Gets возвращает область отображения  
[RecordMode](P_Tessa_Extensions_Default_Client_Views_ContentSwitchView_RecordMode.htm)|
...
(Унаследован от
[Control](https://learn.microsoft.com/dotnet/api/system.windows.controls.control))  
[TableMode](P_Tessa_Extensions_Default_Client_Views_ContentSwitchView_TableMode.htm)|
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[GetTemplate](M_Tessa_Extensions_Default_Client_Views_ContentSwitchView_GetTemplate.htm)|
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[InitializeComponent](M_Tessa_Extensions_Default_Client_Views_ContentSwitchView_InitializeComponent.htm)|
InitializeComponent  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[OnPropertyChanged(String)](M_Tessa_Extensions_Default_Client_Views_ContentSwitchView_OnPropertyChanged.htm)|
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[SetContentViewModeAsync](M_Tessa_Extensions_Default_Client_Views_ContentSwitchView_SetContentViewModeAsync.htm)|  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[PropertyChanged](E_Tessa_Extensions_Default_Client_Views_ContentSwitchView_PropertyChanged.htm)|
