# ConditionCardStrictSecurity - класс
...
C# __Копировать
     public sealed class ConditionCardStrictSecurity : CardStrictSecurity
VB __Копировать
     Public NotInheritable Class ConditionCardStrictSecurity
    	Inherits CardStrictSecurity
C++ __Копировать
     public ref class ConditionCardStrictSecurity sealed : public CardStrictSecurity
F# __Копировать
     [<SealedAttribute>]
    type ConditionCardStrictSecurity = 
        class
            inherit CardStrictSecurity
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStrictSecurity](T_Tessa_Extensions_Platform_Server_Cards_CardStrictSecurity.htm) __ ConditionCardStrictSecurity
##  __Конструкторы
[ConditionCardStrictSecurity](M_Tessa_Extensions_Platform_Server_Cards_ConditionCardStrictSecurity__ctor.htm)|
Инициализирует новый экземпляр класса ConditionCardStrictSecurity  
---|---  
##  __Методы
[CheckOnDeleteAsync](M_Tessa_Extensions_Platform_Server_Cards_ConditionCardStrictSecurity_CheckOnDeleteAsync.htm)|
...
---|---  
[CheckOnNewAsync](M_Tessa_Extensions_Platform_Server_Cards_ConditionCardStrictSecurity_CheckOnNewAsync.htm)|
...
[CheckOnStoreAsync](M_Tessa_Extensions_Platform_Server_Cards_ConditionCardStrictSecurity_CheckOnStoreAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[UpdateOnSealedAsync](M_Tessa_Extensions_Platform_Server_Cards_ConditionCardStrictSecurity_UpdateOnSealedAsync.htm)|
...
[UpdateOnStrictSecurityAsync](M_Tessa_Extensions_Platform_Server_Cards_ConditionCardStrictSecurity_UpdateOnStrictSecurityAsync.htm)|
Обновляет доступ к карточке при наличии ограничения
[StrictSecurity](T_Tessa_Platform_Runtime_ConfigurationFlags.htm)  
