# ClientCommandHandlerContext - класс
...
C# __Копировать
     public sealed class ClientCommandHandlerContext : IClientCommandHandlerContext, 
    	IExtensionContext
VB __Копировать
     Public NotInheritable Class ClientCommandHandlerContext
    	Implements IClientCommandHandlerContext, IExtensionContext
C++ __Копировать
     public ref class ClientCommandHandlerContext sealed : IClientCommandHandlerContext, 
    	IExtensionContext
F# __Копировать
     [<SealedAttribute>]
    type ClientCommandHandlerContext = 
        class
            interface IClientCommandHandlerContext
            interface IExtensionContext
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ClientCommandHandlerContext
Implements
    [IClientCommandHandlerContext](T_Tessa_Extensions_Default_Shared_Workflow_KrProcess_ClientCommandInterpreter_IClientCommandHandlerContext.htm), [IExtensionContext](T_Tessa_Extensions_IExtensionContext.htm)
##  __Конструкторы
[ClientCommandHandlerContext](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_ClientCommandInterpreter_ClientCommandHandlerContext__ctor.htm)|
Инициализирует новый экземпляр класса ClientCommandHandlerContext  
---|---  
##  __Свойства
