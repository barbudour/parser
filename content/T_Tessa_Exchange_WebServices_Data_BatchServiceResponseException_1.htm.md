# BatchServiceResponseException<TResponse> \- класс
...
C++ __Копировать
    ...
    where TResponse : ServiceResponse
    public ref class BatchServiceResponseException abstract : public ServiceRemoteException
F# __Копировать
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceRemoteException](T_Tessa_Exchange_WebServices_Data_ServiceRemoteException.htm) __ BatchServiceResponseException<TResponse>
Derived
[Tessa.Exchange.WebServices.Data.CreateAttachmentException](T_Tessa_Exchange_WebServices_Data_CreateAttachmentException.htm)
[Tessa.Exchange.WebServices.Data.DeleteAttachmentException](T_Tessa_Exchange_WebServices_Data_DeleteAttachmentException.htm)
#### Параметры типа
TResponse
    The type of the response.
##  __Конструкторы
[BatchServiceResponseException<TResponse>](M_Tessa_Exchange_WebServices_Data_BatchServiceResponseException_1__ctor.htm)|
Initializes a new instance of the BatchServiceResponseException class with
serialized data.  
---|---  
## __Свойства
