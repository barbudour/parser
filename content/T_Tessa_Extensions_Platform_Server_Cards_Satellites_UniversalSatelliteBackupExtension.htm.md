# UniversalSatelliteBackupExtension - класс
...
C# __Копировать
     public sealed class UniversalSatelliteBackupExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class UniversalSatelliteBackupExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class UniversalSatelliteBackupExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type UniversalSatelliteBackupExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ UniversalSatelliteBackupExtension
##  __Конструкторы
[UniversalSatelliteBackupExtension](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteBackupExtension__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteBackupExtension_AfterRequest.htm)|
