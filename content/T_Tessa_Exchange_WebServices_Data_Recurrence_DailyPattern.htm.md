...
VB __Копировать
     Public NotInheritable Class DailyPattern
    	Inherits Recurrence.IntervalPattern
C++ __Копировать
     public ref class DailyPattern sealed : public Recurrence.IntervalPattern
F# __Копировать
     [<SealedAttribute>]
    type DailyPattern = 
        class
