# CardTaskHistoryGroupTreeNode - класс
##  __Definition
 **Пространство имён:**
[Tessa.Cards.SmartMerge.Nodes](N_Tessa_Cards_SmartMerge_Nodes.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class CardTaskHistoryGroupTreeNode : CardTreeNodeBase
VB __Копировать
     Public Class CardTaskHistoryGroupTreeNode
    	Inherits CardTreeNodeBase
C++ __Копировать
     public ref class CardTaskHistoryGroupTreeNode : public CardTreeNodeBase
F# __Копировать
     type CardTaskHistoryGroupTreeNode = 
        class
            inherit CardTreeNodeBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TreeNodeBase](T_Tessa_SmartMerge_TreeNodeBase_1.htm)<[Card](T_Tessa_Cards_Card.htm)> __[CardTreeNodeBase](T_Tessa_Cards_SmartMerge_Nodes_CardTreeNodeBase.htm) __ CardTaskHistoryGroupTreeNode
##  __Конструкторы
[CardTaskHistoryGroupTreeNode](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryGroupTreeNode__ctor.htm)|
Инициализирует новый экземпляр класса CardTaskHistoryGroupTreeNode  
---|---  
##  __Свойства
...
его.  
(Унаследован от [TreeNodeBase<T>](T_Tessa_SmartMerge_TreeNodeBase_1.htm))  
[Clone](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryGroupTreeNode_Clone.htm)|  
(Переопределяет
[TreeNodeBase<T>.Clone()](M_Tessa_SmartMerge_TreeNodeBase_1_Clone.htm))  
[Equals(ITreeNode<Card>)](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryGroupTreeNode_Equals.htm)|  
(Переопределяет
...
[EqualsByKey](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryGroupTreeNode_EqualsByKey.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetHashCode(Int32)](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryGroupTreeNode_GetHashCode.htm)|
...
[GetMergeResult](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryGroupTreeNode_GetMergeResult.htm)|  
(Переопределяет
...
состояние узла.  
(Унаследован от [TreeNodeBase<T>](T_Tessa_SmartMerge_TreeNodeBase_1.htm))  
[ToString](M_Tessa_Cards_SmartMerge_Nodes_CardTaskHistoryGroupTreeNode_ToString.htm)|  
(Переопределяет
