# ApplicationAttributesResult - класс
...
C# __Копировать
     public sealed class ApplicationAttributesResult : StorageSerializable
VB __Копировать
     Public NotInheritable Class ApplicationAttributesResult
    	Inherits StorageSerializable
C++ __Копировать
     public ref class ApplicationAttributesResult sealed : public StorageSerializable
F# __Копировать
     [<SealedAttribute>]
    type ApplicationAttributesResult = 
        class
            inherit StorageSerializable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageSerializable](T_Tessa_Platform_Storage_StorageSerializable.htm) __ ApplicationAttributesResult
##  __Конструкторы
[ApplicationAttributesResult](M_Tessa_Applications_Synchronization_ApplicationAttributesResult__ctor.htm)|
Инициализирует новый экземпляр класса ApplicationAttributesResult  
---|---  
##  __Свойства
...
(Унаследован от
[StorageSerializable](T_Tessa_Platform_Storage_StorageSerializable.htm))  
[DeserializeCore](M_Tessa_Applications_Synchronization_ApplicationAttributesResult_DeserializeCore.htm)|
Выполняет десериализацию полей объекта из заданного хранилища.  
...
(Унаследован от
[StorageSerializable](T_Tessa_Platform_Storage_StorageSerializable.htm))  
[SerializeCore](M_Tessa_Applications_Synchronization_ApplicationAttributesResult_SerializeCore.htm)|
Выполняет сериализацию полей объекта в заданное хранилище.  
