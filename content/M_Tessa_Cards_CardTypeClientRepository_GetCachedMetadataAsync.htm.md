# CardTypeClientRepository.GetCachedMetadataAsync - метод
...
#### Реализации
[ICardTypeClientRepository.GetCachedMetadataAsync(String,
CancellationToken)](M_Tessa_Cards_ICardTypeClientRepository_GetCachedMetadataAsync.htm)  
##  __Заметки
