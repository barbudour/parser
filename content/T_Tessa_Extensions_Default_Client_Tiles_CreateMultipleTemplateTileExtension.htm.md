# CreateMultipleTemplateTileExtension - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public sealed class CreateMultipleTemplateTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class CreateMultipleTemplateTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class CreateMultipleTemplateTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type CreateMultipleTemplateTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ CreateMultipleTemplateTileExtension
##  __Конструкторы
[CreateMultipleTemplateTileExtension](M_Tessa_Extensions_Default_Client_Tiles_CreateMultipleTemplateTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса CreateMultipleTemplateTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm))  
[InitializingLocal](M_Tessa_Extensions_Default_Client_Tiles_CreateMultipleTemplateTileExtension_InitializingLocal.htm)|  
(Переопределяет
