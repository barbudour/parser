# GetLastQuantEndRequestExtension - методы
##  __Методы
...
##  __См. также
#### Ссылки
[GetLastQuantEndRequestExtension -
](T_Tessa_Extensions_Platform_Server_BusinessCalendar_GetLastQuantEndRequestExtension.htm)
