...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __ CommandException
Derived
[Tessa.Platform.CommandLine.CommandArgumentException](T_Tessa_Platform_CommandLine_CommandArgumentException.htm)
[Tessa.Platform.CommandLine.CommandCanceledException](T_Tessa_Platform_CommandLine_CommandCanceledException.htm)
##  __Конструкторы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Platform_CommandLine_CommandException_GetObjectData.htm)|
