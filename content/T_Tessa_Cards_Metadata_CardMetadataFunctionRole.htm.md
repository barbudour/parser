# CardMetadataFunctionRole - класс
...
C# __Копировать
    ...
    public sealed class CardMetadataFunctionRole : CardSerializableEntryWithCaption
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardMetadataFunctionRole
    	Inherits CardSerializableEntryWithCaption
C++ __Копировать
    [SerializableAttribute]
    public ref class CardMetadataFunctionRole sealed : public CardSerializableEntryWithCaption
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardMetadataFunctionRole = 
        class
            inherit CardSerializableEntryWithCaption
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __[CardSerializableEntry](T_Tessa_Cards_CardSerializableEntry.htm) __[CardSerializableEntryWithCaption](T_Tessa_Cards_CardSerializableEntryWithCaption.htm) __ CardMetadataFunctionRole
##  __Конструкторы
...
## __Свойства
[CanBeDeputy](P_Tessa_Cards_Metadata_CardMetadataFunctionRole_CanBeDeputy.htm)|
Признак того, что в функциональную роль включаются заместители.  
---|---  
[Caption](P_Tessa_Cards_CardSerializableEntryWithCaption_Caption.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[XmlElementNameInternal](P_Tessa_Cards_Metadata_CardMetadataFunctionRole_XmlElementNameInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeAttributeFromXml](M_Tessa_Cards_Metadata_CardMetadataFunctionRole_DeserializeAttributeFromXml.htm)|
Выполняется для каждого атрибута десериализуемого атрибута.  
(Переопределяет
[CardSerializableEntryWithCaption.DeserializeAttributeFromXml(String,
String)](M_Tessa_Cards_CardSerializableEntryWithCaption_DeserializeAttributeFromXml.htm))  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_Metadata_CardMetadataFunctionRole_DeserializeFromBinaryInternal.htm)|
Выполняет десериализацию всех полей текущего объекта из байтового потока.  
(Переопределяет
[CardSerializableEntryWithCaption.DeserializeFromBinaryInternal(BinaryReader)](M_Tessa_Cards_CardSerializableEntryWithCaption_DeserializeFromBinaryInternal.htm))  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_Metadata_CardMetadataFunctionRole_DeserializeFromStorageInternal.htm)|
Выполняет десериализацию объекта и всех его дочерних объектов из хранилища
Dictionary<string, object>.  
(Переопределяет
[CardSerializableEntryWithCaption.DeserializeFromStorageInternal(Dictionary<String,
Object>)](M_Tessa_Cards_CardSerializableEntryWithCaption_DeserializeFromStorageInternal.htm))  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_Metadata_CardMetadataFunctionRole_OnDeserializing.htm)|
Выполняется перед десериализацией объекта и всех его дочерних объектов из
элемента XML.  
(Переопределяет
[CardSerializableEntryWithCaption.OnDeserializing(SerializationMode)](M_Tessa_Cards_CardSerializableEntryWithCaption_OnDeserializing.htm))  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeAttributesToXml](M_Tessa_Cards_Metadata_CardMetadataFunctionRole_SerializeAttributesToXml.htm)|
Выполняет сериализацию текущего объекта в атрибуты XML.  
(Переопределяет
[CardSerializableEntryWithCaption.SerializeAttributesToXml(XmlWriter)](M_Tessa_Cards_CardSerializableEntryWithCaption_SerializeAttributesToXml.htm))  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_Metadata_CardMetadataFunctionRole_SerializeToBinaryInternal.htm)|
Выполняет сериализацию текущего объекта в байтовый поток.  
(Переопределяет
[CardSerializableEntryWithCaption.SerializeToBinaryInternal(BinaryWriter)](M_Tessa_Cards_CardSerializableEntryWithCaption_SerializeToBinaryInternal.htm))  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_Metadata_CardMetadataFunctionRole_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
хранилище Dictionary<string, object>.  
(Переопределяет
[CardSerializableEntryWithCaption.SerializeToStorageInternal(Dictionary<String,
Object>)](M_Tessa_Cards_CardSerializableEntryWithCaption_SerializeToStorageInternal.htm))  
...
(Унаследован от
[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardSerializableEntry_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Унаследован от
[CardSerializableEntry](T_Tessa_Cards_CardSerializableEntry.htm))  
##  __Поля
[XmlElementName](F_Tessa_Cards_Metadata_CardMetadataFunctionRole_XmlElementName.htm)|
Имя XML-элемента.  
---|---  
## __Методы расширения
