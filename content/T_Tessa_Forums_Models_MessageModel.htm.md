...
C++ __Копировать
    [SerializableAttribute]
    public ref class MessageModel : public MessageModelBase
F# __Копировать
     [<SerializableAttribute>]
    type MessageModel = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm) __ MessageModel
##  __Конструкторы
[MessageModel()](M_Tessa_Forums_Models_MessageModel__ctor.htm)| Инициализирует
новый экземпляр класса MessageModel  
---|---  
[MessageModel(Dictionary<String,
Object>)](M_Tessa_Forums_Models_MessageModel__ctor_1.htm)| Инициализирует
новый экземпляр класса MessageModel  
[MessageModel(SerializationInfo,
StreamingContext)](M_Tessa_Forums_Models_MessageModel__ctor_2.htm)|
Инициализирует новый экземпляр класса MessageModel  
##  __Свойства
[Attachments](P_Tessa_Forums_Models_MessageModel_Attachments.htm)|  
---|---  
...
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
[FirstName](P_Tessa_Forums_Models_MessageModel_FirstName.htm)|  
[ID](P_Tessa_Forums_Models_MessageModelBase_ID.htm)|  
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
[LastName](P_Tessa_Forums_Models_MessageModel_LastName.htm)|  
...
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
[Reply](P_Tessa_Forums_Models_MessageModel_Reply.htm)|  
[TopicID](P_Tessa_Forums_Models_MessageModelBase_TopicID.htm)|  
(Унаследован от
[MessageModelBase](T_Tessa_Forums_Models_MessageModelBase.htm))  
[Type](P_Tessa_Forums_Models_MessageModel_Type.htm)|  
## __Методы
