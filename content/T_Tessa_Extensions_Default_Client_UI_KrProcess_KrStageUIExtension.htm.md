...
VB __Копировать
     Public NotInheritable Class KrStageUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrStageUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrStageUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrStageUIExtension
##  __Конструкторы
[KrStageUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrStageUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrStageUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Finalized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrStageUIExtension_Finalized.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrStageUIExtension_Initialized.htm)|
