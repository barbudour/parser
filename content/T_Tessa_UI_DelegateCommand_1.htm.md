...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Command](T_Tessa_UI_Command.htm) __ DelegateCommand<T>
Derived
[Tessa.UI.Cards.CardToolbarItemDelegateCommand<T>](T_Tessa_UI_Cards_CardToolbarItemDelegateCommand_1.htm)
#### Параметры типа
T
##  __Конструкторы
[DelegateCommand<T>](M_Tessa_UI_DelegateCommand_1__ctor.htm)|  Создаёт
экземпляр класса с указанием делегатов, определяющих поведение команды.  
---|---  
## __Методы
[CanExecute](M_Tessa_UI_DelegateCommand_1_CanExecute.htm)| Определяет признак
доступности команды.  
(Переопределяет
...
[Execute](M_Tessa_UI_DelegateCommand_1_Execute.htm)| Выполняет команду с
заданным параметром.  
...
---|---  
##  __Поля
[Empty](F_Tessa_UI_DelegateCommand_1_Empty.htm)|  Экземпляр команды
[DelegateCommand](T_Tessa_UI_DelegateCommand.htm), не выполняющей действий и
всегда являющейся доступной.  
---|---  
## __Методы расширения
