# IFileSignatureCollectionBase<TCollection> \- интерфейс
Базовый интерфейс для коллекции подписей для версии файла.
## __Definition
 **Пространство имён:** [Tessa.Files](N_Tessa_Files.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public interface IFileSignatureCollectionBase<out TCollection> : IFileEntityCollection<IFileSignature, TCollection>, 
...
VB __Копировать
     Public Interface IFileSignatureCollectionBase(Of Out TCollection As {Class, Object, IFileSignatureCollectionBase(Of TCollection)})
    	Inherits IFileEntityCollection(Of IFileSignature, TCollection), IObservableCollectionLookup(Of Guid, IFileSignature, TCollection), 
    	IObservableCollection(Of IFileSignature, TCollection), IList(Of IFileSignature), 
...
C++ __Копировать
    ...
    public interface class IFileSignatureCollectionBase : IFileEntityCollection<IFileSignature^, TCollection>, 
    	IObservableCollectionLookup<Guid, IFileSignature^, TCollection>, IObservableCollection<IFileSignature^, TCollection>, 
    	IList<IFileSignature^>, ICollection<IFileSignature^>, IEnumerable<IFileSignature^>, 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer<Guid, IFileSignature^>, 
    	IControllableCollection<IFileSignature^>
F# __Копировать
     type IFileSignatureCollectionBase<'TCollection when 'TCollection : not struct and Object and IFileSignatureCollectionBase<'TCollection>> = 
        interface
