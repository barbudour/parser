# NumberQueueActionType.FromGuid - метод
...
C# __Копировать
     public static NumberQueueActionType FromGuid(
    	Guid guid
    )
VB __Копировать
     Public Shared Function FromGuid ( 
    	guid As Guid
    ) As NumberQueueActionType
C++ __Копировать
     public:
    static NumberQueueActionType^ FromGuid(
    	Guid guid
    )
F# __Копировать
     static member FromGuid : 
            guid : Guid -> NumberQueueActionType 
#### Параметры
