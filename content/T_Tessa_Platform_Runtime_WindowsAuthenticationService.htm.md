# WindowsAuthenticationService - класс
...
VB __Копировать
     Public NotInheritable Class WindowsAuthenticationService
    	Implements IAuthenticationService
C++ __Копировать
     public ref class WindowsAuthenticationService sealed : IAuthenticationService
F# __Копировать
     [<SealedAttribute>]
    type WindowsAuthenticationService = 
        class
            interface IAuthenticationService
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ WindowsAuthenticationService
Implements
    [IAuthenticationService](T_Tessa_Platform_Runtime_IAuthenticationService.htm)
##  __Конструкторы
[WindowsAuthenticationService](M_Tessa_Platform_Runtime_WindowsAuthenticationService__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[LoginAsync](M_Tessa_Platform_Runtime_WindowsAuthenticationService_LoginAsync.htm)|
