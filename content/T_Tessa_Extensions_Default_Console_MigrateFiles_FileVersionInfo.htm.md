...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FileVersionInfo
##  __Конструкторы
[FileVersionInfo](M_Tessa_Extensions_Default_Console_MigrateFiles_FileVersionInfo__ctor.htm)|
Инициализирует новый экземпляр класса FileVersionInfo  
---|---  
##  __Свойства
[VersionRowID](P_Tessa_Extensions_Default_Console_MigrateFiles_FileVersionInfo_VersionRowID.htm)|  
---|---  
## __Методы
[CreateContext](M_Tessa_Extensions_Default_Console_MigrateFiles_FileVersionInfo_CreateContext.htm)|  
---|---  
