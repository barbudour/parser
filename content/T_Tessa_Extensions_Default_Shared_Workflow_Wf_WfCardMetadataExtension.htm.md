...
C# __Копировать
     public sealed class WfCardMetadataExtension : CardTypeMetadataExtension
VB __Копировать
     Public NotInheritable Class WfCardMetadataExtension
    	Inherits CardTypeMetadataExtension
C++ __Копировать
     public ref class WfCardMetadataExtension sealed : public CardTypeMetadataExtension
F# __Копировать
     [<SealedAttribute>]
    type WfCardMetadataExtension = 
        class
            inherit CardTypeMetadataExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardMetadataExtension](T_Tessa_Cards_Extensions_CardMetadataExtension.htm) __[CardTypeMetadataExtension](T_Tessa_Cards_Extensions_CardTypeMetadataExtension.htm) __ WfCardMetadataExtension
##  __Конструкторы
[WfCardMetadataExtension()](M_Tessa_Extensions_Default_Shared_Workflow_Wf_WfCardMetadataExtension__ctor.htm)|
Инициализирует новый экземпляр класса WfCardMetadataExtension  
---|---  
...
[ModifyTypes](M_Tessa_Extensions_Default_Shared_Workflow_Wf_WfCardMetadataExtension_ModifyTypes.htm)|  
(Переопределяет
