# InheritTimeZonesStoreExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.TimeZones](N_Tessa_Extensions_Platform_Server_TimeZones.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class InheritTimeZonesStoreExtension : CardStoreExtension
VB __Копировать
     Public Class InheritTimeZonesStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class InheritTimeZonesStoreExtension : public CardStoreExtension
F# __Копировать
     type InheritTimeZonesStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ InheritTimeZonesStoreExtension
##  __Конструкторы
[InheritTimeZonesStoreExtension](M_Tessa_Extensions_Platform_Server_TimeZones_InheritTimeZonesStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса InheritTimeZonesStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_TimeZones_InheritTimeZonesStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
