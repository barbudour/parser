# SchemeDbmsSpecificValue<T>.ValueCollection - структура
##  __Definition
 **Пространство имён:** [Tessa.Scheme](N_Tessa_Scheme.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public readonly struct ValueCollection : ICollection<T>, 
    	IEnumerable<T>, IEnumerable
VB __Копировать
     Public Structure ValueCollection
    	Implements ICollection(Of T), IEnumerable(Of T), 
    	IEnumerable
C++ __Копировать
     public value class ValueCollection : ICollection<T>, 
    	IEnumerable<T>, IEnumerable
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) __ SchemeDbmsSpecificValue<T>.ValueCollection
Implements
    [ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<[T](T_Tessa_Scheme_SchemeDbmsSpecificValue_1.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<[T](T_Tessa_Scheme_SchemeDbmsSpecificValue_1.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.ienumerable)
##  __Свойства
[Count](P_Tessa_Scheme_SchemeDbmsSpecificValue_1_ValueCollection_Count.htm)|  
---|---  
[IsReadOnly](P_Tessa_Scheme_SchemeDbmsSpecificValue_1_ValueCollection_IsReadOnly.htm)|  
## __Методы
[Contains](M_Tessa_Scheme_SchemeDbmsSpecificValue_1_ValueCollection_Contains.htm)|  
---|---  
[CopyTo](M_Tessa_Scheme_SchemeDbmsSpecificValue_1_ValueCollection_CopyTo.htm)|  
...
[GetEnumerator](M_Tessa_Scheme_SchemeDbmsSpecificValue_1_ValueCollection_GetEnumerator.htm)|  
