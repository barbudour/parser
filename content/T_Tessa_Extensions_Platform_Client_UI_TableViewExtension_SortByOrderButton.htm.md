...
C# __Копировать
     public sealed class SortByOrderButton : MoveButtonBase
VB __Копировать
     Public NotInheritable Class SortByOrderButton
    	Inherits MoveButtonBase
C++ __Копировать
     public ref class SortByOrderButton sealed : public MoveButtonBase
F# __Копировать
     [<SealedAttribute>]
    type SortByOrderButton = 
        class
            inherit MoveButtonBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NotificationObject](T_Tessa_Platform_NotificationObject.htm) __[MoveButtonBase](T_Tessa_Extensions_Platform_Client_UI_TableViewExtension_MoveButtonBase.htm) __ SortByOrderButton
##  __Конструкторы
[SortByOrderButton](M_Tessa_Extensions_Platform_Client_UI_TableViewExtension_SortByOrderButton__ctor.htm)|
Инициализирует новый экземпляр класса SortByOrderButton  
---|---  
##  __Свойства
