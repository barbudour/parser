...
VB __Копировать
    <EditorBrowsableAttribute(EditorBrowsableState.Never)>
    Public NotInheritable Class ItemIdCollection
    	Inherits ComplexPropertyCollection(Of ItemId)
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class ItemIdCollection sealed : public ComplexPropertyCollection<ItemId^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type ItemIdCollection = 
        class
            inherit ComplexPropertyCollection<ItemId>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[ItemId](T_Tessa_Exchange_WebServices_Data_ItemId.htm)> __ ItemIdCollection
##  __Свойства
