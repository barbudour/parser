...
C# __Копировать
    [RegistratorAttribute(ExtensionStage.AfterPlatform, Tag = RegistratorTag.Client)]
...
##  __Конструкторы
[Registrator](M_Tessa_Extensions_Default_Shared_Notices_Registrator__ctor.htm)|
...
в этом объекте.  
(Унаследован от [RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm))  
[RegisterUnity](M_Tessa_Extensions_Default_Shared_Notices_Registrator_RegisterUnity.htm)|  
(Переопределяет
