# CardTaskCompletionOptionSettings - класс
...
C# __Копировать
    ...
    public sealed class CardTaskCompletionOptionSettings : StorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardTaskCompletionOptionSettings
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTaskCompletionOptionSettings sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardTaskCompletionOptionSettings = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ CardTaskCompletionOptionSettings
##  __Заметки
Для создания экземпляров объекта можно использовать реализации интерфейса
[ICardTaskCompletionOptionSettingsBuilder](T_Tessa_Cards_ICardTaskCompletionOptionSettingsBuilder.htm)
описывающего билдер объектов типа CardTaskCompletionOptionSettings.
##  __Конструкторы
[CardTaskCompletionOptionSettings()](M_Tessa_Cards_CardTaskCompletionOptionSettings__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[CardTaskCompletionOptionSettings(Dictionary<String,
Object>)](M_Tessa_Cards_CardTaskCompletionOptionSettings__ctor_1.htm)| Создаёт
