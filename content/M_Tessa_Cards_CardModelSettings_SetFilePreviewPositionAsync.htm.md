...
C++ __Копировать
     public:
    virtual Task^ SetFilePreviewPositionAsync(
    	CardFilePreviewPosition value, 
...
F# __Копировать
    ...
    *)
    -> Task 
    override SetFilePreviewPositionAsync : 
            value : CardFilePreviewPosition * 
            ?executePropertyChangedAsync : Func<Action, CancellationToken, Task> * 
            ?cancellationToken : CancellationToken 
    (* Defaults:
...
Асинхронная задача.
#### Реализации
[ICardModelSettings.SetFilePreviewPositionAsync(CardFilePreviewPosition,
Func<Action, CancellationToken, Task>,
CancellationToken)](M_Tessa_Cards_ICardModelSettings_SetFilePreviewPositionAsync.htm)  
##  __См. также
#### Ссылки
