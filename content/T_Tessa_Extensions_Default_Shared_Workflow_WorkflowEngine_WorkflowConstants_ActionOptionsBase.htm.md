# WorkflowConstants.ActionOptionsBase - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public MustInherit Class ActionOptionsBase
C++ __Копировать
     public ref class ActionOptionsBase abstract
F# __Копировать
     [<AbstractClassAttribute>]
    type ActionOptionsBase = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ WorkflowConstants.ActionOptionsBase
Derived
[Tessa.Extensions.Default.Shared.Workflow.WorkflowEngine.WorkflowConstants.ActionSeveralTaskTypesOptionsBase](T_Tessa_Extensions_Default_Shared_Workflow_WorkflowEngine_WorkflowConstants_ActionSeveralTaskTypesOptionsBase.htm)
[Tessa.Extensions.Default.Shared.Workflow.WorkflowEngine.WorkflowConstants.KrTaskRegistrationActionOptionsVirtual](T_Tessa_Extensions_Default_Shared_Workflow_WorkflowEngine_WorkflowConstants_KrTaskRegistrationActionOptionsVirtual.htm)
##  __Конструкторы
[WorkflowConstants.ActionOptionsBase](M_Tessa_Extensions_Default_Shared_Workflow_WorkflowEngine_WorkflowConstants_ActionOptionsBase__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowConstants.ActionOptionsBase  
---|---  
##  __Методы
