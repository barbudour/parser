# FileSourceForCardContext - класс
...
C# __Копировать
     public sealed class FileSourceForCardContext
VB __Копировать
     Public NotInheritable Class FileSourceForCardContext
C++ __Копировать
     public ref class FileSourceForCardContext sealed
F# __Копировать
     [<SealedAttribute>]
    type FileSourceForCardContext = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FileSourceForCardContext
##  __Конструкторы
...
---|---  
[ExecuteInContextAsync](M_Tessa_Cards_FileSourceForCardContext_ExecuteInContextAsync.htm)|
