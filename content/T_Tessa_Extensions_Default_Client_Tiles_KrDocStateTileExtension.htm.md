...
C# __Копировать
     public sealed class KrDocStateTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class KrDocStateTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class KrDocStateTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type KrDocStateTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ KrDocStateTileExtension
##  __Конструкторы
[KrDocStateTileExtension](M_Tessa_Extensions_Default_Client_Tiles_KrDocStateTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrDocStateTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_KrDocStateTileExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[InitializingLocal](M_Tessa_Extensions_Default_Client_Tiles_KrDocStateTileExtension_InitializingLocal.htm)|  
(Переопределяет
