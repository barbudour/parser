# CommandOnContainerCellEvent - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Behaviors](N_Tessa_UI_Behaviors.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class CommandOnContainerCellEvent : CommandOnContainerEvent
VB __Копировать
     Public NotInheritable Class CommandOnContainerCellEvent
    	Inherits CommandOnContainerEvent
C++ __Копировать
     public ref class CommandOnContainerCellEvent sealed : public CommandOnContainerEvent
F# __Копировать
     [<SealedAttribute>]
    type CommandOnContainerCellEvent = 
        class
            inherit CommandOnContainerEvent
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[CommandOnEventBehaviorBase](T_Tessa_UI_Behaviors_CommandOnEventBehaviorBase.htm) __[CommandOnContainerEvent](T_Tessa_UI_Behaviors_CommandOnContainerEvent.htm) __ CommandOnContainerCellEvent
##  __Конструкторы
[CommandOnContainerCellEvent](M_Tessa_UI_Behaviors_CommandOnContainerCellEvent__ctor.htm)|
Инициализирует новый экземпляр класса CommandOnContainerCellEvent  
---|---  
##  __Свойства
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_CommandOnContainerCellEvent_CreateInstanceCore.htm)|  
(Переопределяет
[CommandOnContainerEvent.CreateInstanceCore()](M_Tessa_UI_Behaviors_CommandOnContainerEvent_CreateInstanceCore.htm))  
...
(Унаследован от
[CommandOnContainerEvent](T_Tessa_UI_Behaviors_CommandOnContainerEvent.htm))  
[ExecuteCommandOverride](M_Tessa_UI_Behaviors_CommandOnContainerCellEvent_ExecuteCommandOverride.htm)|  
(Переопределяет
[CommandOnContainerEvent.ExecuteCommandOverride(DependencyObject)](M_Tessa_UI_Behaviors_CommandOnContainerEvent_ExecuteCommandOverride.htm))  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[GetRequiredType](M_Tessa_UI_Behaviors_CommandOnContainerCellEvent_GetRequiredType.htm)|  
(Переопределяет
[CommandOnContainerEvent.GetRequiredType(Int32)](M_Tessa_UI_Behaviors_CommandOnContainerEvent_GetRequiredType.htm))  
[GetRequiredTypeCount](M_Tessa_UI_Behaviors_CommandOnContainerCellEvent_GetRequiredTypeCount.htm)|  
(Переопределяет
[CommandOnContainerEvent.GetRequiredTypeCount()](M_Tessa_UI_Behaviors_CommandOnContainerEvent_GetRequiredTypeCount.htm))  
...
(Унаследован от
[CommandOnContainerEvent](T_Tessa_UI_Behaviors_CommandOnContainerEvent.htm))  
[HandleEventOverride](M_Tessa_UI_Behaviors_CommandOnContainerCellEvent_HandleEventOverride.htm)|  
(Переопределяет [CommandOnContainerEvent.HandleEventOverride(Object,
RoutedEventArgs)](M_Tessa_UI_Behaviors_CommandOnContainerEvent_HandleEventOverride.htm))  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_CommandOnContainerCellEvent_OnAttached.htm)|  
(Переопределяет
[CommandOnContainerEvent.OnAttached()](M_Tessa_UI_Behaviors_CommandOnContainerEvent_OnAttached.htm))  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_CommandOnContainerCellEvent_OnDetaching.htm)|  
(Переопределяет
[CommandOnContainerEvent.OnDetaching()](M_Tessa_UI_Behaviors_CommandOnContainerEvent_OnDetaching.htm))  
