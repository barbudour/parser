...
VB __Копировать
     Public Interface ICardRequestExtensionContext
    	Inherits ICardRequestExtensionContext(Of CardRequest, CardResponse), ICardExtensionContext, 
    	ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
C++ __Копировать
     public interface class ICardRequestExtensionContext : ICardRequestExtensionContext<CardRequest^, CardResponse^>, 
    	ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
F# __Копировать
     type ICardRequestExtensionContext = 
        interface
