# ScanSource - класс
Контракт источника сканирования - сервиса сканирования
## __Definition
 **Пространство имён:** [Tessa.Host](N_Tessa_Host.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class ScanSource : StorageObject, 
    	IScanSource, IEquatable<IScanSource>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class ScanSource
    	Inherits StorageObject
    	Implements IScanSource, IEquatable(Of IScanSource)
C++ __Копировать
    [SerializableAttribute]
    public ref class ScanSource sealed : public StorageObject, 
    	IScanSource, IEquatable<IScanSource^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ScanSource
Implements
...
##  __Конструкторы
[ScanSource()](M_Tessa_Host_ScanSource__ctor.htm)|  Создаёт экземпляр класса и
пустое хранилище Dictionary<string, object>, декоратором для которого является
создаваемый объект.  
---|---  
[ScanSource(Dictionary<String, Object>)](M_Tessa_Host_ScanSource__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[ScanSource(IScanSource)](M_Tessa_Host_ScanSource__ctor_3.htm)| Инициализирует
новый экземпляр класса ScanSource  
[ScanSource(IStorageObjectProvider)](M_Tessa_Host_ScanSource__ctor_4.htm)|
...
[ScanSource(Int32, String, String,
String)](M_Tessa_Host_ScanSource__ctor_2.htm)| Инициализирует новый экземпляр
класса ScanSource  
##  __Свойства
[DriverVersion](P_Tessa_Host_ScanSource_DriverVersion.htm)|  Версия драйвера
для сканера.  
---|---  
[ID](P_Tessa_Host_ScanSource_ID.htm)|  Идентификатор источника  
[Name](P_Tessa_Host_ScanSource_Name.htm)|  Имя драйвера для сканера.  
[ProtocolVersion](P_Tessa_Host_ScanSource_ProtocolVersion.htm)|  Версия
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Equals(IScanSource)](M_Tessa_Host_ScanSource_Equals_1.htm)| Indicates whether
the current object is equal to another object of the same type.  
[Equals(Object)](M_Tessa_Host_ScanSource_Equals.htm)|  
(Переопределяет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[GetHashCode](M_Tessa_Host_ScanSource_GetHashCode.htm)| Serves as the default
hash function.  
(Переопределяет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
##  __Поля
[DriverVersionKey](F_Tessa_Host_ScanSource_DriverVersionKey.htm)|  
---|---  
[IDKey](F_Tessa_Host_ScanSource_IDKey.htm)|  
[ItemFactory](F_Tessa_Host_ScanSource_ItemFactory.htm)|  
[NameKey](F_Tessa_Host_ScanSource_NameKey.htm)|  
[ProtocolVersionKey](F_Tessa_Host_ScanSource_ProtocolVersionKey.htm)|  
## __Методы расширения
