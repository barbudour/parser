...
VB __Копировать
     Public Class CycleGrouping
    	Inherits FileGrouping
C++ __Копировать
     public ref class CycleGrouping : public FileGrouping
F# __Копировать
     type CycleGrouping = 
        class
...
## __Конструкторы
[CycleGrouping](M_Tessa_Extensions_Default_Client_Files_CycleGrouping__ctor.htm)|
Инициализирует новый экземпляр класса CycleGrouping  
---|---  
##  __Свойства
...
(Унаследован от [ViewModel<TModel>](T_Tessa_UI_ViewModel_1.htm))  
##  __Методы
[Attach](M_Tessa_Extensions_Default_Client_Files_CycleGrouping_Attach.htm)|  
(Переопределяет
[FileControlObject.Attach(IFileViewModel)](M_Tessa_UI_Files_FileControlObject_Attach.htm))  
---|---  
[Detach](M_Tessa_Extensions_Default_Client_Files_CycleGrouping_Detach.htm)|  
(Переопределяет
[FileControlObject.Detach(IFileViewModel)](M_Tessa_UI_Files_FileControlObject_Detach.htm))  
...
[GetGroupInfoCore](M_Tessa_Extensions_Default_Client_Files_CycleGrouping_GetGroupInfoCore.htm)|  
(Переопределяет
...
(Унаследован от [FileControlObject](T_Tessa_UI_Files_FileControlObject.htm))  
##  __Поля
[CycleGroupName](F_Tessa_Extensions_Default_Client_Files_CycleGrouping_CycleGroupName.htm)|  
---|---  
[DocumentsOnApprovalGroupName](F_Tessa_Extensions_Default_Client_Files_CycleGrouping_DocumentsOnApprovalGroupName.htm)|
