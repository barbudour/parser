# OpenForumContextMenuViewExtensionConfigurator - класс
...
C# __Копировать
     public sealed class OpenForumContextMenuViewExtensionConfigurator : ExtensionSettingsConfiguratorBase
VB __Копировать
     Public NotInheritable Class OpenForumContextMenuViewExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class OpenForumContextMenuViewExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type OpenForumContextMenuViewExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ OpenForumContextMenuViewExtensionConfigurator
##  __Конструкторы
[OpenForumContextMenuViewExtensionConfigurator](M_Tessa_Extensions_Default_Client_Forums_OpenForumContextMenuViewExtensionConfigurator__ctor.htm)|
Инициализирует новый экземпляр класса
OpenForumContextMenuViewExtensionConfigurator  
---|---  
##  __Свойства
