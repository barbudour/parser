# FunctionRoleDeleteExtension - класс
...
C# __Копировать
     public sealed class FunctionRoleDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class FunctionRoleDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class FunctionRoleDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type FunctionRoleDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ FunctionRoleDeleteExtension
##  __Конструкторы
[FunctionRoleDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_FunctionRoleDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса FunctionRoleDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_FunctionRoleDeleteExtension_BeforeRequest.htm)|  
(Переопределяет
