...
C# __Копировать
    ...
    public sealed class UserCipherInfoObject : InfoStorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class UserCipherInfoObject
    	Inherits InfoStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class UserCipherInfoObject sealed : public InfoStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type UserCipherInfoObject = 
        class
            inherit InfoStorageObject
            interface ICloneable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm) __ UserCipherInfoObject
Implements
    [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable)
##  __Конструкторы
[UserCipherInfoObject()](M_Tessa_Platform_Runtime_UserCipherInfoObject__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[UserCipherInfoObject(Dictionary<String,
Object>)](M_Tessa_Platform_Runtime_UserCipherInfoObject__ctor_1.htm)| Создаёт
экземпляр класса с указанием хранилища, декоратором для которого является
создаваемый объект.  
[UserCipherInfoObject(IStorageObjectProvider)](M_Tessa_Platform_Runtime_UserCipherInfoObject__ctor_2.htm)|
...
(Унаследован от
[InfoStorageObject](T_Tessa_Platform_Storage_InfoStorageObject.htm))  
[IsEncrypted](P_Tessa_Platform_Runtime_UserCipherInfoObject_IsEncrypted.htm)|
Признак того, что некоторые данные в объекте зашифрованы, в т.ч. ключи
[LocalPrivateKeys](P_Tessa_Platform_Runtime_UserCipherInfoObject_LocalPrivateKeys.htm).  
[LocalExpiryDates](P_Tessa_Platform_Runtime_UserCipherInfoObject_LocalExpiryDates.htm)|
Список дат истечения срока действия закрытых ключей, каждый элемент
соответствует элементу в списке
[LocalPrivateKeys](P_Tessa_Platform_Runtime_UserCipherInfoObject_LocalPrivateKeys.htm).
По умолчанию пустой.  
[LocalPrivateKeys](P_Tessa_Platform_Runtime_UserCipherInfoObject_LocalPrivateKeys.htm)|
Список закрытых ключей, используемых для шифрования файлов локально на
компьютере пользователя. Каждый ключ имеет размер 16 байт -
[LocalPrivateKeyLength](F_Tessa_Platform_Runtime_UserCipherInfoObject_LocalPrivateKeyLength.htm).
Если ключи не зашифрованы, то каждый элемент списка является ключом и имеет
соответствующий срок действия в списке
[LocalExpiryDates](P_Tessa_Platform_Runtime_UserCipherInfoObject_LocalExpiryDates.htm).
Если ключи зашифрованы (свойство
[IsEncrypted](P_Tessa_Platform_Runtime_UserCipherInfoObject_IsEncrypted.htm)
равно true), то список содержит единственное значение, содержащее все ключи в
зашифрованном виде. По умолчанию список пуст.  
[Nonce](P_Tessa_Platform_Runtime_UserCipherInfoObject_Nonce.htm)|  Уникальный
вектор инициализации для расшифровки ключей
[LocalPrivateKeys](P_Tessa_Platform_Runtime_UserCipherInfoObject_LocalPrivateKeys.htm).
Значение равно null, если ключи не зашифрованы.  
[Tag](P_Tessa_Platform_Runtime_UserCipherInfoObject_Tag.htm)|  Подпись
зашифрованных ключей. Проверяется при дешифровке. Значение равно null, если
ключи не зашифрованы.  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Platform_Runtime_UserCipherInfoObject_Clone.htm)|  Выполняет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Platform_Runtime_UserCipherInfoObject_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[RepairStorage](M_Tessa_Platform_Runtime_UserCipherInfoObject_RepairStorage.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetLocalExpiryDates](M_Tessa_Platform_Runtime_UserCipherInfoObject_TryGetLocalExpiryDates.htm)|
Возвращает список попыток неудачного входа, которые образуют серию, или null,
если список ещё не был задан. Очищается при успешном входе. По умолчанию null.  
[TryGetLocalPrivateKeys](M_Tessa_Platform_Runtime_UserCipherInfoObject_TryGetLocalPrivateKeys.htm)|
Возвращает список объектов с информацией по хешам предыдущих паролей, которые
были изменены пользователями, или null, если список ещё не был задан. Каждый
ключ имеет размер 16 байт -
[LocalPrivateKeyLength](F_Tessa_Platform_Runtime_UserCipherInfoObject_LocalPrivateKeyLength.htm).
По умолчанию null.  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
##  __Поля
[LocalExpiryDatesKey](F_Tessa_Platform_Runtime_UserCipherInfoObject_LocalExpiryDatesKey.htm)|  
---|---  
[LocalPrivateKeyLength](F_Tessa_Platform_Runtime_UserCipherInfoObject_LocalPrivateKeyLength.htm)|
Размер ключа для шифрования файлов локально на компьютере пользователя. По
умолчанию равен 16 байт.  
[LocalPrivateKeysKey](F_Tessa_Platform_Runtime_UserCipherInfoObject_LocalPrivateKeysKey.htm)|  
[NonceKey](F_Tessa_Platform_Runtime_UserCipherInfoObject_NonceKey.htm)|  
[TagKey](F_Tessa_Platform_Runtime_UserCipherInfoObject_TagKey.htm)|  
## __Методы расширения
