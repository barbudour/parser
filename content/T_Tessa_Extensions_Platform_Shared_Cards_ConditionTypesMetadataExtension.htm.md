# ConditionTypesMetadataExtension - класс
...
C# __Копировать
     public sealed class ConditionTypesMetadataExtension : CardTypeMetadataExtension
VB __Копировать
     Public NotInheritable Class ConditionTypesMetadataExtension
    	Inherits CardTypeMetadataExtension
C++ __Копировать
     public ref class ConditionTypesMetadataExtension sealed : public CardTypeMetadataExtension
F# __Копировать
     [<SealedAttribute>]
    type ConditionTypesMetadataExtension = 
        class
            inherit CardTypeMetadataExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardMetadataExtension](T_Tessa_Cards_Extensions_CardMetadataExtension.htm) __[CardTypeMetadataExtension](T_Tessa_Cards_Extensions_CardTypeMetadataExtension.htm) __ ConditionTypesMetadataExtension
##  __Конструкторы
[ConditionTypesMetadataExtension](M_Tessa_Extensions_Platform_Shared_Cards_ConditionTypesMetadataExtension__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ModifyMetadata](M_Tessa_Extensions_Platform_Shared_Cards_ConditionTypesMetadataExtension_ModifyMetadata.htm)|
