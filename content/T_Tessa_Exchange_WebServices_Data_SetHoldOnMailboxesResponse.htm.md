# SetHoldOnMailboxesResponse - класс
...
C++ __Копировать
     public ref class SetHoldOnMailboxesResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ SetHoldOnMailboxesResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[HoldResult](P_Tessa_Exchange_WebServices_Data_SetHoldOnMailboxesResponse_HoldResult.htm)|
Mailbox hold result  
