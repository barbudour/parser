# CompletionOptionNewExtension - класс
...
C# __Копировать
     public sealed class CompletionOptionNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class CompletionOptionNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class CompletionOptionNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type CompletionOptionNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ CompletionOptionNewExtension
##  __Конструкторы
[CompletionOptionNewExtension](M_Tessa_Extensions_Platform_Server_Cards_CompletionOptionNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса CompletionOptionNewExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_CompletionOptionNewExtension_BeforeRequest.htm)|  
(Переопределяет
