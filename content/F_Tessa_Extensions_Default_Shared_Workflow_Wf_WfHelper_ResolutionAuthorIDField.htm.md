# WfHelper.ResolutionAuthorIDField - поле
...
VB __Копировать
     Public Const ResolutionAuthorIDField As String = "AuthorID"
C++ __Копировать
     public:
    literal String^ ResolutionAuthorIDField = "AuthorID"
F# __Копировать
     static val mutable ResolutionAuthorIDField: string
#### Значение поля
