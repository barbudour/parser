# CardExtensions.WhenMethod(IExtensionPolicyContainer, CardStoreMethod[]) -
метод
...
C++ __Копировать
    ...
    static IExtensionPolicyContainer^ WhenMethod(
    	...
    	... array<CardStoreMethod>^ methods
    )
F# __Копировать
     [<ExtensionAttribute>]
    static member WhenMethod : 
            policyContainer : IExtensionPolicyContainer * 
            methods : CardStoreMethod[] -> IExtensionPolicyContainer 
#### Параметры
policyContainer
...
methods [CardStoreMethod](T_Tessa_Cards_CardStoreMethod.htm)[]
