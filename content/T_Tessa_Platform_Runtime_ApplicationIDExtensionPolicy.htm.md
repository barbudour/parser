# ApplicationIDExtensionPolicy - класс
...
C# __Копировать
     public sealed class ApplicationIDExtensionPolicy : IApplicationExtensionPolicy, 
    	IExtensionPolicy
VB __Копировать
     Public NotInheritable Class ApplicationIDExtensionPolicy
    	Implements IApplicationExtensionPolicy, IExtensionPolicy
C++ __Копировать
     public ref class ApplicationIDExtensionPolicy sealed : IApplicationExtensionPolicy, 
    	IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type ApplicationIDExtensionPolicy = 
        class
            interface IApplicationExtensionPolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ApplicationIDExtensionPolicy
Implements
...
## __Конструкторы
[ApplicationIDExtensionPolicy](M_Tessa_Platform_Runtime_ApplicationIDExtensionPolicy__ctor.htm)|
Создаёт экземпляр класса с указанием списка допустимых идентификаторов типов
приложений для выполнения методов расширения.  
---|---  
## __Свойства
[IsAllowAny](P_Tessa_Platform_Runtime_ApplicationIDExtensionPolicy_IsAllowAny.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsAllowed](M_Tessa_Platform_Runtime_ApplicationIDExtensionPolicy_IsAllowed.htm)|
