# StrictSecurityStorageGetExtension - класс
...
C# __Копировать
     public sealed class StrictSecurityStorageGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class StrictSecurityStorageGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class StrictSecurityStorageGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type StrictSecurityStorageGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ StrictSecurityStorageGetExtension
##  __Конструкторы
[StrictSecurityStorageGetExtension](M_Tessa_Extensions_Platform_Server_Cards_StrictSecurityStorageGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса StrictSecurityStorageGetExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_StrictSecurityStorageGetExtension_BeforeRequest.htm)|  
(Переопределяет
