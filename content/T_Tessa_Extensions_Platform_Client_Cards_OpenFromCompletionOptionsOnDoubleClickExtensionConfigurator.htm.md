# OpenFromCompletionOptionsOnDoubleClickExtensionConfigurator - класс
...
C# __Копировать
     public sealed class OpenFromCompletionOptionsOnDoubleClickExtensionConfigurator : ExtensionSettingsConfiguratorBase
VB __Копировать
     Public NotInheritable Class OpenFromCompletionOptionsOnDoubleClickExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class OpenFromCompletionOptionsOnDoubleClickExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type OpenFromCompletionOptionsOnDoubleClickExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ OpenFromCompletionOptionsOnDoubleClickExtensionConfigurator
##  __Конструкторы
[OpenFromCompletionOptionsOnDoubleClickExtensionConfigurator](M_Tessa_Extensions_Platform_Client_Cards_OpenFromCompletionOptionsOnDoubleClickExtensionConfigurator__ctor.htm)|
