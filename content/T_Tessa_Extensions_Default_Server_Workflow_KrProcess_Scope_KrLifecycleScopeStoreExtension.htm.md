# KrLifecycleScopeStoreExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrLifecycleScopeStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class KrLifecycleScopeStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type KrLifecycleScopeStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ KrLifecycleScopeStoreExtension
##  __Конструкторы
[KrLifecycleScopeStoreExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Scope_KrLifecycleScopeStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrLifecycleScopeStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Scope_KrLifecycleScopeStoreExtension_AfterBeginTransaction.htm)|
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Scope_KrLifecycleScopeStoreExtension_AfterRequest.htm)|
...
[AfterRequestFinally](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Scope_KrLifecycleScopeStoreExtension_AfterRequestFinally.htm)|
