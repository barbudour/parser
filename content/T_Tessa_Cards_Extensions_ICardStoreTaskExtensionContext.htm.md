...
VB __Копировать
     Public Interface ICardStoreTaskExtensionContext
    	Inherits ICardTaskExtensionContext, ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, 
    	ITraceableExtensionContext
C++ __Копировать
     public interface class ICardStoreTaskExtensionContext : ICardTaskExtensionContext, 
    	ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext
F# __Копировать
     type ICardStoreTaskExtensionContext = 
        interface
