# CardStorageObject - класс
Базовый класс для объектов карточек, являющихся декораторами для хранилища.
## __Definition
 **Пространство имён:** [Tessa.Cards](N_Tessa_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public abstract class CardStorageObject : ValidationStorageObject, 
    	IStorageCleanable
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class CardStorageObject
    	Inherits ValidationStorageObject
    	Implements IStorageCleanable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardStorageObject abstract : public ValidationStorageObject, 
    	IStorageCleanable
F# __Копировать
     [<AbstractClassAttribute>]
    [<SerializableAttribute>]
    type CardStorageObject = 
        class
            inherit ValidationStorageObject
            interface IStorageCleanable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __ CardStorageObject
Derived
[Tessa.Cards.CardAutocompleteInfo](T_Tessa_Cards_CardAutocompleteInfo.htm)
[Tessa.Cards.CardFileContentMapping](T_Tessa_Cards_CardFileContentMapping.htm)
[Tessa.Cards.CardFileContentSource](T_Tessa_Cards_CardFileContentSource.htm)
[Tessa.Cards.CardFileVersion](T_Tessa_Cards_CardFileVersion.htm)
[Tessa.Cards.CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm)
[Tessa.Cards.CardPermissionInfo](T_Tessa_Cards_CardPermissionInfo.htm)
[Tessa.Cards.CardRowPermissionInfo](T_Tessa_Cards_CardRowPermissionInfo.htm)
[Tessa.Cards.CardSection](T_Tessa_Cards_CardSection.htm)
[Tessa.Cards.CardSectionPermissionInfo](T_Tessa_Cards_CardSectionPermissionInfo.htm)
[Tessa.Cards.ComponentModel.CardHeader](T_Tessa_Cards_ComponentModel_CardHeader.htm)
[Tessa.Cards.Numbers.NumberControlRequest](T_Tessa_Cards_Numbers_NumberControlRequest.htm)
[Tessa.Extensions.Default.Shared.Cards.CardViewControlInfo](T_Tessa_Extensions_Default_Shared_Cards_CardViewControlInfo.htm)
[Tessa.Extensions.Default.Shared.Workflow.KrProcess.KrToken](T_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrToken.htm)
Подробнее __Less __
Implements
...
поддерживающий валидацию свойств и очистку хранилища от избыточных данных.
## __Конструкторы
