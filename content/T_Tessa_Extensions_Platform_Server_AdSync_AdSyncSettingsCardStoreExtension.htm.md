# AdSyncSettingsCardStoreExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.AdSync](N_Tessa_Extensions_Platform_Server_AdSync.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class AdSyncSettingsCardStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class AdSyncSettingsCardStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class AdSyncSettingsCardStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type AdSyncSettingsCardStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ AdSyncSettingsCardStoreExtension
##  __Конструкторы
[AdSyncSettingsCardStoreExtension](M_Tessa_Extensions_Platform_Server_AdSync_AdSyncSettingsCardStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса AdSyncSettingsCardStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_AdSync_AdSyncSettingsCardStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
