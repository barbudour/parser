...
C# __Копировать
     public sealed class KrTemplateUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class KrTemplateUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrTemplateUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrTemplateUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrTemplateUIExtension
##  __Конструкторы
[KrTemplateUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrTemplateUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrTemplateUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrTemplateUIExtension_Initialized.htm)|  
(Переопределяет
