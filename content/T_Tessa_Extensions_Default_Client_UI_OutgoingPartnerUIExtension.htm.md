# OutgoingPartnerUIExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Class OutgoingPartnerUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class OutgoingPartnerUIExtension : public CardUIExtension
F# __Копировать
     type OutgoingPartnerUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ OutgoingPartnerUIExtension
##  __Конструкторы
[OutgoingPartnerUIExtension](M_Tessa_Extensions_Default_Client_UI_OutgoingPartnerUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса OutgoingPartnerUIExtension  
---|---  
##  __Методы
...
(Унаследован от [CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm))  
[Initializing](M_Tessa_Extensions_Default_Client_UI_OutgoingPartnerUIExtension_Initializing.htm)|  
(Переопределяет
