# SealableObservableCollection<T> \- класс
...
F# __Копировать
     [<SerializableAttribute>]
    type SealableObservableCollection<'T> = 
        class
...
Derived
[Tessa.Platform.Collections.SealableObjectObservableCollection<T>](T_Tessa_Platform_Collections_SealableObjectObservableCollection_1.htm)
Implements
...
##  __Конструкторы
[SealableObservableCollection<T>()](M_Tessa_Platform_Collections_SealableObservableCollection_1__ctor.htm)|
Создаёт экземпляр класса с параметрами по умолчанию.  
---|---  
[SealableObservableCollection<T>(Boolean)](M_Tessa_Platform_Collections_SealableObservableCollection_1__ctor_1.htm)|
Создаёт экземпляр класса с указанием признака того, что объект должен быть
защищён от изменений.  
[SealableObservableCollection<T>(IEnumerable<T>)](M_Tessa_Platform_Collections_SealableObservableCollection_1__ctor_2.htm)|
Создаёт экземпляр класса с указанием коллекции элементов, используемой для
инициализации списка.  
[SealableObservableCollection<T>(List<T>)](M_Tessa_Platform_Collections_SealableObservableCollection_1__ctor_4.htm)|
Создаёт экземпляр класса с указанием списка элементов, используемого для
инициализации списка.  
[SealableObservableCollection<T>(IEnumerable<T>,
Boolean)](M_Tessa_Platform_Collections_SealableObservableCollection_1__ctor_3.htm)|
Создаёт экземпляр класса с указанием коллекции элементов, используемой для
инициализации списка, и признака того, что объект должен быть защищён от
изменений.  
[SealableObservableCollection<T>(List<T>,
Boolean)](M_Tessa_Platform_Collections_SealableObservableCollection_1__ctor_5.htm)|
Создаёт экземпляр класса с указанием списка элементов, используемого для
инициализации списка, и признака того, что объект должен быть защищён от
изменений.  
## __Свойства
...
(Унаследован от
[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<T>)  
[InsertItem](M_Tessa_Platform_Collections_SealableObservableCollection_1_InsertItem.htm)|
...
[SealInternal](M_Tessa_Platform_Collections_SealableObservableCollection_1_SealInternal.htm)|
Защищает объект от изменений.
Метод может быть переопределён в классах-наследниках.  
[SetItem](M_Tessa_Platform_Collections_SealableObservableCollection_1_SetItem.htm)|
