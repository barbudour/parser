# ServerInstanceGetExtension - класс
...
C# __Копировать
     public sealed class ServerInstanceGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class ServerInstanceGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class ServerInstanceGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type ServerInstanceGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ ServerInstanceGetExtension
##  __Конструкторы
[ServerInstanceGetExtension](M_Tessa_Extensions_Platform_Server_Cards_ServerInstanceGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса ServerInstanceGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_ServerInstanceGetExtension_AfterRequest.htm)|  
(Переопределяет
...
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
##  __Поля
[SourcesKey](F_Tessa_Extensions_Platform_Server_Cards_ServerInstanceGetExtension_SourcesKey.htm)|  
---|---  
## __Методы расширения
