# KrConstants.KrProcessManagementStageSettingsVirtual.ManagePrimaryProcess -
поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly ManagePrimaryProcess As String
C++ __Копировать
     public:
    static initonly String^ ManagePrimaryProcess
F# __Копировать
     static val ManagePrimaryProcess: string
#### Значение поля
