# KrPermissionSectionSettings.MandatoryFields - свойство
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public HashSet<Guid> MandatoryFields { get; set; }
VB __Копировать
     Public Property MandatoryFields As HashSet(Of Guid)
    	Get
    	Set
C++ __Копировать
     public:
    property HashSet<Guid>^ MandatoryFields {
    	HashSet<Guid>^ get ();
    	void set (HashSet<Guid>^ value);
    }
F# __Копировать
     member MandatoryFields : HashSet<Guid> with get, set
#### Значение свойства
