# ActionHistoryGetFileExtension - класс
...
C# __Копировать
     public sealed class ActionHistoryGetFileExtension : CardGetFileContentExtension
VB __Копировать
     Public NotInheritable Class ActionHistoryGetFileExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class ActionHistoryGetFileExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type ActionHistoryGetFileExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ ActionHistoryGetFileExtension
##  __Конструкторы
[ActionHistoryGetFileExtension](M_Tessa_Extensions_Platform_Server_Cards_ActionHistoryGetFileExtension__ctor.htm)|
Инициализирует новый экземпляр класса ActionHistoryGetFileExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_ActionHistoryGetFileExtension_AfterRequest.htm)|  
(Переопределяет
