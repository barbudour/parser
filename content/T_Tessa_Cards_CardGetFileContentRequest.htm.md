# CardGetFileContentRequest - класс
...
C# __Копировать
    ...
    public sealed class CardGetFileContentRequest : CardFileRequestBase, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardGetFileContentRequest
    	Inherits CardFileRequestBase
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardGetFileContentRequest sealed : public CardFileRequestBase, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardGetFileContentRequest = 
        class
            inherit CardFileRequestBase
            interface ICloneable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm) __[CardRequestBase](T_Tessa_Cards_CardRequestBase.htm) __[CardFileRequestBase](T_Tessa_Cards_CardFileRequestBase.htm) __ CardGetFileContentRequest
Implements
    [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable)
##  __Конструкторы
[CardGetFileContentRequest()](M_Tessa_Cards_CardGetFileContentRequest__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[CardGetFileContentRequest(Dictionary<String,
Object>)](M_Tessa_Cards_CardGetFileContentRequest__ctor_1.htm)| Создаёт
экземпляр класса с указанием хранилища, декоратором для которого является
создаваемый объект.  
[CardGetFileContentRequest(IStorageObjectProvider)](M_Tessa_Cards_CardGetFileContentRequest__ctor_2.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_CardGetFileContentRequest_Clone.htm)|  Выполняет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[FromTypedJson](M_Tessa_Cards_CardGetFileContentRequest_FromTypedJson.htm)|
Устанавливает содержимое объекта в соответствии с данными, десериализованными
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardGetFileContentRequest_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
[CardFileRequestBase.ValidateInternal(IValidationResultBuilder)](M_Tessa_Cards_CardFileRequestBase_ValidateInternal.htm))  
##  __Поля
...
[GetForbidStoringHistory](M_Tessa_Cards_CardRequestExtensions_GetForbidStoringHistory_1.htm)|
...
(Определяется
[ComHelper](T_Tessa_Extensions_Default_Client_EDS_ComHelper.htm))  
[SetConverterFormat](M_Tessa_Cards_CardRequestExtensions_SetConverterFormat_1.htm)|
...
(Определяется
[CardRequestExtensions](T_Tessa_Cards_CardRequestExtensions.htm))  
[SetForbidStoringHistory](M_Tessa_Cards_CardRequestExtensions_SetForbidStoringHistory_1.htm)|
...
(Определяется
[KrProcessSharedExtensions](T_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrProcessSharedExtensions.htm))  
[TryGetConverterFormat](M_Tessa_Cards_CardRequestExtensions_TryGetConverterFormat_1.htm)|
...
(Определяется
[KrProcessSharedExtensions](T_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrProcessSharedExtensions.htm))  
[TryRepairRequestParametersTypesInInfo](M_Tessa_Web_Client_Helpers_CommonExtensions_TryRepairRequestParametersTypesInInfo.htm)|  
(Определяется
