...
C# __Копировать
     public sealed class Splash : ISplash, 
    	IDisposable
VB __Копировать
     Public NotInheritable Class Splash
    	Implements ISplash, IDisposable
C++ __Копировать
     public ref class Splash sealed : ISplash, 
    	IDisposable
F# __Копировать
     [<SealedAttribute>]
    type Splash = 
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ Splash
Implements
    [IDisposable](https://learn.microsoft.com/dotnet/api/system.idisposable), [ISplash](T_Tessa_Platform_ISplash.htm)
##  __Конструкторы
[Splash](M_Tessa_UI_Runtime_Splash__ctor.htm)|  Создаёт экземпляр класса с
указанием сообщения, которое требуется вывести на экране загрузки.  
---|---  
## __Свойства
[IsCollapsed](P_Tessa_UI_Runtime_Splash_IsCollapsed.htm)|  Признак того, что
...
---|---  
[Text](P_Tessa_UI_Runtime_Splash_Text.htm)| Текст, отображаемый в окне
операции.  
##  __Методы
[Dispose](M_Tessa_UI_Runtime_Splash_Dispose.htm)|  Закрывает окно с экраном
загрузки.  
---|---  
