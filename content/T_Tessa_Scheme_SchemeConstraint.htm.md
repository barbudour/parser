# SchemeConstraint - класс
##  __Definition
 **Пространство имён:** [Tessa.Scheme](N_Tessa_Scheme.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class SchemeConstraint : SchemeNamedObject
VB __Копировать
     Public MustInherit Class SchemeConstraint
    	Inherits SchemeNamedObject
C++ __Копировать
     public ref class SchemeConstraint abstract : public SchemeNamedObject
F# __Копировать
     [<AbstractClassAttribute>]
    type SchemeConstraint = 
        class
            inherit SchemeNamedObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[SchemeObject](T_Tessa_Scheme_SchemeObject.htm) __[SchemePartionableObject](T_Tessa_Scheme_SchemePartionableObject.htm) __[SchemeNamedObject](T_Tessa_Scheme_SchemeNamedObject.htm) __ SchemeConstraint
Derived
[Tessa.Scheme.SchemeDefaultConstraint](T_Tessa_Scheme_SchemeDefaultConstraint.htm)
[Tessa.Scheme.SchemeForeignKey](T_Tessa_Scheme_SchemeForeignKey.htm)
[Tessa.Scheme.SchemeUniqueKey](T_Tessa_Scheme_SchemeUniqueKey.htm)
##  __Свойства
