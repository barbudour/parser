# TaskSatelliteBackupExtension.TryGetSatelliteInfoListAsync - метод
...
VB __Копировать
     Protected Overrides Function TryGetSatelliteInfoListAsync ( 
    	dbScope As IDbScope,
    	mainCardID As Guid,
...
F# __Копировать
    ...
    *)
    ...
    override TryGetSatelliteInfoListAsync : 
            dbScope : IDbScope * 
            mainCardID : Guid * 
            ?cancellationToken : CancellationToken 
    (* Defaults:
