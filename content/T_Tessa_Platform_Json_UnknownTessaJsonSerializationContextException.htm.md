# UnknownTessaJsonSerializationContextException - класс
...
C# __Копировать
    ...
    public class UnknownTessaJsonSerializationContextException : ApplicationException
VB __Копировать
    <SerializableAttribute>
    Public Class UnknownTessaJsonSerializationContextException
    	Inherits ApplicationException
C++ __Копировать
    [SerializableAttribute]
    public ref class UnknownTessaJsonSerializationContextException : public ApplicationException
F# __Копировать
     [<SerializableAttribute>]
    type UnknownTessaJsonSerializationContextException = 
        class
            inherit ApplicationException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception) __ UnknownTessaJsonSerializationContextException
##  __Конструкторы
[UnknownTessaJsonSerializationContextException()](M_Tessa_Platform_Json_UnknownTessaJsonSerializationContextException__ctor.htm)|
Инициализирует новый экземпляр класса
UnknownTessaJsonSerializationContextException.  
---|---  
[UnknownTessaJsonSerializationContextException(String)](M_Tessa_Platform_Json_UnknownTessaJsonSerializationContextException__ctor_2.htm)|
Выполняет инициализацию нового экземпляра класса
UnknownTessaJsonSerializationContextException, используя указанное сообщение
об ошибке.  
[UnknownTessaJsonSerializationContextException(SerializationInfo,
StreamingContext)](M_Tessa_Platform_Json_UnknownTessaJsonSerializationContextException__ctor_1.htm)|
...
[UnknownTessaJsonSerializationContextException(String,
Exception)](M_Tessa_Platform_Json_UnknownTessaJsonSerializationContextException__ctor_3.htm)|
Выполняет инициализацию нового экземпляра класса
UnknownTessaJsonSerializationContextException с указанным сообщением об ошибке
и ссылкой на внутреннее исключение, которое стало причиной данного исключения.  
## __Свойства
