# EmbeddedDataGetFileContentExtension - класс
...
C# __Копировать
     public sealed class EmbeddedDataGetFileContentExtension : CardGetFileContentExtension
VB __Копировать
     Public NotInheritable Class EmbeddedDataGetFileContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class EmbeddedDataGetFileContentExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type EmbeddedDataGetFileContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ EmbeddedDataGetFileContentExtension
##  __Конструкторы
[EmbeddedDataGetFileContentExtension](M_Tessa_Extensions_Default_Server_Files_EmbeddedDataGetFileContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса EmbeddedDataGetFileContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Files_EmbeddedDataGetFileContentExtension_BeforeRequest.htm)|  
(Переопределяет
