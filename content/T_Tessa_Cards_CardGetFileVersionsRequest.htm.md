# CardGetFileVersionsRequest - класс
...
C# __Копировать
    ...
    public sealed class CardGetFileVersionsRequest : CardFileRequestBase, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardGetFileVersionsRequest
    	Inherits CardFileRequestBase
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardGetFileVersionsRequest sealed : public CardFileRequestBase, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardGetFileVersionsRequest = 
        class
            inherit CardFileRequestBase
            interface ICloneable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm) __[CardRequestBase](T_Tessa_Cards_CardRequestBase.htm) __[CardFileRequestBase](T_Tessa_Cards_CardFileRequestBase.htm) __ CardGetFileVersionsRequest
Implements
    [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable)
##  __Конструкторы
[CardGetFileVersionsRequest()](M_Tessa_Cards_CardGetFileVersionsRequest__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[CardGetFileVersionsRequest(Dictionary<String,
Object>)](M_Tessa_Cards_CardGetFileVersionsRequest__ctor_1.htm)| Создаёт
экземпляр класса с указанием хранилища, декоратором для которого является
создаваемый объект.  
[CardGetFileVersionsRequest(IStorageObjectProvider)](M_Tessa_Cards_CardGetFileVersionsRequest__ctor_2.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_CardGetFileVersionsRequest_Clone.htm)|  Выполняет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[FromTypedJson](M_Tessa_Cards_CardGetFileVersionsRequest_FromTypedJson.htm)|
Устанавливает содержимое объекта в соответствии с данными, десериализованными
