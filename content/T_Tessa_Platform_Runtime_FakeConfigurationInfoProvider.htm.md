# FakeConfigurationInfoProvider - класс
...
C# __Копировать
     public sealed class FakeConfigurationInfoProvider : IConfigurationInfoProvider
VB __Копировать
     Public NotInheritable Class FakeConfigurationInfoProvider
    	Implements IConfigurationInfoProvider
C++ __Копировать
     public ref class FakeConfigurationInfoProvider sealed : IConfigurationInfoProvider
F# __Копировать
     [<SealedAttribute>]
    type FakeConfigurationInfoProvider = 
        class
            interface IConfigurationInfoProvider
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FakeConfigurationInfoProvider
Implements
    [IConfigurationInfoProvider](T_Tessa_Platform_Runtime_IConfigurationInfoProvider.htm)
##  __Конструкторы
[FakeConfigurationInfoProvider](M_Tessa_Platform_Runtime_FakeConfigurationInfoProvider__ctor.htm)|
Инициализирует новый экземпляр класса FakeConfigurationInfoProvider  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetFlags](M_Tessa_Platform_Runtime_FakeConfigurationInfoProvider_GetFlags.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetInfoAsync](M_Tessa_Platform_Runtime_FakeConfigurationInfoProvider_GetInfoAsync.htm)|
