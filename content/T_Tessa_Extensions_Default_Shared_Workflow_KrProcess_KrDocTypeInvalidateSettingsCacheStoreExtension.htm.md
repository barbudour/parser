# KrDocTypeInvalidateSettingsCacheStoreExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Class KrDocTypeInvalidateSettingsCacheStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class KrDocTypeInvalidateSettingsCacheStoreExtension : public CardStoreExtension
F# __Копировать
     type KrDocTypeInvalidateSettingsCacheStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ KrDocTypeInvalidateSettingsCacheStoreExtension
##  __Конструкторы
[KrDocTypeInvalidateSettingsCacheStoreExtension](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrDocTypeInvalidateSettingsCacheStoreExtension__ctor.htm)|
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrDocTypeInvalidateSettingsCacheStoreExtension_AfterRequest.htm)|  
(Переопределяет
