# TiffScanDocumentGenerator - класс
...
C# __Копировать
     public sealed class TiffScanDocumentGenerator : ScanDocumentGenerator
VB __Копировать
     Public NotInheritable Class TiffScanDocumentGenerator
    	Inherits ScanDocumentGenerator
C++ __Копировать
     public ref class TiffScanDocumentGenerator sealed : public ScanDocumentGenerator
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ScanDocumentGenerator](T_Tessa_Extensions_Platform_Client_Scanning_ScanDocumentGenerator.htm) __ TiffScanDocumentGenerator
##  __Конструкторы
[TiffScanDocumentGenerator](M_Tessa_Extensions_Platform_Client_Scanning_TiffScanDocumentGenerator__ctor.htm)|
...
(Унаследован от
[ScanDocumentGenerator](T_Tessa_Extensions_Platform_Client_Scanning_ScanDocumentGenerator.htm))  
[TryGenerateCoreAsync](M_Tessa_Extensions_Platform_Client_Scanning_TiffScanDocumentGenerator_TryGenerateCoreAsync.htm)|  
