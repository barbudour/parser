# AcquaintanceHelper.PlaceholderAliasesKey - поле
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public const string PlaceholderAliasesKey = ".PlaceholderAliases"
VB __Копировать
     Public Const PlaceholderAliasesKey As String = ".PlaceholderAliases"
C++ __Копировать
     public:
    literal String^ PlaceholderAliasesKey = ".PlaceholderAliases"
F# __Копировать
     static val mutable PlaceholderAliasesKey: string
#### Значение поля
