# IKrPermissionSectionSettings.MandatoryFields - свойство
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Property MandatoryFields As IReadOnlyCollection(Of Guid)
    	Get
    	Set
C++ __Копировать
    property IReadOnlyCollection<Guid>^ MandatoryFields {
    	IReadOnlyCollection<Guid>^ get ();
    	void set (IReadOnlyCollection<Guid>^ value);
    }
F# __Копировать
     abstract MandatoryFields : IReadOnlyCollection<Guid> with get, set
#### Значение свойства
