# CreateCardExtensionConfigurator - класс
...
VB __Копировать
     Public NotInheritable Class CreateCardExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class CreateCardExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type CreateCardExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ CreateCardExtensionConfigurator
##  __Конструкторы
[CreateCardExtensionConfigurator](M_Tessa_Extensions_Default_Client_Views_CreateCardExtensionConfigurator__ctor.htm)|
Инициализирует новый экземпляр класса CreateCardExtensionConfigurator  
---|---  
##  __Свойства
...
(Унаследован от
[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm))  
[GetConfiguratorFormAsync](M_Tessa_Extensions_Default_Client_Views_CreateCardExtensionConfigurator_GetConfiguratorFormAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialize](M_Tessa_Extensions_Default_Client_Views_CreateCardExtensionConfigurator_Initialize.htm)|
