...
C# __Копировать
     public sealed class SelectAll : Behavior<Control>
VB __Копировать
     Public NotInheritable Class SelectAll
    	Inherits Behavior(Of Control)
C++ __Копировать
     public ref class SelectAll sealed : public Behavior<Control^>
F# __Копировать
     [<SealedAttribute>]
    type SelectAll = 
        class
            inherit Behavior<Control>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[Control](https://learn.microsoft.com/dotnet/api/system.windows.controls.control)> __ SelectAll
##  __Конструкторы
[SelectAll](M_Tessa_UI_Behaviors_SelectAll__ctor.htm)| Инициализирует новый
экземпляр класса SelectAll  
---|---  
##  __Свойства
...
[Command](P_Tessa_UI_Behaviors_SelectAll_Command.htm)|  Команда, при
выполнении которой выделяется весь текст в контроле, с которым связано
поведение.  
[Control](P_Tessa_UI_Behaviors_SelectAll_Control.htm)|  Элемент управления,
для которого выполняется поведение или null, если поведение выполняется для
объекта, к которому добавлено поведение.  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_SelectAll_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_SelectAll_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_SelectAll_OnDetaching.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[CommandProperty](F_Tessa_UI_Behaviors_SelectAll_CommandProperty.htm)|  
---|---  
[ControlProperty](F_Tessa_UI_Behaviors_SelectAll_ControlProperty.htm)|  
## __См. также
#### Ссылки
