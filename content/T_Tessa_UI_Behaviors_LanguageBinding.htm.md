# LanguageBinding - класс
Поведение, добавляющее возможность создавать привязку для свойства
...
C# __Копировать
     public sealed class LanguageBinding : Behavior<FrameworkElement>
VB __Копировать
     Public NotInheritable Class LanguageBinding
    	Inherits Behavior(Of FrameworkElement)
C++ __Копировать
     public ref class LanguageBinding sealed : public Behavior<FrameworkElement^>
F# __Копировать
     [<SealedAttribute>]
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[Language](P_Tessa_UI_Behaviors_LanguageBinding_Language.htm)|  Значение
языка, привязка которого выполняется.  
## __Методы
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_LanguageBinding_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_LanguageBinding_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_LanguageBinding_OnDetaching.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[LanguageProperty](F_Tessa_UI_Behaviors_LanguageBinding_LanguageProperty.htm)|  
---|---  
## __См. также
#### Ссылки
