# KrConstants.KrDialogStageTypeSettingsVirtual.OpenModeID - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly OpenModeID As String
C++ __Копировать
     public:
    static initonly String^ OpenModeID
F# __Копировать
     static val OpenModeID: string
#### Значение поля
