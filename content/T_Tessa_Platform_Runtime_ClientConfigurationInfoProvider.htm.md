# ClientConfigurationInfoProvider - класс
...
C# __Копировать
     public sealed class ClientConfigurationInfoProvider : IConfigurationInfoProvider
VB __Копировать
     Public NotInheritable Class ClientConfigurationInfoProvider
    	Implements IConfigurationInfoProvider
C++ __Копировать
     public ref class ClientConfigurationInfoProvider sealed : IConfigurationInfoProvider
F# __Копировать
     [<SealedAttribute>]
    type ClientConfigurationInfoProvider = 
        class
            interface IConfigurationInfoProvider
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ClientConfigurationInfoProvider
Implements
    [IConfigurationInfoProvider](T_Tessa_Platform_Runtime_IConfigurationInfoProvider.htm)
##  __Конструкторы
[ClientConfigurationInfoProvider](M_Tessa_Platform_Runtime_ClientConfigurationInfoProvider__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetFlags](M_Tessa_Platform_Runtime_ClientConfigurationInfoProvider_GetFlags.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetInfoAsync](M_Tessa_Platform_Runtime_ClientConfigurationInfoProvider_GetInfoAsync.htm)|
