...
C# __Копировать
    ...
    public sealed class ViewStoreRequest : StorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class ViewStoreRequest
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class ViewStoreRequest sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type ViewStoreRequest = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ViewStoreRequest
##  __Конструкторы
[ViewStoreRequest()](M_Tessa_Platform_Configuration_ViewStoreRequest__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[ViewStoreRequest(Dictionary<String,
Object>)](M_Tessa_Platform_Configuration_ViewStoreRequest__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[ViewStoreRequest(IStorageObjectProvider)](M_Tessa_Platform_Configuration_ViewStoreRequest__ctor_2.htm)|
...
## __Свойства
[Action](P_Tessa_Platform_Configuration_ViewStoreRequest_Action.htm)|  
---|---  
[Alias](P_Tessa_Platform_Configuration_ViewStoreRequest_Alias.htm)|  
[Caption](P_Tessa_Platform_Configuration_ViewStoreRequest_Caption.htm)|  
[Description](P_Tessa_Platform_Configuration_ViewStoreRequest_Description.htm)|  
[FormatVersion](P_Tessa_Platform_Configuration_ViewStoreRequest_FormatVersion.htm)|  
[GroupName](P_Tessa_Platform_Configuration_ViewStoreRequest_GroupName.htm)|  
[Id](P_Tessa_Platform_Configuration_ViewStoreRequest_Id.htm)|  
[ImportRoles](P_Tessa_Platform_Configuration_ViewStoreRequest_ImportRoles.htm)|  
[MetadataSource](P_Tessa_Platform_Configuration_ViewStoreRequest_MetadataSource.htm)|  
[NeedClear](P_Tessa_Platform_Configuration_ViewStoreRequest_NeedClear.htm)|  
## __Методы
