# RemoveUserFromRolesDeleteExtension - класс
...
C# __Копировать
     public sealed class RemoveUserFromRolesDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class RemoveUserFromRolesDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class RemoveUserFromRolesDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type RemoveUserFromRolesDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ RemoveUserFromRolesDeleteExtension
##  __Конструкторы
[RemoveUserFromRolesDeleteExtension](M_Tessa_Extensions_Platform_Server_Roles_RemoveUserFromRolesDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса RemoveUserFromRolesDeleteExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Roles_RemoveUserFromRolesDeleteExtension_AfterBeginTransaction.htm)|  
(Переопределяет
