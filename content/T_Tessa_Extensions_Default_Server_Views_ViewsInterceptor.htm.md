...
C# __Копировать
     public sealed class ViewsInterceptor : ViewInterceptorBase
VB __Копировать
     Public NotInheritable Class ViewsInterceptor
    	Inherits ViewInterceptorBase
C++ __Копировать
     public ref class ViewsInterceptor sealed : public ViewInterceptorBase
F# __Копировать
     [<SealedAttribute>]
    type ViewsInterceptor = 
        class
            inherit ViewInterceptorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ViewInterceptorBase](T_Tessa_Views_ViewInterceptorBase.htm) __ ViewsInterceptor
##  __Конструкторы
[ViewsInterceptor](M_Tessa_Extensions_Default_Server_Views_ViewsInterceptor__ctor.htm)|
Initializes a new instance of the ViewsInterceptor class. Инициализирует новый
экземпляр класса ViewsInterceptor.  
---|---  
## __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetDataAsync](M_Tessa_Extensions_Default_Server_Views_ViewsInterceptor_GetDataAsync.htm)|
