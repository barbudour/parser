# KrCreateBasedOnNewExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrCreateBasedOnNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class KrCreateBasedOnNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type KrCreateBasedOnNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ KrCreateBasedOnNewExtension
##  __Конструкторы
[KrCreateBasedOnNewExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrCreateBasedOnNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrCreateBasedOnNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrCreateBasedOnNewExtension_AfterRequest.htm)|  
(Переопределяет
