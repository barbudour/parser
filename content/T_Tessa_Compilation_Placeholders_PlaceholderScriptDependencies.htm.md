# PlaceholderScriptDependencies - класс
...
C# __Копировать
     public sealed class PlaceholderScriptDependencies : IPlaceholderScriptDependencies
VB __Копировать
     Public NotInheritable Class PlaceholderScriptDependencies
    	Implements IPlaceholderScriptDependencies
C++ __Копировать
     public ref class PlaceholderScriptDependencies sealed : IPlaceholderScriptDependencies
F# __Копировать
     [<SealedAttribute>]
    type PlaceholderScriptDependencies = 
        class
            interface IPlaceholderScriptDependencies
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ PlaceholderScriptDependencies
Implements
    [IPlaceholderScriptDependencies](T_Tessa_Platform_Placeholders_Compilation_IPlaceholderScriptDependencies.htm)
##  __Конструкторы
[PlaceholderScriptDependencies](M_Tessa_Compilation_Placeholders_PlaceholderScriptDependencies__ctor.htm)|
