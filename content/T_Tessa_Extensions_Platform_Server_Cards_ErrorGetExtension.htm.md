# ErrorGetExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Cards](N_Tessa_Extensions_Platform_Server_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class ErrorGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class ErrorGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class ErrorGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type ErrorGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ ErrorGetExtension
##  __Конструкторы
[ErrorGetExtension](M_Tessa_Extensions_Platform_Server_Cards_ErrorGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса ErrorGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_ErrorGetExtension_AfterRequest.htm)|  
(Переопределяет
