...
(Унаследован от
[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject))  
[HorizontalScrollRatio](P_Tessa_UI_Behaviors_VerticalWheelScroll_HorizontalScrollRatio.htm)|
Количество интервалов по горизонтали, на которые прокручивается таблица за
каждую прокрутку колесом мыши с зажатым Shift, если указано свойство
[HorizontalScrollWithShift](P_Tessa_UI_Behaviors_VerticalWheelScroll_HorizontalScrollWithShift.htm).
По умолчанию равно 1.  
[HorizontalScrollWithShift](P_Tessa_UI_Behaviors_VerticalWheelScroll_HorizontalScrollWithShift.htm)|
Горизонтальный скролл с зажатой кнопкой Shift. По умолчанию выключен.  
...
[VerticalScrollRatio](P_Tessa_UI_Behaviors_VerticalWheelScroll_VerticalScrollRatio.htm)|
Количество интервалов по вертикали, на которые прокручивается таблица за
каждую прокрутку колесом мыши. По умолчанию равно 1.  
## __Методы
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_VerticalWheelScroll_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnConnected](M_Tessa_UI_Behaviors_VerticalWheelScroll_OnConnected.htm)|  
(Переопределяет
...
(Унаследован от
[ScrollViewerBehaviorBase](T_Tessa_UI_Behaviors_ScrollViewerBehaviorBase.htm))  
[OnDisconnected](M_Tessa_UI_Behaviors_VerticalWheelScroll_OnDisconnected.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[HorizontalScrollRatioProperty](F_Tessa_UI_Behaviors_VerticalWheelScroll_HorizontalScrollRatioProperty.htm)|  
---|---  
[HorizontalScrollWithShiftProperty](F_Tessa_UI_Behaviors_VerticalWheelScroll_HorizontalScrollWithShiftProperty.htm)|  
[VerticalScrollRatioProperty](F_Tessa_UI_Behaviors_VerticalWheelScroll_VerticalScrollRatioProperty.htm)|  
## __См. также
#### Ссылки
