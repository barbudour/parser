# KrConstants.Keys.CompletionOptionSettings - поле
Ключ по которому в
...
C# __Копировать
     public const string CompletionOptionSettings = "CompletionOptionSettings"
VB __Копировать
     Public Const CompletionOptionSettings As String = "CompletionOptionSettings"
C++ __Копировать
     public:
    literal String^ CompletionOptionSettings = "CompletionOptionSettings"
F# __Копировать
     static val mutable CompletionOptionSettings: string
#### Значение поля
