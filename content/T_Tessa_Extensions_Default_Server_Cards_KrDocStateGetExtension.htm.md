...
C# __Копировать
     public sealed class KrDocStateGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class KrDocStateGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class KrDocStateGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrDocStateGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ KrDocStateGetExtension
##  __Конструкторы
[KrDocStateGetExtension](M_Tessa_Extensions_Default_Server_Cards_KrDocStateGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrDocStateGetExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Cards_KrDocStateGetExtension_BeforeRequest.htm)|  
(Переопределяет
