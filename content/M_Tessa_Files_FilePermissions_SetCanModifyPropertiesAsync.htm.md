...
F# __Копировать
    ...
    *)
    -> Task 
    override SetCanModifyPropertiesAsync : 
            value : bool * 
            ?executePropertyChangedAsync : Func<Action, CancellationToken, Task> * 
            ?cancellationToken : CancellationToken 
    (* Defaults:
...
value [Boolean](https://learn.microsoft.com/dotnet/api/system.boolean)
     Устанавливаемый признак того, что свойства файла могут быть изменены. 
...
Асинхронная задача.
#### Реализации
[IFilePermissions.SetCanModifyPropertiesAsync(Boolean, Func<Action,
CancellationToken, Task>,
CancellationToken)](M_Tessa_Files_IFilePermissions_SetCanModifyPropertiesAsync.htm)  
##  __Исключения
