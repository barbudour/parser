# DocLoadBarcodeTemplateNewExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class DocLoadBarcodeTemplateNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class DocLoadBarcodeTemplateNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type DocLoadBarcodeTemplateNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ DocLoadBarcodeTemplateNewExtension
##  __Конструкторы
[DocLoadBarcodeTemplateNewExtension](M_Tessa_Extensions_Default_Server_Cards_DocLoadBarcodeTemplateNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса DocLoadBarcodeTemplateNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Cards_DocLoadBarcodeTemplateNewExtension_AfterRequest.htm)|  
(Переопределяет
