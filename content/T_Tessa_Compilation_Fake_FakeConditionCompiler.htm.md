...
C# __Копировать
     public sealed class FakeConditionCompiler : IConditionCompiler
VB __Копировать
     Public NotInheritable Class FakeConditionCompiler
    	Implements IConditionCompiler
C++ __Копировать
     public ref class FakeConditionCompiler sealed : IConditionCompiler
F# __Копировать
     [<SealedAttribute>]
    type FakeConditionCompiler = 
        class
            interface IConditionCompiler
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FakeConditionCompiler
Implements
    [IConditionCompiler](T_Tessa_Platform_Conditions_IConditionCompiler.htm)
##  __Конструкторы
[FakeConditionCompiler](M_Tessa_Compilation_Fake_FakeConditionCompiler__ctor.htm)|
Инициализирует новый экземпляр класса FakeConditionCompiler  
---|---  
##  __Свойства
...
## __Методы
[Compile](M_Tessa_Compilation_Fake_FakeConditionCompiler_Compile.htm)|  Метод
для компиляции типов условий  
---|---  
[CreateContext](M_Tessa_Compilation_Fake_FakeConditionCompiler_CreateContext.htm)|
