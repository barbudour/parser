# KrSecondaryProcessMetadataExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrSecondaryProcessMetadataExtension
    	Inherits CardTypeMetadataExtension
C++ __Копировать
     public ref class KrSecondaryProcessMetadataExtension sealed : public CardTypeMetadataExtension
F# __Копировать
     [<SealedAttribute>]
    type KrSecondaryProcessMetadataExtension = 
        class
            inherit CardTypeMetadataExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardMetadataExtension](T_Tessa_Cards_Extensions_CardMetadataExtension.htm) __[CardTypeMetadataExtension](T_Tessa_Cards_Extensions_CardTypeMetadataExtension.htm) __ KrSecondaryProcessMetadataExtension
##  __Конструкторы
[KrSecondaryProcessMetadataExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrSecondaryProcessMetadataExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrSecondaryProcessMetadataExtension  
---|---  
##  __Свойства
...
[ModifyTypes](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrSecondaryProcessMetadataExtension_ModifyTypes.htm)|
