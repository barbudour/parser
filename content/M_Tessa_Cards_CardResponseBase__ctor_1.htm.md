# CardResponseBase(SerializationInfo, StreamingContext) - конструктор
...
F# __Копировать
     new : 
            ...
            context : StreamingContext -> CardResponseBase
#### Параметры
info
...
[CardResponseBase -
перегрузка](Overload_Tessa_Cards_CardResponseBase__ctor.htm)
