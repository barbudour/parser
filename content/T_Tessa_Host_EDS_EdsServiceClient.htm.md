# EdsServiceClient - класс
##  __Definition
 **Пространство имён:** [Tessa.Host.EDS](N_Tessa_Host_EDS.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class EdsServiceClient : IEdsService, 
    	IAsyncDisposable, IDisposable
VB __Копировать
     Public NotInheritable Class EdsServiceClient
    	Implements IEdsService, IAsyncDisposable, IDisposable
C++ __Копировать
     public ref class EdsServiceClient sealed : IEdsService, 
    	IAsyncDisposable, IDisposable
F# __Копировать
     [<SealedAttribute>]
    type EdsServiceClient = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ EdsServiceClient
Implements
...
##  __Конструкторы
[EdsServiceClient](M_Tessa_Host_EDS_EdsServiceClient__ctor.htm)|
Инициализирует новый экземпляр класса EdsServiceClient  
---|---  
##  __Свойства
[Connection](P_Tessa_Host_EDS_EdsServiceClient_Connection.htm)|  
---|---  
## __Методы
[Dispose](M_Tessa_Host_EDS_EdsServiceClient_Dispose.htm)| Освобождает ресурсы,
занимаемые объектом.  
---|---  
[DisposeAsync](M_Tessa_Host_EDS_EdsServiceClient_DisposeAsync.htm)|  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GenerateSignatureAsync](M_Tessa_Host_EDS_EdsServiceClient_GenerateSignatureAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[VerifySignatureAsync](M_Tessa_Host_EDS_EdsServiceClient_VerifySignatureAsync.htm)|
