# WriterLockWrapper - структура
Структура, обеспечивающая синхронизацию доступа к ресурсу на запись.
## __Definition
 **Пространство имён:** [Tessa.Platform](N_Tessa_Platform.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public readonly struct WriterLockWrapper : IDisposable
VB __Копировать
     Public Structure WriterLockWrapper
    	Implements IDisposable
C++ __Копировать
     public value class WriterLockWrapper : IDisposable
F# __Копировать
     [<SealedAttribute>]
    type WriterLockWrapper = 
        struct
            inherit ValueType
            interface IDisposable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) __ WriterLockWrapper
Implements
    [IDisposable](https://learn.microsoft.com/dotnet/api/system.idisposable)
##  __Конструкторы
[WriterLockWrapper](M_Tessa_Platform_WriterLockWrapper__ctor.htm)|  Создаёт
экземпляр структуры с указанием объекта, обеспечивающего синхронизацию доступа
по чтению и изменению ресурса.  
---|---  
## __Методы
[Dispose](M_Tessa_Platform_WriterLockWrapper_Dispose.htm)| Освобождает
