# CardTypeTabForm - класс
Объект, описывающий базовую информацию о форме карточки, которая выводится во
вкладке. Тип карточки [CardType](T_Tessa_Cards_CardType.htm) \- это частный
случай формы.
## __Definition
...
C# __Копировать
    ...
    public abstract class CardTypeTabForm : CardTypeForm, 
    	ICardMetadataOrderable
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class CardTypeTabForm
    	Inherits CardTypeForm
    	Implements ICardMetadataOrderable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTypeTabForm abstract : public CardTypeForm, 
    	ICardMetadataOrderable
F# __Копировать
     [<AbstractClassAttribute>]
    [<SerializableAttribute>]
    type CardTypeTabForm = 
        class
            inherit CardTypeForm
            interface ICardMetadataOrderable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __[CardTypeForm](T_Tessa_Cards_CardTypeForm.htm) __ CardTypeTabForm
Derived
[Tessa.Cards.CardType](T_Tessa_Cards_CardType.htm)
[Tessa.Cards.CardTypeNamedForm](T_Tessa_Cards_CardTypeNamedForm.htm)
[Tessa.Cards.CardTypeTabControlForm](T_Tessa_Cards_CardTypeTabControlForm.htm)
Implements
...
(Переопределяет
[CardTypeForm.BaseIsEmpty()](M_Tessa_Cards_CardTypeForm_BaseIsEmpty.htm))  
---|---  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeAttributeFromXml](M_Tessa_Cards_CardTypeTabForm_DeserializeAttributeFromXml.htm)|
Выполняется для каждого атрибута десериализуемого атрибута.  
(Переопределяет [CardTypeForm.DeserializeAttributeFromXml(String,
String)](M_Tessa_Cards_CardTypeForm_DeserializeAttributeFromXml.htm))  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_CardTypeTabForm_DeserializeFromBinaryInternal.htm)|
Выполняет десериализацию всех полей текущего объекта из байтового потока.  
(Переопределяет
[CardTypeForm.DeserializeFromBinaryInternal(BinaryReader)](M_Tessa_Cards_CardTypeForm_DeserializeFromBinaryInternal.htm))  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_CardTypeTabForm_DeserializeFromStorageInternal.htm)|
Выполняет десериализацию объекта и всех его дочерних объектов из хранилища
Dictionary<string, object>.  
(Переопределяет
[CardTypeForm.DeserializeFromStorageInternal(Dictionary<String,
Object>)](M_Tessa_Cards_CardTypeForm_DeserializeFromStorageInternal.htm))  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetValidationName](M_Tessa_Cards_CardTypeTabForm_GetValidationName.htm)|
Возвращает строку, определяющую имя объекта, или null, если имя объекта ещё
неизвестно или объект не содержит имени.  
(Переопределяет
[CardTypeForm.GetValidationName()](M_Tessa_Cards_CardTypeForm_GetValidationName.htm))  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_CardTypeTabForm_OnDeserializing.htm)|
Выполняется перед десериализацией объекта и всех его дочерних объектов из
элемента XML.  
(Переопределяет
[CardTypeForm.OnDeserializing(SerializationMode)](M_Tessa_Cards_CardTypeForm_OnDeserializing.htm))  
...
(Унаследован от [CardTypeForm](T_Tessa_Cards_CardTypeForm.htm))  
[SerializeAttributesToXml](M_Tessa_Cards_CardTypeTabForm_SerializeAttributesToXml.htm)|
Выполняет сериализацию текущего объекта в атрибуты XML.  
(Переопределяет
[CardTypeForm.SerializeAttributesToXml(XmlWriter)](M_Tessa_Cards_CardTypeForm_SerializeAttributesToXml.htm))  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_CardTypeTabForm_SerializeToBinaryInternal.htm)|
Выполняет сериализацию текущего объекта в байтовый поток.  
(Переопределяет
[CardTypeForm.SerializeToBinaryInternal(BinaryWriter)](M_Tessa_Cards_CardTypeForm_SerializeToBinaryInternal.htm))  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_CardTypeTabForm_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
хранилище Dictionary<string, object>.  
(Переопределяет [CardTypeForm.SerializeToStorageInternal(Dictionary<String,
Object>)](M_Tessa_Cards_CardTypeForm_SerializeToStorageInternal.htm))  
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[ToString](M_Tessa_Cards_CardTypeTabForm_ToString.htm)| Возвращает хеш-код
объекта.  
(Переопределяет
