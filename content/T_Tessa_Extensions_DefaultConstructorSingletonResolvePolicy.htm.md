# DefaultConstructorSingletonResolvePolicy - класс
...
C# __Копировать
     public sealed class DefaultConstructorSingletonResolvePolicy : IResolvePolicy, 
    	IExtensionPolicy
VB __Копировать
     Public NotInheritable Class DefaultConstructorSingletonResolvePolicy
    	Implements IResolvePolicy, IExtensionPolicy
C++ __Копировать
     public ref class DefaultConstructorSingletonResolvePolicy sealed : IResolvePolicy, 
    	IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type DefaultConstructorSingletonResolvePolicy = 
        class
            interface IResolvePolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ DefaultConstructorSingletonResolvePolicy
Implements
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ResolveAsync](M_Tessa_Extensions_DefaultConstructorSingletonResolvePolicy_ResolveAsync.htm)|
