...
C# __Копировать
     public sealed class CalendarGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class CalendarGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class CalendarGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type CalendarGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ CalendarGetExtension
##  __Конструкторы
[CalendarGetExtension](M_Tessa_Extensions_Default_Server_BusinessCalendar_CalendarGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса CalendarGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_BusinessCalendar_CalendarGetExtension_AfterRequest.htm)|  
(Переопределяет
