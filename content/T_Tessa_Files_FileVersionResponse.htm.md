# FileVersionResponse - класс
Ответ на запрос на получение коллекции доступных версий файла.
## __Definition
 **Пространство имён:** [Tessa.Files](N_Tessa_Files.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class FileVersionResponse : IFileVersionResponse
VB __Копировать
     Public NotInheritable Class FileVersionResponse
    	Implements IFileVersionResponse
C++ __Копировать
     public ref class FileVersionResponse sealed : IFileVersionResponse
F# __Копировать
     [<SealedAttribute>]
    type FileVersionResponse = 
        class
            interface IFileVersionResponse
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FileVersionResponse
Implements
    [IFileVersionResponse](T_Tessa_Files_IFileVersionResponse.htm)
##  __Конструкторы
[FileVersionResponse](M_Tessa_Files_FileVersionResponse__ctor.htm)|  Создаёт
