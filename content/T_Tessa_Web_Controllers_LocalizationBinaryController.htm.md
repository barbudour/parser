# LocalizationBinaryController - класс
...
C# __Копировать
    [RouteAttribute("api/b/Localization")]
    [AllowAnonymousAttribute]
    [ApiExplorerSettingsAttribute(IgnoreApi = true)]
    public sealed class LocalizationBinaryController : Controller
VB __Копировать
    <RouteAttribute("api/b/Localization")>
    <AllowAnonymousAttribute>
    <ApiExplorerSettingsAttribute(IgnoreApi := true)>
    Public NotInheritable Class LocalizationBinaryController
    	Inherits Controller
C++ __Копировать
    [RouteAttribute(L"api/b/Localization")]
    [AllowAnonymousAttribute]
    [ApiExplorerSettingsAttribute(IgnoreApi = true)]
    public ref class LocalizationBinaryController sealed : public Controller
F# __Копировать
     [<SealedAttribute>]
    [<RouteAttribute("api/b/Localization")>]
    [<AllowAnonymousAttribute>]
    [<ApiExplorerSettingsAttribute(IgnoreApi = true)>]
    type LocalizationBinaryController = 
        class
            inherit Controller
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase) __[Controller](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controller) __ LocalizationBinaryController
##  __Конструкторы
[LocalizationBinaryController](M_Tessa_Web_Controllers_LocalizationBinaryController__ctor.htm)|
Инициализирует новый экземпляр класса LocalizationBinaryController  
---|---  
##  __Свойства
...
(Унаследован от
[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase))  
[PostGetEntries](M_Tessa_Web_Controllers_LocalizationBinaryController_PostGetEntries.htm)|
