# NumberControlResponse(IStorageObjectProvider) - конструктор
...
F# __Копировать
     new : 
            storageProvider : IStorageObjectProvider -> NumberControlResponse
#### Параметры
storageProvider
...
[NumberControlResponse -
перегрузка](Overload_Tessa_Cards_Numbers_NumberControlResponse__ctor.htm)
