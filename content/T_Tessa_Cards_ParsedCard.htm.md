...
VB __Копировать
     Public NotInheritable Class ParsedCard
C++ __Копировать
     public ref class ParsedCard sealed
F# __Копировать
     [<SealedAttribute>]
    type ParsedCard = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ParsedCard
##  __Конструкторы
[ParsedCard](M_Tessa_Cards_ParsedCard__ctor.htm)| Инициализирует новый
экземпляр класса ParsedCard  
---|---  
##  __Свойства
