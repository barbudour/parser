# CardRequestExtensions.TryGetWarningIfEntryNotFoundFlag - метод
...
C# __Копировать
     public static bool TryGetWarningIfEntryNotFoundFlag(
    	this CardGetRequest request
    )
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function TryGetWarningIfEntryNotFoundFlag ( 
    	request As CardGetRequest
    ) As Boolean
C++ __Копировать
     public:
    [ExtensionAttribute]
    static bool TryGetWarningIfEntryNotFoundFlag(
    	CardGetRequest^ request
    )
F# __Копировать
     [<ExtensionAttribute>]
    static member TryGetWarningIfEntryNotFoundFlag : 
