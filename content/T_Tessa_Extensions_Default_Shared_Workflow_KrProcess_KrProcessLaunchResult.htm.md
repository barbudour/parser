...
C# __Копировать
    ...
    public sealed class KrProcessLaunchResult : StorageObject, 
    	IKrProcessLaunchResult
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class KrProcessLaunchResult
    	Inherits StorageObject
    	Implements IKrProcessLaunchResult
C++ __Копировать
    [SerializableAttribute]
    public ref class KrProcessLaunchResult sealed : public StorageObject, 
    	IKrProcessLaunchResult
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type KrProcessLaunchResult = 
        class
            inherit StorageObject
            interface IKrProcessLaunchResult
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ KrProcessLaunchResult
Implements
...
Инициализирует новый экземпляр класса KrProcessLaunchResult  
---|---  
