...
C# __Копировать
     public class ClientViewServiceImplementer : IViewServiceImplementer, 
    	IViewServiceInitializer
VB __Копировать
     Public Class ClientViewServiceImplementer
    	Implements IViewServiceImplementer, IViewServiceInitializer
C++ __Копировать
     public ref class ClientViewServiceImplementer : IViewServiceImplementer, 
    	IViewServiceInitializer
F# __Копировать
...
Derived
[Tessa.UI.AppManager.AppManagerClientViewServiceImplementer](T_Tessa_UI_AppManager_AppManagerClientViewServiceImplementer.htm)
Implements
...
##  __Конструкторы
[ClientViewServiceImplementer](M_Tessa_Applications_ClientViewServiceImplementer__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetAllViewsAsync](M_Tessa_Applications_ClientViewServiceImplementer_GetAllViewsAsync.htm)|
Возвращает список представлений [ITessaView](T_Tessa_Views_ITessaView.htm).  
[GetByNameAsync](M_Tessa_Applications_ClientViewServiceImplementer_GetByNameAsync.htm)|
Возвращает представление заданное по имени viewName  
[GetByNamesAsync](M_Tessa_Applications_ClientViewServiceImplementer_GetByNamesAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetViewsMetadataAsync](M_Tessa_Applications_ClientViewServiceImplementer_GetViewsMetadataAsync.htm)|
