...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardStreamStoreStrategy
Implements
    [ICardStreamStoreStrategy](T_Tessa_Cards_ComponentModel_ICardStreamStoreStrategy.htm)
##  __Конструкторы
[CardStreamStoreStrategy](M_Tessa_Cards_ComponentModel_CardStreamStoreStrategy__ctor.htm)|
