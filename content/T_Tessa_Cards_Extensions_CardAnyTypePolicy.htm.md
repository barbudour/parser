...
C# __Копировать
     public sealed class CardAnyTypePolicy : ICardTypePolicy, 
    	IExtensionPolicy
VB __Копировать
     Public NotInheritable Class CardAnyTypePolicy
    	Implements ICardTypePolicy, IExtensionPolicy
C++ __Копировать
     public ref class CardAnyTypePolicy sealed : ICardTypePolicy, 
    	IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type CardAnyTypePolicy = 
        class
            interface ICardTypePolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardAnyTypePolicy
Implements
...
## __Конструкторы
[CardAnyTypePolicy](M_Tessa_Cards_Extensions_CardAnyTypePolicy__ctor.htm)|
Инициализирует новый экземпляр класса CardAnyTypePolicy  
---|---  
##  __Свойства
