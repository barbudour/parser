# InitializeFilesViewUIExtension - класс
...
VB __Копировать
     Public NotInheritable Class InitializeFilesViewUIExtension
    	Inherits FilesViewGeneratorBaseUIExtension
C++ __Копировать
     public ref class InitializeFilesViewUIExtension sealed : public FilesViewGeneratorBaseUIExtension
F# __Копировать
     [<SealedAttribute>]
    type InitializeFilesViewUIExtension = 
        class
            inherit FilesViewGeneratorBaseUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __[FilesViewGeneratorBaseUIExtension](T_Tessa_Extensions_Default_Client_UI_CardFiles_FilesViewGeneratorBaseUIExtension.htm) __ InitializeFilesViewUIExtension
##  __Конструкторы
[InitializeFilesViewUIExtension](M_Tessa_Extensions_Default_Client_UI_CardFiles_InitializeFilesViewUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса InitializeFilesViewUIExtension  
---|---  
##  __Свойства
[ExtensionContainer](P_Tessa_Extensions_Default_Client_UI_CardFiles_FilesViewGeneratorBaseUIExtension_ExtensionContainer.htm)|
...
---|---  
[ProcessNameResolver](P_Tessa_Extensions_Default_Client_UI_CardFiles_FilesViewGeneratorBaseUIExtension_ProcessNameResolver.htm)|
Объект, обеспечивающий получение отображаемого имени приложения по
запускающему файлу процесса, обычно по .exe.  
(Унаследован от
[FilesViewGeneratorBaseUIExtension](T_Tessa_Extensions_Default_Client_UI_CardFiles_FilesViewGeneratorBaseUIExtension.htm))  
[Session](P_Tessa_Extensions_Default_Client_UI_CardFiles_FilesViewGeneratorBaseUIExtension_Session.htm)|
Сессия пользователя.  
(Унаследован от
[FilesViewGeneratorBaseUIExtension](T_Tessa_Extensions_Default_Client_UI_CardFiles_FilesViewGeneratorBaseUIExtension.htm))  
[ViewService](P_Tessa_Extensions_Default_Client_UI_CardFiles_FilesViewGeneratorBaseUIExtension_ViewService.htm)|
Описание интерфейса сервиса представлений. Сервис предоставляет доступ к
представлениям доступным в системе.  
(Унаследован от
[FilesViewGeneratorBaseUIExtension](T_Tessa_Extensions_Default_Client_UI_CardFiles_FilesViewGeneratorBaseUIExtension.htm))  
##  __Методы
[AddCardModelInitializers](M_Tessa_Extensions_Default_Client_UI_CardFiles_FilesViewGeneratorBaseUIExtension_AddCardModelInitializers.htm)|
Создает скрытый FileControl, через который представление будет
взаимодействовать с файловым API. Для каждого алиаса представления должен быть
создан свой файлконтрол. Создание происходит в CardUIExtension.Initializing.  
(Унаследован от
[FilesViewGeneratorBaseUIExtension](T_Tessa_Extensions_Default_Client_UI_CardFiles_FilesViewGeneratorBaseUIExtension.htm))  
---|---  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_CardFiles_InitializeFilesViewUIExtension_Initialized.htm)|  
(Переопределяет
...
(Унаследован от [CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm))  
[Initializing](M_Tessa_Extensions_Default_Client_UI_CardFiles_InitializeFilesViewUIExtension_Initializing.htm)|  
(Переопределяет
[CardUIExtension.Initializing(ICardUIExtensionContext)](M_Tessa_UI_Cards_CardUIExtension_Initializing.htm))  
