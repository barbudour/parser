# ForumProviderExtensions.ForumProviderGetTopicsWithMessagesRequest - класс
##  __Definition
 **Пространство имён:** [Tessa.Forums](N_Tessa_Forums.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class ForumProviderGetTopicsWithMessagesRequest : StorageObject
VB __Копировать
     Public Class ForumProviderGetTopicsWithMessagesRequest
    	Inherits StorageObject
C++ __Копировать
     public ref class ForumProviderGetTopicsWithMessagesRequest : public StorageObject
F# __Копировать
     type ForumProviderGetTopicsWithMessagesRequest = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForumProviderExtensions.ForumProviderGetTopicsWithMessagesRequest
##  __Конструкторы
[ForumProviderExtensions.ForumProviderGetTopicsWithMessagesRequest()](M_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicsWithMessagesRequest__ctor.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderGetTopicsWithMessagesRequest  
---|---  
[ForumProviderExtensions.ForumProviderGetTopicsWithMessagesRequest(Dictionary<String,
Object>)](M_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicsWithMessagesRequest__ctor_1.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderGetTopicsWithMessagesRequest  
##  __Свойства
[CardID](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicsWithMessagesRequest_CardID.htm)|  
---|---  
[IsSuperModerator](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicsWithMessagesRequest_IsSuperModerator.htm)|  
[LastDate](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicsWithMessagesRequest_LastDate.htm)|  
[MessagesInTopicCount](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicsWithMessagesRequest_MessagesInTopicCount.htm)|  
[TypeID](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicsWithMessagesRequest_TypeID.htm)|  
## __Методы
