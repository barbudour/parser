...
VB __Копировать
     Public NotInheritable Class SinglePerformerProxy
    	Inherits Performer
C++ __Копировать
     public ref class SinglePerformerProxy sealed : public Performer
F# __Копировать
     [<SealedAttribute>]
    type SinglePerformerProxy = 
        class
            inherit Performer
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[Performer](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer.htm) __ SinglePerformerProxy
##  __Конструкторы
[SinglePerformerProxy](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_SinglePerformerProxy__ctor.htm)|
Инициализирует новый экземпляр класса SinglePerformerProxy  
---|---  
##  __Свойства
...
(Унаследован от
[Performer](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer.htm))  
[PerformerID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_SinglePerformerProxy_PerformerID.htm)|
ID роли исполнителя  
(Переопределяет
[Performer.PerformerID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_PerformerID.htm))  
[PerformerName](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_SinglePerformerProxy_PerformerName.htm)|
