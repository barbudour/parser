...
C# __Копировать
     public sealed class SessionServiceRouter : ISessionService
VB __Копировать
     Public NotInheritable Class SessionServiceRouter
    	Implements ISessionService
C++ __Копировать
     public ref class SessionServiceRouter sealed : ISessionService
F# __Копировать
     [<SealedAttribute>]
    type SessionServiceRouter = 
        class
            interface ISessionService
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ SessionServiceRouter
Implements
    [ISessionService](T_Tessa_Platform_Runtime_ISessionService.htm)
##  __Конструкторы
[SessionServiceRouter](M_Tessa_Platform_Runtime_SessionServiceRouter__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Методы
[CloseSessionAsAdminAsync](M_Tessa_Platform_Runtime_SessionServiceRouter_CloseSessionAsAdminAsync.htm)|
...
---|---  
[CloseSessionAsync](M_Tessa_Platform_Runtime_SessionServiceRouter_CloseSessionAsync.htm)|
...
[CloseSessionWithTokenAsync](M_Tessa_Platform_Runtime_SessionServiceRouter_CloseSessionWithTokenAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IncrementConfigurationVersionAsync](M_Tessa_Platform_Runtime_SessionServiceRouter_IncrementConfigurationVersionAsync.htm)|
