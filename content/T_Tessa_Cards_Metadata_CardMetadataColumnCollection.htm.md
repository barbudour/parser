# CardMetadataColumnCollection - класс
...
C# __Копировать
    ...
    public sealed class CardMetadataColumnCollection : CardSerializableEntryCollection<CardMetadataColumn>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardMetadataColumnCollection
    	Inherits CardSerializableEntryCollection(Of CardMetadataColumn)
C++ __Копировать
    [SerializableAttribute]
    public ref class CardMetadataColumnCollection sealed : public CardSerializableEntryCollection<CardMetadataColumn^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardMetadataColumnCollection = 
        class
            inherit CardSerializableEntryCollection<CardMetadataColumn>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __[CardSerializableEntryCollection](T_Tessa_Cards_CardSerializableEntryCollection_1.htm)<[CardMetadataColumn](T_Tessa_Cards_Metadata_CardMetadataColumn.htm)> __ CardMetadataColumnCollection
##  __Конструкторы
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[XmlElementNameInternal](P_Tessa_Cards_Metadata_CardMetadataColumnCollection_XmlElementNameInternal.htm)|
...
[XmlItemNameInternal](P_Tessa_Cards_Metadata_CardMetadataColumnCollection_XmlItemNameInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[GetPhysicalColumns](M_Tessa_Cards_Metadata_CardMetadataColumnCollection_GetPhysicalColumns.htm)|
...
(Определяется
[ComHelper](T_Tessa_Extensions_Default_Client_EDS_ComHelper.htm))  
[TryGetIgnoreCase](M_Tessa_Cards_CardExtensions_TryGetIgnoreCase.htm)|
