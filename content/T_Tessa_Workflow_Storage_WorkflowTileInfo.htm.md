# WorkflowTileInfo - класс
##  __Definition
 **Пространство имён:** [Tessa.Workflow.Storage](N_Tessa_Workflow_Storage.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class WorkflowTileInfo : StorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowTileInfo
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowTileInfo sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowTileInfo = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ WorkflowTileInfo
##  __Конструкторы
[WorkflowTileInfo()](M_Tessa_Workflow_Storage_WorkflowTileInfo__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowTileInfo  
---|---  
[WorkflowTileInfo(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowTileInfo__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowTileInfo  
[WorkflowTileInfo(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowTileInfo__ctor_4.htm)|
Инициализирует новый экземпляр класса WorkflowTileInfo  
[WorkflowTileInfo(SerializationInfo,
StreamingContext)](M_Tessa_Workflow_Storage_WorkflowTileInfo__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowTileInfo  
[WorkflowTileInfo(String, Guid, String, String, String, String, TileSize,
String, Boolean, Boolean, String, Boolean, IEnumerable<WorkflowTileInfo>,
Int32, Boolean)](M_Tessa_Workflow_Storage_WorkflowTileInfo__ctor_3.htm)|
Инициализирует новый экземпляр класса WorkflowTileInfo  
##  __Свойства
[ActionGrouping](P_Tessa_Workflow_Storage_WorkflowTileInfo_ActionGrouping.htm)|  
---|---  
[AskConfirmation](P_Tessa_Workflow_Storage_WorkflowTileInfo_AskConfirmation.htm)|  
[ButtonHotkey](P_Tessa_Workflow_Storage_WorkflowTileInfo_ButtonHotkey.htm)|  
[Caption](P_Tessa_Workflow_Storage_WorkflowTileInfo_Caption.htm)|  
[ConfirmationMessage](P_Tessa_Workflow_Storage_WorkflowTileInfo_ConfirmationMessage.htm)|  
[Icon](P_Tessa_Workflow_Storage_WorkflowTileInfo_Icon.htm)|  
[ID](P_Tessa_Workflow_Storage_WorkflowTileInfo_ID.htm)|  
[IsGlobal](P_Tessa_Workflow_Storage_WorkflowTileInfo_IsGlobal.htm)|  
[Name](P_Tessa_Workflow_Storage_WorkflowTileInfo_Name.htm)|  
[NestedTiles](P_Tessa_Workflow_Storage_WorkflowTileInfo_NestedTiles.htm)|  
[OpenEditor](P_Tessa_Workflow_Storage_WorkflowTileInfo_OpenEditor.htm)|  
[Order](P_Tessa_Workflow_Storage_WorkflowTileInfo_Order.htm)|  
[TileSize](P_Tessa_Workflow_Storage_WorkflowTileInfo_TileSize.htm)|  
[Tooltip](P_Tessa_Workflow_Storage_WorkflowTileInfo_Tooltip.htm)|  
[WorkflowType](P_Tessa_Workflow_Storage_WorkflowTileInfo_WorkflowType.htm)|  
## __Методы
