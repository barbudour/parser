...
C# __Копировать
     public class KeyDownWeakEventManager : WeakEventManager<KeyDownWeakEventManager, UIElement>
VB __Копировать
     Public Class KeyDownWeakEventManager
    	Inherits WeakEventManager(Of KeyDownWeakEventManager, UIElement)
C++ __Копировать
     public ref class KeyDownWeakEventManager : public WeakEventManager<KeyDownWeakEventManager^, UIElement^>
F# __Копировать
     type KeyDownWeakEventManager = 
        class
            inherit WeakEventManager<KeyDownWeakEventManager, UIElement>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[WeakEventManager](https://learn.microsoft.com/dotnet/api/system.windows.weakeventmanager) __[WeakEventManager](T_Tessa_UI_WeakEventManager_2.htm)<KeyDownWeakEventManager, [UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement)> __ KeyDownWeakEventManager
##  __Конструкторы
[KeyDownWeakEventManager](M_Tessa_UI_Windows_KeyDownWeakEventManager__ctor.htm)|
Инициализирует новый экземпляр класса KeyDownWeakEventManager  
---|---  
##  __Свойства
...
[StartListening(UIElement)](M_Tessa_UI_Windows_KeyDownWeakEventManager_StartListening.htm)|
Присоединяет обработчик события от текущего объекта для заданного источника.  
...
(Унаследован от [WeakEventManager<TManager,
TEventSource>](T_Tessa_UI_WeakEventManager_2.htm))  
[StopListening(UIElement)](M_Tessa_UI_Windows_KeyDownWeakEventManager_StopListening.htm)|
Отсоединяет обработчик события от текущего объекта для заданного источника.  
(Переопределяет [WeakEventManager<TManager,
