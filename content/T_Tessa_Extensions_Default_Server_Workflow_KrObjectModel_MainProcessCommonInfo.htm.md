...
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class MainProcessCommonInfo
    	Inherits ProcessCommonInfo
C++ __Копировать
    [SerializableAttribute]
    public ref class MainProcessCommonInfo sealed : public ProcessCommonInfo
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type MainProcessCommonInfo = 
        class
            inherit ProcessCommonInfo
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ProcessCommonInfo](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo.htm) __ MainProcessCommonInfo
##  __Конструкторы
[MainProcessCommonInfo(Dictionary<String,
Object>)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MainProcessCommonInfo__ctor.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
---|---  
[MainProcessCommonInfo(Nullable<Guid>, IDictionary<String, Object>,
Nullable<Guid>, Nullable<Guid>, String, String, Int32, Nullable<Guid>,
String)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MainProcessCommonInfo__ctor_1.htm)|
Инициализирует новый экземпляр класса MainProcessCommonInfo.  
## __Свойства
[AffectMainCardVersionWhenStateChanged](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MainProcessCommonInfo_AffectMainCardVersionWhenStateChanged.htm)|
Возвращает или задаёт признак, показывающий, что версия основной карточки
должна быть изменена, если состояние документа изменилось.  
---|---  
[AffectMainCardVersionWhenStateChangedTimestamp](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MainProcessCommonInfo_AffectMainCardVersionWhenStateChangedTimestamp.htm)|
Возвращает или задаёт штамп времени изменения флага версии основной карточки.  
[AuthorComment](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MainProcessCommonInfo_AuthorComment.htm)|
Возвращает или задаёт комментарий инициатора процесса.  
[AuthorCommentTimestamp](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MainProcessCommonInfo_AuthorCommentTimestamp.htm)|
Возвращает или задаёт штамп времени изменения комментарий инициатора процесса.  
[AuthorID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_AuthorID.htm)|
...
[AuthorName](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_AuthorName.htm)|
Возвращает или задаёт имя инициатора процесса.  
(Унаследован от
[ProcessCommonInfo](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo.htm))  
[AuthorTimestamp](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_AuthorTimestamp.htm)|
...
(Унаследован от
[ProcessCommonInfo](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo.htm))  
[ProcessOwnerID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_ProcessOwnerID.htm)|
Возвращает или задаёт идентификатор владельца процесса.  
(Унаследован от
[ProcessCommonInfo](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo.htm))  
[ProcessOwnerName](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_ProcessOwnerName.htm)|
Возвращает или задаёт имя владельца процесса.  
(Унаследован от
[ProcessCommonInfo](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo.htm))  
[ProcessOwnerTimestamp](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo_ProcessOwnerTimestamp.htm)|
...
(Унаследован от
[ProcessCommonInfo](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_ProcessCommonInfo.htm))  
[State](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MainProcessCommonInfo_State.htm)|
Возвращает или задаёт состояние процесса.  
[StateTimestamp](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MainProcessCommonInfo_StateTimestamp.htm)|
