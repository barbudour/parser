# INamedObservableCollection<TItem, TCollection> \- интерфейс
...
C# __Копировать
     public interface INamedObservableCollection<TItem, out TCollection> : IObservableCollection<TItem, TCollection>, 
...
VB __Копировать
     Public Interface INamedObservableCollection(Of TItem As {Class, INamedItem}, Out TCollection As {Class, Object, IObservableCollection(Of TItem, TCollection)})
...
C++ __Копировать
    ...
    public interface class INamedObservableCollection : IObservableCollection<TItem, TCollection>, 
    	IList<TItem>, ICollection<TItem>, IEnumerable<TItem>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
F# __Копировать
     type INamedObservableCollection<'TItem, 'TCollection when 'TItem : not struct and INamedItem when 'TCollection : not struct and Object and IObservableCollection<'TItem, 'TCollection>> = 
        interface
