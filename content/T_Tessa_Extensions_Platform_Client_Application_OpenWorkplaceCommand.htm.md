...
C# __Копировать
     public sealed class OpenWorkplaceCommand : Command
VB __Копировать
     Public NotInheritable Class OpenWorkplaceCommand
    	Inherits Command
C++ __Копировать
     public ref class OpenWorkplaceCommand sealed : public Command
F# __Копировать
     [<SealedAttribute>]
    type OpenWorkplaceCommand = 
        class
            inherit Command
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Command](T_Tessa_UI_Command.htm) __ OpenWorkplaceCommand
##  __Конструкторы
[OpenWorkplaceCommand](M_Tessa_Extensions_Platform_Client_Application_OpenWorkplaceCommand__ctor.htm)|
Инициализирует новый экземпляр класса OpenWorkplaceCommand  
---|---  
##  __Методы
[CanExecute](M_Tessa_Extensions_Platform_Client_Application_OpenWorkplaceCommand_CanExecute.htm)|
...
[Execute](M_Tessa_Extensions_Platform_Client_Application_OpenWorkplaceCommand_Execute.htm)|
