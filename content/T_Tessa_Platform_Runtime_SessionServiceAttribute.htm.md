...
C# __Копировать
    ...
    public sealed class SessionServiceAttribute : Attribute
VB __Копировать
    <AttributeUsageAttribute(AttributeTargets.Interface)>
    Public NotInheritable Class SessionServiceAttribute
    	Inherits Attribute
C++ __Копировать
    [AttributeUsageAttribute(AttributeTargets::Interface)]
    public ref class SessionServiceAttribute sealed : public Attribute
F# __Копировать
     [<SealedAttribute>]
    [<AttributeUsageAttribute(AttributeTargets.Interface)>]
    type SessionServiceAttribute = 
        class
            inherit Attribute
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Attribute](https://learn.microsoft.com/dotnet/api/system.attribute) __ SessionServiceAttribute
##  __Конструкторы
[SessionServiceAttribute](M_Tessa_Platform_Runtime_SessionServiceAttribute__ctor.htm)|
Описывает интерфейс веб-сервиса Tessa.  
---|---  
## __Свойства
[ServiceAddress](P_Tessa_Platform_Runtime_SessionServiceAttribute_ServiceAddress.htm)|
Относительный адрес веб-сервиса, при необходимости с указанием конечной точки.
Адрес указывается относительно базового адреса сервисов.  
---|---  
[TransferMode](P_Tessa_Platform_Runtime_SessionServiceAttribute_TransferMode.htm)|
Способ передачи информации при взаимодействии с веб-сервисом. Например,
передача может быть буферизированной или потоковой.  
