# CardGetFileVersionsResponse - класс
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_CardGetFileVersionsResponse_Clone.htm)|  Выполняет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Cards_CardGetFileVersionsResponse_EnsureCacheResolved.htm)|
...
[EraseOnError](M_Tessa_Cards_CardGetFileVersionsResponse_EraseOnError.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[FromTypedJson](M_Tessa_Cards_CardGetFileVersionsResponse_FromTypedJson.htm)|
Устанавливает содержимое объекта в соответствии с данными, десериализованными
...
не найден.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetFileVersions](M_Tessa_Cards_CardGetFileVersionsResponse_TryGetFileVersions.htm)|
