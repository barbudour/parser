# CardApplicationPackageBinder - класс
...
C# __Копировать
     public sealed class CardApplicationPackageBinder : IApplicationPackageBinder
VB __Копировать
     Public NotInheritable Class CardApplicationPackageBinder
    	Implements IApplicationPackageBinder
C++ __Копировать
     public ref class CardApplicationPackageBinder sealed : IApplicationPackageBinder
F# __Копировать
     [<SealedAttribute>]
    type CardApplicationPackageBinder = 
        class
            interface IApplicationPackageBinder
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardApplicationPackageBinder
Implements
    [IApplicationPackageBinder](T_Tessa_Applications_Package_IApplicationPackageBinder.htm)
##  __Конструкторы
[CardApplicationPackageBinder](M_Tessa_Applications_Package_CardApplicationPackageBinder__ctor.htm)|
Initializes a new instance of the CardApplicationPackageBinder class.
Инициализирует новый экземпляр класса
[Object](https://learn.microsoft.com/dotnet/api/system.object).  
---|---  
## __Методы
[BindAsync](M_Tessa_Applications_Package_CardApplicationPackageBinder_BindAsync.htm)|
