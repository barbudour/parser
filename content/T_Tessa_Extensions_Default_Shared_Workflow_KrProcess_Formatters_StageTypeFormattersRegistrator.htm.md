# StageTypeFormattersRegistrator - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
    <RegistratorAttribute(ExtensionStage.AfterPlatform)>
    Public Class StageTypeFormattersRegistrator
    	Inherits RegistratorBase
C++ __Копировать
    [RegistratorAttribute(ExtensionStage::AfterPlatform)]
    public ref class StageTypeFormattersRegistrator : public RegistratorBase
F# __Копировать
     [<RegistratorAttribute(ExtensionStage.AfterPlatform)>]
    type StageTypeFormattersRegistrator = 
        class
            inherit RegistratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm) __ StageTypeFormattersRegistrator
##  __Конструкторы
[StageTypeFormattersRegistrator](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_Formatters_StageTypeFormattersRegistrator__ctor.htm)|
Инициализирует новый экземпляр класса StageTypeFormattersRegistrator  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[FinalizeRegistration](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_Formatters_StageTypeFormattersRegistrator_FinalizeRegistration.htm)|  
(Переопределяет
...
в этом объекте.  
(Унаследован от [RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm))  
[RegisterUnity](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_Formatters_StageTypeFormattersRegistrator_RegisterUnity.htm)|  
(Переопределяет
