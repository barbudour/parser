...
C# __Копировать
     public abstract class CardMetadataBuilderBase : ICardMetadataBuilder
VB __Копировать
     Public MustInherit Class CardMetadataBuilderBase
    	Implements ICardMetadataBuilder
C++ __Копировать
     public ref class CardMetadataBuilderBase abstract : ICardMetadataBuilder
F# __Копировать
     [<AbstractClassAttribute>]
    type CardMetadataBuilderBase = 
        class
            interface ICardMetadataBuilder
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardMetadataBuilderBase
Derived
[Tessa.Cards.Metadata.CardMetadataBuilder](T_Tessa_Cards_Metadata_CardMetadataBuilder.htm)
[Tessa.Cards.Metadata.CardMetadataUsageBuilder](T_Tessa_Cards_Metadata_CardMetadataUsageBuilder.htm)
Implements
    [ICardMetadataBuilder](T_Tessa_Cards_Metadata_ICardMetadataBuilder.htm)
##  __Конструкторы
[CardMetadataBuilderBase](M_Tessa_Cards_Metadata_CardMetadataBuilderBase__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Методы
[AddCardTypeAsync](M_Tessa_Cards_Metadata_CardMetadataBuilderBase_AddCardTypeAsync.htm)|
...
[CardMetadata](T_Tessa_Cards_Metadata_CardMetadata.htm) по заданным типам
карточек cardTypes и возвращает созданный объект.  
[CheckCardType](M_Tessa_Cards_Metadata_CardMetadataBuilderBase_CheckCardType.htm)|
