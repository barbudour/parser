# KrDocStateDeleteExtension - класс
...
C# __Копировать
     public sealed class KrDocStateDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class KrDocStateDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class KrDocStateDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type KrDocStateDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ KrDocStateDeleteExtension
##  __Конструкторы
[KrDocStateDeleteExtension](M_Tessa_Extensions_Default_Server_Cards_KrDocStateDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrDocStateDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Cards_KrDocStateDeleteExtension_BeforeRequest.htm)|  
(Переопределяет
