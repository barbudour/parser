# NotificationTypeUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class NotificationTypeUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class NotificationTypeUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class NotificationTypeUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type NotificationTypeUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ NotificationTypeUIExtension
##  __Конструкторы
[NotificationTypeUIExtension](M_Tessa_Extensions_Platform_Client_UI_NotificationTypeUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса NotificationTypeUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_NotificationTypeUIExtension_Initialized.htm)|  
(Переопределяет
