# KrConstants.KrApprovalCommonInfo.StateName - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Const StateName As String = "StateName"
C++ __Копировать
     public:
    literal String^ StateName = "StateName"
F# __Копировать
     static val mutable StateName: string
#### Значение поля
