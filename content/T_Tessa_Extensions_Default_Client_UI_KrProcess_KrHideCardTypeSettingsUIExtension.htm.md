# KrHideCardTypeSettingsUIExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrHideCardTypeSettingsUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrHideCardTypeSettingsUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrHideCardTypeSettingsUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrHideCardTypeSettingsUIExtension
##  __Конструкторы
[KrHideCardTypeSettingsUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrHideCardTypeSettingsUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrHideCardTypeSettingsUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrHideCardTypeSettingsUIExtension_Initialized.htm)|  
(Переопределяет
