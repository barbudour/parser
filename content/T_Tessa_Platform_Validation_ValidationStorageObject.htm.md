...
C# __Копировать
    ...
    public abstract class ValidationStorageObject : StorageObject, 
    	IValidationObject, IValidatable
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class ValidationStorageObject
    	Inherits StorageObject
    	Implements IValidationObject, IValidatable
C++ __Копировать
    [SerializableAttribute]
    public ref class ValidationStorageObject abstract : public StorageObject, 
    	IValidationObject, IValidatable
F# __Копировать
     [<AbstractClassAttribute>]
    [<SerializableAttribute>]
    type ValidationStorageObject = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ValidationStorageObject
Derived
[Tessa.Cards.CardStorageObject](T_Tessa_Cards_CardStorageObject.htm)
[Tessa.Forums.Notifications.FmNotificationItem](T_Tessa_Forums_Notifications_FmNotificationItem.htm)
[Tessa.Platform.Licensing.License](T_Tessa_Platform_Licensing_License.htm)
[Tessa.Platform.Licensing.LicenseModule](T_Tessa_Platform_Licensing_LicenseModule.htm)
[Tessa.Platform.Validation.ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm)
[Tessa.Platform.Validation.ValidationStorageResultBuilder](T_Tessa_Platform_Validation_ValidationStorageResultBuilder.htm)
[Tessa.Platform.Validation.ValidationStorageResultItem](T_Tessa_Platform_Validation_ValidationStorageResultItem.htm)
Подробнее __Less __
Implements
...
##  __Конструкторы
[ValidationStorageObject(Dictionary<String,
Object>)](M_Tessa_Platform_Validation_ValidationStorageObject__ctor.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
---|---  
[ValidationStorageObject(SerializationInfo,
StreamingContext)](M_Tessa_Platform_Validation_ValidationStorageObject__ctor_1.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[GetFieldName<T>](M_Tessa_Platform_Validation_ValidationStorageObject_GetFieldName__1.htm)|
...
[ValidateInternal](M_Tessa_Platform_Validation_ValidationStorageObject_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
##  __Поля
[PropertyHasInvalidItemsOrNotExists](F_Tessa_Platform_Validation_ValidationStorageObject_PropertyHasInvalidItemsOrNotExists.htm)|
Ключ сообщения валидации о том, что заданное свойство содержит неверные
элементы, или свойство отсутствует в хранилище.  
---|---  
[PropertyIsEmpty](F_Tessa_Platform_Validation_ValidationStorageObject_PropertyIsEmpty.htm)|
Ключ сообщения валидации о том, что у заданного свойства пустое значение.  
[PropertyIsEmptyOrNotExists](F_Tessa_Platform_Validation_ValidationStorageObject_PropertyIsEmptyOrNotExists.htm)|
Ключ сообщения валидации о том, что у заданного свойства пустое значение, или
свойство отсутствует в хранилище.  
[PropertyIsInvalid](F_Tessa_Platform_Validation_ValidationStorageObject_PropertyIsInvalid.htm)|
Ключ сообщения валидации о том, что у заданного свойства некорректное
значение.  
[PropertyIsInvalidOrNotExists](F_Tessa_Platform_Validation_ValidationStorageObject_PropertyIsInvalidOrNotExists.htm)|
Ключ сообщения валидации о том, что у заданного свойства некорректное значение
или свойство отсутствует в хранилище.  
[PropertyNotExists](F_Tessa_Platform_Validation_ValidationStorageObject_PropertyNotExists.htm)|
Ключ сообщения валидации о том, что заданное свойство отсутствует в хранилище.  
## __Методы расширения
