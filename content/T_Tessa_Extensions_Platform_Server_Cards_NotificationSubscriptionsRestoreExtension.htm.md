# NotificationSubscriptionsRestoreExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Cards](N_Tessa_Extensions_Platform_Server_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class NotificationSubscriptionsRestoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class NotificationSubscriptionsRestoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class NotificationSubscriptionsRestoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type NotificationSubscriptionsRestoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ NotificationSubscriptionsRestoreExtension
##  __Конструкторы
[NotificationSubscriptionsRestoreExtension](M_Tessa_Extensions_Platform_Server_Cards_NotificationSubscriptionsRestoreExtension__ctor.htm)|
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Cards_NotificationSubscriptionsRestoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
