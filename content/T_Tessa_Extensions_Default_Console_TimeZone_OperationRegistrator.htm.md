...
##  __Конструкторы
[OperationRegistrator](M_Tessa_Extensions_Default_Console_TimeZone_OperationRegistrator__ctor.htm)|
...
в этом объекте.  
(Унаследован от [RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm))  
[RegisterUnity](M_Tessa_Extensions_Default_Console_TimeZone_OperationRegistrator_RegisterUnity.htm)|  
(Переопределяет
