# CheckSavingFilesUIExtension - класс
...
C# __Копировать
     public sealed class CheckSavingFilesUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class CheckSavingFilesUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class CheckSavingFilesUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type CheckSavingFilesUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ CheckSavingFilesUIExtension
##  __Конструкторы
[CheckSavingFilesUIExtension](M_Tessa_Extensions_Platform_Client_UI_CheckSavingFilesUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса CheckSavingFilesUIExtension  
---|---  
##  __Методы
