# ViewModelRegisteredEventManager - класс
##  __Definition
 **Пространство имён:** [Tessa.UI](N_Tessa_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class ViewModelRegisteredEventManager : WeakEventManagerBase<ViewModelRegisteredEventManager, ViewModelScope>
VB __Копировать
     Public NotInheritable Class ViewModelRegisteredEventManager
    	Inherits WeakEventManagerBase(Of ViewModelRegisteredEventManager, ViewModelScope)
C++ __Копировать
     public ref class ViewModelRegisteredEventManager sealed : public WeakEventManagerBase<ViewModelRegisteredEventManager^, ViewModelScope^>
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[WeakEventManager](https://learn.microsoft.com/dotnet/api/system.windows.weakeventmanager) __[WeakEventManagerBase](T_Tessa_UI_WeakEventManagerBase_2.htm)<ViewModelRegisteredEventManager, [ViewModelScope](T_Tessa_UI_ViewModelScope.htm)> __ ViewModelRegisteredEventManager
##  __Свойства
[AllModels](P_Tessa_UI_ViewModelRegisteredEventManager_AllModels.htm)|  
---|---  
...
[WeakEventManager](https://learn.microsoft.com/dotnet/api/system.windows.weakeventmanager))  
##  __Методы
[AddListener(ViewModelScope,
IWeakEventListener)](M_Tessa_UI_ViewModelRegisteredEventManager_AddListener.htm)|  
---|---  
[AddListener(ViewModelScope, IWeakEventListener,
Object)](M_Tessa_UI_ViewModelRegisteredEventManager_AddListener_1.htm)|  
...
(Унаследован от
[WeakEventManager](https://learn.microsoft.com/dotnet/api/system.windows.weakeventmanager))  
[Purge](M_Tessa_UI_ViewModelRegisteredEventManager_Purge.htm)|  
(Переопределяет [WeakEventManager.Purge(Object, Object,
Boolean)](https://learn.microsoft.com/dotnet/api/system.windows.weakeventmanager.purge#system-
...
(Унаследован от
[WeakEventManager](https://learn.microsoft.com/dotnet/api/system.windows.weakeventmanager))  
[RemoveListener(ViewModelScope,
IWeakEventListener)](M_Tessa_UI_ViewModelRegisteredEventManager_RemoveListener.htm)|  
[RemoveListener(ViewModelScope, IWeakEventListener,
Object)](M_Tessa_UI_ViewModelRegisteredEventManager_RemoveListener_1.htm)|  
...
(Унаследован от [WeakEventManagerBase<TManager,
TEventSource>](T_Tessa_UI_WeakEventManagerBase_2.htm))  
[StartListening(ViewModelScope)](M_Tessa_UI_ViewModelRegisteredEventManager_StartListening.htm)|  
(Переопределяет [WeakEventManagerBase<TManager,
TEventSource>.StartListening(TEventSource)](M_Tessa_UI_WeakEventManagerBase_2_StartListening_1.htm))  
...
(Унаследован от [WeakEventManagerBase<TManager,
TEventSource>](T_Tessa_UI_WeakEventManagerBase_2.htm))  
[StopListening(ViewModelScope)](M_Tessa_UI_ViewModelRegisteredEventManager_StopListening.htm)|  
(Переопределяет [WeakEventManagerBase<TManager,
TEventSource>.StopListening(TEventSource)](M_Tessa_UI_WeakEventManagerBase_2_StopListening_1.htm))  
