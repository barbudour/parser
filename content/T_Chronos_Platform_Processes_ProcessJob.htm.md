...
##  __Конструкторы
[ProcessJob](M_Chronos_Platform_Processes_ProcessJob__ctor.htm)|  Создаёт
экземпляр класса. Выполняет создание объекта Job средствами WinAPI.  
---|---  
## __Методы
[AddProcess](M_Chronos_Platform_Processes_ProcessJob_AddProcess.htm)|
Добавляет Handle процесса в объект WinAPI Job.  
---|---  
[Dispose](M_Chronos_Platform_Processes_ProcessJob_Dispose.htm)|  Освобождает
...
[Finalize](M_Chronos_Platform_Processes_ProcessJob_Finalize.htm)|  Финализатор
объекта.  
(Переопределяет
