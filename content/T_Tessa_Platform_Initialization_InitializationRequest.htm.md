...
C# __Копировать
    ...
    public sealed class InitializationRequest : ValidationInfoStorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class InitializationRequest
    	Inherits ValidationInfoStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class InitializationRequest sealed : public ValidationInfoStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm) __ InitializationRequest
Implements
    [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable)
##  __Конструкторы
[InitializationRequest()](M_Tessa_Platform_Initialization_InitializationRequest__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[InitializationRequest(Dictionary<String,
Object>)](M_Tessa_Platform_Initialization_InitializationRequest__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[InitializationRequest(IStorageObjectProvider)](M_Tessa_Platform_Initialization_InitializationRequest__ctor_2.htm)|
...
## __Свойства
[BuildDate](P_Tessa_Platform_Initialization_InitializationRequest_BuildDate.htm)|
Строка с датой сборки платформы, которая передаётся от клиентского приложения
к серверу. По умолчанию заполняется как текущая дата сборки платформы.  
---|---  
[CachedConfigurationVersion](P_Tessa_Platform_Initialization_InitializationRequest_CachedConfigurationVersion.htm)|
Версия конфигурации, которая кэширована локально на клиенте, или null, если в
клиенте отсутствует локальный кэш или он не поддерживается. Если сервер
обнаруживает, что версия не изменилась, то данные по конфигурации не будут
возвращены. По умолчанию значение равно null.  
[CachedSessionInfo](P_Tessa_Platform_Initialization_InitializationRequest_CachedSessionInfo.htm)|
Информация по сессии, которая кэширована локально на клиенте. Может
использоваться для определения того, что кэш с метаинформацией необходимо не
использовать, даже если версия конфигурации совпадает (например, отличается
язык сотрудника).  
...
(Унаследован от
[ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm))  
[PublishMode](P_Tessa_Platform_Initialization_InitializationRequest_PublishMode.htm)|
Признак того, что выполняется инициализация при публикации приложения.  
[Version](P_Tessa_Platform_Initialization_InitializationRequest_Version.htm)|
Строка с версией платформы, которая передаётся от клиентского приложения к
серверу. По умолчанию заполняется как текущая версия платформы.  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Platform_Initialization_InitializationRequest_Clone.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Platform_Initialization_InitializationRequest_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetCachedSessionInfo](M_Tessa_Platform_Initialization_InitializationRequest_TryGetCachedSessionInfo.htm)|
Возвращает информацию по сессии, которая кэширована локально на клиенте, или
null, если информация ещё не была задана.  
[TryGetCachedSessionToken](M_Tessa_Platform_Initialization_InitializationRequest_TryGetCachedSessionToken.htm)|
Возвращает информацию по сессии
[SessionToken](T_Tessa_Platform_Runtime_SessionToken.htm), которая кэширована
локально на клиенте, или null, если информация ещё не была задана.  
...
[ValidationInfoStorageObject](T_Tessa_Platform_Validation_ValidationInfoStorageObject.htm))  
##  __Поля
[ApplicationIDKey](F_Tessa_Platform_Initialization_InitializationRequest_ApplicationIDKey.htm)|  
---|---  
[BuildDateKey](F_Tessa_Platform_Initialization_InitializationRequest_BuildDateKey.htm)|  
[CachedConfigurationVersionKey](F_Tessa_Platform_Initialization_InitializationRequest_CachedConfigurationVersionKey.htm)|  
[CachedSessionInfoKey](F_Tessa_Platform_Initialization_InitializationRequest_CachedSessionInfoKey.htm)|  
[PublishModeKey](F_Tessa_Platform_Initialization_InitializationRequest_PublishModeKey.htm)|  
[VersionKey](F_Tessa_Platform_Initialization_InitializationRequest_VersionKey.htm)|  
## __Методы расширения
