# KrPermissionSectionSettings.MaskedFields - свойство
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public HashSet<Guid> MaskedFields { get; set; }
VB __Копировать
     Public Property MaskedFields As HashSet(Of Guid)
    	Get
    	Set
C++ __Копировать
     public:
    property HashSet<Guid>^ MaskedFields {
    	HashSet<Guid>^ get ();
    	void set (HashSet<Guid>^ value);
    }
F# __Копировать
     member MaskedFields : HashSet<Guid> with get, set
#### Значение свойства
