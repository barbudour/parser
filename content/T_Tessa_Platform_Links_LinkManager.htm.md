...
C++ __Копировать
     public ref class LinkManager sealed : ILinkManager
F# __Копировать
     [<SealedAttribute>]
    type LinkManager = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ LinkManager
Implements
    [ILinkManager](T_Tessa_Platform_Links_ILinkManager.htm)
##  __Конструкторы
[LinkManager](M_Tessa_Platform_Links_LinkManager__ctor.htm)|  Создаёт
экземпляр класса с указанием значений его свойств.  
---|---  
## __Свойства
[ExecutableAssembly](P_Tessa_Platform_Links_LinkManager_ExecutableAssembly.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[HandleAsync](M_Tessa_Platform_Links_LinkManager_HandleAsync.htm)| Выполняет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Register](M_Tessa_Platform_Links_LinkManager_Register.htm)| Регистрирует
