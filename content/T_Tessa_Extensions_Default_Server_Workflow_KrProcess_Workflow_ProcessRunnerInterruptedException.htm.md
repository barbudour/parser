# ProcessRunnerInterruptedException - класс
...
VB __Копировать
    <SerializableAttribute>
    Public Class ProcessRunnerInterruptedException
    	Inherits Exception
C++ __Копировать
    [SerializableAttribute]
    public ref class ProcessRunnerInterruptedException : public Exception
F# __Копировать
     [<SerializableAttribute>]
    type ProcessRunnerInterruptedException = 
        class
            inherit Exception
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __ ProcessRunnerInterruptedException
##  __Конструкторы
[ProcessRunnerInterruptedException()](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_ProcessRunnerInterruptedException__ctor.htm)|
Инициализирует новый экземпляр класса ProcessRunnerInterruptedException  
---|---  
[ProcessRunnerInterruptedException(String)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_ProcessRunnerInterruptedException__ctor_2.htm)|
Инициализирует новый экземпляр класса ProcessRunnerInterruptedException  
[ProcessRunnerInterruptedException(SerializationInfo,
StreamingContext)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_ProcessRunnerInterruptedException__ctor_1.htm)|
Инициализирует новый экземпляр класса ProcessRunnerInterruptedException  
[ProcessRunnerInterruptedException(String,
Exception)](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_ProcessRunnerInterruptedException__ctor_3.htm)|
Инициализирует новый экземпляр класса ProcessRunnerInterruptedException  
##  __Свойства
