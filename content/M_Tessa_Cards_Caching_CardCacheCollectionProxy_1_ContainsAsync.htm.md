# CardCacheCollectionProxy<T>.ContainsAsync - метод
...
случае.
#### Реализации
[ICardCacheCollection<T>.ContainsAsync(String,
CancellationToken)](M_Tessa_Cards_Caching_ICardCacheCollection_1_ContainsAsync.htm)  
##  __Исключения
