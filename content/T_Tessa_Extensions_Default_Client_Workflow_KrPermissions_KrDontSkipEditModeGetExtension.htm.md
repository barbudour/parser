# KrDontSkipEditModeGetExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrDontSkipEditModeGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class KrDontSkipEditModeGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrDontSkipEditModeGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ KrDontSkipEditModeGetExtension
##  __Конструкторы
[KrDontSkipEditModeGetExtension](M_Tessa_Extensions_Default_Client_Workflow_KrPermissions_KrDontSkipEditModeGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrDontSkipEditModeGetExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Client_Workflow_KrPermissions_KrDontSkipEditModeGetExtension_BeforeRequest.htm)|  
(Переопределяет
