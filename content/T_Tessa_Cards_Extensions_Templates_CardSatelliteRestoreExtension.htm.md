# CardSatelliteRestoreExtension - класс
...
C# __Копировать
     public abstract class CardSatelliteRestoreExtension : CardDeleteExtension
VB __Копировать
     Public MustInherit Class CardSatelliteRestoreExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class CardSatelliteRestoreExtension abstract : public CardDeleteExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type CardSatelliteRestoreExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ CardSatelliteRestoreExtension
##  __Конструкторы
[CardSatelliteRestoreExtension](M_Tessa_Cards_Extensions_Templates_CardSatelliteRestoreExtension__ctor.htm)|
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Cards_Extensions_Templates_CardSatelliteRestoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsMainCardTypeAsync](M_Tessa_Cards_Extensions_Templates_CardSatelliteRestoreExtension_IsMainCardTypeAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetSatelliteCardAsync](M_Tessa_Cards_Extensions_Templates_CardSatelliteRestoreExtension_TryGetSatelliteCardAsync.htm)|
