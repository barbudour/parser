# ValidateNotNullTableStoreExtension - класс
...
C# __Копировать
     public sealed class ValidateNotNullTableStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class ValidateNotNullTableStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class ValidateNotNullTableStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type ValidateNotNullTableStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ ValidateNotNullTableStoreExtension
##  __Конструкторы
[ValidateNotNullTableStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_ValidateNotNullTableStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса ValidateNotNullTableStoreExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_ValidateNotNullTableStoreExtension_AfterRequest.htm)|  
(Переопределяет
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Cards_ValidateNotNullTableStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
