...
C++ __Копировать
     public ref class SplashWindow : public Window, 
    	ISplashWindow, IComponentConnector
F# __Копировать
     type SplashWindow = 
        class
...
##  __Конструкторы
[SplashWindow](M_Tessa_UI_Runtime_SplashWindow__ctor.htm)| Создаёт экземпляр
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[IsCollapsed](P_Tessa_UI_Runtime_SplashWindow_IsCollapsed.htm)| Признак того,
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[Text](P_Tessa_UI_Runtime_SplashWindow_Text.htm)| Текст сообщения на экране
загрузки.  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[InitializeComponent](M_Tessa_UI_Runtime_SplashWindow_InitializeComponent.htm)|
InitializeComponent  
...
(Унаследован от
[Window](https://learn.microsoft.com/dotnet/api/system.windows.window))  
[OnActivated(EventArgs)](M_Tessa_UI_Runtime_SplashWindow_OnActivated.htm)|  
