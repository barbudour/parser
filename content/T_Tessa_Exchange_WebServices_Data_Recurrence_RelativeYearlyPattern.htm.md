# Recurrence.RelativeYearlyPattern - класс
...
VB __Копировать
     Public NotInheritable Class RelativeYearlyPattern
    	Inherits Recurrence
C++ __Копировать
     public ref class RelativeYearlyPattern sealed : public Recurrence
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[Recurrence](T_Tessa_Exchange_WebServices_Data_Recurrence.htm) __ Recurrence.RelativeYearlyPattern
##  __Конструкторы
[Recurrence.RelativeYearlyPattern()](M_Tessa_Exchange_WebServices_Data_Recurrence_RelativeYearlyPattern__ctor.htm)|
Initializes a new instance of the Recurrence.RelativeYearlyPattern class.  
---|---  
[Recurrence.RelativeYearlyPattern(DateTime, Month, DayOfTheWeek,
DayOfTheWeekIndex)](M_Tessa_Exchange_WebServices_Data_Recurrence_RelativeYearlyPattern__ctor_1.htm)|
Initializes a new instance of the Recurrence.RelativeYearlyPattern class.  
## __Свойства
[DayOfTheWeek](P_Tessa_Exchange_WebServices_Data_Recurrence_RelativeYearlyPattern_DayOfTheWeek.htm)|
Gets or sets the day of the week when each occurrence happens.  
---|---  
[DayOfTheWeekIndex](P_Tessa_Exchange_WebServices_Data_Recurrence_RelativeYearlyPattern_DayOfTheWeekIndex.htm)|
Gets or sets the relative position of the day specified in DayOfTheWeek within
the month.  
...
(Унаследован от
[Recurrence](T_Tessa_Exchange_WebServices_Data_Recurrence.htm))  
[Month](P_Tessa_Exchange_WebServices_Data_Recurrence_RelativeYearlyPattern_Month.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsSame](M_Tessa_Exchange_WebServices_Data_Recurrence_RelativeYearlyPattern_IsSame.htm)|
