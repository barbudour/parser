# StorageMappingExportExtension - класс
...
C# __Копировать
     public class StorageMappingExportExtension : CardGetExtension
VB __Копировать
     Public Class StorageMappingExportExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class StorageMappingExportExtension : public CardGetExtension
F# __Копировать
     type StorageMappingExportExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ StorageMappingExportExtension
##  __Конструкторы
[StorageMappingExportExtension](M_Tessa_Extensions_Platform_Server_Cards_StorageMappingExportExtension__ctor.htm)|
Инициализирует новый экземпляр класса StorageMappingExportExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_StorageMappingExportExtension_AfterRequest.htm)|
