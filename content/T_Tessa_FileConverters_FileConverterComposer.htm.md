...
VB __Копировать
     Public NotInheritable Class FileConverterComposer
    	Implements IFileConverterComposer
C++ __Копировать
     public ref class FileConverterComposer sealed : IFileConverterComposer
F# __Копировать
     [<SealedAttribute>]
    type FileConverterComposer = 
        class
            interface IFileConverterComposer
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FileConverterComposer
Implements
    [IFileConverterComposer](T_Tessa_FileConverters_IFileConverterComposer.htm)
##  __Конструкторы
[FileConverterComposer](M_Tessa_FileConverters_FileConverterComposer__ctor.htm)|
