...
C++ __Копировать
     public ref class ServerBusyException : public ServiceResponseException
F# __Копировать
     type ServerBusyException = 
        class
            inherit ServiceResponseException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceRemoteException](T_Tessa_Exchange_WebServices_Data_ServiceRemoteException.htm) __[ServiceResponseException](T_Tessa_Exchange_WebServices_Data_ServiceResponseException.htm) __ ServerBusyException
##  __Конструкторы
[ServerBusyException(ServiceResponse)](M_Tessa_Exchange_WebServices_Data_ServerBusyException__ctor_1.htm)|
Initializes a new instance of the ServerBusyException class.  
---|---  
[ServerBusyException(SerializationInfo,
StreamingContext)](M_Tessa_Exchange_WebServices_Data_ServerBusyException__ctor.htm)|
Initializes a new instance of the ServerBusyException class with serialized
data.  
## __Свойства
[BackOffMilliseconds](P_Tessa_Exchange_WebServices_Data_ServerBusyException_BackOffMilliseconds.htm)|
Suggested number of milliseconds to wait before attempting a request again. If
zero, there is no suggested backoff time.  
---|---  
...
[ErrorCode](P_Tessa_Exchange_WebServices_Data_ServiceResponseException_ErrorCode.htm)|
...
(Унаследован от
[Exception](https://learn.microsoft.com/dotnet/api/system.exception))  
[Message](P_Tessa_Exchange_WebServices_Data_ServiceResponseException_Message.htm)|
Gets a message that describes the current exception.  
(Унаследован от
[ServiceResponseException](T_Tessa_Exchange_WebServices_Data_ServiceResponseException.htm))  
[Response](P_Tessa_Exchange_WebServices_Data_ServiceResponseException_Response.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Exchange_WebServices_Data_ServerBusyException_GetObjectData.htm)|
Sets the
...
(Переопределяет [ServiceResponseException.GetObjectData(SerializationInfo,
StreamingContext)](M_Tessa_Exchange_WebServices_Data_ServiceResponseException_GetObjectData.htm))  
