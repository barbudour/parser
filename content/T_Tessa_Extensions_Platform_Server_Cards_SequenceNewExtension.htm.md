...
C# __Копировать
     public sealed class SequenceNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class SequenceNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class SequenceNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type SequenceNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ SequenceNewExtension
##  __Конструкторы
[SequenceNewExtension](M_Tessa_Extensions_Platform_Server_Cards_SequenceNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса SequenceNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_SequenceNewExtension_AfterRequest.htm)|  
(Переопределяет
