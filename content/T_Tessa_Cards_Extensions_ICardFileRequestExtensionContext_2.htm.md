# ICardFileRequestExtensionContext<TRequest, TResponse> \- интерфейс
Контекст процесса взаимодействия с запросом на файл карточки.
## __Definition
 **Пространство имён:** [Tessa.Cards.Extensions](N_Tessa_Cards_Extensions.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public interface ICardFileRequestExtensionContext<out TRequest, TResponse> : ICardFileExtensionContext, 
    	ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext, ICardRequestExtensionContext<TRequest, TResponse>
    where TRequest : CardInfoStorageObject
    where TResponse : CardInfoStorageObject
VB __Копировать
     Public Interface ICardFileRequestExtensionContext(Of Out TRequest As CardInfoStorageObject, TResponse As CardInfoStorageObject)
    	Inherits ICardFileExtensionContext, ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, 
    	ITraceableExtensionContext, ICardRequestExtensionContext(Of TRequest, TResponse)
C++ __Копировать
    generic<typename TRequest, typename TResponse>
    where TRequest : CardInfoStorageObject
    where TResponse : CardInfoStorageObject
    public interface class ICardFileRequestExtensionContext : ICardFileExtensionContext, 
    	ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext, ICardRequestExtensionContext<TRequest, TResponse>
F# __Копировать
     type ICardFileRequestExtensionContext<'TRequest, 'TResponse when 'TRequest : CardInfoStorageObject when 'TResponse : CardInfoStorageObject> = 
        interface
            ...
            interface ICardRequestExtensionContext<'TRequest, 'TResponse>
        end
Implements
    [ICardExtensionContext](T_Tessa_Cards_Extensions_ICardExtensionContext.htm), [ICardFileExtensionContext](T_Tessa_Cards_Extensions_ICardFileExtensionContext.htm), [ICardRequestExtensionContext](T_Tessa_Cards_Extensions_ICardRequestExtensionContext_2.htm)<TRequest, TResponse>, [ICardTypeExtensionContext](T_Tessa_Cards_Extensions_ICardTypeExtensionContext.htm), [IExtensionContext](T_Tessa_Extensions_IExtensionContext.htm), [ITraceableExtensionContext](T_Tessa_Extensions_ITraceableExtensionContext.htm)
#### Параметры типа
TRequest
    Тип объекта, содержащего информацию по запросу.
TResponse
    Тип объекта, содержащего информацию по ответу на запрос.
##  __Свойства
