# KrTokenToTaskHistoryViewUIExtension - класс
...
C# __Копировать
     public sealed class KrTokenToTaskHistoryViewUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class KrTokenToTaskHistoryViewUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrTokenToTaskHistoryViewUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrTokenToTaskHistoryViewUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrTokenToTaskHistoryViewUIExtension
##  __Конструкторы
[KrTokenToTaskHistoryViewUIExtension](M_Tessa_Extensions_Default_Client_Workflow_KrPermissions_KrTokenToTaskHistoryViewUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrTokenToTaskHistoryViewUIExtension  
---|---  
##  __Методы
...
(Унаследован от [CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm))  
[Initializing](M_Tessa_Extensions_Default_Client_Workflow_KrPermissions_KrTokenToTaskHistoryViewUIExtension_Initializing.htm)|
