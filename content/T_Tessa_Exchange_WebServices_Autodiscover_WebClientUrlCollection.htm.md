...
VB __Копировать
     Public NotInheritable Class WebClientUrlCollection
C++ __Копировать
     public ref class WebClientUrlCollection sealed
F# __Копировать
     [<SealedAttribute>]
    type WebClientUrlCollection = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ WebClientUrlCollection
##  __Свойства
