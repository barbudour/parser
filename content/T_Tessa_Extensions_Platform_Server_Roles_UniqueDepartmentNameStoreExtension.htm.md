# UniqueDepartmentNameStoreExtension - класс
...
C# __Копировать
     public sealed class UniqueDepartmentNameStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class UniqueDepartmentNameStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class UniqueDepartmentNameStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type UniqueDepartmentNameStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ UniqueDepartmentNameStoreExtension
##  __Конструкторы
[UniqueDepartmentNameStoreExtension](M_Tessa_Extensions_Platform_Server_Roles_UniqueDepartmentNameStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса UniqueDepartmentNameStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Roles_UniqueDepartmentNameStoreExtension_AfterBeginTransaction.htm)|  
(Переопределяет
