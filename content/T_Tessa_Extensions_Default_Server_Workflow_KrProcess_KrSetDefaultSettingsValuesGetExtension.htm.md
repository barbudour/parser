# KrSetDefaultSettingsValuesGetExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrSetDefaultSettingsValuesGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class KrSetDefaultSettingsValuesGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrSetDefaultSettingsValuesGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ KrSetDefaultSettingsValuesGetExtension
##  __Конструкторы
[KrSetDefaultSettingsValuesGetExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrSetDefaultSettingsValuesGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrSetDefaultSettingsValuesGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrSetDefaultSettingsValuesGetExtension_AfterRequest.htm)|  
(Переопределяет
