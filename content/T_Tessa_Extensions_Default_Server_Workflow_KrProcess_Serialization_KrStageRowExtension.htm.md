...
C# __Копировать
     public abstract class KrStageRowExtension : IKrStageRowExtension, 
    	IExtension
VB __Копировать
     Public MustInherit Class KrStageRowExtension
    	Implements IKrStageRowExtension, IExtension
C++ __Копировать
     public ref class KrStageRowExtension abstract : IKrStageRowExtension, 
    	IExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type KrStageRowExtension = 
        class
            interface IKrStageRowExtension
            interface IExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ KrStageRowExtension
Derived
[Tessa.Extensions.Default.Server.Workflow.KrProcess.Serialization.ExtraSourcesStageRowExtensionBase](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Serialization_ExtraSourcesStageRowExtensionBase.htm)
Implements
    [IKrStageRowExtension](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Serialization_IKrStageRowExtension.htm), [IExtension](T_Tessa_Extensions_IExtension.htm)
##  __Конструкторы
[KrStageRowExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Serialization_KrStageRowExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrStageRowExtension  
---|---  
##  __Методы
