# DocumentNumberDirector.OnImportingCardAsync - метод
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     protected override Task<bool> OnImportingCardAsync(
    	INumberContext context,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Protected Overrides Function OnImportingCardAsync ( 
    	context As INumberContext,
    	Optional cancellationToken As CancellationToken = Nothing
    ) As Task(Of Boolean)
C++ __Копировать
     protected:
    virtual Task<bool>^ OnImportingCardAsync(
    	INumberContext^ context, 
    	CancellationToken cancellationToken = CancellationToken()
    ) override
F# __Копировать
     abstract OnImportingCardAsync : 
