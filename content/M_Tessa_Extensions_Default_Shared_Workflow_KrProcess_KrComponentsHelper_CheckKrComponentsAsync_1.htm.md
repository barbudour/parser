# KrComponentsHelper.CheckKrComponentsAsync(Card, Nullable<Guid>, IDbScope,
IKrTypesCache, KrComponents, CancellationToken) - метод
...
card [Card](T_Tessa_Cards_Card.htm)
    Карточка, по которой будет определён идентификатор типа документа, если он не задан.
docTypeID
