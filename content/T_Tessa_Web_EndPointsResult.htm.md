...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) __ EndPointsResult
##  __Конструкторы
[EndPointsResult](M_Tessa_Web_EndPointsResult__ctor.htm)| Инициализирует новый
экземпляр класса EndPointsResult  
---|---  
##  __Свойства
[HasAny](P_Tessa_Web_EndPointsResult_HasAny.htm)|  
---|---  
[HasHttps](P_Tessa_Web_EndPointsResult_HasHttps.htm)|  
## __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ToString](M_Tessa_Web_EndPointsResult_ToString.htm)|  
(Переопределяет
