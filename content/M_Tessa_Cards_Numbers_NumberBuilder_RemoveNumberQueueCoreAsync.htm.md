# NumberBuilder.RemoveNumberQueueCoreAsync - метод
...
C# __Копировать
     protected virtual ValueTask<bool> RemoveNumberQueueCoreAsync(
    	INumberContext context,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Protected Overridable Function RemoveNumberQueueCoreAsync ( 
    	context As INumberContext,
    	Optional cancellationToken As CancellationToken = Nothing
    ) As ValueTask(Of Boolean)
C++ __Копировать
     protected:
    virtual ValueTask<bool> RemoveNumberQueueCoreAsync(
    	INumberContext^ context, 
    	CancellationToken cancellationToken = CancellationToken()
    )
F# __Копировать
     abstract RemoveNumberQueueCoreAsync : 
    ...
    *)
    -> ValueTask<bool> 
    override RemoveNumberQueueCoreAsync : 
            context : INumberContext * 
            ?cancellationToken : CancellationToken 
    (* Defaults:
            let _cancellationToken = defaultArg cancellationToken new CancellationToken()
