# TessaShellButton - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Windows](N_Tessa_UI_Windows.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class TessaShellButton : TessaShellControlBase
VB __Копировать
     Public NotInheritable Class TessaShellButton
    	Inherits TessaShellControlBase
C++ __Копировать
     public ref class TessaShellButton sealed : public TessaShellControlBase
F# __Копировать
     [<SealedAttribute>]
    type TessaShellButton = 
        class
            inherit TessaShellControlBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NotificationObject](T_Tessa_Platform_NotificationObject.htm) __[TessaShellControlBase](T_Tessa_UI_Windows_TessaShellControlBase.htm) __ TessaShellButton
##  __Конструкторы
[TessaShellButton](M_Tessa_UI_Windows_TessaShellButton__ctor.htm)|
...
(Унаследован от
[TessaShellControlBase](T_Tessa_UI_Windows_TessaShellControlBase.htm))  
[Command](P_Tessa_UI_Windows_TessaShellButton_Command.htm)|  
