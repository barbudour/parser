...
VB __Копировать
     Public Class KrCardMetadataExtension
    	Inherits KrCardMetadataExtensionBase
C++ __Копировать
     public ref class KrCardMetadataExtension : public KrCardMetadataExtensionBase
F# __Копировать
...
##  __Конструкторы
[KrCardMetadataExtension(IDbScope)](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_KrCardMetadataExtension__ctor_1.htm)|
Инициализирует новый экземпляр класса KrCardMetadataExtension  
---|---  
[KrCardMetadataExtension(ICardMetadata,
ICardCache)](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_KrCardMetadataExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrCardMetadataExtension  
##  __Свойства
...
---|---  
[ExtendKrTypesAsync](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_KrCardMetadataExtension_ExtendKrTypesAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetAllSectionsAsync](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_KrCardMetadataExtension_GetAllSectionsAsync.htm)|
...
[GetCardTypeIDsAsync](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_KrCardMetadataExtension_GetCardTypeIDsAsync.htm)|
