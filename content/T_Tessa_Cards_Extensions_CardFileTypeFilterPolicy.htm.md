# CardFileTypeFilterPolicy - класс
...
C# __Копировать
     public sealed class CardFileTypeFilterPolicy : IFilterPolicy, 
    	IExtensionPolicy
VB __Копировать
     Public NotInheritable Class CardFileTypeFilterPolicy
    	Implements IFilterPolicy, IExtensionPolicy
C++ __Копировать
     public ref class CardFileTypeFilterPolicy sealed : IFilterPolicy, 
    	IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type CardFileTypeFilterPolicy = 
        class
            interface IFilterPolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardFileTypeFilterPolicy
Implements
    [IExtensionPolicy](T_Tessa_Extensions_IExtensionPolicy.htm), [IFilterPolicy](T_Tessa_Extensions_IFilterPolicy.htm)
##  __Конструкторы
[CardFileTypeFilterPolicy](M_Tessa_Cards_Extensions_CardFileTypeFilterPolicy__ctor.htm)|
Инициализирует новый экземпляр класса CardFileTypeFilterPolicy  
---|---  
##  __Свойства
[Instance](P_Tessa_Cards_Extensions_CardFileTypeFilterPolicy_Instance.htm)|
Экземпляр класса.  
---|---  
##  __Методы
...
---|---  
[FilterAsync](M_Tessa_Cards_Extensions_CardFileTypeFilterPolicy_FilterAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetFilterContextAsync](M_Tessa_Cards_Extensions_CardFileTypeFilterPolicy_GetFilterContextAsync.htm)|
