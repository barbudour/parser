# SchemeDatabaseProperties - класс
##  __Definition
 **Пространство имён:** [Tessa.Scheme](N_Tessa_Scheme.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class SchemeDatabaseProperties : SchemeNamedObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class SchemeDatabaseProperties
    	Inherits SchemeNamedObject
C++ __Копировать
    [SerializableAttribute]
    public ref class SchemeDatabaseProperties sealed : public SchemeNamedObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type SchemeDatabaseProperties = 
        class
            inherit SchemeNamedObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[SchemeObject](T_Tessa_Scheme_SchemeObject.htm) __[SchemePartionableObject](T_Tessa_Scheme_SchemePartionableObject.htm) __[SchemeNamedObject](T_Tessa_Scheme_SchemeNamedObject.htm) __ SchemeDatabaseProperties
##  __Конструкторы
[SchemeDatabaseProperties()](M_Tessa_Scheme_SchemeDatabaseProperties__ctor.htm)|
Инициализирует новый экземпляр класса SchemeDatabaseProperties  
Устарело.  
---|---  
[SchemeDatabaseProperties(String)](M_Tessa_Scheme_SchemeDatabaseProperties__ctor_1.htm)|
Инициализирует новый экземпляр класса SchemeDatabaseProperties  
##  __Свойства
[Collation](P_Tessa_Scheme_SchemeDatabaseProperties_Collation.htm)|  
---|---  
...
(Унаследован от [SchemeObject](T_Tessa_Scheme_SchemeObject.htm))  
[Modified](P_Tessa_Scheme_SchemeDatabaseProperties_Modified.htm)|  
[ModifiedByID](P_Tessa_Scheme_SchemeDatabaseProperties_ModifiedByID.htm)|  
[ModifiedByName](P_Tessa_Scheme_SchemeDatabaseProperties_ModifiedByName.htm)|  
...
[SchemePartionableObject](T_Tessa_Scheme_SchemePartionableObject.htm))  
##  __Методы
[BeginDeserializationOverride](M_Tessa_Scheme_SchemeDatabaseProperties_BeginDeserializationOverride.htm)|  
(Переопределяет
...
---|---  
[Copy](M_Tessa_Scheme_SchemeDatabaseProperties_Copy.htm)|  
(Переопределяет
...
(Унаследован от
[SchemePartionableObject](T_Tessa_Scheme_SchemePartionableObject.htm))  
[GetObjectData](M_Tessa_Scheme_SchemeDatabaseProperties_GetObjectData.htm)|  
(Переопределяет
