...
VB __Копировать
     Public NotInheritable Class CommandContextScope
    	Implements IDisposable
C++ __Копировать
     public ref class CommandContextScope sealed : IDisposable
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CommandContextScope
Implements
...
CommandContext.  
## __Методы
[Dispose](M_Tessa_Platform_CommandLine_CommandContextScope_Dispose.htm)|
Restores the original CommandContext to the active context and recycles the
CommandContextScope object.  
---|---  
