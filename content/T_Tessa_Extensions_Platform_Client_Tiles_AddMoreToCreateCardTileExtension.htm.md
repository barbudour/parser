# AddMoreToCreateCardTileExtension - класс
...
C# __Копировать
     public sealed class AddMoreToCreateCardTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class AddMoreToCreateCardTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class AddMoreToCreateCardTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type AddMoreToCreateCardTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ AddMoreToCreateCardTileExtension
##  __Конструкторы
[AddMoreToCreateCardTileExtension](M_Tessa_Extensions_Platform_Client_Tiles_AddMoreToCreateCardTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса AddMoreToCreateCardTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Platform_Client_Tiles_AddMoreToCreateCardTileExtension_InitializingGlobal.htm)|  
(Переопределяет
