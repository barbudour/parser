...
C# __Копировать
    ...
    public sealed class NumberType : RegistryItem<Guid, NumberType>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class NumberType
    	Inherits RegistryItem(Of Guid, NumberType)
C++ __Копировать
    [SerializableAttribute]
    public ref class NumberType sealed : public RegistryItem<Guid, NumberType^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type NumberType = 
        class
            inherit RegistryItem<Guid, NumberType>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[RegistryItem](T_Tessa_Platform_RegistryItem_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), NumberType> __ NumberType
##  __Конструкторы
[NumberType](M_Tessa_Cards_Numbers_NumberType__ctor.htm)| Создаёт экземпляр
...
(Унаследован от [RegistryItem<TIdentifier,
TItem>](T_Tessa_Platform_RegistryItem_2.htm))  
[Registry](P_Tessa_Cards_Numbers_NumberType_Registry.htm)| Реестр, содержащий
...
[FromGuid](M_Tessa_Cards_Numbers_NumberType_FromGuid.htm)|  Возвращает тип по
уникальному идентификатору, полученному посредством метода
[Tessa.Platform.RegistryItem{TItem}.ToGuid].  
[FromName](M_Tessa_Cards_Numbers_NumberType_FromName.htm)|  Возвращает тип по
уникальному имени, полученному посредством метода
...
(Определяется
[ComHelper](T_Tessa_Extensions_Default_Client_EDS_ComHelper.htm))  
[IsKnown](M_Tessa_Cards_Numbers_NumberExtensions_IsKnown_5.htm)|  Возвращает
...
[IsRegistered](M_Tessa_Cards_Numbers_NumberExtensions_IsRegistered_5.htm)|
