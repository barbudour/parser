# KrPermissionsMaskDataGetExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrPermissionsMaskDataGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class KrPermissionsMaskDataGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrPermissionsMaskDataGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ KrPermissionsMaskDataGetExtension
##  __Конструкторы
[KrPermissionsMaskDataGetExtension](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrPermissionsMaskDataGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrPermissionsMaskDataGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrPermissionsMaskDataGetExtension_AfterRequest.htm)|  
(Переопределяет
