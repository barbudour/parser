...
C++ __Копировать
    [SerializableAttribute]
    public ref class ForumSettingsModel : public StorageObject
F# __Копировать
     [<SerializableAttribute>]
    type ForumSettingsModel = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForumSettingsModel
##  __Конструкторы
[ForumSettingsModel()](M_Tessa_Forums_Models_ForumSettingsModel__ctor.htm)|
Инициализирует новый экземпляр класса ForumSettingsModel  
---|---  
[ForumSettingsModel(Dictionary<String,
Object>)](M_Tessa_Forums_Models_ForumSettingsModel__ctor_1.htm)|
Инициализирует новый экземпляр класса ForumSettingsModel  
[ForumSettingsModel(SerializationInfo,
StreamingContext)](M_Tessa_Forums_Models_ForumSettingsModel__ctor_2.htm)|
Инициализирует новый экземпляр класса ForumSettingsModel  
##  __Свойства
[ContentRatio](P_Tessa_Forums_Models_ForumSettingsModel_ContentRatio.htm)|  
---|---  
[HideTopicListNavigation](P_Tessa_Forums_Models_ForumSettingsModel_HideTopicListNavigation.htm)|  
[InputBlockHeight](P_Tessa_Forums_Models_ForumSettingsModel_InputBlockHeight.htm)|  
[IsFullSize](P_Tessa_Forums_Models_ForumSettingsModel_IsFullSize.htm)|  
## __Методы
