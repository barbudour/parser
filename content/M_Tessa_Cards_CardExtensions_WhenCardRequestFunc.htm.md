# CardExtensions.WhenCardRequestFunc - метод
...
C# __Копировать
     public static IExtensionPolicyContainer WhenCardRequestFunc(
    	this IExtensionPolicyContainer policyContainer,
    	Func<ICardRequestExtensionContext, bool> isAllowedFunc
    )
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function WhenCardRequestFunc ( 
    	policyContainer As IExtensionPolicyContainer,
    	isAllowedFunc As Func(Of ICardRequestExtensionContext, Boolean)
    ) As IExtensionPolicyContainer
C++ __Копировать
     public:
    [ExtensionAttribute]
    static IExtensionPolicyContainer^ WhenCardRequestFunc(
    	IExtensionPolicyContainer^ policyContainer, 
    	Func<ICardRequestExtensionContext^, bool>^ isAllowedFunc
    )
F# __Копировать
     [<ExtensionAttribute>]
    static member WhenCardRequestFunc : 
            policyContainer : IExtensionPolicyContainer * 
            isAllowedFunc : Func<ICardRequestExtensionContext, bool> -> IExtensionPolicyContainer 
#### Параметры
policyContainer
...
isAllowedFunc
[Func](https://learn.microsoft.com/dotnet/api/system.func-2)<[ICardRequestExtensionContext](T_Tessa_Cards_Extensions_ICardRequestExtensionContext.htm),
