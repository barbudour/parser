# PreviewExtensionConfigurator - класс
...
C# __Копировать
     public sealed class PreviewExtensionConfigurator : ExtensionSettingsConfiguratorBase
VB __Копировать
     Public NotInheritable Class PreviewExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class PreviewExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type PreviewExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ PreviewExtensionConfigurator
##  __Конструкторы
[PreviewExtensionConfigurator](M_Tessa_Extensions_Default_Client_Views_PreviewExtensionConfigurator__ctor.htm)|
Инициализирует новый экземпляр класса PreviewExtensionConfigurator  
---|---  
##  __Свойства
