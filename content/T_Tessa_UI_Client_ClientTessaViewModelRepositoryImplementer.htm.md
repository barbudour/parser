...
##  __Конструкторы
[ClientTessaViewModelRepositoryImplementer](M_Tessa_UI_Client_ClientTessaViewModelRepositoryImplementer__ctor.htm)|
Initializes a new instance of the ClientTessaViewModelRepositoryImplementer
class.  
---|---  
## __Методы
[ChangeAsync](M_Tessa_UI_Client_ClientTessaViewModelRepositoryImplementer_ChangeAsync.htm)|
Осуществляет изменение элементов хранилища  
---|---  
[DeleteAsync](M_Tessa_UI_Client_ClientTessaViewModelRepositoryImplementer_DeleteAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetAsync](M_Tessa_UI_Client_ClientTessaViewModelRepositoryImplementer_GetAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ImportAsync](M_Tessa_UI_Client_ClientTessaViewModelRepositoryImplementer_ImportAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[NewAsync](M_Tessa_UI_Client_ClientTessaViewModelRepositoryImplementer_NewAsync.htm)|
