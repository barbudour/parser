# ServerInstanceStoreExtension - класс
...
C# __Копировать
     public sealed class ServerInstanceStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class ServerInstanceStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class ServerInstanceStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type ServerInstanceStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ ServerInstanceStoreExtension
##  __Конструкторы
[ServerInstanceStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_ServerInstanceStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса ServerInstanceStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Cards_ServerInstanceStoreExtension_AfterBeginTransaction.htm)|  
(Переопределяет
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Cards_ServerInstanceStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_ServerInstanceStoreExtension_BeforeRequest.htm)|  
(Переопределяет
