# KrCheckGroupBoundariesInSatelliteStoreExtension - класс
...
C# __Копировать
     public sealed class KrCheckGroupBoundariesInSatelliteStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class KrCheckGroupBoundariesInSatelliteStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class KrCheckGroupBoundariesInSatelliteStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type KrCheckGroupBoundariesInSatelliteStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ KrCheckGroupBoundariesInSatelliteStoreExtension
##  __Конструкторы
[KrCheckGroupBoundariesInSatelliteStoreExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrCheckGroupBoundariesInSatelliteStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса
KrCheckGroupBoundariesInSatelliteStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Requests_KrCheckGroupBoundariesInSatelliteStoreExtension_BeforeCommitTransaction.htm)|
