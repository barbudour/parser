# NumberQueueEventTypeRegistry - класс
...
C# __Копировать
     public sealed class NumberQueueEventTypeRegistry : Registry<Guid, NumberQueueEventType>, 
    	INumberQueueEventTypeRegistry, IRegistry<Guid, NumberQueueEventType>
VB __Копировать
     Public NotInheritable Class NumberQueueEventTypeRegistry
    	Inherits Registry(Of Guid, NumberQueueEventType)
    	Implements INumberQueueEventTypeRegistry, IRegistry(Of Guid, NumberQueueEventType)
C++ __Копировать
     public ref class NumberQueueEventTypeRegistry sealed : public Registry<Guid, NumberQueueEventType^>, 
    	INumberQueueEventTypeRegistry, IRegistry<Guid, NumberQueueEventType^>
F# __Копировать
     [<SealedAttribute>]
    type NumberQueueEventTypeRegistry = 
        class
            inherit Registry<Guid, NumberQueueEventType>
            interface INumberQueueEventTypeRegistry
            interface IRegistry<Guid, NumberQueueEventType>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Registry](T_Tessa_Platform_Registry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [NumberQueueEventType](T_Tessa_Cards_Numbers_NumberQueueEventType.htm)> __ NumberQueueEventTypeRegistry
Implements
    [INumberQueueEventTypeRegistry](T_Tessa_Cards_Numbers_INumberQueueEventTypeRegistry.htm), [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [NumberQueueEventType](T_Tessa_Cards_Numbers_NumberQueueEventType.htm)>
##  __Свойства
