# HideTasksFromAuthorStoreExtension - класс
...
C# __Копировать
     public sealed class HideTasksFromAuthorStoreExtension : CardStoreTaskExtension
VB __Копировать
     Public NotInheritable Class HideTasksFromAuthorStoreExtension
    	Inherits CardStoreTaskExtension
C++ __Копировать
     public ref class HideTasksFromAuthorStoreExtension sealed : public CardStoreTaskExtension
F# __Копировать
     [<SealedAttribute>]
    type HideTasksFromAuthorStoreExtension = 
        class
            inherit CardStoreTaskExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreTaskExtension](T_Tessa_Cards_Extensions_CardStoreTaskExtension.htm) __ HideTasksFromAuthorStoreExtension
##  __Конструкторы
[HideTasksFromAuthorStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_HideTasksFromAuthorStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса HideTasksFromAuthorStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreTaskExtension](T_Tessa_Cards_Extensions_CardStoreTaskExtension.htm))  
[StoreTaskBeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_HideTasksFromAuthorStoreExtension_StoreTaskBeforeRequest.htm)|  
(Переопределяет
