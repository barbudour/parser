# ServerInstanceDeleteExtension - класс
...
C# __Копировать
     public sealed class ServerInstanceDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class ServerInstanceDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class ServerInstanceDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type ServerInstanceDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ ServerInstanceDeleteExtension
##  __Конструкторы
[ServerInstanceDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_ServerInstanceDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса ServerInstanceDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Cards_ServerInstanceDeleteExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
