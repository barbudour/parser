# StageTypeDescriptorNotInitializedException - класс
...
VB __Копировать
    <SerializableAttribute>
    Public Class StageTypeDescriptorNotInitializedException
    	Inherits Exception
C++ __Копировать
    [SerializableAttribute]
    public ref class StageTypeDescriptorNotInitializedException : public Exception
F# __Копировать
     [<SerializableAttribute>]
    type StageTypeDescriptorNotInitializedException = 
        class
            inherit Exception
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __ StageTypeDescriptorNotInitializedException
##  __Конструкторы
