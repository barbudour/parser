# KrConstants.KrDialogStageTypeSettingsVirtual.DialogTypeID - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly DialogTypeID As String
C++ __Копировать
     public:
    static initonly String^ DialogTypeID
F# __Копировать
     static val DialogTypeID: string
#### Значение поля
