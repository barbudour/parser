# ForumPermissionsResponse - класс
##  __Definition
 **Пространство имён:** [Tessa.Forums](N_Tessa_Forums.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class ForumPermissionsResponse : StorageObject
VB __Копировать
     Public NotInheritable Class ForumPermissionsResponse
    	Inherits StorageObject
C++ __Копировать
     public ref class ForumPermissionsResponse sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForumPermissionsResponse
##  __Конструкторы
[ForumPermissionsResponse()](M_Tessa_Forums_ForumPermissionsResponse__ctor.htm)|
Инициализирует новый экземпляр класса ForumPermissionsResponse  
---|---  
[ForumPermissionsResponse(Dictionary<String,
Object>)](M_Tessa_Forums_ForumPermissionsResponse__ctor_1.htm)| Инициализирует
новый экземпляр класса ForumPermissionsResponse  
##  __Свойства
[Empty](P_Tessa_Forums_ForumPermissionsResponse_Empty.htm)|  Пустой объект
типа ForumPermissionsResponse.  
---|---  
[HasRequiredPermission](P_Tessa_Forums_ForumPermissionsResponse_HasRequiredPermission.htm)|  
[Participant](P_Tessa_Forums_ForumPermissionsResponse_Participant.htm)|  
## __Методы
