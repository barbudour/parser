# WfTasksClientGetExtension - класс
...
C# __Копировать
     public sealed class WfTasksClientGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class WfTasksClientGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class WfTasksClientGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type WfTasksClientGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ WfTasksClientGetExtension
##  __Конструкторы
[WfTasksClientGetExtension](M_Tessa_Extensions_Default_Client_Workflow_Wf_WfTasksClientGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса WfTasksClientGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Client_Workflow_Wf_WfTasksClientGetExtension_AfterRequest.htm)|  
(Переопределяет
