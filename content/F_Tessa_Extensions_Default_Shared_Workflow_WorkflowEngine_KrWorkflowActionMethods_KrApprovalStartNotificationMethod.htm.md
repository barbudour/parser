# KrWorkflowActionMethods.KrApprovalStartNotificationMethod - поле
...
VB __Копировать
     Public Shared ReadOnly KrApprovalStartNotificationMethod As WorkflowActionMethodDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionMethodDescriptor^ KrApprovalStartNotificationMethod
F# __Копировать
     static val KrApprovalStartNotificationMethod: WorkflowActionMethodDescriptor
#### Значение поля
