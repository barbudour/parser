# KrConstants.KrDialogStageTypeSettingsVirtual.OpenModeName - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly OpenModeName As String
C++ __Копировать
     public:
    static initonly String^ OpenModeName
F# __Копировать
     static val OpenModeName: string
#### Значение поля
