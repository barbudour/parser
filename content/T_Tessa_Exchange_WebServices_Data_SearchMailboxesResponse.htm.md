...
VB __Копировать
     Public NotInheritable Class SearchMailboxesResponse
    	Inherits ServiceResponse
C++ __Копировать
     public ref class SearchMailboxesResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ SearchMailboxesResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[SearchResult](P_Tessa_Exchange_WebServices_Data_SearchMailboxesResponse_SearchResult.htm)|
