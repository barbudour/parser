# WorkflowTilesUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class WorkflowTilesUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class WorkflowTilesUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class WorkflowTilesUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type WorkflowTilesUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ WorkflowTilesUIExtension
##  __Конструкторы
[WorkflowTilesUIExtension](M_Tessa_Extensions_Platform_Client_UI_WorkflowTilesUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowTilesUIExtension  
---|---  
##  __Методы
[ContextInitialized](M_Tessa_Extensions_Platform_Client_UI_WorkflowTilesUIExtension_ContextInitialized.htm)|  
(Переопределяет
