# CardInfoStorageObject(SerializationInfo, StreamingContext) - конструктор
...
C# __Копировать
     protected CardInfoStorageObject(
...
F# __Копировать
     new : 
            ...
            context : StreamingContext -> CardInfoStorageObject
#### Параметры
info
...
[CardInfoStorageObject -
перегрузка](Overload_Tessa_Cards_CardInfoStorageObject__ctor.htm)
