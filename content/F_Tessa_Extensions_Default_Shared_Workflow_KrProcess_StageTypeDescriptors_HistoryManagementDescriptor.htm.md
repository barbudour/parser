# StageTypeDescriptors.HistoryManagementDescriptor - поле
...
VB __Копировать
     Public Shared ReadOnly HistoryManagementDescriptor As StageTypeDescriptor
C++ __Копировать
     public:
    static initonly StageTypeDescriptor^ HistoryManagementDescriptor
F# __Копировать
     static val HistoryManagementDescriptor: StageTypeDescriptor
#### Значение поля
