# CardDeleteMethodFilterPolicy - класс
...
C# __Копировать
     public sealed class CardDeleteMethodFilterPolicy : IFilterPolicy, 
    	IExtensionPolicy
VB __Копировать
     Public NotInheritable Class CardDeleteMethodFilterPolicy
    	Implements IFilterPolicy, IExtensionPolicy
C++ __Копировать
     public ref class CardDeleteMethodFilterPolicy sealed : IFilterPolicy, 
    	IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type CardDeleteMethodFilterPolicy = 
        class
            interface IFilterPolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardDeleteMethodFilterPolicy
Implements
    [IExtensionPolicy](T_Tessa_Extensions_IExtensionPolicy.htm), [IFilterPolicy](T_Tessa_Extensions_IFilterPolicy.htm)
##  __Конструкторы
[CardDeleteMethodFilterPolicy](M_Tessa_Cards_Extensions_CardDeleteMethodFilterPolicy__ctor.htm)|
Инициализирует новый экземпляр класса CardDeleteMethodFilterPolicy  
---|---  
##  __Свойства
...
---|---  
[FilterAsync](M_Tessa_Cards_Extensions_CardDeleteMethodFilterPolicy_FilterAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetFilterContextAsync](M_Tessa_Cards_Extensions_CardDeleteMethodFilterPolicy_GetFilterContextAsync.htm)|
