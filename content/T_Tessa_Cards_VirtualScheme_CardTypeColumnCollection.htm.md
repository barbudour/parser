# CardTypeColumnCollection - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
    ...
    public sealed class CardTypeColumnCollection : CardSerializableEntryCollection<CardTypeSectionColumn>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardTypeColumnCollection
    	Inherits CardSerializableEntryCollection(Of CardTypeSectionColumn)
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTypeColumnCollection sealed : public CardSerializableEntryCollection<CardTypeSectionColumn^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardTypeColumnCollection = 
        class
            inherit CardSerializableEntryCollection<CardTypeSectionColumn>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __[CardSerializableEntryCollection](T_Tessa_Cards_CardSerializableEntryCollection_1.htm)<[CardTypeSectionColumn](T_Tessa_Cards_VirtualScheme_CardTypeSectionColumn.htm)> __ CardTypeColumnCollection
##  __Конструкторы
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[XmlElementNameInternal](P_Tessa_Cards_VirtualScheme_CardTypeColumnCollection_XmlElementNameInternal.htm)|
...
[XmlItemNameInternal](P_Tessa_Cards_VirtualScheme_CardTypeColumnCollection_XmlItemNameInternal.htm)|
