# KrConstants.StartProcessButton - поле
...
VB __Копировать
     Public Shared ReadOnly StartProcessButton As Guid
C++ __Копировать
     public:
    static initonly Guid StartProcessButton
F# __Копировать
     static val StartProcessButton: Guid
#### Значение поля
