# ManagerWorkplaceSettings.ActiveImageColumnName - свойство
...
VB __Копировать
     Public Property ActiveImageColumnName As String
    	Get
    	Set
C++ __Копировать
     public:
    property String^ ActiveImageColumnName {
    	String^ get ();
    	void set (String^ value);
    }
F# __Копировать
     member ActiveImageColumnName : string with get, set
#### Значение свойства
