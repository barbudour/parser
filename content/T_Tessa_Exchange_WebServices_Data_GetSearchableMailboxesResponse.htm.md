# GetSearchableMailboxesResponse - класс
...
C++ __Копировать
     public ref class GetSearchableMailboxesResponse sealed : public ServiceResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ GetSearchableMailboxesResponse
##  __Свойства
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[FailedMailboxes](P_Tessa_Exchange_WebServices_Data_GetSearchableMailboxesResponse_FailedMailboxes.htm)|
Failed mailboxes  
[Result](P_Tessa_Exchange_WebServices_Data_ServiceResponse_Result.htm)|  Gets
the result associated with this response.  
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[SearchableMailboxes](P_Tessa_Exchange_WebServices_Data_GetSearchableMailboxesResponse_SearchableMailboxes.htm)|
