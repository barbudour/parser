...
C# __Копировать
    ...
    public sealed class ConfigurationObject : StorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class ConfigurationObject
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class ConfigurationObject sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ConfigurationObject
##  __Конструкторы
[ConfigurationObject()](M_Tessa_Platform_ConfigurationObject__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[ConfigurationObject(Dictionary<String,
Object>)](M_Tessa_Platform_ConfigurationObject__ctor_1.htm)| Создаёт экземпляр
класса с указанием хранилища, декоратором для которого является создаваемый
объект.  
[ConfigurationObject(IStorageObjectProvider)](M_Tessa_Platform_ConfigurationObject__ctor_2.htm)|
...
## __Свойства
[Connections](P_Tessa_Platform_ConfigurationObject_Connections.htm)|  Строки
подключения к базе данных.  
---|---  
[DataProviders](P_Tessa_Platform_ConfigurationObject_DataProviders.htm)|
Поставщики данных, используемых для строк подключения.  
[Dynamic](P_Tessa_Platform_ConfigurationObject_Dynamic.htm)|  Объект,
осуществляющий доступ к текущему объекту через позднее связывание свойств.  
[Settings](P_Tessa_Platform_ConfigurationObject_Settings.htm)|  Общие
настройки.  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[CreateDbManager](M_Tessa_Platform_ConfigurationObject_CreateDbManager.htm)|
Создаёт объект [DbManager](T_Tessa_Platform_Data_DbManager.htm) с
использованием строки подключения с заданным именем.  
[EnsureCacheResolved](M_Tessa_Platform_ConfigurationObject_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[GetConfigurationDataProvider](M_Tessa_Platform_ConfigurationObject_GetConfigurationDataProvider.htm)|
Возвращает объект с поставщиком данных
[ConfigurationDataProvider](T_Tessa_Platform_ConfigurationDataProvider.htm) и
соединением с базой данных
[ConfigurationConnection](T_Tessa_Platform_ConfigurationConnection.htm).  
[GetConfigurationDataProviderFromType](M_Tessa_Platform_ConfigurationObject_GetConfigurationDataProviderFromType.htm)|
Возвращает объект
...
имён.  
[GetDataProvider](M_Tessa_Platform_ConfigurationObject_GetDataProvider.htm)|
Получает объект IDataProvider с использованием строки подключения с заданным
именем.  
[GetDbProviderFactory](M_Tessa_Platform_ConfigurationObject_GetDbProviderFactory.htm)|
Получает объект
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[InitConnections](M_Tessa_Platform_ConfigurationObject_InitConnections.htm)|
Выполняет инициализацию строк подключения
[Connections](P_Tessa_Platform_ConfigurationObject_Connections.htm) и
провайдеров
[DataProviders](P_Tessa_Platform_ConfigurationObject_DataProviders.htm). Для
объекта конфигурации по умолчанию
[Default](P_Tessa_Platform_ConfigurationManager_Default.htm) выполнять
инициализацию вручную не требуется.  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
##  __Поля
[ConnectionStringsKey](F_Tessa_Platform_ConfigurationObject_ConnectionStringsKey.htm)|  
---|---  
[DataProvidersKey](F_Tessa_Platform_ConfigurationObject_DataProvidersKey.htm)|  
[SettingsKey](F_Tessa_Platform_ConfigurationObject_SettingsKey.htm)|  
## __Методы расширения
