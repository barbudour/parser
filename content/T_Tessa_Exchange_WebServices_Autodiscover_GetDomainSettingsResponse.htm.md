# GetDomainSettingsResponse - класс
...
C++ __Копировать
     public ref class GetDomainSettingsResponse sealed : public AutodiscoverResponse
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[AutodiscoverResponse](T_Tessa_Exchange_WebServices_Autodiscover_AutodiscoverResponse.htm) __ GetDomainSettingsResponse
##  __Конструкторы
[GetDomainSettingsResponse](M_Tessa_Exchange_WebServices_Autodiscover_GetDomainSettingsResponse__ctor.htm)|
