# ICardFileSourceSettings.GetLargeFileSizeAsync - метод
...
C# __Копировать
    ValueTask<long?> GetLargeFileSizeAsync(
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Function GetLargeFileSizeAsync ( 
    	Optional cancellationToken As CancellationToken = Nothing
    ) As ValueTask(Of Long?)
C++ __Копировать
    ValueTask<Nullable<long long>> GetLargeFileSizeAsync(
