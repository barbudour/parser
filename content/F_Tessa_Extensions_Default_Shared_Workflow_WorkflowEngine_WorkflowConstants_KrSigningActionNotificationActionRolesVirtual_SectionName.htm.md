...
C# __Копировать
     public const string SectionName = "KrSigningActionNotificationActionRolesVirtual"
VB __Копировать
     Public Const SectionName As String = "KrSigningActionNotificationActionRolesVirtual"
C++ __Копировать
     public:
    literal String^ SectionName = "KrSigningActionNotificationActionRolesVirtual"
F# __Копировать
