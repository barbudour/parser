...
C# __Копировать
     public sealed class PersonalRoleUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class PersonalRoleUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class PersonalRoleUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type PersonalRoleUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ PersonalRoleUIExtension
##  __Конструкторы
[PersonalRoleUIExtension](M_Tessa_Extensions_Platform_Client_UI_PersonalRoleUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса PersonalRoleUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_PersonalRoleUIExtension_Initialized.htm)|  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Reopened](M_Tessa_Extensions_Platform_Client_UI_PersonalRoleUIExtension_Reopened.htm)|  
(Переопределяет
