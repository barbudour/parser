# ActionHistoryRecordUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class ActionHistoryRecordUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class ActionHistoryRecordUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class ActionHistoryRecordUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type ActionHistoryRecordUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ ActionHistoryRecordUIExtension
##  __Конструкторы
[ActionHistoryRecordUIExtension](M_Tessa_Extensions_Platform_Client_UI_ActionHistoryRecordUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса ActionHistoryRecordUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_ActionHistoryRecordUIExtension_Initialized.htm)|  
(Переопределяет
