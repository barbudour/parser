# BusinessProcessTemplateExtendedRepairExtension - класс
...
C# __Копировать
     public sealed class BusinessProcessTemplateExtendedRepairExtension : CardRepairExtension
VB __Копировать
     Public NotInheritable Class BusinessProcessTemplateExtendedRepairExtension
    	Inherits CardRepairExtension
C++ __Копировать
     public ref class BusinessProcessTemplateExtendedRepairExtension sealed : public CardRepairExtension
F# __Копировать
     [<SealedAttribute>]
    type BusinessProcessTemplateExtendedRepairExtension = 
        class
            inherit CardRepairExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm) __ BusinessProcessTemplateExtendedRepairExtension
##  __Конструкторы
[BusinessProcessTemplateExtendedRepairExtension](M_Tessa_Extensions_Platform_Shared_Cards_BusinessProcessTemplateExtendedRepairExtension__ctor.htm)|
Инициализирует новый экземпляр класса
BusinessProcessTemplateExtendedRepairExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Shared_Cards_BusinessProcessTemplateExtendedRepairExtension_BeforeRequest.htm)|
