...
C# __Копировать
     public sealed class ServiceScanProvider : ViewModel<EmptyModel>, 
    	IScanProvider, INotifyPropertyChanged, IAsyncDisposable
VB __Копировать
     Public NotInheritable Class ServiceScanProvider
    	Inherits ViewModel(Of EmptyModel)
    	Implements IScanProvider, INotifyPropertyChanged, IAsyncDisposable
C++ __Копировать
     public ref class ServiceScanProvider sealed : public ViewModel<EmptyModel^>, 
    	IScanProvider, INotifyPropertyChanged, IAsyncDisposable
F# __Копировать
     [<SealedAttribute>]
    type ServiceScanProvider = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NotificationObject](T_Tessa_Platform_NotificationObject.htm) __[NotificationUIObject](T_Tessa_UI_NotificationUIObject.htm) __[ViewModel](T_Tessa_UI_ViewModel_1.htm)<[EmptyModel](T_Tessa_UI_EmptyModel.htm)> __ ServiceScanProvider
Implements
...
##  __Конструкторы
[ServiceScanProvider](M_Tessa_Extensions_Default_Client_Scanning_ServiceScanProvider__ctor.htm)|
Инициализирует новый экземпляр класса ServiceScanProvider  
---|---  
##  __Свойства
...
(Унаследован от [ViewModel<TModel>](T_Tessa_UI_ViewModel_1.htm))  
[State](P_Tessa_Extensions_Default_Client_Scanning_ServiceScanProvider_State.htm)|
Текущее состояние сканирования  
## __Методы
[CancelAsync](M_Tessa_Extensions_Default_Client_Scanning_ServiceScanProvider_CancelAsync.htm)|
Вызывает отмену сканирования  
---|---  
[DisposeAsync](M_Tessa_Extensions_Default_Client_Scanning_ServiceScanProvider_DisposeAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetSourcesAsync](M_Tessa_Extensions_Default_Client_Scanning_ServiceScanProvider_GetSourcesAsync.htm)|
...
(Унаследован от [ViewModel<TModel>](T_Tessa_UI_ViewModel_1.htm))  
[ScanAsync](M_Tessa_Extensions_Default_Client_Scanning_ServiceScanProvider_ScanAsync.htm)|
...
[SetProcessAction](M_Tessa_Extensions_Default_Client_Scanning_ServiceScanProvider_SetProcessAction.htm)|
