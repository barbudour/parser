# WorkflowAnnotationStorage - класс
##  __Definition
 **Пространство имён:** [Tessa.Workflow.Storage](N_Tessa_Workflow_Storage.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class WorkflowAnnotationStorage : WorkflowStorageBase
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowAnnotationStorage
    	Inherits WorkflowStorageBase
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowAnnotationStorage sealed : public WorkflowStorageBase
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowAnnotationStorage = 
        class
            inherit WorkflowStorageBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __ WorkflowAnnotationStorage
##  __Конструкторы
[WorkflowAnnotationStorage()](M_Tessa_Workflow_Storage_WorkflowAnnotationStorage__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowAnnotationStorage  
---|---  
[WorkflowAnnotationStorage(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowAnnotationStorage__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowAnnotationStorage  
[WorkflowAnnotationStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowAnnotationStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowAnnotationStorage  
##  __Свойства
...
---|---  
[ElementID](P_Tessa_Workflow_Storage_WorkflowAnnotationStorage_ElementID.htm)|  
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[Left](P_Tessa_Workflow_Storage_WorkflowAnnotationStorage_Left.htm)|  
[Text](P_Tessa_Workflow_Storage_WorkflowAnnotationStorage_Text.htm)|  
[Top](P_Tessa_Workflow_Storage_WorkflowAnnotationStorage_Top.htm)|  
## __Методы
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[Clone](M_Tessa_Workflow_Storage_WorkflowAnnotationStorage_Clone.htm)|  
(Переопределяет
