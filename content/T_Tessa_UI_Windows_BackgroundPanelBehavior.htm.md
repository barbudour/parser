# BackgroundPanelBehavior - класс
The background behavior for panel.
## __Definition
 **Пространство имён:** [Tessa.UI.Windows](N_Tessa_UI_Windows.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class BackgroundPanelBehavior : Behavior<Panel>, 
    	IWeakEventListener
VB __Копировать
     Public NotInheritable Class BackgroundPanelBehavior
    	Inherits Behavior(Of Panel)
    	Implements IWeakEventListener
C++ __Копировать
     public ref class BackgroundPanelBehavior sealed : public Behavior<Panel^>, 
    	IWeakEventListener
F# __Копировать
     [<SealedAttribute>]
    type BackgroundPanelBehavior = 
        class
            inherit Behavior<Panel>
            interface IWeakEventListener
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[Panel](https://learn.microsoft.com/dotnet/api/system.windows.controls.panel)> __ BackgroundPanelBehavior
Implements
...
## __Конструкторы
[BackgroundPanelBehavior](M_Tessa_UI_Windows_BackgroundPanelBehavior__ctor.htm)|
Инициализирует новый экземпляр класса BackgroundPanelBehavior  
---|---  
##  __Свойства
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Windows_BackgroundPanelBehavior_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Windows_BackgroundPanelBehavior_OnAttached.htm)|
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Windows_BackgroundPanelBehavior_OnDetaching.htm)|
