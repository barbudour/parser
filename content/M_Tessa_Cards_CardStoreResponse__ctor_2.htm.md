# CardStoreResponse(IStorageObjectProvider) - конструктор
...
F# __Копировать
     new : 
            storageProvider : IStorageObjectProvider -> CardStoreResponse
#### Параметры
storageProvider
...
[CardStoreResponse -
перегрузка](Overload_Tessa_Cards_CardStoreResponse__ctor.htm)
