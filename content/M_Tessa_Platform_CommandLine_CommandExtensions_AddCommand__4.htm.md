# CommandExtensions.AddCommand<T1, T2, T3, T4>(CommandContext, Func<T1, T2,
T3, T4, Task>) - метод
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public static CommandContext AddCommand<T1, T2, T3, T4>(
    	this CommandContext commandContext,
    	Func<T1, T2, T3, T4, Task> commandDelegate
    )
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function AddCommand(Of T1, T2, T3, T4) ( 
    	commandContext As CommandContext,
    	commandDelegate As Func(Of T1, T2, T3, T4, Task)
    ) As CommandContext
C++ __Копировать
     public:
    [ExtensionAttribute]
...
F# __Копировать
    ...
    static member AddCommand : 
            commandContext : CommandContext * 
            commandDelegate : Func<'T1, 'T2, 'T3, 'T4, Task> -> CommandContext 
#### Параметры
commandContext
[CommandContext](T_Tessa_Platform_CommandLine_CommandContext.htm)
commandDelegate
[Func](https://learn.microsoft.com/dotnet/api/system.func-5)<T1, T2, T3, T4,
