# UniversalSatelliteRestoreExtension - класс
...
C# __Копировать
     public sealed class UniversalSatelliteRestoreExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class UniversalSatelliteRestoreExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class UniversalSatelliteRestoreExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type UniversalSatelliteRestoreExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ UniversalSatelliteRestoreExtension
##  __Конструкторы
[UniversalSatelliteRestoreExtension](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteRestoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса UniversalSatelliteRestoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteRestoreExtension_AfterBeginTransaction.htm)|
...
---|---  
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteRestoreExtension_AfterRequest.htm)|
