# KrReplaceRecalcMessageStoreExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrReplaceRecalcMessageStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class KrReplaceRecalcMessageStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type KrReplaceRecalcMessageStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ KrReplaceRecalcMessageStoreExtension
##  __Конструкторы
[KrReplaceRecalcMessageStoreExtension](M_Tessa_Extensions_Default_Client_Workflow_KrCompilers_KrReplaceRecalcMessageStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrReplaceRecalcMessageStoreExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Client_Workflow_KrCompilers_KrReplaceRecalcMessageStoreExtension_AfterRequest.htm)|  
(Переопределяет
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Client.Workflow.KrCompilers - пространство
имён](N_Tessa_Extensions_Default_Client_Workflow_KrCompilers.htm)
