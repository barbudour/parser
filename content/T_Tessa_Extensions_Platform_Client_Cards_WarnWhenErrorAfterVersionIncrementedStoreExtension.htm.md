# WarnWhenErrorAfterVersionIncrementedStoreExtension - класс
...
C# __Копировать
     public sealed class WarnWhenErrorAfterVersionIncrementedStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class WarnWhenErrorAfterVersionIncrementedStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class WarnWhenErrorAfterVersionIncrementedStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type WarnWhenErrorAfterVersionIncrementedStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ WarnWhenErrorAfterVersionIncrementedStoreExtension
##  __Конструкторы
[WarnWhenErrorAfterVersionIncrementedStoreExtension](M_Tessa_Extensions_Platform_Client_Cards_WarnWhenErrorAfterVersionIncrementedStoreExtension__ctor.htm)|
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[AfterRequestFinally](M_Tessa_Extensions_Platform_Client_Cards_WarnWhenErrorAfterVersionIncrementedStoreExtension_AfterRequestFinally.htm)|  
(Переопределяет
