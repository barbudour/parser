# ScanFileHelper.IsPdfExtension - метод
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.ViewModels](N_Tessa_Extensions_Platform_Client_ViewModels.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public static bool IsPdfExtension(
    	string extension
    )
VB __Копировать
     Public Shared Function IsPdfExtension ( 
    	extension As String
    ) As Boolean
C++ __Копировать
     public:
    static bool IsPdfExtension(
    	String^ extension
    )
F# __Копировать
     static member IsPdfExtension : 
