...
C# __Копировать
     public sealed class ConditionCompiler : IConditionCompiler
VB __Копировать
     Public NotInheritable Class ConditionCompiler
    	Implements IConditionCompiler
C++ __Копировать
     public ref class ConditionCompiler sealed : IConditionCompiler
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ConditionCompiler
Implements
    [IConditionCompiler](T_Tessa_Platform_Conditions_IConditionCompiler.htm)
##  __Конструкторы
[ConditionCompiler](M_Tessa_Compilation_Conditions_ConditionCompiler__ctor.htm)|
Инициализирует новый экземпляр класса ConditionCompiler  
---|---  
##  __Свойства
...
## __Методы
[Compile](M_Tessa_Compilation_Conditions_ConditionCompiler_Compile.htm)|
Метод для компиляции типов условий  
---|---  
[CreateContext](M_Tessa_Compilation_Conditions_ConditionCompiler_CreateContext.htm)|
