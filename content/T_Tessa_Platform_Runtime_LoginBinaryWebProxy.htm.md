...
C# __Копировать
     public sealed class LoginBinaryWebProxy : WebProxy
VB __Копировать
     Public NotInheritable Class LoginBinaryWebProxy
    	Inherits WebProxy
C++ __Копировать
     public ref class LoginBinaryWebProxy sealed : public WebProxy
F# __Копировать
     [<SealedAttribute>]
    type LoginBinaryWebProxy = 
        class
            inherit WebProxy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm) __ LoginBinaryWebProxy
##  __Конструкторы
[LoginBinaryWebProxy](M_Tessa_Platform_Runtime_LoginBinaryWebProxy__ctor.htm)|
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[OpenSessionAsync](M_Tessa_Platform_Runtime_LoginBinaryWebProxy_OpenSessionAsync.htm)|
...
[OpenSessionWindowsAuthAsync](M_Tessa_Platform_Runtime_LoginBinaryWebProxy_OpenSessionWindowsAuthAsync.htm)|
