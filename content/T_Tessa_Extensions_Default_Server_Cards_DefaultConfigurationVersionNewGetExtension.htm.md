# DefaultConfigurationVersionNewGetExtension - класс
...
C# __Копировать
     public sealed class DefaultConfigurationVersionNewGetExtension : CardNewGetExtension
VB __Копировать
     Public NotInheritable Class DefaultConfigurationVersionNewGetExtension
    	Inherits CardNewGetExtension
C++ __Копировать
     public ref class DefaultConfigurationVersionNewGetExtension sealed : public CardNewGetExtension
F# __Копировать
     [<SealedAttribute>]
    type DefaultConfigurationVersionNewGetExtension = 
        class
            inherit CardNewGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewGetExtension](T_Tessa_Cards_Extensions_CardNewGetExtension.htm) __ DefaultConfigurationVersionNewGetExtension
##  __Конструкторы
[DefaultConfigurationVersionNewGetExtension](M_Tessa_Extensions_Default_Server_Cards_DefaultConfigurationVersionNewGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса
DefaultConfigurationVersionNewGetExtension  
---|---  
##  __Методы
[AfterRequest(ICardGetExtensionContext)](M_Tessa_Extensions_Default_Server_Cards_DefaultConfigurationVersionNewGetExtension_AfterRequest.htm)|  
(Переопределяет
[CardNewGetExtension.AfterRequest(ICardGetExtensionContext)](M_Tessa_Cards_Extensions_CardNewGetExtension_AfterRequest.htm))  
---|---  
[AfterRequest(ICardNewExtensionContext)](M_Tessa_Extensions_Default_Server_Cards_DefaultConfigurationVersionNewGetExtension_AfterRequest_1.htm)|  
(Переопределяет
