# FileVersionCollection - класс
Коллекция версий файла.
## __Definition
 **Пространство имён:** [Tessa.Files](N_Tessa_Files.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class FileVersionCollection : FileEntityCollection<IFileVersion, IFileVersionCollection>, 
    	IFileVersionCollection, IFileEntityCollection<IFileVersion, IFileVersionCollection>, IObservableCollectionLookup<Guid, IFileVersion, IFileVersionCollection>, 
    	IObservableCollection<IFileVersion, IFileVersionCollection>, IList<IFileVersion>, 
    	ICollection<IFileVersion>, IEnumerable<IFileVersion>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer<Guid, IFileVersion>, 
    	IControllableCollection<IFileVersion>
VB __Копировать
     Public NotInheritable Class FileVersionCollection
    	Inherits FileEntityCollection(Of IFileVersion, IFileVersionCollection)
    	Implements IFileVersionCollection, IFileEntityCollection(Of IFileVersion, IFileVersionCollection), 
    	IObservableCollectionLookup(Of Guid, IFileVersion, IFileVersionCollection), IObservableCollection(Of IFileVersion, IFileVersionCollection), 
    	IList(Of IFileVersion), ICollection(Of IFileVersion), IEnumerable(Of IFileVersion), 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer(Of Guid, IFileVersion), 
    	IControllableCollection(Of IFileVersion)
C++ __Копировать
     public ref class FileVersionCollection sealed : public FileEntityCollection<IFileVersion^, IFileVersionCollection^>, 
    	IFileVersionCollection, IFileEntityCollection<IFileVersion^, IFileVersionCollection^>, IObservableCollectionLookup<Guid, IFileVersion^, IFileVersionCollection^>, 
    	IObservableCollection<IFileVersion^, IFileVersionCollection^>, IList<IFileVersion^>, 
    	ICollection<IFileVersion^>, IEnumerable<IFileVersion^>, IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer<Guid, IFileVersion^>, 
...
F# __Копировать
    ...
    type FileVersionCollection = 
        class
            inherit FileEntityCollection<IFileVersion, IFileVersionCollection>
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<[IFileVersion](T_Tessa_Files_IFileVersion.htm)> __[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[IFileVersion](T_Tessa_Files_IFileVersion.htm)> __[SuspendableObservableCollection](T_Tessa_Platform_Collections_SuspendableObservableCollection_1.htm)<[IFileVersion](T_Tessa_Files_IFileVersion.htm)> __[ObservableCollection](T_Tessa_Platform_Collections_ObservableCollection_2.htm)<[IFileVersion](T_Tessa_Files_IFileVersion.htm), [IFileVersionCollection](T_Tessa_Files_IFileVersionCollection.htm)> __[ObservableCollectionLookup](T_Tessa_Platform_Collections_ObservableCollectionLookup_3.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [IFileVersion](T_Tessa_Files_IFileVersion.htm), [IFileVersionCollection](T_Tessa_Files_IFileVersionCollection.htm)> __[FileEntityCollection](T_Tessa_Files_FileEntityCollection_2.htm)<[IFileVersion](T_Tessa_Files_IFileVersion.htm), [IFileVersionCollection](T_Tessa_Files_IFileVersionCollection.htm)> __ FileVersionCollection
Implements
    [ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<[IFileVersion](T_Tessa_Files_IFileVersion.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<[IFileVersion](T_Tessa_Files_IFileVersion.htm)>, [IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<[IFileVersion](T_Tessa_Files_IFileVersion.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.ienumerable), [INotifyCollectionChanged](https://learn.microsoft.com/dotnet/api/system.collections.specialized.inotifycollectionchanged), [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged), [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable), [IFileEntityCollection](T_Tessa_Files_IFileEntityCollection_2.htm)<[IFileVersion](T_Tessa_Files_IFileVersion.htm), [IFileVersionCollection](T_Tessa_Files_IFileVersionCollection.htm)>, [IFileVersionCollection](T_Tessa_Files_IFileVersionCollection.htm), [IControllableCollection](T_Tessa_Platform_Collections_IControllableCollection_1.htm)<[IFileVersion](T_Tessa_Files_IFileVersion.htm)>, [ILookupContainer](T_Tessa_Platform_Collections_ILookupContainer_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [IFileVersion](T_Tessa_Files_IFileVersion.htm)>, [IObservableCollection](T_Tessa_Platform_Collections_IObservableCollection_2.htm)<[IFileVersion](T_Tessa_Files_IFileVersion.htm), [IFileVersionCollection](T_Tessa_Files_IFileVersionCollection.htm)>, [IObservableCollectionLookup](T_Tessa_Platform_Collections_IObservableCollectionLookup_3.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [IFileVersion](T_Tessa_Files_IFileVersion.htm), [IFileVersionCollection](T_Tessa_Files_IFileVersionCollection.htm)>
##  __Конструкторы
...
(Унаследован от
[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<[IFileVersion](T_Tessa_Files_IFileVersion.htm)>)  
[ClearItems](M_Tessa_Files_FileVersionCollection_ClearItems.htm)| Удаляет все
элементы из коллекции.  
(Переопределяет [ObservableCollectionLookup<TKey, TItem,
TCollection>.ClearItems()](M_Tessa_Platform_Collections_ObservableCollectionLookup_3_ClearItems.htm))  
[Clone](M_Tessa_Files_FileVersionCollection_Clone.htm)|  Выполняет глубокое
...
(Унаследован от
[Collection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.collection-1)<[IFileVersion](T_Tessa_Files_IFileVersion.htm)>)  
[InsertItem](M_Tessa_Files_FileVersionCollection_InsertItem.htm)| Вставляет в
коллекцию заданный элемент по указанному индексу.  
(Переопределяет [ObservableCollectionLookup<TKey, TItem,
TCollection>.InsertItem(Int32,
TItem)](M_Tessa_Platform_Collections_ObservableCollectionLookup_3_InsertItem.htm))  
...
(Унаследован от
[ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1)<[IFileVersion](T_Tessa_Files_IFileVersion.htm)>)  
[MoveItem](M_Tessa_Files_FileVersionCollection_MoveItem.htm)| Перемещает
элемент внутри коллекции.  
(Переопределяет [ObservableCollection<T>.MoveItem(Int32,
Int32)](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1.moveitem#system-
...
(Унаследован от [FileEntityCollection<TItem,
TCollection>](T_Tessa_Files_FileEntityCollection_2.htm))  
[RemoveItem](M_Tessa_Files_FileVersionCollection_RemoveItem.htm)| Удаляет
элемент из коллекции по заданному индексу.  
(Переопределяет [ObservableCollectionLookup<TKey, TItem,
TCollection>.RemoveItem(Int32)](M_Tessa_Platform_Collections_ObservableCollectionLookup_3_RemoveItem.htm))  
[SetItem](M_Tessa_Files_FileVersionCollection_SetItem.htm)| Замещает заданный
элемент по указанному индексу коллекции.  
(Переопределяет [ObservableCollectionLookup<TKey, TItem,
TCollection>.SetItem(Int32,
TItem)](M_Tessa_Platform_Collections_ObservableCollectionLookup_3_SetItem.htm))  
[SuspendNotifications](M_Tessa_Platform_Collections_SuspendableObservableCollection_1_SuspendNotifications.htm)|
