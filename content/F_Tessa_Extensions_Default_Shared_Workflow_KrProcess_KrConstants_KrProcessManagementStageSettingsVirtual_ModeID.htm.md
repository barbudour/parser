# KrConstants.KrProcessManagementStageSettingsVirtual.ModeID - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly ModeID As String
C++ __Копировать
     public:
    static initonly String^ ModeID
F# __Копировать
     static val ModeID: string
#### Значение поля
