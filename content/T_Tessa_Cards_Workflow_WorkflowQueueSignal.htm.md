...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_Workflow_WorkflowQueueSignal_Clone.htm)|  Выполняет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Cards_Workflow_WorkflowQueueSignal_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[IsEmpty](M_Tessa_Cards_Workflow_WorkflowQueueSignal_IsEmpty.htm)|  Возвращает
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[Set(IWorkflowSignal)](M_Tessa_Cards_Workflow_WorkflowQueueSignal_Set.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[ToWorkflowSignal](M_Tessa_Cards_Workflow_WorkflowQueueSignal_ToWorkflowSignal.htm)|
Преобразует информацию по сигналу, указанную в текущем объекте, в объект типа
[IWorkflowSignal](T_Tessa_Cards_Workflow_IWorkflowSignal.htm).  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetParameters](M_Tessa_Cards_Workflow_WorkflowQueueSignal_TryGetParameters.htm)|
Возвращает параметры сигнала или null, если параметры не были заданы.  
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_Workflow_WorkflowQueueSignal_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
