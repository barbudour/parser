# DisableFormValueModelBindingAttribute - класс
##  __Definition
...
C# __Копировать
    ...
    public class DisableFormValueModelBindingAttribute : Attribute, 
    	IResourceFilter, IFilterMetadata
VB __Копировать
    ...
    Public Class DisableFormValueModelBindingAttribute
    	Inherits Attribute
    	Implements IResourceFilter, IFilterMetadata
C++ __Копировать
    [AttributeUsageAttribute(AttributeTargets::Class|AttributeTargets::Method)]
    public ref class DisableFormValueModelBindingAttribute : public Attribute, 
    	IResourceFilter, IFilterMetadata
F# __Копировать
     [<AttributeUsageAttribute(AttributeTargets.Class|AttributeTargets.Method)>]
    type DisableFormValueModelBindingAttribute = 
        class
            inherit Attribute
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Attribute](https://learn.microsoft.com/dotnet/api/system.attribute) __ DisableFormValueModelBindingAttribute
Implements
    [IFilterMetadata](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.filters.ifiltermetadata), [IResourceFilter](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.filters.iresourcefilter)
##  __Конструкторы
[DisableFormValueModelBindingAttribute](M_Tessa_Web_DisableFormValueModelBindingAttribute__ctor.htm)|
Инициализирует новый экземпляр класса DisableFormValueModelBindingAttribute  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[OnResourceExecuted](M_Tessa_Web_DisableFormValueModelBindingAttribute_OnResourceExecuted.htm)|  
[OnResourceExecuting](M_Tessa_Web_DisableFormValueModelBindingAttribute_OnResourceExecuting.htm)|  
