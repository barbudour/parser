# KrPermissionsRulesExportExtension - класс
...
C# __Копировать
     public sealed class KrPermissionsRulesExportExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class KrPermissionsRulesExportExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class KrPermissionsRulesExportExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrPermissionsRulesExportExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ KrPermissionsRulesExportExtension
##  __Конструкторы
[KrPermissionsRulesExportExtension](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrPermissionsRulesExportExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrPermissionsRulesExportExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrPermissions_KrPermissionsRulesExportExtension_AfterRequest.htm)|  
(Переопределяет
