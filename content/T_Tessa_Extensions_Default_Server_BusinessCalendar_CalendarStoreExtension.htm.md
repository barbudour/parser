...
C# __Копировать
     public sealed class CalendarStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class CalendarStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class CalendarStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type CalendarStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ CalendarStoreExtension
##  __Конструкторы
[CalendarStoreExtension](M_Tessa_Extensions_Default_Server_BusinessCalendar_CalendarStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса CalendarStoreExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Server_BusinessCalendar_CalendarStoreExtension_AfterRequest.htm)|  
(Переопределяет
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Default_Server_BusinessCalendar_CalendarStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Default_Server_BusinessCalendar_CalendarStoreExtension_BeforeRequest.htm)|  
(Переопределяет
