...
C# __Копировать
    ...
    public sealed class CardDeleteRequest : CardRequestBase, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardDeleteRequest
    	Inherits CardRequestBase
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardDeleteRequest sealed : public CardRequestBase, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_CardDeleteRequest_Clone.htm)|  Выполняет глубокое
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[FromTypedJson](M_Tessa_Cards_CardDeleteRequest_FromTypedJson.htm)|
Устанавливает содержимое объекта в соответствии с данными, десериализованными
...
[GetForbidStoringHistory](M_Tessa_Cards_CardRequestExtensions_GetForbidStoringHistory.htm)|
...
(Определяется
[CardRequestExtensions](T_Tessa_Cards_CardRequestExtensions.htm))  
[SetForbidStoringHistory](M_Tessa_Cards_CardRequestExtensions_SetForbidStoringHistory.htm)|
