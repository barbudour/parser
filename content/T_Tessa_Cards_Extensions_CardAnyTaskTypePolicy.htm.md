...
C# __Копировать
     public sealed class CardAnyTaskTypePolicy : ICardTaskTypePolicy, 
    	IExtensionPolicy
VB __Копировать
     Public NotInheritable Class CardAnyTaskTypePolicy
    	Implements ICardTaskTypePolicy, IExtensionPolicy
C++ __Копировать
     public ref class CardAnyTaskTypePolicy sealed : ICardTaskTypePolicy, 
    	IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type CardAnyTaskTypePolicy = 
        class
            interface ICardTaskTypePolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardAnyTaskTypePolicy
Implements
...
## __Конструкторы
[CardAnyTaskTypePolicy](M_Tessa_Cards_Extensions_CardAnyTaskTypePolicy__ctor.htm)|
Инициализирует новый экземпляр класса CardAnyTaskTypePolicy  
---|---  
##  __Свойства
