# ICardGetFileVersionsExtensionContext - интерфейс
Контекст загрузки версий для файла карточки.
## __Definition
 **Пространство имён:** [Tessa.Cards.Extensions](N_Tessa_Cards_Extensions.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public interface ICardGetFileVersionsExtensionContext : ICardFileRequestExtensionContext<CardGetFileVersionsRequest, CardGetFileVersionsResponse>, 
    	ICardFileExtensionContext, ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext, 
    	ICardRequestExtensionContext<CardGetFileVersionsRequest, CardGetFileVersionsResponse>
VB __Копировать
     Public Interface ICardGetFileVersionsExtensionContext
    	Inherits ICardFileRequestExtensionContext(Of CardGetFileVersionsRequest, CardGetFileVersionsResponse), ICardFileExtensionContext, 
    	ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext, ICardRequestExtensionContext(Of CardGetFileVersionsRequest, CardGetFileVersionsResponse)
C++ __Копировать
     public interface class ICardGetFileVersionsExtensionContext : ICardFileRequestExtensionContext<CardGetFileVersionsRequest^, CardGetFileVersionsResponse^>, 
    	ICardFileExtensionContext, ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext, 
    	ICardRequestExtensionContext<CardGetFileVersionsRequest^, CardGetFileVersionsResponse^>
F# __Копировать
     type ICardGetFileVersionsExtensionContext = 
        interface
