# FilePathToImageSourceConverter - класс
...
C# __Копировать
     public sealed class FilePathToImageSourceConverter : ValueConverter<string, ImageSource>
VB __Копировать
     Public NotInheritable Class FilePathToImageSourceConverter
    	Inherits ValueConverter(Of String, ImageSource)
C++ __Копировать
     public ref class FilePathToImageSourceConverter sealed : public ValueConverter<String^, ImageSource^>
F# __Копировать
     [<SealedAttribute>]
    type FilePathToImageSourceConverter = 
        class
            inherit ValueConverter<string, ImageSource>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueConverter](T_Tessa_UI_Data_ValueConverter_2.htm)<[String](https://learn.microsoft.com/dotnet/api/system.string), [ImageSource](https://learn.microsoft.com/dotnet/api/system.windows.media.imagesource)> __ FilePathToImageSourceConverter
##  __Конструкторы
[FilePathToImageSourceConverter](M_Tessa_UI_Data_FilePathToImageSourceConverter__ctor.htm)|
Инициализирует новый экземпляр класса FilePathToImageSourceConverter  
---|---  
##  __Методы
...
CultureInfo)](M_Tessa_UI_Data_FilePathToImageSourceConverter_Convert.htm)|  
