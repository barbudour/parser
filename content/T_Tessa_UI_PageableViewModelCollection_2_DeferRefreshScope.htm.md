# PageableViewModelCollection<TItemModel, TItemViewModel>.DeferRefreshScope -
структура
##  __Definition
 **Пространство имён:** [Tessa.UI](N_Tessa_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public readonly struct DeferRefreshScope : IDisposable
VB __Копировать
     Public Structure DeferRefreshScope
    	Implements IDisposable
C++ __Копировать
     public value class DeferRefreshScope : IDisposable
F# __Копировать
     [<SealedAttribute>]
    type DeferRefreshScope = 
        struct
            inherit ValueType
            interface IDisposable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) __ PageableViewModelCollection<TItemModel, TItemViewModel>.DeferRefreshScope
Implements
    [IDisposable](https://learn.microsoft.com/dotnet/api/system.idisposable)
##  __Методы
[Dispose](M_Tessa_UI_PageableViewModelCollection_2_DeferRefreshScope_Dispose.htm)|
