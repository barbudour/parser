# CardTypeTabControl - класс
Объект, описывающий расположение и свойства элемента управления для вывода
списка форм [CardTypeTabControlForm](T_Tessa_Cards_CardTypeTabControlForm.htm)
во вкладках.
## __Definition
...
(Унаследован от [CardTypeControl](T_Tessa_Cards_CardTypeControl.htm))  
[Flags](P_Tessa_Cards_CardTypeTabControl_Flags.htm)|  Флаги, определяющие
дополнительные атрибуты.  
[Forms](P_Tessa_Cards_CardTypeTabControl_Forms.htm)|  Список форм, выводимый
во вкладках.  
...
управления.  
(Унаследован от [CardTypeControl](T_Tessa_Cards_CardTypeControl.htm))  
[XmlElementNameInternal](P_Tessa_Cards_CardTypeTabControl_XmlElementNameInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeAttributeFromXml](M_Tessa_Cards_CardTypeTabControl_DeserializeAttributeFromXml.htm)|
...
[DeserializeChildrenFromBinaryInternal](M_Tessa_Cards_CardTypeTabControl_DeserializeChildrenFromBinaryInternal.htm)|
...
[DeserializeElementFromXml](M_Tessa_Cards_CardTypeTabControl_DeserializeElementFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_CardTypeTabControl_DeserializeFromBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_CardTypeTabControl_DeserializeFromStorageInternal.htm)|
...
[ControlSettings](P_Tessa_Cards_CardTypeControl_ControlSettings.htm).  
(Унаследован от [CardTypeControl](T_Tessa_Cards_CardTypeControl.htm))  
[EqualsInternal](M_Tessa_Cards_CardTypeTabControl_EqualsInternal.htm)|
...
(Унаследован от [CardTypeContent](T_Tessa_Cards_CardTypeContent.htm))  
[IsRequired](M_Tessa_Cards_CardTypeTabControl_IsRequired.htm)|  Возвращает
...
[IsVisible](M_Tessa_Cards_CardTypeTabControl_IsVisible.htm)| Возвращает
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_CardTypeTabControl_OnDeserializing.htm)|
...
(Унаследован от
[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm))  
[RepairInternalAsync](M_Tessa_Cards_CardTypeTabControl_RepairInternalAsync.htm)|
Метод восстанавливает объект к работоспособному состоянии в соответствии со
схемой. Этот процесс включает удаление данных из текущего объекта, которые
имеют отношение к схеме, но фактически в ней отсутствуют.  
(Переопределяет
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SealInternal](M_Tessa_Cards_CardTypeTabControl_SealInternal.htm)|
Защищает объект от изменений.
Метод может быть переопределён в классах-наследниках.
(Переопределяет
[CardTypeControl.SealInternal()](M_Tessa_Cards_CardTypeControl_SealInternal.htm))  
[SerializeAttributesToXml](M_Tessa_Cards_CardTypeTabControl_SerializeAttributesToXml.htm)|
...
[SerializeChildrenToBinaryInternal](M_Tessa_Cards_CardTypeTabControl_SerializeChildrenToBinaryInternal.htm)|
...
[SerializeElementsToXml](M_Tessa_Cards_CardTypeTabControl_SerializeElementsToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_CardTypeTabControl_SerializeToBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_CardTypeTabControl_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SetRequired](M_Tessa_Cards_CardTypeTabControl_SetRequired.htm)|
...
[SetVisible](M_Tessa_Cards_CardTypeTabControl_SetVisible.htm)|  Устанавливает
признак того, что элемент управления является видимым в интерфейсе. Если
элемент управления не поддерживает установку такого признака, то действий не
выполняется.  
(Переопределяет
...
(Унаследован от
[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardTypeTabControl_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
[CardTypeContent.ValidateInternal(IValidationResultBuilder)](M_Tessa_Cards_CardTypeContent_ValidateInternal.htm))  
##  __Поля
[XmlElementName](F_Tessa_Cards_CardTypeTabControl_XmlElementName.htm)|  Имя
XML-элемента.  
---|---  
## __Методы расширения
