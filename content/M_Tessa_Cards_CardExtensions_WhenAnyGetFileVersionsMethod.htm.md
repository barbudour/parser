# CardExtensions.WhenAnyGetFileVersionsMethod - метод
...
C# __Копировать
     public static IExtensionPolicyContainer WhenAnyGetFileVersionsMethod(
    	this IExtensionPolicyContainer policyContainer
    )
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function WhenAnyGetFileVersionsMethod ( 
    	policyContainer As IExtensionPolicyContainer
    ) As IExtensionPolicyContainer
C++ __Копировать
     public:
    [ExtensionAttribute]
    static IExtensionPolicyContainer^ WhenAnyGetFileVersionsMethod(
    	IExtensionPolicyContainer^ policyContainer
    )
F# __Копировать
     [<ExtensionAttribute>]
    static member WhenAnyGetFileVersionsMethod : 
