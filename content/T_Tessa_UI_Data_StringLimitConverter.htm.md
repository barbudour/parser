# StringLimitConverter - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Data](N_Tessa_UI_Data.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
    [ValueConversionAttribute(typeof(string), typeof(string))]
    public class StringLimitConverter : ValueConverter<string, string>
VB __Копировать
    <ValueConversionAttribute(GetType(String), GetType(String))>
    Public Class StringLimitConverter
    	Inherits ValueConverter(Of String, String)
C++ __Копировать
    [ValueConversionAttribute(typeof(String), typeof(String))]
    public ref class StringLimitConverter : public ValueConverter<String^, String^>
F# __Копировать
     [<ValueConversionAttribute(typeof(string), typeof(string))>]
    type StringLimitConverter = 
        class
            inherit ValueConverter<string, string>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueConverter](T_Tessa_UI_Data_ValueConverter_2.htm)<[String](https://learn.microsoft.com/dotnet/api/system.string), [String](https://learn.microsoft.com/dotnet/api/system.string)> __ StringLimitConverter
##  __Конструкторы
[StringLimitConverter](M_Tessa_UI_Data_StringLimitConverter__ctor.htm)|
Инициализирует новый экземпляр класса StringLimitConverter  
---|---  
##  __Свойства
[Instance](P_Tessa_UI_Data_StringLimitConverter_Instance.htm)|  
---|---  
## __Методы
...
CultureInfo)](M_Tessa_UI_Data_StringLimitConverter_Convert.htm)|  
...
CultureInfo)](M_Tessa_UI_Data_StringLimitConverter_ConvertBack.htm)|  
