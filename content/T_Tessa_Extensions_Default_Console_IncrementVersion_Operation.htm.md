...
VB __Копировать
     Public NotInheritable Class Operation
    	Inherits ConsoleOperation
C++ __Копировать
     public ref class Operation sealed : public ConsoleOperation
F# __Копировать
     [<SealedAttribute>]
    type Operation = 
        class
            inherit ConsoleOperation
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ConsoleOperation](T_Tessa_Platform_ConsoleApps_ConsoleOperation_1.htm)<[ConsoleOperationContext](T_Tessa_Platform_ConsoleApps_ConsoleOperationContext.htm)> __[ConsoleOperation](T_Tessa_Platform_ConsoleApps_ConsoleOperation.htm) __ Operation
##  __Конструкторы
[Operation](M_Tessa_Extensions_Default_Console_IncrementVersion_Operation__ctor.htm)|
...
[ExecuteAsync(ConsoleOperationContext,
CancellationToken)](M_Tessa_Extensions_Default_Console_IncrementVersion_Operation_ExecuteAsync.htm)|  
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Console.IncrementVersion - пространство
имён](N_Tessa_Extensions_Default_Console_IncrementVersion.htm)
