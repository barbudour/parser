# CardCacheCollectionProxy<T>.GetAsync - метод
...
C++ __Копировать
     public:
    virtual ValueTask<CardCacheValue<T>> GetAsync(
    	String^ key, 
...
[ValueTask](https://learn.microsoft.com/dotnet/api/system.threading.tasks.valuetask-1)<[CardCacheValue](T_Tessa_Cards_Caching_CardCacheValue_1.htm)<[T](T_Tessa_Cards_Caching_CardCacheCollectionProxy_1.htm)>>  
Значение из кэша, полученное по заданному ключу, при этом выполняется создание
значения при его отсутствии в кэше.
#### Реализации
[ICardCacheCollection<T>.GetAsync(String,
CancellationToken)](M_Tessa_Cards_Caching_ICardCacheCollection_1_GetAsync.htm)  
##  __Исключения
