# RecalcRoleGeneratorRequestExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Roles](N_Tessa_Extensions_Platform_Server_Roles.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class RecalcRoleGeneratorRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class RecalcRoleGeneratorRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class RecalcRoleGeneratorRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type RecalcRoleGeneratorRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ RecalcRoleGeneratorRequestExtension
##  __Конструкторы
[RecalcRoleGeneratorRequestExtension](M_Tessa_Extensions_Platform_Server_Roles_RecalcRoleGeneratorRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса RecalcRoleGeneratorRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_RecalcRoleGeneratorRequestExtension_AfterRequest.htm)|  
(Переопределяет
