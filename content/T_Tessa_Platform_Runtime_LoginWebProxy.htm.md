...
C# __Копировать
     public sealed class LoginWebProxy : WebProxy
VB __Копировать
     Public NotInheritable Class LoginWebProxy
    	Inherits WebProxy
C++ __Копировать
     public ref class LoginWebProxy sealed : public WebProxy
F# __Копировать
     [<SealedAttribute>]
    type LoginWebProxy = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm) __ LoginWebProxy
##  __Конструкторы
[LoginWebProxy](M_Tessa_Platform_Runtime_LoginWebProxy__ctor.htm)| Создаёт
...
(Унаследован от [WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm))  
[OpenSessionAsync](M_Tessa_Platform_Runtime_LoginWebProxy_OpenSessionAsync.htm)|
Открывает сессию с указанными параметрами.  
