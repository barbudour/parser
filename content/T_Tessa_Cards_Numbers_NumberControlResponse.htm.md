...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[NumberObject](P_Tessa_Cards_Numbers_NumberControlResponse_NumberObject.htm)|
Сериализованный объект номера.  
[NumberQueue](P_Tessa_Cards_Numbers_NumberControlResponse_NumberQueue.htm)|
Очередь действий с номерами.  
## __Методы
[Clean](M_Tessa_Cards_Numbers_NumberControlResponse_Clean.htm)| Выполняет
очистку хранилища от избыточных данных.  
(Переопределяет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_Numbers_NumberControlResponse_Clone.htm)|  Выполняет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[CopyNumberQueueTo](M_Tessa_Cards_Numbers_NumberControlResponse_CopyNumberQueueTo.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetNumberObject](M_Tessa_Cards_Numbers_NumberControlResponse_TryGetNumberObject.htm)|
Возвращает сериализованный объект номера или null, если объект не был задан.  
[TryGetNumberQueue](M_Tessa_Cards_Numbers_NumberControlResponse_TryGetNumberQueue.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_Numbers_NumberControlResponse_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
