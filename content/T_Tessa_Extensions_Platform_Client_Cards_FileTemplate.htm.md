...
VB __Копировать
     Public NotInheritable Class FileTemplate
C++ __Копировать
     public ref class FileTemplate sealed
F# __Копировать
     [<SealedAttribute>]
    type FileTemplate = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FileTemplate
##  __Конструкторы
[FileTemplate](M_Tessa_Extensions_Platform_Client_Cards_FileTemplate__ctor.htm)|
