# WorkflowCommandSubscriptionStorage - класс
##  __Definition
 **Пространство имён:** [Tessa.Workflow.Storage](N_Tessa_Workflow_Storage.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class WorkflowCommandSubscriptionStorage : WorkflowSubscriptionStorageBase
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowCommandSubscriptionStorage
    	Inherits WorkflowSubscriptionStorageBase
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowCommandSubscriptionStorage sealed : public WorkflowSubscriptionStorageBase
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowCommandSubscriptionStorage = 
        class
            inherit WorkflowSubscriptionStorageBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __[WorkflowSubscriptionStorageBase](T_Tessa_Workflow_Storage_WorkflowSubscriptionStorageBase.htm) __ WorkflowCommandSubscriptionStorage
##  __Конструкторы
[WorkflowCommandSubscriptionStorage()](M_Tessa_Workflow_Storage_WorkflowCommandSubscriptionStorage__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowCommandSubscriptionStorage  
---|---  
[WorkflowCommandSubscriptionStorage(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowCommandSubscriptionStorage__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowCommandSubscriptionStorage  
[WorkflowCommandSubscriptionStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowCommandSubscriptionStorage__ctor_3.htm)|
Инициализирует новый экземпляр класса WorkflowCommandSubscriptionStorage  
[WorkflowCommandSubscriptionStorage(Guid, Guid,
String)](M_Tessa_Workflow_Storage_WorkflowCommandSubscriptionStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowCommandSubscriptionStorage  
##  __Свойства
[Command](P_Tessa_Workflow_Storage_WorkflowCommandSubscriptionStorage_Command.htm)|  
---|---  
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[Clone](M_Tessa_Workflow_Storage_WorkflowCommandSubscriptionStorage_Clone.htm)|  
(Переопределяет
