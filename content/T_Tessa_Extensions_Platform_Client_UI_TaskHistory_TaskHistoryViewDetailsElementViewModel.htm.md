# TaskHistoryViewDetailsElementViewModel - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI.TaskHistory](N_Tessa_Extensions_Platform_Client_UI_TaskHistory.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public class TaskHistoryViewDetailsElementViewModel : ViewModel<EmptyModel>
VB __Копировать
     Public Class TaskHistoryViewDetailsElementViewModel
    	Inherits ViewModel(Of EmptyModel)
C++ __Копировать
     public ref class TaskHistoryViewDetailsElementViewModel : public ViewModel<EmptyModel^>
F# __Копировать
     type TaskHistoryViewDetailsElementViewModel = 
        class
            inherit ViewModel<EmptyModel>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NotificationObject](T_Tessa_Platform_NotificationObject.htm) __[NotificationUIObject](T_Tessa_UI_NotificationUIObject.htm) __[ViewModel](T_Tessa_UI_ViewModel_1.htm)<[EmptyModel](T_Tessa_UI_EmptyModel.htm)> __ TaskHistoryViewDetailsElementViewModel
##  __Конструкторы
[TaskHistoryViewDetailsElementViewModel](M_Tessa_Extensions_Platform_Client_UI_TaskHistory_TaskHistoryViewDetailsElementViewModel__ctor.htm)|
Создаёт модель представления для элемента отображения в диалоге расширенных
сведений об элементе истории заданий.  
---|---  
## __Свойства
[Alias](P_Tessa_Extensions_Platform_Client_UI_TaskHistory_TaskHistoryViewDetailsElementViewModel_Alias.htm)|
Псевдоним колонки модели.  
---|---  
[AutomationId](P_Tessa_Extensions_Platform_Client_UI_TaskHistory_TaskHistoryViewDetailsElementViewModel_AutomationId.htm)|
Идентификатор объекта для автоматизации.  
[Caption](P_Tessa_Extensions_Platform_Client_UI_TaskHistory_TaskHistoryViewDetailsElementViewModel_Caption.htm)|  
...
[Prefix](P_Tessa_Extensions_Platform_Client_UI_TaskHistory_TaskHistoryViewDetailsElementViewModel_Prefix.htm)|
Префикс, соответствует положению колонки.  
[Scope](P_Tessa_UI_ViewModel_1_Scope.htm)|  
(Унаследован от [ViewModel<TModel>](T_Tessa_UI_ViewModel_1.htm))  
[Text](P_Tessa_Extensions_Platform_Client_UI_TaskHistory_TaskHistoryViewDetailsElementViewModel_Text.htm)|  
## __Методы
