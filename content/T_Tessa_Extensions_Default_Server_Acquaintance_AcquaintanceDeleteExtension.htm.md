# AcquaintanceDeleteExtension - класс
...
VB __Копировать
     Public NotInheritable Class AcquaintanceDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class AcquaintanceDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type AcquaintanceDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ AcquaintanceDeleteExtension
##  __Конструкторы
[AcquaintanceDeleteExtension](M_Tessa_Extensions_Default_Server_Acquaintance_AcquaintanceDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса AcquaintanceDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Default_Server_Acquaintance_AcquaintanceDeleteExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
