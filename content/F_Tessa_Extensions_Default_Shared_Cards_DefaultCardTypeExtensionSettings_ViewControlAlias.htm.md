# DefaultCardTypeExtensionSettings.ViewControlAlias - поле
...
C# __Копировать
     public static readonly string ViewControlAlias
VB __Копировать
     Public Shared ReadOnly ViewControlAlias As String
C++ __Копировать
     public:
    static initonly String^ ViewControlAlias
F# __Копировать
     static val ViewControlAlias: string
#### Значение поля
