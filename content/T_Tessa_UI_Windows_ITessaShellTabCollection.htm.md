# ITessaShellTabCollection - интерфейс
...
C# __Копировать
     public interface ITessaShellTabCollection : IObservableCollection<ITessaShellTab, ITessaShellTabCollection>, 
    	IList<ITessaShellTab>, ICollection<ITessaShellTab>, IEnumerable<ITessaShellTab>, 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
VB __Копировать
     Public Interface ITessaShellTabCollection
    	Inherits IObservableCollection(Of ITessaShellTab, ITessaShellTabCollection), IList(Of ITessaShellTab), 
    	ICollection(Of ITessaShellTab), IEnumerable(Of ITessaShellTab), IEnumerable, 
    	INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
C++ __Копировать
     public interface class ITessaShellTabCollection : IObservableCollection<ITessaShellTab^, ITessaShellTabCollection^>, 
    	IList<ITessaShellTab^>, ICollection<ITessaShellTab^>, IEnumerable<ITessaShellTab^>, 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable
F# __Копировать
     type ITessaShellTabCollection = 
        interface
...
Implements
    [ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)>, [IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.ienumerable), [INotifyCollectionChanged](https://learn.microsoft.com/dotnet/api/system.collections.specialized.inotifycollectionchanged), [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged), [ICloneable](https://learn.microsoft.com/dotnet/api/system.icloneable), [IObservableCollection](T_Tessa_Platform_Collections_IObservableCollection_2.htm)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm), ITessaShellTabCollection>
##  __Свойства
...
(Унаследован от
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)>)  
---|---  
...
the specified index.  
(Унаследован от
[IList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)>)  
##  __Методы
...
(Унаследован от
[IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<[ITessaShellTab](T_Tessa_UI_Windows_ITessaShellTab.htm)>)  
