...
C# __Копировать
     public sealed class ServerInitializer : IServerInitializer
VB __Копировать
     Public NotInheritable Class ServerInitializer
    	Implements IServerInitializer
C++ __Копировать
     public ref class ServerInitializer sealed : IServerInitializer
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ServerInitializer
Implements
    [IServerInitializer](T_Tessa_Platform_Initialization_IServerInitializer.htm)
##  __Конструкторы
[ServerInitializer](M_Tessa_Platform_Initialization_ServerInitializer__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetInitializationResponseAsync](M_Tessa_Platform_Initialization_ServerInitializer_GetInitializationResponseAsync.htm)|
