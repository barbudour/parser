...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[Type](P_Tessa_Cards_Numbers_NumberStorageLocation_Type.htm)|  Тип
местоположения номера в карточке. По умолчанию равен типу
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_Numbers_NumberStorageLocation_Clone.htm)|  Выполняет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[IsEmpty](M_Tessa_Cards_Numbers_NumberStorageLocation_IsEmpty.htm)|
...
восстановить в методе FromTypedJson.  
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[ToNumberLocation](M_Tessa_Cards_Numbers_NumberStorageLocation_ToNumberLocation.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_Numbers_NumberStorageLocation_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
[CardInfoStorageObject.ValidateInternal(IValidationResultBuilder)](M_Tessa_Cards_CardInfoStorageObject_ValidateInternal.htm))  
##  __Поля
[TypeIDKey](F_Tessa_Cards_Numbers_NumberStorageLocation_TypeIDKey.htm)|  
---|---  
[TypeNameKey](F_Tessa_Cards_Numbers_NumberStorageLocation_TypeNameKey.htm)|  
## __Методы расширения
