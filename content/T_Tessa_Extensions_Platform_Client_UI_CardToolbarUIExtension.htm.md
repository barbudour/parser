# CardToolbarUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class CardToolbarUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class CardToolbarUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class CardToolbarUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type CardToolbarUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ CardToolbarUIExtension
##  __Конструкторы
[CardToolbarUIExtension](M_Tessa_Extensions_Platform_Client_UI_CardToolbarUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса CardToolbarUIExtension  
---|---  
##  __Методы
