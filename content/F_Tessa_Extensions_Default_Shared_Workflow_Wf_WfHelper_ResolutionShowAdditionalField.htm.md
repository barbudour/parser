# WfHelper.ResolutionShowAdditionalField - поле
...
VB __Копировать
     Public Const ResolutionShowAdditionalField As String = "ShowAdditional"
C++ __Копировать
     public:
    literal String^ ResolutionShowAdditionalField = "ShowAdditional"
F# __Копировать
     static val mutable ResolutionShowAdditionalField: string
#### Значение поля
