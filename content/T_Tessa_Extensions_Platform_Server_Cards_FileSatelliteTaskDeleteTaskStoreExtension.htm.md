# FileSatelliteTaskDeleteTaskStoreExtension - класс
...
C# __Копировать
     public sealed class FileSatelliteTaskDeleteTaskStoreExtension : CardStoreTaskExtension
VB __Копировать
     Public NotInheritable Class FileSatelliteTaskDeleteTaskStoreExtension
    	Inherits CardStoreTaskExtension
C++ __Копировать
     public ref class FileSatelliteTaskDeleteTaskStoreExtension sealed : public CardStoreTaskExtension
F# __Копировать
     [<SealedAttribute>]
    type FileSatelliteTaskDeleteTaskStoreExtension = 
        class
            inherit CardStoreTaskExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreTaskExtension](T_Tessa_Cards_Extensions_CardStoreTaskExtension.htm) __ FileSatelliteTaskDeleteTaskStoreExtension
##  __Конструкторы
[FileSatelliteTaskDeleteTaskStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_FileSatelliteTaskDeleteTaskStoreExtension__ctor.htm)|
...
[StoreTaskAfterRequest](M_Tessa_Extensions_Platform_Server_Cards_FileSatelliteTaskDeleteTaskStoreExtension_StoreTaskAfterRequest.htm)|
...
(Переопределяет
[CardStoreTaskExtension.StoreTaskAfterRequest(ICardStoreTaskExtensionContext)](M_Tessa_Cards_Extensions_CardStoreTaskExtension_StoreTaskAfterRequest.htm))  
