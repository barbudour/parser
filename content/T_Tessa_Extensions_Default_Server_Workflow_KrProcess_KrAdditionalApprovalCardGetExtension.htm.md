# KrAdditionalApprovalCardGetExtension - класс
...
C# __Копировать
     public sealed class KrAdditionalApprovalCardGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class KrAdditionalApprovalCardGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class KrAdditionalApprovalCardGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrAdditionalApprovalCardGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ KrAdditionalApprovalCardGetExtension
##  __Конструкторы
[KrAdditionalApprovalCardGetExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrAdditionalApprovalCardGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrAdditionalApprovalCardGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrAdditionalApprovalCardGetExtension_AfterRequest.htm)|
