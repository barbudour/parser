...
C++ __Копировать
     public ref class MeetingResponse : public MeetingMessage
F# __Копировать
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceObject](T_Tessa_Exchange_WebServices_Data_ServiceObject.htm) __[Item](T_Tessa_Exchange_WebServices_Data_Item.htm) __[EmailMessage](T_Tessa_Exchange_WebServices_Data_EmailMessage.htm) __[MeetingMessage](T_Tessa_Exchange_WebServices_Data_MeetingMessage.htm) __ MeetingResponse
##  __Свойства
...
has on this item.  
(Унаследован от [Item](T_Tessa_Exchange_WebServices_Data_Item.htm))  
[End](P_Tessa_Exchange_WebServices_Data_MeetingResponse_End.htm)|  Gets the
end time of the appointment.  
[EnhancedLocation](P_Tessa_Exchange_WebServices_Data_MeetingResponse_EnhancedLocation.htm)|
...
(Унаследован от
[EmailMessage](T_Tessa_Exchange_WebServices_Data_EmailMessage.htm))  
[Location](P_Tessa_Exchange_WebServices_Data_MeetingResponse_Location.htm)|
...
Preview.  
(Унаследован от [Item](T_Tessa_Exchange_WebServices_Data_Item.htm))  
[ProposedEnd](P_Tessa_Exchange_WebServices_Data_MeetingResponse_ProposedEnd.htm)|
Gets the proposed end time of the appointment.  
[ProposedStart](P_Tessa_Exchange_WebServices_Data_MeetingResponse_ProposedStart.htm)|
...
(Унаследован от
[EmailMessage](T_Tessa_Exchange_WebServices_Data_EmailMessage.htm))  
[Recurrence](P_Tessa_Exchange_WebServices_Data_MeetingResponse_Recurrence.htm)|
...
this item.  
(Унаследован от [Item](T_Tessa_Exchange_WebServices_Data_Item.htm))  
[Start](P_Tessa_Exchange_WebServices_Data_MeetingResponse_Start.htm)|  Gets
...
ItemId)](M_Tessa_Exchange_WebServices_Data_MeetingResponse_Bind.htm)|  Binds
to an existing meeting response and loads its first class properties. Calling
this method results in a call to EWS.  
---|---  
[Bind(ExchangeService, ItemId, PropertySet,
CancellationToken)](M_Tessa_Exchange_WebServices_Data_MeetingResponse_Bind_1.htm)|
