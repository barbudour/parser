# UriToImageSourceConverter - класс
...
C# __Копировать
     public sealed class UriToImageSourceConverter : ValueConverter<Uri, ImageSource>
VB __Копировать
     Public NotInheritable Class UriToImageSourceConverter
    	Inherits ValueConverter(Of Uri, ImageSource)
C++ __Копировать
     public ref class UriToImageSourceConverter sealed : public ValueConverter<Uri^, ImageSource^>
F# __Копировать
     [<SealedAttribute>]
    type UriToImageSourceConverter = 
        class
            inherit ValueConverter<Uri, ImageSource>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueConverter](T_Tessa_UI_Data_ValueConverter_2.htm)<[Uri](https://learn.microsoft.com/dotnet/api/system.uri), [ImageSource](https://learn.microsoft.com/dotnet/api/system.windows.media.imagesource)> __ UriToImageSourceConverter
##  __Конструкторы
[UriToImageSourceConverter](M_Tessa_UI_Data_UriToImageSourceConverter__ctor.htm)|
Инициализирует новый экземпляр класса UriToImageSourceConverter  
---|---  
##  __Свойства
[Instance](P_Tessa_UI_Data_UriToImageSourceConverter_Instance.htm)| Экземпляр
класса.  
---|---  
##  __Методы
...
TTarget>](T_Tessa_UI_Data_ValueConverter_2.htm))  
[Convert(Uri, Object,
CultureInfo)](M_Tessa_UI_Data_UriToImageSourceConverter_Convert.htm)|  
