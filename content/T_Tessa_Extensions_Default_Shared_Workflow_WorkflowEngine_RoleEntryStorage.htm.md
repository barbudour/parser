...
C# __Копировать
     public sealed class RoleEntryStorage : StorageObject, 
    	INamedEntry, INamedItem
VB __Копировать
     Public NotInheritable Class RoleEntryStorage
    	Inherits StorageObject
    	Implements INamedEntry, INamedItem
C++ __Копировать
     public ref class RoleEntryStorage sealed : public StorageObject, 
    	INamedEntry, INamedItem
F# __Копировать
     [<SealedAttribute>]
    type RoleEntryStorage = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ RoleEntryStorage
Implements
...
Инициализирует новый экземпляр класса RoleEntryStorage.  
