...
C# __Копировать
     public sealed class ErrorRepairExtension : CardRepairExtension
VB __Копировать
     Public NotInheritable Class ErrorRepairExtension
    	Inherits CardRepairExtension
C++ __Копировать
     public ref class ErrorRepairExtension sealed : public CardRepairExtension
F# __Копировать
     [<SealedAttribute>]
    type ErrorRepairExtension = 
        class
            inherit CardRepairExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm) __ ErrorRepairExtension
##  __Конструкторы
[ErrorRepairExtension](M_Tessa_Extensions_Platform_Shared_Cards_ErrorRepairExtension__ctor.htm)|
Инициализирует новый экземпляр класса ErrorRepairExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Shared_Cards_ErrorRepairExtension_AfterRequest.htm)|  
(Переопределяет
