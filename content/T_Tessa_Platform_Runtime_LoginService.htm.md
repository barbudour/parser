...
C++ __Копировать
     public ref class LoginService sealed : ILoginService
F# __Копировать
     [<SealedAttribute>]
    type LoginService = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ LoginService
Implements
    [ILoginService](T_Tessa_Platform_Runtime_ILoginService.htm)
##  __Конструкторы
[LoginService](M_Tessa_Platform_Runtime_LoginService__ctor.htm)|  Создаёт
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[OpenSessionAsync](M_Tessa_Platform_Runtime_LoginService_OpenSessionAsync.htm)|
...
[OpenSessionWindowsAuthAsync](M_Tessa_Platform_Runtime_LoginService_OpenSessionWindowsAuthAsync.htm)|
