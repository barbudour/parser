# DynamicRoleRecalcUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class DynamicRoleRecalcUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class DynamicRoleRecalcUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class DynamicRoleRecalcUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type DynamicRoleRecalcUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ DynamicRoleRecalcUIExtension
##  __Конструкторы
[DynamicRoleRecalcUIExtension](M_Tessa_Extensions_Platform_Client_UI_DynamicRoleRecalcUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса DynamicRoleRecalcUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_DynamicRoleRecalcUIExtension_Initialized.htm)|  
(Переопределяет
