# ReadOnlyCollectionWrapper<T> \- класс
...
C# __Копировать
     public sealed class ReadOnlyCollectionWrapper<T> : ICollection<T>, 
    	IEnumerable<T>, IEnumerable, INotifyCollectionChanged, IReadOnlyCollection<T>
VB __Копировать
     Public NotInheritable Class ReadOnlyCollectionWrapper(Of T)
    	Implements ICollection(Of T), IEnumerable(Of T), 
    	IEnumerable, INotifyCollectionChanged, IReadOnlyCollection(Of T)
C++ __Копировать
    generic<typename T>
    public ref class ReadOnlyCollectionWrapper sealed : ICollection<T>, 
    	IEnumerable<T>, IEnumerable, INotifyCollectionChanged, IReadOnlyCollection<T>
F# __Копировать
     [<SealedAttribute>]
    type ReadOnlyCollectionWrapper<'T> = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ ReadOnlyCollectionWrapper<T>
Implements
    [ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)<T>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)<T>, [IReadOnlyCollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.ireadonlycollection-1)<T>, [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.ienumerable), [INotifyCollectionChanged](https://learn.microsoft.com/dotnet/api/system.collections.specialized.inotifycollectionchanged)
#### Параметры типа
T
    Тип элементов коллекции.
##  __Конструкторы
[ReadOnlyCollectionWrapper<T>](M_Tessa_Platform_Collections_ReadOnlyCollectionWrapper_1__ctor.htm)|
Создаёт экземпляр объекта с указанием коллекции, к которой необходимо
обеспечить доступ только для чтения.  
---|---  
## __Свойства
[Count](P_Tessa_Platform_Collections_ReadOnlyCollectionWrapper_1_Count.htm)|
Количество элементов в коллекции.  
---|---  
[IsReadOnly](P_Tessa_Platform_Collections_ReadOnlyCollectionWrapper_1_IsReadOnly.htm)|
Признак того, что коллекция доступна только для чтения. Значение всегда равно
true.  
## __Методы
[Contains](M_Tessa_Platform_Collections_ReadOnlyCollectionWrapper_1_Contains.htm)|
Возвращает признак того, что заданный элемент содержится в коллекции.  
---|---  
[CopyTo](M_Tessa_Platform_Collections_ReadOnlyCollectionWrapper_1_CopyTo.htm)|
Копирует содержимое коллекции в заданный массив array, начиная с индекса
arrayIndex.  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetEnumerator](M_Tessa_Platform_Collections_ReadOnlyCollectionWrapper_1_GetEnumerator.htm)|
Возвращает объект, осуществляющий перечисление элементов коллекции.  
...
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
##  __События
[CollectionChanged](E_Tessa_Platform_Collections_ReadOnlyCollectionWrapper_1_CollectionChanged.htm)|
Уведомляет об изменении списка объектов, выполненного через текущий экземпляр
декоратора.  
---|---  
## __Методы расширения
