...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ AttendeeAvailability
##  __Свойства
[CalendarEvents](P_Tessa_Exchange_WebServices_Data_AttendeeAvailability_CalendarEvents.htm)|
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[MergedFreeBusyStatus](P_Tessa_Exchange_WebServices_Data_AttendeeAvailability_MergedFreeBusyStatus.htm)|
...
(Унаследован от
[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm))  
[ViewType](P_Tessa_Exchange_WebServices_Data_AttendeeAvailability_ViewType.htm)|
Gets the free/busy view type that wes retrieved for the attendee.  
[WorkingHours](P_Tessa_Exchange_WebServices_Data_AttendeeAvailability_WorkingHours.htm)|
