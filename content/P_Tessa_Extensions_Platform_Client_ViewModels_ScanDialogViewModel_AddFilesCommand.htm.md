# ScanDialogViewModel.AddFilesCommand - свойство
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public ReadOnly Property AddFilesCommand As ICommand
    	Get
C++ __Копировать
     public:
    property ICommand^ AddFilesCommand {
    	ICommand^ get ();
    }
F# __Копировать
     member AddFilesCommand : ICommand with get
#### Значение свойства
