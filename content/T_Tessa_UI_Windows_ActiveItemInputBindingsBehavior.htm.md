# ActiveItemInputBindingsBehavior - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Windows](N_Tessa_UI_Windows.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class ActiveItemInputBindingsBehavior : Behavior<TabControl>
VB __Копировать
     Public NotInheritable Class ActiveItemInputBindingsBehavior
    	Inherits Behavior(Of TabControl)
C++ __Копировать
     public ref class ActiveItemInputBindingsBehavior sealed : public Behavior<TabControl^>
F# __Копировать
     [<SealedAttribute>]
    type ActiveItemInputBindingsBehavior = 
        class
            inherit Behavior<TabControl>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[TabControl](https://learn.microsoft.com/dotnet/api/system.windows.controls.tabcontrol)> __ ActiveItemInputBindingsBehavior
##  __Конструкторы
[ActiveItemInputBindingsBehavior](M_Tessa_UI_Windows_ActiveItemInputBindingsBehavior__ctor.htm)|
Инициализирует новый экземпляр класса ActiveItemInputBindingsBehavior  
---|---  
##  __Свойства
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Windows_ActiveItemInputBindingsBehavior_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Windows_ActiveItemInputBindingsBehavior_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Windows_ActiveItemInputBindingsBehavior_OnDetaching.htm)|  
(Переопределяет
