# KrSettingsForumLicenseGetExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrSettingsForumLicenseGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class KrSettingsForumLicenseGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrSettingsForumLicenseGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ KrSettingsForumLicenseGetExtension
##  __Конструкторы
[KrSettingsForumLicenseGetExtension](M_Tessa_Extensions_Default_Server_Cards_KrSettingsForumLicenseGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrSettingsForumLicenseGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Cards_KrSettingsForumLicenseGetExtension_AfterRequest.htm)|  
(Переопределяет
