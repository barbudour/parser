# FileTemplateInvalidateCacheStoreExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class FileTemplateInvalidateCacheStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class FileTemplateInvalidateCacheStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type FileTemplateInvalidateCacheStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ FileTemplateInvalidateCacheStoreExtension
##  __Конструкторы
[FileTemplateInvalidateCacheStoreExtension](M_Tessa_Extensions_Default_Server_Cards_FileTemplateInvalidateCacheStoreExtension__ctor.htm)|
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Server_Cards_FileTemplateInvalidateCacheStoreExtension_AfterRequest.htm)|  
(Переопределяет
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Default_Server_Cards_FileTemplateInvalidateCacheStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
