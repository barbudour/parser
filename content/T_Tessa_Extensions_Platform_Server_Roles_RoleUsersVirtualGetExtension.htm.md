# RoleUsersVirtualGetExtension - класс
...
C# __Копировать
     public sealed class RoleUsersVirtualGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class RoleUsersVirtualGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class RoleUsersVirtualGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type RoleUsersVirtualGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ RoleUsersVirtualGetExtension
##  __Конструкторы
[RoleUsersVirtualGetExtension](M_Tessa_Extensions_Platform_Server_Roles_RoleUsersVirtualGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса RoleUsersVirtualGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_RoleUsersVirtualGetExtension_AfterRequest.htm)|  
(Переопределяет
