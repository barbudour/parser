# ComputedInsightValuePropertyCollection - класс
...
VB __Копировать
     Public NotInheritable Class ComputedInsightValuePropertyCollection
    	Inherits ComplexPropertyCollection(Of ComputedInsightValueProperty)
C++ __Копировать
     public ref class ComputedInsightValuePropertyCollection sealed : public ComplexPropertyCollection<ComputedInsightValueProperty^>
F# __Копировать
     [<SealedAttribute>]
    type ComputedInsightValuePropertyCollection = 
        class
            inherit ComplexPropertyCollection<ComputedInsightValueProperty>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[ComputedInsightValueProperty](T_Tessa_Exchange_WebServices_Data_ComputedInsightValueProperty.htm)> __ ComputedInsightValuePropertyCollection
##  __Свойства
