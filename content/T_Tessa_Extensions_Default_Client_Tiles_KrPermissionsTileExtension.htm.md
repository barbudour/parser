# KrPermissionsTileExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrPermissionsTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class KrPermissionsTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type KrPermissionsTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ KrPermissionsTileExtension
##  __Конструкторы
[KrPermissionsTileExtension](M_Tessa_Extensions_Default_Client_Tiles_KrPermissionsTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrPermissionsTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_KrPermissionsTileExtension_InitializingGlobal.htm)|  
(Переопределяет
