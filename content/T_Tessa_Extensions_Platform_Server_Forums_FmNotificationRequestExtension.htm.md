# FmNotificationRequestExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Forums](N_Tessa_Extensions_Platform_Server_Forums.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class FmNotificationRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class FmNotificationRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class FmNotificationRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type FmNotificationRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ FmNotificationRequestExtension
##  __Конструкторы
[FmNotificationRequestExtension](M_Tessa_Extensions_Platform_Server_Forums_FmNotificationRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса FmNotificationRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Forums_FmNotificationRequestExtension_AfterRequest.htm)|  
(Переопределяет
