# ChangeStateStageTypeHandler - класс
Обработчик этапа
...
VB __Копировать
     Public Class ChangeStateStageTypeHandler
    	Inherits StageTypeHandlerBase
C++ __Копировать
     public ref class ChangeStateStageTypeHandler : public StageTypeHandlerBase
F# __Копировать
     type ChangeStateStageTypeHandler = 
        class
            inherit StageTypeHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StageTypeHandlerBase](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTypeHandlerBase.htm) __ ChangeStateStageTypeHandler
##  __Конструкторы
[ChangeStateStageTypeHandler](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_ChangeStateStageTypeHandler__ctor.htm)|
Инициализирует новый экземпляр класса ChangeStateStageTypeHandler  
---|---  
##  __Методы
...
(Унаследован от
[StageTypeHandlerBase](T_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_StageTypeHandlerBase.htm))  
[HandleStageStartAsync](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Workflow_Handlers_ChangeStateStageTypeHandler_HandleStageStartAsync.htm)|
