...
C# __Копировать
    ...
    public sealed class WorkplaceStoreRequest : StorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkplaceStoreRequest
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkplaceStoreRequest sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkplaceStoreRequest = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ WorkplaceStoreRequest
##  __Конструкторы
[WorkplaceStoreRequest()](M_Tessa_Platform_Configuration_WorkplaceStoreRequest__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[WorkplaceStoreRequest(Dictionary<String,
Object>)](M_Tessa_Platform_Configuration_WorkplaceStoreRequest__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[WorkplaceStoreRequest(IStorageObjectProvider)](M_Tessa_Platform_Configuration_WorkplaceStoreRequest__ctor_2.htm)|
...
## __Свойства
[Action](P_Tessa_Platform_Configuration_WorkplaceStoreRequest_Action.htm)|  
---|---  
[FormatVersion](P_Tessa_Platform_Configuration_WorkplaceStoreRequest_FormatVersion.htm)|  
[ID](P_Tessa_Platform_Configuration_WorkplaceStoreRequest_ID.htm)|  
[ImportRoles](P_Tessa_Platform_Configuration_WorkplaceStoreRequest_ImportRoles.htm)|  
[ImportSearchQueries](P_Tessa_Platform_Configuration_WorkplaceStoreRequest_ImportSearchQueries.htm)|  
[ImportViews](P_Tessa_Platform_Configuration_WorkplaceStoreRequest_ImportViews.htm)|  
[Metadata](P_Tessa_Platform_Configuration_WorkplaceStoreRequest_Metadata.htm)|  
[Name](P_Tessa_Platform_Configuration_WorkplaceStoreRequest_Name.htm)|  
[NeedClear](P_Tessa_Platform_Configuration_WorkplaceStoreRequest_NeedClear.htm)|  
## __Методы
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[GetDisplayName()](M_Tessa_Platform_Configuration_WorkplaceStoreRequest_GetDisplayName.htm)|  
[GetDisplayName(Guid,
String)](M_Tessa_Platform_Configuration_WorkplaceStoreRequest_GetDisplayName_1.htm)|  
