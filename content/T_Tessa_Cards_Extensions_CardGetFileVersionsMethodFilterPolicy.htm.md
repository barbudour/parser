# CardGetFileVersionsMethodFilterPolicy - класс
...
C# __Копировать
     public sealed class CardGetFileVersionsMethodFilterPolicy : IFilterPolicy, 
    	IExtensionPolicy
VB __Копировать
     Public NotInheritable Class CardGetFileVersionsMethodFilterPolicy
    	Implements IFilterPolicy, IExtensionPolicy
C++ __Копировать
     public ref class CardGetFileVersionsMethodFilterPolicy sealed : IFilterPolicy, 
    	IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type CardGetFileVersionsMethodFilterPolicy = 
        class
            interface IFilterPolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardGetFileVersionsMethodFilterPolicy
Implements
    [IExtensionPolicy](T_Tessa_Extensions_IExtensionPolicy.htm), [IFilterPolicy](T_Tessa_Extensions_IFilterPolicy.htm)
##  __Конструкторы
[CardGetFileVersionsMethodFilterPolicy](M_Tessa_Cards_Extensions_CardGetFileVersionsMethodFilterPolicy__ctor.htm)|
Инициализирует новый экземпляр класса CardGetFileVersionsMethodFilterPolicy  
---|---  
##  __Свойства
...
---|---  
[FilterAsync](M_Tessa_Cards_Extensions_CardGetFileVersionsMethodFilterPolicy_FilterAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetFilterContextAsync](M_Tessa_Cards_Extensions_CardGetFileVersionsMethodFilterPolicy_GetFilterContextAsync.htm)|
