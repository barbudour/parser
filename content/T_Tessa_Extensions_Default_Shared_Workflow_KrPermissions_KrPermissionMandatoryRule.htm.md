# KrPermissionMandatoryRule - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class KrPermissionMandatoryRule
C++ __Копировать
     public ref class KrPermissionMandatoryRule sealed
F# __Копировать
     [<SealedAttribute>]
    type KrPermissionMandatoryRule = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ KrPermissionMandatoryRule
##  __Конструкторы
[KrPermissionMandatoryRule](M_Tessa_Extensions_Default_Shared_Workflow_KrPermissions_KrPermissionMandatoryRule__ctor.htm)|
Инициализирует новый экземпляр класса KrPermissionMandatoryRule  
---|---  
##  __Свойства
