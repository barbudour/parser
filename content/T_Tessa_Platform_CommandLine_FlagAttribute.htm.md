...
VB __Копировать
    <AttributeUsageAttribute(AttributeTargets.Field)>
    Public NotInheritable Class FlagAttribute
    	Inherits Attribute
C++ __Копировать
    [AttributeUsageAttribute(AttributeTargets::Field)]
    public ref class FlagAttribute sealed : public Attribute
F# __Копировать
     [<SealedAttribute>]
    [<AttributeUsageAttribute(AttributeTargets.Field)>]
    type FlagAttribute = 
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Attribute](https://learn.microsoft.com/dotnet/api/system.attribute) __ FlagAttribute
##  __Конструкторы
[FlagAttribute](M_Tessa_Platform_CommandLine_FlagAttribute__ctor.htm)|
Initializes a new instance of the FlagAttribute class using the specified flag
name.  
---|---  
## __Свойства
[Name](P_Tessa_Platform_CommandLine_FlagAttribute_Name.htm)|  Gets the name
