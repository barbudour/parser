# CardGetFileContentMethodFilterPolicy - класс
...
C# __Копировать
     public sealed class CardGetFileContentMethodFilterPolicy : IFilterPolicy, 
    	IExtensionPolicy
VB __Копировать
     Public NotInheritable Class CardGetFileContentMethodFilterPolicy
    	Implements IFilterPolicy, IExtensionPolicy
C++ __Копировать
     public ref class CardGetFileContentMethodFilterPolicy sealed : IFilterPolicy, 
    	IExtensionPolicy
F# __Копировать
     [<SealedAttribute>]
    type CardGetFileContentMethodFilterPolicy = 
        class
            interface IFilterPolicy
            interface IExtensionPolicy
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardGetFileContentMethodFilterPolicy
Implements
    [IExtensionPolicy](T_Tessa_Extensions_IExtensionPolicy.htm), [IFilterPolicy](T_Tessa_Extensions_IFilterPolicy.htm)
##  __Конструкторы
[CardGetFileContentMethodFilterPolicy](M_Tessa_Cards_Extensions_CardGetFileContentMethodFilterPolicy__ctor.htm)|
Инициализирует новый экземпляр класса CardGetFileContentMethodFilterPolicy  
---|---  
##  __Свойства
...
---|---  
[FilterAsync](M_Tessa_Cards_Extensions_CardGetFileContentMethodFilterPolicy_FilterAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetFilterContextAsync](M_Tessa_Cards_Extensions_CardGetFileContentMethodFilterPolicy_GetFilterContextAsync.htm)|
