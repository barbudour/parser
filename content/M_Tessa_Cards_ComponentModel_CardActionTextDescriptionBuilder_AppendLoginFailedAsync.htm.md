# CardActionTextDescriptionBuilder.AppendLoginFailedAsync - метод
...
C# __Копировать
     public ValueTask<StringBuilder> AppendLoginFailedAsync(
    	StringBuilder builder,
    	Dictionary<string, Object> storage,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Public Function AppendLoginFailedAsync ( 
...
C++ __Копировать
     public:
    virtual ValueTask<StringBuilder^> AppendLoginFailedAsync(
    	StringBuilder^ builder, 
    	Dictionary<String^, Object^>^ storage, 
    	CancellationToken cancellationToken = CancellationToken()
    ) sealed
F# __Копировать
     abstract AppendLoginFailedAsync : 
    ...
    *)
    ...
    override AppendLoginFailedAsync : 
            builder : StringBuilder * 
            storage : Dictionary<string, Object> * 
            ?cancellationToken : CancellationToken 
    (* Defaults:
...
[Object](https://learn.microsoft.com/dotnet/api/system.object)>
    Хранилище для записи в истории действий с информацией по неудачной попытке входа в систему.
cancellationToken
...
#### Реализации
[ICardActionDescriptionBuilder.AppendLoginFailedAsync(StringBuilder,
Dictionary<String, Object>,
CancellationToken)](M_Tessa_Cards_ComponentModel_ICardActionDescriptionBuilder_AppendLoginFailedAsync.htm)  
##  __См. также
#### Ссылки
