# KrPermissionSectionSettings.AllowedFields - свойство
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public HashSet<Guid> AllowedFields { get; set; }
VB __Копировать
     Public Property AllowedFields As HashSet(Of Guid)
    	Get
    	Set
C++ __Копировать
     public:
    property HashSet<Guid>^ AllowedFields {
    	HashSet<Guid>^ get ();
    	void set (HashSet<Guid>^ value);
    }
F# __Копировать
     member AllowedFields : HashSet<Guid> with get, set
#### Значение свойства
