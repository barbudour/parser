...
C# __Копировать
     public sealed class MenuAction : SelectableViewModel<EmptyModel>, 
    	IMenuAction, ICloneable, INamedItem, INotifyPropertyChanged
VB __Копировать
     Public NotInheritable Class MenuAction
    	Inherits SelectableViewModel(Of EmptyModel)
    	Implements IMenuAction, ICloneable, INamedItem, INotifyPropertyChanged
C++ __Копировать
     public ref class MenuAction sealed : public SelectableViewModel<EmptyModel^>, 
    	IMenuAction, ICloneable, INamedItem, INotifyPropertyChanged
F# __Копировать
     [<SealedAttribute>]
    type MenuAction = 
...
##  __Конструкторы
[MenuAction](M_Tessa_UI_Menu_MenuAction__ctor.htm)|  Создаёт экземпляр класса
с указанием значений его свойств.  
---|---  
## __Свойства
[Caption](P_Tessa_UI_Menu_MenuAction_Caption.htm)| Заголовок действия,
отображаемый пользователю.  
---|---  
[CaptionFontWeight](P_Tessa_UI_Menu_MenuAction_CaptionFontWeight.htm)|
Толщина шрифта, используемая при выводе заголовка
[Tessa.UI.Menu.IMenuAction.Caption].  
[Children](P_Tessa_UI_Menu_MenuAction_Children.htm)| Дочерние действия.  
[Command](P_Tessa_UI_Menu_MenuAction_Command.htm)| Команда по действию.  
[CommandClosure](P_Tessa_UI_Menu_MenuAction_CommandClosure.htm)|  Замыкание
...
[Icon](P_Tessa_UI_Menu_MenuAction_Icon.htm)| Заголовок действия, отображаемый
пользователю.  
[Info](P_Tessa_UI_Menu_MenuAction_Info.htm)| Информация для расширений.  
[InputGestureText](P_Tessa_UI_Menu_MenuAction_InputGestureText.htm)|  Текст с
...
[IsCollapsed](P_Tessa_UI_Menu_MenuAction_IsCollapsed.htm)|  Признак того, что
действие скрыто от пользователя. По умолчанию значение false.  
[IsEnabled](P_Tessa_UI_Menu_MenuAction_IsEnabled.htm)|  Признак того, что
...
[Name](P_Tessa_UI_Menu_MenuAction_Name.htm)| Имя объекта, по которому объект
можно идентифицировать в коллекциях.  
[Scope](P_Tessa_UI_ViewModel_1_Scope.htm)|  
(Унаследован от [ViewModel<TModel>](T_Tessa_UI_ViewModel_1.htm))  
[Tooltip](P_Tessa_UI_Menu_MenuAction_Tooltip.htm)| Подсказка элемента меню.  
##  __Методы
[Clone](M_Tessa_UI_Menu_MenuAction_Clone.htm)| Создаёт полную копию действия и
его дочерних действий.  
---|---  
