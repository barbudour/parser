# PersonalRoleDeputiesPermissionsNewExtension - класс
...
C# __Копировать
     public sealed class PersonalRoleDeputiesPermissionsNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class PersonalRoleDeputiesPermissionsNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class PersonalRoleDeputiesPermissionsNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type PersonalRoleDeputiesPermissionsNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ PersonalRoleDeputiesPermissionsNewExtension
##  __Конструкторы
[PersonalRoleDeputiesPermissionsNewExtension](M_Tessa_Extensions_Platform_Server_Roles_PersonalRoleDeputiesPermissionsNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса
PersonalRoleDeputiesPermissionsNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Roles_PersonalRoleDeputiesPermissionsNewExtension_AfterRequest.htm)|  
(Переопределяет
