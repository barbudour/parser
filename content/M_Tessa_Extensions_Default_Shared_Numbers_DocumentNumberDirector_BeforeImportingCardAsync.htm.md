# DocumentNumberDirector.BeforeImportingCardAsync - метод
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     protected override Task<bool> BeforeImportingCardAsync(
    	INumberContext context,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Protected Overrides Function BeforeImportingCardAsync ( 
    	context As INumberContext,
    	Optional cancellationToken As CancellationToken = Nothing
    ) As Task(Of Boolean)
C++ __Копировать
     protected:
    virtual Task<bool>^ BeforeImportingCardAsync(
    	INumberContext^ context, 
    	CancellationToken cancellationToken = CancellationToken()
    ) override
F# __Копировать
     abstract BeforeImportingCardAsync : 
    ...
    *)
    -> Task<bool> 
    override BeforeImportingCardAsync : 
            context : INumberContext * 
            ?cancellationToken : CancellationToken 
    (* Defaults:
            let _cancellationToken = defaultArg cancellationToken new CancellationToken()
