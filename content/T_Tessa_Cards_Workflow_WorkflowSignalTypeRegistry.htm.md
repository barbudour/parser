# WorkflowSignalTypeRegistry - класс
...
C# __Копировать
     public sealed class WorkflowSignalTypeRegistry : Registry<Guid, WorkflowSignalType>, 
    	IWorkflowSignalTypeRegistry, IRegistry<Guid, WorkflowSignalType>
VB __Копировать
     Public NotInheritable Class WorkflowSignalTypeRegistry
    	Inherits Registry(Of Guid, WorkflowSignalType)
    	Implements IWorkflowSignalTypeRegistry, IRegistry(Of Guid, WorkflowSignalType)
C++ __Копировать
     public ref class WorkflowSignalTypeRegistry sealed : public Registry<Guid, WorkflowSignalType^>, 
    	IWorkflowSignalTypeRegistry, IRegistry<Guid, WorkflowSignalType^>
F# __Копировать
     [<SealedAttribute>]
    type WorkflowSignalTypeRegistry = 
        class
            inherit Registry<Guid, WorkflowSignalType>
            interface IWorkflowSignalTypeRegistry
            interface IRegistry<Guid, WorkflowSignalType>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Registry](T_Tessa_Platform_Registry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [WorkflowSignalType](T_Tessa_Cards_Workflow_WorkflowSignalType.htm)> __ WorkflowSignalTypeRegistry
Implements
    [IWorkflowSignalTypeRegistry](T_Tessa_Cards_Workflow_IWorkflowSignalTypeRegistry.htm), [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [WorkflowSignalType](T_Tessa_Cards_Workflow_WorkflowSignalType.htm)>
##  __Свойства
