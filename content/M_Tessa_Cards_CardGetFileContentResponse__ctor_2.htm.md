# CardGetFileContentResponse(IStorageObjectProvider) - конструктор
...
C# __Копировать
     public CardGetFileContentResponse(
...
F# __Копировать
     new : 
            storageProvider : IStorageObjectProvider -> CardGetFileContentResponse
#### Параметры
storageProvider
...
[CardGetFileContentResponse -
перегрузка](Overload_Tessa_Cards_CardGetFileContentResponse__ctor.htm)
