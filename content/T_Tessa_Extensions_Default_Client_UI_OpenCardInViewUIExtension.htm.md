# OpenCardInViewUIExtension - класс
...
VB __Копировать
     Public NotInheritable Class OpenCardInViewUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class OpenCardInViewUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type OpenCardInViewUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ OpenCardInViewUIExtension
##  __Конструкторы
[OpenCardInViewUIExtension](M_Tessa_Extensions_Default_Client_UI_OpenCardInViewUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса OpenCardInViewUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_OpenCardInViewUIExtension_Initialized.htm)|
