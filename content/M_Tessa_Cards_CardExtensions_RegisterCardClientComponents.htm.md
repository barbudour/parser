# CardExtensions.RegisterCardClientComponents - метод
...
C# __Копировать
     public static IUnityContainer RegisterCardClientComponents(
    	this IUnityContainer container
    )
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function RegisterCardClientComponents ( 
    	container As IUnityContainer
    ) As IUnityContainer
C++ __Копировать
     public:
    [ExtensionAttribute]
    static IUnityContainer^ RegisterCardClientComponents(
    	IUnityContainer^ container
    )
F# __Копировать
     [<ExtensionAttribute>]
    static member RegisterCardClientComponents : 
