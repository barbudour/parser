# ContactPhoneEntityCollection - класс
...
VB __Копировать
    <EditorBrowsableAttribute(EditorBrowsableState.Never)>
    Public NotInheritable Class ContactPhoneEntityCollection
    	Inherits ComplexPropertyCollection(Of ContactPhoneEntity)
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class ContactPhoneEntityCollection sealed : public ComplexPropertyCollection<ContactPhoneEntity^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type ContactPhoneEntityCollection = 
        class
            inherit ComplexPropertyCollection<ContactPhoneEntity>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[ContactPhoneEntity](T_Tessa_Exchange_WebServices_Data_ContactPhoneEntity.htm)> __ ContactPhoneEntityCollection
##  __Свойства
