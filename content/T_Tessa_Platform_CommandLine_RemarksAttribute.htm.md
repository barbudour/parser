...
VB __Копировать
    <AttributeUsageAttribute(AttributeTargets.Method)>
    Public Class RemarksAttribute
    	Inherits Attribute
C++ __Копировать
    [AttributeUsageAttribute(AttributeTargets::Method)]
    public ref class RemarksAttribute : public Attribute
F# __Копировать
     [<AttributeUsageAttribute(AttributeTargets.Method)>]
    type RemarksAttribute = 
        class
            inherit Attribute
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Attribute](https://learn.microsoft.com/dotnet/api/system.attribute) __ RemarksAttribute
##  __Конструкторы
[RemarksAttribute()](M_Tessa_Platform_CommandLine_RemarksAttribute__ctor.htm)|
Initializes a new instance of the RemarksAttribute class with no remarks.  
---|---  
[RemarksAttribute(String)](M_Tessa_Platform_CommandLine_RemarksAttribute__ctor_1.htm)|
Initializes a new instance of the RemarksAttribute class using the specified
remarks.  
## __Свойства
[Remarks](P_Tessa_Platform_CommandLine_RemarksAttribute_Remarks.htm)|  Gets
the remarks stored in this attribute.  
---|---  
[RemarksValue](P_Tessa_Platform_CommandLine_RemarksAttribute_RemarksValue.htm)|
