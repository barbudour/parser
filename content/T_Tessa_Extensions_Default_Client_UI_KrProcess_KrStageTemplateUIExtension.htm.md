# KrStageTemplateUIExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrStageTemplateUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrStageTemplateUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrStageTemplateUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrStageTemplateUIExtension
##  __Конструкторы
[KrStageTemplateUIExtension](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrStageTemplateUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrStageTemplateUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_KrProcess_KrStageTemplateUIExtension_Initialized.htm)|
