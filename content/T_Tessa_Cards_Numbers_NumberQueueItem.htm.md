...
## __Методы
[Clean](M_Tessa_Cards_Numbers_NumberQueueItem_Clean.htm)| Выполняет очистку
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_Numbers_NumberQueueItem_Clone.htm)|  Выполняет глубокое
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Cards_Numbers_NumberQueueItem_EnsureCacheResolved.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[IsEmpty](M_Tessa_Cards_Numbers_NumberQueueItem_IsEmpty.htm)|  Возвращает
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetNumber](M_Tessa_Cards_Numbers_NumberQueueItem_TryGetNumber.htm)|
Возвращает номер, для которого требуется выполнить действие в очереди, или
null, если номер ещё не был задан.  
[TryGetSourceLocation](M_Tessa_Cards_Numbers_NumberQueueItem_TryGetSourceLocation.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetTargetLocation](M_Tessa_Cards_Numbers_NumberQueueItem_TryGetTargetLocation.htm)|
Возвращает информацию по местоположению номера в карточке, по которому номер
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_Numbers_NumberQueueItem_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
...
Устанавливает идентификатор записи в очереди действий NumberQueueItem, который
будет использоваться для предиката в текущей записи.  
...
Возвращает идентификатор записи в очереди действий NumberQueueItem, который
