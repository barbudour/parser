# WorkflowEngineCompiledTypesViewInterceptor - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Workflow](N_Tessa_Extensions_Platform_Server_Workflow.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class WorkflowEngineCompiledTypesViewInterceptor : ViewInterceptorBase
VB __Копировать
     Public NotInheritable Class WorkflowEngineCompiledTypesViewInterceptor
    	Inherits ViewInterceptorBase
C++ __Копировать
     public ref class WorkflowEngineCompiledTypesViewInterceptor sealed : public ViewInterceptorBase
F# __Копировать
     [<SealedAttribute>]
    type WorkflowEngineCompiledTypesViewInterceptor = 
        class
            inherit ViewInterceptorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ViewInterceptorBase](T_Tessa_Views_ViewInterceptorBase.htm) __ WorkflowEngineCompiledTypesViewInterceptor
##  __Конструкторы
[WorkflowEngineCompiledTypesViewInterceptor](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowEngineCompiledTypesViewInterceptor__ctor.htm)|
Инициализирует новый экземпляр класса
WorkflowEngineCompiledTypesViewInterceptor  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetDataAsync](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowEngineCompiledTypesViewInterceptor_GetDataAsync.htm)|
