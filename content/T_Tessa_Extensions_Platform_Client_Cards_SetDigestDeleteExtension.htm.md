# SetDigestDeleteExtension - класс
...
C# __Копировать
     public sealed class SetDigestDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class SetDigestDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class SetDigestDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type SetDigestDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ SetDigestDeleteExtension
##  __Конструкторы
[SetDigestDeleteExtension](M_Tessa_Extensions_Platform_Client_Cards_SetDigestDeleteExtension__ctor.htm)|
Инициализирует новый экземпляр класса SetDigestDeleteExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Client_Cards_SetDigestDeleteExtension_BeforeRequest.htm)|  
(Переопределяет
