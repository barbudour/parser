# NoServerInGetDigestRequestExtension - класс
...
C# __Копировать
     public sealed class NoServerInGetDigestRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class NoServerInGetDigestRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class NoServerInGetDigestRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type NoServerInGetDigestRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ NoServerInGetDigestRequestExtension
##  __Конструкторы
[NoServerInGetDigestRequestExtension](M_Tessa_Extensions_Platform_Shared_Cards_NoServerInGetDigestRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса NoServerInGetDigestRequestExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Shared_Cards_NoServerInGetDigestRequestExtension_BeforeRequest.htm)|  
(Переопределяет
