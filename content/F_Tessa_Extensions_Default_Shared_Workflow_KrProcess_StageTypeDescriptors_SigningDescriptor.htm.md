# StageTypeDescriptors.SigningDescriptor - поле
...
VB __Копировать
     Public Shared ReadOnly SigningDescriptor As StageTypeDescriptor
C++ __Копировать
     public:
    static initonly StageTypeDescriptor^ SigningDescriptor
F# __Копировать
     static val SigningDescriptor: StageTypeDescriptor
#### Значение поля
