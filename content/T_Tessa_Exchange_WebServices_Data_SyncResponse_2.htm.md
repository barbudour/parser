# SyncResponse<TServiceObject, TChange> \- класс
...
VB __Копировать
    <EditorBrowsableAttribute(EditorBrowsableState.Never)>
    Public MustInherit Class SyncResponse(Of TServiceObject As ServiceObject, TChange As Change)
...
C++ __Копировать
    ...
    where TServiceObject : ServiceObject
    where TChange : Change
    public ref class SyncResponse abstract : public ServiceResponse
F# __Копировать
     [<AbstractClassAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type SyncResponse<'TServiceObject, 'TChange when 'TServiceObject : ServiceObject when 'TChange : Change> = 
        class
            inherit ServiceResponse
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ServiceResponse](T_Tessa_Exchange_WebServices_Data_ServiceResponse.htm) __ SyncResponse<TServiceObject, TChange>
Derived
[Tessa.Exchange.WebServices.Data.SyncFolderHierarchyResponse](T_Tessa_Exchange_WebServices_Data_SyncFolderHierarchyResponse.htm)
[Tessa.Exchange.WebServices.Data.SyncFolderItemsResponse](T_Tessa_Exchange_WebServices_Data_SyncFolderItemsResponse.htm)
#### Параметры типа
TServiceObject
    ServiceObject type.
TChange
    Change type.
##  __Свойства
[Changes](P_Tessa_Exchange_WebServices_Data_SyncResponse_2_Changes.htm)|  Gets
a list of changes that occurred on the synchronized folder.  
---|---  
