# CardStoreStreamingContext - класс
...
C# __Копировать
     public sealed class CardStoreStreamingContext : ICardStoreStreamingContext
VB __Копировать
     Public NotInheritable Class CardStoreStreamingContext
    	Implements ICardStoreStreamingContext
C++ __Копировать
     public ref class CardStoreStreamingContext sealed : ICardStoreStreamingContext
F# __Копировать
     [<SealedAttribute>]
    type CardStoreStreamingContext = 
        class
            interface ICardStoreStreamingContext
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardStoreStreamingContext
Implements
    [ICardStoreStreamingContext](T_Tessa_Cards_ComponentModel_ICardStoreStreamingContext.htm)
##  __Конструкторы
[CardStoreStreamingContext](M_Tessa_Cards_ComponentModel_CardStoreStreamingContext__ctor.htm)|
Инициализирует новый экземпляр класса CardStoreStreamingContext  
---|---  
##  __Свойства
