...
[ComplexPropertyCollection<TComplexProperty>](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm))  
##  __Методы
[Add(EmailAddress)](M_Tessa_Exchange_WebServices_Data_EmailAddressCollection_Add_2.htm)|
Adds an e-mail address to the collection.  
---|---  
[Add(String)](M_Tessa_Exchange_WebServices_Data_EmailAddressCollection_Add.htm)|
Adds an e-mail address to the collection.  
[Add(String,
String)](M_Tessa_Exchange_WebServices_Data_EmailAddressCollection_Add_1.htm)|
Adds an e-mail address to the collection.  
[AddRange(IEnumerable<String>)](M_Tessa_Exchange_WebServices_Data_EmailAddressCollection_AddRange.htm)|
Adds multiple e-mail addresses to the collection.  
[AddRange(IEnumerable<EmailAddress>)](M_Tessa_Exchange_WebServices_Data_EmailAddressCollection_AddRange_1.htm)|
Adds multiple e-mail addresses to the collection.  
[Clear](M_Tessa_Exchange_WebServices_Data_EmailAddressCollection_Clear.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Remove](M_Tessa_Exchange_WebServices_Data_EmailAddressCollection_Remove.htm)|
Removes an e-mail address from the collection.  
[RemoveAt](M_Tessa_Exchange_WebServices_Data_EmailAddressCollection_RemoveAt.htm)|
Removes an e-mail address from the collection.  
