# UriLinkDependencies - класс
Объект, содержащий зависимости для обработки ссылок.
## __Definition
 **Пространство имён:** [Tessa.UriLinks](N_Tessa_UriLinks.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public class UriLinkDependencies : IUriLinkDependencies
VB __Копировать
     Public Class UriLinkDependencies
    	Implements IUriLinkDependencies
C++ __Копировать
     public ref class UriLinkDependencies : IUriLinkDependencies
F# __Копировать
     type UriLinkDependencies = 
        class
            interface IUriLinkDependencies
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ UriLinkDependencies
Implements
    [IUriLinkDependencies](T_Tessa_UriLinks_IUriLinkDependencies.htm)
##  __Конструкторы
[UriLinkDependencies](M_Tessa_UriLinks_UriLinkDependencies__ctor.htm)|
