# CardDeleteResponse - класс
Ответ на запрос на удаление карточки посредством сервиса карточек. Содержит
объект, осуществляющий валидацию результата удаления.
## __Definition
 **Пространство имён:** [Tessa.Cards](N_Tessa_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class CardDeleteResponse : CardResponseBase, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardDeleteResponse
    	Inherits CardResponseBase
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class CardDeleteResponse sealed : public CardResponseBase, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
##  __Методы
[Clean](M_Tessa_Cards_CardDeleteResponse_Clean.htm)| Выполняет очистку
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Cards_CardDeleteResponse_Clone.htm)|  Выполняет глубокое
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[FromTypedJson](M_Tessa_Cards_CardDeleteResponse_FromTypedJson.htm)|
Устанавливает содержимое объекта в соответствии с данными, десериализованными
...
(Унаследован от [CardResponseBase](T_Tessa_Cards_CardResponseBase.htm))  
##  __Поля
[CardTypeIDKey](F_Tessa_Cards_CardDeleteResponse_CardTypeIDKey.htm)|  
---|---  
[CardTypeNameKey](F_Tessa_Cards_CardDeleteResponse_CardTypeNameKey.htm)|  
## __Методы расширения
