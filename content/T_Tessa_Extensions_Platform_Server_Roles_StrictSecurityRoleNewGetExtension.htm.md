# StrictSecurityRoleNewGetExtension - класс
...
C# __Копировать
     public sealed class StrictSecurityRoleNewGetExtension : CardNewGetExtension
VB __Копировать
     Public NotInheritable Class StrictSecurityRoleNewGetExtension
    	Inherits CardNewGetExtension
C++ __Копировать
     public ref class StrictSecurityRoleNewGetExtension sealed : public CardNewGetExtension
F# __Копировать
     [<SealedAttribute>]
    type StrictSecurityRoleNewGetExtension = 
        class
            inherit CardNewGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewGetExtension](T_Tessa_Cards_Extensions_CardNewGetExtension.htm) __ StrictSecurityRoleNewGetExtension
##  __Конструкторы
[StrictSecurityRoleNewGetExtension](M_Tessa_Extensions_Platform_Server_Roles_StrictSecurityRoleNewGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса StrictSecurityRoleNewGetExtension  
---|---  
##  __Методы
[AfterRequest(ICardGetExtensionContext)](M_Tessa_Extensions_Platform_Server_Roles_StrictSecurityRoleNewGetExtension_AfterRequest.htm)|  
(Переопределяет
[CardNewGetExtension.AfterRequest(ICardGetExtensionContext)](M_Tessa_Cards_Extensions_CardNewGetExtension_AfterRequest.htm))  
---|---  
[AfterRequest(ICardNewExtensionContext)](M_Tessa_Extensions_Platform_Server_Roles_StrictSecurityRoleNewGetExtension_AfterRequest_1.htm)|  
(Переопределяет
