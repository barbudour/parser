...
VB __Копировать
    <AttributeUsageAttribute(AttributeTargets.Field)>
    Public NotInheritable Class ThemePropertyAttribute
    	Inherits Attribute
    	Implements IThemePropertyInfo
C++ __Копировать
    [AttributeUsageAttribute(AttributeTargets::Field)]
    public ref class ThemePropertyAttribute sealed : public Attribute, 
    	IThemePropertyInfo
F# __Копировать
     [<SealedAttribute>]
    [<AttributeUsageAttribute(AttributeTargets.Field)>]
    type ThemePropertyAttribute = 
        class
            inherit Attribute
            interface IThemePropertyInfo
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Attribute](https://learn.microsoft.com/dotnet/api/system.attribute) __ ThemePropertyAttribute
Implements
    [IThemePropertyInfo](T_Tessa_Themes_IThemePropertyInfo.htm)
##  __Конструкторы
[ThemePropertyAttribute](M_Tessa_Themes_ThemePropertyAttribute__ctor.htm)|
Создаёт атрибут с указанием его обязательных свойств.  
---|---  
## __Свойства
[PropertyType](P_Tessa_Themes_ThemePropertyAttribute_PropertyType.htm)|  Тип
свойства темы.  
---|---  
