# SchemeOperationException - класс
##  __Definition
 **Пространство имён:** [Tessa.Scheme](N_Tessa_Scheme.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class SchemeOperationException : SchemeException
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class SchemeOperationException
    	Inherits SchemeException
C++ __Копировать
    [SerializableAttribute]
    public ref class SchemeOperationException sealed : public SchemeException
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type SchemeOperationException = 
        class
            inherit SchemeException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[SchemeException](T_Tessa_Scheme_SchemeException.htm) __ SchemeOperationException
##  __Конструкторы
[SchemeOperationException](M_Tessa_Scheme_SchemeOperationException__ctor.htm)|
...
---|---  
[Dump](P_Tessa_Scheme_SchemeOperationException_Dump.htm)|  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetObjectData](M_Tessa_Scheme_SchemeOperationException_GetObjectData.htm)|  
