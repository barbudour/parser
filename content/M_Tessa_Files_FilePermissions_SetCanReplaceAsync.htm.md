...
value [Boolean](https://learn.microsoft.com/dotnet/api/system.boolean)
     Устанавливаемый признак того, что контент файла можно заменить. 
...
Асинхронная задача.
#### Реализации
[IFilePermissions.SetCanReplaceAsync(Boolean, Func<Action, CancellationToken,
Task>,
CancellationToken)](M_Tessa_Files_IFilePermissions_SetCanReplaceAsync.htm)  
##  __Исключения
