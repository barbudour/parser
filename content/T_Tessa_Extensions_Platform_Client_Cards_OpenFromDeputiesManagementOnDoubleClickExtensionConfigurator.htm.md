# OpenFromDeputiesManagementOnDoubleClickExtensionConfigurator - класс
...
C# __Копировать
     public sealed class OpenFromDeputiesManagementOnDoubleClickExtensionConfigurator : ExtensionSettingsConfiguratorBase
VB __Копировать
     Public NotInheritable Class OpenFromDeputiesManagementOnDoubleClickExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class OpenFromDeputiesManagementOnDoubleClickExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type OpenFromDeputiesManagementOnDoubleClickExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ OpenFromDeputiesManagementOnDoubleClickExtensionConfigurator
##  __Конструкторы
[OpenFromDeputiesManagementOnDoubleClickExtensionConfigurator](M_Tessa_Extensions_Platform_Client_Cards_OpenFromDeputiesManagementOnDoubleClickExtensionConfigurator__ctor.htm)|
