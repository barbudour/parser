...
C# __Копировать
     public class Performer : StorageObject, IEquatable<Performer>, 
    	ISealable
VB __Копировать
     Public Class Performer
    	Inherits StorageObject
    	Implements IEquatable(Of Performer), ISealable
C++ __Копировать
     public ref class Performer : public StorageObject, 
    	IEquatable<Performer^>, ISealable
F# __Копировать
     type Performer = 
        class
            inherit StorageObject
            interface IEquatable<Performer>
            interface ISealable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ Performer
Derived
[Tessa.Extensions.Default.Server.Workflow.KrObjectModel.MultiPerformer](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_MultiPerformer.htm)
[Tessa.Extensions.Default.Server.Workflow.KrObjectModel.SinglePerformerProxy](T_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_SinglePerformerProxy.htm)
Implements
    [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)<Performer>, [ISealable](T_Tessa_Platform_ISealable.htm)
##  __Конструкторы
[Performer()](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer__ctor.htm)|
Initializes a new instance of the
[Object](https://learn.microsoft.com/dotnet/api/system.object) class.  
---|---  
[Performer(Dictionary<String,
Object>)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[Performer(Guid,
String)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer__ctor_2.htm)|
Инициализирует новый экземпляр класса Performer  
##  __Свойства
...
---|---  
[IsSql](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_IsSql.htm)|
Признак того, что исполнитель подставлен через SQL  
[PerformerID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_PerformerID.htm)|
ID роли исполнителя  
[PerformerName](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_PerformerName.htm)|
Имя роли исполнителя  
[RowID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_RowID.htm)|
Идентификатор строки исполнителя. Используется только для представления в
виртуальных секциях  
[StageRowID](P_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_StageRowID.htm)|
ID этапа.  
## __Методы
...
##  __Операторы
[Equality(Performer,
Performer)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_op_Equality.htm)|  
---|---  
[Inequality(Performer,
Performer)](M_Tessa_Extensions_Default_Server_Workflow_KrObjectModel_Performer_op_Inequality.htm)|  
## __Методы расширения
