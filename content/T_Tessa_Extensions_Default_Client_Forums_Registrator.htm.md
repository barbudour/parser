...
##  __Конструкторы
[Registrator](M_Tessa_Extensions_Default_Client_Forums_Registrator__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[FinalizeRegistration](M_Tessa_Extensions_Default_Client_Forums_Registrator_FinalizeRegistration.htm)|  
(Переопределяет
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterExtensions](M_Tessa_Extensions_Default_Client_Forums_Registrator_RegisterExtensions.htm)|  
(Переопределяет
[RegistratorBase.RegisterExtensions(IExtensionContainer)](M_Tessa_Extensions_RegistratorBase_RegisterExtensions.htm))  
[RegisterUnity](M_Tessa_Extensions_Default_Client_Forums_Registrator_RegisterUnity.htm)|  
(Переопределяет
