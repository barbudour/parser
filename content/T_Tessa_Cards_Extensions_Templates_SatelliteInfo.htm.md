...
VB __Копировать
     Public Class SatelliteInfo
C++ __Копировать
     public ref class SatelliteInfo
F# __Копировать
     type SatelliteInfo = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ SatelliteInfo
##  __Конструкторы
[SatelliteInfo](M_Tessa_Cards_Extensions_Templates_SatelliteInfo__ctor.htm)|
Инициализирует новый экземпляр класса SatelliteInfo  
---|---  
##  __Свойства
