# KrRoutesInWorkflowEngineUIExtension - класс
...
C# __Копировать
     public sealed class KrRoutesInWorkflowEngineUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class KrRoutesInWorkflowEngineUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class KrRoutesInWorkflowEngineUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type KrRoutesInWorkflowEngineUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ KrRoutesInWorkflowEngineUIExtension
##  __Конструкторы
[KrRoutesInWorkflowEngineUIExtension](M_Tessa_Extensions_Default_Client_UI_WorkflowEngine_KrRoutesInWorkflowEngineUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrRoutesInWorkflowEngineUIExtension.  
---|---  
## __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_WorkflowEngine_KrRoutesInWorkflowEngineUIExtension_Initialized.htm)|
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Client.UI.WorkflowEngine - пространство
имён](N_Tessa_Extensions_Default_Client_UI_WorkflowEngine.htm)
