# DeletedOriginalUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class DeletedOriginalUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class DeletedOriginalUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class DeletedOriginalUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type DeletedOriginalUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ DeletedOriginalUIExtension
##  __Конструкторы
[DeletedOriginalUIExtension](M_Tessa_Extensions_Platform_Client_UI_DeletedOriginalUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса DeletedOriginalUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_DeletedOriginalUIExtension_Initialized.htm)|  
(Переопределяет
