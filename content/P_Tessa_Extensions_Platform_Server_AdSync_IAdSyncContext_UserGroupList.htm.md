# IAdSyncContext.UserGroupList - свойство
...
C# __Копировать
    HashSet<Guid> UserGroupList { get; }
VB __Копировать
     ReadOnly Property UserGroupList As HashSet(Of Guid)
    	Get
C++ __Копировать
    property HashSet<Guid>^ UserGroupList {
    	HashSet<Guid>^ get ();
    }
F# __Копировать
     abstract UserGroupList : HashSet<Guid> with get
#### Значение свойства
