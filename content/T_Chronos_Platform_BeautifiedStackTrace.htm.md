# BeautifiedStackTrace - структура
...
C# __Копировать
     public readonly struct BeautifiedStackTrace
VB __Копировать
     Public Structure BeautifiedStackTrace
C++ __Копировать
     public value class BeautifiedStackTrace
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) __ BeautifiedStackTrace
##  __Конструкторы
[BeautifiedStackTrace(Boolean)](M_Chronos_Platform_BeautifiedStackTrace__ctor.htm)|
Инициализирует новый экземпляр класса BeautifiedStackTrace  
---|---  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[ToString](M_Chronos_Platform_BeautifiedStackTrace_ToString.htm)|  
(Переопределяет
