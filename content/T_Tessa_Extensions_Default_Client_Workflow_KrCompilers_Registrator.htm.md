...
##  __Конструкторы
[Registrator](M_Tessa_Extensions_Default_Client_Workflow_KrCompilers_Registrator__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[RegisterExtensions](M_Tessa_Extensions_Default_Client_Workflow_KrCompilers_Registrator_RegisterExtensions.htm)|  
(Переопределяет
