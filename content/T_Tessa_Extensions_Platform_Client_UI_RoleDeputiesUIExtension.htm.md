# RoleDeputiesUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class RoleDeputiesUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class RoleDeputiesUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class RoleDeputiesUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type RoleDeputiesUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ RoleDeputiesUIExtension
##  __Конструкторы
[RoleDeputiesUIExtension](M_Tessa_Extensions_Platform_Client_UI_RoleDeputiesUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса RoleDeputiesUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_RoleDeputiesUIExtension_Initialized.htm)|  
(Переопределяет
