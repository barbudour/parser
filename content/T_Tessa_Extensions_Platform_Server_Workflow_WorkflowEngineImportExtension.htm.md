# WorkflowEngineImportExtension - класс
...
C# __Копировать
     public sealed class WorkflowEngineImportExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class WorkflowEngineImportExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class WorkflowEngineImportExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type WorkflowEngineImportExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ WorkflowEngineImportExtension
##  __Конструкторы
[WorkflowEngineImportExtension](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowEngineImportExtension__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowEngineImportExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowEngineImportExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
