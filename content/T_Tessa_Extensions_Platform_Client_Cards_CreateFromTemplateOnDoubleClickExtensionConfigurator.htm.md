# CreateFromTemplateOnDoubleClickExtensionConfigurator - класс
...
C# __Копировать
     public sealed class CreateFromTemplateOnDoubleClickExtensionConfigurator : ExtensionSettingsConfiguratorBase
VB __Копировать
     Public NotInheritable Class CreateFromTemplateOnDoubleClickExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class CreateFromTemplateOnDoubleClickExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type CreateFromTemplateOnDoubleClickExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ CreateFromTemplateOnDoubleClickExtensionConfigurator
##  __Конструкторы
[CreateFromTemplateOnDoubleClickExtensionConfigurator](M_Tessa_Extensions_Platform_Client_Cards_CreateFromTemplateOnDoubleClickExtensionConfigurator__ctor.htm)|
