# TimeZoneConversionException - класс
...
C++ __Копировать
     public ref class TimeZoneConversionException : public ServiceLocalException
F# __Копировать
     type TimeZoneConversionException = 
        class
            inherit ServiceLocalException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ServiceLocalException](T_Tessa_Exchange_WebServices_Data_ServiceLocalException.htm) __ TimeZoneConversionException
##  __Конструкторы
[TimeZoneConversionException()](M_Tessa_Exchange_WebServices_Data_TimeZoneConversionException__ctor.htm)|
ServiceLocalException Constructor.  
---|---  
[TimeZoneConversionException(String)](M_Tessa_Exchange_WebServices_Data_TimeZoneConversionException__ctor_2.htm)|
ServiceLocalException Constructor.  
[TimeZoneConversionException(SerializationInfo,
StreamingContext)](M_Tessa_Exchange_WebServices_Data_TimeZoneConversionException__ctor_1.htm)|
Initializes a new instance of the TimeZoneConversionException class with
serialized data.  
[TimeZoneConversionException(String,
Exception)](M_Tessa_Exchange_WebServices_Data_TimeZoneConversionException__ctor_3.htm)|
ServiceLocalException Constructor.  
## __Свойства
