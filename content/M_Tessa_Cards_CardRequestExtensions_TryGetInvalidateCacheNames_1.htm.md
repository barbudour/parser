#
CardRequestExtensions.TryGetInvalidateCacheNames(ICardRequestExtensionContext)
- метод
...
C# __Копировать
     public static HashSet<string> TryGetInvalidateCacheNames(
...
C++ __Копировать
     public:
    [ExtensionAttribute]
    static HashSet<String^>^ TryGetInvalidateCacheNames(
