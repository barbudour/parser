# FixMetaRoleStoreExtension - класс
...
C# __Копировать
     public sealed class FixMetaRoleStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class FixMetaRoleStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class FixMetaRoleStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type FixMetaRoleStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ FixMetaRoleStoreExtension
##  __Конструкторы
[FixMetaRoleStoreExtension](M_Tessa_Extensions_Platform_Server_Roles_FixMetaRoleStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса FixMetaRoleStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Roles_FixMetaRoleStoreExtension_BeforeRequest.htm)|  
(Переопределяет
