# FillAuthorTaskRowIDListGetExtension - класс
...
C# __Копировать
     public sealed class FillAuthorTaskRowIDListGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class FillAuthorTaskRowIDListGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class FillAuthorTaskRowIDListGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type FillAuthorTaskRowIDListGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ FillAuthorTaskRowIDListGetExtension
##  __Конструкторы
[FillAuthorTaskRowIDListGetExtension](M_Tessa_Extensions_Platform_Client_Cards_FillAuthorTaskRowIDListGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса FillAuthorTaskRowIDListGetExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Client_Cards_FillAuthorTaskRowIDListGetExtension_BeforeRequest.htm)|  
(Переопределяет
