# FunctionRoleGetExtension - класс
...
C# __Копировать
     public sealed class FunctionRoleGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class FunctionRoleGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class FunctionRoleGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type FunctionRoleGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ FunctionRoleGetExtension
##  __Конструкторы
[FunctionRoleGetExtension](M_Tessa_Extensions_Platform_Server_Cards_FunctionRoleGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса FunctionRoleGetExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_FunctionRoleGetExtension_BeforeRequest.htm)|  
(Переопределяет
