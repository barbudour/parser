# FixRoleUsersWithDeputiesStoreExtension - класс
...
C# __Копировать
     public sealed class FixRoleUsersWithDeputiesStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class FixRoleUsersWithDeputiesStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class FixRoleUsersWithDeputiesStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type FixRoleUsersWithDeputiesStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ FixRoleUsersWithDeputiesStoreExtension
##  __Конструкторы
[FixRoleUsersWithDeputiesStoreExtension](M_Tessa_Extensions_Platform_Server_Roles_FixRoleUsersWithDeputiesStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса FixRoleUsersWithDeputiesStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Roles_FixRoleUsersWithDeputiesStoreExtension_AfterBeginTransaction.htm)|  
(Переопределяет
