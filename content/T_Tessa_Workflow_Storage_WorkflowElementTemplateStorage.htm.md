# WorkflowElementTemplateStorage - класс
##  __Definition
 **Пространство имён:** [Tessa.Workflow.Storage](N_Tessa_Workflow_Storage.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class WorkflowElementTemplateStorage : WorkflowTemplateStorageBase
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WorkflowElementTemplateStorage
    	Inherits WorkflowTemplateStorageBase
C++ __Копировать
    [SerializableAttribute]
    public ref class WorkflowElementTemplateStorage sealed : public WorkflowTemplateStorageBase
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type WorkflowElementTemplateStorage = 
        class
            inherit WorkflowTemplateStorageBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm) __[WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm) __ WorkflowElementTemplateStorage
##  __Конструкторы
[WorkflowElementTemplateStorage()](M_Tessa_Workflow_Storage_WorkflowElementTemplateStorage__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowElementTemplateStorage  
---|---  
[WorkflowElementTemplateStorage(Dictionary<String,
Object>)](M_Tessa_Workflow_Storage_WorkflowElementTemplateStorage__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowElementTemplateStorage  
[WorkflowElementTemplateStorage(IStorageObjectProvider)](M_Tessa_Workflow_Storage_WorkflowElementTemplateStorage__ctor_2.htm)|
Инициализирует новый экземпляр класса WorkflowElementTemplateStorage  
[WorkflowElementTemplateStorage(WorkflowNodeStorage)](M_Tessa_Workflow_Storage_WorkflowElementTemplateStorage__ctor_4.htm)|
Создает шаблон по переданному узлу  
[WorkflowElementTemplateStorage(WorkflowActionDescriptor,
CardType)](M_Tessa_Workflow_Storage_WorkflowElementTemplateStorage__ctor_3.htm)|
Создает шаблон по типу действия  
## __Свойства
...
---|---  
[CreationAction](P_Tessa_Workflow_Storage_WorkflowElementTemplateStorage_CreationAction.htm)|
Действие, которое создается при создании по данному шаблону  
[CreationNode](P_Tessa_Workflow_Storage_WorkflowElementTemplateStorage_CreationNode.htm)|
Узел, который создается при создании по данному шаблону  
...
[GroupName](P_Tessa_Workflow_Storage_WorkflowElementTemplateStorage_GroupName.htm)|
Имя группы  
[Hash](P_Tessa_Workflow_Storage_WorkflowStorageBase_Hash.htm)|  Параметры
объекта  
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[IconResource](P_Tessa_Workflow_Storage_WorkflowElementTemplateStorage_IconResource.htm)|
Имя ресурса для иконки  
[ID](P_Tessa_Workflow_Storage_WorkflowStorageBase_ID.htm)|  ID объекта  
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[IsNodeTemplate](P_Tessa_Workflow_Storage_WorkflowElementTemplateStorage_IsNodeTemplate.htm)|
Признак определяет, хранится ли объект узла или объект действия  
[Name](P_Tessa_Workflow_Storage_WorkflowTemplateStorageBase_Name.htm)|  Имя
объекта.  
(Унаследован от
[WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm))  
[Order](P_Tessa_Workflow_Storage_WorkflowElementTemplateStorage_Order.htm)|  
...
(Унаследован от
[WorkflowStorageBase](T_Tessa_Workflow_Storage_WorkflowStorageBase.htm))  
[Clone](M_Tessa_Workflow_Storage_WorkflowElementTemplateStorage_Clone.htm)|  
(Переопределяет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[UpdateData](M_Tessa_Workflow_Storage_WorkflowTemplateStorageBase_UpdateData.htm)|  
(Унаследован от
[WorkflowTemplateStorageBase](T_Tessa_Workflow_Storage_WorkflowTemplateStorageBase.htm))  
##  __События
