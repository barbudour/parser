...
VB __Копировать
     Public Class DataResource
    	Inherits Freezable
C++ __Копировать
     public ref class DataResource : public Freezable
F# __Копировать
     type DataResource = 
        class
            inherit Freezable
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __ DataResource
##  __Конструкторы
[DataResource](M_Tessa_UI_Data_DataResource__ctor.htm)|  Initializes a new
instance of the DataResource class.  
---|---  
## __Свойства
[BindingTarget](P_Tessa_UI_Data_DataResource_BindingTarget.htm)|  Gets or sets
the binding target.  
---|---  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CloneCore](M_Tessa_UI_Data_DataResource_CloneCore.htm)|  Makes the instance a
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Data_DataResource_CreateInstanceCore.htm)|
...
---|---  
##  __Поля
[BindingTargetProperty](F_Tessa_UI_Data_DataResource_BindingTargetProperty.htm)|
Identifies the [BindingTarget](P_Tessa_UI_Data_DataResource_BindingTarget.htm)
dependency property.  
---|---  
## __См. также
#### Ссылки
