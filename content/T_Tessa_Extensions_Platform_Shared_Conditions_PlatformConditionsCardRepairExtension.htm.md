# PlatformConditionsCardRepairExtension - класс
...
C# __Копировать
     public sealed class PlatformConditionsCardRepairExtension : ConditionsCardRepairExtensionBase
VB __Копировать
     Public NotInheritable Class PlatformConditionsCardRepairExtension
    	Inherits ConditionsCardRepairExtensionBase
C++ __Копировать
     public ref class PlatformConditionsCardRepairExtension sealed : public ConditionsCardRepairExtensionBase
F# __Копировать
     [<SealedAttribute>]
    type PlatformConditionsCardRepairExtension = 
        class
            inherit ConditionsCardRepairExtensionBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm) __[ConditionsCardRepairExtensionBase](T_Tessa_Extensions_Platform_Shared_Conditions_ConditionsCardRepairExtensionBase.htm) __ PlatformConditionsCardRepairExtension
##  __Конструкторы
[PlatformConditionsCardRepairExtension](M_Tessa_Extensions_Platform_Shared_Conditions_PlatformConditionsCardRepairExtension__ctor.htm)|
