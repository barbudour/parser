# CardInfoStorageObject - класс
Базовый класс для объектов карточек, являющихся декораторами для хранилища, с
...
C# __Копировать
    ...
    public abstract class CardInfoStorageObject : CardStorageObject
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class CardInfoStorageObject
    	Inherits CardStorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class CardInfoStorageObject abstract : public CardStorageObject
F# __Копировать
     [<AbstractClassAttribute>]
    [<SerializableAttribute>]
    type CardInfoStorageObject = 
        class
            inherit CardStorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __ CardInfoStorageObject
Derived
[Tessa.Cards.Card](T_Tessa_Cards_Card.htm)
[Tessa.Cards.CardFile](T_Tessa_Cards_CardFile.htm)
[Tessa.Cards.CardNewRequest](T_Tessa_Cards_CardNewRequest.htm)
[Tessa.Cards.CardRequest](T_Tessa_Cards_CardRequest.htm)
[Tessa.Cards.CardRequestBase](T_Tessa_Cards_CardRequestBase.htm)
[Tessa.Cards.CardResponseBase](T_Tessa_Cards_CardResponseBase.htm)
[Tessa.Cards.CardStoreRequest](T_Tessa_Cards_CardStoreRequest.htm)
[Tessa.Cards.CardTask](T_Tessa_Cards_CardTask.htm)
[Tessa.Cards.CardTaskHistoryGroup](T_Tessa_Cards_CardTaskHistoryGroup.htm)
[Tessa.Cards.CardTaskHistoryItem](T_Tessa_Cards_CardTaskHistoryItem.htm)
[Tessa.Cards.Numbers.NumberControlResponse](T_Tessa_Cards_Numbers_NumberControlResponse.htm)
[Tessa.Cards.Numbers.NumberQueue](T_Tessa_Cards_Numbers_NumberQueue.htm)
[Tessa.Cards.Numbers.NumberQueueItem](T_Tessa_Cards_Numbers_NumberQueueItem.htm)
[Tessa.Cards.Numbers.NumberStorageLocation](T_Tessa_Cards_Numbers_NumberStorageLocation.htm)
[Tessa.Cards.Numbers.NumberStorageObject](T_Tessa_Cards_Numbers_NumberStorageObject.htm)
[Tessa.Cards.Numbers.NumberStorageTypeDescriptor](T_Tessa_Cards_Numbers_NumberStorageTypeDescriptor.htm)
[Tessa.Cards.Workflow.WorkflowQueue](T_Tessa_Cards_Workflow_WorkflowQueue.htm)
[Tessa.Cards.Workflow.WorkflowQueueItem](T_Tessa_Cards_Workflow_WorkflowQueueItem.htm)
[Tessa.Cards.Workflow.WorkflowQueueSignal](T_Tessa_Cards_Workflow_WorkflowQueueSignal.htm)
[Tessa.Extensions.Default.Shared.Workflow.Wf.WfData](T_Tessa_Extensions_Default_Shared_Workflow_Wf_WfData.htm)
[Tessa.Extensions.Default.Shared.Workflow.Wf.WfProcessData](T_Tessa_Extensions_Default_Shared_Workflow_Wf_WfProcessData.htm)
[Tessa.Web.Client.Models.CardCopyRequest](T_Tessa_Web_Client_Models_CardCopyRequest.htm)
[Tessa.Web.Client.Models.CardCreateFromTemplateRequest](T_Tessa_Web_Client_Models_CardCreateFromTemplateRequest.htm)
[Tessa.Web.Client.Models.CardCreateFromTemplateResponse](T_Tessa_Web_Client_Models_CardCreateFromTemplateResponse.htm)
[Tessa.Web.Client.Models.CardRepairRequest](T_Tessa_Web_Client_Models_CardRepairRequest.htm)
Подробнее __Less __
##  __Заметки
Строго типизированный декоратор для хранилища Dictionary<string, object>,
поддерживающий валидацию свойств, раздел для дополнительной пользовательской
информации, очистку хранилища от избыточных и пользовательских данных, а также
динамический доступ к хранилищу.
## __Конструкторы
...
##  __Поля
[InfoKey](F_Tessa_Cards_CardInfoStorageObject_InfoKey.htm)|  
---|---  
## __Методы расширения
