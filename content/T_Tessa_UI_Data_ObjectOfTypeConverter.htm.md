# ObjectOfTypeConverter - класс
##  __Definition
 **Пространство имён:** [Tessa.UI.Data](N_Tessa_UI_Data.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
    [ValueConversionAttribute(typeof(Object), typeof(bool))]
    public sealed class ObjectOfTypeConverter : ValueConverter<Object, bool>
VB __Копировать
    <ValueConversionAttribute(GetType(Object), GetType(Boolean))>
    Public NotInheritable Class ObjectOfTypeConverter
    	Inherits ValueConverter(Of Object, Boolean)
C++ __Копировать
    [ValueConversionAttribute(typeof(Object), typeof(bool))]
    public ref class ObjectOfTypeConverter sealed : public ValueConverter<Object^, bool>
F# __Копировать
     [<SealedAttribute>]
    [<ValueConversionAttribute(typeof(Object), typeof(bool))>]
    type ObjectOfTypeConverter = 
        class
            inherit ValueConverter<Object, bool>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueConverter](T_Tessa_UI_Data_ValueConverter_2.htm)<[Object](https://learn.microsoft.com/dotnet/api/system.object), [Boolean](https://learn.microsoft.com/dotnet/api/system.boolean)> __ ObjectOfTypeConverter
##  __Конструкторы
[ObjectOfTypeConverter](M_Tessa_UI_Data_ObjectOfTypeConverter__ctor.htm)|
Инициализирует новый экземпляр класса ObjectOfTypeConverter  
---|---  
##  __Методы
...
---|---  
[BoxTargetValue](M_Tessa_UI_Data_ObjectOfTypeConverter_BoxTargetValue.htm)|  
...
CultureInfo)](M_Tessa_UI_Data_ObjectOfTypeConverter_Convert.htm)|  
