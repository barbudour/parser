# AspMvcModelTypeAttribute - класс
...
F# __Копировать
     [<SealedAttribute>]
    [<AttributeUsageAttribute(AttributeTargets.Parameter)>]
    type AspMvcModelTypeAttribute = 
        class
            inherit Attribute
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Attribute](https://learn.microsoft.com/dotnet/api/system.attribute) __ AspMvcModelTypeAttribute
##  __Конструкторы
[AspMvcModelTypeAttribute](M_Tessa_Properties_Resharper_AspMvcModelTypeAttribute__ctor.htm)|
Инициализирует новый экземпляр класса AspMvcModelTypeAttribute  
---|---  
##  __Свойства
