# KrConstants.KrDialogStageTypeSettingsVirtual.DisplayValue - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly DisplayValue As String
C++ __Копировать
     public:
    static initonly String^ DisplayValue
F# __Копировать
     static val DisplayValue: string
#### Значение поля
