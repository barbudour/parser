# KrApprovalActionUIHandler - класс
...
VB __Копировать
     Public NotInheritable Class KrApprovalActionUIHandler
    	Inherits WorkflowActionUIHandlerBase
C++ __Копировать
     public ref class KrApprovalActionUIHandler sealed : public WorkflowActionUIHandlerBase
F# __Копировать
     [<SealedAttribute>]
    type KrApprovalActionUIHandler = 
        class
            inherit WorkflowActionUIHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WorkflowActionUIHandlerBase](T_Tessa_UI_WorkflowViewer_Actions_WorkflowActionUIHandlerBase.htm) __ KrApprovalActionUIHandler
##  __Конструкторы
[KrApprovalActionUIHandler](M_Tessa_Extensions_Default_Client_Workflow_WorkflowEngine_KrApprovalActionUIHandler__ctor.htm)|
Инициализирует новый экземпляр класса KrApprovalActionUIHandler.  
---|---  
## __Свойства
...
(Унаследован от
[WorkflowActionUIHandlerBase](T_Tessa_UI_WorkflowViewer_Actions_WorkflowActionUIHandlerBase.htm))  
[AttachToCardCoreAsync](M_Tessa_Extensions_Default_Client_Workflow_WorkflowEngine_KrApprovalActionUIHandler_AttachToCardCoreAsync.htm)|
...
(Унаследован от
[WorkflowActionUIHandlerBase](T_Tessa_UI_WorkflowViewer_Actions_WorkflowActionUIHandlerBase.htm))  
[InvalidateFormCore](M_Tessa_Extensions_Default_Client_Workflow_WorkflowEngine_KrApprovalActionUIHandler_InvalidateFormCore.htm)|
...
(Унаследован от
[WorkflowActionUIHandlerBase](T_Tessa_UI_WorkflowViewer_Actions_WorkflowActionUIHandlerBase.htm))  
[UpdateFormCoreAsync](M_Tessa_Extensions_Default_Client_Workflow_WorkflowEngine_KrApprovalActionUIHandler_UpdateFormCoreAsync.htm)|
