# KrVirtualFileConvertGetContentExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrVirtualFileConvertGetContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class KrVirtualFileConvertGetContentExtension sealed : public CardGetFileContentExtension
F# __Копировать
     [<SealedAttribute>]
    type KrVirtualFileConvertGetContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ KrVirtualFileConvertGetContentExtension
##  __Конструкторы
[KrVirtualFileConvertGetContentExtension](M_Tessa_Extensions_Default_Server_Files_KrVirtualFileConvertGetContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrVirtualFileConvertGetContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Files_KrVirtualFileConvertGetContentExtension_BeforeRequest.htm)|  
(Переопределяет
