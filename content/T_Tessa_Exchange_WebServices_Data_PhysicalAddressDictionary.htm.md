# PhysicalAddressDictionary - класс
...
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class PhysicalAddressDictionary sealed : public DictionaryProperty<PhysicalAddressKey, PhysicalAddressEntry^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type PhysicalAddressDictionary = 
        class
            inherit DictionaryProperty<PhysicalAddressKey, PhysicalAddressEntry>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[DictionaryProperty](T_Tessa_Exchange_WebServices_Data_DictionaryProperty_2.htm)<[PhysicalAddressKey](T_Tessa_Exchange_WebServices_Data_PhysicalAddressKey.htm), [PhysicalAddressEntry](T_Tessa_Exchange_WebServices_Data_PhysicalAddressEntry.htm)> __ PhysicalAddressDictionary
##  __Конструкторы
[PhysicalAddressDictionary](M_Tessa_Exchange_WebServices_Data_PhysicalAddressDictionary__ctor.htm)|
Инициализирует новый экземпляр класса PhysicalAddressDictionary  
---|---  
##  __Свойства
[Item](P_Tessa_Exchange_WebServices_Data_PhysicalAddressDictionary_Item.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetValue](M_Tessa_Exchange_WebServices_Data_PhysicalAddressDictionary_TryGetValue.htm)|
