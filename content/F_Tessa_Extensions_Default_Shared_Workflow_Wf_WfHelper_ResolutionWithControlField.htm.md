# WfHelper.ResolutionWithControlField - поле
...
VB __Копировать
     Public Const ResolutionWithControlField As String = "WithControl"
C++ __Копировать
     public:
    literal String^ ResolutionWithControlField = "WithControl"
F# __Копировать
     static val mutable ResolutionWithControlField: string
#### Значение поля
