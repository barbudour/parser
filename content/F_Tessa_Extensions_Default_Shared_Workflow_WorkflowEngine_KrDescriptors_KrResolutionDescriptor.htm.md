# KrDescriptors.KrResolutionDescriptor - поле
Выполнение задачи.
## __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly KrResolutionDescriptor As WorkflowActionDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionDescriptor^ KrResolutionDescriptor
F# __Копировать
     static val KrResolutionDescriptor: WorkflowActionDescriptor
#### Значение поля
