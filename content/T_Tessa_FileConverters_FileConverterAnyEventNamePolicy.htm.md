# FileConverterAnyEventNamePolicy - класс
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FileConverterAnyEventNamePolicy
Implements
    [IExtensionPolicy](T_Tessa_Extensions_IExtensionPolicy.htm), [IFileConverterEventNamePolicy](T_Tessa_FileConverters_IFileConverterEventNamePolicy.htm)
##  __Заметки
Для использования этой политики требуется зарегистрировать политику
[IFilterPolicy](T_Tessa_Extensions_IFilterPolicy.htm).
## __Конструкторы
[FileConverterAnyEventNamePolicy](M_Tessa_FileConverters_FileConverterAnyEventNamePolicy__ctor.htm)|
Инициализирует новый экземпляр класса FileConverterAnyEventNamePolicy  
---|---  
##  __Свойства
[Instance](P_Tessa_FileConverters_FileConverterAnyEventNamePolicy_Instance.htm)|
Экземпляр класса.  
---|---  
[IsAllowAny](P_Tessa_FileConverters_FileConverterAnyEventNamePolicy_IsAllowAny.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsAllowed](M_Tessa_FileConverters_FileConverterAnyEventNamePolicy_IsAllowed.htm)|
