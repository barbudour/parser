# AllowToModifyTimeZonesGetExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.TimeZones](N_Tessa_Extensions_Platform_Server_TimeZones.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class AllowToModifyTimeZonesGetExtension : CardGetExtension
VB __Копировать
     Public Class AllowToModifyTimeZonesGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class AllowToModifyTimeZonesGetExtension : public CardGetExtension
F# __Копировать
     type AllowToModifyTimeZonesGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ AllowToModifyTimeZonesGetExtension
##  __Конструкторы
[AllowToModifyTimeZonesGetExtension](M_Tessa_Extensions_Platform_Server_TimeZones_AllowToModifyTimeZonesGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса AllowToModifyTimeZonesGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_TimeZones_AllowToModifyTimeZonesGetExtension_AfterRequest.htm)|  
(Переопределяет
