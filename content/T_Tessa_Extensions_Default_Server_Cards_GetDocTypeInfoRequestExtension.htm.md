# GetDocTypeInfoRequestExtension - класс
...
C# __Копировать
     public sealed class GetDocTypeInfoRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class GetDocTypeInfoRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class GetDocTypeInfoRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type GetDocTypeInfoRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ GetDocTypeInfoRequestExtension
##  __Конструкторы
[GetDocTypeInfoRequestExtension](M_Tessa_Extensions_Default_Server_Cards_GetDocTypeInfoRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса GetDocTypeInfoRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Cards_GetDocTypeInfoRequestExtension_AfterRequest.htm)|  
(Переопределяет
