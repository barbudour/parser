# KrProcessSharedExtensions.GetApprovalInfoSection - метод
...
C# __Копировать
     public static CardSection GetApprovalInfoSection(
    	this Card card
    )
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function GetApprovalInfoSection ( 
    	card As Card
    ) As CardSection
C++ __Копировать
     public:
    [ExtensionAttribute]
    static CardSection^ GetApprovalInfoSection(
    	Card^ card
    )
F# __Копировать
     [<ExtensionAttribute>]
    static member GetApprovalInfoSection : 
