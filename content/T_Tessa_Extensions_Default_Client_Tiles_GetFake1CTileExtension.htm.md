...
C# __Копировать
     public sealed class GetFake1CTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class GetFake1CTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class GetFake1CTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type GetFake1CTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ GetFake1CTileExtension
##  __Конструкторы
[GetFake1CTileExtension](M_Tessa_Extensions_Default_Client_Tiles_GetFake1CTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса GetFake1CTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_GetFake1CTileExtension_InitializingGlobal.htm)|  
(Переопределяет
