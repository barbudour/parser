...
C# __Копировать
    ...
    public sealed class WfData : CardInfoStorageObject, 
    	ICloneable
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class WfData
    	Inherits CardInfoStorageObject
    	Implements ICloneable
C++ __Копировать
    [SerializableAttribute]
    public ref class WfData sealed : public CardInfoStorageObject, 
    	ICloneable
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Инициализирует новый экземпляр класса WfData  
---|---  
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[Processes](P_Tessa_Extensions_Default_Shared_Workflow_Wf_WfData_Processes.htm)|
Список объектов, содержащих информацию по отдельным бизнес-процессам.  
## __Методы
[Clean](M_Tessa_Extensions_Default_Shared_Workflow_Wf_WfData_Clean.htm)|  
(Переопределяет
...
[Clear](M_Tessa_Extensions_Default_Shared_Workflow_Wf_WfData_Clear.htm)|
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[Clone](M_Tessa_Extensions_Default_Shared_Workflow_Wf_WfData_Clone.htm)|  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[EnsureCacheResolved](M_Tessa_Extensions_Default_Shared_Workflow_Wf_WfData_EnsureCacheResolved.htm)|  
(Переопределяет
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[TryGetProcesses](M_Tessa_Extensions_Default_Shared_Workflow_Wf_WfData_TryGetProcesses.htm)|
Возвращает список объектов, содержащих информацию по отдельным бизнес-
процессам, или null, если список ещё не был задан.  
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Extensions_Default_Shared_Workflow_Wf_WfData_ValidateInternal.htm)|  
(Переопределяет
