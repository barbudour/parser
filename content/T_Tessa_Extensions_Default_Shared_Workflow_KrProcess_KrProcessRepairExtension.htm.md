# KrProcessRepairExtension - класс
...
C# __Копировать
     public sealed class KrProcessRepairExtension : CardRepairExtension
VB __Копировать
     Public NotInheritable Class KrProcessRepairExtension
    	Inherits CardRepairExtension
C++ __Копировать
     public ref class KrProcessRepairExtension sealed : public CardRepairExtension
F# __Копировать
     [<SealedAttribute>]
    type KrProcessRepairExtension = 
        class
            inherit CardRepairExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRepairExtension](T_Tessa_Cards_Extensions_CardRepairExtension.htm) __ KrProcessRepairExtension
##  __Конструкторы
[KrProcessRepairExtension](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrProcessRepairExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrProcessRepairExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrProcessRepairExtension_AfterRequest.htm)|  
(Переопределяет
