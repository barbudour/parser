...
VB __Копировать
     Public NotInheritable Class KrSatelliteHandler
    	Inherits SatelliteHandlerBase
C++ __Копировать
     public ref class KrSatelliteHandler sealed : public SatelliteHandlerBase
F# __Копировать
     [<SealedAttribute>]
    type KrSatelliteHandler = 
        class
            inherit SatelliteHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[SatelliteHandlerBase](T_Tessa_Extensions_Platform_Server_Cards_Satellites_Handlers_SatelliteHandlerBase.htm) __ KrSatelliteHandler
##  __Конструкторы
[KrSatelliteHandler](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Satellite_KrSatelliteHandler__ctor.htm)|
Инициализирует новый экземпляр класса KrSatelliteHandler  
---|---  
##  __Методы
...
(Унаследован от
[SatelliteHandlerBase](T_Tessa_Extensions_Platform_Server_Cards_Satellites_Handlers_SatelliteHandlerBase.htm))  
[IsMainCardTypeAsync](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Satellite_KrSatelliteHandler_IsMainCardTypeAsync.htm)|  
...
(Унаследован от
[SatelliteHandlerBase](T_Tessa_Extensions_Platform_Server_Cards_Satellites_Handlers_SatelliteHandlerBase.htm))  
[PrepareSatelliteForCreateAsync](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Satellite_KrSatelliteHandler_PrepareSatelliteForCreateAsync.htm)|  
(Переопределяет
