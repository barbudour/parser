# FixPersonalRolesStoreExtension - класс
...
C# __Копировать
     public sealed class FixPersonalRolesStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class FixPersonalRolesStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class FixPersonalRolesStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type FixPersonalRolesStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ FixPersonalRolesStoreExtension
##  __Конструкторы
[FixPersonalRolesStoreExtension](M_Tessa_Extensions_Platform_Server_Roles_FixPersonalRolesStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса FixPersonalRolesStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Roles_FixPersonalRolesStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Roles_FixPersonalRolesStoreExtension_BeforeRequest.htm)|  
(Переопределяет
