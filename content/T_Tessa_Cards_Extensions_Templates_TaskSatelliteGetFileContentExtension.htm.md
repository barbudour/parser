# TaskSatelliteGetFileContentExtension - класс
...
C# __Копировать
     public abstract class TaskSatelliteGetFileContentExtension : CardGetFileContentExtension
VB __Копировать
     Public MustInherit Class TaskSatelliteGetFileContentExtension
    	Inherits CardGetFileContentExtension
C++ __Копировать
     public ref class TaskSatelliteGetFileContentExtension abstract : public CardGetFileContentExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type TaskSatelliteGetFileContentExtension = 
        class
            inherit CardGetFileContentExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm) __ TaskSatelliteGetFileContentExtension
##  __Конструкторы
[TaskSatelliteGetFileContentExtension](M_Tessa_Cards_Extensions_Templates_TaskSatelliteGetFileContentExtension__ctor.htm)|
Инициализирует новый экземпляр класса TaskSatelliteGetFileContentExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetFileContentExtension](T_Tessa_Cards_Extensions_CardGetFileContentExtension.htm))  
[BeforeRequest](M_Tessa_Cards_Extensions_Templates_TaskSatelliteGetFileContentExtension_BeforeRequest.htm)|
...
[CheckAccessAsync](M_Tessa_Cards_Extensions_Templates_TaskSatelliteGetFileContentExtension_CheckAccessAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetMainCardIDFromSatelliteIDAsync](M_Tessa_Cards_Extensions_Templates_TaskSatelliteGetFileContentExtension_TryGetMainCardIDFromSatelliteIDAsync.htm)|
