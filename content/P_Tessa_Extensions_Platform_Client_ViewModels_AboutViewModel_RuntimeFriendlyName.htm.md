# AboutViewModel.RuntimeFriendlyName - свойство
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.ViewModels](N_Tessa_Extensions_Platform_Client_ViewModels.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public string RuntimeFriendlyName { get; }
VB __Копировать
     Public ReadOnly Property RuntimeFriendlyName As String
    	Get
C++ __Копировать
     public:
    property String^ RuntimeFriendlyName {
    	String^ get ();
    }
F# __Копировать
     member RuntimeFriendlyName : string with get
#### Значение свойства
