...
C# __Копировать
     public sealed class NumberEventTypeRegistry : Registry<Guid, NumberEventType>, 
    	INumberEventTypeRegistry, IRegistry<Guid, NumberEventType>
VB __Копировать
     Public NotInheritable Class NumberEventTypeRegistry
    	Inherits Registry(Of Guid, NumberEventType)
    	Implements INumberEventTypeRegistry, IRegistry(Of Guid, NumberEventType)
C++ __Копировать
     public ref class NumberEventTypeRegistry sealed : public Registry<Guid, NumberEventType^>, 
    	INumberEventTypeRegistry, IRegistry<Guid, NumberEventType^>
F# __Копировать
     [<SealedAttribute>]
    type NumberEventTypeRegistry = 
        class
            inherit Registry<Guid, NumberEventType>
            interface INumberEventTypeRegistry
            interface IRegistry<Guid, NumberEventType>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Registry](T_Tessa_Platform_Registry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [NumberEventType](T_Tessa_Cards_Numbers_NumberEventType.htm)> __ NumberEventTypeRegistry
Implements
    [INumberEventTypeRegistry](T_Tessa_Cards_Numbers_INumberEventTypeRegistry.htm), [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [NumberEventType](T_Tessa_Cards_Numbers_NumberEventType.htm)>
##  __Свойства
