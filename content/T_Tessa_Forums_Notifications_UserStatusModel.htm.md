...
C# __Копировать
    ...
    public class UserStatusModel : StorageObject
VB __Копировать
    <SerializableAttribute>
...
C++ __Копировать
    [SerializableAttribute]
    public ref class UserStatusModel : public StorageObject
F# __Копировать
     [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ UserStatusModel
##  __Конструкторы
[UserStatusModel()](M_Tessa_Forums_Notifications_UserStatusModel__ctor.htm)|
Инициализирует новый экземпляр класса UserStatusModel  
---|---  
[UserStatusModel(Dictionary<String,
Object>)](M_Tessa_Forums_Notifications_UserStatusModel__ctor_1.htm)|
Инициализирует новый экземпляр класса UserStatusModel  
[UserStatusModel(SerializationInfo,
StreamingContext)](M_Tessa_Forums_Notifications_UserStatusModel__ctor_2.htm)|
Инициализирует новый экземпляр класса UserStatusModel  
##  __Свойства
[LastReadMessageTime](P_Tessa_Forums_Notifications_UserStatusModel_LastReadMessageTime.htm)|  
---|---  
[PreLastVisitedAt](P_Tessa_Forums_Notifications_UserStatusModel_PreLastVisitedAt.htm)|  
[TopicID](P_Tessa_Forums_Notifications_UserStatusModel_TopicID.htm)|  
[UserID](P_Tessa_Forums_Notifications_UserStatusModel_UserID.htm)|  
## __Методы
