# SessionServiceClient - класс
Сервис, обеспечивающий взаимодействие с сессиями, доступный на клиенте.
## __Definition
 **Пространство имён:** [Tessa.Platform.Runtime](N_Tessa_Platform_Runtime.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class SessionServiceClient : ISessionService
VB __Копировать
     Public NotInheritable Class SessionServiceClient
    	Implements ISessionService
C++ __Копировать
     public ref class SessionServiceClient sealed : ISessionService
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ SessionServiceClient
Implements
    [ISessionService](T_Tessa_Platform_Runtime_ISessionService.htm)
##  __Конструкторы
[SessionServiceClient](M_Tessa_Platform_Runtime_SessionServiceClient__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Методы
[CloseSessionAsAdminAsync](M_Tessa_Platform_Runtime_SessionServiceClient_CloseSessionAsAdminAsync.htm)|
...
---|---  
[CloseSessionAsync](M_Tessa_Platform_Runtime_SessionServiceClient_CloseSessionAsync.htm)|
...
[CloseSessionWithTokenAsync](M_Tessa_Platform_Runtime_SessionServiceClient_CloseSessionWithTokenAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IncrementConfigurationVersionAsync](M_Tessa_Platform_Runtime_SessionServiceClient_IncrementConfigurationVersionAsync.htm)|
