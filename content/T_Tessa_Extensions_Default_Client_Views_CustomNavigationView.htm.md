...
C# __Копировать
     public class CustomNavigationView : UserControl, 
    	INotifyPropertyChanged, IContentItem, IComponentConnector
VB __Копировать
     Public Class CustomNavigationView
    	Inherits UserControl
    	Implements INotifyPropertyChanged, IContentItem, IComponentConnector
C++ __Копировать
     public ref class CustomNavigationView : public UserControl, 
    	INotifyPropertyChanged, IContentItem, IComponentConnector
F# __Копировать
     type CustomNavigationView = 
        class
            inherit UserControl
...
##  __Конструкторы
[CustomNavigationView](M_Tessa_Extensions_Default_Client_Views_CustomNavigationView__ctor.htm)|
...
[ApplyFilterCommand](P_Tessa_Extensions_Default_Client_Views_CustomNavigationView_ApplyFilterCommand.htm)|  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[ClearFilterCommand](P_Tessa_Extensions_Default_Client_Views_CustomNavigationView_ClearFilterCommand.htm)|  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[FilterModel](P_Tessa_Extensions_Default_Client_Views_CustomNavigationView_FilterModel.htm)|  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[Order](P_Tessa_Extensions_Default_Client_Views_CustomNavigationView_Order.htm)|
...
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
Устарело.  
[PlaceAreas](P_Tessa_Extensions_Default_Client_Views_CustomNavigationView_PlaceAreas.htm)|
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[GetTemplate](M_Tessa_Extensions_Default_Client_Views_CustomNavigationView_GetTemplate.htm)|
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[InitializeComponent](M_Tessa_Extensions_Default_Client_Views_CustomNavigationView_InitializeComponent.htm)|
InitializeComponent  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[OnPropertyChanged(String)](M_Tessa_Extensions_Default_Client_Views_CustomNavigationView_OnPropertyChanged.htm)|
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[PropertyChanged](E_Tessa_Extensions_Default_Client_Views_CustomNavigationView_PropertyChanged.htm)|
