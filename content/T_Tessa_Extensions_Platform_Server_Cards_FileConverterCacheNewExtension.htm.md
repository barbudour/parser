# FileConverterCacheNewExtension - класс
...
C# __Копировать
     public sealed class FileConverterCacheNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class FileConverterCacheNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class FileConverterCacheNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type FileConverterCacheNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ FileConverterCacheNewExtension
##  __Конструкторы
[FileConverterCacheNewExtension](M_Tessa_Extensions_Platform_Server_Cards_FileConverterCacheNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса FileConverterCacheNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_FileConverterCacheNewExtension_AfterRequest.htm)|  
(Переопределяет
