# EmailAddressEntityCollection - класс
...
VB __Копировать
    <EditorBrowsableAttribute(EditorBrowsableState.Never)>
    Public NotInheritable Class EmailAddressEntityCollection
    	Inherits ComplexPropertyCollection(Of EmailAddressEntity)
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class EmailAddressEntityCollection sealed : public ComplexPropertyCollection<EmailAddressEntity^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type EmailAddressEntityCollection = 
        class
            inherit ComplexPropertyCollection<EmailAddressEntity>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[EmailAddressEntity](T_Tessa_Exchange_WebServices_Data_EmailAddressEntity.htm)> __ EmailAddressEntityCollection
##  __Свойства
