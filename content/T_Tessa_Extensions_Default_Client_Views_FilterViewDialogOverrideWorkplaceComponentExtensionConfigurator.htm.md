# FilterViewDialogOverrideWorkplaceComponentExtensionConfigurator - класс
...
C# __Копировать
     public sealed class FilterViewDialogOverrideWorkplaceComponentExtensionConfigurator : ExtensionSettingsConfiguratorBase
VB __Копировать
     Public NotInheritable Class FilterViewDialogOverrideWorkplaceComponentExtensionConfigurator
    	Inherits ExtensionSettingsConfiguratorBase
C++ __Копировать
     public ref class FilterViewDialogOverrideWorkplaceComponentExtensionConfigurator sealed : public ExtensionSettingsConfiguratorBase
F# __Копировать
     [<SealedAttribute>]
    type FilterViewDialogOverrideWorkplaceComponentExtensionConfigurator = 
        class
            inherit ExtensionSettingsConfiguratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ExtensionSettingsConfiguratorBase](T_Tessa_UI_Views_Extensions_ExtensionSettingsConfiguratorBase.htm) __ FilterViewDialogOverrideWorkplaceComponentExtensionConfigurator
##  __Конструкторы
[FilterViewDialogOverrideWorkplaceComponentExtensionConfigurator](M_Tessa_Extensions_Default_Client_Views_FilterViewDialogOverrideWorkplaceComponentExtensionConfigurator__ctor.htm)|
Инициализирует новый экземпляр класса
FilterViewDialogOverrideWorkplaceComponentExtensionConfigurator  
---|---  
##  __Свойства
