# FixCardTimeZonesStoreExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.TimeZones](N_Tessa_Extensions_Platform_Server_TimeZones.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class FixCardTimeZonesStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class FixCardTimeZonesStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class FixCardTimeZonesStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type FixCardTimeZonesStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ FixCardTimeZonesStoreExtension
##  __Конструкторы
[FixCardTimeZonesStoreExtension](M_Tessa_Extensions_Platform_Server_TimeZones_FixCardTimeZonesStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса FixCardTimeZonesStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_TimeZones_FixCardTimeZonesStoreExtension_BeforeRequest.htm)|  
(Переопределяет
