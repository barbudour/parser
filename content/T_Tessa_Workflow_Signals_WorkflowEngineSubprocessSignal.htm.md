# WorkflowEngineSubprocessSignal - класс
##  __Definition
 **Пространство имён:** [Tessa.Workflow.Signals](N_Tessa_Workflow_Signals.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class WorkflowEngineSubprocessSignal : WorkflowEngineSignal
VB __Копировать
     Public NotInheritable Class WorkflowEngineSubprocessSignal
    	Inherits WorkflowEngineSignal
C++ __Копировать
     public ref class WorkflowEngineSubprocessSignal sealed : public WorkflowEngineSignal
F# __Копировать
     [<SealedAttribute>]
    type WorkflowEngineSubprocessSignal = 
        class
            inherit WorkflowEngineSignal
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[WorkflowEngineSignal](T_Tessa_Workflow_Signals_WorkflowEngineSignal.htm) __ WorkflowEngineSubprocessSignal
##  __Конструкторы
[WorkflowEngineSubprocessSignal()](M_Tessa_Workflow_Signals_WorkflowEngineSubprocessSignal__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowEngineSubprocessSignal  
---|---  
[WorkflowEngineSubprocessSignal(Dictionary<String,
Object>)](M_Tessa_Workflow_Signals_WorkflowEngineSubprocessSignal__ctor_1.htm)|
Инициализирует новый экземпляр класса WorkflowEngineSubprocessSignal  
##  __Свойства
...
(Унаследован от
[WorkflowEngineSignal](T_Tessa_Workflow_Signals_WorkflowEngineSignal.htm))  
[SubprocessControlSignal](P_Tessa_Workflow_Signals_WorkflowEngineSubprocessSignal_SubprocessControlSignal.htm)|
Сигнал управления, отправляемый в подпроцесс  
[SubprocessEndSignals](P_Tessa_Workflow_Signals_WorkflowEngineSubprocessSignal_SubprocessEndSignals.htm)|
Список сигналов завершения подпроцесса, обрабатываемых в родительском процессе  
[SubprocessHash](P_Tessa_Workflow_Signals_WorkflowEngineSubprocessSignal_SubprocessHash.htm)|
Хеш завершаемого подпроцесса  
[SubprocessIDs](P_Tessa_Workflow_Signals_WorkflowEngineSubprocessSignal_SubprocessIDs.htm)|
Список идентификаторов подпроцессов, которые должны обрабатываться, или null,
если требуется обработка всех подпроцессов  
