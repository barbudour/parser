...
C# __Копировать
    ...
    public class CustomRichTextBoxModel : StorageObject
VB __Копировать
    <SerializableAttribute>
    Public Class CustomRichTextBoxModel
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class CustomRichTextBoxModel : public StorageObject
F# __Копировать
     [<SerializableAttribute>]
    type CustomRichTextBoxModel = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ CustomRichTextBoxModel
##  __Конструкторы
[CustomRichTextBoxModel()](M_Tessa_Forums_Models_CustomRichTextBoxModel__ctor.htm)|
Инициализирует новый экземпляр класса CustomRichTextBoxModel  
---|---  
[CustomRichTextBoxModel(Dictionary<String,
Object>)](M_Tessa_Forums_Models_CustomRichTextBoxModel__ctor_1.htm)|
Инициализирует новый экземпляр класса CustomRichTextBoxModel  
[CustomRichTextBoxModel(SerializationInfo,
StreamingContext)](M_Tessa_Forums_Models_CustomRichTextBoxModel__ctor_2.htm)|
Инициализирует новый экземпляр класса CustomRichTextBoxModel  
##  __Свойства
[Attachments](P_Tessa_Forums_Models_CustomRichTextBoxModel_Attachments.htm)|
Все прикрепленные элементы к RichTextBox`y  
---|---  
[Text](P_Tessa_Forums_Models_CustomRichTextBoxModel_Text.htm)|  Сам текст
сообщения в html  
## __Методы
