# MakeReadonlyGetExtension - класс
...
C# __Копировать
     public sealed class MakeReadonlyGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class MakeReadonlyGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class MakeReadonlyGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type MakeReadonlyGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ MakeReadonlyGetExtension
##  __Заметки
Расширение выполняется на этапе
[Finalize](T_Tessa_Extensions_ExtensionStage.htm), чтобы любые другие
расширения уже применили свои изменения к этому моменту, а также чтобы они
заполнили виртуальные секции, если только для чтения устанавливается на них.
## __Конструкторы
[MakeReadonlyGetExtension](M_Tessa_Extensions_Platform_Server_Cards_MakeReadonlyGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса MakeReadonlyGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_MakeReadonlyGetExtension_AfterRequest.htm)|  
(Переопределяет
