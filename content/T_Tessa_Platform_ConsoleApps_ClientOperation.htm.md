...
Операция для клиентского скрипта
...
C# __Копировать
     public sealed class ClientOperation : ConsoleOperation<ClientOperationContext>
VB __Копировать
     Public NotInheritable Class ClientOperation
    	Inherits ConsoleOperation(Of ClientOperationContext)
C++ __Копировать
     public ref class ClientOperation sealed : public ConsoleOperation<ClientOperationContext^>
F# __Копировать
     [<SealedAttribute>]
    type ClientOperation = 
        class
            inherit ConsoleOperation<ClientOperationContext>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ConsoleOperation](T_Tessa_Platform_ConsoleApps_ConsoleOperation_1.htm)<[ClientOperationContext](T_Tessa_Platform_ConsoleApps_ClientOperationContext.htm)> __ ClientOperation
##  __Конструкторы
[ClientOperation](M_Tessa_Platform_ConsoleApps_ClientOperation__ctor.htm)|
...
[ExecuteAsync](M_Tessa_Platform_ConsoleApps_ClientOperation_ExecuteAsync.htm)|
