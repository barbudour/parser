# CardLibrary - класс
Библиотека с карточками.
## __Definition
 **Пространство имён:** [Tessa.Cards](N_Tessa_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public sealed class CardLibrary : CardSerializableObject, 
    	IEquatable<CardLibrary>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardLibrary
    	Inherits CardSerializableObject
    	Implements IEquatable(Of CardLibrary)
C++ __Копировать
    [SerializableAttribute]
    public ref class CardLibrary sealed : public CardSerializableObject, 
    	IEquatable<CardLibrary^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardLibrary = 
        class
            ...
            interface IEquatable<CardLibrary>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __ CardLibrary
Implements
    [IEquatable](https://learn.microsoft.com/dotnet/api/system.iequatable-1)<CardLibrary>
##  __Конструкторы
...
## __Свойства
[Description](P_Tessa_Cards_CardLibrary_Description.htm)|  Описание библиотеки
с карточками.  
---|---  
...
[Items](P_Tessa_Cards_CardLibrary_Items.htm)|  Список записей в библиотеке с
карточками.  
[Reference](P_Tessa_Cards_CardSerializableObject_Reference.htm)|  Имя
глобального объекта, на который ссылается данный объект.  
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[XmlElementNameInternal](P_Tessa_Cards_CardLibrary_XmlElementNameInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeChildrenFromBinaryInternal](M_Tessa_Cards_CardLibrary_DeserializeChildrenFromBinaryInternal.htm)|
...
[DeserializeElementFromXml](M_Tessa_Cards_CardLibrary_DeserializeElementFromXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromBinaryInternal](M_Tessa_Cards_CardLibrary_DeserializeFromBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[DeserializeFromStorageInternal](M_Tessa_Cards_CardLibrary_DeserializeFromStorageInternal.htm)|
...
[GetHashCode](M_Tessa_Cards_CardLibrary_GetHashCode.htm)| Возвращает хеш-код
объекта.  
(Переопределяет
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[OnDeserializing](M_Tessa_Cards_CardLibrary_OnDeserializing.htm)| Выполняется
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SealInternal](M_Tessa_Cards_CardLibrary_SealInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeChildrenToBinaryInternal](M_Tessa_Cards_CardLibrary_SerializeChildrenToBinaryInternal.htm)|
...
[SerializeElementsToXml](M_Tessa_Cards_CardLibrary_SerializeElementsToXml.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToBinaryInternal](M_Tessa_Cards_CardLibrary_SerializeToBinaryInternal.htm)|
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[SerializeToStorageInternal](M_Tessa_Cards_CardLibrary_SerializeToStorageInternal.htm)|
Выполняет сериализацию текущего объекта и всех его дочерних объектов в
...
[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm))  
##  __Поля
[XmlElementName](F_Tessa_Cards_CardLibrary_XmlElementName.htm)|  Имя XML-
элемента.  
---|---  
## __Методы расширения
