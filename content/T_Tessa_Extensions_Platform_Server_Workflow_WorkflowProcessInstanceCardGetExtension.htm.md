# WorkflowProcessInstanceCardGetExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Workflow](N_Tessa_Extensions_Platform_Server_Workflow.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class WorkflowProcessInstanceCardGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class WorkflowProcessInstanceCardGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class WorkflowProcessInstanceCardGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type WorkflowProcessInstanceCardGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ WorkflowProcessInstanceCardGetExtension
##  __Конструкторы
[WorkflowProcessInstanceCardGetExtension](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowProcessInstanceCardGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowProcessInstanceCardGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowProcessInstanceCardGetExtension_AfterRequest.htm)|  
(Переопределяет
