...
C# __Копировать
     public sealed class Focusable : Behavior<UIElement>
VB __Копировать
     Public NotInheritable Class Focusable
    	Inherits Behavior(Of UIElement)
C++ __Копировать
     public ref class Focusable sealed : public Behavior<UIElement^>
F# __Копировать
     [<SealedAttribute>]
    type Focusable = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable) __[LinkedFreezable](T_Tessa_UI_LinkedFreezable.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior.htm) __[Behavior](T_Tessa_UI_Behaviors_Behavior_1.htm)<[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement)> __ Focusable
##  __Конструкторы
[Focusable](M_Tessa_UI_Behaviors_Focusable__ctor.htm)| Инициализирует новый
экземпляр класса Focusable  
---|---  
##  __Свойства
...
(Унаследован от
[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject))  
[IsFocused](P_Tessa_UI_Behaviors_Focusable_IsFocused.htm)|  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[Type](P_Tessa_UI_Behaviors_Focusable_Type.htm)|  
## __Методы
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_Focusable_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[OnAttached](M_Tessa_UI_Behaviors_Focusable_OnAttached.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnDetaching](M_Tessa_UI_Behaviors_Focusable_OnDetaching.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[IsFocusedProperty](F_Tessa_UI_Behaviors_Focusable_IsFocusedProperty.htm)|  
---|---  
[TypeProperty](F_Tessa_UI_Behaviors_Focusable_TypeProperty.htm)|  
## __См. также
#### Ссылки
