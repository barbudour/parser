# FileSatelliteCardStoreExtension - класс
...
C# __Копировать
     public sealed class FileSatelliteCardStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class FileSatelliteCardStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class FileSatelliteCardStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type FileSatelliteCardStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ FileSatelliteCardStoreExtension
##  __Конструкторы
[FileSatelliteCardStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_FileSatelliteCardStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса FileSatelliteCardStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Cards_FileSatelliteCardStoreExtension_BeforeCommitTransaction.htm)|
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_FileSatelliteCardStoreExtension_BeforeRequest.htm)|
