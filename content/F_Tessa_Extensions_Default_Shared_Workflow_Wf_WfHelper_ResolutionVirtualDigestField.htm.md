# WfHelper.ResolutionVirtualDigestField - поле
...
VB __Копировать
     Public Const ResolutionVirtualDigestField As String = "Digest"
C++ __Копировать
     public:
    literal String^ ResolutionVirtualDigestField = "Digest"
F# __Копировать
     static val mutable ResolutionVirtualDigestField: string
#### Значение поля
