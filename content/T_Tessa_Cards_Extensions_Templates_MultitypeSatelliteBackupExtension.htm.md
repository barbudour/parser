# MultitypeSatelliteBackupExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Cards.Extensions.Templates](N_Tessa_Cards_Extensions_Templates.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public abstract class MultitypeSatelliteBackupExtension : CardGetExtension
VB __Копировать
     Public MustInherit Class MultitypeSatelliteBackupExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class MultitypeSatelliteBackupExtension abstract : public CardGetExtension
F# __Копировать
     [<AbstractClassAttribute>]
    type MultitypeSatelliteBackupExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ MultitypeSatelliteBackupExtension
Derived
[Tessa.Cards.Extensions.Templates.TaskSatelliteBackupExtension](T_Tessa_Cards_Extensions_Templates_TaskSatelliteBackupExtension.htm)
##  __Конструкторы
[MultitypeSatelliteBackupExtension](M_Tessa_Cards_Extensions_Templates_MultitypeSatelliteBackupExtension__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetSatelliteInfoListAsync](M_Tessa_Cards_Extensions_Templates_MultitypeSatelliteBackupExtension_TryGetSatelliteInfoListAsync.htm)|
