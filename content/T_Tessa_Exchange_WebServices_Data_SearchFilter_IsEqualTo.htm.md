...
VB __Копировать
     Public NotInheritable Class IsEqualTo
    	Inherits SearchFilter.RelationalFilter
C++ __Копировать
     public ref class IsEqualTo sealed : public SearchFilter.RelationalFilter
F# __Копировать
     [<SealedAttribute>]
    type IsEqualTo = 
        class
