...
C# __Копировать
     public class TimeZonesGetExtension : CardGetExtension
VB __Копировать
     Public Class TimeZonesGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class TimeZonesGetExtension : public CardGetExtension
F# __Копировать
     type TimeZonesGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ TimeZonesGetExtension
##  __Конструкторы
[TimeZonesGetExtension](M_Tessa_Extensions_Platform_Server_TimeZones_TimeZonesGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса TimeZonesGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_TimeZones_TimeZonesGetExtension_AfterRequest.htm)|  
(Переопределяет
...
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
##  __Поля
[ZonesKey](F_Tessa_Extensions_Platform_Server_TimeZones_TimeZonesGetExtension_ZonesKey.htm)|  
---|---  
## __Методы расширения
