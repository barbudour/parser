# NumberQueuePredicateTypeRegistry - класс
...
C# __Копировать
     public sealed class NumberQueuePredicateTypeRegistry : Registry<Guid, NumberQueuePredicateType>, 
    	INumberQueuePredicateTypeRegistry, IRegistry<Guid, NumberQueuePredicateType>
VB __Копировать
     Public NotInheritable Class NumberQueuePredicateTypeRegistry
    	Inherits Registry(Of Guid, NumberQueuePredicateType)
    	Implements INumberQueuePredicateTypeRegistry, IRegistry(Of Guid, NumberQueuePredicateType)
C++ __Копировать
     public ref class NumberQueuePredicateTypeRegistry sealed : public Registry<Guid, NumberQueuePredicateType^>, 
    	INumberQueuePredicateTypeRegistry, IRegistry<Guid, NumberQueuePredicateType^>
F# __Копировать
     [<SealedAttribute>]
    type NumberQueuePredicateTypeRegistry = 
        class
            inherit Registry<Guid, NumberQueuePredicateType>
            interface INumberQueuePredicateTypeRegistry
            interface IRegistry<Guid, NumberQueuePredicateType>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Registry](T_Tessa_Platform_Registry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [NumberQueuePredicateType](T_Tessa_Cards_Numbers_NumberQueuePredicateType.htm)> __ NumberQueuePredicateTypeRegistry
Implements
    [INumberQueuePredicateTypeRegistry](T_Tessa_Cards_Numbers_INumberQueuePredicateTypeRegistry.htm), [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [NumberQueuePredicateType](T_Tessa_Cards_Numbers_NumberQueuePredicateType.htm)>
##  __Свойства
