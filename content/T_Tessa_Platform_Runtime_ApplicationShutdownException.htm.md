# ApplicationShutdownException - класс
...
VB __Копировать
    <SerializableAttribute>
    Public Class ApplicationShutdownException
    	Inherits ApplicationException
C++ __Копировать
    [SerializableAttribute]
    public ref class ApplicationShutdownException : public ApplicationException
F# __Копировать
     [<SerializableAttribute>]
    type ApplicationShutdownException = 
        class
            inherit ApplicationException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception) __ ApplicationShutdownException
##  __Конструкторы
[ApplicationShutdownException()](M_Tessa_Platform_Runtime_ApplicationShutdownException__ctor.htm)|
Создаёт экземпляр класса с параметрами по умолчанию.  
---|---  
[ApplicationShutdownException(SerializationInfo,
StreamingContext)](M_Tessa_Platform_Runtime_ApplicationShutdownException__ctor_1.htm)|
