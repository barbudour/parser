...
VB __Копировать
     Public Structure CompilationAnchor
C++ __Копировать
     public value class CompilationAnchor
F# __Копировать
     [<SealedAttribute>]
    type CompilationAnchor = 
        struct
            inherit ValueType
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) __ CompilationAnchor
##  __Конструкторы
[CompilationAnchor](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_CompilationAnchor__ctor.htm)|
Инициализирует новый экземпляр CompilationAnchor.  
---|---  
## __Свойства
[Name](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_CompilationAnchor_Name.htm)|
Возвращает имя элемента.  
---|---  
[SyntaxKind](P_Tessa_Extensions_Default_Server_Workflow_KrCompilers_SourceBuilders_CompilationAnchor_SyntaxKind.htm)|
