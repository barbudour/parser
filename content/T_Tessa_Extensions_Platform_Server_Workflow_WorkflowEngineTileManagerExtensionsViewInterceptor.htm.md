# WorkflowEngineTileManagerExtensionsViewInterceptor - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Workflow](N_Tessa_Extensions_Platform_Server_Workflow.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class WorkflowEngineTileManagerExtensionsViewInterceptor : ViewInterceptorBase
VB __Копировать
     Public NotInheritable Class WorkflowEngineTileManagerExtensionsViewInterceptor
    	Inherits ViewInterceptorBase
C++ __Копировать
     public ref class WorkflowEngineTileManagerExtensionsViewInterceptor sealed : public ViewInterceptorBase
F# __Копировать
     [<SealedAttribute>]
    type WorkflowEngineTileManagerExtensionsViewInterceptor = 
        class
            inherit ViewInterceptorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ViewInterceptorBase](T_Tessa_Views_ViewInterceptorBase.htm) __ WorkflowEngineTileManagerExtensionsViewInterceptor
##  __Конструкторы
[WorkflowEngineTileManagerExtensionsViewInterceptor](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowEngineTileManagerExtensionsViewInterceptor__ctor.htm)|
Инициализирует новый экземпляр класса
WorkflowEngineTileManagerExtensionsViewInterceptor  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetDataAsync](M_Tessa_Extensions_Platform_Server_Workflow_WorkflowEngineTileManagerExtensionsViewInterceptor_GetDataAsync.htm)|
