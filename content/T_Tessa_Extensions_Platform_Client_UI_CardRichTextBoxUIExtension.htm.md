# CardRichTextBoxUIExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Client.UI](N_Tessa_Extensions_Platform_Client_UI.htm)  
 **Сборка:** Tessa.UI (в Tessa.UI.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class CardRichTextBoxUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class CardRichTextBoxUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class CardRichTextBoxUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type CardRichTextBoxUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ CardRichTextBoxUIExtension
##  __Конструкторы
[CardRichTextBoxUIExtension](M_Tessa_Extensions_Platform_Client_UI_CardRichTextBoxUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса CardRichTextBoxUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Platform_Client_UI_CardRichTextBoxUIExtension_Initialized.htm)|  
(Переопределяет
