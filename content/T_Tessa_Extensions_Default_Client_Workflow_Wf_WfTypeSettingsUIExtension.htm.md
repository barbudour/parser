# WfTypeSettingsUIExtension - класс
...
C# __Копировать
     public sealed class WfTypeSettingsUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class WfTypeSettingsUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class WfTypeSettingsUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type WfTypeSettingsUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ WfTypeSettingsUIExtension
##  __Конструкторы
[WfTypeSettingsUIExtension](M_Tessa_Extensions_Default_Client_Workflow_Wf_WfTypeSettingsUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса WfTypeSettingsUIExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_Workflow_Wf_WfTypeSettingsUIExtension_Initialized.htm)|  
(Переопределяет
