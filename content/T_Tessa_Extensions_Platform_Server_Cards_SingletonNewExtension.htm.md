...
C# __Копировать
     public sealed class SingletonNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class SingletonNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class SingletonNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type SingletonNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ SingletonNewExtension
##  __Конструкторы
[SingletonNewExtension](M_Tessa_Extensions_Platform_Server_Cards_SingletonNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса SingletonNewExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_SingletonNewExtension_BeforeRequest.htm)|  
(Переопределяет
