# ForumProviderExtensions.ForumProviderGetTopicRequest - класс
##  __Definition
 **Пространство имён:** [Tessa.Forums](N_Tessa_Forums.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public class ForumProviderGetTopicRequest : StorageObject
VB __Копировать
     Public Class ForumProviderGetTopicRequest
    	Inherits StorageObject
C++ __Копировать
     public ref class ForumProviderGetTopicRequest : public StorageObject
F# __Копировать
     type ForumProviderGetTopicRequest = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ ForumProviderExtensions.ForumProviderGetTopicRequest
##  __Конструкторы
[ForumProviderExtensions.ForumProviderGetTopicRequest()](M_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicRequest__ctor.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderGetTopicRequest  
---|---  
[ForumProviderExtensions.ForumProviderGetTopicRequest(Dictionary<String,
Object>)](M_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicRequest__ctor_1.htm)|
Инициализирует новый экземпляр класса
ForumProviderExtensions.ForumProviderGetTopicRequest  
##  __Свойства
[CardID](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicRequest_CardID.htm)|  
---|---  
[IsSuperModerator](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicRequest_IsSuperModerator.htm)|  
[PermissionsToken](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicRequest_PermissionsToken.htm)|  
[SingletonMode](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicRequest_SingletonMode.htm)|  
[TopicID](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicRequest_TopicID.htm)|  
[TypeID](P_Tessa_Forums_ForumProviderExtensions_ForumProviderGetTopicRequest_TypeID.htm)|  
## __Методы
