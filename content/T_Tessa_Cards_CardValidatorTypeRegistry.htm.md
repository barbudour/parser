# CardValidatorTypeRegistry - класс
...
C# __Копировать
     public sealed class CardValidatorTypeRegistry : Registry<Guid, CardValidatorType>, 
    	ICardValidatorTypeRegistry, IRegistry<Guid, CardValidatorType>
VB __Копировать
     Public NotInheritable Class CardValidatorTypeRegistry
    	Inherits Registry(Of Guid, CardValidatorType)
    	Implements ICardValidatorTypeRegistry, IRegistry(Of Guid, CardValidatorType)
C++ __Копировать
     public ref class CardValidatorTypeRegistry sealed : public Registry<Guid, CardValidatorType^>, 
    	ICardValidatorTypeRegistry, IRegistry<Guid, CardValidatorType^>
F# __Копировать
     [<SealedAttribute>]
    type CardValidatorTypeRegistry = 
        class
            inherit Registry<Guid, CardValidatorType>
            interface ICardValidatorTypeRegistry
            interface IRegistry<Guid, CardValidatorType>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Registry](T_Tessa_Platform_Registry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [CardValidatorType](T_Tessa_Cards_CardValidatorType.htm)> __ CardValidatorTypeRegistry
Implements
    [ICardValidatorTypeRegistry](T_Tessa_Cards_ICardValidatorTypeRegistry.htm), [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [CardValidatorType](T_Tessa_Cards_CardValidatorType.htm)>
##  __Свойства
