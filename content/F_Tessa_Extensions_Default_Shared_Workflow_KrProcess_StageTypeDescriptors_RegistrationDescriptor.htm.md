# StageTypeDescriptors.RegistrationDescriptor - поле
...
VB __Копировать
     Public Shared ReadOnly RegistrationDescriptor As StageTypeDescriptor
C++ __Копировать
     public:
    static initonly StageTypeDescriptor^ RegistrationDescriptor
F# __Копировать
     static val RegistrationDescriptor: StageTypeDescriptor
#### Значение поля
