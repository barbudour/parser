...
C# __Копировать
     public sealed class KrStagesExportExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class KrStagesExportExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class KrStagesExportExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type KrStagesExportExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ KrStagesExportExtension
##  __Конструкторы
[KrStagesExportExtension](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrStagesExportExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrStagesExportExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_KrStagesExportExtension_AfterRequest.htm)|  
(Переопределяет
