# WorkflowConstants.KrUniversalTaskActionButtonsVirtual.Digest - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Const Digest As String = "Digest"
C++ __Копировать
     public:
    literal String^ Digest = "Digest"
F# __Копировать
     static val mutable Digest: string
#### Значение поля
