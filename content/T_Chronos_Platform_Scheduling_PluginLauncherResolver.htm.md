...
C# __Копировать
     public sealed class PluginLauncherResolver
VB __Копировать
     Public NotInheritable Class PluginLauncherResolver
C++ __Копировать
     public ref class PluginLauncherResolver sealed
F# __Копировать
     [<SealedAttribute>]
    type PluginLauncherResolver = class end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ PluginLauncherResolver
##  __Заметки
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Register](M_Chronos_Platform_Scheduling_PluginLauncherResolver_Register.htm)|
...
объект.  
[Resolve](M_Chronos_Platform_Scheduling_PluginLauncherResolver_Resolve.htm)|
