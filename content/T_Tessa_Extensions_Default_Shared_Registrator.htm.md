...
##  __Конструкторы
[Registrator](M_Tessa_Extensions_Default_Shared_Registrator__ctor.htm)|
...
(Унаследован от [RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm))  
[InitializeRegistration](M_Tessa_Extensions_Default_Shared_Registrator_InitializeRegistration.htm)|  
(Переопределяет
[RegistratorBase.InitializeRegistration()](M_Tessa_Extensions_RegistratorBase_InitializeRegistration.htm))  
