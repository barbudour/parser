...
VB __Копировать
     Public NotInheritable Class SchemeColumnCollection
    	Inherits SchemeNamedObjectCollection(Of SchemeColumn)
C++ __Копировать
     public ref class SchemeColumnCollection sealed : public SchemeNamedObjectCollection<SchemeColumn^>
F# __Копировать
     [<SealedAttribute>]
    type SchemeColumnCollection = 
        class
            inherit SchemeNamedObjectCollection<SchemeColumn>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[SchemeObjectCollection](T_Tessa_Scheme_SchemeObjectCollection_1.htm)<[SchemeColumn](T_Tessa_Scheme_SchemeColumn.htm)> __[SchemeNamedObjectCollection](T_Tessa_Scheme_SchemeNamedObjectCollection_1.htm)<[SchemeColumn](T_Tessa_Scheme_SchemeColumn.htm)> __ SchemeColumnCollection
##  __Свойства
...
(Унаследован от
[SchemeObjectCollection<T>](T_Tessa_Scheme_SchemeObjectCollection_1.htm))  
[Construct](M_Tessa_Scheme_SchemeColumnCollection_Construct.htm)|  
(Переопределяет
...
(Унаследован от
[SchemeNamedObjectCollection<T>](T_Tessa_Scheme_SchemeNamedObjectCollection_1.htm))  
[ValidateInsertingItem](M_Tessa_Scheme_SchemeColumnCollection_ValidateInsertingItem.htm)|  
...
[ValidateItemUniqueness](M_Tessa_Scheme_SchemeColumnCollection_ValidateItemUniqueness.htm)|  
(Переопределяет [SchemeNamedObjectCollection<T>.ValidateItemUniqueness(T,
T)](M_Tessa_Scheme_SchemeNamedObjectCollection_1_ValidateItemUniqueness.htm))  
...
---|---  
[GetColumn](M_Tessa_Scheme_SchemeColumnCollectionExtensions_GetColumn.htm)|  
(Определяется
[SchemeColumnCollectionExtensions](T_Tessa_Scheme_SchemeColumnCollectionExtensions.htm))  
[GetColumn](M_Tessa_Scheme_SchemeColumnCollectionExtensions_GetColumn_1.htm)|  
(Определяется
[SchemeColumnCollectionExtensions](T_Tessa_Scheme_SchemeColumnCollectionExtensions.htm))  
[GetColumn](M_Tessa_Scheme_SchemeColumnCollectionExtensions_GetColumn_2.htm)|  
(Определяется
[SchemeColumnCollectionExtensions](T_Tessa_Scheme_SchemeColumnCollectionExtensions.htm))  
[GetColumn](M_Tessa_Scheme_SchemeColumnCollectionExtensions_GetColumn_3.htm)|  
(Определяется
[SchemeColumnCollectionExtensions](T_Tessa_Scheme_SchemeColumnCollectionExtensions.htm))  
[GetComplexColumn](M_Tessa_Scheme_SchemeColumnCollectionExtensions_GetComplexColumn.htm)|  
(Определяется
[SchemeColumnCollectionExtensions](T_Tessa_Scheme_SchemeColumnCollectionExtensions.htm))  
[GetComplexColumn](M_Tessa_Scheme_SchemeColumnCollectionExtensions_GetComplexColumn_1.htm)|  
(Определяется
[SchemeColumnCollectionExtensions](T_Tessa_Scheme_SchemeColumnCollectionExtensions.htm))  
[GetComplexColumn](M_Tessa_Scheme_SchemeColumnCollectionExtensions_GetComplexColumn_2.htm)|  
(Определяется
[SchemeColumnCollectionExtensions](T_Tessa_Scheme_SchemeColumnCollectionExtensions.htm))  
[GetComplexColumn](M_Tessa_Scheme_SchemeColumnCollectionExtensions_GetComplexColumn_3.htm)|  
(Определяется
[SchemeColumnCollectionExtensions](T_Tessa_Scheme_SchemeColumnCollectionExtensions.htm))  
[GetPhysicalColumn](M_Tessa_Scheme_SchemeColumnCollectionExtensions_GetPhysicalColumn.htm)|  
(Определяется
[SchemeColumnCollectionExtensions](T_Tessa_Scheme_SchemeColumnCollectionExtensions.htm))  
[GetPhysicalColumn](M_Tessa_Scheme_SchemeColumnCollectionExtensions_GetPhysicalColumn_1.htm)|  
(Определяется
[SchemeColumnCollectionExtensions](T_Tessa_Scheme_SchemeColumnCollectionExtensions.htm))  
[GetPhysicalColumn](M_Tessa_Scheme_SchemeColumnCollectionExtensions_GetPhysicalColumn_2.htm)|  
(Определяется
[SchemeColumnCollectionExtensions](T_Tessa_Scheme_SchemeColumnCollectionExtensions.htm))  
[GetPhysicalColumn](M_Tessa_Scheme_SchemeColumnCollectionExtensions_GetPhysicalColumn_3.htm)|  
(Определяется
[SchemeColumnCollectionExtensions](T_Tessa_Scheme_SchemeColumnCollectionExtensions.htm))  
