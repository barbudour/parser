...
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class KrProcessInstance
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class KrProcessInstance sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type KrProcessInstance = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ KrProcessInstance
##  __Конструкторы
...
Инициализирует новый экземпляр объекта KrProcessInstance.  
