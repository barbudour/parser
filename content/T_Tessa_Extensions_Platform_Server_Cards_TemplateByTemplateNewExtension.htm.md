# TemplateByTemplateNewExtension - класс
...
C# __Копировать
     public sealed class TemplateByTemplateNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class TemplateByTemplateNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class TemplateByTemplateNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type TemplateByTemplateNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ TemplateByTemplateNewExtension
##  __Конструкторы
[TemplateByTemplateNewExtension](M_Tessa_Extensions_Platform_Server_Cards_TemplateByTemplateNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса TemplateByTemplateNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_TemplateByTemplateNewExtension_AfterRequest.htm)|  
(Переопределяет
