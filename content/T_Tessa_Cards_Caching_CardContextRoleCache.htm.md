...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ CardContextRoleCache
Implements
    [ICardContextRoleCache](T_Tessa_Cards_Caching_ICardContextRoleCache.htm)
##  __Конструкторы
[CardContextRoleCache](M_Tessa_Cards_Caching_CardContextRoleCache__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Методы
[ContainsAsync](M_Tessa_Cards_Caching_CardContextRoleCache_ContainsAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetAsync](M_Tessa_Cards_Caching_CardContextRoleCache_GetAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InvalidateAsync](M_Tessa_Cards_Caching_CardContextRoleCache_InvalidateAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[TryGetAsync](M_Tessa_Cards_Caching_CardContextRoleCache_TryGetAsync.htm)|
