# FilterViewDialogOverrideTileExtension - класс
...
C# __Копировать
     public sealed class FilterViewDialogOverrideTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class FilterViewDialogOverrideTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class FilterViewDialogOverrideTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type FilterViewDialogOverrideTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ FilterViewDialogOverrideTileExtension
##  __Конструкторы
[FilterViewDialogOverrideTileExtension](M_Tessa_Extensions_Default_Client_Tiles_FilterViewDialogOverrideTileExtension__ctor.htm)|
...
(Унаследован от
[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm))  
[InitializingLocal](M_Tessa_Extensions_Default_Client_Tiles_FilterViewDialogOverrideTileExtension_InitializingLocal.htm)|
