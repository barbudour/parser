...
C# __Копировать
     public sealed class NumberDependencies : INumberDependencies
VB __Копировать
     Public NotInheritable Class NumberDependencies
    	Implements INumberDependencies
C++ __Копировать
     public ref class NumberDependencies sealed : INumberDependencies
F# __Копировать
     [<SealedAttribute>]
    type NumberDependencies = 
        class
            interface INumberDependencies
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ NumberDependencies
Implements
    [INumberDependencies](T_Tessa_Cards_Numbers_INumberDependencies.htm)
##  __Конструкторы
[NumberDependencies](M_Tessa_Cards_Numbers_NumberDependencies__ctor.htm)|
