# AspMvcControllerAttribute - класс
...
C++ __Копировать
    [AttributeUsageAttribute(AttributeTargets::Method|AttributeTargets::Parameter)]
    public ref class AspMvcControllerAttribute sealed : public Attribute
F# __Копировать
     [<SealedAttribute>]
    [<AttributeUsageAttribute(AttributeTargets.Method|AttributeTargets.Parameter)>]
    type AspMvcControllerAttribute = 
        class
            inherit Attribute
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Attribute](https://learn.microsoft.com/dotnet/api/system.attribute) __ AspMvcControllerAttribute
##  __Конструкторы
...
Initializes a new instance of the AspMvcControllerAttribute class.  
## __Свойства
[AnonymousProperty](P_Tessa_Properties_Resharper_AspMvcControllerAttribute_AnonymousProperty.htm)|
