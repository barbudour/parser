...
C# __Копировать
     public sealed class KrSettingsTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class KrSettingsTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class KrSettingsTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type KrSettingsTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ KrSettingsTileExtension
##  __Конструкторы
[KrSettingsTileExtension](M_Tessa_Extensions_Default_Client_Tiles_KrSettingsTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrSettingsTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_KrSettingsTileExtension_InitializingGlobal.htm)|  
(Переопределяет
