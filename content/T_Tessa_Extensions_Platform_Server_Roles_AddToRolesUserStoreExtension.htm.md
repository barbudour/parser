# AddToRolesUserStoreExtension - класс
...
C# __Копировать
     public sealed class AddToRolesUserStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class AddToRolesUserStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class AddToRolesUserStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type AddToRolesUserStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ AddToRolesUserStoreExtension
##  __Конструкторы
[AddToRolesUserStoreExtension](M_Tessa_Extensions_Platform_Server_Roles_AddToRolesUserStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса AddToRolesUserStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Roles_AddToRolesUserStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
