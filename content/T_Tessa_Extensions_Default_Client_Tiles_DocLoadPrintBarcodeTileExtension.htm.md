# DocLoadPrintBarcodeTileExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class DocLoadPrintBarcodeTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class DocLoadPrintBarcodeTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type DocLoadPrintBarcodeTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ DocLoadPrintBarcodeTileExtension
##  __Конструкторы
[DocLoadPrintBarcodeTileExtension](M_Tessa_Extensions_Default_Client_Tiles_DocLoadPrintBarcodeTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса DocLoadPrintBarcodeTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_DocLoadPrintBarcodeTileExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[InitializingLocal](M_Tessa_Extensions_Default_Client_Tiles_DocLoadPrintBarcodeTileExtension_InitializingLocal.htm)|  
(Переопределяет
