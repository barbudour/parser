# FileSignatureCollection - класс
Коллекция подписей для версии файла.
## __Definition
 **Пространство имён:** [Tessa.Files](N_Tessa_Files.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class FileSignatureCollection : FileSignatureCollectionBase<IFileSignatureCollection>, 
    	IFileSignatureCollection, IFileSignatureCollectionBase<IFileSignatureCollection>, IFileEntityCollection<IFileSignature, IFileSignatureCollection>, 
    	IObservableCollectionLookup<Guid, IFileSignature, IFileSignatureCollection>, IObservableCollection<IFileSignature, IFileSignatureCollection>, 
...
VB __Копировать
     Public NotInheritable Class FileSignatureCollection
    	Inherits FileSignatureCollectionBase(Of IFileSignatureCollection)
    	Implements IFileSignatureCollection, IFileSignatureCollectionBase(Of IFileSignatureCollection), 
    	IFileEntityCollection(Of IFileSignature, IFileSignatureCollection), IObservableCollectionLookup(Of Guid, IFileSignature, IFileSignatureCollection), 
    	IObservableCollection(Of IFileSignature, IFileSignatureCollection), IList(Of IFileSignature), 
...
C++ __Копировать
     public ref class FileSignatureCollection sealed : public FileSignatureCollectionBase<IFileSignatureCollection^>, 
    	IFileSignatureCollection, IFileSignatureCollectionBase<IFileSignatureCollection^>, IFileEntityCollection<IFileSignature^, IFileSignatureCollection^>, 
    	IObservableCollectionLookup<Guid, IFileSignature^, IFileSignatureCollection^>, IObservableCollection<IFileSignature^, IFileSignatureCollection^>, 
    	IList<IFileSignature^>, ICollection<IFileSignature^>, IEnumerable<IFileSignature^>, 
    	IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged, ICloneable, ILookupContainer<Guid, IFileSignature^>, 
...
F# __Копировать
     [<SealedAttribute>]
    type FileSignatureCollection = 
        class
            inherit FileSignatureCollectionBase<IFileSignatureCollection>
            interface IFileSignatureCollection
            interface IFileSignatureCollectionBase<IFileSignatureCollection>
            interface IFileEntityCollection<IFileSignature, IFileSignatureCollection>
            interface IObservableCollectionLookup<Guid, IFileSignature, IFileSignatureCollection>
            interface IObservableCollection<IFileSignature, IFileSignatureCollection>
...
(Унаследован от [ObservableCollectionLookup<TKey, TItem,
TCollection>](T_Tessa_Platform_Collections_ObservableCollectionLookup_3.htm))  
[Clone](M_Tessa_Files_FileSignatureCollection_Clone.htm)|  Выполняет глубокое
