# WorkflowBindingSqlExecutor - класс
##  __Definition
 **Пространство имён:**
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ WorkflowBindingSqlExecutor
Implements
    [IWorkflowBindingExecutor](T_Tessa_Workflow_Bindings_IWorkflowBindingExecutor.htm)
##  __Конструкторы
[WorkflowBindingSqlExecutor](M_Tessa_Workflow_Bindings_WorkflowBindingSqlExecutor__ctor.htm)|
Инициализирует новый экземпляр класса WorkflowBindingSqlExecutor  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Get<T>](M_Tessa_Workflow_Bindings_WorkflowBindingSqlExecutor_Get__1.htm)|
...
[GetAsync<T>](M_Tessa_Workflow_Bindings_WorkflowBindingSqlExecutor_GetAsync__1.htm)|
...
T)](M_Tessa_Workflow_Bindings_WorkflowBindingSqlExecutor_Set__1_1.htm)|
...
T)](M_Tessa_Workflow_Bindings_WorkflowBindingSqlExecutor_Set__1.htm)|
