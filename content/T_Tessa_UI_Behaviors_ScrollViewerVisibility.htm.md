...
[ComputedHorizontalScrollBarVisibility](P_Tessa_UI_Behaviors_ScrollViewerVisibility_ComputedHorizontalScrollBarVisibility.htm)|  
[ComputedVerticalScrollBarVisibility](P_Tessa_UI_Behaviors_ScrollViewerVisibility_ComputedVerticalScrollBarVisibility.htm)|  
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_ScrollViewerVisibility_CreateInstanceCore.htm)|  
(Переопределяет
...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[OnConnected](M_Tessa_UI_Behaviors_ScrollViewerVisibility_OnConnected.htm)|  
(Переопределяет
...
(Унаследован от
[ScrollViewerBehaviorBase](T_Tessa_UI_Behaviors_ScrollViewerBehaviorBase.htm))  
[OnDisconnected](M_Tessa_UI_Behaviors_ScrollViewerVisibility_OnDisconnected.htm)|  
(Переопределяет
...
---|---  
##  __Поля
[ComputedHorizontalScrollBarVisibilityProperty](F_Tessa_UI_Behaviors_ScrollViewerVisibility_ComputedHorizontalScrollBarVisibilityProperty.htm)|  
---|---  
[ComputedVerticalScrollBarVisibilityProperty](F_Tessa_UI_Behaviors_ScrollViewerVisibility_ComputedVerticalScrollBarVisibilityProperty.htm)|  
## __См. также
#### Ссылки
