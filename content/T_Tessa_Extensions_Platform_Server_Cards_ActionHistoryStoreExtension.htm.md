# ActionHistoryStoreExtension - класс
...
C# __Копировать
     public sealed class ActionHistoryStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class ActionHistoryStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class ActionHistoryStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type ActionHistoryStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ ActionHistoryStoreExtension
##  __Конструкторы
[ActionHistoryStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_ActionHistoryStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса ActionHistoryStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Cards_ActionHistoryStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
