# ValidateUniqueStoreExtension - класс
...
C# __Копировать
     public sealed class ValidateUniqueStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class ValidateUniqueStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class ValidateUniqueStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type ValidateUniqueStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ ValidateUniqueStoreExtension
##  __Заметки
Расширение по порядку должно быть зарегистрировано после
[ValidateCardStoreExtension](T_Tessa_Extensions_Platform_Shared_Cards_ValidateCardStoreExtension.htm).
## __Конструкторы
[ValidateUniqueStoreExtension](M_Tessa_Extensions_Platform_Server_Cards_ValidateUniqueStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса ValidateUniqueStoreExtension  
---|---  
##  __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Cards_ValidateUniqueStoreExtension_AfterBeginTransaction.htm)|  
(Переопределяет
...
---|---  
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_ValidateUniqueStoreExtension_AfterRequest.htm)|  
(Переопределяет
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_ValidateUniqueStoreExtension_BeforeRequest.htm)|  
(Переопределяет
