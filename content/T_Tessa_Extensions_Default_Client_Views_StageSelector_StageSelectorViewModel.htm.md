...
VB __Копировать
     Public Class StageSelectorViewModel
    	Inherits ViewModel(Of EmptyModel)
C++ __Копировать
     public ref class StageSelectorViewModel : public ViewModel<EmptyModel^>
F# __Копировать
     type StageSelectorViewModel = 
        class
            inherit ViewModel<EmptyModel>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[NotificationObject](T_Tessa_Platform_NotificationObject.htm) __[NotificationUIObject](T_Tessa_UI_NotificationUIObject.htm) __[ViewModel](T_Tessa_UI_ViewModel_1.htm)<[EmptyModel](T_Tessa_UI_EmptyModel.htm)> __ StageSelectorViewModel
##  __Конструкторы
[StageSelectorViewModel](M_Tessa_Extensions_Default_Client_Views_StageSelector_StageSelectorViewModel__ctor.htm)|
Инициализирует новый экземпляр класса StageSelectorViewModel.  
---|---  
## __Свойства
[Groups](P_Tessa_Extensions_Default_Client_Views_StageSelector_StageSelectorViewModel_Groups.htm)|
...
(Унаследован от [ViewModel<TModel>](T_Tessa_UI_ViewModel_1.htm))  
[SelectedGroup](P_Tessa_Extensions_Default_Client_Views_StageSelector_StageSelectorViewModel_SelectedGroup.htm)|
Возвращает или задаёт выбранную модель представления группы этапов.  
[SelectedType](P_Tessa_Extensions_Default_Client_Views_StageSelector_StageSelectorViewModel_SelectedType.htm)|
Возвращает или задаёт выбранную модель представления типа этапа.  
[SelectTypeCommand](P_Tessa_Extensions_Default_Client_Views_StageSelector_StageSelectorViewModel_SelectTypeCommand.htm)|
Возвращает команду выполняемую при выборе типа этапа.  
[Types](P_Tessa_Extensions_Default_Client_Views_StageSelector_StageSelectorViewModel_Types.htm)|
Возвращает коллекцию доступных для выбора моделей представления типов этапов
соответствующих текущей выбранной группе
[SelectedGroup](P_Tessa_Extensions_Default_Client_Views_StageSelector_StageSelectorViewModel_SelectedGroup.htm).  
## __Методы
...
(Унаследован от [ViewModel<TModel>](T_Tessa_UI_ViewModel_1.htm))  
[RefreshAsync](M_Tessa_Extensions_Default_Client_Views_StageSelector_StageSelectorViewModel_RefreshAsync.htm)|
