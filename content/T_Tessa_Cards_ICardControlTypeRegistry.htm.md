# ICardControlTypeRegistry - интерфейс
...
C# __Копировать
     public interface ICardControlTypeRegistry : IRegistry<Guid, CardControlType>
VB __Копировать
     Public Interface ICardControlTypeRegistry
    	Inherits IRegistry(Of Guid, CardControlType)
C++ __Копировать
     public interface class ICardControlTypeRegistry : IRegistry<Guid, CardControlType^>
F# __Копировать
     type ICardControlTypeRegistry = 
        interface
            interface IRegistry<Guid, CardControlType>
        end
Implements
    [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [CardControlType](T_Tessa_Cards_CardControlType.htm)>
##  __Методы
