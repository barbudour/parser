...
C# __Копировать
    [RouteAttribute("api/v1/localization")]
...
VB __Копировать
    ...
    <ProducesResponseTypeAttribute(401)>
    <ProducesResponseTypeAttribute(403)>
    Public NotInheritable Class LocalizationController
    	Inherits Controller
C++ __Копировать
    [RouteAttribute(L"api/v1/localization")]
    [AllowAnonymousAttribute]
    [ApiControllerAttribute]
    [ProducesErrorResponseTypeAttribute(typeof(PlainValidationResult))]
    [ProducesResponseTypeAttribute(400)]
    [ProducesResponseTypeAttribute(401)]
    [ProducesResponseTypeAttribute(403)]
    public ref class LocalizationController sealed : public Controller
F# __Копировать
     [<SealedAttribute>]
    [<RouteAttribute("api/v1/localization")>]
    [<AllowAnonymousAttribute>]
    ...
    [<ProducesResponseTypeAttribute(401)>]
    [<ProducesResponseTypeAttribute(403)>]
    type LocalizationController = 
        class
            inherit Controller
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase) __[Controller](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controller) __ LocalizationController
##  __Конструкторы
[LocalizationController](M_Tessa_Web_Controllers_LocalizationController__ctor.htm)|
Инициализирует новый экземпляр класса LocalizationController  
---|---  
##  __Свойства
...
(Унаследован от
[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase))  
[GetEntries](M_Tessa_Web_Controllers_LocalizationController_GetEntries.htm)|
Возвращает строки локализации со всех библиотек для заданного языка. Метод
учитывает переопределение строк с одинаковым названием в разных библиотеках.  
[GetLibrary](M_Tessa_Web_Controllers_LocalizationController_GetLibrary.htm)|
Возвращает библиотеку локализации по указанному идентификатору. Возвращается
204 (No Content), если библиотека не найдена.  
...
(Унаследован от
[ControllerBase](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.controllerbase))  
[PostGetLibraries](M_Tessa_Web_Controllers_LocalizationController_PostGetLibraries.htm)|
Возвращает все существующие библиотеки локализации.  
[PostGetLibraryByName](M_Tessa_Web_Controllers_LocalizationController_PostGetLibraryByName.htm)|
Возвращает библиотеку локализации по указанному уникальному имени библиотеки.
Возвращается 204 (No Content), если библиотека не найдена.  
[PostRemoveLibrary](M_Tessa_Web_Controllers_LocalizationController_PostRemoveLibrary.htm)|
Удаляет заданную библиотеку локализации. Возвращает признак того, что
библиотека существовала на момент удаления. Метод доступен только
администраторам.  
[PostSaveLibrary](M_Tessa_Web_Controllers_LocalizationController_PostSaveLibrary.htm)|
Создаёт или изменяет заданную библиотеку локализации. Метод доступен только
администраторам.  
