...
VB __Копировать
     Public Class ExternalFileSource
    	Inherits FileSource
C++ __Копировать
     public ref class ExternalFileSource : public FileSource
F# __Копировать
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[FileSource](T_Tessa_Files_FileSource.htm) __ ExternalFileSource
##  __Конструкторы
[ExternalFileSource](M_Tessa_Extensions_Default_Client_ExternalFiles_ExternalFileSource__ctor.htm)|
Инициализирует новый экземпляр класса ExternalFileSource  
---|---  
##  __Свойства
...
по заданному токену.  
(Унаследован от [FileSource](T_Tessa_Files_FileSource.htm))  
[CreateFileCoreAsync](M_Tessa_Extensions_Default_Client_ExternalFiles_ExternalFileSource_CreateFileCoreAsync.htm)|  
...
(Унаследован от [FileSource](T_Tessa_Files_FileSource.htm))  
[GetContentCoreAsync](M_Tessa_Extensions_Default_Client_ExternalFiles_ExternalFileSource_GetContentCoreAsync.htm)|  
...
[IFileSource].  
(Унаследован от [FileSource](T_Tessa_Files_FileSource.htm))  
[GetFileCreationTokenCoreAsync](M_Tessa_Extensions_Default_Client_ExternalFiles_ExternalFileSource_GetFileCreationTokenCoreAsync.htm)|  
(Переопределяет
