...
VB __Копировать
     Public NotInheritable Class CardNewEventEmitter
    	Inherits CardNewExtension
C++ __Копировать
     public ref class CardNewEventEmitter sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type CardNewEventEmitter = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ CardNewEventEmitter
##  __Конструкторы
[CardNewEventEmitter](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Actions_CardNewEventEmitter__ctor.htm)|
Инициализирует новый экземпляр класса CardNewEventEmitter.  
---|---  
## __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Workflow_KrProcess_Actions_CardNewEventEmitter_AfterRequest.htm)|
