# MessageReceivedEventArgs - класс
...
C# __Копировать
     public class MessageReceivedEventArgs : DeferredEventArgs
VB __Копировать
     Public Class MessageReceivedEventArgs
    	Inherits DeferredEventArgs
C++ __Копировать
     public ref class MessageReceivedEventArgs : public DeferredEventArgs
F# __Копировать
     type MessageReceivedEventArgs = 
        class
            inherit DeferredEventArgs
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[EventArgs](https://learn.microsoft.com/dotnet/api/system.eventargs) __[DeferredEventArgs](T_Tessa_Platform_DeferredEventArgs.htm) __ MessageReceivedEventArgs
##  __Конструкторы
[MessageReceivedEventArgs](M_Tessa_Applications_Services_PlatformApplication_MessageReceivedEventArgs__ctor.htm)|
