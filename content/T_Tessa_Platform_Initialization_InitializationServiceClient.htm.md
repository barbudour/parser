# InitializationServiceClient - класс
...
C# __Копировать
     public sealed class InitializationServiceClient : IInitializationService
VB __Копировать
     Public NotInheritable Class InitializationServiceClient
    	Implements IInitializationService
C++ __Копировать
     public ref class InitializationServiceClient sealed : IInitializationService
F# __Копировать
     [<SealedAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ InitializationServiceClient
Implements
    [IInitializationService](T_Tessa_Platform_Initialization_IInitializationService.htm)
##  __Конструкторы
[InitializationServiceClient](M_Tessa_Platform_Initialization_InitializationServiceClient__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializeAsync](M_Tessa_Platform_Initialization_InitializationServiceClient_InitializeAsync.htm)|
