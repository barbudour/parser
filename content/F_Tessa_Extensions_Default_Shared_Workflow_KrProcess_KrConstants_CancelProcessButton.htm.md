# KrConstants.CancelProcessButton - поле
...
VB __Копировать
     Public Shared ReadOnly CancelProcessButton As Guid
C++ __Копировать
     public:
    static initonly Guid CancelProcessButton
F# __Копировать
     static val CancelProcessButton: Guid
#### Значение поля
