# KrStageTemplateStoreExtension - класс
...
VB __Копировать
     Public NotInheritable Class KrStageTemplateStoreExtension
    	Inherits KrTemplateStoreExtension
C++ __Копировать
     public ref class KrStageTemplateStoreExtension sealed : public KrTemplateStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type KrStageTemplateStoreExtension = 
        class
            inherit KrTemplateStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __[KrTemplateStoreExtension](T_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrTemplateStoreExtension.htm) __ KrStageTemplateStoreExtension
##  __Конструкторы
[KrStageTemplateStoreExtension](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrStageTemplateStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrStageTemplateStoreExtension.  
---|---  
## __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrStageTemplateStoreExtension_BeforeRequest.htm)|
...
(Переопределяет
[KrTemplateStoreExtension.BeforeRequest(ICardStoreExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrTemplateStoreExtension_BeforeRequest.htm))  
[DoInsert](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrStageTemplateStoreExtension_DoInsert.htm)|
...
(Переопределяет
[KrTemplateStoreExtension.DoInsert(ICardStoreExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrTemplateStoreExtension_DoInsert.htm))  
[DoUpdate](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrStageTemplateStoreExtension_DoUpdate.htm)|
...
(Переопределяет
[KrTemplateStoreExtension.DoUpdate(ICardStoreExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrTemplateStoreExtension_DoUpdate.htm))  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetInnerCardAsync](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrStageTemplateStoreExtension_GetInnerCardAsync.htm)|
Возвращает обновляемую карточку в которую должны быть сохранены изменения из
сохраняемой карточки.  
(Переопределяет
[KrTemplateStoreExtension.GetInnerCardAsync(ICardStoreExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrTemplateStoreExtension_GetInnerCardAsync.htm))  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[OnInsert](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrStageTemplateStoreExtension_OnInsert.htm)|
Действие выполняемое перед обработкой карточки при её создании
([Insert](T_Tessa_Cards_CardStoreMode.htm)).  
(Переопределяет
[KrTemplateStoreExtension.OnInsert(ICardStoreExtensionContext)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrTemplateStoreExtension_OnInsert.htm))  
[OnUpdate](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrStageTemplateStoreExtension_OnUpdate.htm)|
Действие выполняемое перед обновлением карточки содержащей данные из
сохраняемой карточки.  
(Переопределяет [KrTemplateStoreExtension.OnUpdate(ICardStoreExtensionContext,
Card)](M_Tessa_Extensions_Default_Server_Workflow_KrCompilers_Requests_KrTemplateStoreExtension_OnUpdate.htm))  
