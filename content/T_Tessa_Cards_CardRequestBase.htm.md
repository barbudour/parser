# CardRequestBase - класс
Запрос на выполнение действий через сервис карточек по идентификатору карточки
с предоставлением дополнительной информации по идентификатору или имени её
типа.
## __Definition
...
C# __Копировать
    ...
    public abstract class CardRequestBase : CardInfoStorageObject
VB __Копировать
    <SerializableAttribute>
    Public MustInherit Class CardRequestBase
    	Inherits CardInfoStorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class CardRequestBase abstract : public CardInfoStorageObject
F# __Копировать
     [<AbstractClassAttribute>]
    [<SerializableAttribute>]
    type CardRequestBase = 
        class
            inherit CardInfoStorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm) __[CardStorageObject](T_Tessa_Cards_CardStorageObject.htm) __[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm) __ CardRequestBase
Derived
[Tessa.Cards.CardDeleteRequest](T_Tessa_Cards_CardDeleteRequest.htm)
[Tessa.Cards.CardFileRequestBase](T_Tessa_Cards_CardFileRequestBase.htm)
[Tessa.Cards.CardGetRequest](T_Tessa_Cards_CardGetRequest.htm)
##  __Конструкторы
