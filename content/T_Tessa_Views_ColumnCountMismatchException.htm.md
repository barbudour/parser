# ColumnCountMismatchException - класс
##  __Definition
 **Пространство имён:** [Tessa.Views](N_Tessa_Views.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
    [SerializableAttribute]
    public class ColumnCountMismatchException : InvalidOperationException
VB __Копировать
    <SerializableAttribute>
...
C++ __Копировать
    [SerializableAttribute]
    public ref class ColumnCountMismatchException : public InvalidOperationException
F# __Копировать
     [<SerializableAttribute>]
    type ColumnCountMismatchException = 
        class
            inherit InvalidOperationException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[SystemException](https://learn.microsoft.com/dotnet/api/system.systemexception) __[InvalidOperationException](https://learn.microsoft.com/dotnet/api/system.invalidoperationexception) __ ColumnCountMismatchException
##  __Конструкторы
[ColumnCountMismatchException()](M_Tessa_Views_ColumnCountMismatchException__ctor.htm)|
Инициализирует новый экземпляр класса ColumnCountMismatchException  
---|---  
[ColumnCountMismatchException(String)](M_Tessa_Views_ColumnCountMismatchException__ctor_2.htm)|
Инициализирует новый экземпляр класса ColumnCountMismatchException  
[ColumnCountMismatchException(SerializationInfo,
StreamingContext)](M_Tessa_Views_ColumnCountMismatchException__ctor_1.htm)|
Инициализирует новый экземпляр класса ColumnCountMismatchException  
[ColumnCountMismatchException(String,
Exception)](M_Tessa_Views_ColumnCountMismatchException__ctor_3.htm)|
Инициализирует новый экземпляр класса ColumnCountMismatchException  
##  __Свойства
