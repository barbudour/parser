# WorkplaceCardGetExtension - класс
...
C# __Копировать
     public sealed class WorkplaceCardGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class WorkplaceCardGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class WorkplaceCardGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type WorkplaceCardGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ WorkplaceCardGetExtension
##  __Конструкторы
[WorkplaceCardGetExtension](M_Tessa_Extensions_Platform_Server_Cards_WorkplaceCardGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса WorkplaceCardGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_WorkplaceCardGetExtension_AfterRequest.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_WorkplaceCardGetExtension_BeforeRequest.htm)|  
(Переопределяет
