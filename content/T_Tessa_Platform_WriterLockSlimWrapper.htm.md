# WriterLockSlimWrapper - структура
...
VB __Копировать
     Public Structure WriterLockSlimWrapper
    	Implements IDisposable
C++ __Копировать
     public value class WriterLockSlimWrapper : IDisposable
F# __Копировать
     [<SealedAttribute>]
    type WriterLockSlimWrapper = 
        struct
            inherit ValueType
            interface IDisposable
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) __ WriterLockSlimWrapper
Implements
    [IDisposable](https://learn.microsoft.com/dotnet/api/system.idisposable)
##  __Конструкторы
[WriterLockSlimWrapper](M_Tessa_Platform_WriterLockSlimWrapper__ctor.htm)|
Создаёт экземпляр структуры с указанием объекта, обеспечивающего синхронизацию
доступа по чтению и изменению ресурса.  
---|---  
## __Методы
[Dispose](M_Tessa_Platform_WriterLockSlimWrapper_Dispose.htm)| Освобождает
