# EmailUserEntityCollection - класс
...
C++ __Копировать
    [EditorBrowsableAttribute(EditorBrowsableState::Never)]
    public ref class EmailUserEntityCollection sealed : public ComplexPropertyCollection<EmailUserEntity^>
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type EmailUserEntityCollection = 
        class
            inherit ComplexPropertyCollection<EmailUserEntity>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __[ComplexPropertyCollection](T_Tessa_Exchange_WebServices_Data_ComplexPropertyCollection_1.htm)<[EmailUserEntity](T_Tessa_Exchange_WebServices_Data_EmailUserEntity.htm)> __ EmailUserEntityCollection
##  __Свойства
