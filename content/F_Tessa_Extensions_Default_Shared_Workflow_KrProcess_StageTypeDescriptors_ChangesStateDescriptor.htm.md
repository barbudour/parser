# StageTypeDescriptors.ChangesStateDescriptor - поле
...
VB __Копировать
     Public Shared ReadOnly ChangesStateDescriptor As StageTypeDescriptor
C++ __Копировать
     public:
    static initonly StageTypeDescriptor^ ChangesStateDescriptor
F# __Копировать
     static val ChangesStateDescriptor: StageTypeDescriptor
#### Значение поля
