...
C# __Копировать
     public sealed class SessionServiceLegacy2X : ISessionService
VB __Копировать
     Public NotInheritable Class SessionServiceLegacy2X
    	Implements ISessionService
C++ __Копировать
     public ref class SessionServiceLegacy2X sealed : ISessionService
F# __Копировать
     [<SealedAttribute>]
    type SessionServiceLegacy2X = 
        class
            interface ISessionService
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ SessionServiceLegacy2X
Implements
    [ISessionService](T_Tessa_Platform_Runtime_ISessionService.htm)
##  __Конструкторы
[SessionServiceLegacy2X](M_Tessa_Platform_Runtime_SessionServiceLegacy2X__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Методы
[CloseSessionAsAdminAsync](M_Tessa_Platform_Runtime_SessionServiceLegacy2X_CloseSessionAsAdminAsync.htm)|
...
---|---  
[CloseSessionAsync](M_Tessa_Platform_Runtime_SessionServiceLegacy2X_CloseSessionAsync.htm)|
...
[CloseSessionWithTokenAsync](M_Tessa_Platform_Runtime_SessionServiceLegacy2X_CloseSessionWithTokenAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IncrementConfigurationVersionAsync](M_Tessa_Platform_Runtime_SessionServiceLegacy2X_IncrementConfigurationVersionAsync.htm)|
