# CardMetadataEnumerationColumnCollection - класс
...
C# __Копировать
    ...
    public sealed class CardMetadataEnumerationColumnCollection : CardSerializableEntryCollection<CardMetadataEnumerationColumn>
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardMetadataEnumerationColumnCollection
    	Inherits CardSerializableEntryCollection(Of CardMetadataEnumerationColumn)
C++ __Копировать
    [SerializableAttribute]
    public ref class CardMetadataEnumerationColumnCollection sealed : public CardSerializableEntryCollection<CardMetadataEnumerationColumn^>
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardMetadataEnumerationColumnCollection = 
        class
            inherit CardSerializableEntryCollection<CardMetadataEnumerationColumn>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ValidationObject](T_Tessa_Platform_Validation_ValidationObject.htm) __[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm) __[CardSchemeSerializableObject](T_Tessa_Cards_CardSchemeSerializableObject.htm) __[CardSerializableEntryCollection](T_Tessa_Cards_CardSerializableEntryCollection_1.htm)<[CardMetadataEnumerationColumn](T_Tessa_Cards_Metadata_CardMetadataEnumerationColumn.htm)> __ CardMetadataEnumerationColumnCollection
##  __Конструкторы
...
(Унаследован от
[CardSerializableObject](T_Tessa_Cards_CardSerializableObject.htm))  
[XmlElementNameInternal](P_Tessa_Cards_Metadata_CardMetadataEnumerationColumnCollection_XmlElementNameInternal.htm)|
...
[XmlItemNameInternal](P_Tessa_Cards_Metadata_CardMetadataEnumerationColumnCollection_XmlItemNameInternal.htm)|
