...
C# __Копировать
     public sealed class CalendarUIExtension : CardUIExtension
VB __Копировать
     Public NotInheritable Class CalendarUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class CalendarUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type CalendarUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ CalendarUIExtension
##  __Конструкторы
[CalendarUIExtension](M_Tessa_Extensions_Default_Client_UI_CalendarUIExtension__ctor.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_UI_CalendarUIExtension_Initialized.htm)|  
(Переопределяет
