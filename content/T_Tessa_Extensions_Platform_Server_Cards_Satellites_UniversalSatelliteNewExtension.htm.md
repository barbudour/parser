# UniversalSatelliteNewExtension - класс
...
C# __Копировать
     public sealed class UniversalSatelliteNewExtension : CardNewExtension
VB __Копировать
     Public NotInheritable Class UniversalSatelliteNewExtension
    	Inherits CardNewExtension
C++ __Копировать
     public ref class UniversalSatelliteNewExtension sealed : public CardNewExtension
F# __Копировать
     [<SealedAttribute>]
    type UniversalSatelliteNewExtension = 
        class
            inherit CardNewExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardNewExtension](T_Tessa_Cards_Extensions_CardNewExtension.htm) __ UniversalSatelliteNewExtension
##  __Конструкторы
[UniversalSatelliteNewExtension](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteNewExtension__ctor.htm)|
Инициализирует новый экземпляр класса UniversalSatelliteNewExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteNewExtension_AfterRequest.htm)|  
(Переопределяет
