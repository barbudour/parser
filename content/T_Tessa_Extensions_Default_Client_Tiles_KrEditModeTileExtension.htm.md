...
C# __Копировать
     public sealed class KrEditModeTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class KrEditModeTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class KrEditModeTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type KrEditModeTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ KrEditModeTileExtension
##  __Конструкторы
[KrEditModeTileExtension](M_Tessa_Extensions_Default_Client_Tiles_KrEditModeTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса KrEditModeTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_KrEditModeTileExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[InitializingLocal](M_Tessa_Extensions_Default_Client_Tiles_KrEditModeTileExtension_InitializingLocal.htm)|  
(Переопределяет
