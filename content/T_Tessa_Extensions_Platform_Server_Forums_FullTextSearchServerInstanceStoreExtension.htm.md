# FullTextSearchServerInstanceStoreExtension - класс
##  __Definition
 **Пространство имён:**
[Tessa.Extensions.Platform.Server.Forums](N_Tessa_Extensions_Platform_Server_Forums.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class FullTextSearchServerInstanceStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class FullTextSearchServerInstanceStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class FullTextSearchServerInstanceStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type FullTextSearchServerInstanceStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ FullTextSearchServerInstanceStoreExtension
##  __Конструкторы
[FullTextSearchServerInstanceStoreExtension](M_Tessa_Extensions_Platform_Server_Forums_FullTextSearchServerInstanceStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса
FullTextSearchServerInstanceStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Platform_Server_Forums_FullTextSearchServerInstanceStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
