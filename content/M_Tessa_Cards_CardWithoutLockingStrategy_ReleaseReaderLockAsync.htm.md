# CardWithoutLockingStrategy.ReleaseReaderLockAsync - метод
Выполняет снятие блокировки на чтение карточки.
##  __Definition
 **Пространство имён:** [Tessa.Cards](N_Tessa_Cards.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public Task ReleaseReaderLockAsync(
    	Guid cardID,
...
C++ __Копировать
     public:
    virtual Task^ ReleaseReaderLockAsync(
    	Guid cardID, 
...
Асинхронная задача.
#### Реализации
[ICardLockingStrategy.ReleaseReaderLockAsync(Guid,
CancellationToken)](M_Tessa_Cards_ICardLockingStrategy_ReleaseReaderLockAsync.htm)  
##  __См. также
#### Ссылки
