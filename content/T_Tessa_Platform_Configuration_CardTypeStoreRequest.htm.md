...
C# __Копировать
    ...
    public sealed class CardTypeStoreRequest : StorageObject
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class CardTypeStoreRequest
    	Inherits StorageObject
C++ __Копировать
    [SerializableAttribute]
    public ref class CardTypeStoreRequest sealed : public StorageObject
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type CardTypeStoreRequest = 
        class
            inherit StorageObject
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ CardTypeStoreRequest
##  __Конструкторы
[CardTypeStoreRequest()](M_Tessa_Platform_Configuration_CardTypeStoreRequest__ctor.htm)|
Создаёт экземпляр класса и пустое хранилище Dictionary<string, object>,
декоратором для которого является создаваемый объект.  
---|---  
[CardTypeStoreRequest(Dictionary<String,
Object>)](M_Tessa_Platform_Configuration_CardTypeStoreRequest__ctor_1.htm)|
Создаёт экземпляр класса с указанием хранилища, декоратором для которого
является создаваемый объект.  
[CardTypeStoreRequest(IStorageObjectProvider)](M_Tessa_Platform_Configuration_CardTypeStoreRequest__ctor_3.htm)|
...
[CardTypeStoreRequest(CardTypeRepositoryData,
ActionType)](M_Tessa_Platform_Configuration_CardTypeStoreRequest__ctor_2.htm)|
Инициализирует новый экземпляр класса CardTypeStoreRequest  
##  __Свойства
[Action](P_Tessa_Platform_Configuration_CardTypeStoreRequest_Action.htm)|  
---|---  
[Caption](P_Tessa_Platform_Configuration_CardTypeStoreRequest_Caption.htm)|  
[Flags](P_Tessa_Platform_Configuration_CardTypeStoreRequest_Flags.htm)|  
[Group](P_Tessa_Platform_Configuration_CardTypeStoreRequest_Group.htm)|  
[ID](P_Tessa_Platform_Configuration_CardTypeStoreRequest_ID.htm)|  
[InstanceType](P_Tessa_Platform_Configuration_CardTypeStoreRequest_InstanceType.htm)|  
[Metadata](P_Tessa_Platform_Configuration_CardTypeStoreRequest_Metadata.htm)|  
[Name](P_Tessa_Platform_Configuration_CardTypeStoreRequest_Name.htm)|  
## __Методы
