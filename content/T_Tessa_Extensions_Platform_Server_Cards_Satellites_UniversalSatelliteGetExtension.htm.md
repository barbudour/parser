# UniversalSatelliteGetExtension - класс
...
C# __Копировать
     public sealed class UniversalSatelliteGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class UniversalSatelliteGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class UniversalSatelliteGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type UniversalSatelliteGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ UniversalSatelliteGetExtension
##  __Конструкторы
[UniversalSatelliteGetExtension](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteGetExtension__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteGetExtension_AfterRequest.htm)|
...
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteGetExtension_BeforeRequest.htm)|
