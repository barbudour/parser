# TaskFilesExampleStoreExtension - класс
...
C# __Копировать
     public sealed class TaskFilesExampleStoreExtension : CardStoreExtension
VB __Копировать
     Public NotInheritable Class TaskFilesExampleStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class TaskFilesExampleStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type TaskFilesExampleStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ TaskFilesExampleStoreExtension
##  __Конструкторы
[TaskFilesExampleStoreExtension](M_Tessa_Extensions_Default_Server_Cards_TaskFilesExampleStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса TaskFilesExampleStoreExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Default_Server_Cards_TaskFilesExampleStoreExtension_BeforeCommitTransaction.htm)|
...
[BeforeRequest](M_Tessa_Extensions_Default_Server_Cards_TaskFilesExampleStoreExtension_BeforeRequest.htm)|
