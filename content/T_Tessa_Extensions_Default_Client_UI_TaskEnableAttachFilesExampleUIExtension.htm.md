# TaskEnableAttachFilesExampleUIExtension - класс
...
VB __Копировать
     Public NotInheritable Class TaskEnableAttachFilesExampleUIExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class TaskEnableAttachFilesExampleUIExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type TaskEnableAttachFilesExampleUIExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ TaskEnableAttachFilesExampleUIExtension
##  __Конструкторы
[TaskEnableAttachFilesExampleUIExtension](M_Tessa_Extensions_Default_Client_UI_TaskEnableAttachFilesExampleUIExtension__ctor.htm)|
Инициализирует новый экземпляр класса TaskEnableAttachFilesExampleUIExtension  
---|---  
##  __Методы
...
(Унаследован от [CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm))  
[Saving](M_Tessa_Extensions_Default_Client_UI_TaskEnableAttachFilesExampleUIExtension_Saving.htm)|
