# ResolutionStageUIHandler - класс
...
VB __Копировать
     Public NotInheritable Class ResolutionStageUIHandler
    	Inherits StageTypeUIHandlerBase
C++ __Копировать
     public ref class ResolutionStageUIHandler sealed : public StageTypeUIHandlerBase
F# __Копировать
     [<SealedAttribute>]
    type ResolutionStageUIHandler = 
        class
            inherit StageTypeUIHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StageTypeUIHandlerBase](T_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_StageTypeUIHandlerBase.htm) __ ResolutionStageUIHandler
##  __Конструкторы
[ResolutionStageUIHandler](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_ResolutionStageUIHandler__ctor.htm)|
Инициализирует новый экземпляр класса ResolutionStageUIHandler  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Finalize(IKrStageTypeUIHandlerContext)](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_ResolutionStageUIHandler_Finalize.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialize](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_ResolutionStageUIHandler_Initialize.htm)|
