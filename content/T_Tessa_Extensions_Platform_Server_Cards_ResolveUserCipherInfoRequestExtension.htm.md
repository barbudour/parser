# ResolveUserCipherInfoRequestExtension - класс
...
C# __Копировать
     public sealed class ResolveUserCipherInfoRequestExtension : CardRequestExtension
VB __Копировать
     Public NotInheritable Class ResolveUserCipherInfoRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class ResolveUserCipherInfoRequestExtension sealed : public CardRequestExtension
F# __Копировать
     [<SealedAttribute>]
    type ResolveUserCipherInfoRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ ResolveUserCipherInfoRequestExtension
##  __Конструкторы
[ResolveUserCipherInfoRequestExtension](M_Tessa_Extensions_Platform_Server_Cards_ResolveUserCipherInfoRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса ResolveUserCipherInfoRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_ResolveUserCipherInfoRequestExtension_AfterRequest.htm)|  
(Переопределяет
