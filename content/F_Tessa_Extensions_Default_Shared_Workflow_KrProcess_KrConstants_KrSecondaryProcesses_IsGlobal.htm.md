# KrConstants.KrSecondaryProcesses.IsGlobal - поле
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Const IsGlobal As String = "IsGlobal"
C++ __Копировать
     public:
    literal String^ IsGlobal = "IsGlobal"
F# __Копировать
     static val mutable IsGlobal: string
#### Значение поля
