# CardDeleteRequest.FromTypedJson - метод
...
C# __Копировать
     public CardDeleteRequest FromTypedJson(
    	string json
    )
VB __Копировать
     Public Function FromTypedJson ( 
    	json As String
    ) As CardDeleteRequest
C++ __Копировать
     public:
    CardDeleteRequest^ FromTypedJson(
    	String^ json
    )
F# __Копировать
     member FromTypedJson : 
            json : string -> CardDeleteRequest 
#### Параметры
