# LocalizationLibraryByNameCollection - класс
##  __Definition
 **Пространство имён:** [Tessa.Localization](N_Tessa_Localization.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public sealed class LocalizationLibraryByNameCollection : HashSet<string, LocalizationLibrary>
VB __Копировать
     Public NotInheritable Class LocalizationLibraryByNameCollection
    	Inherits HashSet(Of String, LocalizationLibrary)
C++ __Копировать
     public ref class LocalizationLibraryByNameCollection sealed : public HashSet<String^, LocalizationLibrary^>
F# __Копировать
     [<SealedAttribute>]
    type LocalizationLibraryByNameCollection = 
        class
            inherit HashSet<string, LocalizationLibrary>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[HashSet](T_Tessa_Platform_Collections_HashSet_2.htm)<[String](https://learn.microsoft.com/dotnet/api/system.string), [LocalizationLibrary](T_Tessa_Localization_LocalizationLibrary.htm)> __ LocalizationLibraryByNameCollection
##  __Конструкторы
[LocalizationLibraryByNameCollection()](M_Tessa_Localization_LocalizationLibraryByNameCollection__ctor.htm)|
Инициализирует новый экземпляр класса LocalizationLibraryByNameCollection  
---|---  
[LocalizationLibraryByNameCollection(IEnumerable<LocalizationLibrary>)](M_Tessa_Localization_LocalizationLibraryByNameCollection__ctor_1.htm)|
Инициализирует новый экземпляр класса LocalizationLibraryByNameCollection  
##  __Свойства
