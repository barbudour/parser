# KrDescriptors.KrAmendingDescriptor - поле
Доработка.
## __Definition
 **Пространство имён:**
...
VB __Копировать
     Public Shared ReadOnly KrAmendingDescriptor As WorkflowActionDescriptor
C++ __Копировать
     public:
    static initonly WorkflowActionDescriptor^ KrAmendingDescriptor
F# __Копировать
     static val KrAmendingDescriptor: WorkflowActionDescriptor
#### Значение поля
