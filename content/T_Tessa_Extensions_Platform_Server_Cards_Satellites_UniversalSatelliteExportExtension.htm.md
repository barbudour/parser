# UniversalSatelliteExportExtension - класс
...
C# __Копировать
     public sealed class UniversalSatelliteExportExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class UniversalSatelliteExportExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class UniversalSatelliteExportExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type UniversalSatelliteExportExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ UniversalSatelliteExportExtension
##  __Конструкторы
[UniversalSatelliteExportExtension](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteExportExtension__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteExportExtension_AfterRequest.htm)|
