...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[FixFromMetadataAsync](M_Tessa_Cards_CardTaskHistoryItem_FixFromMetadataAsync.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[HasChanges](M_Tessa_Cards_CardTaskHistoryItem_HasChanges.htm)|  Возвращает
признак того, что элемент истории заданий изменен.  
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[IsEmpty](M_Tessa_Cards_CardTaskHistoryItem_IsEmpty.htm)|  Возвращает признак
...
(Унаследован от [StorageObject](T_Tessa_Platform_Storage_StorageObject.htm))  
[RemoveChanges](M_Tessa_Cards_CardTaskHistoryItem_RemoveChanges.htm)|
...
(Унаследован от
[CardInfoStorageObject](T_Tessa_Cards_CardInfoStorageObject.htm))  
[RepairStorage](M_Tessa_Cards_CardTaskHistoryItem_RepairStorage.htm)|
...
(Унаследован от
[ValidationStorageObject](T_Tessa_Platform_Validation_ValidationStorageObject.htm))  
[ValidateInternal](M_Tessa_Cards_CardTaskHistoryItem_ValidateInternal.htm)|
Выполняет валидацию текущего объекта и всех его дочерних объектов.  
(Переопределяет
