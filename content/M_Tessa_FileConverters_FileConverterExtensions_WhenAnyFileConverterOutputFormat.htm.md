# FileConverterExtensions.WhenAnyFileConverterOutputFormat - метод
...
C# __Копировать
     public static IExtensionPolicyContainer WhenAnyFileConverterOutputFormat(
    	this IExtensionPolicyContainer policyContainer
    )
VB __Копировать
    <ExtensionAttribute>
    Public Shared Function WhenAnyFileConverterOutputFormat ( 
    	policyContainer As IExtensionPolicyContainer
    ) As IExtensionPolicyContainer
C++ __Копировать
     public:
    [ExtensionAttribute]
    static IExtensionPolicyContainer^ WhenAnyFileConverterOutputFormat(
    	IExtensionPolicyContainer^ policyContainer
    )
F# __Копировать
     [<ExtensionAttribute>]
    static member WhenAnyFileConverterOutputFormat : 
