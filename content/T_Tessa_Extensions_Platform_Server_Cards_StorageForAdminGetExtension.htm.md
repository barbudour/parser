# StorageForAdminGetExtension - класс
...
C# __Копировать
     public sealed class StorageForAdminGetExtension : CardGetExtension
VB __Копировать
     Public NotInheritable Class StorageForAdminGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class StorageForAdminGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type StorageForAdminGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ StorageForAdminGetExtension
##  __Конструкторы
[StorageForAdminGetExtension](M_Tessa_Extensions_Platform_Server_Cards_StorageForAdminGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса StorageForAdminGetExtension  
---|---  
##  __Методы
...
(Унаследован от
[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_StorageForAdminGetExtension_BeforeRequest.htm)|  
(Переопределяет
