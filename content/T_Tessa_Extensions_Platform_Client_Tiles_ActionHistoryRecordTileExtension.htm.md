# ActionHistoryRecordTileExtension - класс
...
C# __Копировать
     public sealed class ActionHistoryRecordTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class ActionHistoryRecordTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class ActionHistoryRecordTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type ActionHistoryRecordTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ ActionHistoryRecordTileExtension
##  __Конструкторы
[ActionHistoryRecordTileExtension()](M_Tessa_Extensions_Platform_Client_Tiles_ActionHistoryRecordTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса ActionHistoryRecordTileExtension  
---|---  
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Platform_Client_Tiles_ActionHistoryRecordTileExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[InitializingLocal](M_Tessa_Extensions_Platform_Client_Tiles_ActionHistoryRecordTileExtension_InitializingLocal.htm)|  
(Переопределяет
