...
VB __Копировать
     Public NotInheritable Class ForumGetExtension
    	Inherits CardGetExtension
C++ __Копировать
     public ref class ForumGetExtension sealed : public CardGetExtension
F# __Копировать
     [<SealedAttribute>]
    type ForumGetExtension = 
        class
            inherit CardGetExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardGetExtension](T_Tessa_Cards_Extensions_CardGetExtension.htm) __ ForumGetExtension
##  __Конструкторы
[ForumGetExtension](M_Tessa_Extensions_Default_Server_Forums_ForumGetExtension__ctor.htm)|
Инициализирует новый экземпляр класса ForumGetExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Default_Server_Forums_ForumGetExtension_AfterRequest.htm)|  
(Переопределяет
