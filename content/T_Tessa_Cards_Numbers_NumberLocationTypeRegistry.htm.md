# NumberLocationTypeRegistry - класс
...
C# __Копировать
     public sealed class NumberLocationTypeRegistry : Registry<Guid, NumberLocationType>, 
    	INumberLocationTypeRegistry, IRegistry<Guid, NumberLocationType>
VB __Копировать
     Public NotInheritable Class NumberLocationTypeRegistry
    	Inherits Registry(Of Guid, NumberLocationType)
    	Implements INumberLocationTypeRegistry, IRegistry(Of Guid, NumberLocationType)
C++ __Копировать
     public ref class NumberLocationTypeRegistry sealed : public Registry<Guid, NumberLocationType^>, 
    	INumberLocationTypeRegistry, IRegistry<Guid, NumberLocationType^>
F# __Копировать
     [<SealedAttribute>]
    type NumberLocationTypeRegistry = 
        class
            inherit Registry<Guid, NumberLocationType>
            interface INumberLocationTypeRegistry
            interface IRegistry<Guid, NumberLocationType>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Registry](T_Tessa_Platform_Registry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [NumberLocationType](T_Tessa_Cards_Numbers_NumberLocationType.htm)> __ NumberLocationTypeRegistry
Implements
    [INumberLocationTypeRegistry](T_Tessa_Cards_Numbers_INumberLocationTypeRegistry.htm), [IRegistry](T_Tessa_Platform_IRegistry_2.htm)<[Guid](https://learn.microsoft.com/dotnet/api/system.guid), [NumberLocationType](T_Tessa_Cards_Numbers_NumberLocationType.htm)>
##  __Свойства
