# AutoAprovedTaskNotificationInfo - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
     public class AutoAprovedTaskNotificationInfo : TaskNotificationStorage
VB __Копировать
     Public Class AutoAprovedTaskNotificationInfo
    	Inherits TaskNotificationStorage
C++ __Копировать
     public ref class AutoAprovedTaskNotificationInfo : public TaskNotificationStorage
F# __Копировать
     type AutoAprovedTaskNotificationInfo = 
        class
            inherit TaskNotificationStorage
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __[TaskNotificationStorage](T_Tessa_Extensions_Default_Chronos_Notices_TaskNotificationStorage.htm) __ AutoAprovedTaskNotificationInfo
##  __Конструкторы
[AutoAprovedTaskNotificationInfo](M_Tessa_Extensions_Default_Chronos_Notices_AutoAprovedTaskNotificationInfo__ctor.htm)|
Инициализирует новый экземпляр класса AutoAprovedTaskNotificationInfo  
---|---  
##  __Свойства
...
---|---  
[Comment](P_Tessa_Extensions_Default_Chronos_Notices_AutoAprovedTaskNotificationInfo_Comment.htm)|
Комментарий, с которым было завершено задание  
[Date](P_Tessa_Extensions_Default_Chronos_Notices_AutoAprovedTaskNotificationInfo_Date.htm)|
Дата автоматического завершения  
[ID](P_Tessa_Extensions_Default_Chronos_Notices_AutoAprovedTaskNotificationInfo_ID.htm)|
