# ICardGetFileContentExtensionContext - интерфейс
Контекст процесса получения контента файла.
## __Definition
 **Пространство имён:** [Tessa.Cards.Extensions](N_Tessa_Cards_Extensions.htm)  
 **Сборка:** Tessa (в Tessa.dll) Версия: 3.6.0.17
C# __Копировать
     public interface ICardGetFileContentExtensionContext : ICardFileRequestExtensionContext<CardGetFileContentRequest, CardGetFileContentResponse>, 
    	ICardFileExtensionContext, ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext, 
    	ICardRequestExtensionContext<CardGetFileContentRequest, CardGetFileContentResponse>
VB __Копировать
     Public Interface ICardGetFileContentExtensionContext
    	Inherits ICardFileRequestExtensionContext(Of CardGetFileContentRequest, CardGetFileContentResponse), ICardFileExtensionContext, 
    	ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext, ICardRequestExtensionContext(Of CardGetFileContentRequest, CardGetFileContentResponse)
C++ __Копировать
     public interface class ICardGetFileContentExtensionContext : ICardFileRequestExtensionContext<CardGetFileContentRequest^, CardGetFileContentResponse^>, 
    	ICardFileExtensionContext, ICardExtensionContext, ICardTypeExtensionContext, IExtensionContext, ITraceableExtensionContext, 
    	ICardRequestExtensionContext<CardGetFileContentRequest^, CardGetFileContentResponse^>
F# __Копировать
     type ICardGetFileContentExtensionContext = 
        interface
...
(Унаследован от
[ICardTypeExtensionContext](T_Tessa_Cards_Extensions_ICardTypeExtensionContext.htm))  
[ContentFuncAsync](P_Tessa_Cards_Extensions_ICardGetFileContentExtensionContext_ContentFuncAsync.htm)|
