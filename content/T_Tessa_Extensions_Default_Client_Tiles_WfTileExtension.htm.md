...
C# __Копировать
     public sealed class WfTileExtension : TileExtension
VB __Копировать
     Public NotInheritable Class WfTileExtension
    	Inherits TileExtension
C++ __Копировать
     public ref class WfTileExtension sealed : public TileExtension
F# __Копировать
     [<SealedAttribute>]
    type WfTileExtension = 
        class
            inherit TileExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[TileExtension](T_Tessa_UI_Tiles_Extensions_TileExtension.htm) __ WfTileExtension
##  __Конструкторы
[WfTileExtension](M_Tessa_Extensions_Default_Client_Tiles_WfTileExtension__ctor.htm)|
Инициализирует новый экземпляр класса WfTileExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[InitializingGlobal](M_Tessa_Extensions_Default_Client_Tiles_WfTileExtension_InitializingGlobal.htm)|  
(Переопределяет
...
[InitializingLocal](M_Tessa_Extensions_Default_Client_Tiles_WfTileExtension_InitializingLocal.htm)|  
(Переопределяет
