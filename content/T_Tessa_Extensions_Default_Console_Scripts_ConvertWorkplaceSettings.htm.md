# ConvertWorkplaceSettings - класс
##  __Definition
 **Пространство имён:**
...
C# __Копировать
    [ConsoleScriptAttribute("ConvertWorkplaceSettings")]
    public sealed class ConvertWorkplaceSettings : ServerConsoleScriptBase
VB __Копировать
    <ConsoleScriptAttribute("ConvertWorkplaceSettings")>
    Public NotInheritable Class ConvertWorkplaceSettings
    	Inherits ServerConsoleScriptBase
C++ __Копировать
    [ConsoleScriptAttribute(L"ConvertWorkplaceSettings")]
    public ref class ConvertWorkplaceSettings sealed : public ServerConsoleScriptBase
F# __Копировать
     [<SealedAttribute>]
    [<ConsoleScriptAttribute("ConvertWorkplaceSettings")>]
    type ConvertWorkplaceSettings = 
        class
            inherit ServerConsoleScriptBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ConsoleScriptBase](T_Tessa_Platform_ConsoleApps_ConsoleScriptBase.htm) __[ServerConsoleScriptBase](T_Tessa_Platform_ConsoleApps_ServerConsoleScriptBase.htm) __ ConvertWorkplaceSettings
##  __Конструкторы
[ConvertWorkplaceSettings](M_Tessa_Extensions_Default_Console_Scripts_ConvertWorkplaceSettings__ctor.htm)|
Инициализирует новый экземпляр класса ConvertWorkplaceSettings  
---|---  
##  __Свойства
...
(Унаследован от
[ConsoleScriptBase](T_Tessa_Platform_ConsoleApps_ConsoleScriptBase.htm))  
[ExecuteCoreAsync](M_Tessa_Extensions_Default_Console_Scripts_ConvertWorkplaceSettings_ExecuteCoreAsync.htm)|  
(Переопределяет
...
(Унаследован от
[ServerConsoleScriptBase](T_Tessa_Platform_ConsoleApps_ServerConsoleScriptBase.htm))  
[ShowHelpCoreAsync](M_Tessa_Extensions_Default_Console_Scripts_ConvertWorkplaceSettings_ShowHelpCoreAsync.htm)|  
(Переопределяет
