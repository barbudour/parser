# WindowActivatedEventManager - класс
...
C# __Копировать
     public sealed class WindowActivatedEventManager : WeakEventManager<WindowActivatedEventManager, Window>
VB __Копировать
     Public NotInheritable Class WindowActivatedEventManager
    	Inherits WeakEventManager(Of WindowActivatedEventManager, Window)
C++ __Копировать
     public ref class WindowActivatedEventManager sealed : public WeakEventManager<WindowActivatedEventManager^, Window^>
F# __Копировать
     [<SealedAttribute>]
    type WindowActivatedEventManager = 
        class
            inherit WeakEventManager<WindowActivatedEventManager, Window>
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[WeakEventManager](https://learn.microsoft.com/dotnet/api/system.windows.weakeventmanager) __[WeakEventManager](T_Tessa_UI_WeakEventManager_2.htm)<WindowActivatedEventManager, [Window](https://learn.microsoft.com/dotnet/api/system.windows.window)> __ WindowActivatedEventManager
##  __Свойства
...
[StartListening(Window)](M_Tessa_UI_Windows_WindowActivatedEventManager_StartListening.htm)|
Присоединяет обработчик события от текущего объекта для заданного источника.  
...
(Унаследован от [WeakEventManager<TManager,
TEventSource>](T_Tessa_UI_WeakEventManager_2.htm))  
[StopListening(Window)](M_Tessa_UI_Windows_WindowActivatedEventManager_StopListening.htm)|
Отсоединяет обработчик события от текущего объекта для заданного источника.  
(Переопределяет [WeakEventManager<TManager,
