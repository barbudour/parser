# CardModelSettings.SetFilePreviewWidthRatioAsync - метод
...
C# __Копировать
     public Task SetFilePreviewWidthRatioAsync(
    	double value,
    	Func<Action, CancellationToken, Task> executePropertyChangedAsync = null,
    	CancellationToken cancellationToken = default
    )
VB __Копировать
     Public Function SetFilePreviewWidthRatioAsync ( 
    	value As Double,
...
C++ __Копировать
     public:
    virtual Task^ SetFilePreviewWidthRatioAsync(
    	double value, 
...
F# __Копировать
    ...
    *)
    -> Task 
    override SetFilePreviewWidthRatioAsync : 
            value : float * 
            ?executePropertyChangedAsync : Func<Action, CancellationToken, Task> * 
            ?cancellationToken : CancellationToken 
    (* Defaults:
...
Асинхронная задача.
#### Реализации
[ICardModelSettings.SetFilePreviewWidthRatioAsync(Double, Func<Action,
CancellationToken, Task>,
CancellationToken)](M_Tessa_Cards_ICardModelSettings_SetFilePreviewWidthRatioAsync.htm)  
##  __См. также
#### Ссылки
