...
VB __Копировать
     Public NotInheritable Class TabCaptionUIHandler
    	Inherits StageTypeUIHandlerBase
C++ __Копировать
     public ref class TabCaptionUIHandler sealed : public StageTypeUIHandlerBase
F# __Копировать
     [<SealedAttribute>]
    type TabCaptionUIHandler = 
        class
            inherit StageTypeUIHandlerBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StageTypeUIHandlerBase](T_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_StageTypeUIHandlerBase.htm) __ TabCaptionUIHandler
##  __Конструкторы
[TabCaptionUIHandler](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_TabCaptionUIHandler__ctor.htm)|
Инициализирует новый экземпляр класса TabCaptionUIHandler  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Finalize(IKrStageTypeUIHandlerContext)](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_TabCaptionUIHandler_Finalize.htm)|
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialize](M_Tessa_Extensions_Default_Client_UI_KrProcess_StageHandlers_TabCaptionUIHandler_Initialize.htm)|
