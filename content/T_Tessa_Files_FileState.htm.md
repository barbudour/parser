...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __ FileState
Implements
    [IFileState](T_Tessa_Files_IFileState.htm)
##  __Конструкторы
[FileState](M_Tessa_Files_FileState__ctor.htm)|  Создаёт экземпляр класса с
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[IsDependantFileProperty](M_Tessa_Files_FileState_IsDependantFileProperty.htm)|
