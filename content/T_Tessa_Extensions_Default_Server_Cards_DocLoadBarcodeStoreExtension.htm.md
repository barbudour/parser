# DocLoadBarcodeStoreExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class DocLoadBarcodeStoreExtension
    	Inherits CardStoreExtension
C++ __Копировать
     public ref class DocLoadBarcodeStoreExtension sealed : public CardStoreExtension
F# __Копировать
     [<SealedAttribute>]
    type DocLoadBarcodeStoreExtension = 
        class
            inherit CardStoreExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm) __ DocLoadBarcodeStoreExtension
##  __Конструкторы
[DocLoadBarcodeStoreExtension](M_Tessa_Extensions_Default_Server_Cards_DocLoadBarcodeStoreExtension__ctor.htm)|
Инициализирует новый экземпляр класса DocLoadBarcodeStoreExtension  
---|---  
##  __Методы
...
---|---  
[AfterRequest](M_Tessa_Extensions_Default_Server_Cards_DocLoadBarcodeStoreExtension_AfterRequest.htm)|  
(Переопределяет
...
(Унаследован от
[CardStoreExtension](T_Tessa_Cards_Extensions_CardStoreExtension.htm))  
[BeforeCommitTransaction](M_Tessa_Extensions_Default_Server_Cards_DocLoadBarcodeStoreExtension_BeforeCommitTransaction.htm)|  
(Переопределяет
...
[BeforeRequest](M_Tessa_Extensions_Default_Server_Cards_DocLoadBarcodeStoreExtension_BeforeRequest.htm)|  
(Переопределяет
...
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
##  __Поля
[CreateBarcodeKey](F_Tessa_Extensions_Default_Server_Cards_DocLoadBarcodeStoreExtension_CreateBarcodeKey.htm)|  
---|---  
## __Методы расширения
