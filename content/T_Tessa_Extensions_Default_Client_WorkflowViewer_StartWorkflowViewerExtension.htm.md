# StartWorkflowViewerExtension - класс
##  __Definition
 **Пространство имён:**
...
VB __Копировать
     Public NotInheritable Class StartWorkflowViewerExtension
    	Inherits CardUIExtension
C++ __Копировать
     public ref class StartWorkflowViewerExtension sealed : public CardUIExtension
F# __Копировать
     [<SealedAttribute>]
    type StartWorkflowViewerExtension = 
        class
            inherit CardUIExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardUIExtension](T_Tessa_UI_Cards_CardUIExtension.htm) __ StartWorkflowViewerExtension
##  __Конструкторы
[StartWorkflowViewerExtension](M_Tessa_Extensions_Default_Client_WorkflowViewer_StartWorkflowViewerExtension__ctor.htm)|
Инициализирует новый экземпляр класса StartWorkflowViewerExtension  
---|---  
##  __Методы
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[Initialized](M_Tessa_Extensions_Default_Client_WorkflowViewer_StartWorkflowViewerExtension_Initialized.htm)|  
(Переопределяет
