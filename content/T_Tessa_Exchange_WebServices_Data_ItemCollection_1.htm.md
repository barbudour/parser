...
C# __Копировать
    ...
    public sealed class ItemCollection<TItem> : ComplexProperty, 
    	IEnumerable<TItem>, IEnumerable
    where TItem : Item
VB __Копировать
    <EditorBrowsableAttribute(EditorBrowsableState.Never)>
    Public NotInheritable Class ItemCollection(Of TItem As Item)
...
C++ __Копировать
    ...
    where TItem : Item
    public ref class ItemCollection sealed : public ComplexProperty, 
    	IEnumerable<TItem>, IEnumerable
F# __Копировать
     [<SealedAttribute>]
    [<EditorBrowsableAttribute(EditorBrowsableState.Never)>]
    type ItemCollection<'TItem when 'TItem : Item> = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[ComplexProperty](T_Tessa_Exchange_WebServices_Data_ComplexProperty.htm) __ ItemCollection<TItem>
Implements
...
##  __Свойства
[Count](P_Tessa_Exchange_WebServices_Data_ItemCollection_1_Count.htm)|  Gets
the total number of items in the collection.  
---|---  
[Item](P_Tessa_Exchange_WebServices_Data_ItemCollection_1_Item.htm)|  Gets the
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetEnumerator](M_Tessa_Exchange_WebServices_Data_ItemCollection_1_GetEnumerator.htm)|
