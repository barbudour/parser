# BusinessProcessGetBlockStatusRequestExtension - класс
...
C# __Копировать
     public class BusinessProcessGetBlockStatusRequestExtension : CardRequestExtension
VB __Копировать
     Public Class BusinessProcessGetBlockStatusRequestExtension
    	Inherits CardRequestExtension
C++ __Копировать
     public ref class BusinessProcessGetBlockStatusRequestExtension : public CardRequestExtension
F# __Копировать
     type BusinessProcessGetBlockStatusRequestExtension = 
        class
            inherit CardRequestExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardRequestExtension](T_Tessa_Cards_Extensions_CardRequestExtension.htm) __ BusinessProcessGetBlockStatusRequestExtension
##  __Конструкторы
[BusinessProcessGetBlockStatusRequestExtension](M_Tessa_Extensions_Platform_Server_Workflow_BusinessProcessGetBlockStatusRequestExtension__ctor.htm)|
Инициализирует новый экземпляр класса
BusinessProcessGetBlockStatusRequestExtension  
---|---  
##  __Методы
[AfterRequest](M_Tessa_Extensions_Platform_Server_Workflow_BusinessProcessGetBlockStatusRequestExtension_AfterRequest.htm)|  
(Переопределяет
