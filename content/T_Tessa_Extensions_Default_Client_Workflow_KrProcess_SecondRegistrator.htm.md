...
C# __Копировать
    [RegistratorAttribute(ExtensionStage.AfterPlatform, Order = 2)]
    public sealed class SecondRegistrator : RegistratorBase
VB __Копировать
    <RegistratorAttribute(ExtensionStage.AfterPlatform, Order := 2)>
    Public NotInheritable Class SecondRegistrator
    	Inherits RegistratorBase
C++ __Копировать
    [RegistratorAttribute(ExtensionStage::AfterPlatform, Order = 2)]
    public ref class SecondRegistrator sealed : public RegistratorBase
F# __Копировать
     [<SealedAttribute>]
    [<RegistratorAttribute(ExtensionStage.AfterPlatform, Order = 2)>]
    type SecondRegistrator = 
        class
            inherit RegistratorBase
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm) __ SecondRegistrator
##  __Конструкторы
[SecondRegistrator](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_SecondRegistrator__ctor.htm)|
Инициализирует новый экземпляр класса SecondRegistrator  
---|---  
##  __Свойства
...
в этом объекте.  
(Унаследован от [RegistratorBase](T_Tessa_Extensions_RegistratorBase.htm))  
[RegisterUnity](M_Tessa_Extensions_Default_Client_Workflow_KrProcess_SecondRegistrator_RegisterUnity.htm)|
