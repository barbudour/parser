# ChronosSerializationException - класс
...
C# __Копировать
    ...
    public sealed class ChronosSerializationException : ApplicationException
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class ChronosSerializationException
    	Inherits ApplicationException
C++ __Копировать
    [SerializableAttribute]
    public ref class ChronosSerializationException sealed : public ApplicationException
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
    type ChronosSerializationException = 
        class
            inherit ApplicationException
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[Exception](https://learn.microsoft.com/dotnet/api/system.exception) __[ApplicationException](https://learn.microsoft.com/dotnet/api/system.applicationexception) __ ChronosSerializationException
##  __Конструкторы
[ChronosSerializationException()](M_Chronos_Platform_ChronosSerializationException__ctor.htm)|
Инициализирует новый экземпляр класса ChronosSerializationException  
---|---  
