...
C# __Копировать
     public class PreviewView : UserControl, 
    	IContentItem, INotifyPropertyChanged, IPreviewPageExtractorProvider, IWeakEventListener, IComponentConnector
VB __Копировать
     Public Class PreviewView
    	Inherits UserControl
    	Implements IContentItem, INotifyPropertyChanged, IPreviewPageExtractorProvider, IWeakEventListener, 
    	IComponentConnector
C++ __Копировать
     public ref class PreviewView : public UserControl, 
    	IContentItem, INotifyPropertyChanged, IPreviewPageExtractorProvider, IWeakEventListener, IComponentConnector
F# __Копировать
     type PreviewView = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[DispatcherObject](https://learn.microsoft.com/dotnet/api/system.windows.threading.dispatcherobject) __[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject) __[Visual](https://learn.microsoft.com/dotnet/api/system.windows.media.visual) __[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement) __[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement) __[Control](https://learn.microsoft.com/dotnet/api/system.windows.controls.control) __[ContentControl](https://learn.microsoft.com/dotnet/api/system.windows.controls.contentcontrol) __[UserControl](https://learn.microsoft.com/dotnet/api/system.windows.controls.usercontrol) __ PreviewView
Implements
    [INotifyPropertyChanged](https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged), [IWeakEventListener](https://learn.microsoft.com/dotnet/api/system.windows.iweakeventlistener), [IComponentConnector](https://learn.microsoft.com/dotnet/api/system.windows.markup.icomponentconnector), [IPreviewPageExtractorProvider](T_Tessa_UI_Files_IPreviewPageExtractorProvider.htm), [IContentItem](T_Tessa_UI_Views_Content_IContentItem.htm)
##  __Конструкторы
[PreviewView](M_Tessa_Extensions_Default_Client_Views_PreviewView__ctor.htm)|
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[FileNameColumnName](P_Tessa_Extensions_Default_Client_Views_PreviewView_FileNameColumnName.htm)|
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[Order](P_Tessa_Extensions_Default_Client_Views_PreviewView_Order.htm)|
...
(Унаследован от
[Control](https://learn.microsoft.com/dotnet/api/system.windows.controls.control))  
[PageOptions](P_Tessa_Extensions_Default_Client_Views_PreviewView_PageOptions.htm)|
Настройки отображения области предпросмотра документа, разделённого на
страницы. Значение не равно null.  
...
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
Устарело.  
[PlaceAreas](P_Tessa_Extensions_Default_Client_Views_PreviewView_PlaceAreas.htm)|
Область отображения.  
[PreviewHandlersPool](P_Tessa_Extensions_Default_Client_Views_PreviewView_PreviewHandlersPool.htm)|
Пул обработчиков предварительного просмотра.  
[PreviewInfoCache](P_Tessa_Extensions_Default_Client_Views_PreviewView_PreviewInfoCache.htm)|
Кэш, предоставляющий информацию по предпросмотру файлов.  
[PreviewPath](P_Tessa_Extensions_Default_Client_Views_PreviewView_PreviewPath.htm)|
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[GetTemplate](M_Tessa_Extensions_Default_Client_Views_PreviewView_GetTemplate.htm)|
Возвращает шаблон представления для указанной области или null, если
используется шаблон представления по умолчанию.  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[InitializeComponent](M_Tessa_Extensions_Default_Client_Views_PreviewView_InitializeComponent.htm)|
InitializeComponent  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[OnPropertyChanged(DependencyPropertyChangedEventArgs)](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement.onpropertychanged#system-
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[OnPropertyChanged(PropertyChangedEventArgs)](M_Tessa_Extensions_Default_Client_Views_PreviewView_OnPropertyChanged.htm)|  
[OnPropertyChanged(String)](M_Tessa_Extensions_Default_Client_Views_PreviewView_OnPropertyChanged_1.htm)|  
...
(Унаследован от
[DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject))  
[ReceiveWeakEvent](M_Tessa_Extensions_Default_Client_Views_PreviewView_ReceiveWeakEvent.htm)|  
...
(Унаследован от
[FrameworkElement](https://learn.microsoft.com/dotnet/api/system.windows.frameworkelement))  
[TryGetPageExtractor](M_Tessa_Extensions_Default_Client_Views_PreviewView_TryGetPageExtractor.htm)|
Возвращает объект, выполняющий извлечение страницы для предпросмотра из
многостраничного документа, или null, если такой объект не зарегистрирован или
недоступен.  
...
(Унаследован от
[UIElement](https://learn.microsoft.com/dotnet/api/system.windows.uielement))  
[PropertyChanged](E_Tessa_Extensions_Default_Client_Views_PreviewView_PropertyChanged.htm)|
