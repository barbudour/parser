...
C# __Копировать
     public sealed class CheckWebProxy : WebProxy
VB __Копировать
     Public NotInheritable Class CheckWebProxy
    	Inherits WebProxy
C++ __Копировать
     public ref class CheckWebProxy sealed : public WebProxy
F# __Копировать
     [<SealedAttribute>]
    type CheckWebProxy = 
        class
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[WebProxy](T_Tessa_Platform_Runtime_WebProxy.htm) __ CheckWebProxy
##  __Конструкторы
[CheckWebProxy](M_Tessa_Extensions_Default_Console_CheckCommand_CheckWebProxy__ctor.htm)|
Инициализирует новый экземпляр класса CheckWebProxy  
---|---  
##  __Свойства
...
(Унаследован от
[Object](https://learn.microsoft.com/dotnet/api/system.object))  
[GetAsync](M_Tessa_Extensions_Default_Console_CheckCommand_CheckWebProxy_GetAsync.htm)|  
...
##  __См. также
#### Ссылки
[Tessa.Extensions.Default.Console.CheckCommand - пространство
имён](N_Tessa_Extensions_Default_Console_CheckCommand.htm)
