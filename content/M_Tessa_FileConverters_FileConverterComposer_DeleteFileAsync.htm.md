# FileConverterComposer.DeleteFileAsync - метод
...
#### Реализации
[IFileConverterComposer.DeleteFileAsync(IFileConverterRequest,
CancellationToken)](M_Tessa_FileConverters_IFileConverterComposer_DeleteFileAsync.htm)  
##  __См. также
#### Ссылки
