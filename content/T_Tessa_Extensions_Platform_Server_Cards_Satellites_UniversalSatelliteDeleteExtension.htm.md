# UniversalSatelliteDeleteExtension - класс
...
C# __Копировать
     public sealed class UniversalSatelliteDeleteExtension : CardDeleteExtension
VB __Копировать
     Public NotInheritable Class UniversalSatelliteDeleteExtension
    	Inherits CardDeleteExtension
C++ __Копировать
     public ref class UniversalSatelliteDeleteExtension sealed : public CardDeleteExtension
F# __Копировать
     [<SealedAttribute>]
    type UniversalSatelliteDeleteExtension = 
        class
            inherit CardDeleteExtension
        end
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm) __ UniversalSatelliteDeleteExtension
##  __Конструкторы
[UniversalSatelliteDeleteExtension](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteDeleteExtension__ctor.htm)|
Создаёт экземпляр класса с указанием его зависимостей.  
---|---  
## __Методы
[AfterBeginTransaction](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteDeleteExtension_AfterBeginTransaction.htm)|
...
---|---  
[AfterRequest](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteDeleteExtension_AfterRequest.htm)|
...
(Унаследован от
[CardDeleteExtension](T_Tessa_Cards_Extensions_CardDeleteExtension.htm))  
[BeforeRequest](M_Tessa_Extensions_Platform_Server_Cards_Satellites_UniversalSatelliteDeleteExtension_BeforeRequest.htm)|
