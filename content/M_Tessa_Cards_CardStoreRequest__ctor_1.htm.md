# CardStoreRequest(Dictionary<String, Object>) - конструктор
...
F# __Копировать
     new : 
            storage : Dictionary<string, Object> -> CardStoreRequest
#### Параметры
storage
...
[CardStoreRequest -
перегрузка](Overload_Tessa_Cards_CardStoreRequest__ctor.htm)
