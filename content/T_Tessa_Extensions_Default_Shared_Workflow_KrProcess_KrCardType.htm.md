...
C# __Копировать
    ...
    public sealed class KrCardType : StorageObject, 
    	IKrType
VB __Копировать
    <SerializableAttribute>
    Public NotInheritable Class KrCardType
    	Inherits StorageObject
    	Implements IKrType
C++ __Копировать
    [SerializableAttribute]
    public ref class KrCardType sealed : public StorageObject, 
    	IKrType
F# __Копировать
     [<SealedAttribute>]
    [<SerializableAttribute>]
...
Inheritance
    [Object](https://learn.microsoft.com/dotnet/api/system.object) __[StorageObject](T_Tessa_Platform_Storage_StorageObject.htm) __ KrCardType
Implements
    [IKrType](T_Tessa_Extensions_Default_Shared_Workflow_KrProcess_IKrType.htm)
##  __Конструкторы
[KrCardType](M_Tessa_Extensions_Default_Shared_Workflow_KrProcess_KrCardType__ctor.htm)|
Инициализирует новый экземпляр класса KrCardType  
---|---  
##  __Свойства
