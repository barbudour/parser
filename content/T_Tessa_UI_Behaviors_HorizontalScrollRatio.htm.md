...
(Унаследован от
[Freezable](https://learn.microsoft.com/dotnet/api/system.windows.freezable))  
[CreateInstanceCore](M_Tessa_UI_Behaviors_HorizontalScrollRatio_CreateInstanceCore.htm)|  
(Переопределяет
